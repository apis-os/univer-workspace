/**
 * CSV/TSV workbook conversion used by `/render` exchange interceptor and tests.
 * Production `/render` still calls IExchangeService; this is the in-page Universer
 * stand-in for csv/tsv (no exchange-node-binding).
 */
