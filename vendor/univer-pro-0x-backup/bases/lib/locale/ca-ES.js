const e = {
  bases: {
    fieldType: {
      text: "Text",
      singleSelect: "Opció única",
      multiSelect: "Opcions múltiples",
      person: "Persona",
      group: "Grup",
      date: "Data",
      attachment: "Adjunt",
    ...
    fieldConfig: {
      textPlaceholder: "Introdueix contingut",
      linkPlaceholder:
    ...
    error: {
      ...
      invalidCalendarDateField: "El calendari requereix un camp de data",
