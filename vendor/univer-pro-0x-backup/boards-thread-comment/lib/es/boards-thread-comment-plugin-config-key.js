...
const g="boards-thread-comment.config",var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB={};

export { g as BOARDS_THREAD_COMMENT_PLUGIN_CONFIG_KEY };

export { var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB };
