const e = {
  "collaboration-client-ui": {
    ...
    snapshotLoading: {
      timeout: "Loading\x20stopped\x20at\x20{0}/{1}.\x20Refresh\x20the\x20page\x20to\x20try\x20again.",
    ...
    collaboration: {
      "offline-data-not-saved": "You\x20have\x20offline\x20edits\x20that\x20have\x20not\x20been\x20saved\x20to\x20the\x20server.\x20Please\x20check\x20your\x20network\x20and\x20try\x20again.",
      "single-unit": {
    ...
    formula: {
      calculation: {
        ...
        waiting: "Formula calculation queue is full, waiting for available slot...",
        unable: "Unable to perform formula calculation at this time. Please try again later."
      }
    }
  }
};
