const e = {
  "collaboration-client": {
    ...
    session: {
      ...
      "room-full":
        "The document has reached its collaboration limit. Your edits will be cached locally.",
      "join-failed":
        "Failed to join collaboration. Please try again later. Your edits will be cached locally.",
      "room-not-exists":
        "Failed to join collaboration. Your edits will be cached locally.",
      "room-permission-denied":
        "No collaboration permission. Your edits will be cached locally.",
      "room-cnt-exceeds":
