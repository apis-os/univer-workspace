const e = {
  "collaboration-client": {
    ...
    session: {
      ...
      "join-failed":
        "Beitritt zur Zusammenarbeit fehlgeschlagen. Bitte versuchen Sie es später erneut. Ihre Änderungen werden lokal zwischengespeichert.",
      "room-not-exists":
        "Beitritt zur Zusammenarbeit fehlgeschlagen. Ihre Änderungen werden lokal zwischengespeichert.",
      "room-permission-denied":
        "Keine\x20Zusammenarbeitsberechtigung.\x20Ihre\x20Änderungen\x20werden\x20lokal\x20zwischengespeichert.",
      "room-cnt-exceeds":
        "Die Anzahl der Zusammenarbeitsdokumente überschreitet das Limit. Ihre Änderungen werden lokal zwischengespeichert.",
      "collaboration-timeout":
        "Der Server reagiert nicht auf Ihre Zusammenarbeitsanfrage. Ihre Änderungen werden lokal gespeichert.",
    },
    conflict: {
    ...
    auth: {
      needGotoLoginAlert:
        "Ihre\x20Anmeldung\x20ist\x20abgelaufen.\x20Klicken\x20Sie\x20auf\x20OK,\x20um\x20sich\x20erneut\x20anzumelden,\x20oder\x20auf\x20Abbrechen,\x20um\x20Ihre\x20lokalen\x20Änderungen\x20zu\x20speichern.",
    },
  },
};
export { e as default };
