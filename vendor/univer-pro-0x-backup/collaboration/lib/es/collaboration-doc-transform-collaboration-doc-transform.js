...
import { ur } from "./collaboration-rich-text-editing-mutation-with-self.js";
let dr = class extends Disposable {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46582) {
    super(), this._transformService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46582, [...ur].forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46250 => {
      this._transformService["registerTransformAlgorithm"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46250);
    });
  }
};
export { dr as DocTransformController };
