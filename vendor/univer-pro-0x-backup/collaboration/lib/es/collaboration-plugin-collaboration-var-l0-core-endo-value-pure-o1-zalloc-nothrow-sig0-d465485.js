...
let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465485 = class extends Disposable {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461337) {
    super(), this._commandService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461337, [Cn].forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46394 => this._commandService["registerCommand"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46394));
  }
};
