...
import { jn } from "./collaboration-transform-mutations-with-changeset-failure.js";
function Mn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461880) {
  return !jn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461880);
}
export { Mn as isTransformMutationsWithChangesetSuccess };
