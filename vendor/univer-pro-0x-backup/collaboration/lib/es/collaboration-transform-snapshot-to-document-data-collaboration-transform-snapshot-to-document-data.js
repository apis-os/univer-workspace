...
function wd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465007) {
  return JSON.parse(typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465007 == "string" ? Md(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465007) : md.decode(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465007));
}
function Kd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465213) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465214 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465213.doc;
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465214 == null) throw Error("transformSnapshotToDocumentData(): snapshot.doc is undefined.");
  let {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465215,
      rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465216,
      name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465217,
      originalMeta: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465218,
      resources: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465219 = []
    } = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465214,
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465220 = wd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465218);
  return {
    locale: LocaleType.EN_US,
    ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465220,
    documentStyle: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465220.documentStyle ?? {},
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465215,
    rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465216,
    title: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465217,
    resources: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465219
  };
}
export { Kd as transformSnapshotToDocumentData };
