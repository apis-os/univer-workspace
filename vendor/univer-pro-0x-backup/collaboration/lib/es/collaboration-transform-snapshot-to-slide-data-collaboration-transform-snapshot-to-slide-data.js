...
function Td(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465009) {
  return JSON.parse(typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465009 == "string" ? Md(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465009) : md.decode(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465009));
}
function Yd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465261) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465262 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465261.slide ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465261.doc;
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465262 == null) throw Error("transformSnapshotToSlideData(): snapshot.slide or snapshot.doc is undefined.");
  return {
    ...Td(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465262.originalMeta),
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465262.unitID,
    rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465261.rev,
    name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465262.name
  };
}
export { Yd as transformSnapshotToSlideData };
