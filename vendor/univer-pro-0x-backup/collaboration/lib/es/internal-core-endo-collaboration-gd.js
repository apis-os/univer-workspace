...
function gd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464991) {
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A239 = ["id", "rev", "name", "sheetOrder", "sheets", "resources"],
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB603 = {};
  return Object.keys(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464991).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461442 => {
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A239.includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461442) || (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB603[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461442] = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464991[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461442]));
  }), pd.encode(JSON.stringify(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB603));
}
export { gd };
