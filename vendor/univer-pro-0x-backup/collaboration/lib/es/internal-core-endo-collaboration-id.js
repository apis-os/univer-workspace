...
async function Id() {
  await new Promise(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461452 => {
    typeof setImmediate == "function" ? setImmediate(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461452) : setTimeout(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461452, 0);
  });
}
export { Id };
