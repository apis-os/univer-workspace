...
import { fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E } from "./internal-core-endo-internal-core-endo.js";
import { gf } from "./internal-core-endo-internal-glue.js";
function yf(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465381) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465382;
  let var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D142 = 0,
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465383 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465381.cellData;
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465383) {
    for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46428 in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465383) Object.prototype["hasOwnProperty"].call(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465383, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46428) && (var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D142 = Math.max(var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D142, fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465383[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46428])));
  }
  return Math.max(((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465382 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465381.fieldOrder) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465382.length) ?? gf(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465381.fields), fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465381.colId), var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D142);
}
export { yf };
