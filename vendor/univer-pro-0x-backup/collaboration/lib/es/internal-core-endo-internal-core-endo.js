...
function fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465375) {
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465375) return 0;
  let var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D140 = 0;
  for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461513 in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465375) {
    if (!Object.prototype["hasOwnProperty"].call(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465375, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461513)) continue;
    let var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D23 = Number(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461513);
    Number.isFinite(var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D23) && (var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D140 = Math.max(var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D140, var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D23 + 1));
  }
  return var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D140;
}
