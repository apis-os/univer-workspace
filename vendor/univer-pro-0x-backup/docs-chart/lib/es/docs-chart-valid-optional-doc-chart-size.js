...
function q(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46406){if(!K(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46406))throw Error("Document chart width and height must be positive finite numbers.");}
