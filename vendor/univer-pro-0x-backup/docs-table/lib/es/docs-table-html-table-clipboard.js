...
function da(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622){let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463623=new DOMParser().parseFromString(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622,"text/html").querySelector("table");return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463623?fa(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463623):{rows:[],columnWidths:[]};}
