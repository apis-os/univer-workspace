...
import { RUST_INCREMENTAL_DEPENDENCY_MUTATIONS } from "./engine-formula-rust-rust-upsert-reference-data-mutation-id.js";
function isRustIncrementalDependencyMutation(id) {
  return RUST_INCREMENTAL_DEPENDENCY_MUTATIONS.has(id);
}
export { isRustIncrementalDependencyMutation };
