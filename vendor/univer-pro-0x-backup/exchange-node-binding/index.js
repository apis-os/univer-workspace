...
const PACKAGE_NAME = '@univerjs-pro/exchange-node-binding';
const BINARY_NAME = 'univer-exchange-node';
...
for (const exportName of ['exchangeImportToSnapshot', 'exchangeExportSnapshot']) {
