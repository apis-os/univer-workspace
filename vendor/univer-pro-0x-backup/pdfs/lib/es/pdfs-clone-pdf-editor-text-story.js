...
function Em(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D467129){return JSON.parse(JSON.stringify(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D467129));}

export { Em as clonePdfEditorTextStory };
