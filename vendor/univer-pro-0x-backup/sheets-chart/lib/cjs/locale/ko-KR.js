const e = {
  "sheets-chart": {
    ...
    blank: "(비어 있음)",
    msg: {
      emptyTips: "계열을 추가하여 데이터 시각화를 시작하세요",
      sankeyCircularTips:
        "생키\x20차트에는\x20순환형\x20데이터를\x20포함할\x20수\x20없습니다",
    },
    bubble: {
      emptyTips: "거품형 차트는 가로 축, 세로 축 등 최소 2개의 열이 필요합니다",
    },
    relation: {
      emptyTips:
    ...
    chartField: {
      missingCategoryFields:
        "이\x20차트에는\x20레이블\x20필드가\x20더\x20필요합니다.",
