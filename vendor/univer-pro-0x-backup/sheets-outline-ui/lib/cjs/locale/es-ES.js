const e = {
  "sheets-outline-ui": {
    ...
    ungroupRows: "Desagrupar\x20filas\x20{0}\x20-\x20{1}",
    ...
    error: {
      ...
      invalidRange:
        "No se puede crear el esquema porque el intervalo seleccionado no es válido.",
      outOfBounds:
      ...
      maxDepth:
        "No\x20se\x20puede\x20crear\x20el\x20esquema\x20porque\x20los\x20esquemas\x20compatibles\x20con\x20Excel\x20admiten\x20hasta\x208\x20niveles.",
      moveSplitsOutline:
