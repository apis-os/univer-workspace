...
const X=createIdentifier("univer-pro.sheet-print-manager.service"),qt=var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736=>Math.floor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736*100)/100,Jt={'startColumn':0,'endColumn':0,'startRow':0,'endRow':0},Yt={'startColumn':-1,'startRow':-1,'xSplit':0,'ySplit':0};
