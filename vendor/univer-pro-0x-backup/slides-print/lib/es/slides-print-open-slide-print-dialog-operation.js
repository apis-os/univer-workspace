...
const V={id:"slide.operation.print-open",type:CommandType.OPERATION,handler(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46409,var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46410){return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46409.get(B).open(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46410),true;}},H={id:"slide.operation.print-close",type:CommandType.OPERATION,handler(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46413){return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46413.get(B).close(),true;}};
