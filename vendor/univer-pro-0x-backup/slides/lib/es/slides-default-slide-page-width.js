...
const Ue=960,We=540,Ge=Ve[0].colorScheme,Ke=Ve[0].fmtScheme,O={'id':Ve[0].id,'name':"Office Theme",'colorScheme':Ge,'fontScheme':{'heading':"Calibri Light",'body':"Calibri"},'fmtScheme':Ke},k="master-default",qe={'id':k,'pageType':"master",'name':"Office Theme",'pageSize':{'width':960,'height':540},'elementOrder':[],'elements':{},'background':{'type':"solid",'color':'#ffffff'}};
