...
const Yn=[UnitAction.Edit,UnitAction.Copy,UnitAction.Print,UnitAction.Export,UnitAction.Comment],Xn=new Set([UnitObject.Slide,UnitObject.SlidePage,UnitObject.SlideElement,UnitObject.SlideMaster]),Zn="page/",Qn='element/',var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB33='master-view';
