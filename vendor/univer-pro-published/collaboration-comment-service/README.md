...
The domain Service for Univer Thread Comments. When using Univer Comment Client, `UniverCommentEndpoint` calls it according to the frontend Comment protocol:
...
It manages comment bodies, replies, edits, solve/reopen, deletion, user-profile enrichment, middleware, and post-commit events. Root anchors remain in the main collaboration snapshot/changeset plane.
