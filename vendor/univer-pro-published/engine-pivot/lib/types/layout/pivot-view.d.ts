...
import type { ILabelViewHeaderMapItem, ILabelViewItemJSON, IPageViewItemJSON, IPageViewItemRange, IPivotTableDateGroupInfo, IPivotTableValueFieldQueryData, IPivotViewCellData, IPivotViewErrorValue, IPivotViewInfo, IPivotViewItemData, IPivotViewItemJSON, IPivotViewJSON, IPivotViewPrefixValue, IPivotViewValueType, PivotCellStyleTypeEnum } from '../types';
/**
 * @class PivotView
...
export declare class PivotView {
     ...
     */
    setFormat(model: PivotModel, valueQueryInfo: IPivotTableValueFieldQueryData[]): void;
    getVersion(): number;
