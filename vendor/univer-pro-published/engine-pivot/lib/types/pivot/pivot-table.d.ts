...
import type { PivotTableValuePositionEnum } from '../types/enum';
import type { IPivotTableFilterInfo, IPivotTableQueryData, IPivotTableShowDataAsInfo, IPivotTableSortInfo, IPivotTableValueFilter } from '../types/interface';
...
import { PivotCallbackEnum, PivotDataFieldDataTypeEnum, PivotLayoutTypeEnum, PivotSubtotalTypeEnum, PivotTableFiledAreaEnum } from '../types/enum';
...
export declare class PivotTable {
    ...
    private _summaryManagerCache?;
    private _summaryCacheState;
    ...
    setShowDataAs(fieldId: string, info: IPivotTableShowDataAsInfo): void;
    /**
     * - Rename the field.
     * @param {string} fieldId - The id of the field.
    ...
    /**
     * Set the runtime fallback locale for legacy sort metadata that does not persist a locale.
     * @param locale A BCP 47 locale tag.
     */
    setDefaultSortLocale(locale?: string): void;
    /**
     ...
     */
    setValueFilterInfo(fieldId: string, filterInfo: IPivotTableValueFilter | undefined, index?: number): void;
    /**
