...
export declare function createPivotSortCompare(sortLocale?: string, defaultSortLocale?: string): (a: string, b: string) => number;
/**
 ...
 */
export declare function sortLabelItem(items: string[], itemTypes: PivotDataFieldDataTypeEnum[], itemsMap: Record<string, number>, compare?: (a: string, b: string) => number): Record<string, number>;
