...
export interface ISmartArtTextFormatOverrides {
    fontColor?: boolean;
    fontFamily?: boolean;
...
export interface ISmartArtDataNode {
    ...
    /** Direct text formatting authored on this data point; absent properties remain controlled by the SmartArt layout. */
    formatOverrides?: ISmartArtTextFormatOverrides;
}
...
export interface ISmartArtPresentationShape {
    id: string;
    /** Semantic link to the DiagramML presentation point that produced this rendered shape. */
    presentationPointId?: string;
    name?: string;
    role: SmartArtPresentationShapeRoleEnum;
    dataNodeIds: string[];
    transform: ISmartArtTransform;
    /** Independent text bounds used by DiagramML Shapes whose text layout differs from their geometry. */
    textTransform?: ISmartArtTransform;
    /** Insets authored on the independent DiagramML text body before text-bound composition. */
    textBodyPadding?: IShapeTextRectPadding;
    /** Theme style references retained as namespace-neutral SmartArt instructions for native OOXML round trips. */
    styleReference?: ISmartArtDefinitionInstruction;
...
export interface ISmartArtTopologyPoint {
    ...
    /** Text carried by document or transition points that are not editable content nodes. */
    text?: IShapeTextData;
    formatOverrides?: ISmartArtTextFormatOverrides;
    /** Direct Shape formatting stored on the DiagramML data point. */
    shapeData?: IBasicShapeData;
}
...
export interface ISmartArtTopologyConnection {
    ...
    /** Additional namespace-neutral DiagramML relationship attributes. */
    properties?: Record<string, string>;
}
/**
...
export interface ISmartArtData {
    ...
    /** The logical node tree changed and the presentation Shapes must be recomputed. */
