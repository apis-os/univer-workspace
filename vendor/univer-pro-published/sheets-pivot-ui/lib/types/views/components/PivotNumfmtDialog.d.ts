...
export declare const PivotNumfmtDialog: ({ unitId, subUnitId, pivotTableId, tableFieldId, originPattern, tableFieldInfo, dataFieldInfo }: IPivotNumfmtPanelProps) => import("react").JSX.Element;
export {};
