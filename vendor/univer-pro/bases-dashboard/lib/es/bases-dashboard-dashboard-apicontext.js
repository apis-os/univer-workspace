...
let X = class {
  constructor(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46440, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46441, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46442, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46443) {
    this.resourceService = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46440, this.commandService = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46441, this.permissionService = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46442, this.instanceService = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46443;
  }
};
export { X as BaseDashboardAPIContextService };
