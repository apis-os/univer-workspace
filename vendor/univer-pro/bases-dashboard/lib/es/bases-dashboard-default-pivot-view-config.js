...
function it(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46660) {
  return {
    pivot: rt(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46660),
    chart: {
      type: ChartTypeBits.Column,
      orient: "column"
    },
