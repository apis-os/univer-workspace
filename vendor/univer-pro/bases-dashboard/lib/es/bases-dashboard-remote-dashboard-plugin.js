...
let var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46806 = class extends Plugin {
  constructor(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46464 = {}, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46465, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46466) {
    super(), this._injector = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46465, Z.forEach(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D4671 => {
      this.disposeWithMe(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46466.registerCommand(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D4671));
    });
  }
  onStarting() {
    this._injector["add"]([G]), touchDependencies(this._injector, [[G]]);
  }
};
