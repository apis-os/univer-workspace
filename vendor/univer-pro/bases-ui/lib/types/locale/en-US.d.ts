declare const locale: {
    'bases-ui': {
        ...
        collaboration: {
            ...
            notCollabStatus: string;
            notCollabTooltip: string;
        };
        virtualRecord: {
            regrouped: string;
            resorted: string;
        ...
        duplicateTable: {
            ...
            tableName: string;
            options: string;
            configurationsOnly: string;
            configurationsAndRecords: string;
            action: string;
            copyName: string;
        };
        tableNameValidation: {
        ...
        fieldConfig: {
            recordLinkTargetTable: string;
            recordLinkDisplayField: string;
            recordLinkPickerFields: string;
            recordLinkAllowMultiple: string;
            recordLinkDescription: string;
            fieldTitle: string;
        ...
        cellEditor: {
            ...
            deleteAttachmentsConfirmTitle: string;
            deleteAttachmentConfirmDescription: string;
        ...
        fieldMenu: {
            createSharedBaseField: string;
            closeAddFieldMenu: string;
