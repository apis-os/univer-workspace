...
function o(var_core_value_sig4767) {
...
function l(var_core_value_sigB489, var_core_value_sig76E7) {
  ...
  } : var_core_value_sig7E7F.some(var_core_value_sig3457 => !(0, e.isValidBaseRecordId)(var_core_value_sig3457)) || new Set(var_core_value_sig7E7F).size !== var_core_value_sig7E7F.length || c(var_core_value_sig7E7F) !== var_core_value_sigB489 ? {
    'valid': false,
...
;
function u(var_core_value_sig7947, var_core_value_sig7FEC) {
  if (var_core_value_sig7FEC.type !== e.BaseFieldType["RecordLink"]) return {
    'valid': true
  };
  let var_core_value_sig73D2 = o(var_core_value_sig7FEC),
  ...
  let var_core_value_sig3A25 = [...(var_core_value_sig73D2.displayFieldId ? [var_core_value_sig73D2.displayFieldId] : []), ...(var_core_value_sig73D2.pickerFieldIds ?? [])].find(var_core_value_sig4A08 => {
    ...
    return !var_core_value_sig1BC4 || var_core_value_sig1BC4.system === true || var_core_value_sig1BC4.type === e.BaseFieldType['RecordId'];
  });
...
;
function d(var_core_value_sigCBAA, var_core_value_sigC096, var_core_value_sig6140, var_core_value_sigDD84 = {}) {
  let var_core_value_sig7BA5 = o(var_core_value_sigC096);
  if (var_core_value_sigC096.type !== e.BaseFieldType["RecordLink"] || !var_core_value_sig7BA5) return {
    'valid': false,
    'reason': "[RecordLink]: field config is invalid."
  };
  let var_core_value_sig543F = l(var_core_value_sig6140, var_core_value_sig7BA5.multiple);
  ...
  let var_core_value_sigAA0E = s(var_core_value_sig6140).find(var_core_value_sig9EAB => !var_core_value_sigBF30.records[var_core_value_sig9EAB]);
  return var_core_value_sigAA0E ? {
    'valid': false,
    'reason': "[RecordLink]: target record \"" + var_core_value_sigAA0E + '\x22\x20does\x20not\x20exist.'
  } : {
    'valid': true
  };
}
;
function f(var_core_value_sig3747, var_core_value_sig9B6A) {
  return Object.values(var_core_value_sig3747.tables).flatMap(var_core_value_sigA5C3 => Object.values(var_core_value_sigA5C3.fields).flatMap(var_core_value_sig2D58 => {
    let var_core_value_sig223F = var_core_value_sig2D58.type === e.BaseFieldType["RecordLink"] ? o(var_core_value_sig2D58) : null;
...
let m = function (var_core_value_sig7BFA) {
...
let g = function (var_core_value_sig09FA) {
...
function _(var_core_value_sig6881, var_core_value_sigAB94) {
  if (!var_core_value_sigAB94) return false;
  let var_core_value_sigEE05 = var_core_value_sig6881.fields[var_core_value_sigAB94];
  if (!var_core_value_sigEE05 || var_core_value_sigEE05.type !== e.BaseFieldType["RecordLink"]) return false;
  let var_core_value_sig0F0E = o(var_core_value_sigEE05);
...
;
function v(var_core_value_sig3A40) {
  return [...var_core_value_sig3A40.fieldOrder, ...Object.keys(var_core_value_sig3A40.fields).filter(var_core_value_sig3515 => !var_core_value_sig3A40.fieldOrder["includes"](var_core_value_sig3515)).sort()].find(var_core_value_sigC2A0 => {
    ...
    return _(var_core_value_sig3A40, var_core_value_sigC2A0) ? ((var_core_value_sig7C65 = o(var_core_value_sig3A40.fields[var_core_value_sigC2A0])) == null ? undefined : var_core_value_sig7C65.relationRole) === e.BaseRecordLinkRole["Parent"] : false;
  }) ?? null;
}
;
function y(var_core_value_sig2377) {
  let var_core_value_sig4EEF = v(var_core_value_sig2377);
  if (var_core_value_sig4EEF) return var_core_value_sig4EEF;
  let var_core_value_sigC58E = p,
    var_core_value_sig9063 = 2;
  for (; var_core_value_sig2377.fields[var_core_value_sigC58E];) var_core_value_sigC58E = p + '_' + var_core_value_sig9063++;
  return var_core_value_sigC58E;
}
;
function b(var_core_value_sig99CE, var_core_value_sigFB15 = y(var_core_value_sig99CE), var_core_value_sig9AF5 = 'Parent\x20Items') {
  return {
...
;
function x(var_core_value_sigCD2E) {
  let var_core_value_sig60CE = v(var_core_value_sigCD2E);
  return var_core_value_sig60CE ? [var_core_value_sig60CE] : [];
}
;
function S(var_core_value_sigFA1B, var_core_value_sig5FEF) {
  let var_core_value_sigD48C = [...x(var_core_value_sigFA1B)].filter(var_core_value_sig7F05 => var_core_value_sig5FEF.some(var_core_value_sigD749 => Object.prototype["hasOwnProperty"].call(var_core_value_sigD749.values, var_core_value_sig7F05)));
  ...
  return var_core_value_sigD48C.forEach(var_core_value_sig6E78 => {
    let var_core_value_sigB3EE = E(var_core_value_sigFA1B, var_core_value_sig6E78),
      var_core_value_sigC50A = E(var_core_value_sig3807, var_core_value_sig6E78);
    for (let [var_core_value_sigCFFA, var_core_value_sig58C1] of var_core_value_sigC50A.invalidReasonByRecordId) {
      ...
      if (var_core_value_sigB3EE.invalidReasonByRecordId["get"](var_core_value_sigCFFA) !== var_core_value_sig58C1 || var_core_value_sig8178) throw new h(w(var_core_value_sig58C1));
    }
...
;
function C(var_core_value_sig680F, var_core_value_sig2E36) {
  ...
  let var_core_value_sigA847 = x(var_core_value_sig680F),
    var_core_value_sig1AB4 = var_core_value_sigA847.length ? null : y(var_core_value_sig680F),
  ...
  return var_core_value_sig7272.forEach(var_core_value_sigCC17 => {
    let var_core_value_sig32AE = E(var_core_value_sig885F, var_core_value_sigCC17);
    var_core_value_sig2E36.forEach(var_core_value_sig6418 => {
      ...
      if (var_core_value_sig1896) throw new h(w(var_core_value_sig1896));
...
;
function w(var_core_value_sig6934) {
...
;
function T(var_core_value_sig2842, var_core_value_sigA5A3) {
  let var_core_value_sig590F = new Set(var_core_value_sigA5A3),
    var_core_value_sigECA2 = x(var_core_value_sig2842);
  return Object.values(var_core_value_sig2842.records).flatMap(var_core_value_sigC753 => var_core_value_sig590F.has(var_core_value_sigC753.id) ? [] : Array.from(var_core_value_sigECA2).flatMap(var_core_value_sig777D => {
    let var_core_value_sig3F4C = s(var_core_value_sigC753.values[var_core_value_sig777D])[0] ?? null;
...
;
function E(var_core_value_sigCAC4, var_core_value_sig2017, var_core_value_sig49A4 = var_core_value_sigCAC4.recordOrder ?? Object.keys(var_core_value_sigCAC4.records)) {
  if (!(!var_core_value_sigCAC4.fields[var_core_value_sig2017] && var_core_value_sig2017 === y(var_core_value_sigCAC4)) && !_(var_core_value_sigCAC4, var_core_value_sig2017)) throw Error("[BaseHierarchy]: field \"" + var_core_value_sig2017 + '\x22\x20must\x20be\x20a\x20same-table,\x20single-value\x20RecordLink.');
  let var_core_value_sigA166 = ne(var_core_value_sigCAC4, var_core_value_sig49A4),
  ...
  for (let var_core_value_sigFFD1 of var_core_value_sigA166) {
    ...
    let var_core_value_sigD65A = s((var_core_value_sig7868 = var_core_value_sigCAC4.records[var_core_value_sigFFD1]) == null ? undefined : var_core_value_sig7868.values[var_core_value_sig2017])[0] ?? null;
    var_core_value_sigD65A ? var_core_value_sigD65A === var_core_value_sigFFD1 ? (var_core_value_sigEB84.set(var_core_value_sigFFD1, null), var_core_value_sig3B17.set(var_core_value_sigFFD1, e.BaseHierarchyInvalidReason['SelfParent'])) : var_core_value_sigCAC4.records[var_core_value_sigD65A] ? var_core_value_sigEB84.set(var_core_value_sigFFD1, var_core_value_sigD65A) : (var_core_value_sigEB84.set(var_core_value_sigFFD1, null), var_core_value_sig3B17.set(var_core_value_sigFFD1, e.BaseHierarchyInvalidReason["MissingParent"])) : var_core_value_sigEB84.set(var_core_value_sigFFD1, null);
  }
  re(var_core_value_sigEB84, var_core_value_sig3B17, var_core_value_sigA166), ie(var_core_value_sigEB84, var_core_value_sig3B17, var_core_value_sigA166);
...
;
function D(var_core_value_sig8407, var_core_value_sig635F, var_core_value_sig79E0 = new Set(var_core_value_sig635F.map(var_core_value_sig34C8 => var_core_value_sig34C8.recordId))) {
...
;
function ee(var_core_value_sig4B27, var_core_value_sig153F) {
...
;
function te(var_core_value_sig88EA, var_core_value_sig4E97, var_core_value_sigBE44) {
  if (!var_core_value_sigBE44) return {
    'valid': true
  };
  if (var_core_value_sig4E97 === var_core_value_sigBE44) return {
    'valid': false,
    'reason': e.BaseHierarchyInvalidReason["SelfParent"]
  };
  ...
  for (; var_core_value_sigE675;) {
    if (var_core_value_sigE675 === var_core_value_sig4E97) return {
      'valid': false,
      'reason': e.BaseHierarchyInvalidReason["Cycle"]
    };
  ...
  return (var_core_value_sig88EA.depthByRecordId["get"](var_core_value_sigBE44) ?? 0) + 1 + (var_core_value_sig88EA.subtreeHeightByRecordId["get"](var_core_value_sig4E97) ?? 0) >= 5 ? {
    'valid': false,
    'reason': e.BaseHierarchyInvalidReason["MaxDepth"]
  } : {
    'valid': true
  };
}
;
function ne(var_core_value_sig4346, var_core_value_sigB49C) {
...
;
function re(var_core_value_sig27CD, var_core_value_sig8977, var_core_value_sigE931) {
  ...
  for (let var_core_value_sigC7E7 of var_core_value_sigE931) {
    ...
    for (; var_core_value_sigA6F6 && !var_core_value_sig9F9C.has(var_core_value_sigA6F6);) {
      ...
      if (var_core_value_sigF704 != null) {
        ...
        var_core_value_sig27CD.set(var_core_value_sig8061, null), var_core_value_sig8977.set(var_core_value_sig8061, e.BaseHierarchyInvalidReason['Cycle']);
        break;
      }
...
function ie(var_core_value_sig0728, var_core_value_sigDC83, var_core_value_sig56A8) {
  let var_core_value_sigF487 = new Map(),
    var_core_value_sigC62E = var_core_value_sig6E1C => {
      ...
      return var_core_value_sig5BCE >= 5 ? (var_core_value_sig0728.set(var_core_value_sig6E1C, null), var_core_value_sigDC83.set(var_core_value_sig6E1C, e.BaseHierarchyInvalidReason["MaxDepth"]), var_core_value_sigF487.set(var_core_value_sig6E1C, 0), 0) : (var_core_value_sigF487.set(var_core_value_sig6E1C, var_core_value_sig5BCE), var_core_value_sig5BCE);
    };
...
;
function O(var_core_value_sigCD50, var_core_value_sig51C4, var_core_value_sigEECD) {
  if (!oe()) return var_core_value_sig51C4();
  let var_core_value_sigB655 = ce(),
    var_core_value_sigF30A = "base-perf-" + ae++;
  le(var_core_value_sigF30A + ':start');
  try {
    return var_core_value_sig51C4();
  } finally {
    let var_core_value_sigD57D = ce() - var_core_value_sigB655;
    le(var_core_value_sigF30A + ':end'), ue(var_core_value_sigCD50, var_core_value_sigF30A + ":start", var_core_value_sigF30A + ":end"), se(var_core_value_sigCD50, var_core_value_sigD57D, var_core_value_sigEECD);
  }
}
;
function se(var_core_value_sigD81A, var_core_value_sigBE17, var_core_value_sigBB5E) {
  if (!oe()) return;
  ...
  console.info("[BasePerf] " + var_core_value_sigD81A + ':\x20' + var_core_value_sigB440 + 'ms' + var_core_value_sig9D0F);
}
;
function ce() {
...
;
function le(var_core_value_sig0354) {
  try {
...
;
function ue(var_core_value_sigB5C8, var_core_value_sig8320, var_core_value_sig1C1B) {
  try {
    if (typeof performance < 'u') {
...
;
function k(var_core_value_sig50A1) {
  var var_core_value_sig71D2;
  return oe() ? O('IBaseCellData.ensureTableCellLayout', () => de(var_core_value_sig50A1), {
  ...
  }) : de(var_core_value_sig50A1);
}
;
function de(var_core_value_sigC113) {
  ...
  let var_core_value_sigAF55 = var_core_value_sigD610.length ? [...var_core_value_sig4358, ...Fe(var_core_value_sigD610)] : var_core_value_sig4358,
  ...
  return var_core_value_sigAF55.forEach((var_core_value_sig16C7, var_core_value_sig7481) => {
    ...
    var_core_value_sigB505 != null && (var_core_value_sigDBDA[var_core_value_sigB505] = {
      ...
      var_core_value_sigDE08 != null && (var_core_value_sigDBDA[var_core_value_sigB505][var_core_value_sigDE08] = ye(var_core_value_sigE243));
    }));
    ...
    var_core_value_sig1DCE != null && (var_core_value_sig7428.values = {
      ...
      [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sig7428.id
      ...
      (var_core_value_sig0C53 == null ? undefined : var_core_value_sig0C53.type) === e.BaseFieldType["Attachment"] && we(var_core_value_sigC113, var_core_value_sig7428.id, var_core_value_sigACCB, var_core_value_sig7F33);
      ...
      if (var_core_value_sig7A62 != null) {
        Oe(var_core_value_sig7A62, var_core_value_sig0C53, var_core_value_sig7F33) && (var_core_value_sigDBDA[var_core_value_sig1DCE][var_core_value_sigEA04] = ve(var_core_value_sig7F33, var_core_value_sig0C53));
        return;
      }
      var_core_value_sigDBDA[var_core_value_sig1DCE][var_core_value_sigEA04] = ve(var_core_value_sig7F33, var_core_value_sig0C53);
    }));
  }), var_core_value_sigC113;
}
;
function fe(var_core_value_sig1EFA) {
  return k(var_core_value_sig1EFA), Object.entries(var_core_value_sig1EFA.rowId ?? {}).forEach(([var_core_value_sig0567, var_core_value_sigA7F3]) => {
    ...
    var_core_value_sigF7BB && (var_core_value_sigF7BB.values = {
      ...
      var_core_value_sig3E71 === e.BASE_RECORD_ID_FIELD_ID ? var_core_value_sigF7BB.values[e.BASE_RECORD_ID_FIELD_ID] = var_core_value_sigF7BB.id : var_core_value_sig3E71 && (var_core_value_sigF7BB.values[var_core_value_sig3E71] = be(var_core_value_sig7565, var_core_value_sig1EFA.fields[var_core_value_sig3E71], var_core_value_sig1EFA, var_core_value_sigA7F3));
    }));
  }), var_core_value_sig1EFA;
}
;
function pe(var_core_value_sig7CF4, var_core_value_sigE956) {
  for (let {
    ...
    if (var_core_value_sig7442 === e.BASE_RECORD_ID_FIELD_ID) {
      var_core_value_sigDF87.values[e.BASE_RECORD_ID_FIELD_ID] = var_core_value_sigDF87.id;
      continue;
    }
    ...
    }, var_core_value_sigDF87.values[var_core_value_sig7442] = be(var_core_value_sig9EE0, var_core_value_sig7CF4.fields[var_core_value_sig7442], var_core_value_sig7CF4, var_core_value_sig01B3));
  }
  return var_core_value_sig7CF4;
}
;
function me(var_core_value_sig9A60, var_core_value_sig5EF5, var_core_value_sig5324) {
  ...
  let var_core_value_sigEC12 = k(var_core_value_sig9A60),
...
;
function he(var_core_value_sig1529, var_core_value_sigAFD8, var_core_value_sig6017) {
  var var_core_value_sigC66C;
  let var_core_value_sigC5AC = me(var_core_value_sig1529, var_core_value_sigAFD8, var_core_value_sig6017);
...
;
function ge(var_core_value_sig5880, var_core_value_sigF7E2, var_core_value_sigDEEA) {
  var var_core_value_sig49D1;
  let var_core_value_sigEDEC = he(var_core_value_sig5880, var_core_value_sigF7E2, var_core_value_sigDEEA),
    var_core_value_sig4F7B = var_core_value_sig5880.fields[var_core_value_sigDEEA];
  if ((var_core_value_sig4F7B == null ? undefined : var_core_value_sig4F7B.type) === e.BaseFieldType["Attachment"]) {
    var var_core_value_sig8269;
    return Te(var_core_value_sig5880, var_core_value_sigF7E2, var_core_value_sigDEEA) ?? Ee((var_core_value_sig8269 = var_core_value_sig5880.records[var_core_value_sigF7E2]) == null || (var_core_value_sig8269 = var_core_value_sig8269.values) == null ? undefined : var_core_value_sig8269[var_core_value_sigDEEA]);
  }
  if (ke(var_core_value_sig4F7B) || Ae(var_core_value_sig4F7B) || (var_core_value_sig4F7B == null ? undefined : var_core_value_sig4F7B.type) === e.BaseFieldType['Link']) {
    ...
    return var_core_value_sigA7DB != null && var_core_value_sigA7DB !== '' ? De(var_core_value_sigA7DB, var_core_value_sig4F7B) : be(var_core_value_sigEDEC, var_core_value_sig4F7B, var_core_value_sig5880, var_core_value_sigF7E2);
  }
...
;
function _e(var_core_value_sigC04F, var_core_value_sig8B16, var_core_value_sig9640) {
  var var_core_value_sig34AB;
  let var_core_value_sig0BE5 = he(var_core_value_sigC04F, var_core_value_sig8B16, var_core_value_sig9640);
  ...
  return ve(((var_core_value_sig34AB = var_core_value_sigC04F.records[var_core_value_sig8B16]) == null || (var_core_value_sig34AB = var_core_value_sig34AB.values) == null ? undefined : var_core_value_sig34AB[var_core_value_sig9640]) ?? null, var_core_value_sig2F9D).v ?? null;
}
;
function ve(var_core_value_sig9511, var_core_value_sigAFDD) {
  if (Se(var_core_value_sig9511)) return (var_core_value_sigAFDD == null ? undefined : var_core_value_sigAFDD.type) === e.BaseFieldType["Attachment"] ? {
    ...var_core_value_sig9511,
    'v': '',
    't': e.CellValueType["STRING"]
  } : ye(var_core_value_sig9511);
  if ((var_core_value_sigAFDD == null ? undefined : var_core_value_sigAFDD.type) === e.BaseFieldType["Attachment"]) return {
    'v': '',
    't': e.CellValueType["STRING"]
  };
  if (Ae(var_core_value_sigAFDD)) {
    let var_core_value_sig5EEE = je(var_core_value_sig9511);
    return {
      'v': var_core_value_sig5EEE,
      't': Pe(var_core_value_sig5EEE)
    };
  }
  if (ke(var_core_value_sigAFDD)) return {
    'v': Me(var_core_value_sig9511).join(',\x20'),
    't': e.CellValueType["STRING"]
  };
  if ((var_core_value_sigAFDD == null ? undefined : var_core_value_sigAFDD.type) === e.BaseFieldType['Link'] && var_core_value_sig9511 && typeof var_core_value_sig9511 == 'object' && !Array.isArray(var_core_value_sig9511)) {
...
;
function ye(var_core_value_sig431B) {
  let var_core_value_sig3073 = Ie(var_core_value_sig431B.t, var_core_value_sig431B.v);
...
;
function be(var_core_value_sig4C99, var_core_value_sigDDD2, var_core_value_sig6D5F, var_core_value_sigB80D) {
  if (!var_core_value_sig4C99) return null;
  if ((var_core_value_sigDDD2 == null ? undefined : var_core_value_sigDDD2.type) === e.BaseFieldType["Attachment"]) return var_core_value_sig6D5F && var_core_value_sigB80D ? Te(var_core_value_sig6D5F, var_core_value_sigB80D, var_core_value_sigDDD2.id) ?? [] : [];
  if (ke(var_core_value_sigDDD2)) return Me(var_core_value_sig4C99.v);
  if ((var_core_value_sigDDD2 == null ? undefined : var_core_value_sigDDD2.type) === e.BaseFieldType['Link'] && var_core_value_sig6D5F && var_core_value_sigB80D) {
...
;
function xe(var_core_value_sig8F71, var_core_value_sig9016, var_core_value_sigB043, var_core_value_sig554B, var_core_value_sig33F0) {
  return (var_core_value_sigB043 == null ? undefined : var_core_value_sigB043.type) === e.BaseFieldType["Attachment"] ? Ee(var_core_value_sig8F71) : Ae(var_core_value_sigB043) ? je(var_core_value_sig8F71) : ke(var_core_value_sigB043) ? Me(var_core_value_sig8F71) : (var_core_value_sigB043 == null ? undefined : var_core_value_sigB043.type) === e.BaseFieldType["Link"] && (var_core_value_sig8F71 == null || var_core_value_sig8F71 === '') ? null : (var_core_value_sigB043 == null ? undefined : var_core_value_sigB043.type) === e.BaseFieldType['Link'] && var_core_value_sig8F71 && typeof var_core_value_sig8F71 == "object" && !Array.isArray(var_core_value_sig8F71) && !Se(var_core_value_sig8F71) ? var_core_value_sig8F71 : be(var_core_value_sig9016, var_core_value_sigB043, var_core_value_sig554B, var_core_value_sig33F0);
}
;
function Se(var_core_value_sigC9BF) {
...
;
function Ce(var_core_value_sigE1AD, var_core_value_sig90FF) {
  return var_core_value_sigE1AD + '\x1f' + var_core_value_sig90FF;
}
;
function we(var_core_value_sigA7F6, var_core_value_sig5A0F, var_core_value_sigCDF5, var_core_value_sig3802) {
  let var_core_value_sigB642 = Ee(var_core_value_sig3802);
  ...
  let var_core_value_sig9026 = Ce(var_core_value_sigCDF5, var_core_value_sig5A0F),
...
;
function Te(var_core_value_sig048B, var_core_value_sig1334, var_core_value_sig2605) {
  var var_core_value_sig5F20;
  let var_core_value_sig019C = Ce(var_core_value_sig2605, var_core_value_sig1334),
...
;
function Ee(var_core_value_sigCD501) {
  if (var_core_value_sigCD501 == null || var_core_value_sigCD501 === '' || Se(var_core_value_sigCD501) && !('id' in var_core_value_sigCD501) && !('name' in var_core_value_sigCD501)) return [];
...
;
function De(var_core_value_sigF543, var_core_value_sig0806) {
  return (var_core_value_sig0806 == null ? undefined : var_core_value_sig0806.type) === e.BaseFieldType["Attachment"] ? Ee(var_core_value_sigF543) : Ae(var_core_value_sig0806) ? je(var_core_value_sigF543) : ke(var_core_value_sig0806) ? Me(var_core_value_sigF543) : var_core_value_sigF543;
}
;
function Oe(var_core_value_sigE224, var_core_value_sig773E, var_core_value_sig83A7) {
  return (var_core_value_sig773E == null ? undefined : var_core_value_sig773E.type) === e.BaseFieldType['Attachment'] ? var_core_value_sigE224.v !== '' : Ae(var_core_value_sig773E) ? var_core_value_sigE224.v !== je(var_core_value_sig83A7) : ke(var_core_value_sig773E) ? Array.isArray(var_core_value_sig83A7) && (var_core_value_sigE224.v == null || var_core_value_sigE224.v === '') : false;
}
;
function ke(var_core_value_sigFE18) {
  return (var_core_value_sigFE18 == null ? undefined : var_core_value_sigFE18.type) === e.BaseFieldType["MultiSelect"] || (var_core_value_sigFE18 == null ? undefined : var_core_value_sigFE18.type) === e.BaseFieldType['Group'] || (var_core_value_sigFE18 == null ? undefined : var_core_value_sigFE18.type) === e.BaseFieldType["Person"] && var_core_value_sigFE18.config["allowMultiple"] === true;
}
;
function Ae(var_core_value_sig816B) {
  return (var_core_value_sig816B == null ? undefined : var_core_value_sig816B.type) === e.BaseFieldType["Person"] && var_core_value_sig816B.config['allowMultiple'] !== true;
}
;
function je(var_core_value_sigA89B) {
  let var_core_value_sig5020 = Se(var_core_value_sigA89B) ? var_core_value_sigA89B.v : var_core_value_sigA89B,
...
;
function Me(var_core_value_sig3D4B) {
  ...
  if (Array.isArray(var_core_value_sig3D4B)) {
    for (let var_core_value_sigE799 = 0; var_core_value_sigE799 < var_core_value_sig3D4B.length; var_core_value_sigE799++) {
      ...
      let var_core_value_sigB577 = Ne(var_core_value_sig3D4B[var_core_value_sigE799]);
...
;
function Ne(var_core_value_sig9F28) {
...
;
function Pe(var_core_value_sig8A50) {
  return var_core_value_sig8A50 == null ? null : typeof var_core_value_sig8A50 == 'number' ? e.CellValueType["NUMBER"] : typeof var_core_value_sig8A50 == "boolean" ? e.CellValueType["BOOLEAN"] : e.CellValueType["STRING"];
}
;
function Fe(var_core_value_sig8AF9) {
...
;
function Ie(var_core_value_sig020B, var_core_value_sig091A) {
  return var_core_value_sig020B === e.CellValueType["STRING"] || var_core_value_sig020B === e.CellValueType["NUMBER"] || var_core_value_sig020B === e.CellValueType['BOOLEAN'] || var_core_value_sig020B === e.CellValueType["FORCE_STRING"] || var_core_value_sig020B == null ? var_core_value_sig020B : Pe(var_core_value_sig091A ?? null);
}
;
function A(var_core_value_sigC45A) {
  let var_core_value_sig8A05 = null;
  for (let var_core_value_sigFBF0 of var_core_value_sigC45A) var_core_value_sig8A05 = var_core_value_sig8A05 === null ? var_core_value_sigFBF0 : e.JSON1["type"].compose(var_core_value_sig8A05, var_core_value_sigFBF0);
...
var j = class t {
  static tryMaterializeSnapshot(var_core_value_sig2F95, var_core_value_sigF0E1) {
    ...
    for (let var_core_value_sig8B71 of var_core_value_sigF0E1) {
      let var_core_value_sig9572 = Le(var_core_value_sig8B71);
    ...
    try {
      let var_core_value_sigAEFB = A(var_core_value_sig2D8D);
      return var_core_value_sigAEFB === null ? var_core_value_sig2F95 : new t().applyOp(var_core_value_sig2F95, var_core_value_sigAEFB);
    } catch {
      return null;
    }
  }
  applyOp(var_core_value_sigE5A6, var_core_value_sigF449) {
    let var_core_value_sig38C5 = this.getAffectedRanges(var_core_value_sigF449),
      var_core_value_sigC87D = O("BaseJson1.cloneForOp", () => qe(var_core_value_sigE5A6, var_core_value_sigF449), {
        'invalidations': var_core_value_sig38C5.length
      }),
      var_core_value_sigCCDC = O("BaseJson1.json1Apply", () => e.JSON1["type"].apply(var_core_value_sigC87D, var_core_value_sigF449), {
        'invalidations': var_core_value_sig38C5.length
      }),
      var_core_value_sigC310 = ze(var_core_value_sigCCDC, var_core_value_sig38C5);
    return O("BaseJson1.syncCellInvalidations", () => Re(var_core_value_sigCCDC, var_core_value_sig38C5), {
      'invalidations': var_core_value_sig38C5.length
    }) ? (Be(var_core_value_sigCCDC, var_core_value_sigC310), var_core_value_sigCCDC) : (O("BaseJson1.normalizeTables", () => {
      this._getTablesToNormalize(var_core_value_sigCCDC, var_core_value_sig38C5).forEach(var_core_value_sigD873 => {
        fe(var_core_value_sigD873);
      });
    }, {
      'invalidations': var_core_value_sig38C5.length
    }), Be(var_core_value_sigCCDC, var_core_value_sigC310), var_core_value_sigCCDC);
  }
  invertOp(var_core_value_sigA4E8, var_core_value_sigDC07) {
    return e.JSON1["type"].invertWithDoc(var_core_value_sigDC07, var_core_value_sigA4E8);
  }
  getAffectedRanges(var_core_value_sig3474) {
    let var_core_value_sig4E80 = We(var_core_value_sig3474);
    return var_core_value_sig4E80.length ? Ge(var_core_value_sig4E80.flatMap(var_core_value_sig826B => this.getAffectedRanges(var_core_value_sig826B))) : Ve(var_core_value_sig3474);
  }
...
function Le(var_core_value_sig431F) {
...
;
function Re(var_core_value_sig222E, var_core_value_sig3A07) {
  ...
  return var_core_value_sigE7EB.forEach((var_core_value_sig78E6, var_core_value_sig541F) => {
    ...
    var_core_value_sigAA90 && pe(var_core_value_sigAA90, var_core_value_sig78E6);
  }), true;
}
;
function ze(var_core_value_sig6125, var_core_value_sig5781) {
...
;
function Be(var_core_value_sig7A4A, var_core_value_sigB7E2) {
...
;
function Ve(var_core_value_sigD477) {
  ...
  return var_core_value_sigEB82 === -1 || typeof var_core_value_sig6149[var_core_value_sigEB82 + 1] != "string" ? var_core_value_sig6149[0] === "tableOrder" ? [] : [{
    'tableId': '',
    'reason': "unknown"
  }] : He(var_core_value_sig6149, var_core_value_sigEB82, String(var_core_value_sig6149[var_core_value_sigEB82 + 1]));
}
;
function He(var_core_value_sig843F, var_core_value_sig9FB7, var_core_value_sigB7A4) {
  let var_core_value_sig295F = var_core_value_sig843F[var_core_value_sig9FB7 + 2];
  return var_core_value_sig295F === "records" && typeof var_core_value_sig843F[var_core_value_sig9FB7 + 3] == "string" ? Ue(var_core_value_sig843F, var_core_value_sig9FB7, var_core_value_sigB7A4, String(var_core_value_sig843F[var_core_value_sig9FB7 + 3])) : var_core_value_sig295F === "cellData" && var_core_value_sig843F[var_core_value_sig9FB7 + 3] != null && var_core_value_sig843F[var_core_value_sig9FB7 + 4] != null ? [{
...
;
function Ue(var_core_value_sigE36B, var_core_value_sigDA3B, var_core_value_sig9E32, var_core_value_sig26EC) {
...
;
function We(var_core_value_sigF226) {
...
;
function Ge(var_core_value_sig7E16) {
...
;
function Ke(var_core_value_sig3C23) {
  return e.Tools["deepClone"](var_core_value_sig3C23);
}
;
function qe(var_core_value_sigDAE6, var_core_value_sigDD81) {
  let var_core_value_sig3870 = Je(var_core_value_sigDD81);
  if (!var_core_value_sig3870.length) return Ke(var_core_value_sigDAE6);
  let var_core_value_sig13D1 = tt(var_core_value_sigDAE6),
    var_core_value_sigECFC = new Set();
  for (let var_core_value_sigA345 of var_core_value_sig3870) Ze(var_core_value_sig13D1, var_core_value_sigA345, var_core_value_sigECFC);
  return var_core_value_sig13D1;
}
;
function Je(var_core_value_sig5E62) {
  let var_core_value_sig3B89 = [];
  return Ye(var_core_value_sig5E62, [], var_core_value_sig3B89), var_core_value_sig3B89;
}
;
function Ye(var_core_value_sig4B55, var_core_value_sig9E69, var_core_value_sig432A) {
  ...
  for (let var_core_value_sigA468 of var_core_value_sig4B55) {
    if (Array.isArray(var_core_value_sigA468)) {
      Ye(var_core_value_sigA468, [...var_core_value_sig9E69, ...var_core_value_sig3B51], var_core_value_sig432A);
      continue;
    }
    if (Xe(var_core_value_sigA468)) {
...
;
function Xe(var_core_value_sig542D) {
...
;
function Ze(var_core_value_sig8AAB, var_core_value_sigE82A, var_core_value_sigB2CF) {
  ...
  for (let var_core_value_sig1561 = 0; var_core_value_sig1561 < var_core_value_sigE82A.length - 1; var_core_value_sig1561++) {
    ...
    let var_core_value_sig237B = Qe(var_core_value_sig5955, var_core_value_sigCFAC);
    if (!et(var_core_value_sig237B)) return;
    let var_core_value_sigFEAB = JSON.stringify(var_core_value_sigF829);
    var_core_value_sigB2CF.has(var_core_value_sigFEAB) || ($e(var_core_value_sig5955, var_core_value_sigCFAC, tt(var_core_value_sig237B)), var_core_value_sigB2CF.add(var_core_value_sigFEAB));
    let var_core_value_sigE347 = Qe(var_core_value_sig5955, var_core_value_sigCFAC);
    if (!et(var_core_value_sigE347)) return;
    var_core_value_sig5955 = var_core_value_sigE347;
  }
}
;
function Qe(var_core_value_sig2900, var_core_value_sig51D8) {
...
;
function $e(var_core_value_sig8693, var_core_value_sigAACD, var_core_value_sig895A) {
...
;
function et(var_core_value_sigA764) {
  return !!var_core_value_sigA764 && typeof var_core_value_sigA764 == "object";
}
;
function tt(var_core_value_sigC3D9) {
...
function M(var_core_value_sigA6C0, var_core_value_sigFF70 = e.DateSystem["Date1900"]) {
  let var_core_value_sigB469 = (0, e.dateKit)(var_core_value_sigA6C0).valueOf();
  return (0, e.excelDateTimeSerial)(new Date(var_core_value_sigB469), var_core_value_sigFF70);
}
;
function at(var_core_value_sig0276, var_core_value_sigFA20 = e.DateSystem["Date1900"]) {
  return (0, e.excelSerialToDateTime)(var_core_value_sig0276, var_core_value_sigFA20).getTime();
}
;
function ot(var_core_value_sig2752, var_core_value_sig0E1A = e.DateSystem["Date1900"]) {
  if (var_core_value_sig2752 == null || var_core_value_sig2752 === '') return null;
  if (var_core_value_sig2752 instanceof Date) return M(var_core_value_sig2752, var_core_value_sig0E1A);
  if (typeof var_core_value_sig2752 == "number") return Number.isFinite(var_core_value_sig2752) ? var_core_value_sig2752 > 1000000 ? M(var_core_value_sig2752, var_core_value_sig0E1A) : var_core_value_sig2752 : null;
  let var_core_value_sig6A48 = Date.parse(String(var_core_value_sig2752));
  return Number.isNaN(var_core_value_sig6A48) ? null : M(var_core_value_sig6A48, var_core_value_sig0E1A);
}
;
function st(var_core_value_sig2D2A, var_core_value_sig1D22 = e.DateSystem["Date1900"]) {
  let var_core_value_sig91FE = ot(var_core_value_sig2D2A, var_core_value_sig1D22);
  return var_core_value_sig91FE == null ? null : at(var_core_value_sig91FE, var_core_value_sig1D22);
}
;
function ct(var_core_value_sig528C = {}) {
  let var_core_value_sig749D = String(var_core_value_sig528C.pattern ?? var_core_value_sig528C.format ?? var_core_value_sig528C.dateFormat ?? nt).trim() || nt,
    var_core_value_sig1FB8 = rt.test(var_core_value_sig749D);
  return {
    'pattern': var_core_value_sig749D.replace(rt, '') || nt,
...
;
function lt(var_core_value_sig032D = {}) {
  let {
  ...
  return {
    ...var_core_value_sig6434,
    ...ct(var_core_value_sig032D)
  };
}
;
function ut(var_core_value_sig398A, var_core_value_sig1760 = {}) {
  let var_core_value_sig7C7A = st(var_core_value_sig398A);
  if (var_core_value_sig7C7A == null || !Number.isFinite(var_core_value_sig7C7A)) return '';
  let var_core_value_sig78E8 = ct(var_core_value_sig1760);
  return (0, e.dateKit)(var_core_value_sig7C7A).format(dt(var_core_value_sig78E8));
}
;
function dt(var_core_value_sigF002) {
  let {
      pattern: var_core_value_sig715D,
      includeTime: var_core_value_sigEB90,
      hourCycle: var_core_value_sig9506
    } = var_core_value_sigF002,
    var_core_value_sigC460 = it[var_core_value_sig715D] ?? it[nt];
...
const ft = {
  ...
  N = 1440 * 60 * 1000;
function mt(var_core_value_sig00D0) {
  switch (var_core_value_sig00D0) {
    ...
    case e.BaseFieldType['Rating']:
      return [e.BaseConditionalColorOperator['IS'], e.BaseConditionalColorOperator["IS_NOT"], e.BaseConditionalColorOperator["GREATER_THAN"], e.BaseConditionalColorOperator["LESS_THAN"], e.BaseConditionalColorOperator["IS_EMPTY"], e.BaseConditionalColorOperator["IS_NOT_EMPTY"]];
    case e.BaseFieldType["Date"]:
    case e.BaseFieldType['CreatedAt']:
    case e.BaseFieldType["UpdatedAt"]:
      return [e.BaseConditionalColorOperator['IS'], e.BaseConditionalColorOperator["IS_NOT"], e.BaseConditionalColorOperator["BEFORE"], e.BaseConditionalColorOperator["AFTER"], e.BaseConditionalColorOperator["IS_EMPTY"], e.BaseConditionalColorOperator['IS_NOT_EMPTY']];
    case e.BaseFieldType['Checkbox']:
      return [e.BaseConditionalColorOperator['IS'], e.BaseConditionalColorOperator["IS_NOT"]];
    default:
      return [e.BaseConditionalColorOperator['IS'], e.BaseConditionalColorOperator["IS_NOT"], e.BaseConditionalColorOperator['CONTAINS'], e.BaseConditionalColorOperator["NOT_CONTAINS"], e.BaseConditionalColorOperator["IS_EMPTY"], e.BaseConditionalColorOperator["IS_NOT_EMPTY"]];
  }
}
;
function ht(var_core_value_sig2880) {
  return var_core_value_sig2880 === e.BaseFieldType['Date'] || var_core_value_sig2880 === e.BaseFieldType["CreatedAt"] || var_core_value_sig2880 === e.BaseFieldType["UpdatedAt"];
}
;
function gt(var_core_value_sig76AC, var_core_value_sigEA39) {
...
;
function _t(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325, var_core_value_sigAB8D, var_core_value_sig4B86 = {}) {
  if (var_core_value_sig87EA === "isEmpty") return vt(var_core_value_sig252C);
  if (var_core_value_sig87EA === "isNotEmpty") return !vt(var_core_value_sig252C);
  switch (var_core_value_sigAB8D.type) {
    case e.BaseFieldType["Number"]:
    case e.BaseFieldType["Currency"]:
    case e.BaseFieldType["Progress"]:
    case e.BaseFieldType["Rating"]:
      return yt(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325);
    case e.BaseFieldType["Date"]:
    case e.BaseFieldType["CreatedAt"]:
    case e.BaseFieldType["UpdatedAt"]:
      return xt(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325, var_core_value_sig4B86);
    case e.BaseFieldType["Checkbox"]:
      return Dt(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325);
    case e.BaseFieldType['SingleSelect']:
    case e.BaseFieldType['MultiSelect']:
    case e.BaseFieldType["Person"]:
    case e.BaseFieldType["Group"]:
      return kt(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325, var_core_value_sigAB8D);
    default:
      return At(var_core_value_sig252C, var_core_value_sig87EA, var_core_value_sig4325);
  }
}
;
function vt(var_core_value_sig240E) {
...
;
function yt(var_core_value_sigDE46, var_core_value_sigF30E, var_core_value_sigA6B6) {
  let var_core_value_sig1FDB = bt(var_core_value_sigDE46),
    var_core_value_sig6B7D = bt(var_core_value_sigA6B6);
...
;
function bt(var_core_value_sig0D1B) {
...
;
function xt(var_core_value_sig0C3A, var_core_value_sig5A20, var_core_value_sig4037, var_core_value_sig5F5F) {
  let var_core_value_sig801E = Ct(var_core_value_sig0C3A);
  if (var_core_value_sig801E == null) return false;
  let var_core_value_sigD8A7 = St(var_core_value_sig5F5F.dateMode ?? "exact", var_core_value_sig4037, var_core_value_sig5F5F.now);
...
;
function St(var_core_value_sig7D2D, var_core_value_sig5BC4, var_core_value_sigE445 = Date.now()) {
  let var_core_value_sig5C54 = wt(var_core_value_sigE445);
  switch (var_core_value_sig7D2D) {
    case "exact":
      {
        let var_core_value_sig3C5B = Ct(var_core_value_sig5BC4);
        return var_core_value_sig3C5B == null ? null : {
          'start': var_core_value_sig3C5B,
          'end': var_core_value_sig3C5B + N - 1
        };
      }
    case "today":
      return {
        'start': var_core_value_sig5C54,
        'end': var_core_value_sig5C54 + N - 1
      };
    case 'tomorrow':
      return {
        'start': var_core_value_sig5C54 + N,
        'end': var_core_value_sig5C54 + N * 2 - 1
      };
    case "yesterday":
      return {
        'start': var_core_value_sig5C54 - N,
    ...
    case "thisWeek":
      return Tt(var_core_value_sig5C54, 0);
    case "lastWeek":
      return Tt(var_core_value_sig5C54, -1);
    case "thisMonth":
      return Et(var_core_value_sig5C54, 0);
    case "lastMonth":
      return Et(var_core_value_sig5C54, -1);
    case "past7":
      return {
        'start': var_core_value_sig5C54 - N * 6,
        'end': var_core_value_sig5C54 + N - 1
      };
    case "next7":
      return {
        'start': var_core_value_sig5C54,
        'end': var_core_value_sig5C54 + N * 7 - 1
      };
    case "past30":
      return {
        'start': var_core_value_sig5C54 - N * 29,
        'end': var_core_value_sig5C54 + N - 1
      };
    case "next30":
      return {
        'start': var_core_value_sig5C54,
        'end': var_core_value_sig5C54 + N * 30 - 1
      };
  }
}
;
function Ct(var_core_value_sigD167) {
  let var_core_value_sig2DA0 = ot(var_core_value_sigD167);
  return var_core_value_sig2DA0 == null ? null : wt(at(var_core_value_sig2DA0));
}
;
function wt(var_core_value_sig51DC) {
...
;
function Tt(var_core_value_sig80BD, var_core_value_sigF6A6) {
  let var_core_value_sigE59D = var_core_value_sig80BD - (new Date(var_core_value_sig80BD).getDay() + 6) % 7 * N + var_core_value_sigF6A6 * N * 7;
  return {
    'start': var_core_value_sigE59D,
    'end': var_core_value_sigE59D + N * 7 - 1
  };
}
;
function Et(var_core_value_sig3D65, var_core_value_sig4D17) {
...
;
function Dt(var_core_value_sig975D, var_core_value_sig3C3D, var_core_value_sigD33D) {
  let var_core_value_sig71B9 = Ot(var_core_value_sig975D),
    var_core_value_sig248C = Ot(var_core_value_sigD33D);
...
;
function Ot(var_core_value_sig8DE6) {
  return var_core_value_sig8DE6 === true || var_core_value_sig8DE6 === "true" || var_core_value_sig8DE6 === 1 || var_core_value_sig8DE6 === '1';
}
;
function kt(var_core_value_sig55C6, var_core_value_sig2C60, var_core_value_sig2914, var_core_value_sig7FD9) {
  let var_core_value_sig7A3D = Mt(var_core_value_sig55C6, var_core_value_sig7FD9),
    var_core_value_sig7325 = Mt(var_core_value_sig2914, var_core_value_sig7FD9),
...
;
function At(var_core_value_sigB11B, var_core_value_sig826D, var_core_value_sig949F) {
  let var_core_value_sig77E0 = jt(var_core_value_sigB11B),
    var_core_value_sigD177 = jt(var_core_value_sig949F);
...
;
function jt(var_core_value_sig26E6) {
  if (Array.isArray(var_core_value_sig26E6)) return var_core_value_sig26E6.map(var_core_value_sig842F => jt(var_core_value_sig842F)).join('\x0a');
...
;
function Mt(var_core_value_sig43D5, var_core_value_sig132C) {
  let var_core_value_sig469E = Nt(var_core_value_sig43D5),
    var_core_value_sig3C91 = Pt(var_core_value_sig132C.config ?? {});
...
;
function Nt(var_core_value_sig5A6B) {
  if (var_core_value_sig5A6B == null || var_core_value_sig5A6B === '') return [];
  if (Array.isArray(var_core_value_sig5A6B)) return var_core_value_sig5A6B.flatMap(var_core_value_sigBBBC => Nt(var_core_value_sigBBBC));
  if (var_core_value_sig5A6B && typeof var_core_value_sig5A6B == "object") {
    let var_core_value_sig5440 = var_core_value_sig5A6B;
    return ['id', "name", "label", "value", "text"].flatMap(var_core_value_sig200B => Nt(var_core_value_sig5440[var_core_value_sig200B])).filter((var_core_value_sig3863, var_core_value_sigC97C, var_core_value_sigC4B1) => var_core_value_sigC4B1.indexOf(var_core_value_sig3863) === var_core_value_sigC97C);
  }
  return [jt(var_core_value_sig5A6B)];
}
;
function Pt(var_core_value_sigD8F0) {
  ...
  return (Array.isArray(var_core_value_sigD8F0.options) ? var_core_value_sigD8F0.options : []).forEach(var_core_value_sigE28B => {
    ...
    let var_core_value_sig0FD9 = Nt(var_core_value_sigE28B),
...
;
function P(var_core_value_sigB1E6, var_core_value_sig02FE = {}, var_core_value_sigD80D = var_core_value_sigCAD5 => var_core_value_sigCAD5, var_core_value_sig572B = {}) {
  let var_core_value_sigB8EA = !pt.has(var_core_value_sigB1E6),
  ...
  return {
    ...
    'compare': (var_core_value_sig44F9, var_core_value_sigE532) => gt(var_core_value_sig44F9, var_core_value_sigE532),
    'filter': (var_core_value_sigF381, var_core_value_sigCB92, var_core_value_sigC844, var_core_value_sig2ED4) => _t(var_core_value_sigF381, var_core_value_sigCB92, var_core_value_sigC844, var_core_value_sig2ED4),
    ...
    'getCapabilities': () => ({
      ...
      'editable': var_core_value_sigB8EA && (var_core_value_sig02FE.editable ?? ft.editable)
    })
  };
}
;
function Ft() {
  return [P(e.BaseFieldType["Text"], {
    'groupable': true,
    'usableAsTitle': true
  }, undefined, {
    'createDefaultConfig': () => ({
  ...
  }), P(e.BaseFieldType["SingleSelect"], {
    'groupable': true,
    ...
    'validate': Ht
  }), P(e.BaseFieldType["Date"], {
    'groupable': true,
    'usableAsCalendarDate': true,
    'usableAsGanttStart': true,
    'usableAsGanttEnd': true
  }, var_core_value_sig5E11 => ot(var_core_value_sig5E11), {
    'createDefaultConfig': () => Lt(),
    'validate': Ut
  }), P(e.BaseFieldType["Attachment"], {
  ...
  }), P(e.BaseFieldType["Number"], {}, var_core_value_sig424E => var_core_value_sig424E == null || var_core_value_sig424E === '' ? null : Number(var_core_value_sig424E), {
    'createDefaultConfig': () => It(),
    'validate': Wt
  }), P(e.BaseFieldType["Checkbox"], {
    'groupable': true,
    'usableAsKanbanGroup': true
  ...
  }), P(e.BaseFieldType["Link"], {
    'supportsRelation': true
  }, Kt, {
    'createDefaultConfig': () => ({
      'placeholder': "bases.fieldConfig.linkPlaceholder"
    }),
    'toPlainText': var_core_value_sig9DC6 => qt(var_core_value_sig9DC6),
    'fromPlainText': var_core_value_sig6643 => Kt(var_core_value_sig6643)
  }), P(e.BaseFieldType['Formula'], {
    'editable': false
  }, undefined, {
    'createDefaultConfig': () => ({
      'formula': '',
  ...
  }), P(e.BaseFieldType['Email'], {
    'usableAsTitle': true
  }, var_core_value_sigEEEF => var_core_value_sigEEEF == null ? null : String(var_core_value_sigEEEF).trim(), {
    'validate': var_core_value_sig9A01 => var_core_value_sig9A01 == null || var_core_value_sig9A01 === '' || Yt(String(var_core_value_sig9A01)) ? {
      'valid': true
    } : {
      'valid': false,
      'reason': "[BaseField]: invalid email value."
    }
  }), P(e.BaseFieldType["Progress"], {
    ...
    'validate': (var_core_value_sigC8F6, var_core_value_sig8A26) => Gt(var_core_value_sigC8F6, var_core_value_sig8A26, '[BaseField]:\x20invalid\x20progress\x20value.')
  }), P(e.BaseFieldType["Currency"], {}, var_core_value_sigD073 => var_core_value_sigD073 == null || var_core_value_sigD073 === '' ? null : Number(var_core_value_sigD073), {
    'createDefaultConfig': () => ({
      ...It(),
      'currencySymbol': '$'
    }),
    'validate': Wt
  }), P(e.BaseFieldType["Rating"], {
    'groupable': true,
    'usableAsKanbanGroup': true
    ...
    'createDefaultValue': () => null,
    'validate': (var_core_value_sig2278, var_core_value_sig7053) => Gt(var_core_value_sig2278, var_core_value_sig7053, "[BaseField]: invalid rating value.")
  }), P(e.BaseFieldType['RecordLink'], {
    'supportsRelation': true,
    'supportsMultipleValues': true
  }, zt, {
    'createDefaultConfig': () => ({
    ...
    'createDefaultValue': () => '',
    'validate': (var_core_value_sig52F1, var_core_value_sig1E74) => l(var_core_value_sig52F1, var_core_value_sig1E74.config['multiple'] === true)
  }), P(e.BaseFieldType["RecordId"], {
    'editable': false,
    'sortable': true,
    'filterable': true,
    'usableAsTitle': true
  }), P(e.BaseFieldType['CreatedBy'], {
    'editable': false,
    'groupable': true
    ...
    'createDefaultValue': () => null
  }), P(e.BaseFieldType['CreatedAt'], {
    'editable': false,
    'usableAsCalendarDate': true,
    'usableAsGanttStart': true,
    'usableAsGanttEnd': true
  }, var_core_value_sig69B8 => ot(var_core_value_sig69B8), {
    'createDefaultConfig': () => Lt(),
    'createDefaultValue': () => null,
    'validate': Ut
  }), P(e.BaseFieldType['UpdatedAt'], {
    'editable': false,
    'usableAsCalendarDate': true,
    'usableAsGanttStart': true,
    'usableAsGanttEnd': true
  }, var_core_value_sig983D => ot(var_core_value_sig983D), {
    'createDefaultConfig': () => Lt(),
    'createDefaultValue': () => null,
    'validate': Ut
  })];
...
;
function Rt(var_core_value_sigB5E9) {
...
;
function zt(var_core_value_sig0862) {
  return typeof var_core_value_sig0862 == 'string' ? var_core_value_sig0862 : '';
}
;
function Bt(var_core_value_sig9099, var_core_value_sigC317) {
...
;
function Vt(var_core_value_sig2746, var_core_value_sig71B8) {
  return var_core_value_sig71B8.config["allowMultiple"] === true ? Ht(var_core_value_sig2746) : var_core_value_sig2746 == null || var_core_value_sig2746 === '' || typeof var_core_value_sig2746 == "string" ? {
    'valid': true
  } : {
    'valid': false,
...
;
function Ht(var_core_value_sigFD40) {
...
;
function Ut(var_core_value_sig152B) {
...
;
function Wt(var_core_value_sig0334, var_core_value_sigE424) {
...
;
function Gt(var_core_value_sigCDE2, var_core_value_sigD2B0, var_core_value_sig4E8D) {
  let var_core_value_sig9675 = Wt(var_core_value_sigCDE2, var_core_value_sigD2B0);
...
;
function Kt(var_core_value_sig96C7) {
  ...
  if (typeof var_core_value_sig96C7 == "object" && !Array.isArray(var_core_value_sig96C7)) {
    let var_core_value_sig3363 = var_core_value_sig96C7,
      ...
      var_core_value_sigA790 = Jt(var_core_value_sig25EC || var_core_value_sigF64A);
  ...
  let var_core_value_sig8D50 = String(var_core_value_sig96C7).trim(),
    var_core_value_sigB5EA = Jt(var_core_value_sig8D50);
...
;
function qt(var_core_value_sigE952) {
...
;
function Jt(var_core_value_sigE241) {
...
;
function Yt(var_core_value_sig0891) {
...
var I = class {
  setBaseName(var_core_value_sigD6A9, var_core_value_sig0FCF) {
    ...
    return A([this._replaceOptional(['name'], var_core_value_sigD6A9.name, var_core_value_sig0FCF), ...(var_core_value_sigCF96 ? [var_core_value_sigCF96] : [])]);
  }
  renameFormulaUnitReferences(var_core_value_sigC4E9, var_core_value_sigF612, var_core_value_sigAA6C) {
    let var_core_value_sig8BFA = Object.values(var_core_value_sigC4E9.tables).flatMap(var_core_value_sigE503 => Object.values(var_core_value_sigE503.fields).flatMap(var_core_value_sigA12B => {
      ...
      if (var_core_value_sigA12B.type !== e.BaseFieldType["Formula"]) return [];
      let var_core_value_sig6F91 = String(((var_core_value_sigF230 = var_core_value_sigA12B.config) == null ? undefined : var_core_value_sigF230.formula) ?? ''),
        var_core_value_sigF9C7 = (0, t.refactorFormulaUnitQualifier)(var_core_value_sig6F91, var_core_value_sigF612, var_core_value_sigAA6C);
      return var_core_value_sigF9C7 === var_core_value_sig6F91 ? [] : [this._replaceOptional([...F.field(var_core_value_sigE503.id, var_core_value_sigA12B.id), "config", "formula"], (var_core_value_sig09B8 = var_core_value_sigA12B.config) == null ? undefined : var_core_value_sig09B8.formula, var_core_value_sigF9C7)];
    }));
    return var_core_value_sig8BFA.length > 0 ? A(var_core_value_sig8BFA) : undefined;
  }
  createTable(var_core_value_sig236B, var_core_value_sig1951, var_core_value_sigFEA0 = var_core_value_sig236B.tableOrder["length"]) {
    let var_core_value_sig931A = (0, e.allocateBaseFormulaTableName)(var_core_value_sig1951.name, (0, e.createBaseFormulaTableNameMap)(var_core_value_sig236B).values(), var_core_value_sig1951.formulaName),
    ...
    return A([...this._materializeFormulaTableNames(var_core_value_sig236B), e.JSON1['insertOp'](F.table(var_core_value_sig1951.id), var_core_value_sigEE7D), e.JSON1["insertOp"](["tableOrder", var_core_value_sigFEA0], var_core_value_sig1951.id)]);
  }
  renameTable(var_core_value_sig3585, var_core_value_sig31A8, var_core_value_sigA4DA) {
    ...
    return A([...this._materializeFormulaTableNames(var_core_value_sig3585), e.JSON1['replaceOp']([...F.table(var_core_value_sig31A8), 'name'], var_core_value_sig6FC0.name, var_core_value_sigA4DA)]);
  }
  deleteTable(var_core_value_sig6217, var_core_value_sigB805) {
    ...
    return A([...this._materializeFormulaTableNames(var_core_value_sig6217, new Set([var_core_value_sigB805])), e.JSON1['removeOp'](F.table(var_core_value_sigB805), var_core_value_sig4FAE), e.JSON1["removeOp"](["tableOrder", var_core_value_sig1FCC], var_core_value_sigB805)]);
  }
  ...
  createRecords(var_core_value_sigBDB5, var_core_value_sig59CE, var_core_value_sig3AD7) {
    let var_core_value_sig04E4 = var_core_value_sigBDB5.tables[var_core_value_sig59CE],
      var_core_value_sigD8F01 = var_core_value_sig3AD7.filter(var_core_value_sig48DD => var_core_value_sig48DD && !var_core_value_sig04E4.records[var_core_value_sig48DD.id]).map(var_core_value_sig5E6A => ({
        ...
        'values': {
          ...
          [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sig5E6A.id
        }
      }));
    if (!var_core_value_sigD8F01.length) return e.JSON1["replaceOp"]([...F.table(var_core_value_sig59CE), "records"], var_core_value_sig04E4.records, var_core_value_sig04E4.records);
    let var_core_value_sig1475 = new e["JSON1"]["WriteCursor"](),
      ...
      var_core_value_sig2008 = [...F.table(var_core_value_sig59CE), "records"];
    ...
    return A([var_core_value_sig1475.get(), this._createRecordOrderOp(var_core_value_sigBDB5, var_core_value_sig59CE, var_core_value_sigD8F01)]);
  }
  ...
  deleteRecords(var_core_value_sig3FCF, var_core_value_sig675A, var_core_value_sig837F) {
    ...
    if (!var_core_value_sigB205.length) return e.JSON1['replaceOp']([...F.table(var_core_value_sig675A), "records"], var_core_value_sig9D6E.records, var_core_value_sig9D6E.records);
    let var_core_value_sigBF78 = new Set(var_core_value_sigB205),
      var_core_value_sig8AF3 = T(var_core_value_sig9D6E, var_core_value_sigB205).map(var_core_value_sigB455 => this.updateCell(var_core_value_sig3FCF, var_core_value_sig675A, var_core_value_sigB455.recordId, var_core_value_sigB455.fieldId, ''));
    return A([this._deleteRecordsBaseOp(var_core_value_sig3FCF, var_core_value_sig675A, var_core_value_sigB205, var_core_value_sigBF78), ...var_core_value_sig8AF3]);
  }
  createDeleteRecordsUndoOp(var_core_value_sigA0CC, var_core_value_sigB3A1, var_core_value_sig1FB9, var_core_value_sig53A9) {
    ...
    return A([new j().invertOp(var_core_value_sigA0CC, this._deleteRecordsBaseOp(var_core_value_sigA0CC, var_core_value_sig1FB9, var_core_value_sig691E, var_core_value_sigD6D6)), ...T(var_core_value_sigDACD, var_core_value_sig691E).map(var_core_value_sigC6E5 => this.updateCell(var_core_value_sigB3A1, var_core_value_sig1FB9, var_core_value_sigC6E5.recordId, var_core_value_sigC6E5.fieldId, var_core_value_sigC6E5.oldParentRecordId ?? ''))]);
  }
  _deleteRecordsBaseOp(var_core_value_sig0347, var_core_value_sig52A3, var_core_value_sigAD91, var_core_value_sigF64E) {
    ...
    return A([...var_core_value_sigAD91.map(var_core_value_sig156F => e.JSON1['removeOp'](F.record(var_core_value_sig52A3, var_core_value_sig156F), var_core_value_sig9B3D.records[var_core_value_sig156F])), ...var_core_value_sigB217.map(({
      recordId: var_core_value_sigDD51,
      index: var_core_value_sigF057
    }) => e.JSON1["removeOp"](['tables', var_core_value_sig52A3, "recordOrder", var_core_value_sigF057], var_core_value_sigDD51)), ...this._deleteAttachmentResources(var_core_value_sig9B3D, var_core_value_sig52A3, var_core_value_sig72F6 => {
  ...
  duplicateRecord(var_core_value_sig1FE6, var_core_value_sig2471, var_core_value_sigD1FC, var_core_value_sigE2F9) {
    return this.createRecord(var_core_value_sig1FE6, var_core_value_sig2471, {
      ...
      'values': {
        ...
        [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sigE2F9.id
      }
    });
  }
  updateRecordOrder(var_core_value_sigD689, var_core_value_sig7AE3, var_core_value_sig1EB3, var_core_value_sigE120) {
    let var_core_value_sigD6E7 = var_core_value_sigD689.tables[var_core_value_sig7AE3],
      var_core_value_sig3669 = [...F.record(var_core_value_sig7AE3, var_core_value_sig1EB3), 'orderKey'],
      ...
      var_core_value_sig20BE = [...F.table(var_core_value_sig7AE3), "recordOrder"];
    return A([this._replaceOptional(var_core_value_sig3669, var_core_value_sigD6E7.records[var_core_value_sig1EB3].orderKey, var_core_value_sigE120), var_core_value_sigD6E7.recordOrder ? e.JSON1["replaceOp"](var_core_value_sig20BE, var_core_value_sigD6E7.recordOrder, var_core_value_sig5CBC) : e.JSON1["insertOp"](var_core_value_sig20BE, var_core_value_sig5CBC)]);
  }
  updateCell(var_core_value_sig6BD0, var_core_value_sig8C15, var_core_value_sig6DF7, var_core_value_sigB411, var_core_value_sigA81B) {
    ...
    let var_core_value_sigF8DE = var_core_value_sig6BD0.tables[var_core_value_sig8C15],
      var_core_value_sigFE76 = tn(var_core_value_sigF8DE, var_core_value_sig6DF7, var_core_value_sigB411) ? var_core_value_sigF8DE : k(var_core_value_sigF8DE),
  ...
  setRecordValues(var_core_value_sigBB37, var_core_value_sig0C51, var_core_value_sigADA4) {
    let var_core_value_sig0E48 = var_core_value_sigBB37.tables[var_core_value_sig0C51],
      var_core_value_sig495B = var_core_value_sigADA4.every(var_core_value_sig029F => Object.keys(var_core_value_sig029F.values).every(var_core_value_sig8895 => tn(var_core_value_sig0E48, var_core_value_sig029F.recordId, var_core_value_sig8895))) ? var_core_value_sig0E48 : k(var_core_value_sig0E48),
      ...
      var_core_value_sig759E = var_core_value_sigADA4.flatMap(var_core_value_sig670B => Object.entries(var_core_value_sig670B.recordPatch ?? {}).map(([var_core_value_sig9E2F, var_core_value_sigD082]) => {
        ...
        let var_core_value_sigD0A8 = [...F.record(var_core_value_sig0C51, var_core_value_sig670B.recordId), var_core_value_sig9E2F],
    ...
    return A([this.setRangeValues(var_core_value_sigBB37, var_core_value_sig0C51, var_core_value_sig310C), ...var_core_value_sig759E]);
  }
  setRangeValues(var_core_value_sig6C80, var_core_value_sig6B99, var_core_value_sig6ADC) {
    let var_core_value_sig41AD = var_core_value_sig6C80.tables[var_core_value_sig6B99],
      var_core_value_sigDBC2 = var_core_value_sig6ADC.every(var_core_value_sig6912 => nn(var_core_value_sig41AD, var_core_value_sig6912.row, var_core_value_sig6912.col)) ? var_core_value_sig41AD : k(var_core_value_sig41AD),
      ...
      var_core_value_sig4040 = var_core_value_sig6ADC.flatMap(var_core_value_sigE235 => {
        ...
        if (var_core_value_sigF639 === e.BASE_RECORD_ID_FIELD_ID || (var_core_value_sigE94C == null ? undefined : var_core_value_sigE94C.type) === e.BaseFieldType["RecordId"]) throw Error("[BaseJson1OpFactory]: cannot write record-id.");
        let var_core_value_sig6D47 = ve(var_core_value_sigE235.value, var_core_value_sigE94C),
          ...
          var_core_value_sigCF4E = this._replaceOptional(F.cellData(var_core_value_sig6B99, var_core_value_sigE235.row, var_core_value_sigE235.col), var_core_value_sigCB82, var_core_value_sig6D47);
        ...
        let var_core_value_sig6CAD = (var_core_value_sig6998 = var_core_value_sigDBC2.records[var_core_value_sigEAE5]) == null ? undefined : var_core_value_sig6998.values[var_core_value_sigF639],
          var_core_value_sig8CF5 = (var_core_value_sigE94C == null ? undefined : var_core_value_sigE94C.type) === e.BaseFieldType["Attachment"] ? Ee(var_core_value_sigE235.value) : xe(var_core_value_sigE235.value, var_core_value_sig6D47, var_core_value_sigE94C, var_core_value_sigDBC2, var_core_value_sigEAE5),
          var_core_value_sigDDD7 = [var_core_value_sigCF4E, this._replaceOptional(F.cell(var_core_value_sig6B99, var_core_value_sigEAE5, var_core_value_sigF639), var_core_value_sig6CAD, var_core_value_sig8CF5)];
        return (var_core_value_sigE94C == null ? undefined : var_core_value_sigE94C.type) === e.BaseFieldType['Attachment'] && var_core_value_sig7739.set(Ce(var_core_value_sigF639, var_core_value_sigEAE5), {
          'recordId': var_core_value_sigEAE5,
          'fieldId': var_core_value_sigF639,
          'attachments': var_core_value_sig8CF5
        }), var_core_value_sigDDD7;
      });
    return var_core_value_sig4040.length ? A([...var_core_value_sig4040, ...this._setAttachmentResources(var_core_value_sigDBC2, var_core_value_sig6B99, Array.from(var_core_value_sig7739.values()))]) : e.JSON1["replaceOp"](['tables', var_core_value_sig6B99, 'cellData'], var_core_value_sigDBC2.cellData, var_core_value_sigDBC2.cellData);
  }
  createField(var_core_value_sig1AAA, var_core_value_sig58DB, var_core_value_sig4840) {
    ...
    if (var_core_value_sigB76D.fields[var_core_value_sig4840.field['id']] || var_core_value_sigB76D.fieldOrder['includes'](var_core_value_sig4840.field['id'])) return e.JSON1['replaceOp'](["tables", var_core_value_sig58DB, 'fieldOrder'], var_core_value_sigB76D.fieldOrder, var_core_value_sigB76D.fieldOrder);
    let var_core_value_sig1015 = Math.max(1, var_core_value_sig4840.index ?? var_core_value_sigB76D.fieldOrder["length"]),
      var_core_value_sig6223 = Object.values(var_core_value_sigB76D.views ?? {}).flatMap(var_core_value_sigB2CE => {
        ...
        let var_core_value_sig39B1 = sn(((var_core_value_sig443C = var_core_value_sig4840.viewIndexes) == null ? undefined : var_core_value_sig443C[var_core_value_sigB2CE.id]) ?? var_core_value_sig1015, var_core_value_sigB2CE.fieldOrder["length"]);
        return [e.JSON1["insertOp"]([...F.view(var_core_value_sig58DB, var_core_value_sigB2CE.id), "fieldOrder", var_core_value_sig39B1], var_core_value_sig4840.field['id'])];
      });
    return A([...(var_core_value_sig4840.field['type'] === e.BaseFieldType["Formula"] ? this._materializeFormulaTableNames(var_core_value_sig1AAA) : []), e.JSON1["insertOp"](F.field(var_core_value_sig58DB, var_core_value_sig4840.field['id']), var_core_value_sig4840.field), e.JSON1["insertOp"](F.fieldOrder(var_core_value_sig58DB, var_core_value_sig1015), var_core_value_sig4840.field['id']), ...var_core_value_sig6223]);
  }
  duplicateField(var_core_value_sigC6B6, var_core_value_sig498A, var_core_value_sigEF45, var_core_value_sig36FE) {
    ...
    let var_core_value_sig14E6 = var_core_value_sig36FE.index ?? var_core_value_sig3AF5.fieldOrder['indexOf'](var_core_value_sigEF45) + 1,
      ...
      var_core_value_sigDF29 = an(var_core_value_sig8690, var_core_value_sig36FE.field['id'], var_core_value_sig14E6),
      var_core_value_sigC0F8 = Object.values(var_core_value_sig3AF5.views ?? {}).flatMap(var_core_value_sigB4B4 => {
        ...
        let var_core_value_sig62B7 = an(var_core_value_sig38CE, var_core_value_sig36FE.field['id'], ((var_core_value_sig63F3 = var_core_value_sig36FE.viewIndexes) == null ? undefined : var_core_value_sig63F3[var_core_value_sigB4B4.id]) ?? var_core_value_sig14E6),
        ...
        return [this._replaceOptional([...F.view(var_core_value_sig498A, var_core_value_sigB4B4.id), "fieldOrder"], var_core_value_sigB4B4.fieldOrder, var_core_value_sig62B7), ...(var_core_value_sig37A8 ? [this._replaceOptional([...F.view(var_core_value_sig498A, var_core_value_sigB4B4.id), "fieldSettings", var_core_value_sig36FE.field['id']], (var_core_value_sig3BF6 = var_core_value_sigB4B4.fieldSettings) == null ? undefined : var_core_value_sig3BF6[var_core_value_sig36FE.field['id']], var_core_value_sig37A8)] : [])];
      }),
      var_core_value_sig3C75 = Object.values(var_core_value_sig3AF5.records).filter(var_core_value_sigA90D => Object.prototype['hasOwnProperty'].call(var_core_value_sigA90D.values, var_core_value_sigEF45)).map(var_core_value_sig7A3C => this._replaceOptional(F.cell(var_core_value_sig498A, var_core_value_sig7A3C.id, var_core_value_sig36FE.field['id']), var_core_value_sig7A3C.values[var_core_value_sig36FE.field['id']], var_core_value_sig7A3C.values[var_core_value_sigEF45]));
    return A([...(var_core_value_sig36FE.field["type"] === e.BaseFieldType['Formula'] ? this._materializeFormulaTableNames(var_core_value_sigC6B6) : []), e.JSON1["insertOp"](F.field(var_core_value_sig498A, var_core_value_sig36FE.field['id']), var_core_value_sig36FE.field), e.JSON1['replaceOp'](['tables', var_core_value_sig498A, "fieldOrder"], var_core_value_sig3AF5.fieldOrder, var_core_value_sigDF29), ...var_core_value_sigC0F8, ...var_core_value_sig3C75]);
  }
  updateField(var_core_value_sig992D, var_core_value_sigE4E4, var_core_value_sigA4B0, var_core_value_sig5F50) {
    ...
    let var_core_value_sig478B = Xt(var_core_value_sig992D.tables[var_core_value_sigE4E4], var_core_value_sigA4B0, var_core_value_sig4494, var_core_value_sigFFAF);
    var_core_value_sigFFAF = var_core_value_sig478B.field;
    let var_core_value_sig1E21 = e.JSON1["replaceOp"](F.field(var_core_value_sigE4E4, var_core_value_sigA4B0), var_core_value_sig4494, var_core_value_sigFFAF);
    return var_core_value_sigFFAF.type === e.BaseFieldType["Formula"] ? A([...this._materializeFormulaTableNames(var_core_value_sig992D), var_core_value_sig1E21, ...this._setFormulaFieldCells(var_core_value_sig992D, var_core_value_sigE4E4, var_core_value_sigA4B0, var_core_value_sigFFAF)]) : A([var_core_value_sig1E21, ...(var_core_value_sig478B.patches["length"] ? [this.setRangeValues(var_core_value_sig992D, var_core_value_sigE4E4, var_core_value_sig478B.patches)] : [])]);
  }
  ...
  deleteField(var_core_value_sig85D5, var_core_value_sig5D2E, var_core_value_sig7221) {
    ...
    if (!(var_core_value_sig0A5A != null && var_core_value_sig0A5A.fields[var_core_value_sig7221]) || var_core_value_sig0A5A.primaryFieldId === var_core_value_sig7221 || var_core_value_sig7221 === e.BASE_RECORD_ID_FIELD_ID) return e.JSON1["replaceOp"](["tables", var_core_value_sig5D2E, 'fieldOrder'], var_core_value_sig0A5A == null ? undefined : var_core_value_sig0A5A.fieldOrder, var_core_value_sig0A5A == null ? undefined : var_core_value_sig0A5A.fieldOrder);
    let var_core_value_sigE6D6 = var_core_value_sig0A5A.fieldOrder["indexOf"](var_core_value_sig7221),
      var_core_value_sig8507 = Object.values(var_core_value_sig0A5A.views).flatMap(var_core_value_sig1F44 => {
        ...
        var_core_value_sigC786 >= 0 && var_core_value_sigDCF5.push(e.JSON1['removeOp']([...F.view(var_core_value_sig5D2E, var_core_value_sig1F44.id), "fieldOrder", var_core_value_sigC786], var_core_value_sig7221));
        ...
        var_core_value_sigC0D9 !== undefined && var_core_value_sigDCF5.push(e.JSON1["removeOp"]([...F.view(var_core_value_sig5D2E, var_core_value_sig1F44.id), 'fieldSettings', var_core_value_sig7221], var_core_value_sigC0D9));
        ...
        var_core_value_sig4EB7 && var_core_value_sig4EB7.length !== ((var_core_value_sig7658 = var_core_value_sig1F44.group) == null ? undefined : var_core_value_sig7658.length) && var_core_value_sigDCF5.push(this._replaceOptional([...F.view(var_core_value_sig5D2E, var_core_value_sig1F44.id), "group"], var_core_value_sig1F44.group, var_core_value_sig4EB7));
        let var_core_value_sig73AF = on(var_core_value_sig1F44.config, var_core_value_sig7221);
        return JSON.stringify(var_core_value_sig73AF) !== JSON.stringify(var_core_value_sig1F44.config) && var_core_value_sigDCF5.push(e.JSON1['replaceOp']([...F.view(var_core_value_sig5D2E, var_core_value_sig1F44.id), "config"], var_core_value_sig1F44.config, var_core_value_sig73AF)), var_core_value_sigDCF5;
      }),
      var_core_value_sig8A7F = Object.values(var_core_value_sig0A5A.records).flatMap(var_core_value_sig548A => Object.prototype['hasOwnProperty'].call(var_core_value_sig548A.values, var_core_value_sig7221) ? [e.JSON1["removeOp"](F.cell(var_core_value_sig5D2E, var_core_value_sig548A.id, var_core_value_sig7221), var_core_value_sig548A.values[var_core_value_sig7221])] : []);
    return A([e.JSON1["removeOp"](F.field(var_core_value_sig5D2E, var_core_value_sig7221), var_core_value_sig0A5A.fields[var_core_value_sig7221]), e.JSON1["removeOp"](F.fieldOrder(var_core_value_sig5D2E, var_core_value_sigE6D6), var_core_value_sig7221), ...var_core_value_sig8507, ...var_core_value_sig8A7F, ...this._deleteAttachmentResources(var_core_value_sig0A5A, var_core_value_sig5D2E, var_core_value_sigE026 => var_core_value_sigE026.startsWith(var_core_value_sig7221 + '\x1f'))]);
  }
  moveField(var_core_value_sig9E81, var_core_value_sig8295, var_core_value_sigA975, var_core_value_sig1263) {
    ...
    if (var_core_value_sigA975 === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig1263.beforeFieldId === e.BASE_RECORD_ID_FIELD_ID) throw Error("[BaseJson1OpFactory]: cannot move a field before record-id.");
    let var_core_value_sigA4E6 = rn(var_core_value_sig457C, var_core_value_sigA975, var_core_value_sig1263);
    return e.JSON1["replaceOp"](["tables", var_core_value_sig8295, "fieldOrder"], var_core_value_sig457C, var_core_value_sigA4E6);
  }
  createView(var_core_value_sig934F, var_core_value_sig74A7, var_core_value_sig3685, var_core_value_sigC621 = var_core_value_sig934F.tables[var_core_value_sig74A7].viewOrder['length']) {
    return A([e.JSON1["insertOp"](F.view(var_core_value_sig74A7, var_core_value_sig3685.id), var_core_value_sig3685), e.JSON1["insertOp"](["tables", var_core_value_sig74A7, "viewOrder", var_core_value_sigC621], var_core_value_sig3685.id)]);
  }
  renameView(var_core_value_sig86D7, var_core_value_sig431B1, var_core_value_sig5C7C, var_core_value_sig87E2) {
    return e.JSON1["replaceOp"]([...F.view(var_core_value_sig431B1, var_core_value_sig5C7C), "name"], var_core_value_sig86D7.tables[var_core_value_sig431B1].views[var_core_value_sig5C7C].name, var_core_value_sig87E2);
  }
  deleteView(var_core_value_sig2E04, var_core_value_sig2EDD, var_core_value_sig27D2) {
    ...
    return A([e.JSON1['removeOp'](F.view(var_core_value_sig2EDD, var_core_value_sig27D2), var_core_value_sig8B21), e.JSON1['removeOp'](["tables", var_core_value_sig2EDD, "viewOrder", var_core_value_sigEB36], var_core_value_sig27D2)]);
  }
  moveView(var_core_value_sig5C27, var_core_value_sigD494, var_core_value_sigBF6D, var_core_value_sigD051) {
    let var_core_value_sig16D9 = var_core_value_sig5C27.tables[var_core_value_sigD494].viewOrder,
      var_core_value_sigF378 = rn(var_core_value_sig16D9, var_core_value_sigBF6D, {
        'beforeFieldId': var_core_value_sigD051.beforeViewId,
        'afterFieldId': var_core_value_sigD051.afterViewId
      });
    return e.JSON1["replaceOp"](["tables", var_core_value_sigD494, "viewOrder"], var_core_value_sig16D9, var_core_value_sigF378);
  }
  updateViewConfig(var_core_value_sig5F6C, var_core_value_sig7E85, var_core_value_sigF204, var_core_value_sig7A15) {
    ...
    }), e.JSON1["replaceOp"]([...F.view(var_core_value_sig7E85, var_core_value_sigF204), "config"], var_core_value_sigEEA6, var_core_value_sigEAE1);
  }
  setViewFilter(var_core_value_sigC69F, var_core_value_sig0442, var_core_value_sig697A, var_core_value_sigDB65) {
    return this._replaceOptional([...F.view(var_core_value_sig0442, var_core_value_sig697A), "filter"], var_core_value_sigC69F.tables[var_core_value_sig0442].views[var_core_value_sig697A].filter, var_core_value_sigDB65);
  }
  setViewSort(var_core_value_sig045E, var_core_value_sig4524, var_core_value_sig64D5, var_core_value_sig9678) {
    return this._replaceOptional([...F.view(var_core_value_sig4524, var_core_value_sig64D5), "sort"], var_core_value_sig045E.tables[var_core_value_sig4524].views[var_core_value_sig64D5].sort, var_core_value_sig9678);
  }
  setViewGroup(var_core_value_sig5E74, var_core_value_sig75FC, var_core_value_sig639A, var_core_value_sig567C) {
    return this._replaceOptional([...F.view(var_core_value_sig75FC, var_core_value_sig639A), "group"], var_core_value_sig5E74.tables[var_core_value_sig75FC].views[var_core_value_sig639A].group, var_core_value_sig567C);
  }
  ...
  setViewFieldOrder(var_core_value_sigE4D0, var_core_value_sigD5F1, var_core_value_sigBC19, var_core_value_sig4F3C, var_core_value_sig8D44) {
    let var_core_value_sig1660 = var_core_value_sigE4D0.tables[var_core_value_sigD5F1].views[var_core_value_sigBC19],
      var_core_value_sigEE7B = rn(var_core_value_sig1660.fieldOrder ?? var_core_value_sigE4D0.tables[var_core_value_sigD5F1].fieldOrder, var_core_value_sig4F3C, var_core_value_sig8D44);
    return this._replaceOptional([...F.view(var_core_value_sigD5F1, var_core_value_sigBC19), "fieldOrder"], var_core_value_sig1660.fieldOrder, var_core_value_sigEE7B);
  }
  _setViewFieldSetting(var_core_value_sig44DF, var_core_value_sig7E48, var_core_value_sig7B9E, var_core_value_sig5C3B, var_core_value_sig4002) {
    ...
    return this._replaceOptional([...F.view(var_core_value_sig7E48, var_core_value_sig7B9E), "fieldSettings"], var_core_value_sig44DF.tables[var_core_value_sig7E48].views[var_core_value_sig7B9E].fieldSettings, var_core_value_sig2825);
  }
  _createRecordOrderOp(var_core_value_sig5FD0, var_core_value_sigA7E3, var_core_value_sigA784) {
    let var_core_value_sig4406 = var_core_value_sig5FD0.tables[var_core_value_sigA7E3],
      ...
      var_core_value_sigDC41 = [...F.table(var_core_value_sigA7E3), "recordOrder"];
    return var_core_value_sig4406.recordOrder ? e.JSON1['replaceOp'](var_core_value_sigDC41, var_core_value_sig4406.recordOrder, var_core_value_sigD4AA) : e.JSON1['insertOp'](var_core_value_sigDC41, var_core_value_sigD4AA);
  }
  _materializeFormulaTableNames(var_core_value_sigFB47, var_core_value_sig9B3D1 = new Set()) {
    let var_core_value_sigC1CF = (0, e.createBaseFormulaTableNameMap)(var_core_value_sigFB47);
    return Object.values(var_core_value_sigFB47.tables).filter(var_core_value_sigB680 => !var_core_value_sig9B3D1.has(var_core_value_sigB680.id)).sort((var_core_value_sig1F64, var_core_value_sigDD1C) => var_core_value_sig1F64.id["localeCompare"](var_core_value_sigDD1C.id)).flatMap(var_core_value_sig2C39 => {
      ...
      return !var_core_value_sigB7D1 || var_core_value_sig2C39.formulaName === var_core_value_sigB7D1 ? [] : [this._replaceOptional([...F.table(var_core_value_sig2C39.id), 'formulaName'], var_core_value_sig2C39.formulaName, var_core_value_sigB7D1)];
    });
  }
  _setFormulaFieldCells(var_core_value_sigEE12, var_core_value_sigD70C, var_core_value_sigF047, var_core_value_sigC2F9) {
    ...
    let var_core_value_sig5A51 = k(var_core_value_sigEE12.tables[var_core_value_sigD70C]),
    ...
    return var_core_value_sigDE14.flatMap(var_core_value_sig2162 => {
      ...
      return [this._replaceOptional(F.cellData(var_core_value_sigD70C, var_core_value_sig340D, var_core_value_sig370E), var_core_value_sig82D4, var_core_value_sigBDE4)];
    });
  }
  _setAttachmentResources(var_core_value_sig6CBB, var_core_value_sig68DA, var_core_value_sig64D8) {
    ...
    let var_core_value_sigF897 = new Map(Object.entries(((var_core_value_sigD755 = var_core_value_sig6CBB.resources) == null ? undefined : var_core_value_sigD755.attachmentSets) ?? {})),
      ...
      var_core_value_sig034D = var_core_value_sig64D8.map(({
        ...
        let var_core_value_sigBBEE = Ce(var_core_value_sigDC86, var_core_value_sig7DF1),
        ...
        }), this._replaceOptional(F.attachmentSet(var_core_value_sig68DA, var_core_value_sigBBEE), (var_core_value_sigA39E = var_core_value_sig6CBB.resources) == null || (var_core_value_sigA39E = var_core_value_sigA39E.attachmentSets) == null ? undefined : var_core_value_sigA39E[var_core_value_sigBBEE], var_core_value_sig011D);
      }),
      var_core_value_sig89EC = Array.from(var_core_value_sigA578).map(([var_core_value_sig6167, var_core_value_sig65A1]) => {
        ...
        return this._replaceOptional(F.attachment(var_core_value_sig68DA, var_core_value_sig6167), (var_core_value_sig7F19 = var_core_value_sig6CBB.resources) == null || (var_core_value_sig7F19 = var_core_value_sig7F19.attachments) == null ? undefined : var_core_value_sig7F19[var_core_value_sig6167], var_core_value_sig65A1);
      }),
      ...
      var_core_value_sig2637 = Array.from(var_core_value_sigD6D9).flatMap(var_core_value_sig7E32 => {
        ...
        return var_core_value_sig79AB !== undefined && !var_core_value_sig9975.has(var_core_value_sig7E32) ? [e.JSON1["removeOp"](F.attachment(var_core_value_sig68DA, var_core_value_sig7E32), var_core_value_sig79AB)] : [];
      });
  ...
  _deleteAttachmentResources(var_core_value_sigAF1D, var_core_value_sigC92D, var_core_value_sigEA3D) {
    ...
    return [...var_core_value_sig9DAA.map(([var_core_value_sigBDF5, var_core_value_sigACC6]) => e.JSON1["removeOp"](F.attachmentSet(var_core_value_sigC92D, var_core_value_sigBDF5), var_core_value_sigACC6)), ...Array.from(var_core_value_sigEBB4).flatMap(var_core_value_sig1614 => {
      ...
      return var_core_value_sigB996 !== undefined && !var_core_value_sig1F8A.has(var_core_value_sig1614) ? [e.JSON1['removeOp'](F.attachment(var_core_value_sigC92D, var_core_value_sig1614), var_core_value_sigB996)] : [];
    })];
  }
  _replaceOptional(var_core_value_sig2B74, var_core_value_sig0483, var_core_value_sig4A48) {
    return var_core_value_sig0483 === undefined ? e.JSON1["insertOp"](var_core_value_sig2B74, var_core_value_sig4A48) : e.JSON1["replaceOp"](var_core_value_sig2B74, var_core_value_sig0483, var_core_value_sig4A48);
  }
};
function Xt(var_core_value_sig305B, var_core_value_sigAE39, var_core_value_sigF21C, var_core_value_sig66D1) {
  var var_core_value_sig83A6;
  let var_core_value_sig7D8E = var_core_value_sig66D1.type;
  if (var_core_value_sigF21C.type !== var_core_value_sig7D8E || var_core_value_sig7D8E !== e.BaseFieldType["SingleSelect"] && var_core_value_sig7D8E !== e.BaseFieldType["MultiSelect"] || Zt(var_core_value_sig66D1.config["optionSource"])) return {
    'field': var_core_value_sig66D1,
    'patches': []
  };
  let var_core_value_sigADFE = Qt(var_core_value_sigF21C),
    var_core_value_sigF11A = Qt(var_core_value_sig66D1);
  if (![...var_core_value_sigADFE].some(var_core_value_sigD170 => !var_core_value_sigF11A.has(var_core_value_sigD170))) return {
    'field': var_core_value_sig66D1,
    'patches': []
  };
  let var_core_value_sigF020 = $t(var_core_value_sig66D1.defaultValue, var_core_value_sigF11A, var_core_value_sig7D8E),
    var_core_value_sigAECB = en(var_core_value_sigF020, var_core_value_sig66D1.defaultValue) ? var_core_value_sig66D1 : {
      ...var_core_value_sig66D1,
      'defaultValue': var_core_value_sigF020
    },
    var_core_value_sigF759 = k(var_core_value_sig305B),
  ...
  return var_core_value_sig52AE == null ? {
    ...
    'patches': (var_core_value_sigF759.recordOrder ?? []).flatMap(var_core_value_sig90E5 => {
      ...
      let var_core_value_sig3633 = (var_core_value_sig7000 = var_core_value_sigF759.rowIndex) == null ? undefined : var_core_value_sig7000[var_core_value_sig90E5],
        ...
        var_core_value_sig90A3 = $t(var_core_value_sig1DF5, var_core_value_sigF11A, var_core_value_sig7D8E);
      return var_core_value_sig3633 == null || en(var_core_value_sig90A3, var_core_value_sig1DF5) ? [] : [{
...
;
function Zt(var_core_value_sig35A1) {
...
;
function Qt(var_core_value_sig5F74) {
...
;
function $t(var_core_value_sig7B0C, var_core_value_sig0616, var_core_value_sigDA4C) {
  if (var_core_value_sig7B0C == null || var_core_value_sig7B0C === '') return var_core_value_sig7B0C;
  if (var_core_value_sigDA4C === e.BaseFieldType['SingleSelect']) return var_core_value_sig0616.has(String(var_core_value_sig7B0C)) ? var_core_value_sig7B0C : null;
...
;
function en(var_core_value_sig182F, var_core_value_sig76FA) {
  return JSON.stringify(var_core_value_sig182F) === JSON.stringify(var_core_value_sig76FA);
}
;
function tn(var_core_value_sig960A, var_core_value_sigBE8E, var_core_value_sig294A) {
...
;
function nn(var_core_value_sig3CF8, var_core_value_sig3EC3, var_core_value_sigBD61) {
...
;
function rn(var_core_value_sig73A8, var_core_value_sigE227, var_core_value_sig6909) {
...
;
function an(var_core_value_sigAA49, var_core_value_sigAB24, var_core_value_sig2F15) {
  ...
  return var_core_value_sig316C.splice(sn(var_core_value_sig2F15, var_core_value_sig316C.length), 0, var_core_value_sigAB24), var_core_value_sig316C;
}
;
function on(var_core_value_sig75A2, var_core_value_sig95CE, var_core_value_sig41FA) {
  if (Array.isArray(var_core_value_sig75A2)) return var_core_value_sig41FA === 'fieldIds' ? var_core_value_sig75A2.filter(var_core_value_sig269A => var_core_value_sig269A !== var_core_value_sig95CE) : var_core_value_sig75A2.flatMap(var_core_value_sigBF53 => {
    ...
    let var_core_value_sigD9BB = on(var_core_value_sigBF53, var_core_value_sig95CE);
  ...
  if (var_core_value_sig73C4.fieldId !== var_core_value_sig95CE) return Object.fromEntries(Object.entries(var_core_value_sig73C4).flatMap(([var_core_value_sigF549, var_core_value_sigC125]) => {
    ...
    let var_core_value_sigB63D = on(var_core_value_sigC125, var_core_value_sig95CE, var_core_value_sigF549);
    return var_core_value_sigB63D === undefined ? [] : [[var_core_value_sigF549, var_core_value_sigB63D]];
  }));
}
;
function sn(var_core_value_sig3216, var_core_value_sigF636) {
  return Math.max(0, Math.min(var_core_value_sig3216, var_core_value_sigF636));
}
;
function cn(var_core_value_sig2EE8) {
  '@babel/helpers - typeof';

  return cn = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig8255) {
  ...
  }, cn(var_core_value_sig2EE8);
}
;
function ln(var_core_value_sig6177, var_core_value_sig723F) {
  if (cn(var_core_value_sig6177) != "object" || !var_core_value_sig6177) return var_core_value_sig6177;
  ...
  if (var_core_value_sigADA0 !== undefined) {
    ...
    if (cn(var_core_value_sig2F52) != "object") return var_core_value_sig2F52;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig723F === "string" ? String : Number)(var_core_value_sig6177);
}
;
function un(var_core_value_sig8FC3) {
  var var_core_value_sigF5B3 = ln(var_core_value_sig8FC3, "string");
  return cn(var_core_value_sigF5B3) == "symbol" ? var_core_value_sigF5B3 : var_core_value_sigF5B3 + '';
}
;
function L(var_core_value_sig074A, var_core_value_sig5FBE, var_core_value_sig9D61) {
  return (var_core_value_sig5FBE = un(var_core_value_sig5FBE)) in var_core_value_sig074A ? Object.defineProperty(var_core_value_sig074A, var_core_value_sig5FBE, {
...
var fn = class extends e.Disposable {
    constructor(...var_core_value_sig933F) {
      super(...var_core_value_sig933F), L(this, "_plugins", new Map());
    }
    register(var_core_value_sig29DE) {
      return this._plugins["set"](var_core_value_sig29DE.type, var_core_value_sig29DE), (0, e.toDisposable)(() => this._plugins["delete"](var_core_value_sig29DE.type));
    }
    get(var_core_value_sig4AFB) {
      let var_core_value_sigC7EA = this._plugins["get"](var_core_value_sig4AFB);
      if (!var_core_value_sigC7EA) throw Error('[BaseFieldRegistryService]:\x20field\x20type\x20\x22' + var_core_value_sig4AFB + "\" is not registered.");
  ...
  pn = class {
    constructor(var_core_value_sig9CF7) {
      this.unitId = var_core_value_sig9CF7, L(this, 'type', n.UnitObject["Base"]), L(this, "subType", n.UnitAction["Comment"]), L(this, "status", e.PermissionStatus['INIT']), L(this, 'id', undefined), L(this, 'value', true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig9CF7;
    }
  },
  mn = class {
    constructor(var_core_value_sigCCE5) {
      this.unitId = var_core_value_sigCCE5, L(this, "type", n.UnitObject["Base"]), L(this, "subType", n.UnitAction["Copy"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigCCE5;
    }
  },
  hn = class {
    constructor(var_core_value_sig5933) {
      this.unitId = var_core_value_sig5933, L(this, "type", n.UnitObject["Base"]), L(this, 'subType', n.UnitAction["Edit"]), L(this, "status", e.PermissionStatus['INIT']), L(this, 'id', undefined), L(this, 'value', true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig5933;
    }
  },
  gn = class {
    constructor(var_core_value_sig884B) {
      this.unitId = var_core_value_sig884B, L(this, "type", n.UnitObject["Base"]), L(this, 'subType', n.UnitAction["Export"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig884B;
    }
  },
  _n = class {
    constructor(var_core_value_sig4E30, var_core_value_sig9730) {
      this.unitId = var_core_value_sig4E30, this.objectId = var_core_value_sig9730, L(this, "type", n.UnitObject["BaseDashboard"]), L(this, 'subType', n.UnitAction["Edit"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig4E30 + '_' + var_core_value_sig9730;
    }
  },
  vn = class {
    constructor(var_core_value_sig8E4A, var_core_value_sig300B) {
      this.unitId = var_core_value_sig8E4A, this.objectId = var_core_value_sig300B, L(this, "type", n.UnitObject["BaseField"]), L(this, "subType", n.UnitAction["Edit"]), L(this, 'status', e.PermissionStatus['INIT']), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig8E4A + '_' + var_core_value_sig300B;
    }
  },
  yn = class {
    constructor(var_core_value_sig8457, var_core_value_sigB30D) {
      this.unitId = var_core_value_sig8457, this.objectId = var_core_value_sigB30D, L(this, "type", n.UnitObject["BaseRecord"]), L(this, "subType", n.UnitAction["Edit"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig8457 + '_' + var_core_value_sigB30D;
    }
  },
  bn = class {
    constructor(var_core_value_sigDB33, var_core_value_sig6C8C) {
      this.unitId = var_core_value_sigDB33, this.objectId = var_core_value_sig6C8C, L(this, 'type', n.UnitObject['BaseTable']), L(this, 'subType', n.UnitAction["Edit"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigDB33 + '_' + var_core_value_sig6C8C;
    }
  },
  xn = class {
    constructor(var_core_value_sig7A5E, var_core_value_sig838E) {
      this.unitId = var_core_value_sig7A5E, this.objectId = var_core_value_sig838E, L(this, "type", n.UnitObject["BaseView"]), L(this, "subType", n.UnitAction["Edit"]), L(this, "status", e.PermissionStatus["INIT"]), L(this, 'id', undefined), L(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig7A5E + '_' + var_core_value_sig838E;
    }
  };
const Sn = [n.UnitAction["Edit"], n.UnitAction["Copy"], n.UnitAction["Export"], n.UnitAction["Comment"]],
  Cn = new Set([n.UnitObject["Base"], n.UnitObject["BaseTable"], n.UnitObject["BaseField"], n.UnitObject["BaseRecord"], n.UnitObject["BaseView"], n.UnitObject["BaseDashboard"]]),
  wn = "table/",
  Tn = "field/",
  En = "record/",
  Dn = "view/",
  On = 'dashboard/';
function R(var_core_value_sigF126) {
  return '' + wn + encodeURIComponent(var_core_value_sigF126);
}
;
function z(var_core_value_sig9AF8, var_core_value_sig7537) {
  return '' + Tn + encodeURIComponent(var_core_value_sig9AF8) + '/' + encodeURIComponent(var_core_value_sig7537);
}
;
function B(var_core_value_sig50C7, var_core_value_sig9B62) {
  return '' + En + encodeURIComponent(var_core_value_sig50C7) + '/' + encodeURIComponent(var_core_value_sig9B62);
}
;
function V(var_core_value_sig470B, var_core_value_sig7525) {
  return '' + Dn + encodeURIComponent(var_core_value_sig470B) + '/' + encodeURIComponent(var_core_value_sig7525);
}
;
function kn(var_core_value_sig95B5) {
  return '' + On + encodeURIComponent(var_core_value_sig95B5);
}
;
function An(var_core_value_sig2347, var_core_value_sigB20E, var_core_value_sig8ADE) {
  if (var_core_value_sigB20E === var_core_value_sig2347) switch (var_core_value_sig8ADE) {
    case n.UnitAction["Edit"]:
      return new hn(var_core_value_sig2347);
    case n.UnitAction["Copy"]:
      return new mn(var_core_value_sig2347);
    case n.UnitAction["Export"]:
      return new gn(var_core_value_sig2347);
    case n.UnitAction["Comment"]:
      return new pn(var_core_value_sig2347);
    default:
      throw Error('Unsupported\x20Base\x20permission\x20action:\x20' + var_core_value_sig8ADE);
  }
  if (var_core_value_sig8ADE !== n.UnitAction['Edit']) throw Error("Base object permissions only support Edit: " + var_core_value_sigB20E);
  if (var_core_value_sigB20E.startsWith(wn)) return new bn(var_core_value_sig2347, var_core_value_sigB20E);
  if (var_core_value_sigB20E.startsWith(Tn)) return new vn(var_core_value_sig2347, var_core_value_sigB20E);
  if (var_core_value_sigB20E.startsWith(En)) return new yn(var_core_value_sig2347, var_core_value_sigB20E);
  if (var_core_value_sigB20E.startsWith(Dn)) return new xn(var_core_value_sig2347, var_core_value_sigB20E);
  if (var_core_value_sigB20E.startsWith(On)) return new _n(var_core_value_sig2347, var_core_value_sigB20E);
  throw Error("Unsupported Base permission object: " + var_core_value_sigB20E);
}
;
function jn(var_core_value_sig7F51, var_core_value_sig622A, var_core_value_sig40EC, var_core_value_sig27C9) {
  var var_core_value_sigF296;
  return ((var_core_value_sigF296 = var_core_value_sig7F51.getPermissionPoint(An(var_core_value_sig622A, var_core_value_sig40EC, var_core_value_sig27C9).id)) == null ? undefined : var_core_value_sigF296.value) ?? true;
}
;
function Mn(var_core_value_sigD001, var_core_value_sig4940, var_core_value_sig7E0F, var_core_value_sig9785, var_core_value_sig235B) {
  let var_core_value_sigBCA8 = An(var_core_value_sig4940, var_core_value_sig7E0F, var_core_value_sig9785);
...
;
function Nn(var_core_value_sig0C8C, var_core_value_sig56FC, var_core_value_sig7EC8, var_core_value_sig0454) {
  var_core_value_sig0C8C.deletePermissionPoint(An(var_core_value_sig56FC, var_core_value_sig7EC8, var_core_value_sig0454).id);
}
;
function Pn(var_core_value_sig71F7, var_core_value_sig8D12) {
  var_core_value_sig71F7.getAllPermissionPoint().forEach((var_core_value_sig9A5B, var_core_value_sigC860) => {
    var_core_value_sig9A5B.subscribe(var_core_value_sig4BBA => {
      Cn.has(var_core_value_sig4BBA.type) && "unitId" in var_core_value_sig4BBA && var_core_value_sig4BBA.unitId === var_core_value_sig8D12 && var_core_value_sig71F7.deletePermissionPoint(var_core_value_sigC860);
    }).unsubscribe();
  });
}
;
function Fn(var_core_value_sigEEC4, var_core_value_sig0EDB, var_core_value_sig1C1B1) {
  return jn(var_core_value_sigEEC4, var_core_value_sig0EDB, var_core_value_sig0EDB, n.UnitAction['Edit']) && Array.from(var_core_value_sig1C1B1).every(var_core_value_sigE64C => jn(var_core_value_sigEEC4, var_core_value_sig0EDB, var_core_value_sigE64C, n.UnitAction["Edit"]));
}
;
function H(var_core_value_sig083D, var_core_value_sig70CE) {
...
;
function U(var_core_value_sig4B4A, var_core_value_sig6585, var_core_value_sig743E, var_core_value_sig9872) {
...
let Ln = class extends e.Disposable {
  constructor(var_core_value_sig992A, var_core_value_sig6281) {
    super(), this._permissionService = var_core_value_sig992A, this._instanceService = var_core_value_sig6281, L(this, '_basePermissions', new Map()), L(this, "_tablePermissions", new Map()), L(this, "_fieldPermissions", new Map()), L(this, '_recordPermissions', new Map()), L(this, "_viewPermissions", new Map()), L(this, "_tableBaseIds", new Map()), this.disposeWithMe(this._instanceService["getTypeOfUnitDisposed$"](e.UniverInstanceType['UNIVER_BASE']).subscribe(var_core_value_sig6201 => this._clearUnit(var_core_value_sig6201.getUnitId())));
  }
  ...
  canEditField(var_core_value_sig6CFC, var_core_value_sig3EC0) {
    ...
    return this._canEditTable(var_core_value_sig6CFC) && this._canEdit(var_core_value_sig6CFC, [z(var_core_value_sig6CFC, var_core_value_sig3EC0)]) && (((var_core_value_sigEA69 = this._fieldPermissions['get'](zn(var_core_value_sig6CFC, var_core_value_sig3EC0))) == null ? undefined : var_core_value_sigEA69.edit) ?? true);
  }
  canDeleteField(var_core_value_sigF42A, var_core_value_sig898E) {
    var var_core_value_sigC481;
    return this.canEditField(var_core_value_sigF42A, var_core_value_sig898E) && (((var_core_value_sigC481 = this._fieldPermissions["get"](zn(var_core_value_sigF42A, var_core_value_sig898E))) == null ? undefined : var_core_value_sigC481.delete) ?? true);
  }
  ...
  canEditRecord(var_core_value_sig00DE, var_core_value_sigEF7C) {
    ...
    let var_core_value_sig6005 = this._recordPermissions['get'](W(var_core_value_sig00DE, var_core_value_sigEF7C));
    return this._canEdit(var_core_value_sig00DE, [R(var_core_value_sig00DE), B(var_core_value_sig00DE, var_core_value_sigEF7C)]) && (((var_core_value_sig07E7 = this._tablePermissions["get"](var_core_value_sig00DE)) == null ? undefined : var_core_value_sig07E7.edit) ?? true) && ((var_core_value_sig6005 == null ? undefined : var_core_value_sig6005.edit) ?? true) && ((var_core_value_sig6005 == null ? undefined : var_core_value_sig6005.editCell) ?? true);
  }
  canDeleteRecord(var_core_value_sig25A4, var_core_value_sigB591) {
    ...
    return this._canEdit(var_core_value_sig25A4, [R(var_core_value_sig25A4), B(var_core_value_sig25A4, var_core_value_sigB591)]) && (((var_core_value_sigB272 = this._tablePermissions['get'](var_core_value_sig25A4)) == null ? undefined : var_core_value_sigB272.edit) ?? true) && (((var_core_value_sig6F52 = this._recordPermissions['get'](W(var_core_value_sig25A4, var_core_value_sigB591))) == null ? undefined : var_core_value_sig6F52.edit) ?? true) && (((var_core_value_sig09C4 = this._recordPermissions["get"](W(var_core_value_sig25A4, var_core_value_sigB591))) == null ? undefined : var_core_value_sig09C4.delete) ?? true);
  }
  canEditCell(var_core_value_sig8E3E, var_core_value_sigC3D3, var_core_value_sig1451) {
    ...
    let var_core_value_sigBDED = this._fieldPermissions["get"](zn(var_core_value_sig8E3E, var_core_value_sig1451));
    return this._canEdit(var_core_value_sig8E3E, [R(var_core_value_sig8E3E), z(var_core_value_sig8E3E, var_core_value_sig1451), B(var_core_value_sig8E3E, var_core_value_sigC3D3)]) && (((var_core_value_sigAD57 = this._tablePermissions["get"](var_core_value_sig8E3E)) == null ? undefined : var_core_value_sigAD57.edit) ?? true) && (((var_core_value_sig58A8 = this._recordPermissions["get"](W(var_core_value_sig8E3E, var_core_value_sigC3D3))) == null ? undefined : var_core_value_sig58A8.edit) ?? true) && (((var_core_value_sigEC1A = this._recordPermissions['get'](W(var_core_value_sig8E3E, var_core_value_sigC3D3))) == null ? undefined : var_core_value_sigEC1A.editCell) ?? true) && ((var_core_value_sigBDED == null ? undefined : var_core_value_sigBDED.edit) ?? true) && ((var_core_value_sigBDED == null ? undefined : var_core_value_sigBDED.editCell) ?? true);
  }
  canManageView(var_core_value_sig4BFF, var_core_value_sig40E7) {
    ...
    return this._canEdit(var_core_value_sig4BFF, [R(var_core_value_sig4BFF), V(var_core_value_sig4BFF, var_core_value_sig40E7)]) && (((var_core_value_sigEDBA = this._tablePermissions["get"](var_core_value_sig4BFF)) == null ? undefined : var_core_value_sigEDBA.edit) ?? true) && (((var_core_value_sigE863 = this._viewPermissions['get'](Bn(var_core_value_sig4BFF, var_core_value_sig40E7))) == null ? undefined : var_core_value_sigE863.edit) ?? true) && (((var_core_value_sig04B4 = this._tablePermissions['get'](var_core_value_sig4BFF)) == null ? undefined : var_core_value_sig04B4.manageView) ?? true);
  }
  setBasePermission(var_core_value_sig1C07, var_core_value_sig93D6) {
    ...
    }), var_core_value_sig93D6.edit !== undefined && Mn(this._permissionService, var_core_value_sig1C07, var_core_value_sig1C07, n.UnitAction["Edit"], var_core_value_sig93D6.edit);
  }
  setTablePermission(var_core_value_sigDD05, var_core_value_sig3932) {
    ...
    }), this._setObjectEdit(var_core_value_sigDD05, R(var_core_value_sigDD05), var_core_value_sig3932.edit);
  }
  setFieldPermission(var_core_value_sig48B2, var_core_value_sig57DF, var_core_value_sigC985) {
    ...
    let var_core_value_sig8DA6 = zn(var_core_value_sig48B2, var_core_value_sig57DF);
    this._fieldPermissions["set"](var_core_value_sig8DA6, {
      ...this._fieldPermissions['get'](var_core_value_sig8DA6),
      ...var_core_value_sigC985
    }), this._setObjectEdit(var_core_value_sig48B2, z(var_core_value_sig48B2, var_core_value_sig57DF), var_core_value_sigC985.edit);
  }
  setRecordPermission(var_core_value_sigCA69, var_core_value_sigB77C, var_core_value_sig9AFF) {
    ...
    let var_core_value_sig3545 = W(var_core_value_sigCA69, var_core_value_sigB77C);
    ...
    }), this._setObjectEdit(var_core_value_sigCA69, B(var_core_value_sigCA69, var_core_value_sigB77C), var_core_value_sig9AFF.edit);
  }
  setViewPermission(var_core_value_sig5EE4, var_core_value_sig7EAB, var_core_value_sig56B9) {
    ...
    let var_core_value_sig90CF = Bn(var_core_value_sig5EE4, var_core_value_sig7EAB);
    this._viewPermissions["set"](var_core_value_sig90CF, {
      ...this._viewPermissions["get"](var_core_value_sig90CF),
      ...var_core_value_sig56B9
    }), this._setObjectEdit(var_core_value_sig5EE4, V(var_core_value_sig5EE4, var_core_value_sig7EAB), var_core_value_sig56B9.edit);
  }
  clearBasePermission(var_core_value_sigA386) {
    this._basePermissions["delete"](var_core_value_sigA386), Nn(this._permissionService, var_core_value_sigA386, var_core_value_sigA386, n.UnitAction["Edit"]);
  }
  clearTablePermission(var_core_value_sigCD6E) {
    this._tablePermissions["delete"](var_core_value_sigCD6E), this._clearObjectEdit(var_core_value_sigCD6E, R(var_core_value_sigCD6E));
  }
  clearFieldPermission(var_core_value_sigFD9D, var_core_value_sigA2A4) {
    this._fieldPermissions['delete'](zn(var_core_value_sigFD9D, var_core_value_sigA2A4)), this._clearObjectEdit(var_core_value_sigFD9D, z(var_core_value_sigFD9D, var_core_value_sigA2A4));
  }
  clearRecordPermission(var_core_value_sigA1AC, var_core_value_sig6180) {
    this._recordPermissions["delete"](W(var_core_value_sigA1AC, var_core_value_sig6180)), this._clearObjectEdit(var_core_value_sigA1AC, B(var_core_value_sigA1AC, var_core_value_sig6180));
  }
  clearViewPermission(var_core_value_sigB93D, var_core_value_sigB17C) {
    this._viewPermissions["delete"](Bn(var_core_value_sigB93D, var_core_value_sigB17C)), this._clearObjectEdit(var_core_value_sigB93D, V(var_core_value_sigB93D, var_core_value_sigB17C));
  }
  getSnapshot() {
    return {
  ...
  _canEditTable(var_core_value_sig69B6) {
    ...
    return this._canEdit(var_core_value_sig69B6, [R(var_core_value_sig69B6)]) && (((var_core_value_sig708D = this._tablePermissions['get'](var_core_value_sig69B6)) == null ? undefined : var_core_value_sig708D.edit) ?? true);
  }
  _canEdit(var_core_value_sig1ED2, var_core_value_sig94C1) {
    ...
    return !var_core_value_sigFAE6 || Fn(this._permissionService, var_core_value_sigFAE6, var_core_value_sig94C1) && (((var_core_value_sigABAC = this._basePermissions["get"](var_core_value_sigFAE6)) == null ? undefined : var_core_value_sigABAC.edit) ?? true);
  }
  _setObjectEdit(var_core_value_sig06AC, var_core_value_sig57E2, var_core_value_sig01FC) {
    ...
    var_core_value_sig10FC && Mn(this._permissionService, var_core_value_sig10FC, var_core_value_sig57E2, n.UnitAction['Edit'], var_core_value_sig01FC);
  }
  _clearObjectEdit(var_core_value_sig5374, var_core_value_sigB66D) {
    ...
    var_core_value_sigD0F0 && Nn(this._permissionService, var_core_value_sigD0F0, var_core_value_sigB66D, n.UnitAction["Edit"]);
  }
  _resolveBaseId(var_core_value_sig8E31) {
    var var_core_value_sig8339;
    let var_core_value_sigA01E = this._instanceService["getUnit"](var_core_value_sig8E31, e.UniverInstanceType['UNIVER_BASE']);
    return var_core_value_sigA01E ? var_core_value_sigA01E.getUnitId() : (var_core_value_sig8339 = this._instanceService["getAllUnitsForType"](e.UniverInstanceType["UNIVER_BASE"]).find(var_core_value_sig5151 => !!var_core_value_sig5151.getSnapshot().tables[var_core_value_sig8E31])) == null ? undefined : var_core_value_sig8339.getUnitId();
  }
  ...
  _clearUnit(var_core_value_sigA49E) {
    this._basePermissions["delete"](var_core_value_sigA49E), this._tableBaseIds['forEach']((var_core_value_sigB542, var_core_value_sigBB6C) => {
      var_core_value_sigB542 === var_core_value_sigA49E && (this._tablePermissions["delete"](var_core_value_sigBB6C), Rn(this._fieldPermissions, var_core_value_sigBB6C + '\x1f'), Rn(this._recordPermissions, var_core_value_sigBB6C + '\x1f'), Rn(this._viewPermissions, var_core_value_sigBB6C + '\x1f'), this._tableBaseIds["delete"](var_core_value_sigBB6C));
    });
  }
};
Ln = U([H(0, e.IPermissionService), H(1, e.IUniverInstanceService)], Ln);
function Rn(var_core_value_sig823B, var_core_value_sigC9B0) {
...
;
function zn(var_core_value_sigAA99, var_core_value_sig1D86) {
  return var_core_value_sigAA99 + '\x1f' + var_core_value_sig1D86;
}
;
function W(var_core_value_sig1F4D, var_core_value_sig91D2) {
  return var_core_value_sig1F4D + '\x1f' + var_core_value_sig91D2;
}
;
function Bn(var_core_value_sigBF6A, var_core_value_sigC8CD) {
  return var_core_value_sigBF6A + '\x1f' + var_core_value_sigC8CD;
}
const G = (0, e.createIdentifier)('base.command.service');
let Vn = class {
  constructor(var_core_value_sig5141, var_core_value_sigA9E0 = Hn(), var_core_value_sig751D = {}) {
    this._permissionService = var_core_value_sig5141, this._fieldRegistry = var_core_value_sigA9E0, this._runtimeContext = var_core_value_sig751D, L(this, "_factory", new I()), L(this, "_applier", new j());
  }
  createTable(var_core_value_sig2E9A, var_core_value_sigE105, var_core_value_sig0BD6) {
    if (!this._permissionService["canCreateTable"](var_core_value_sig2E9A.getUnitId())) throw Error("[BaseCommandService]: cannot create table.");
    (0, e.assertBaseTableRecordIdentity)(var_core_value_sigE105), this._apply(var_core_value_sig2E9A, this._factory["createTable"](var_core_value_sig2E9A.getSnapshot(), var_core_value_sigE105, var_core_value_sig0BD6));
  }
  ...
  deleteTable(var_core_value_sig1056, var_core_value_sig6EE5) {
    if (!this._permissionService['canDeleteTable'](var_core_value_sig6EE5)) throw Error("[BaseCommandService]: cannot delete table.");
    let var_core_value_sig9DD9 = f(var_core_value_sig1056.getSnapshot(), var_core_value_sig6EE5);
    if (var_core_value_sig9DD9.length > 0) throw Error('[BaseCommandService]:\x20cannot\x20delete\x20a\x20RecordLink\x20target\x20table\x20(' + var_core_value_sig9DD9.map(var_core_value_sigE2BF => var_core_value_sigE2BF.tableId + '.' + var_core_value_sigE2BF.fieldId).join(',\x20') + ').');
  ...
  createBatchCreateRecordsOp(var_core_value_sig234B, var_core_value_sig8169, var_core_value_sigC5FB) {
    ...
    return O("BaseCommand.createBatchCreateRecordsOp", () => {
  ...
  createCreateFieldOp(var_core_value_sig8725, var_core_value_sig513B, var_core_value_sig5501, var_core_value_sig7784, var_core_value_sigB706) {
    ...
    return A([var_core_value_sig77E3, this._factory['setRecordValues'](var_core_value_sig15FE, var_core_value_sig513B, var_core_value_sigB071)]);
  }
  ...
  duplicateRecord(var_core_value_sigC60C, var_core_value_sig1C3C, var_core_value_sig71CF, var_core_value_sigC341) {
    if (!this._permissionService["canCreateRecord"](var_core_value_sig1C3C)) throw Error("[BaseCommandService]: cannot create record.");
    this._apply(var_core_value_sigC60C, this._factory["duplicateRecord"](var_core_value_sigC60C.getSnapshot(), var_core_value_sig1C3C, var_core_value_sig71CF, {
      ...
      'values': {
        ...
        [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sigC341.id
      }
    }));
  }
  ...
  updateField(var_core_value_sig135F, var_core_value_sig416D, var_core_value_sigAD5D, var_core_value_sig1B8A) {
    ...
    if (!var_core_value_sig96CF || var_core_value_sigAD5D === e.BASE_RECORD_ID_FIELD_ID) throw Error("[BaseCommandService]: cannot edit record-id.");
  ...
  changeFieldType(var_core_value_sig49F1, var_core_value_sig2F7B, var_core_value_sigB0DF, var_core_value_sig2E44) {
    ...
    if (!this._permissionService["canEditField"](var_core_value_sig2F7B, var_core_value_sigB0DF)) throw Error("[BaseCommandService]: cannot edit field.");
    ...
    if (!var_core_value_sig1E26 || var_core_value_sigB0DF === e.BASE_RECORD_ID_FIELD_ID) throw Error("[BaseCommandService]: cannot change record-id field type.");
  ...
  deleteField(var_core_value_sig5C6C, var_core_value_sigBE85, var_core_value_sig56DE) {
    ...
    if (((var_core_value_sig0278 = var_core_value_sig5C6C.getSnapshot().tables[var_core_value_sigBE85]) == null ? undefined : var_core_value_sig0278.primaryFieldId) === var_core_value_sig56DE || var_core_value_sig56DE === e.BASE_RECORD_ID_FIELD_ID) throw Error('[BaseCommandService]:\x20cannot\x20delete\x20primary\x20field.');
  ...
  moveField(var_core_value_sig08A6, var_core_value_sig04E1, var_core_value_sigC504, var_core_value_sig0515) {
    ...
    if (var_core_value_sigC504 === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig0515.beforeFieldId === e.BASE_RECORD_ID_FIELD_ID) throw Error("[BaseCommandService]: cannot move a field before record-id.");
  ...
  renameView(var_core_value_sig14F3, var_core_value_sig34E8, var_core_value_sigCFE7, var_core_value_sigECBC) {
    if (!this._permissionService["canManageView"](var_core_value_sig34E8, var_core_value_sigCFE7)) throw Error('[BaseCommandService]:\x20cannot\x20manage\x20view.');
  ...
  updateViewConfig(var_core_value_sig9071, var_core_value_sig01A9, var_core_value_sig9477, var_core_value_sig917C) {
    if (!this._permissionService["canManageView"](var_core_value_sig01A9, var_core_value_sig9477)) throw Error("[BaseCommandService]: cannot manage view.");
  ...
  setViewFilter(var_core_value_sig27E2, var_core_value_sig10D7, var_core_value_sig5A1A, var_core_value_sig77D2) {
    if (!this._permissionService["canManageView"](var_core_value_sig10D7, var_core_value_sig5A1A)) throw Error("[BaseCommandService]: cannot manage view.");
  ...
  setViewGroup(var_core_value_sig6694, var_core_value_sig2A21, var_core_value_sig0836, var_core_value_sigD95C) {
    if (!this._permissionService["canManageView"](var_core_value_sig2A21, var_core_value_sig0836)) throw Error("[BaseCommandService]: cannot manage view.");
  ...
  setViewFieldWidth(var_core_value_sig86CC, var_core_value_sig78681, var_core_value_sig9921, var_core_value_sig59BF, var_core_value_sigF001) {
    if (!this._permissionService["canManageView"](var_core_value_sig78681, var_core_value_sig9921)) throw Error('[BaseCommandService]:\x20cannot\x20manage\x20view.');
  ...
  setViewFieldOrder(var_core_value_sigE511, var_core_value_sig1C81, var_core_value_sig2C6A, var_core_value_sig7207, var_core_value_sig297F) {
    if (!this._permissionService["canManageView"](var_core_value_sig1C81, var_core_value_sig2C6A)) throw Error('[BaseCommandService]:\x20cannot\x20manage\x20view.');
  ...
  _createRecordWithDefaults(var_core_value_sig2321, var_core_value_sigFF33, var_core_value_sig16E0, var_core_value_sig213C = this._createNumberingAllocators(var_core_value_sig2321.tables[var_core_value_sigFF33])) {
    ...
    return var_core_value_sigC3C0.values[e.BASE_RECORD_ID_FIELD_ID] = var_core_value_sigC3C0.id, var_core_value_sig31F8.fieldOrder['forEach'](var_core_value_sig1998 => {
      ...
      if (!(!var_core_value_sigFF19 || var_core_value_sigC3C0.values[var_core_value_sig1998] !== undefined)) switch (var_core_value_sigFF19.type) {
        ...
        case e.BaseFieldType["UpdatedBy"]:
          ...
          break;
        case e.BaseFieldType["CreatedAt"]:
          var_core_value_sigC3C0.values[var_core_value_sig1998] = M(var_core_value_sigC3C0.createdAt);
          break;
        case e.BaseFieldType["UpdatedAt"]:
          var_core_value_sigC3C0.values[var_core_value_sig1998] = M(var_core_value_sigC3C0.updatedAt);
          break;
        default:
          {
  ...
  _withModifiedSystemValues(var_core_value_sig1F39, var_core_value_sig9256, var_core_value_sig98A0, var_core_value_sig3EBD) {
    ...
    return var_core_value_sig4C7F.fieldOrder['forEach'](var_core_value_sigD98F => {
      ...
      var_core_value_sig66C0 && (var_core_value_sig66C0.type === e.BaseFieldType['UpdatedAt'] && (var_core_value_sig407E[var_core_value_sigD98F] = M(var_core_value_sig2543)), var_core_value_sig66C0.type === e.BaseFieldType['UpdatedBy'] && var_core_value_sigB230 && (var_core_value_sig407E[var_core_value_sigD98F] = var_core_value_sigB230));
    }), {
  ...
  _createSystemFieldValuePatches(var_core_value_sig88CB, var_core_value_sigD615, var_core_value_sigB708) {
    ...
    return !var_core_value_sig60EF || !Un(var_core_value_sigB708) ? [] : var_core_value_sigB708.type === e.BaseFieldType["Numbering"] ? this._createNumberingFieldValuePatches(var_core_value_sig60EF, var_core_value_sigB708.id) : Object.values(var_core_value_sig60EF.records).flatMap(var_core_value_sig9D15 => {
  ...
  _getSystemFieldValue(var_core_value_sigA6FB, var_core_value_sigD6EA) {
    switch (var_core_value_sigA6FB.type) {
      ...
      case e.BaseFieldType['CreatedAt']:
        return M(var_core_value_sigD6EA.createdAt ?? Date.now());
      case e.BaseFieldType["UpdatedAt"]:
        return M(var_core_value_sigD6EA.updatedAt ?? Date.now());
      default:
        return;
    }
  }
  _createNumberingAllocators(var_core_value_sigA2D3) {
    ...
    return var_core_value_sigA2D3 && var_core_value_sigA2D3.fieldOrder["forEach"](var_core_value_sig130F => {
      ...
      (var_core_value_sigC0E3 == null ? undefined : var_core_value_sigC0E3.type) === e.BaseFieldType['Numbering'] && var_core_value_sig727A.set(var_core_value_sig130F, this._createNumberingAllocator(var_core_value_sigA2D3, var_core_value_sig130F));
  ...
  _normalizeCellValue(var_core_value_sigE025, var_core_value_sigD549, var_core_value_sigC79E, var_core_value_sig9221, var_core_value_sig0351) {
    ...
    if (!var_core_value_sig8E1C) throw Error("[BaseCommandService]: field \"" + var_core_value_sig9221 + "\" does not exist.");
    let var_core_value_sigD719 = this._fieldRegistry["get"](var_core_value_sig8E1C.type);
    if (var_core_value_sig8E1C.readonly || var_core_value_sig8E1C.system || !var_core_value_sigD719.getCapabilities(var_core_value_sig8E1C).editable) throw Error("[BaseCommandService]: cannot edit readonly field.");
    ...
    if (!var_core_value_sig015D.valid) throw Error(var_core_value_sig015D.reason ?? "[BaseCommandService]: invalid cell value.");
    let var_core_value_sigBF8B = var_core_value_sig8E1C.type === e.BaseFieldType["RecordLink"] ? d(var_core_value_sigE025, var_core_value_sig8E1C, var_core_value_sig323C) : {
      'valid': true
    };
  ...
  _assertFieldDefinition(var_core_value_sigF7CE, var_core_value_sig7CF1) {
    if (var_core_value_sig7CF1.id === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig7CF1.type === e.BaseFieldType["RecordId"] || (0, e.isBaseRecordIdFieldName)(var_core_value_sig7CF1.name)) throw Error('[BaseCommandService]:\x20record-id\x20is\x20reserved.');
    let var_core_value_sigA552 = u(var_core_value_sigF7CE, var_core_value_sig7CF1);
    if (!var_core_value_sigA552.valid) throw Error(var_core_value_sigA552.reason ?? "[BaseCommandService]: invalid field definition.");
  }
};
Vn = U([H(0, In), H(1, dn)], Vn);
function Hn() {
  let var_core_value_sig1D8D = new fn();
  return Ft().forEach(var_core_value_sigAE32 => var_core_value_sig1D8D.register(var_core_value_sigAE32)), var_core_value_sig1D8D;
}
;
function Un(var_core_value_sigFCDA) {
  return var_core_value_sigFCDA.type === e.BaseFieldType["Numbering"] || var_core_value_sigFCDA.type === e.BaseFieldType["CreatedBy"] || var_core_value_sigFCDA.type === e.BaseFieldType['UpdatedBy'] || var_core_value_sigFCDA.type === e.BaseFieldType["CreatedAt"] || var_core_value_sigFCDA.type === e.BaseFieldType["UpdatedAt"];
}
const Wn = new Set([e.BaseFieldType["Progress"], e.BaseFieldType["Rating"], e.BaseFieldType["Checkbox"]]);
function Gn(var_core_value_sig4A8B) {
  ...
  for (let var_core_value_sig9B4D of var_core_value_sig4A8B.fieldOrder) {
    ...
    if (var_core_value_sig3F79 && var_core_value_sig3F79.id !== var_core_value_sig4A8B.primaryFieldId && var_core_value_sig3F79.system !== true && var_core_value_sig3F79.type !== e.BaseFieldType["RecordId"]) return var_core_value_sig3F79.id;
  }
  return var_core_value_sig4A8B.primaryFieldId;
}
;
function Kn(var_core_value_sigB8AF, var_core_value_sigD4B6 = [], var_core_value_sigB90E = 5) {
  ...
  for (let var_core_value_sigD0CC of var_core_value_sigB8AF.fieldOrder) {
    ...
    var_core_value_sig880E && var_core_value_sig880E.system !== true && var_core_value_sig880E.type !== e.BaseFieldType['RecordId'] && !var_core_value_sigAEF2.has(var_core_value_sig880E.id) && (Wn.has(var_core_value_sig880E.type) ? var_core_value_sig4453 : var_core_value_sigFA8E).push(var_core_value_sig880E.id);
  }
...
function qn() {
  return [{
    ...
    'createDefaultConfig': var_core_value_sigF347 => {
      let var_core_value_sig80C6 = Jn(var_core_value_sigF347);
      return {
        ...
        'card': {
          ...
          'fieldIds': Kn(var_core_value_sigF347, [var_core_value_sigF347.primaryFieldId, var_core_value_sig80C6])
        }
      };
    },
    'validateConfig': () => ({
    ...
    'buildProjection': () => {
      throw Error("Kanban projection is implemented by BaseProjectionService.");
    }
  }, {
    'type': e.BaseViewType["Calendar"],
    'i18nKey': 'base.viewType.calendar',
    'createDefaultConfig': var_core_value_sigEBFB => {
      let var_core_value_sigF3BF = Yn(var_core_value_sigEBFB);
      return {
        'startDateFieldId': var_core_value_sigF3BF,
        'endDateFieldId': Xn(var_core_value_sigEBFB, var_core_value_sigF3BF),
    ...
    'buildProjection': () => {
      throw Error("Calendar projection is implemented by BaseProjectionService.");
    }
  }, {
    'type': e.BaseViewType['Gantt'],
    'i18nKey': 'base.viewType.gantt',
    'createDefaultConfig': var_core_value_sigAE58 => {
      let var_core_value_sig8E13 = Yn(var_core_value_sigAE58);
      return {
        'startDateFieldId': var_core_value_sig8E13,
        'endDateFieldId': Xn(var_core_value_sigAE58, var_core_value_sig8E13) ?? var_core_value_sig8E13,
    ...
    'createDefaultConfig': var_core_value_sig3AAF => {
      let var_core_value_sig134E = Gn(var_core_value_sig3AAF);
      return {
        'coverFieldId': null,
        'cardLayout': 'normal',
        'showFieldNames': true,
        ...
        'card': {
          ...
          'coverFieldId': null,
          'fieldIds': Kn(var_core_value_sig3AAF, [var_core_value_sig134E, var_core_value_sig3AAF.primaryFieldId])
        },
        'cardSize': "medium"
      };
    },
    ...
    'buildProjection': () => {
      throw Error('Gallery\x20projection\x20is\x20implemented\x20by\x20BaseProjectionService.');
    }
  }];
}
;
function Jn(var_core_value_sig9D66) {
  ...
  return ((var_core_value_sig399F = var_core_value_sig65AA.find(var_core_value_sigD044 => var_core_value_sigD044.type === e.BaseFieldType['SingleSelect'] || var_core_value_sigD044.type === e.BaseFieldType["MultiSelect"] || var_core_value_sigD044.type === e.BaseFieldType['Group'])) == null ? undefined : var_core_value_sig399F.id) ?? ((var_core_value_sig57C2 = var_core_value_sig65AA.find(var_core_value_sig9797 => var_core_value_sig9797.type === e.BaseFieldType["Text"])) == null ? undefined : var_core_value_sig57C2.id) ?? ((var_core_value_sigA85E = var_core_value_sig65AA.find(var_core_value_sig8533 => var_core_value_sig8533.type === e.BaseFieldType["Date"] || var_core_value_sig8533.type === e.BaseFieldType["CreatedAt"] || var_core_value_sig8533.type === e.BaseFieldType["UpdatedAt"])) == null ? undefined : var_core_value_sigA85E.id) ?? var_core_value_sig9D66.primaryFieldId;
}
;
function Yn(var_core_value_sigC6DD) {
  var var_core_value_sig1300;
  return ((var_core_value_sig1300 = var_core_value_sigC6DD.fieldOrder["map"](var_core_value_sig57C5 => var_core_value_sigC6DD.fields[var_core_value_sig57C5]).find(Zn)) == null ? undefined : var_core_value_sig1300.id) ?? '';
}
;
function Xn(var_core_value_sig05BB, var_core_value_sig91CD) {
  var var_core_value_sig2AF0;
  return (var_core_value_sig2AF0 = var_core_value_sig05BB.fieldOrder["map"](var_core_value_sig0DE9 => var_core_value_sig05BB.fields[var_core_value_sig0DE9]).find(var_core_value_sigB00D => Zn(var_core_value_sigB00D) && var_core_value_sigB00D.id !== var_core_value_sig91CD)) == null ? undefined : var_core_value_sig2AF0.id;
}
;
function Zn(var_core_value_sig796D) {
  return !!var_core_value_sig796D && var_core_value_sig796D.type === e.BaseFieldType["Date"] && var_core_value_sig796D.readonly !== true && var_core_value_sig796D.system !== true;
}
const Qn = (0, e.createIdentifier)("base.projection.service"),
  $n = new Set([e.BaseFieldType["Number"], e.BaseFieldType['Currency'], e.BaseFieldType["Progress"], e.BaseFieldType["Rating"], e.BaseFieldType["Date"], e.BaseFieldType["CreatedAt"], e.BaseFieldType["UpdatedAt"], e.BaseFieldType['Checkbox']]),
  er = 1440 * 60 * 1000;
let tr = class extends e.Disposable {
  constructor(var_core_value_sig57C8) {
    super(), this._fieldRegistry = var_core_value_sig57C8, L(this, "_views", new Map()), L(this, '_projectionCache', new WeakMap()), L(this, '_projectedRowsCache', new Map()), L(this, '_projectedViewRowsCache', new Map()), L(this, "_projectedGroupsCache", new Map()), L(this, "_hierarchyIndexCache", new Map()), L(this, "_globalRevision", 0), L(this, "_tableRevisions", new Map()), L(this, "_cellRevisions", new Map()), L(this, "_cellInvalidations", new Map()), L(this, "_viewRevisions", new Map());
  }
  registerView(var_core_value_sigC27D) {
    return this._views['set'](var_core_value_sigC27D.type, var_core_value_sigC27D), (0, e.toDisposable)(() => this._views["delete"](var_core_value_sigC27D.type));
  }
  getProjection(var_core_value_sig7B95, var_core_value_sig7D59, var_core_value_sig5863) {
    ...
    return O("BaseProjection.getProjection", () => {
      ...
      if (!var_core_value_sigB57B || !var_core_value_sig780B) return this._setCachedProjection(var_core_value_sig7B95, var_core_value_sig7D59, var_core_value_sig5863, {
        'type': 'invalid',
        'viewType': (var_core_value_sig780B == null ? undefined : var_core_value_sig780B.type) ?? e.BaseViewType['Grid'],
        'reason': "missingField"
      });
  ...
  _rowTransformCacheSegment(var_core_value_sig8B9C) {
    return var_core_value_sig8B9C ? cr({
      'filter': ar(var_core_value_sig8B9C.filter),
      'sort': sr(var_core_value_sig8B9C.sort)
    }) : "__all__";
  }
  _groupConfigCacheSegment(var_core_value_sigA35B) {
    return cr(var_core_value_sigA35B.map(var_core_value_sigD04E => ({
  ...
  _buildGrid(var_core_value_sig1999, var_core_value_sigFB45) {
    ...
    let var_core_value_sigD892 = y(var_core_value_sig1999),
  ...
  _getHierarchyIndex(var_core_value_sigCDCD, var_core_value_sig206A, var_core_value_sig1EFE, var_core_value_sig9904) {
    ...
    let var_core_value_sig991D = E(var_core_value_sigCDCD, var_core_value_sig206A, var_core_value_sig9904);
  ...
  _buildKanban(var_core_value_sig6AE2, var_core_value_sigFD17) {
    ...
    if (_(var_core_value_sig6AE2, var_core_value_sigFAFE.id)) {
      ...
      return var_core_value_sig2B86.forEach(var_core_value_sigFDEA => {
        let var_core_value_sig86D0 = var_core_value_sig0281.parentByRecordId["get"](var_core_value_sigFDEA.recordId) ?? null,
          ...
          var_core_value_sig50AF = var_core_value_sigED71.get(var_core_value_sig4CD2) ?? {
            ...
            'title': var_core_value_sig48CA ? String(ge(var_core_value_sig6AE2, var_core_value_sig48CA.id, var_core_value_sig6AE2.primaryFieldId) ?? var_core_value_sig86D0) : this._kanbanLaneTitle(var_core_value_sigFAFE, var_core_value_sig4CD2, var_core_value_sigB9C5),
            'recordIds': []
          };
  ...
  _isKanbanGroupField(var_core_value_sig4424, var_core_value_sig57E8) {
    ...
    return this._isAllowedKanbanGroupField(var_core_value_sig76B6) || _(var_core_value_sig4424, var_core_value_sig57E8);
  }
  _isAllowedKanbanGroupField(var_core_value_sig89BC) {
    return !!var_core_value_sig89BC && (var_core_value_sig89BC.type === e.BaseFieldType["SingleSelect"] || var_core_value_sig89BC.type === e.BaseFieldType["MultiSelect"] || var_core_value_sig89BC.type === e.BaseFieldType['Rating'] || var_core_value_sig89BC.type === e.BaseFieldType['Person'] || var_core_value_sig89BC.type === e.BaseFieldType["Group"] || var_core_value_sig89BC.type === e.BaseFieldType['Checkbox']);
  }
  _isColorfulKanbanGroupField(var_core_value_sig2191) {
    return var_core_value_sig2191.type === e.BaseFieldType["SingleSelect"] || var_core_value_sig2191.type === e.BaseFieldType['MultiSelect'];
  }
  ...
  _kanbanGroupKeys(var_core_value_sigFE26, var_core_value_sig1019) {
    let var_core_value_sig32AB = var_core_value_sig390D => {
      ...
      return !var_core_value_sig39B7 || !this._isColorfulKanbanGroupField(var_core_value_sigFE26) ? var_core_value_sig39B7 : ((var_core_value_sigC928 = Ar(var_core_value_sigFE26, var_core_value_sig39B7)) == null ? undefined : var_core_value_sigC928.id) ?? var_core_value_sig39B7;
    };
  ...
  _kanbanLaneTitle(var_core_value_sig72BE, var_core_value_sig3E4A, var_core_value_sig3171) {
    ...
    let var_core_value_sigEBC4 = Ar(var_core_value_sig72BE, var_core_value_sig3E4A);
  ...
  _kanbanLaneColor(var_core_value_sig788B, var_core_value_sig9A80, var_core_value_sig7C69) {
    ...
    if (this._isColorfulKanbanGroupField(var_core_value_sig788B)) return (var_core_value_sig01EF = Ar(var_core_value_sig788B, var_core_value_sig9A80)) == null ? undefined : var_core_value_sig01EF.color;
  }
  _buildCalendar(var_core_value_sig3603, var_core_value_sigC163) {
    ...
    if (!var_core_value_sig5E69 || var_core_value_sig5E69.type !== e.BaseFieldType["Date"] || var_core_value_sig5E69.readonly === true || var_core_value_sig5E69.system === true || !this._capabilities(var_core_value_sig5E69).usableAsCalendarDate) return {
      'type': "invalid",
    ...
    return {
      ...
      'events': var_core_value_sigDCAB.flatMap(var_core_value_sigE161 => {
        let var_core_value_sigBDEE = st(var_core_value_sigE161.values[var_core_value_sigF5F3.startDateFieldId]);
        ...
        let var_core_value_sig1F40 = var_core_value_sigE161.values[var_core_value_sigF5F3.startDateFieldId],
          ...
          var_core_value_sig1E1B = var_core_value_sigF5F3.endDateFieldId == null ? undefined : st(var_core_value_sig3FC7),
  ...
  _normalizeCalendarConfig(var_core_value_sigF569, var_core_value_sig2A9F) {
    let var_core_value_sigB14A = this._resolveCalendarDateFieldId(var_core_value_sigF569, var_core_value_sig2A9F.startDateFieldId),
      ...
      var_core_value_sigEF80 = var_core_value_sig4D6A && var_core_value_sig4D6A.system !== true && var_core_value_sig4D6A.type !== e.BaseFieldType['RecordId'] ? var_core_value_sig2A9F.titleFieldId : var_core_value_sigF569.primaryFieldId,
    ...
    return {
      ...
      'fieldSettings': Object.fromEntries(Object.entries(var_core_value_sig2A9F.fieldSettings ?? {}).filter(([var_core_value_sig89E6]) => {
        ...
        return !!(var_core_value_sig4743 && var_core_value_sig4743.system !== true && var_core_value_sig4743.type !== e.BaseFieldType["RecordId"]);
      }))
    };
  }
  ...
  _isCalendarDateField(var_core_value_sigA77A, var_core_value_sig0701) {
    ...
    return !!var_core_value_sig5DCA && var_core_value_sig5DCA.type === e.BaseFieldType["Date"] && var_core_value_sig5DCA.readonly !== true && var_core_value_sig5DCA.system !== true && this._capabilities(var_core_value_sig5DCA).usableAsCalendarDate;
  }
  _normalizeCalendarDisplayColor(var_core_value_sigF1AB, var_core_value_sig902F) {
    ...
    if ((var_core_value_sig6BD7 == null ? undefined : var_core_value_sig6BD7.type) === "selectField") {
      ...
      if (var_core_value_sig3D46 && var_core_value_sig3D46.type === e.BaseFieldType["SingleSelect"]) return var_core_value_sig6BD7;
    }
    ...
    if (var_core_value_sig902F.colorFieldId) {
      ...
      if (var_core_value_sigCC93 && var_core_value_sigCC93.type === e.BaseFieldType["SingleSelect"]) return {
        'type': "selectField",
  ...
  _calendarEventColor(var_core_value_sig63E0, var_core_value_sig1B87, var_core_value_sig580B) {
    ...
    if ((var_core_value_sig4836 == null ? undefined : var_core_value_sig4836.type) === "selectField") {
      ...
      return var_core_value_sig2A26 == null || (var_core_value_sig4C06 = Ar(var_core_value_sig5964, String(var_core_value_sig2A26))) == null ? undefined : var_core_value_sig4C06.color;
    }
  ...
  _buildGantt(var_core_value_sig9414, var_core_value_sig32E7) {
    ...
    if (!var_core_value_sig3A441 || var_core_value_sig3A441.type !== e.BaseFieldType['Date'] || var_core_value_sig3A441.readonly === true || var_core_value_sig3A441.system === true || !this._capabilities(var_core_value_sig3A441).usableAsGanttStart) return {
      'type': "invalid",
    ...
    if (!var_core_value_sig0642 || var_core_value_sig0642.type !== e.BaseFieldType["Date"] || var_core_value_sig0642.readonly === true || var_core_value_sig0642.system === true || !this._capabilities(var_core_value_sig0642).usableAsGanttEnd) return {
      'type': "invalid",
      'viewType': e.BaseViewType["Gantt"],
    ...
    let var_core_value_sig786E = this._isAllDayGanttDateRange(var_core_value_sig3A441, var_core_value_sig0642),
      ...
      var_core_value_sig48E2 = var_core_value_sigFC47.flatMap(var_core_value_sig1179 => {
        let var_core_value_sigEA92 = st(var_core_value_sig1179.values[var_core_value_sigD8C3.startDateFieldId]),
          var_core_value_sig8FD9 = st(var_core_value_sig1179.values[var_core_value_sigD8C3.endDateFieldId]);
        ...
        return [{
          ...
          'workingDayCount': var_core_value_sigD8C3.workingDaysOnly ? yr(var_core_value_sig1AE5, var_core_value_sig7100, var_core_value_sigD8C3.workingDays) : undefined,
          'dependencyRecordIds': this._recordIds(var_core_value_sig1179.values[var_core_value_sigD8C3.dependencyFieldId ?? ''])
        }];
      }),
      var_core_value_sig2FCA = var_core_value_sig48E2.length ? K(Math.min(...var_core_value_sig48E2.map(var_core_value_sigD3F5 => var_core_value_sigD3F5.start)) - 90 * er) : K(Date.now() - 90 * er),
      var_core_value_sig04F2 = var_core_value_sig48E2.length ? K(Math.max(...var_core_value_sig48E2.map(var_core_value_sig3082 => var_core_value_sig3082.end)) + 91 * er) : K(Date.now() + 91 * er),
      var_core_value_sig2CFC = dr(var_core_value_sigD8C3.scale, var_core_value_sig2FCA, var_core_value_sig04F2, var_core_value_sigD8C3.workingDaysOnly ? var_core_value_sigD8C3.workingDays : undefined);
    return {
      'type': e.BaseViewType["Gantt"],
  ...
  _normalizeGanttConfig(var_core_value_sig5CEB, var_core_value_sig4935) {
    let var_core_value_sig1832 = this._resolveGanttDateFieldId(var_core_value_sig5CEB, var_core_value_sig4935.startDateFieldId, "start"),
      ...
      var_core_value_sigBBE4 = var_core_value_sig5E01 && var_core_value_sig5E01.system !== true && var_core_value_sig5E01.type !== e.BaseFieldType["RecordId"] ? var_core_value_sig4935.titleFieldId : var_core_value_sig5CEB.primaryFieldId,
      ...
      var_core_value_sig9CF2 = ur(var_core_value_sig4935.workingDays);
    return {
      ...
      'fieldSettings': Object.fromEntries(Object.entries(var_core_value_sig4935.fieldSettings ?? {}).filter(([var_core_value_sigF5D1]) => {
        ...
        return !!(var_core_value_sig8775 && var_core_value_sig8775.system !== true && var_core_value_sig8775.type !== e.BaseFieldType["RecordId"]);
      })),
  ...
  _isGanttDateField(var_core_value_sig62231, var_core_value_sig7653, var_core_value_sigF65B) {
    ...
    if (!var_core_value_sig4A94 || var_core_value_sig4A94.type !== e.BaseFieldType["Date"] || var_core_value_sig4A94.readonly === true || var_core_value_sig4A94.system === true) return false;
  ...
  _normalizeGanttDisplayColor(var_core_value_sigD9B0, var_core_value_sigB7D6) {
    ...
    if ((var_core_value_sigCF1F == null ? undefined : var_core_value_sigCF1F.type) === 'selectField') {
      ...
      if (var_core_value_sig13D7 && var_core_value_sig13D7.type === e.BaseFieldType["SingleSelect"]) return var_core_value_sigCF1F;
    }
    ...
    if ((var_core_value_sig9D8F == null ? undefined : var_core_value_sig9D8F.type) === 'selectField') {
      ...
      if (var_core_value_sigC2BB) {
        ...
        let var_core_value_sig2902 = var_core_value_sig1293.values[var_core_value_sig9D8F.fieldId],
          ...
          var_core_value_sig698E = var_core_value_sig9989 == null || (var_core_value_sig8270 = Ar(var_core_value_sigC2BB, String(var_core_value_sig9989))) == null ? undefined : var_core_value_sig8270.color;
  ...
  _matchesGanttColorRule(var_core_value_sig95D9, var_core_value_sig0E92, var_core_value_sig45CD) {
    ...
    return var_core_value_sigAD84 ? _t(var_core_value_sig0E92.values[var_core_value_sigAD84.id], var_core_value_sig45CD.operator, var_core_value_sig45CD.operand, var_core_value_sigAD84, {
  ...
  _normalizeGalleryConfig(var_core_value_sigBBA2, var_core_value_sigC9A1) {
    ...
    return {
      ...
      'fieldSettings': Object.fromEntries(Object.entries(var_core_value_sigC9A1.fieldSettings ?? {}).filter(([var_core_value_sigA363]) => {
        ...
        return !!(var_core_value_sigFBA5 && var_core_value_sigFBA5.system !== true && var_core_value_sigFBA5.type !== e.BaseFieldType["RecordId"]);
      })),
      'card': {
  ...
  _resolveCardTitleFieldId(var_core_value_sig422B, var_core_value_sig1038) {
    ...
    return var_core_value_sigC3E6 && var_core_value_sigC3E6.system !== true && var_core_value_sigC3E6.type !== e.BaseFieldType["RecordId"] ? var_core_value_sigC3E6.id : Gn(var_core_value_sig422B);
  }
  ...
  _resolveGalleryCardFieldIds(var_core_value_sigD4B1, var_core_value_sigE5D8, var_core_value_sig74AF) {
    ...
    let var_core_value_sigF909 = var_core_value_sig74AF.fieldSettings ?? {},
      var_core_value_sigDD0E = ((var_core_value_sigBABA = var_core_value_sig74AF.card) == null ? undefined : var_core_value_sigBABA.titleFieldId) ?? Gn(var_core_value_sigD4B1),
      ...
      var_core_value_sig116F = (var_core_value_sig991C = var_core_value_sig74AF.card) != null && (var_core_value_sig991C = var_core_value_sig991C.fieldIds) != null && var_core_value_sig991C.length ? var_core_value_sig74AF.card["fieldIds"] : Kn(var_core_value_sigD4B1, [var_core_value_sigDD0E, var_core_value_sigF2A0, var_core_value_sigD4B1.primaryFieldId]);
    return var_core_value_sig116F.filter(var_core_value_sigAC47 => {
      ...
      return !(!var_core_value_sig4654 || var_core_value_sig4654.system === true || var_core_value_sig4654.type === e.BaseFieldType["RecordId"] || var_core_value_sig4654.id === var_core_value_sigDD0E || var_core_value_sig4654.id === var_core_value_sigF2A0 || (var_core_value_sigA06F = var_core_value_sigE5D8.fieldSettings) != null && (var_core_value_sigA06F = var_core_value_sigA06F[var_core_value_sigAC47]) != null && var_core_value_sigA06F.hidden || (var_core_value_sig770E = var_core_value_sigF909[var_core_value_sigAC47]) != null && var_core_value_sig770E.hidden);
  ...
  _projectFields(var_core_value_sigA64C, var_core_value_sigAF94) {
    ...
    return ((var_core_value_sig1E9F = var_core_value_sigAF94.fieldOrder) != null && var_core_value_sig1E9F.length ? var_core_value_sigAF94.fieldOrder : var_core_value_sigA64C.fieldOrder).flatMap(var_core_value_sigA8C3 => {
      ...
      return !var_core_value_sig031B || var_core_value_sig031B.system === true || var_core_value_sig031B.type === e.BaseFieldType["RecordId"] || var_core_value_sig9DC0.hidden ? [] : [{
  ...
  _projectRows(var_core_value_sig3CC6, var_core_value_sig041B) {
    ...
    return O("BaseProjection.projectRows", () => {
      ...
      let var_core_value_sig308A = O("BaseProjection.filterAndSortRows", () => this._sortRows(var_core_value_sig3CC6, var_core_value_sig041B, this._filterRows(var_core_value_sig3CC6, var_core_value_sig041B, var_core_value_sigE718)), {
  ...
  _projectTableRows(var_core_value_sig62F3) {
    ...
    return O('BaseProjection.projectTableRows', () => {
      ...
      if (var_core_value_sig9E20 && var_core_value_sig9E20.globalRevision === this._globalRevision && var_core_value_sig9E20.tableRevision === this._getTableRevision(var_core_value_sig62F3.id)) {
        if (var_core_value_sig9E20.cellRevision === var_core_value_sigA309 && or(var_core_value_sig9E20.table, var_core_value_sig62F3)) return var_core_value_sig9E20.table = var_core_value_sig62F3, var_core_value_sig9E20.rows;
      ...
      ir(var_core_value_sig62F3) || k(var_core_value_sig62F3);
      let var_core_value_sig26BB = (var_core_value_sig528D = var_core_value_sig62F3.recordOrder) != null && var_core_value_sig528D.length ? var_core_value_sig62F3.recordOrder : lr(var_core_value_sig62F3.records),
        var_core_value_sig19B4 = O('BaseProjection.materializeTableRows', () => {
          ...
          for (let var_core_value_sig480E of var_core_value_sig26BB) {
            ...
            for (let var_core_value_sig7524 of var_core_value_sig62F3.fieldOrder) var_core_value_sigC9E0[var_core_value_sig7524] = ge(var_core_value_sig62F3, var_core_value_sig4D4C.id, var_core_value_sig7524);
      ...
      return this._projectedRowsCache["set"](var_core_value_sig62F3.id, {
        ...
        'rowIndexById': rr(var_core_value_sig19B4),
        'globalRevision': this._globalRevision,
  ...
  _patchProjectedRowsForCellInvalidations(var_core_value_sig555A, var_core_value_sigF562, var_core_value_sig5913) {
    ...
    for (let [var_core_value_sigFDEE, var_core_value_sigA676] of var_core_value_sig7EE4) {
      ...
      var_core_value_sigA676.forEach(var_core_value_sig26DB => {
        var_core_value_sigBECE[var_core_value_sig26DB] = ge(var_core_value_sig555A, var_core_value_sigFDEE, var_core_value_sig26DB);
  ...
  _filterRows(var_core_value_sig0214, var_core_value_sig5153, var_core_value_sigF323) {
    ...
    let var_core_value_sig1D89 = var_core_value_sig0C32.conditions["filter"](var_core_value_sig040A => !kr(var_core_value_sig040A));
    return var_core_value_sig1D89.length ? var_core_value_sigF323.filter(var_core_value_sig2AE0 => {
      if (var_core_value_sig0C32.conjunction === e.BaseFilterConjunction['OR']) {
  ...
  _sortRows(var_core_value_sig2616, var_core_value_sig97EF, var_core_value_sigA0C0) {
    ...
    return var_core_value_sig06EA.length ? this._canUseFastSort(var_core_value_sig06EA) ? this._fastSortRows(var_core_value_sig06EA, var_core_value_sigA0C0) : [...var_core_value_sigA0C0].sort((var_core_value_sig2776, var_core_value_sig6FB2) => {
      for (let var_core_value_sig7F72 of var_core_value_sig06EA) {
        ...
        if (var_core_value_sig4383 !== 0) return var_core_value_sig7F72.direction === e.BaseSortDirection["DESC"] ? -var_core_value_sig4383 : var_core_value_sig4383;
      }
      return 0;
    }) : var_core_value_sigA0C0;
  }
  _canUseFastSort(var_core_value_sigF3C7) {
    return var_core_value_sigF3C7.every(var_core_value_sigEB43 => $n.has(var_core_value_sigEB43.field['type']));
  }
  _fastSortRows(var_core_value_sig5633, var_core_value_sig2492) {
    return var_core_value_sig2492.map((var_core_value_sig4186, var_core_value_sigF963) => ({
      ...
      for (let var_core_value_sig06CD = 0; var_core_value_sig06CD < var_core_value_sig5633.length; var_core_value_sig06CD++) {
        let var_core_value_sig186C = Or(var_core_value_sigB608.keys[var_core_value_sig06CD], var_core_value_sigF866.keys[var_core_value_sig06CD]);
        if (var_core_value_sig186C !== 0) return var_core_value_sig5633[var_core_value_sig06CD].direction === e.BaseSortDirection["DESC"] ? -var_core_value_sig186C : var_core_value_sig186C;
      }
  ...
  _projectGroups(var_core_value_sig39F2, var_core_value_sigAD47, var_core_value_sig1722) {
    ...
    return O('BaseProjection.projectGroups', () => {
      ...
      for (let var_core_value_sig97A2 of var_core_value_sig1722) {
        ...
        for (let var_core_value_sigFBFA = 0; var_core_value_sigFBFA < var_core_value_sig2682.length; var_core_value_sigFBFA++) {
          let var_core_value_sig2AD8 = var_core_value_sig2682[var_core_value_sigFBFA],
            ...
            var_core_value_sig3EEE = nr(var_core_value_sig2AD0),
  ...
  _materializeGroups(var_core_value_sigF69D, var_core_value_sig7CB9, var_core_value_sigC1D8) {
    ...
    return var_core_value_sig524D && var_core_value_sigCD15.sort((var_core_value_sig37DB, var_core_value_sig5542) => {
      ...
      return var_core_value_sig524D === e.BaseSortDirection["DESC"] ? -var_core_value_sigE0A9 : var_core_value_sigE0A9;
...
tr = U([H(0, (0, e.Inject)(dn))], tr);
function nr(var_core_value_sig7D2B) {
  return var_core_value_sig7D2B == null ? '' : String(var_core_value_sig7D2B);
}
;
function rr(var_core_value_sigEA89) {
...
;
function ir(var_core_value_sig97B1) {
...
;
function ar(var_core_value_sigD238) {
  let var_core_value_sigA1F8 = (var_core_value_sigD238 == null ? undefined : var_core_value_sigD238.conditions["filter"](var_core_value_sig3FD5 => !kr(var_core_value_sig3FD5))) ?? [];
...
;
function or(var_core_value_sig71F3, var_core_value_sigD652) {
...
;
function sr(var_core_value_sig6289) {
...
;
function cr(var_core_value_sigB20A) {
  if (typeof var_core_value_sigB20A != "object" || !var_core_value_sigB20A) return JSON.stringify(var_core_value_sigB20A) ?? "undefined";
  if (Array.isArray(var_core_value_sigB20A)) return '[' + var_core_value_sigB20A.map(cr).join(',') + ']';
  let var_core_value_sig0591 = var_core_value_sigB20A;
  return '{' + Object.keys(var_core_value_sig0591).sort().map(var_core_value_sig2D23 => JSON.stringify(var_core_value_sig2D23) + ':' + cr(var_core_value_sig0591[var_core_value_sig2D23])).join(',') + '}';
}
;
function lr(var_core_value_sigDBF1) {
...
;
function ur(var_core_value_sig56ED) {
  return {
    ...
    'exceptions': Array.isArray(var_core_value_sig56ED == null ? undefined : var_core_value_sig56ED.exceptions) ? var_core_value_sig56ED.exceptions["flatMap"](var_core_value_sig9B13 => !var_core_value_sig9B13 || !Number.isFinite(var_core_value_sig9B13.date) ? [] : [{
      ...
      'date': K(Number(var_core_value_sig9B13.date)),
      'name': String(var_core_value_sig9B13.name || "Working day"),
      'type': var_core_value_sig9B13.type === 'working' ? "working" : "off"
    }]) : []
  };
}
;
function dr(var_core_value_sigFD401, var_core_value_sigD649, var_core_value_sig0E88, var_core_value_sig13C8) {
  let var_core_value_sigE521 = hr(var_core_value_sigFD401, var_core_value_sigD649),
    var_core_value_sig0571 = gr(var_core_value_sigFD401, var_core_value_sig0E88),
    var_core_value_sig43F4 = fr(var_core_value_sigFD401, var_core_value_sigE521, var_core_value_sig0571, var_core_value_sig13C8);
  return {
    'scale': var_core_value_sigFD401,
    'start': var_core_value_sigE521,
    'end': var_core_value_sig0571,
    'unitWidth': mr(var_core_value_sigFD401),
    'majorHeaders': pr(var_core_value_sigFD401, var_core_value_sigE521, var_core_value_sig0571),
    'columns': var_core_value_sig43F4
  };
}
;
function fr(var_core_value_sig37F8, var_core_value_sig45D3, var_core_value_sigE2F3, var_core_value_sig9CB1) {
  let var_core_value_sigFB76 = [],
    var_core_value_sig58A5 = var_core_value_sig45D3;
  for (; var_core_value_sig58A5 < var_core_value_sigE2F3;) {
    let var_core_value_sig7620 = var_core_value_sig37F8 === "quarter" ? q(var_core_value_sig58A5, 7) : var_core_value_sig37F8 === "year" ? Tr(var_core_value_sig58A5, 1) : q(var_core_value_sig58A5, 1);
    var_core_value_sigFB76.push({
      'id': var_core_value_sig37F8 + '-' + var_core_value_sig58A5,
      'label': _r(var_core_value_sig37F8, var_core_value_sig58A5, var_core_value_sig7620),
      'majorLabel': vr(var_core_value_sig37F8, var_core_value_sig58A5),
      'start': var_core_value_sig58A5,
      'end': var_core_value_sig7620,
      'nonWorking': br(var_core_value_sig58A5, var_core_value_sig7620, var_core_value_sig9CB1)
    }), var_core_value_sig58A5 = var_core_value_sig7620;
  }
  return var_core_value_sigFB76;
}
;
function pr(var_core_value_sigA486, var_core_value_sigB0DE, var_core_value_sig6793) {
  let var_core_value_sigECD2 = [],
    var_core_value_sigD28E = var_core_value_sigA486 === 'year' ? wr(var_core_value_sigB0DE) : Cr(var_core_value_sigB0DE);
  for (; var_core_value_sigD28E < var_core_value_sig6793;) {
    let var_core_value_sigB9FC = var_core_value_sigA486 === "year" ? Er(var_core_value_sigD28E, 1) : Tr(var_core_value_sigD28E, 1);
    var_core_value_sigECD2.push({
      'id': "major-" + var_core_value_sigD28E,
      'label': var_core_value_sigA486 === 'year' ? String(new Date(var_core_value_sigD28E).getUTCFullYear()) : Dr(var_core_value_sigD28E),
...
;
function mr(var_core_value_sigB896) {
...
;
function hr(var_core_value_sig22D9, var_core_value_sig7E70) {
  return var_core_value_sig22D9 === 'year' ? wr(var_core_value_sig7E70) : var_core_value_sig22D9 === "quarter" ? Sr(var_core_value_sig7E70) : K(var_core_value_sig7E70);
}
;
function gr(var_core_value_sig9CCC, var_core_value_sigEB93) {
  return var_core_value_sig9CCC === "year" ? Er(wr(var_core_value_sigEB93), 1) : var_core_value_sig9CCC === 'quarter' ? q(Sr(var_core_value_sigEB93), 7) : q(K(var_core_value_sigEB93), 1);
}
;
function _r(var_core_value_sig8F13, var_core_value_sigAC84, var_core_value_sig1312) {
  let var_core_value_sig18A9 = new Date(var_core_value_sigAC84);
  return var_core_value_sig8F13 === 'quarter' ? var_core_value_sig18A9.getUTCDate() + '-' + new Date(var_core_value_sig1312 - er).getUTCDate() : var_core_value_sig8F13 === "year" ? var_core_value_sig18A9.toLocaleString("en-US", {
    'month': 'short',
    'timeZone': "UTC"
  }) : String(var_core_value_sig18A9.getUTCDate());
}
;
function vr(var_core_value_sigE028, var_core_value_sig8FC31) {
  return var_core_value_sigE028 === 'year' ? String(new Date(var_core_value_sig8FC31).getUTCFullYear()) : Dr(var_core_value_sig8FC31);
}
;
function yr(var_core_value_sig76A1, var_core_value_sig642F, var_core_value_sigF190) {
  let var_core_value_sig5BF0 = ur(var_core_value_sigF190),
    var_core_value_sig4144 = 0;
  for (let var_core_value_sig60E6 = K(var_core_value_sig76A1); var_core_value_sig60E6 <= K(var_core_value_sig642F); var_core_value_sig60E6 = q(var_core_value_sig60E6, 1)) xr(var_core_value_sig60E6, var_core_value_sig5BF0) || var_core_value_sig4144++;
  return var_core_value_sig4144;
}
;
function br(var_core_value_sig81CB, var_core_value_sig7C8C, var_core_value_sigF533) {
  if (!var_core_value_sigF533) return false;
  let var_core_value_sig018A = ur(var_core_value_sigF533);
  for (let var_core_value_sig1F6E = K(var_core_value_sig81CB); var_core_value_sig1F6E < var_core_value_sig7C8C; var_core_value_sig1F6E = q(var_core_value_sig1F6E, 1)) if (!xr(var_core_value_sig1F6E, var_core_value_sig018A)) return false;
  return true;
}
;
function xr(var_core_value_sigECD9, var_core_value_sig900B) {
  let var_core_value_sig82F5 = K(var_core_value_sigECD9),
    var_core_value_sigB2AC = var_core_value_sig900B.exceptions['find'](var_core_value_sig7A6B => K(var_core_value_sig7A6B.date) === var_core_value_sig82F5);
...
;
function K(var_core_value_sigDA36) {
...
;
function Sr(var_core_value_sigA9DF) {
  let var_core_value_sigBC94 = K(var_core_value_sigA9DF),
    var_core_value_sig018B = new Date(var_core_value_sigBC94).getUTCDay();
  return q(var_core_value_sigBC94, -(var_core_value_sig018B === 0 ? 6 : var_core_value_sig018B - 1));
}
;
function Cr(var_core_value_sig6F36) {
...
;
function wr(var_core_value_sig51CE) {
  let var_core_value_sigB5C9 = new Date(var_core_value_sig51CE);
  return Date.UTC(var_core_value_sigB5C9.getUTCFullYear(), 0, 1);
}
;
function q(var_core_value_sigFEE6, var_core_value_sig8700) {
  return var_core_value_sigFEE6 + var_core_value_sig8700 * er;
}
;
function Tr(var_core_value_sig723F2, var_core_value_sig70D4) {
...
;
function Er(var_core_value_sigE6AD, var_core_value_sigC4E91) {
...
;
function Dr(var_core_value_sig6818) {
...
;
function Or(var_core_value_sigA21D, var_core_value_sigB754) {
...
;
function kr(var_core_value_sig50E5) {
...
;
function Ar(var_core_value_sig4D3F, var_core_value_sigBE4F) {
...
let jr = function (var_core_value_sig2BE5) {
...
const J = {
  ...
  'handler'(var_core_value_sig79D6, var_core_value_sig6476) {
    let {
      ...
      var_core_value_sig40A0 = var_core_value_sig79D6.get(e.IUniverInstanceService).getUnit(var_core_value_sigAFF3, e.UniverInstanceType["UNIVER_BASE"]);
    if (!var_core_value_sig40A0) return false;
    let var_core_value_sig86F0 = var_core_value_sig40A0.getSnapshot(),
      var_core_value_sigE4B4 = new j(),
    ...
    return var_core_value_sig40A0.setSnapshot(var_core_value_sigED34), Mr(var_core_value_sigED34, var_core_value_sig1D8C, var_core_value_sig79D6.get(Qn)), true;
  }
};
function Mr(var_core_value_sig74CE, var_core_value_sig7FB9, var_core_value_sigAE9F) {
  ...
  for (let var_core_value_sigAEE0 of var_core_value_sig7FB9) {
    ...
    let var_core_value_sigBC91 = Nr(var_core_value_sig74CE, var_core_value_sigAEE0);
...
;
function Nr(var_core_value_sig6D7D, var_core_value_sig335B) {
...
const Pr = e.regexp["createRegExpFromSafeFragment"](String.raw`(?:^|\W)\$?[A-Z]{1,3}\$?\d+(?::\$?[A-Z]{1,3}\$?\d+)?(?:$|\W)`),
  Fr = e.regexp["createRegExpFromSafeFragment"](String.raw`(?:'\[[^\]]+\](?:[^']|'')+'|\[[^\]]+\][^\s'!]+)!\$?[A-Z]{1,3}\$?\d+(?::\$?[A-Z]{1,3}\$?\d+)?`, 'gi'),
  Ir = /\{([^}]+)\}/g,
  Lr = e.regexp["createRegExpFromSafeFragment"](String.raw`\b([A-Z_][\w.]*)\[\[\s*#(This Row|Data)\s*\],\s*\[([^\]]+)\]\]`, 'gi'),
  Rr = e.regexp['createRegExpFromSafeFragment'](String.raw`\b([A-Z_][\w.]*)\[@\[([^\]]+)\]\]`, 'gi'),
  zr = e.regexp["createRegExpFromSafeFragment"](String.raw`\b([A-Z_][\w.]*)\[([^\[\]#]+)\]`, 'gi'),
  Br = e.regexp["createRegExpFromSafeFragment"](String.raw`(^|[^\w\[])\[\[\s*#(This Row|Data)\s*\],\s*\[([^\]]+)\]\]`, 'gi'),
  Vr = e.regexp["createRegExpFromSafeFragment"](String.raw`(^|[^\w\[])\[@\[([^\]]+)\]\](?!\])`, 'g'),
  Hr = e.regexp['createRegExpFromSafeFragment'](String.raw`(^|[^\w\[])\[@?([^\[\]#]+)\](?!\])`, 'g');
var Ur = class {
  ...
  getSuperTableRegistrations(var_core_value_sig55FB, var_core_value_sig2870) {
    let var_core_value_sigC865 = [],
      ...
      var_core_value_sig7B1F = (0, e.createBaseFormulaTableNameMap)(var_core_value_sig55FB);
  ...
  validateFormula(var_core_value_sig7E51, var_core_value_sigAE87, var_core_value_sigFD51 = {}) {
    ...
    if (Yr(var_core_value_sigF6D6)) return {
      'valid': false,
      'reason': "[BaseFormula]: A1 references and ranges are not supported in Base formulas."
    };
    let var_core_value_sigCF95 = var_core_value_sigFD51.snapshot ? (0, e.createBaseFormulaTableNameMap)(var_core_value_sigFD51.snapshot) : undefined;
    for (let var_core_value_sig4161 of Jr(var_core_value_sigF6D6)) {
      let var_core_value_sigF564 = ri(var_core_value_sig4161, var_core_value_sigAE87, var_core_value_sigFD51.snapshot, var_core_value_sigCF95);
      if (!var_core_value_sigF564.table) return {
        'valid': false,
        'reason': '[BaseFormula]:\x20table\x20\x22' + var_core_value_sig4161.tableName + "\" does not exist. Use FBaseTable.getFormulaName() or getSchema().formulaName for structured references."
      };
      if (!var_core_value_sigF564.field) return {
        'valid': false,
        'reason': "[BaseFormula]: field \"" + var_core_value_sig4161.fieldName + "\" does not exist."
      };
    }
    return {
      'valid': true
  ...
  getStructuredDependencies(var_core_value_sig785C, var_core_value_sig6537, var_core_value_sig72BB = {}) {
    let var_core_value_sigC0DF = new Map(),
      var_core_value_sig94B7 = var_core_value_sig72BB.snapshot ? (0, e.createBaseFormulaTableNameMap)(var_core_value_sig72BB.snapshot) : undefined;
    for (let var_core_value_sig1F18 of Jr(var_core_value_sig785C)) {
      let var_core_value_sig8CFA = ri(var_core_value_sig1F18, var_core_value_sig6537, var_core_value_sig72BB.snapshot, var_core_value_sig94B7);
...
function Wr(var_core_value_sigBFDA, var_core_value_sig995C) {
  ...
  return var_core_value_sig4133 && Object.entries(var_core_value_sig4133).forEach(([var_core_value_sig9865, var_core_value_sigA09D]) => {
    ...
    let var_core_value_sigA339 = k(var_core_value_sig1429),
      var_core_value_sig832A = [];
    new e["ObjectMatrix"](var_core_value_sigA09D).forValue((var_core_value_sigD5A0, var_core_value_sig81B2, var_core_value_sigA0A5) => {
      let var_core_value_sig10AA = Gr(var_core_value_sigA339, var_core_value_sigD5A0, var_core_value_sig81B2, var_core_value_sigA0A5);
...
;
function Gr(var_core_value_sig8333, var_core_value_sigB171, var_core_value_sigA6AB, var_core_value_sigDC81) {
  ...
  let var_core_value_sigF4AD = String(((var_core_value_sig1D57 = var_core_value_sig54CD.config) == null ? undefined : var_core_value_sig1D57.formula) ?? '').trim(),
    ...
    var_core_value_sig90E4 = {
      ...
      't': qr(var_core_value_sigF802),
      ...(var_core_value_sigB171 === 0 && var_core_value_sigF4AD ? {
        'f': var_core_value_sigF4AD
      } : {}),
      'si': var_core_value_sig54CD.id
    };
  return Kr(he(var_core_value_sig8333, var_core_value_sig45F01, var_core_value_sig7AFB), var_core_value_sig90E4) ? null : {
...
;
function Kr(var_core_value_sig23B5, var_core_value_sigB560) {
...
;
function qr(var_core_value_sigB46F) {
  return typeof var_core_value_sigB46F == 'number' ? e.CellValueType["NUMBER"] : typeof var_core_value_sigB46F == "boolean" ? e.CellValueType['BOOLEAN'] : typeof var_core_value_sigB46F == "string" ? e.CellValueType["STRING"] : null;
}
;
function Jr(var_core_value_sig440F) {
  let var_core_value_sigB857 = Zr(var_core_value_sig440F, () => ''),
  ...
  for (let var_core_value_sig1166 of var_core_value_sigB857.matchAll(Ir)) var_core_value_sigFDAF({
    'fieldName': var_core_value_sig1166[1],
    'scope': "this-row"
  });
  var_core_value_sigB857 = var_core_value_sigB857.replace(Lr, (var_core_value_sig7ABC, var_core_value_sigF686, var_core_value_sigDFF0, var_core_value_sig01301) => (var_core_value_sigFDAF({
  ...
  }), '\x20')), var_core_value_sigB857 = var_core_value_sigB857.replace(Rr, (var_core_value_sigFD90, var_core_value_sig702C, var_core_value_sig03A4) => (var_core_value_sigFDAF({
    'tableName': var_core_value_sig702C,
    'fieldName': var_core_value_sig03A4,
    'scope': "this-row"
  }), '\x20')), var_core_value_sigB857 = var_core_value_sigB857.replace(Br, (var_core_value_sigB6F5, var_core_value_sig82931, var_core_value_sig43AE, var_core_value_sigEF2E) => (var_core_value_sigFDAF({
    'fieldName': var_core_value_sigEF2E,
    'scope': var_core_value_sig43AE.toLowerCase() === "data" ? "data" : 'this-row'
  }), var_core_value_sig82931 + '\x20')), var_core_value_sigB857 = var_core_value_sigB857.replace(Vr, (var_core_value_sigD83C, var_core_value_sigAC2B, var_core_value_sigFBBE) => (var_core_value_sigFDAF({
    'fieldName': var_core_value_sigFBBE,
    'scope': 'this-row'
  }), var_core_value_sigAC2B + '\x20'));
  for (let var_core_value_sigC982 of var_core_value_sigB857.matchAll(zr)) var_core_value_sigFDAF({
    'tableName': var_core_value_sigC982[1],
    'fieldName': var_core_value_sigC982[2]
  });
  for (let var_core_value_sig59DA of var_core_value_sigB857.matchAll(Hr)) var_core_value_sigFDAF({
...
;
function Yr(var_core_value_sigFC34) {
  let var_core_value_sig162E = Zr(var_core_value_sigFC34, () => '\x20').replace(Ir, '\x20').replace(Lr, '\x20').replace(Rr, '\x20').replace(Br, '$1\x20').replace(Vr, "$1 ").replace(zr, '\x20').replace(Hr, "$1 ");
  return Pr.test(var_core_value_sig162E);
}
;
function Xr(var_core_value_sigB564, var_core_value_sig5989) {
  return ti($r(var_core_value_sigB564, var_core_value_sig5989), var_core_value_sig5989);
}
;
function Zr(var_core_value_sigC36D, var_core_value_sig580E) {
  return Qr(Xr(var_core_value_sigC36D, var_core_value_sig580E), var_core_value_sig580E);
}
;
function Qr(var_core_value_sigF338, var_core_value_sig6EEE) {
  return var_core_value_sigF338.replace(/"(?:""|[^"])*"/g, var_core_value_sig6EEE);
}
;
function $r(var_core_value_sigC0CF, var_core_value_sig10D4) {
  return Fr.lastIndex = 0, var_core_value_sigC0CF.replace(Fr, (var_core_value_sig3002, var_core_value_sig33D2) => ni(var_core_value_sigC0CF, var_core_value_sig33D2) ? var_core_value_sig3002 : var_core_value_sig10D4(var_core_value_sig3002));
}
const ei = /(?:'((?:[^']|'')+)'|\[[^\]]+\]|[A-Za-z0-9_.-]+)![^\s!\[\]]+\[/g;
function ti(var_core_value_sigE597, var_core_value_sig4C3E) {
  let var_core_value_sig616D = [];
  for (ei.lastIndex = 0;;) {
    let var_core_value_sigE6D0 = ei.exec(var_core_value_sigE597);
    if (var_core_value_sigE6D0 == null) break;
    if (ni(var_core_value_sigE597, var_core_value_sigE6D0.index)) continue;
    let var_core_value_sig8E91 = ei.lastIndex - 1,
    ...
    for (let var_core_value_sig5B69 = var_core_value_sig8E91; var_core_value_sig5B69 < var_core_value_sigE597.length; var_core_value_sig5B69++) if (var_core_value_sigE597[var_core_value_sig5B69] === '[' && var_core_value_sig00BE++, var_core_value_sigE597[var_core_value_sig5B69] === ']' && (var_core_value_sig00BE--, var_core_value_sig00BE === 0)) {
      ...
      }), ei.lastIndex = var_core_value_sig5B69 + 1;
      break;
    }
  }
...
;
function ni(var_core_value_sig9AF9, var_core_value_sig662D) {
...
;
function ri(var_core_value_sig6050, var_core_value_sig896E, var_core_value_sig6D9B, var_core_value_sig9425) {
  let var_core_value_sigCE16 = ii(var_core_value_sig6050.tableName, var_core_value_sig896E, var_core_value_sig6D9B, var_core_value_sig9425);
  return {
...
;
function ii(var_core_value_sig0207, var_core_value_sig5FE7, var_core_value_sig5BA5, var_core_value_sig4F79) {
  ...
  let var_core_value_sigC182 = var_core_value_sig0207.toLowerCase(),
    var_core_value_sig1373 = var_core_value_sig4F79 ?? (0, e.createBaseFormulaTableNameMap)(var_core_value_sig5BA5),
    var_core_value_sig2D20 = Object.values(var_core_value_sig5BA5.tables).filter(var_core_value_sig8883 => {
      ...
      return var_core_value_sig8883.id["toLowerCase"]() === var_core_value_sigC182 || var_core_value_sig8883.name["toLowerCase"]() === var_core_value_sigC182 || ((var_core_value_sig488F = var_core_value_sig1373.get(var_core_value_sig8883.id)) == null ? undefined : var_core_value_sig488F.toLowerCase()) === var_core_value_sigC182 || ai(var_core_value_sig8883.id).toLowerCase() === var_core_value_sigC182;
    });
  return var_core_value_sig2D20.length === 1 ? var_core_value_sig2D20[0] : undefined;
}
;
function ai(var_core_value_sigB4E5) {
...
const oi = new Ur();
function si(var_core_value_sigA9C9, var_core_value_sigDA64, var_core_value_sigBE3F) {
  var var_core_value_sig072F;
  if (var_core_value_sigBE3F.type !== e.BaseFieldType["Formula"]) return true;
  ...
  return oi.validateFormula(var_core_value_sigD794, var_core_value_sigCB821.tables[var_core_value_sigDA64], {
    'snapshot': var_core_value_sigCB821
  }).valid;
}
;
function Y(var_core_value_sigB67E, var_core_value_sig7504, var_core_value_sigC2EA) {
...
;
function ci(var_core_value_sigD3D6, var_core_value_sig5BE71, var_core_value_sigFD72) {
  if (var_core_value_sigFD72.id === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sigFD72.type === e.BaseFieldType["RecordId"] || (0, e.isBaseRecordIdFieldName)(var_core_value_sigFD72.name) || !si(var_core_value_sigD3D6, var_core_value_sig5BE71, var_core_value_sigFD72)) return false;
  let var_core_value_sig3FA8 = var_core_value_sigD3D6.getSnapshot();
  if (!u(var_core_value_sig3FA8, var_core_value_sigFD72).valid) return false;
  if (var_core_value_sigFD72.type !== e.BaseFieldType['RecordLink']) return true;
  let var_core_value_sig4749 = o(var_core_value_sigFD72);
  if (!var_core_value_sig4749) return false;
  if (var_core_value_sig4749.relationRole === undefined) return true;
  if (var_core_value_sig4749.relationRole !== e.BaseRecordLinkRole["Parent"] || var_core_value_sig4749.targetTableId !== var_core_value_sig5BE71 || var_core_value_sig4749.multiple !== false) return false;
  ...
  return !Object.values(var_core_value_sig5D76.fields).some(var_core_value_sigA1B6 => {
    ...
    return var_core_value_sigA1B6.id !== var_core_value_sigFD72.id && var_core_value_sigA1B6.type === e.BaseFieldType["RecordLink"] && ((var_core_value_sig66A0 = o(var_core_value_sigA1B6)) == null ? undefined : var_core_value_sig66A0.relationRole) === e.BaseRecordLinkRole["Parent"];
  });
}
;
function li(var_core_value_sigB8B6, var_core_value_sig93DE, var_core_value_sigA278, var_core_value_sig4263) {
  ...
  return !var_core_value_sig8C06 || var_core_value_sig8C06.id === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig8C06.type === e.BaseFieldType["RecordId"] ? false : var_core_value_sig8C06.type !== e.BaseFieldType['RecordLink'] || d(var_core_value_sig1533, var_core_value_sig8C06, fi(var_core_value_sig4263)).valid;
}
;
function ui(var_core_value_sig04F0, var_core_value_sigCDD1, var_core_value_sig6C50) {
  let var_core_value_sig7926 = var_core_value_sig04F0.getSnapshot().tables[var_core_value_sigCDD1];
  return !var_core_value_sig7926 || !(0, e.isValidBaseRecordId)(var_core_value_sig6C50.id) || var_core_value_sig7926.records[var_core_value_sig6C50.id] || Object.prototype["hasOwnProperty"].call(var_core_value_sig6C50.values, e.BASE_RECORD_ID_FIELD_ID) && var_core_value_sig6C50.values[e.BASE_RECORD_ID_FIELD_ID] !== var_core_value_sig6C50.id ? false : Object.entries(var_core_value_sig6C50.values).every(([var_core_value_sig7876, var_core_value_sig2C69]) => var_core_value_sig7876 === e.BASE_RECORD_ID_FIELD_ID || li(var_core_value_sig04F0, var_core_value_sigCDD1, var_core_value_sig7876, var_core_value_sig2C69));
}
;
function di(var_core_value_sig88B3) {
  return {
    ...var_core_value_sig88B3,
    'values': {
      ...var_core_value_sig88B3.values,
      [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sig88B3.id
    }
  };
}
;
function fi(var_core_value_sig6044) {
...
;
function pi(var_core_value_sigEE54, var_core_value_sigBC8E, var_core_value_sig65B41, var_core_value_sig38F9) {
  ...
  let var_core_value_sigB70F = v(var_core_value_sig4EFC),
    var_core_value_sig50E51 = var_core_value_sigB70F ?? y(var_core_value_sig4EFC),
    ...
    var_core_value_sigEF27 = var_core_value_sigB70F ? var_core_value_sig4EFC.fields[var_core_value_sigB70F] : var_core_value_sig8AD2 ? b(var_core_value_sig4EFC, var_core_value_sig50E51, var_core_value_sig38F9) : null,
  ...
  for (let var_core_value_sigF27A of var_core_value_sig65B41) {
    let var_core_value_sigA694 = var_core_value_sigF27A.values[var_core_value_sig50E51],
      ...
      var_core_value_sig0428 = fi(var_core_value_sigA694),
      var_core_value_sigBE07 = null;
    if (var_core_value_sig18E01) {
      if (typeof var_core_value_sig0428 != "string" || !l(var_core_value_sig0428, false).valid) return null;
    ...
    }), !ui(var_core_value_sigEE54, var_core_value_sigBC8E, {
    ...
    var_core_value_sigBE07 !== null && (var_core_value_sig3D6F[var_core_value_sig50E51] = var_core_value_sigBE07), var_core_value_sigD45F.push(di({
      ...var_core_value_sigF27A,
  ...
  return {
    ...
    'hierarchyChanges': C(var_core_value_sig4EFC, var_core_value_sigD45F)
  };
}
const mi = {
    ...
    'handler'(var_core_value_sig9764, var_core_value_sig397B) {
      ...
      let var_core_value_sigC2FF = var_core_value_sig9764.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig8A75,
          tableId: var_core_value_sigCA67,
          records: var_core_value_sigDFDA
        } = var_core_value_sig397B,
        var_core_value_sigEAA1 = var_core_value_sigC2FF.getUnit(var_core_value_sig8A75, e.UniverInstanceType["UNIVER_BASE"]),
        var_core_value_sig77BA = var_core_value_sigDFDA.map(var_core_value_sig47B3 => var_core_value_sig47B3.id);
      if (!var_core_value_sigEAA1 || !Y(var_core_value_sigEAA1, var_core_value_sigCA67) || new Set(var_core_value_sig77BA).size !== var_core_value_sig77BA.length) return false;
      let var_core_value_sig9ED0 = var_core_value_sig9764.get(e.ICommandService),
        var_core_value_sigB650 = var_core_value_sig9764.get(e.IUndoRedoService),
        var_core_value_sig74A81 = var_core_value_sig9764.get(G),
        var_core_value_sigC129 = var_core_value_sigEAA1.getSnapshot(),
        var_core_value_sig59D5 = pi(var_core_value_sigEAA1, var_core_value_sigCA67, var_core_value_sigDFDA);
      ...
      let {
        ...
        var_core_value_sigC043 = A([...(var_core_value_sig7D3E ? [var_core_value_sig7D3E] : []), var_core_value_sig9D1B]),
        var_core_value_sig12F21 = new j().invertOp(var_core_value_sigC129, var_core_value_sigC043),
      ...
      return var_core_value_sig9ED0.syncExecuteCommand(J.id, var_core_value_sig3B28) ? (var_core_value_sigC2FF.focusUnit(var_core_value_sig8A75), var_core_value_sigB650.pushUndoRedo({
        'unitID': var_core_value_sig8A75,
        'undoMutations': [{
          'id': J.id,
  ...
  hi = {
    ...
    'handler': (var_core_value_sig88B7, var_core_value_sigB177) => {
      ...
      let var_core_value_sig9946 = var_core_value_sig88B7.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig731A,
          tableId: var_core_value_sig8E75,
          recordIds: var_core_value_sigF462
        } = var_core_value_sigB177,
        var_core_value_sigF519 = var_core_value_sig9946.getUnit(var_core_value_sig731A, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sigF519 || !Y(var_core_value_sigF519, var_core_value_sig8E75, {
        'recordIds': var_core_value_sigF462
      })) return false;
      let var_core_value_sig80A1 = var_core_value_sig88B7.get(e.ICommandService),
        var_core_value_sigA8D7 = var_core_value_sig88B7.get(e.IUndoRedoService),
        var_core_value_sig5BB8 = var_core_value_sigF519.getSnapshot(),
        var_core_value_sig784F = T(var_core_value_sig5BB8.tables[var_core_value_sig8E75], var_core_value_sigF462),
        var_core_value_sig29001 = new I(),
        var_core_value_sigF735 = new j(),
      ...
      return var_core_value_sig80A1.syncExecuteCommand(J.id, var_core_value_sig57A3) ? (var_core_value_sig9946.focusUnit(var_core_value_sig731A), var_core_value_sigA8D7.pushUndoRedo({
        'unitID': var_core_value_sig731A,
        'undoMutations': [{
          'id': J.id,
  ...
  gi = {
    ...
    'handler': (var_core_value_sig9B63, var_core_value_sigA86B) => {
      ...
      let var_core_value_sig8CE0 = var_core_value_sig9B63.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig9E58 = var_core_value_sig8CE0.getUnit(var_core_value_sig2D89, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig9E58 || var_core_value_sig5C06 === e.BASE_RECORD_ID_FIELD_ID || !Y(var_core_value_sig9E58, var_core_value_sig08CE, {
        'fieldIds': [var_core_value_sig5C06]
      })) return false;
      let var_core_value_sigD105 = var_core_value_sig9B63.get(e.ICommandService),
        var_core_value_sig6F7E = var_core_value_sig9B63.get(e.IUndoRedoService),
        var_core_value_sig3F21 = var_core_value_sig9E58.getSnapshot();
      if (!ci(var_core_value_sig9E58, var_core_value_sig08CE, {
        ...var_core_value_sig3F21.tables[var_core_value_sig08CE].fields[var_core_value_sig5C06],
        ...var_core_value_sigA267
      })) return false;
      let var_core_value_sig22FF = new I().changeFieldType(var_core_value_sig3F21, var_core_value_sig08CE, var_core_value_sig5C06, var_core_value_sigA267),
        var_core_value_sig3189 = new j().invertOp(var_core_value_sig3F21, var_core_value_sig22FF),
      ...
      return var_core_value_sigD105.syncExecuteCommand(J.id, var_core_value_sigA5F8) ? (var_core_value_sig8CE0.focusUnit(var_core_value_sig2D89), var_core_value_sig6F7E.pushUndoRedo({
        'unitID': var_core_value_sig2D89,
        'undoMutations': [{
          'id': J.id,
  ...
  _i = {
    ...
    'handler'(var_core_value_sig11F1, var_core_value_sigA71D) {
      ...
      let {
          unitId: var_core_value_sig0461,
          tableId: var_core_value_sig4A6A,
          parentRecordId: var_core_value_sig52B7
        } = var_core_value_sigA71D,
        var_core_value_sig5BA8 = var_core_value_sig11F1.get(e.IUniverInstanceService),
        var_core_value_sig6CA3 = var_core_value_sig5BA8.getUnit(var_core_value_sig0461, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig6CA3 || !Y(var_core_value_sig6CA3, var_core_value_sig4A6A, {
      ...
      let var_core_value_sig489C = var_core_value_sig6CA3.getSnapshot(),
        ...
        var_core_value_sigAD59 = v(var_core_value_sig9BF2),
        var_core_value_sigD8D7 = var_core_value_sigAD59 ?? var_core_value_sigA71D.fieldId ?? y(var_core_value_sig9BF2);
      if (var_core_value_sigAD59 && var_core_value_sigA71D.fieldId && var_core_value_sigA71D.fieldId !== var_core_value_sigAD59 || var_core_value_sig9BF2.fields[var_core_value_sigD8D7] && !_(var_core_value_sig9BF2, var_core_value_sigD8D7)) throw new h("invalidField");
      if ((E(var_core_value_sig9BF2, var_core_value_sigD8D7).depthByRecordId['get'](var_core_value_sig52B7) ?? 0) + 1 >= 5) throw new h("maxDepth");
      if (!ui(var_core_value_sig6CA3, var_core_value_sig4A6A, var_core_value_sigA71D.record)) return false;
      let var_core_value_sigDD66 = di({
          ...var_core_value_sigA71D.record,
          'values': {
            ...var_core_value_sigA71D.record['values'],
            [var_core_value_sigD8D7]: c([var_core_value_sig52B7])
          }
        }),
        var_core_value_sigDCB6 = var_core_value_sig11F1.get(G),
        var_core_value_sigA346 = new I(),
        var_core_value_sigDB37 = var_core_value_sig9BF2.fields[var_core_value_sigD8D7],
        var_core_value_sig2400 = var_core_value_sigDB37 ? ((var_core_value_sig669B = o(var_core_value_sigDB37)) == null ? undefined : var_core_value_sig669B.relationRole) === e.BaseRecordLinkRole['Parent'] ? null : var_core_value_sigA346.updateField(var_core_value_sig489C, var_core_value_sig4A6A, var_core_value_sigD8D7, {
          'config': {
            ...var_core_value_sigDB37.config,
            'relationRole': e.BaseRecordLinkRole["Parent"]
          }
        }) : var_core_value_sigDCB6.createCreateFieldOp(var_core_value_sig6CA3, var_core_value_sig4A6A, b(var_core_value_sig9BF2, var_core_value_sigD8D7, var_core_value_sigA71D.parentFieldName), var_core_value_sig9BF2.fieldOrder["length"]),
        ...
        var_core_value_sigCBAB = A([...(var_core_value_sig2400 ? [var_core_value_sig2400] : []), var_core_value_sig33E7]),
        var_core_value_sigE3A5 = new j().invertOp(var_core_value_sig489C, var_core_value_sigCBAB),
      ...
      return var_core_value_sig11F1.get(e.ICommandService).syncExecuteCommand(J.id, var_core_value_sig2D30) ? (var_core_value_sig5BA8.focusUnit(var_core_value_sig0461), var_core_value_sig11F1.get(e.IUndoRedoService).pushUndoRedo({
        'unitID': var_core_value_sig0461,
        'undoMutations': [{
          'id': J.id,
  ...
  vi = {
    ...
    'handler'(var_core_value_sigA2D7, var_core_value_sig0A36) {
      ...
      let var_core_value_sig87E7 = var_core_value_sigA2D7.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigA30D = var_core_value_sig87E7.getUnit(var_core_value_sig52761, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sigA30D || !Y(var_core_value_sigA30D, var_core_value_sig0B66) || var_core_value_sigA30D.getSnapshot().tables[var_core_value_sig0B66].fields[var_core_value_sig8E9E.id] || var_core_value_sig9A69 === 0 || !ci(var_core_value_sigA30D, var_core_value_sig0B66, var_core_value_sig8E9E)) return false;
      let var_core_value_sig4F28 = var_core_value_sigA2D7.get(e.ICommandService),
        var_core_value_sigE7DA = var_core_value_sigA2D7.get(e.IUndoRedoService),
        var_core_value_sig56D11 = var_core_value_sigA2D7.get(G).createCreateFieldOp(var_core_value_sigA30D, var_core_value_sig0B66, var_core_value_sig8E9E, var_core_value_sig9A69, var_core_value_sig2A04),
        var_core_value_sig2EDE = new j().invertOp(var_core_value_sigA30D.getSnapshot(), var_core_value_sig56D11),
      ...
      return var_core_value_sig4F28.syncExecuteCommand(J.id, var_core_value_sig70CD) ? (var_core_value_sig87E7.focusUnit(var_core_value_sig52761), var_core_value_sigE7DA.pushUndoRedo({
        'unitID': var_core_value_sig52761,
        'undoMutations': [{
          'id': J.id,
  ...
  yi = {
    ...
    'handler'(var_core_value_sig89B2, var_core_value_sigE594) {
      ...
      let var_core_value_sig63D7 = var_core_value_sig89B2.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig2E441,
          tableId: var_core_value_sig6814,
          record: var_core_value_sig0A10
        } = var_core_value_sigE594,
        var_core_value_sig9E19 = var_core_value_sig63D7.getUnit(var_core_value_sig2E441, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig9E19 || !Y(var_core_value_sig9E19, var_core_value_sig6814)) return false;
      let var_core_value_sigC832 = var_core_value_sig89B2.get(e.ICommandService),
        var_core_value_sig9DD2 = var_core_value_sig89B2.get(e.IUndoRedoService),
        var_core_value_sigDB97 = var_core_value_sig89B2.get(G),
        var_core_value_sigD1A5 = var_core_value_sig9E19.getSnapshot(),
        var_core_value_sigA91A = pi(var_core_value_sig9E19, var_core_value_sig6814, [var_core_value_sig0A10]);
      ...
      let [var_core_value_sig2DE0] = var_core_value_sigA91A.records,
        ...
        var_core_value_sigABC5 = A([...(var_core_value_sig5CE7 ? [var_core_value_sig5CE7] : []), var_core_value_sig3662]),
        var_core_value_sig033B = new j().invertOp(var_core_value_sigD1A5, var_core_value_sigABC5),
      ...
      return var_core_value_sigC832.syncExecuteCommand(J.id, var_core_value_sig2BCC) ? (var_core_value_sig63D7.focusUnit(var_core_value_sig2E441), var_core_value_sig9DD2.pushUndoRedo({
        'unitID': var_core_value_sig2E441,
        'undoMutations': [{
          'id': J.id,
...
function bi(var_core_value_sigAAA8, var_core_value_sigA0B9, var_core_value_sigB40F) {
  ...
  if (!(0, e.nameCharacterCheck)(var_core_value_sigA0B9)) return {
    'valid': false,
    'reason': 'Choose\x20another\x20name.',
    'error': "invalid"
  };
...
;
function xi(var_core_value_sig078D, var_core_value_sig60D5) {
  ...
  for (;;) {
    ...
    if (bi(var_core_value_sig078D, var_core_value_sig6E68).valid) return var_core_value_sig6E68;
...
const Si = {
  ...
  'handler': (var_core_value_sig2381, var_core_value_sig573D) => {
    ...
    let var_core_value_sigC09F = var_core_value_sig2381.get(e.IUniverInstanceService),
      {
        unitId: var_core_value_sig205A,
        table: var_core_value_sig16E2,
        index: var_core_value_sig8904
      } = var_core_value_sig573D,
      var_core_value_sigBA69 = var_core_value_sigC09F.getUnit(var_core_value_sig205A, e.UniverInstanceType["UNIVER_BASE"]);
    if (!var_core_value_sigBA69 || var_core_value_sigBA69.getSnapshot().tables[var_core_value_sig16E2.id] || !bi(var_core_value_sigBA69.getSnapshot(), var_core_value_sig16E2.name).valid) return false;
    try {
      (0, e.assertBaseTableRecordIdentity)(var_core_value_sig16E2);
    } catch {
      return false;
    }
    let var_core_value_sig4AC2 = var_core_value_sig2381.get(e.ICommandService),
      var_core_value_sig08B2 = var_core_value_sig2381.get(e.IUndoRedoService),
      var_core_value_sigDE7F = var_core_value_sigBA69.getSnapshot(),
      var_core_value_sigD898 = new I().createTable(var_core_value_sigDE7F, var_core_value_sig16E2, var_core_value_sig8904),
      var_core_value_sig0386 = new j().invertOp(var_core_value_sigDE7F, var_core_value_sigD898),
    ...
    return var_core_value_sig4AC2.syncExecuteCommand(J.id, var_core_value_sig577B) ? (var_core_value_sigC09F.focusUnit(var_core_value_sig205A), var_core_value_sig08B2.pushUndoRedo({
      'unitID': var_core_value_sig205A,
      'undoMutations': [{
        'id': J.id,
...
function Ci(var_core_value_sig7871, var_core_value_sig7CBA, var_core_value_sigC924 = []) {
...
;
function wi(var_core_value_sig12EE, var_core_value_sigEB89) {
...
function Di(var_core_value_sig820E, var_core_value_sigA753, var_core_value_sigEF41, var_core_value_sig9793) {
  var var_core_value_sigDB87;
  let var_core_value_sig2858 = new I(),
    ...
    var_core_value_sigEA13 = var_core_value_sig2683 ? {
      ...
      'fieldOrder': [e.BASE_RECORD_ID_FIELD_ID, ...(var_core_value_sigEF41.fieldOrder ?? var_core_value_sig2683.fieldOrder).filter(var_core_value_sig96F5 => var_core_value_sig96F5 !== e.BASE_RECORD_ID_FIELD_ID)],
      'fieldSettings': {
        ...var_core_value_sigEF41.fieldSettings,
        [e.BASE_RECORD_ID_FIELD_ID]: {
          ...((var_core_value_sigDB87 = var_core_value_sigEF41.fieldSettings) == null ? undefined : var_core_value_sigDB87[e.BASE_RECORD_ID_FIELD_ID]),
          'hidden': true
        }
      }
    } : var_core_value_sigEF41;
  if (var_core_value_sig2683 && var_core_value_sigEA13.type === "kanban") {
    let var_core_value_sig7F54 = ki(var_core_value_sig2683, var_core_value_sigEA13),
    ...
    return A([...var_core_value_sig7F54.fields["map"](var_core_value_sig8DFE => var_core_value_sig2858.createField(var_core_value_sig820E, var_core_value_sigA753, {
  ...
  let var_core_value_sig1699 = Oi(var_core_value_sig2683, var_core_value_sigEA13),
  ...
  return var_core_value_sigEA13.type === "gantt" && Mi(var_core_value_sigEA13) && (var_core_value_sig42E9 = Ni(var_core_value_sig2683, var_core_value_sig42E9, var_core_value_sig1699.fields)), A([...var_core_value_sig1699.fields["map"](var_core_value_sig0623 => var_core_value_sig2858.createField(var_core_value_sig820E, var_core_value_sigA753, {
...
;
function Oi(var_core_value_sig0B64, var_core_value_sig3BFC, var_core_value_sig9CF5 = false) {
  var var_core_value_sig5BFB, var_core_value_sig47A3;
  let var_core_value_sig7CA8 = var_core_value_sig0B64.fieldOrder['filter'](var_core_value_sigBF43 => Fi(var_core_value_sig0B64, var_core_value_sigBF43)),
    var_core_value_sig1B33 = [],
    var_core_value_sig041A = {
      ...(var_core_value_sig3BFC.config ?? {})
    },
    var_core_value_sig7E4F = typeof var_core_value_sig041A.startDateFieldId == "string" && Fi(var_core_value_sig0B64, var_core_value_sig041A.startDateFieldId) ? var_core_value_sig041A.startDateFieldId : var_core_value_sig7CA8[0],
    var_core_value_sig5A6A = typeof var_core_value_sig041A.endDateFieldId == 'string' && Fi(var_core_value_sig0B64, var_core_value_sig041A.endDateFieldId) && var_core_value_sig041A.endDateFieldId !== var_core_value_sig7E4F ? var_core_value_sig041A.endDateFieldId : var_core_value_sig7CA8.find(var_core_value_sigBC08 => var_core_value_sigBC08 !== var_core_value_sig7E4F);
  if (!var_core_value_sig7E4F) {
    let var_core_value_sig3F28 = Ii(var_core_value_sig0B64, var_core_value_sig1B33, var_core_value_sig3BFC.type === 'gantt' ? "Start date" : "Date");
  ...
  if ((var_core_value_sig3BFC.type === "gantt" || var_core_value_sig9CF5) && !var_core_value_sig5A6A) {
    let var_core_value_sig0A16 = Ii(var_core_value_sig0B64, var_core_value_sig1B33, "End date");
  ...
  let var_core_value_sig7E71 = wi(var_core_value_sig3BFC.fieldOrder, var_core_value_sig1B33.map(var_core_value_sig0A96 => var_core_value_sig0A96.id));
  return {
    'changed': var_core_value_sig1B33.length > 0 || var_core_value_sig041A.startDateFieldId !== ((var_core_value_sig5BFB = var_core_value_sig3BFC.config) == null ? undefined : var_core_value_sig5BFB.startDateFieldId) || var_core_value_sig041A.endDateFieldId !== ((var_core_value_sig47A3 = var_core_value_sig3BFC.config) == null ? undefined : var_core_value_sig47A3.endDateFieldId) || !!(var_core_value_sig7E71 && !e.Tools["diffValue"](var_core_value_sig7E71, var_core_value_sig3BFC.fieldOrder ?? [])),
...
;
function ki(var_core_value_sig14B7, var_core_value_sig7D2C) {
  var var_core_value_sigE10A;
  let var_core_value_sig0AE5 = [],
    var_core_value_sig57CC = {
      ...(var_core_value_sig7D2C.config ?? {})
    },
    var_core_value_sig2932 = typeof var_core_value_sig57CC.groupFieldId == "string" && Ai(var_core_value_sig14B7, var_core_value_sig57CC.groupFieldId) ? var_core_value_sig57CC.groupFieldId : var_core_value_sig14B7.fieldOrder['find'](var_core_value_sig72FE => Ai(var_core_value_sig14B7, var_core_value_sig72FE));
  if (!var_core_value_sig2932) {
    let var_core_value_sigE8ED = ji(var_core_value_sig14B7, var_core_value_sig0AE5);
  ...
  let var_core_value_sigA067 = wi(var_core_value_sig7D2C.fieldOrder, var_core_value_sig0AE5.map(var_core_value_sig6DD3 => var_core_value_sig6DD3.id));
  return {
    'changed': var_core_value_sig0AE5.length > 0 || var_core_value_sig57CC.groupFieldId !== ((var_core_value_sigE10A = var_core_value_sig7D2C.config) == null ? undefined : var_core_value_sigE10A.groupFieldId) || !!(var_core_value_sigA067 && !e.Tools["diffValue"](var_core_value_sigA067, var_core_value_sig7D2C.fieldOrder ?? [])),
...
;
function Ai(var_core_value_sig0CB3, var_core_value_sigE0F3) {
  let var_core_value_sig7330 = var_core_value_sigE0F3 ? var_core_value_sig0CB3.fields[var_core_value_sigE0F3] : null;
  return var_core_value_sig7330 ? [e.BaseFieldType["SingleSelect"], e.BaseFieldType["MultiSelect"], e.BaseFieldType["Rating"], e.BaseFieldType["Person"], e.BaseFieldType["Group"], e.BaseFieldType["Checkbox"]].includes(var_core_value_sig7330.type) : false;
}
;
function ji(var_core_value_sig2766, var_core_value_sig1BD2) {
  return {
    'id': "fld-" + (0, e.generateRandomId)(8),
    'name': Ci(var_core_value_sig2766, "Status", var_core_value_sig1BD2),
    'type': e.BaseFieldType["SingleSelect"],
    'config': e.Tools["deepClone"](Ti)
  };
}
;
function Mi(var_core_value_sig2CA0) {
  return Object.keys(var_core_value_sig2CA0.config ?? {}).length === 0 && Object.keys(var_core_value_sig2CA0.fieldSettings ?? {}).length === 0;
}
;
function Ni(var_core_value_sigDD2D, var_core_value_sig8880, var_core_value_sig005B) {
  let var_core_value_sig6383 = {
    ...
    var_core_value_sig2F83 = typeof var_core_value_sig6383.titleFieldId == "string" && Pi(var_core_value_sigDD2D, var_core_value_sig005B, var_core_value_sig6383.titleFieldId) ? var_core_value_sig6383.titleFieldId : var_core_value_sigDD2D.primaryFieldId,
    ...
    var_core_value_sigECB51 = new Set([var_core_value_sig2F83, var_core_value_sig4AD6, var_core_value_sig83CC].filter(var_core_value_sigCDF2 => var_core_value_sigCDF2 && Pi(var_core_value_sigDD2D, var_core_value_sig005B, var_core_value_sigCDF2))),
    var_core_value_sigEC7A = Object.fromEntries(var_core_value_sig8589.flatMap(var_core_value_sig1043 => var_core_value_sigECB51.has(var_core_value_sig1043) || !Pi(var_core_value_sigDD2D, var_core_value_sig005B, var_core_value_sig1043) ? [] : [[var_core_value_sig1043, {
      'hidden': true
    }]]));
  return {
...
;
function Pi(var_core_value_sig3C20, var_core_value_sig55A0, var_core_value_sig6F0A) {
...
;
function Fi(var_core_value_sig193F, var_core_value_sig5227) {
  let var_core_value_sig8CB8 = var_core_value_sig5227 ? var_core_value_sig193F.fields[var_core_value_sig5227] : null;
  return !!var_core_value_sig8CB8 && var_core_value_sig8CB8.type === e.BaseFieldType["Date"] && var_core_value_sig8CB8.readonly !== true && var_core_value_sig8CB8.system !== true;
}
;
function Ii(var_core_value_sigBE77, var_core_value_sig9700, var_core_value_sigB461) {
  let var_core_value_sigDDFF = new Set([...Object.keys(var_core_value_sigBE77.fields), ...var_core_value_sig9700.map(var_core_value_sig2729 => var_core_value_sig2729.id)]),
    var_core_value_sig52C1 = 'fld-' + (0, e.generateRandomId)(8);
  for (; var_core_value_sigDDFF.has(var_core_value_sig52C1);) var_core_value_sig52C1 = 'fld-' + (0, e.generateRandomId)(8);
  return {
    'id': var_core_value_sig52C1,
    'name': Ci(var_core_value_sigBE77, var_core_value_sigB461, var_core_value_sig9700),
    'type': e.BaseFieldType['Date'],
    'config': {
      ...Ei
    }
  };
...
const Li = {
    ...
    'handler': (var_core_value_sigFA8C, var_core_value_sig19C6) => {
      ...
      let var_core_value_sigDB89 = var_core_value_sigFA8C.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig9717 = var_core_value_sigDB89.getUnit(var_core_value_sigCBF6, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sig9717 || !Y(var_core_value_sig9717, var_core_value_sigE0DD) || var_core_value_sig9717.getSnapshot().tables[var_core_value_sigE0DD].views[var_core_value_sig9874.id]) return false;
      let var_core_value_sig7C72 = var_core_value_sigFA8C.get(e.ICommandService),
        var_core_value_sigECAB = var_core_value_sigFA8C.get(e.IUndoRedoService),
        var_core_value_sigEB4B = var_core_value_sig9717.getSnapshot(),
        var_core_value_sigF741 = Di(var_core_value_sigEB4B, var_core_value_sigE0DD, var_core_value_sig9874, var_core_value_sig61DE),
        var_core_value_sigB227 = new j().invertOp(var_core_value_sigEB4B, var_core_value_sigF741),
      ...
      return var_core_value_sig7C72.syncExecuteCommand(J.id, var_core_value_sigCFC5) ? (var_core_value_sigDB89.focusUnit(var_core_value_sigCBF6), var_core_value_sigECAB.pushUndoRedo({
        'unitID': var_core_value_sigCBF6,
        'undoMutations': [{
          'id': J.id,
  ...
  Ri = {
    ...
    'handler'(var_core_value_sig9B6A1, var_core_value_sigEA29) {
      ...
      let var_core_value_sig3851 = var_core_value_sig9B6A1.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sigE1D0,
          tableId: var_core_value_sig8AFC,
          fieldId: var_core_value_sigA761
        } = var_core_value_sigEA29,
        var_core_value_sig0996 = var_core_value_sig3851.getUnit(var_core_value_sigE1D0, e.UniverInstanceType["UNIVER_BASE"]);
      ...
      if (!Y(var_core_value_sig0996, var_core_value_sig8AFC, {
        'fieldIds': [var_core_value_sigA761]
      }) || var_core_value_sigB201.primaryFieldId === var_core_value_sigA761 || var_core_value_sigA761 === e.BASE_RECORD_ID_FIELD_ID) return false;
      let var_core_value_sigFB17 = var_core_value_sig9B6A1.get(e.ICommandService),
        var_core_value_sigCA91 = var_core_value_sig9B6A1.get(e.IUndoRedoService),
        var_core_value_sig372C = new I().deleteField(var_core_value_sig09E0, var_core_value_sig8AFC, var_core_value_sigA761),
        var_core_value_sig98F9 = new j().invertOp(var_core_value_sig09E0, var_core_value_sig372C),
      ...
      return var_core_value_sigFB17.syncExecuteCommand(J.id, var_core_value_sig3F40) ? (var_core_value_sig3851.focusUnit(var_core_value_sigE1D0), var_core_value_sigCA91.pushUndoRedo({
        'unitID': var_core_value_sigE1D0,
        'undoMutations': [{
          'id': J.id,
  ...
  zi = {
    ...
    'handler': (var_core_value_sig3047, var_core_value_sig19A5) => {
      ...
      let var_core_value_sigC5EA = var_core_value_sig3047.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sigC9A11,
          tableId: var_core_value_sigF92E,
          recordId: var_core_value_sig70AE
        } = var_core_value_sig19A5,
        var_core_value_sig57BC = var_core_value_sigC5EA.getUnit(var_core_value_sigC9A11, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig57BC || !Y(var_core_value_sig57BC, var_core_value_sigF92E, {
        'recordIds': [var_core_value_sig70AE]
      })) return false;
      let var_core_value_sig41AB = var_core_value_sig3047.get(e.ICommandService),
        var_core_value_sigCDAC = var_core_value_sig3047.get(e.IUndoRedoService),
        var_core_value_sigDC24 = var_core_value_sig57BC.getSnapshot(),
        var_core_value_sig3875 = T(var_core_value_sigDC24.tables[var_core_value_sigF92E], [var_core_value_sig70AE]),
        var_core_value_sig5513 = new I(),
        var_core_value_sig6048 = new j(),
      ...
      return var_core_value_sig41AB.syncExecuteCommand(J.id, var_core_value_sig5939) ? (var_core_value_sigC5EA.focusUnit(var_core_value_sigC9A11), var_core_value_sigCDAC.pushUndoRedo({
        'unitID': var_core_value_sigC9A11,
        'undoMutations': [{
          'id': J.id,
  ...
  Bi = {
    ...
    'handler': (var_core_value_sig619B, var_core_value_sig3F16) => {
      ...
      let var_core_value_sig6C48 = var_core_value_sig619B.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig9140,
          tableId: var_core_value_sig1CF9
        } = var_core_value_sig3F16,
        var_core_value_sigC63A = var_core_value_sig6C48.getUnit(var_core_value_sig9140, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sigC63A || !Y(var_core_value_sigC63A, var_core_value_sig1CF9)) return false;
      let var_core_value_sig1D3B = var_core_value_sig619B.get(e.ICommandService),
        var_core_value_sig453A = var_core_value_sig619B.get(e.IUndoRedoService),
        var_core_value_sigEE97 = var_core_value_sigC63A.getSnapshot(),
        var_core_value_sig1DE5 = f(var_core_value_sigEE97, var_core_value_sig1CF9);
      if (var_core_value_sig1DE5.length > 0) return console.error('[DeleteBaseTableCommand]:\x20table\x20\x22' + var_core_value_sig1CF9 + "\" is referenced by " + var_core_value_sig1DE5.map(var_core_value_sig5C75 => var_core_value_sig5C75.tableId + '.' + var_core_value_sig5C75.fieldId).join(',\x20') + '.'), false;
      let var_core_value_sigB51C = new I().deleteTable(var_core_value_sigEE97, var_core_value_sig1CF9),
        var_core_value_sig1426 = new j().invertOp(var_core_value_sigEE97, var_core_value_sigB51C),
      ...
      return var_core_value_sig1D3B.syncExecuteCommand(J.id, var_core_value_sigEA3C) ? (var_core_value_sig6C48.focusUnit(var_core_value_sig9140), var_core_value_sig453A.pushUndoRedo({
        'unitID': var_core_value_sig9140,
        'undoMutations': [{
          'id': J.id,
  ...
  Vi = {
    ...
    'handler': (var_core_value_sig073B, var_core_value_sig4B16) => {
      ...
      let var_core_value_sig3649 = var_core_value_sig073B.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sigD0F3,
          tableId: var_core_value_sig415D,
          viewId: var_core_value_sig0A15
        } = var_core_value_sig4B16,
        var_core_value_sig7113 = var_core_value_sig3649.getUnit(var_core_value_sigD0F3, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig7113 || !Y(var_core_value_sig7113, var_core_value_sig415D, {
        'viewIds': [var_core_value_sig0A15]
      })) return false;
      let var_core_value_sig1555 = var_core_value_sig073B.get(e.ICommandService),
        var_core_value_sigC06C = var_core_value_sig073B.get(e.IUndoRedoService),
        ...
        var_core_value_sig05B7 = new I().deleteView(var_core_value_sigF8D0, var_core_value_sig415D, var_core_value_sig0A15),
        var_core_value_sig19F01 = new j().invertOp(var_core_value_sigF8D0, var_core_value_sig05B7),
      ...
      return var_core_value_sig1555.syncExecuteCommand(J.id, var_core_value_sigF035) ? (var_core_value_sig3649.focusUnit(var_core_value_sigD0F3), var_core_value_sigC06C.pushUndoRedo({
        'unitID': var_core_value_sigD0F3,
        'undoMutations': [{
          'id': J.id,
  ...
  Hi = {
    ...
    'handler': (var_core_value_sig417D, var_core_value_sig73B7) => {
      ...
      let var_core_value_sig4DEF = var_core_value_sig417D.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig9D16 = var_core_value_sig4DEF.getUnit(var_core_value_sigF576, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig9D16 || !Y(var_core_value_sig9D16, var_core_value_sig3087, {
        'fieldIds': [var_core_value_sigC30C]
      }) || var_core_value_sigC30C === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig9D16.getSnapshot().tables[var_core_value_sig3087].fields[var_core_value_sigAE4D.id] || var_core_value_sigA2D5 === 0 || !ci(var_core_value_sig9D16, var_core_value_sig3087, var_core_value_sigAE4D)) return false;
      let var_core_value_sig540B = var_core_value_sig417D.get(e.ICommandService),
        var_core_value_sig70CA = var_core_value_sig417D.get(e.IUndoRedoService),
        var_core_value_sig19C7 = var_core_value_sig9D16.getSnapshot(),
        var_core_value_sigEC6A = new I().duplicateField(var_core_value_sig19C7, var_core_value_sig3087, var_core_value_sigC30C, {
          'field': var_core_value_sigAE4D,
          'index': var_core_value_sigA2D5,
          'viewIndexes': var_core_value_sig7B4C
        }),
        var_core_value_sig3DA8 = new j().invertOp(var_core_value_sig19C7, var_core_value_sigEC6A),
      ...
      return var_core_value_sig540B.syncExecuteCommand(J.id, var_core_value_sig2F57) ? (var_core_value_sig4DEF.focusUnit(var_core_value_sigF576), var_core_value_sig70CA.pushUndoRedo({
        'unitID': var_core_value_sigF576,
        'undoMutations': [{
          'id': J.id,
  ...
  Ui = {
    ...
    'handler': (var_core_value_sig79B6, var_core_value_sigA36D) => {
      ...
      let var_core_value_sig1DE9 = var_core_value_sig79B6.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig0CBE = var_core_value_sig1DE9.getUnit(var_core_value_sig1DE4, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig0CBE || !Y(var_core_value_sig0CBE, var_core_value_sig67091, {
        'recordIds': [var_core_value_sigA9B7]
      }) || !ui(var_core_value_sig0CBE, var_core_value_sig67091, var_core_value_sigD810)) return false;
      let var_core_value_sig8085 = var_core_value_sig79B6.get(e.ICommandService),
        var_core_value_sigC59C = var_core_value_sig79B6.get(e.IUndoRedoService),
        var_core_value_sigB778 = var_core_value_sig0CBE.getSnapshot(),
        var_core_value_sig54E6 = di(var_core_value_sigD810),
        var_core_value_sigE9DB = C(var_core_value_sigB778.tables[var_core_value_sig67091], [var_core_value_sig54E6]),
        var_core_value_sigE26F1 = new I().duplicateRecord(var_core_value_sigB778, var_core_value_sig67091, var_core_value_sigA9B7, var_core_value_sig54E6),
        var_core_value_sig8C20 = new j().invertOp(var_core_value_sigB778, var_core_value_sigE26F1),
      ...
      return var_core_value_sig8085.syncExecuteCommand(J.id, var_core_value_sigBB73) ? (var_core_value_sig1DE9.focusUnit(var_core_value_sig1DE4), var_core_value_sigC59C.pushUndoRedo({
        'unitID': var_core_value_sig1DE4,
        'undoMutations': [{
          'id': J.id,
  ...
  Wi = {
    ...
    'handler'(var_core_value_sig9385, var_core_value_sigE5B5) {
      ...
      let var_core_value_sig8483 = var_core_value_sig9385.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigFA86 = var_core_value_sig8483.getUnit(var_core_value_sig7DCC, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sigFA86 || !Y(var_core_value_sigFA86, var_core_value_sig5C37, {
      ...
      let var_core_value_sigE2431 = Oi(var_core_value_sigEDC3, var_core_value_sigA965, var_core_value_sig6620 === true);
      if (!var_core_value_sigE2431.changed) return false;
      let var_core_value_sig2AA5 = var_core_value_sig9385.get(e.ICommandService),
        var_core_value_sig65F4 = var_core_value_sig9385.get(e.IUndoRedoService),
        var_core_value_sig74FC = new I(),
        ...
        })), Gi([...Ki(var_core_value_sigE5B5.tableId, var_core_value_sigE5B5.viewId), 'config'], var_core_value_sigA965.config, var_core_value_sigE2431.config)];
      var_core_value_sigE2431.fieldOrder && var_core_value_sig107B.push(Gi([...Ki(var_core_value_sigE5B5.tableId, var_core_value_sigE5B5.viewId), 'fieldOrder'], var_core_value_sigA965.fieldOrder, var_core_value_sigE2431.fieldOrder));
      let var_core_value_sig9C8C = A(var_core_value_sig107B),
        var_core_value_sig0141 = new j().invertOp(var_core_value_sigC7E1, var_core_value_sig9C8C),
      ...
      return var_core_value_sig2AA5.syncExecuteCommand(J.id, var_core_value_sig687E) ? (var_core_value_sig8483.focusUnit(var_core_value_sig7DCC), var_core_value_sig65F4.pushUndoRedo({
        'unitID': var_core_value_sig7DCC,
        'undoMutations': [{
          'id': J.id,
...
function Gi(var_core_value_sig07AB, var_core_value_sigD6F3, var_core_value_sig5CA6) {
  return var_core_value_sigD6F3 === undefined ? e.JSON1['insertOp'](var_core_value_sig07AB, var_core_value_sig5CA6) : e.JSON1["replaceOp"](var_core_value_sig07AB, var_core_value_sigD6F3, var_core_value_sig5CA6);
}
;
function Ki(var_core_value_sigFA26, var_core_value_sig3D8F) {
...
const qi = {
    ...
    'handler': (var_core_value_sig9BED, var_core_value_sig5349) => {
      ...
      let var_core_value_sig8232 = var_core_value_sig9BED.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig5CFD = var_core_value_sig8232.getUnit(var_core_value_sig38F6, e.UniverInstanceType['UNIVER_BASE']),
        var_core_value_sig3EB3 = var_core_value_sig32BA.beforeFieldId ?? var_core_value_sig32BA.afterFieldId;
      if (!var_core_value_sig5CFD || !!var_core_value_sig32BA.beforeFieldId == !!var_core_value_sig32BA.afterFieldId || !var_core_value_sig3EB3 || var_core_value_sig3EB3 === var_core_value_sigA2BF || var_core_value_sigA2BF === e.BASE_RECORD_ID_FIELD_ID || var_core_value_sig32BA.beforeFieldId === e.BASE_RECORD_ID_FIELD_ID || !Y(var_core_value_sig5CFD, var_core_value_sigBE37, {
        'fieldIds': [var_core_value_sigA2BF, var_core_value_sig3EB3]
      })) return false;
      let var_core_value_sig5C7C1 = var_core_value_sig9BED.get(e.ICommandService),
        var_core_value_sig89EE = var_core_value_sig9BED.get(e.IUndoRedoService),
        var_core_value_sigCE7B = var_core_value_sig5CFD.getSnapshot(),
        var_core_value_sigBFA9 = new I().moveField(var_core_value_sigCE7B, var_core_value_sigBE37, var_core_value_sigA2BF, var_core_value_sig32BA),
        var_core_value_sig6DF71 = new j().invertOp(var_core_value_sigCE7B, var_core_value_sigBFA9),
      ...
      return var_core_value_sig5C7C1.syncExecuteCommand(J.id, var_core_value_sig00CB1) ? (var_core_value_sig8232.focusUnit(var_core_value_sig38F6), var_core_value_sig89EE.pushUndoRedo({
        'unitID': var_core_value_sig38F6,
        'undoMutations': [{
          'id': J.id,
  ...
  Ji = {
    ...
    'handler': (var_core_value_sigFBED, var_core_value_sigF447) => {
      ...
      let {
        ...
        var_core_value_sigD10D = var_core_value_sigFBED.get(e.IUniverInstanceService),
        var_core_value_sigB8F4 = var_core_value_sigD10D.getUnit(var_core_value_sigE2E6, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sigB8F4 || !Y(var_core_value_sigB8F4, var_core_value_sig8FAB, {
      ...
      let var_core_value_sig79CD = var_core_value_sigB8F4.getSnapshot(),
        ...
        var_core_value_sig7591 = v(var_core_value_sig629F),
        var_core_value_sig76A8 = var_core_value_sig7591 ?? var_core_value_sigF447.fieldId ?? y(var_core_value_sig629F);
      if (var_core_value_sig7591 && var_core_value_sigF447.fieldId && var_core_value_sigF447.fieldId !== var_core_value_sig7591 || var_core_value_sig629F.fields[var_core_value_sig76A8] && !_(var_core_value_sig629F, var_core_value_sig76A8)) throw new h('invalidField');
      let var_core_value_sigB33E = E(var_core_value_sig629F, var_core_value_sig76A8),
        var_core_value_sig72901 = te(var_core_value_sigB33E, var_core_value_sig3524, var_core_value_sigEFDB);
      if (!var_core_value_sig72901.valid) throw new h(var_core_value_sig72901.reason === e.BaseHierarchyInvalidReason["SelfParent"] ? 'selfParent' : var_core_value_sig72901.reason === e.BaseHierarchyInvalidReason["Cycle"] ? "cycle" : "maxDepth");
      ...
      let var_core_value_sigEF9A = var_core_value_sig607E !== var_core_value_sigEFDB,
        ...
        var_core_value_sig1344 = new I(),
        var_core_value_sig01B7 = [],
        var_core_value_sig5392 = var_core_value_sig629F.fields[var_core_value_sig76A8],
        var_core_value_sig2473 = var_core_value_sigEF9A && (!var_core_value_sig5392 || ((var_core_value_sigF37C = o(var_core_value_sig5392)) == null ? undefined : var_core_value_sigF37C.relationRole) !== e.BaseRecordLinkRole["Parent"]) ? var_core_value_sig5392 ? var_core_value_sig1344.updateField(var_core_value_sig79CD, var_core_value_sig8FAB, var_core_value_sig76A8, {
          'config': {
            ...var_core_value_sig5392.config,
            'relationRole': e.BaseRecordLinkRole["Parent"]
          }
        }) : var_core_value_sigFBED.get(G).createCreateFieldOp(var_core_value_sigB8F4, var_core_value_sig8FAB, b(var_core_value_sig629F, var_core_value_sig76A8, var_core_value_sigF447.parentFieldName), var_core_value_sig629F.fieldOrder["length"]) : null;
      var_core_value_sig2473 && var_core_value_sig01B7.push(var_core_value_sig2473), var_core_value_sigEF9A && var_core_value_sig01B7.push(var_core_value_sig1344.updateCell(var_core_value_sig79CD, var_core_value_sig8FAB, var_core_value_sig3524, var_core_value_sig76A8, var_core_value_sigEFDB ? c([var_core_value_sigEFDB]) : '')), var_core_value_sigB040 && var_core_value_sig01B7.push(var_core_value_sig1344.updateRecordOrder(var_core_value_sig79CD, var_core_value_sig8FAB, var_core_value_sig3524, var_core_value_sigEFD1));
      let var_core_value_sig4FB1 = A(var_core_value_sig01B7),
      ...
      if (!var_core_value_sigFBED.get(e.ICommandService).syncExecuteCommand(J.id, var_core_value_sig7ED7)) return false;
      let var_core_value_sigCEE6 = var_core_value_sigB8F4.getSnapshot(),
        var_core_value_sig3CB8 = [];
      var_core_value_sigEF9A && var_core_value_sig3CB8.push(Yi(var_core_value_sigCEE6, var_core_value_sig79CD, var_core_value_sig8FAB, var_core_value_sig3524, var_core_value_sig76A8)), var_core_value_sigB040 && var_core_value_sig3CB8.push(Xi(var_core_value_sigCEE6, var_core_value_sig79CD, var_core_value_sig8FAB, var_core_value_sig3524)), var_core_value_sig2473 && var_core_value_sig3CB8.push(new j().invertOp(var_core_value_sig79CD, var_core_value_sig2473));
      let var_core_value_sig3EF5 = {
        'unitId': var_core_value_sigE2E6,
        'op': A(var_core_value_sig3CB8),
        'trigger': Ji.id,
        'hierarchyChanges': [{
          ...var_core_value_sig3A0E,
      ...
      return var_core_value_sigD10D.focusUnit(var_core_value_sigE2E6), var_core_value_sigFBED.get(e.IUndoRedoService).pushUndoRedo({
        'unitID': var_core_value_sigE2E6,
        'undoMutations': [{
          'id': J.id,
...
function Yi(var_core_value_sigD0FA, var_core_value_sig7701, var_core_value_sig548B, var_core_value_sig7D37, var_core_value_sig781D) {
  ...
  let var_core_value_sig537D = var_core_value_sigD0FA.tables[var_core_value_sig548B],
    ...
    var_core_value_sigA07B = Zi(var_core_value_sig014D == null || var_core_value_sig2768 == null ? null : F.cellData(var_core_value_sig548B, var_core_value_sig014D, var_core_value_sig2768), var_core_value_sig68061, var_core_value_sig6D2F);
  var_core_value_sigA07B && var_core_value_sigA430.push(var_core_value_sigA07B);
  let var_core_value_sigE9BA = Zi(F.cell(var_core_value_sig548B, var_core_value_sig7D37, var_core_value_sig781D), var_core_value_sig7367, var_core_value_sigE7CE);
  return var_core_value_sigE9BA && var_core_value_sigA430.push(var_core_value_sigE9BA), A(var_core_value_sigA430);
}
;
function Xi(var_core_value_sig6083, var_core_value_sig28DE, var_core_value_sigE1B1, var_core_value_sig5E8D) {
...
const Qi = {
    ...
    'handler': (var_core_value_sig5D5E, var_core_value_sigAF62) => {
      ...
      let var_core_value_sigA394 = var_core_value_sig5D5E.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig63A2 = var_core_value_sigA394.getUnit(var_core_value_sig94AF, e.UniverInstanceType['UNIVER_BASE']),
        var_core_value_sig1F1F = var_core_value_sigA3B2.beforeViewId ?? var_core_value_sigA3B2.afterViewId;
      if (!var_core_value_sig63A2 || !var_core_value_sig1F1F || var_core_value_sig1F1F === var_core_value_sigFA83 || !Y(var_core_value_sig63A2, var_core_value_sigFEB4, {
        'viewIds': [var_core_value_sigFA83, var_core_value_sig1F1F]
      })) return false;
      let var_core_value_sig32EC = var_core_value_sig5D5E.get(e.ICommandService),
        var_core_value_sig37FF = var_core_value_sig5D5E.get(e.IUndoRedoService),
        var_core_value_sigF340 = var_core_value_sig63A2.getSnapshot(),
        var_core_value_sig6001 = new I().moveView(var_core_value_sigF340, var_core_value_sigFEB4, var_core_value_sigFA83, var_core_value_sigA3B2),
        var_core_value_sig27FF = new j().invertOp(var_core_value_sigF340, var_core_value_sig6001),
      ...
      return var_core_value_sig32EC.syncExecuteCommand(J.id, var_core_value_sigAF69) ? (var_core_value_sigA394.focusUnit(var_core_value_sig94AF), var_core_value_sig37FF.pushUndoRedo({
        'unitID': var_core_value_sig94AF,
        'undoMutations': [{
          'id': J.id,
  ...
  $i = {
    ...
    'handler': (var_core_value_sigE580, var_core_value_sig6B3D) => {
      ...
      let var_core_value_sig6642 = var_core_value_sigE580.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig93C3,
          tableId: var_core_value_sigB034,
          name: var_core_value_sig0F42
        } = var_core_value_sig6B3D,
        var_core_value_sig147A1 = var_core_value_sig6642.getUnit(var_core_value_sig93C3, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig147A1 || !Y(var_core_value_sig147A1, var_core_value_sigB034) || !bi(var_core_value_sig147A1.getSnapshot(), var_core_value_sig0F42, var_core_value_sigB034).valid) return false;
      let var_core_value_sig6C47 = var_core_value_sigE580.get(e.ICommandService),
        var_core_value_sig8090 = var_core_value_sigE580.get(e.IUndoRedoService),
        var_core_value_sigFBF01 = var_core_value_sig147A1.getSnapshot(),
        var_core_value_sigE8F0 = new I().renameTable(var_core_value_sigFBF01, var_core_value_sigB034, var_core_value_sig0F42),
        var_core_value_sig7A47 = new j().invertOp(var_core_value_sigFBF01, var_core_value_sigE8F0),
      ...
      return var_core_value_sig6C47.syncExecuteCommand(J.id, var_core_value_sigE6A1) ? (var_core_value_sig6642.focusUnit(var_core_value_sig93C3), var_core_value_sig8090.pushUndoRedo({
        'unitID': var_core_value_sig93C3,
        'undoMutations': [{
          'id': J.id,
  ...
  ea = {
    ...
    'handler': (var_core_value_sig9D64, var_core_value_sig29E6) => {
      ...
      let var_core_value_sig7E15 = var_core_value_sig9D64.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig4CAF = var_core_value_sig7E15.getUnit(var_core_value_sig2493, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sig4CAF || !Y(var_core_value_sig4CAF, var_core_value_sig731D, {
        'viewIds': [var_core_value_sig2F24]
      })) return false;
      let var_core_value_sigBCDC = var_core_value_sig9D64.get(e.ICommandService),
        var_core_value_sig3FB8 = var_core_value_sig9D64.get(e.IUndoRedoService),
        var_core_value_sig2CB0 = var_core_value_sig4CAF.getSnapshot(),
        var_core_value_sig5762 = new I().renameView(var_core_value_sig2CB0, var_core_value_sig731D, var_core_value_sig2F24, var_core_value_sigDA3A),
        var_core_value_sigFE00 = new j().invertOp(var_core_value_sig2CB0, var_core_value_sig5762),
      ...
      return var_core_value_sigBCDC.syncExecuteCommand(J.id, var_core_value_sigB03D) ? (var_core_value_sig7E15.focusUnit(var_core_value_sig2493), var_core_value_sig3FB8.pushUndoRedo({
        'unitID': var_core_value_sig2493,
        'undoMutations': [{
          'id': J.id,
  ...
  ta = {
    ...
    'handler': (var_core_value_sigB25D, var_core_value_sig7890) => {
      ...
      let var_core_value_sig06EC = var_core_value_sigB25D.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig436D = var_core_value_sig06EC.getUnit(var_core_value_sig2A4A, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig436D || !Y(var_core_value_sig436D, var_core_value_sig35B2, {
        'viewIds': [var_core_value_sig4B92],
        'fieldIds': [var_core_value_sig8A40]
      })) return false;
      let var_core_value_sig591B = var_core_value_sigB25D.get(e.ICommandService),
        var_core_value_sig4FBC = var_core_value_sigB25D.get(e.IUndoRedoService),
        var_core_value_sig71F0 = var_core_value_sig436D.getSnapshot(),
        var_core_value_sig0812 = new I().updateViewConfig(var_core_value_sig71F0, var_core_value_sig35B2, var_core_value_sig4B92, {
          'groupFieldId': var_core_value_sig8A40
        }),
        var_core_value_sigCF891 = new j().invertOp(var_core_value_sig71F0, var_core_value_sig0812),
      ...
      return var_core_value_sig591B.syncExecuteCommand(J.id, var_core_value_sigA14D) ? (var_core_value_sig06EC.focusUnit(var_core_value_sig2A4A), var_core_value_sig4FBC.pushUndoRedo({
        'unitID': var_core_value_sig2A4A,
        'undoMutations': [{
          'id': J.id,
  ...
  na = {
    ...
    'handler': (var_core_value_sig4AA7, var_core_value_sigC0CB) => {
      ...
      let var_core_value_sig7644 = var_core_value_sig4AA7.get(e.IUniverInstanceService),
        var_core_value_sig6497 = var_core_value_sig7644.getUnit(var_core_value_sigC0CB.unitId, e.UniverInstanceType["UNIVER_BASE"]);
      ...
      let var_core_value_sig2130 = new I(),
        var_core_value_sig5BC41 = new j(),
        var_core_value_sigD642 = [],
        var_core_value_sig187F = [],
        var_core_value_sig1D39 = [var_core_value_sig6497, ...var_core_value_sig7644.getAllUnitsForType(e.UniverInstanceType["UNIVER_BASE"]).filter(var_core_value_sigC11B => var_core_value_sigC11B.getUnitId() !== var_core_value_sigC0CB.unitId)];
      ...
      let var_core_value_sig0BE3 = var_core_value_sig4AA7.get(e.ICommandService),
        var_core_value_sigF681 = var_core_value_sig4AA7.get(e.IUndoRedoService),
        var_core_value_sigABEA = var_core_value_sigF681.__tempBatchingUndoRedo(var_core_value_sigC0CB.unitId);
      try {
        return (0, e.sequenceExecute)(var_core_value_sigD642, var_core_value_sig0BE3).result ? (var_core_value_sig7644.focusUnit(var_core_value_sigC0CB.unitId), var_core_value_sigF681.pushUndoRedo({
  ...
  ra = {
    ...
    'handler'(var_core_value_sig4200, var_core_value_sig09ED) {
      return !var_core_value_sig09ED || !Sn.includes(var_core_value_sig09ED.action) || var_core_value_sig09ED.objectId !== var_core_value_sig09ED.unitId && var_core_value_sig09ED.action !== n.UnitAction["Edit"] ? false : (Mn(var_core_value_sig4200.get(e.IPermissionService), var_core_value_sig09ED.unitId, var_core_value_sig09ED.objectId, var_core_value_sig09ED.action, var_core_value_sig09ED.value), true);
    }
  };
function ia(var_core_value_sig912B, var_core_value_sig60E8) {
  let var_core_value_sigC01F = k(e.Tools["deepClone"](var_core_value_sig912B)),
  ...
  return var_core_value_sig60E8.forEach(var_core_value_sigBA12 => {
    ...
    let var_core_value_sig6883 = ve(var_core_value_sigBA12.value, var_core_value_sig668D),
      var_core_value_sig2A05 = xe(var_core_value_sigBA12.value, var_core_value_sig6883, var_core_value_sig668D, var_core_value_sigC01F, var_core_value_sig7C2D),
...
const aa = {
    ...
    'handler'(var_core_value_sig25D9, var_core_value_sig171B) {
      ...
      let var_core_value_sigF2EF = var_core_value_sig25D9.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig9366,
          tableId: var_core_value_sigE8631,
          patches: var_core_value_sigB2CE1
        } = var_core_value_sig171B,
        var_core_value_sig18E9 = var_core_value_sigF2EF.getUnit(var_core_value_sig9366, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sig18E9 || !Y(var_core_value_sig18E9, var_core_value_sigE8631)) return false;
      let var_core_value_sigC0B9 = var_core_value_sig25D9.get(e.ICommandService),
        var_core_value_sig2F10 = var_core_value_sig25D9.get(e.IUndoRedoService),
        var_core_value_sigC1F2 = var_core_value_sig18E9.getSnapshot(),
        var_core_value_sigDA6F = k(var_core_value_sigC1F2.tables[var_core_value_sigE8631]),
      ...
      if (var_core_value_sig8583.length !== var_core_value_sigB2CE1.length || var_core_value_sig802A.length !== var_core_value_sigB2CE1.length || !Y(var_core_value_sig18E9, var_core_value_sigE8631, {
        'recordIds': var_core_value_sig8583,
        'fieldIds': var_core_value_sig802A
      }) || var_core_value_sigB2CE1.some((var_core_value_sig8B54, var_core_value_sigC19B) => !li(var_core_value_sig18E9, var_core_value_sigE8631, var_core_value_sig802A[var_core_value_sigC19B], var_core_value_sig8B54.value))) return false;
      let var_core_value_sig368A = S(var_core_value_sigDA6F, ia(var_core_value_sigDA6F, var_core_value_sigB2CE1)),
        ...
        var_core_value_sig015F = new I().setRangeValues(var_core_value_sigC1F2, var_core_value_sigE8631, var_core_value_sig89F9),
        var_core_value_sigC32D = new j().invertOp(var_core_value_sigC1F2, var_core_value_sig015F),
        var_core_value_sigEB9F = {
          'unitId': var_core_value_sig9366,
          'op': var_core_value_sig015F,
          'trigger': var_core_value_sig368A.length ? aa.id : undefined,
      ...
      return var_core_value_sigC0B9.syncExecuteCommand(J.id, var_core_value_sigE286) ? (var_core_value_sigF2EF.focusUnit(var_core_value_sig9366), var_core_value_sig2F10.pushUndoRedo({
        'unitID': var_core_value_sig9366,
        'undoMutations': [{
          'id': J.id,
  ...
  oa = {
    ...
    'handler'(var_core_value_sig91C3, var_core_value_sig63B3) {
      ...
      let var_core_value_sig150A = var_core_value_sig91C3.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig2074,
          tableId: var_core_value_sig038C,
          patches: var_core_value_sigE79F
        } = var_core_value_sig63B3,
        var_core_value_sigC725 = var_core_value_sig150A.getUnit(var_core_value_sig2074, e.UniverInstanceType["UNIVER_BASE"]),
      ...
      if (!var_core_value_sigC725 || !Y(var_core_value_sigC725, var_core_value_sig038C, {
        'recordIds': var_core_value_sigD836,
        'fieldIds': var_core_value_sigE06D
      }) || var_core_value_sigE79F.some(var_core_value_sig61E5 => Object.entries(var_core_value_sig61E5.values).some(([var_core_value_sig09F3, var_core_value_sig4592]) => !li(var_core_value_sigC725, var_core_value_sig038C, var_core_value_sig09F3, var_core_value_sig4592)))) return false;
      let var_core_value_sig8DC3 = S(var_core_value_sigC725.getSnapshot().tables[var_core_value_sig038C], var_core_value_sigE79F),
        var_core_value_sig194D = var_core_value_sig91C3.get(e.ICommandService),
        var_core_value_sigE5C1 = var_core_value_sig91C3.get(e.IUndoRedoService),
        var_core_value_sig81B0 = var_core_value_sig91C3.get(G).createSetRecordValuesOp(var_core_value_sigC725, var_core_value_sig038C, var_core_value_sigE79F),
        var_core_value_sig6DF72 = new j().invertOp(var_core_value_sigC725.getSnapshot(), var_core_value_sig81B0),
        var_core_value_sig8E2B = {
          'unitId': var_core_value_sig2074,
          'op': var_core_value_sig81B0,
          'trigger': var_core_value_sig8DC3.length ? oa.id : undefined,
      ...
      return var_core_value_sig194D.syncExecuteCommand(J.id, var_core_value_sig8E2B) ? (var_core_value_sig150A.focusUnit(var_core_value_sig2074), var_core_value_sigE5C1.pushUndoRedo({
        'unitID': var_core_value_sig2074,
        'undoMutations': [{
          'id': J.id,
  ...
  sa = {
    ...
    'handler': (var_core_value_sig6133, var_core_value_sigDCBA) => {
      ...
      let {
        ...
        var_core_value_sigB9DF = var_core_value_sig6133.get(e.IUniverInstanceService),
        var_core_value_sig81A9 = var_core_value_sigB9DF.getUnit(var_core_value_sigEE95, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig81A9 || !Y(var_core_value_sig81A9, var_core_value_sig98C4)) return false;
      ...
      if (var_core_value_sig2F14 !== null && !_(var_core_value_sig1679, var_core_value_sig2F14)) throw new h('invalidField');
      if (v(var_core_value_sig1679) === var_core_value_sig2F14) return true;
      let var_core_value_sigF73D = new I(),
        var_core_value_sigDB18 = A(Object.values(var_core_value_sig1679.fields).flatMap(var_core_value_sigB97D => {
          if (!_(var_core_value_sig1679, var_core_value_sigB97D.id)) return [];
          let var_core_value_sigFE1E = o(var_core_value_sigB97D);
          if (!var_core_value_sigFE1E) return [];
          let var_core_value_sig5F541 = var_core_value_sigB97D.id === var_core_value_sig2F14;
          if (var_core_value_sigFE1E.relationRole === e.BaseRecordLinkRole["Parent"] === var_core_value_sig5F541) return [];
          ...
          return var_core_value_sig5F541 ? var_core_value_sig84B9.relationRole = e.BaseRecordLinkRole["Parent"] : delete var_core_value_sig84B9.relationRole, [var_core_value_sigF73D.updateField(var_core_value_sigF301, var_core_value_sig98C4, var_core_value_sigB97D.id, {
            'config': var_core_value_sig84B9
          })];
        })),
        var_core_value_sig4E47 = new j().invertOp(var_core_value_sigF301, var_core_value_sigDB18),
      ...
      return var_core_value_sig6133.get(e.ICommandService).syncExecuteCommand(J.id, var_core_value_sigACB0) ? (var_core_value_sigB9DF.focusUnit(var_core_value_sigEE95), var_core_value_sig6133.get(e.IUndoRedoService).pushUndoRedo({
        'unitID': var_core_value_sigEE95,
        'undoMutations': [{
          'id': J.id,
  ...
  ca = {
    ...
    'handler': (var_core_value_sigF3BE, var_core_value_sig31FA) => {
      ...
      let var_core_value_sigC23B = var_core_value_sigF3BE.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigBD4F = var_core_value_sigC23B.getUnit(var_core_value_sigB0B1, e.UniverInstanceType["UNIVER_BASE"]),
        var_core_value_sig9C8D = var_core_value_sigB74E.beforeFieldId ?? var_core_value_sigB74E.afterFieldId;
      if (!var_core_value_sigBD4F || !var_core_value_sig9C8D || var_core_value_sig9C8D === var_core_value_sig8A6D || !Y(var_core_value_sigBD4F, var_core_value_sigCB10, {
      ...
      if (var_core_value_sig8E68.system === true || var_core_value_sig8E68.type === e.BaseFieldType["RecordId"] || var_core_value_sigA81A.system === true || var_core_value_sigA81A.type === e.BaseFieldType["RecordId"]) return false;
      let var_core_value_sig15C3 = var_core_value_sigF3BE.get(e.ICommandService),
        var_core_value_sig5CFD1 = var_core_value_sigF3BE.get(e.IUndoRedoService),
        var_core_value_sigCA24 = var_core_value_sigBD4F.getSnapshot(),
        var_core_value_sig0B5D = new I().setViewFieldOrder(var_core_value_sigCA24, var_core_value_sigCB10, var_core_value_sig97AF, var_core_value_sig8A6D, var_core_value_sigB74E),
        var_core_value_sigFC84 = new j().invertOp(var_core_value_sigCA24, var_core_value_sig0B5D),
        var_core_value_sigCA9B = {
          'unitId': var_core_value_sigB0B1,
          'op': var_core_value_sig0B5D
        },
        var_core_value_sig341C = {
          'unitId': var_core_value_sigB0B1,
          'op': var_core_value_sigFC84
        };
      return var_core_value_sig15C3.syncExecuteCommand(J.id, var_core_value_sigCA9B) ? (var_core_value_sigC23B.focusUnit(var_core_value_sigB0B1), var_core_value_sig5CFD1.pushUndoRedo({
        'unitID': var_core_value_sigB0B1,
        'undoMutations': [{
          'id': J.id,
          'params': var_core_value_sig341C
        }],
        'redoMutations': [{
          'id': J.id,
  ...
  la = {
    ...
    'handler'(var_core_value_sig2AA1, var_core_value_sigA506) {
      ...
      let var_core_value_sig6FC9 = var_core_value_sig2AA1.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig1D0B = var_core_value_sig6FC9.getUnit(var_core_value_sig05BE, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig1D0B || !Y(var_core_value_sig1D0B, var_core_value_sig097E, {
      ...
      if (var_core_value_sigA5CC.system === true || var_core_value_sigA5CC.type === e.BaseFieldType["RecordId"]) return false;
      let var_core_value_sigA22E = var_core_value_sig2AA1.get(e.ICommandService),
        var_core_value_sigAFB6 = var_core_value_sig2AA1.get(e.IUndoRedoService),
        var_core_value_sigFC4C = var_core_value_sig1D0B.getSnapshot(),
        var_core_value_sigAE5C = new I().setViewFieldVisible(var_core_value_sigFC4C, var_core_value_sig097E, var_core_value_sig0240, var_core_value_sig90E0, var_core_value_sigA81B1),
        var_core_value_sig9A4B = new j().invertOp(var_core_value_sigFC4C, var_core_value_sigAE5C),
      ...
      return var_core_value_sigA22E.syncExecuteCommand(J.id, var_core_value_sigB1771) ? (var_core_value_sig6FC9.focusUnit(var_core_value_sig05BE), var_core_value_sigAFB6.pushUndoRedo({
        'unitID': var_core_value_sig05BE,
        'undoMutations': [{
          'id': J.id,
  ...
  ua = {
    ...
    'handler': (var_core_value_sig0601, var_core_value_sig2AAC) => {
      ...
      let var_core_value_sig6D82 = var_core_value_sig0601.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigFA1E = var_core_value_sig6D82.getUnit(var_core_value_sig8E0C, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sigFA1E || !Y(var_core_value_sigFA1E, var_core_value_sigA440, {
      ...
      if (var_core_value_sig713B.system === true || var_core_value_sig713B.type === e.BaseFieldType["RecordId"]) return false;
      let var_core_value_sigDEC9 = var_core_value_sig0601.get(e.ICommandService),
        var_core_value_sig1BE8 = var_core_value_sig0601.get(e.IUndoRedoService),
        var_core_value_sig955E = var_core_value_sigFA1E.getSnapshot(),
        var_core_value_sig6248 = new I().setViewFieldWidth(var_core_value_sig955E, var_core_value_sigA440, var_core_value_sigB2E6, var_core_value_sigA35D, var_core_value_sig5C6B),
        var_core_value_sigEE43 = new j().invertOp(var_core_value_sig955E, var_core_value_sig6248),
      ...
      return var_core_value_sigDEC9.syncExecuteCommand(J.id, var_core_value_sig96E6) ? (var_core_value_sig6D82.focusUnit(var_core_value_sig8E0C), var_core_value_sig1BE8.pushUndoRedo({
        'unitID': var_core_value_sig8E0C,
        'undoMutations': [{
          'id': J.id,
  ...
  da = {
    ...
    'handler': (var_core_value_sig826A, var_core_value_sig16C71) => {
      ...
      let var_core_value_sig3040 = var_core_value_sig826A.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigCAD2 = var_core_value_sig3040.getUnit(var_core_value_sig1A10, e.UniverInstanceType['UNIVER_BASE']),
      ...
      if (!var_core_value_sigCAD2 || !Y(var_core_value_sigCAD2, var_core_value_sig271B, {
        'viewIds': [var_core_value_sigC24D],
        'fieldIds': var_core_value_sigCF20
      })) return false;
      let var_core_value_sigF733 = var_core_value_sig826A.get(e.ICommandService),
        var_core_value_sigEABC = var_core_value_sig826A.get(e.IUndoRedoService),
        var_core_value_sig416F = var_core_value_sigCAD2.getSnapshot(),
        var_core_value_sigF4B7 = new I().setViewFilter(var_core_value_sig416F, var_core_value_sig271B, var_core_value_sigC24D, var_core_value_sig793B),
        var_core_value_sig78BE = new j().invertOp(var_core_value_sig416F, var_core_value_sigF4B7),
      ...
      return var_core_value_sigF733.syncExecuteCommand(J.id, var_core_value_sig8BF7) ? (var_core_value_sig3040.focusUnit(var_core_value_sig1A10), var_core_value_sigEABC.pushUndoRedo({
        'unitID': var_core_value_sig1A10,
        'undoMutations': [{
          'id': J.id,
  ...
  fa = {
    ...
    'handler': (var_core_value_sig6588, var_core_value_sigE223) => {
      ...
      let var_core_value_sigEFBD = var_core_value_sig6588.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig86C4 = var_core_value_sigEFBD.getUnit(var_core_value_sig20EC, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig86C4 || !Y(var_core_value_sig86C4, var_core_value_sig549B, {
      ...
      let var_core_value_sig2634 = var_core_value_sig6588.get(e.ICommandService),
        var_core_value_sig77A5 = var_core_value_sig6588.get(e.IUndoRedoService),
        var_core_value_sig258A = var_core_value_sig86C4.getSnapshot(),
        var_core_value_sigCE81 = new I().setViewGroup(var_core_value_sig258A, var_core_value_sig549B, var_core_value_sig0FA5, var_core_value_sig1B16),
        var_core_value_sigD09E = new j().invertOp(var_core_value_sig258A, var_core_value_sigCE81),
      ...
      return var_core_value_sig2634.syncExecuteCommand(J.id, var_core_value_sigE729) ? (var_core_value_sigEFBD.focusUnit(var_core_value_sig20EC), var_core_value_sig77A5.pushUndoRedo({
        'unitID': var_core_value_sig20EC,
        'undoMutations': [{
          'id': J.id,
  ...
  pa = {
    ...
    'handler': (var_core_value_sigFDC0, var_core_value_sig0CF8) => {
      ...
      let var_core_value_sigE365 = var_core_value_sigFDC0.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sigBE2D = var_core_value_sigE365.getUnit(var_core_value_sig411D, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sigBE2D || !Y(var_core_value_sigBE2D, var_core_value_sigF3E2, {
        'viewIds': [var_core_value_sig8429],
        'fieldIds': var_core_value_sigDAB4.map(var_core_value_sig5B2B => var_core_value_sig5B2B.fieldId)
      })) return false;
      let var_core_value_sig29F9 = var_core_value_sigFDC0.get(e.ICommandService),
        var_core_value_sigA738 = var_core_value_sigFDC0.get(e.IUndoRedoService),
        var_core_value_sigA249 = var_core_value_sigBE2D.getSnapshot(),
        var_core_value_sigAE70 = new I().setViewSort(var_core_value_sigA249, var_core_value_sigF3E2, var_core_value_sig8429, var_core_value_sigDAB4),
        var_core_value_sigE3B2 = new j().invertOp(var_core_value_sigA249, var_core_value_sigAE70),
      ...
      return var_core_value_sig29F9.syncExecuteCommand(J.id, var_core_value_sigE76A) ? (var_core_value_sigE365.focusUnit(var_core_value_sig411D), var_core_value_sigA738.pushUndoRedo({
        'unitID': var_core_value_sig411D,
        'undoMutations': [{
          'id': J.id,
  ...
  ma = {
    ...
    'handler'(var_core_value_sig8FE2, var_core_value_sig5B59) {
      ...
      let var_core_value_sigA74E = var_core_value_sig8FE2.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig63FB = var_core_value_sigA74E.getUnit(var_core_value_sig438B, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig63FB || !Y(var_core_value_sig63FB, var_core_value_sigCD4B, {
        'recordIds': [var_core_value_sig3102],
        'fieldIds': [var_core_value_sig46AF]
      }) || !li(var_core_value_sig63FB, var_core_value_sigCD4B, var_core_value_sig46AF, var_core_value_sig4A74)) return false;
      let var_core_value_sigADD7 = var_core_value_sig63FB.getSnapshot().tables[var_core_value_sigCD4B],
        var_core_value_sig49E0 = _(var_core_value_sigADD7, var_core_value_sig46AF) && x(var_core_value_sigADD7).includes(var_core_value_sig46AF),
        var_core_value_sigAFAA = var_core_value_sig49E0 ? E(var_core_value_sigADD7, var_core_value_sig46AF) : null,
        ...
        var_core_value_sig43F41 = var_core_value_sig49E0 ? s(var_core_value_sig4A74)[0] ?? null : null;
      if (var_core_value_sigAFAA) {
        if (var_core_value_sig43F41 && !var_core_value_sigADD7.records[var_core_value_sig43F41]) throw new h('missingRecord');
        let var_core_value_sigE5FE = te(var_core_value_sigAFAA, var_core_value_sig3102, var_core_value_sig43F41);
        if (!var_core_value_sigE5FE.valid) throw new h(var_core_value_sigE5FE.reason === e.BaseHierarchyInvalidReason["SelfParent"] ? 'selfParent' : var_core_value_sigE5FE.reason === e.BaseHierarchyInvalidReason['Cycle'] ? "cycle" : "maxDepth");
      }
      let var_core_value_sigEA921 = var_core_value_sig8FE2.get(e.ICommandService),
        var_core_value_sig125D = var_core_value_sig8FE2.get(e.IUndoRedoService),
        var_core_value_sig1FF9 = var_core_value_sig8FE2.get(G),
      ...
      let var_core_value_sig4F23 = new j().invertOp(var_core_value_sig63FB.getSnapshot(), var_core_value_sig85CF),
        ...
        var_core_value_sig3408 = {
          ...
          'trigger': var_core_value_sigC116 ? ma.id : undefined,
      ...
      return var_core_value_sigEA921.syncExecuteCommand(J.id, var_core_value_sig3408) ? (var_core_value_sigA74E.focusUnit(var_core_value_sig438B), var_core_value_sig125D.pushUndoRedo({
        'unitID': var_core_value_sig438B,
        'undoMutations': [{
          'id': J.id,
  ...
  ha = {
    ...
    'handler'(var_core_value_sigFED2, var_core_value_sig7392) {
      ...
      let var_core_value_sig878B = var_core_value_sigFED2.get(e.IUniverInstanceService),
        {
          unitId: var_core_value_sig52D0,
          tableId: var_core_value_sig3B18,
          fieldId: var_core_value_sigCA31
        } = var_core_value_sig7392,
        var_core_value_sig9C20 = var_core_value_sig878B.getUnit(var_core_value_sig52D0, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig9C20 || !Y(var_core_value_sig9C20, var_core_value_sig3B18, {
        'fieldIds': [var_core_value_sigCA31]
      })) return false;
      let var_core_value_sig7435 = var_core_value_sigFED2.get(e.ICommandService),
        var_core_value_sig9C58 = var_core_value_sigFED2.get(e.IUndoRedoService),
        var_core_value_sig676C = var_core_value_sig9C20.getSnapshot(),
        var_core_value_sig9D47 = var_core_value_sig7392.description['trim'](),
        var_core_value_sigA6E3 = new I().updateField(var_core_value_sig676C, var_core_value_sig3B18, var_core_value_sigCA31, {
          'description': var_core_value_sig9D47
        }),
        var_core_value_sig34CC = new j().invertOp(var_core_value_sig9C20.getSnapshot(), var_core_value_sigA6E3),
      ...
      return var_core_value_sig7435.syncExecuteCommand(J.id, var_core_value_sig67F5) ? (var_core_value_sig878B.focusUnit(var_core_value_sig52D0), var_core_value_sig9C58.pushUndoRedo({
        'unitID': var_core_value_sig52D0,
        'undoMutations': [{
          'id': J.id,
  ...
  ga = {
    ...
    'handler': (var_core_value_sig5A38, var_core_value_sig4E8A) => {
      ...
      let var_core_value_sigE618 = var_core_value_sig5A38.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig00DD = var_core_value_sigE618.getUnit(var_core_value_sig2700, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig00DD || var_core_value_sig5E9A === e.BASE_RECORD_ID_FIELD_ID || !Y(var_core_value_sig00DD, var_core_value_sigD319, {
        'fieldIds': [var_core_value_sig5E9A]
      })) return false;
      let var_core_value_sigA864 = var_core_value_sig5A38.get(e.ICommandService),
        var_core_value_sig0E68 = var_core_value_sig5A38.get(e.IUndoRedoService),
        var_core_value_sig2889 = var_core_value_sig00DD.getSnapshot();
      if (!ci(var_core_value_sig00DD, var_core_value_sigD319, {
        ...var_core_value_sig2889.tables[var_core_value_sigD319].fields[var_core_value_sig5E9A],
        ...var_core_value_sig52E2
      })) return false;
      let var_core_value_sigB3EE1 = new I().updateField(var_core_value_sig2889, var_core_value_sigD319, var_core_value_sig5E9A, var_core_value_sig52E2),
        var_core_value_sig0E3B = new j().invertOp(var_core_value_sig2889, var_core_value_sigB3EE1),
      ...
      return var_core_value_sigA864.syncExecuteCommand(J.id, var_core_value_sigDCD1) ? (var_core_value_sigE618.focusUnit(var_core_value_sig2700), var_core_value_sig0E68.pushUndoRedo({
        'unitID': var_core_value_sig2700,
        'undoMutations': [{
          'id': J.id,
  ...
  _a = {
    ...
    'handler': (var_core_value_sigEF78, var_core_value_sigA7F8) => {
      ...
      let var_core_value_sig007E = var_core_value_sigEF78.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig7C02 = var_core_value_sig007E.getUnit(var_core_value_sigD261, e.UniverInstanceType['UNIVER_BASE']);
      if (!var_core_value_sig7C02 || !Y(var_core_value_sig7C02, var_core_value_sigE75A, {
        'viewIds': [var_core_value_sigEC28]
      })) return false;
      let var_core_value_sig5489 = var_core_value_sigEF78.get(e.ICommandService),
        var_core_value_sig632D = var_core_value_sigEF78.get(e.IUndoRedoService),
        var_core_value_sigE6D3 = var_core_value_sig7C02.getSnapshot(),
        var_core_value_sig2C1F = new I().updateViewConfig(var_core_value_sigE6D3, var_core_value_sigE75A, var_core_value_sigEC28, var_core_value_sig7870),
        var_core_value_sigF27F = new j().invertOp(var_core_value_sigE6D3, var_core_value_sig2C1F),
      ...
      return var_core_value_sig5489.syncExecuteCommand(J.id, var_core_value_sig56FA) ? (var_core_value_sig007E.focusUnit(var_core_value_sigD261), var_core_value_sig632D.pushUndoRedo({
        'unitID': var_core_value_sigD261,
        'undoMutations': [{
          'id': J.id,
  ...
  va = {
    ...
    'handler': (var_core_value_sig3CA3, var_core_value_sigC1AB) => {
      ...
      let var_core_value_sig5E6D = var_core_value_sig3CA3.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig7061 = var_core_value_sig5E6D.getUnit(var_core_value_sigA1F4, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig7061 || !Y(var_core_value_sig7061, var_core_value_sig0CE9, {
        'recordIds': [var_core_value_sig3281]
      })) return false;
      let var_core_value_sig795D = var_core_value_sig3CA3.get(e.ICommandService),
        var_core_value_sigD358 = var_core_value_sig3CA3.get(e.IUndoRedoService),
        var_core_value_sig42D2 = var_core_value_sig7061.getSnapshot(),
        var_core_value_sigB02D = new I().updateRecordOrder(var_core_value_sig42D2, var_core_value_sig0CE9, var_core_value_sig3281, var_core_value_sig486A),
        var_core_value_sig5235 = new j().invertOp(var_core_value_sig42D2, var_core_value_sigB02D),
      ...
      return var_core_value_sig795D.syncExecuteCommand(J.id, var_core_value_sig36851) ? (var_core_value_sig5E6D.focusUnit(var_core_value_sigA1F4), var_core_value_sigD358.pushUndoRedo({
        'unitID': var_core_value_sigA1F4,
        'undoMutations': [{
          'id': J.id,
...
let ya = function (var_core_value_sigA50E) {
...
const ba = {
  ...
  'handler': (var_core_value_sigCE3D, var_core_value_sigF82C) => {
    ...
    let var_core_value_sig0FDC = var_core_value_sigCE3D.get(e.IUniverInstanceService),
      var_core_value_sig28AB = var_core_value_sig0FDC.getUnit(var_core_value_sigF82C.unitId, e.UniverInstanceType['UNIVER_BASE']);
    if (!var_core_value_sig28AB || !Y(var_core_value_sig28AB, var_core_value_sigF82C.tableId, {
    ...
    let var_core_value_sigCEEB = var_core_value_sig28AB.getSnapshot(),
      ...
      var_core_value_sig2D5A = xa(((var_core_value_sig0809 = var_core_value_sigF064.views[var_core_value_sigF82C.viewId].config["conditionalColoring"]) == null ? undefined : var_core_value_sig0809.rules) ?? [], var_core_value_sigF82C);
    if (!var_core_value_sig2D5A) return false;
    Sa(var_core_value_sigF064, var_core_value_sig2D5A);
    let var_core_value_sig0D17 = new I().updateViewConfig(var_core_value_sigCEEB, var_core_value_sigF82C.tableId, var_core_value_sigF82C.viewId, {
        'conditionalColoring': var_core_value_sig2D5A.length ? {
          'rules': var_core_value_sig2D5A
        } : null
      }),
      var_core_value_sigF02B = new j().invertOp(var_core_value_sigCEEB, var_core_value_sig0D17),
    ...
    return var_core_value_sigCE3D.get(e.ICommandService).syncExecuteCommand(J.id, var_core_value_sigCC5B) ? (var_core_value_sig0FDC.focusUnit(var_core_value_sigF82C.unitId), var_core_value_sigCE3D.get(e.IUndoRedoService).pushUndoRedo({
      'unitID': var_core_value_sigF82C.unitId,
      'undoMutations': [{
        'id': J.id,
...
function xa(var_core_value_sigFCAC, var_core_value_sig6740) {
  switch (var_core_value_sig6740.type) {
    case "set":
      return e.Tools['deepClone'](var_core_value_sig6740.rules);
    case "add":
      return [...e.Tools["deepClone"](var_core_value_sigFCAC), e.Tools['deepClone'](var_core_value_sig6740.rule)];
    case "delete":
      {
        ...
        return var_core_value_sigC5C4.length === var_core_value_sigFCAC.length ? null : e.Tools["deepClone"](var_core_value_sigC5C4);
      }
    case 'clear':
...
;
function Sa(var_core_value_sig89A9, var_core_value_sig3BD1) {
  if (!Array.isArray(var_core_value_sig3BD1)) throw TypeError('[UpdateBaseViewConditionalColorRulesCommand]:\x20rules\x20must\x20be\x20an\x20array.');
  let var_core_value_sig1B07 = new Set();
  for (let [var_core_value_sigC723, var_core_value_sig1E32] of var_core_value_sig3BD1.entries()) wa(var_core_value_sig89A9, var_core_value_sig1E32, Ca(var_core_value_sig1E32, var_core_value_sigC723, var_core_value_sig1B07));
}
;
function Ca(var_core_value_sigA093, var_core_value_sig4B13, var_core_value_sigAF5A) {
  if (!var_core_value_sigA093 || typeof var_core_value_sigA093 != 'object') throw TypeError("[UpdateBaseViewConditionalColorRulesCommand]: rule at index " + var_core_value_sig4B13 + " must be an object.");
  let var_core_value_sigE64B = typeof var_core_value_sigA093.id == "string" && var_core_value_sigA093.id["trim"]() ? '\x22' + var_core_value_sigA093.id + '\x22' : "at index " + var_core_value_sig4B13;
  ...
  if (var_core_value_sigAF5A.has(var_core_value_sigA093.id)) throw Error("[UpdateBaseViewConditionalColorRulesCommand]: duplicate rule id \"" + var_core_value_sigA093.id + '\x22.');
  var_core_value_sigAF5A.add(var_core_value_sigA093.id);
  let var_core_value_sigDC7E = typeof var_core_value_sigA093.color == "string" && var_core_value_sigA093.color["trim"]() ? new e["ColorKit"](var_core_value_sigA093.color) : null;
  if (!(var_core_value_sigDC7E != null && var_core_value_sigDC7E.isValid)) throw Error("[UpdateBaseViewConditionalColorRulesCommand]: rule " + var_core_value_sigE64B + '\x20must\x20have\x20a\x20valid\x20CSS\x20color.');
  return var_core_value_sigE64B;
}
;
function wa(var_core_value_sig1384, var_core_value_sig3397, var_core_value_sig3918) {
  let var_core_value_sigA952 = new Set(Object.values(e.BaseConditionalColorTarget)),
    var_core_value_sigC0961 = new Set(Object.values(e.BaseConditionalColorOperator)),
    var_core_value_sig2A1C = new Set(Object.values(e.BaseConditionalDateMode));
  ...
  if (!var_core_value_sig2D1C || var_core_value_sig2D1C.system === true || var_core_value_sig2D1C.type === e.BaseFieldType["RecordId"]) throw Error('[UpdateBaseViewConditionalColorRulesCommand]:\x20rule\x20' + var_core_value_sig3918 + '\x20references\x20missing\x20or\x20non-public\x20field\x20\x22' + String(var_core_value_sig3397.fieldId) + '\x22.');
  if (!var_core_value_sigC0961.has(var_core_value_sig3397.operator)) throw Error('[UpdateBaseViewConditionalColorRulesCommand]:\x20rule\x20' + var_core_value_sig3918 + " has unsupported operator \"" + String(var_core_value_sig3397.operator) + '\x22.');
  if (var_core_value_sig3397.dateMode !== undefined && !var_core_value_sig2A1C.has(var_core_value_sig3397.dateMode)) throw Error('[UpdateBaseViewConditionalColorRulesCommand]:\x20rule\x20' + var_core_value_sig3918 + '\x20has\x20unsupported\x20date\x20mode\x20\x22' + String(var_core_value_sig3397.dateMode) + '\x22.');
  if (var_core_value_sig3397.target === e.BaseConditionalColorTarget["COLUMN"]) return;
  let var_core_value_sig0EDB1 = mt(var_core_value_sig2D1C.type);
  if (!var_core_value_sig0EDB1.includes(var_core_value_sig3397.operator)) throw Error("[UpdateBaseViewConditionalColorRulesCommand]: rule " + var_core_value_sig3918 + " cannot use operator \"" + var_core_value_sig3397.operator + '\x22\x20with\x20field\x20type\x20\x22' + var_core_value_sig2D1C.type + '\x22.\x20Allowed\x20operators:\x20' + var_core_value_sig0EDB1.join(',\x20') + '.');
  if (var_core_value_sig3397.dateMode !== undefined && !ht(var_core_value_sig2D1C.type)) throw Error('[UpdateBaseViewConditionalColorRulesCommand]:\x20rule\x20' + var_core_value_sig3918 + " can use dateMode only with Date, CreatedAt, or UpdatedAt fields.");
}
const Ta = {
    ...
    'handler': (var_core_value_sig2C5D, var_core_value_sigCC49) => {
      ...
      let var_core_value_sigFA56 = var_core_value_sig2C5D.get(e.IUniverInstanceService),
        {
        ...
        var_core_value_sig6C1F = var_core_value_sigFA56.getUnit(var_core_value_sig764E, e.UniverInstanceType["UNIVER_BASE"]);
      if (!var_core_value_sig6C1F || !Y(var_core_value_sig6C1F, var_core_value_sigBB1B, {
        'viewIds': [var_core_value_sigB3C1]
      })) return false;
      let var_core_value_sig0707 = var_core_value_sig2C5D.get(e.ICommandService),
        var_core_value_sig0E4C = var_core_value_sig2C5D.get(e.IUndoRedoService),
        var_core_value_sig8CE7 = var_core_value_sig6C1F.getSnapshot(),
        var_core_value_sig7BBA = new I().updateViewConfig(var_core_value_sig8CE7, var_core_value_sigBB1B, var_core_value_sigB3C1, var_core_value_sigB6FA),
        var_core_value_sig1B72 = new j().invertOp(var_core_value_sig8CE7, var_core_value_sig7BBA),
      ...
      return var_core_value_sig0707.syncExecuteCommand(J.id, var_core_value_sigBB0A) ? (var_core_value_sigFA56.focusUnit(var_core_value_sig764E), var_core_value_sig0E4C.pushUndoRedo({
        'unitID': var_core_value_sig764E,
        'undoMutations': [{
          'id': J.id,
  ...
  Ea = {
    ...
    'handler'(var_core_value_sig81A0, var_core_value_sig1E36) {
      if (!var_core_value_sig1E36) return {
        'valid': false,
        'reason': '[BaseFormula]:\x20validation\x20parameters\x20are\x20required.'
      };
      let var_core_value_sigFFDE = var_core_value_sig81A0.get(e.IUniverInstanceService).getUnit(var_core_value_sig1E36.unitId, e.UniverInstanceType["UNIVER_BASE"]),
      ...
      } : new Ur().validateFormula(var_core_value_sig1E36.formula, var_core_value_sigA79E, {
        'snapshot': var_core_value_sigD7E9
      });
    }
  };
function Da(var_core_value_sig9630) {
  let var_core_value_sigFA2E = var_core_value_sig9630.now ?? Date.now(),
    ...
    var_core_value_sigA250 = (0, e.createBaseRecordIdField)(),
  ...
  for (let var_core_value_sig22AF = 0; var_core_value_sig22AF < var_core_value_sigF63F; var_core_value_sig22AF++) {
    ...
    var_core_value_sig77DC[var_core_value_sig1617] = {
      ...
      'values': {
        [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sig1617,
  ...
  let var_core_value_sig240A = {
    ...
    'name': "Grid",
    'type': e.BaseViewType["Grid"],
    'fieldOrder': [e.BASE_RECORD_ID_FIELD_ID, var_core_value_sigF20F],
    'fieldSettings': {
      [e.BASE_RECORD_ID_FIELD_ID]: {
        'hidden': true
      }
  ...
  return {
    ...
    'fieldOrder': [e.BASE_RECORD_ID_FIELD_ID, var_core_value_sigF20F],
    'fields': {
      [e.BASE_RECORD_ID_FIELD_ID]: var_core_value_sigA250,
    ...
    'colIndex': {
      [e.BASE_RECORD_ID_FIELD_ID]: 0,
      [var_core_value_sigF20F]: 1
    },
    'colId': {
      0: e.BASE_RECORD_ID_FIELD_ID,
...
function ka(var_core_value_sig756B) {
  let var_core_value_sig41FB = Da({
  ...
  return {
    ...
    'resources': {
      ...
      [Oa]: Ma(var_core_value_sig756B)
    }
  };
}
;
function Aa(var_core_value_sigE071) {
  return {
    'id': J.id,
    'params': {
      'unitId': var_core_value_sigE071.unitId,
      'op': e.JSON1["type"].compose(e.JSON1["insertOp"](["tables", var_core_value_sigE071.table['id']], var_core_value_sigE071.table), e.JSON1["insertOp"](["tableOrder", var_core_value_sigE071.index ?? var_core_value_sigE071.snapshot["tableOrder"].length], var_core_value_sigE071.table['id'])),
      'trigger': "embed-ui"
    }
  };
}
;
function ja(var_core_value_sigEF01) {
  ...
  if (!(!var_core_value_sigEF01.snapshot["tables"][var_core_value_sigEF01.tableId] || var_core_value_sig6AB2 < 0)) return {
    ...
    'params': {
      ...
      'op': e.JSON1["type"].compose(e.JSON1['removeOp'](["tables", var_core_value_sigEF01.tableId], var_core_value_sigEF01.snapshot["tables"][var_core_value_sigEF01.tableId]), e.JSON1["removeOp"](['tableOrder', var_core_value_sig6AB2], var_core_value_sigEF01.tableId)),
      'trigger': "embed-ui"
    }
  };
}
;
function Ma(var_core_value_sig4971) {
  return {
    'version': 1,
...
;
function Na(var_core_value_sigA887) {
  let var_core_value_sigC142 = Math.max(0, Number(var_core_value_sigA887.decimalPlaces ?? 0)),
    ...
    var_core_value_sig7BFB = Fa(var_core_value_sigA887.abbreviation);
  return '' + (var_core_value_sigA887.currencySymbol ? Ia(var_core_value_sigA887.currencySymbol) : '') + var_core_value_sigEA08 + var_core_value_sig1163 + var_core_value_sig7BFB;
}
;
function Pa(var_core_value_sigE065, var_core_value_sig1B83) {
  let var_core_value_sig1F85 = Na(var_core_value_sig1B83),
    var_core_value_sig0149 = e.numfmt["format"](var_core_value_sig1F85, var_core_value_sigE065, {
      'throws': false
    });
  return La(String(var_core_value_sig0149), var_core_value_sig1B83.separatorStyle, var_core_value_sig1B83.locale);
}
;
function Fa(var_core_value_sig9F77) {
  return var_core_value_sig9F77 === 'K' ? ",\"K\"" : var_core_value_sig9F77 === 'M' ? ',,\x22M\x22' : var_core_value_sig9F77 === 'B' ? ",,,\"B\"" : '';
}
;
function Ia(var_core_value_sig83CF) {
  return /^[A-Z]+$/i.test(var_core_value_sig83CF) ? '\x22' + var_core_value_sig83CF + '\x22' : var_core_value_sig83CF;
}
;
function La(var_core_value_sigF518, var_core_value_sigBDCA, var_core_value_sigCCF1) {
  let var_core_value_sig74C0 = var_core_value_sigBDCA === "local" ? Ra(var_core_value_sigCCF1) : var_core_value_sigBDCA;
...
;
function Ra(var_core_value_sig291B) {
...
;
function za(var_core_value_sig788A, var_core_value_sig8676) {
  let var_core_value_sigDEEE = var_core_value_sig8676 && typeof var_core_value_sig8676 == "object" && !Array.isArray(var_core_value_sig8676) ? var_core_value_sig8676 : {},
    var_core_value_sig990D = Ba(var_core_value_sigDEEE.decimalPlaces, 0, 2, 0),
...
;
function Ba(var_core_value_sig5C96, var_core_value_sig2755, var_core_value_sigC7AF, var_core_value_sigC669) {
...
const Va = ["count", "filled", 'empty', 'unique', "sum", "average", 'min', "max"],
  Ha = ["count", "filled", "empty", "unique"],
  Ua = ['sum', "average", "min", "max"],
  Wa = ["min", 'max'],
  Ga = new Set([e.BaseFieldType['Number'], e.BaseFieldType["Currency"], e.BaseFieldType["Progress"], e.BaseFieldType["Rating"]]),
  Ka = new Set([e.BaseFieldType['MultiSelect'], e.BaseFieldType["Person"], e.BaseFieldType["Group"]]),
  qa = "General";
function Ja(var_core_value_sigDA7F) {
  return typeof var_core_value_sigDA7F == "string" && Va.includes(var_core_value_sigDA7F);
}
;
function Ya(var_core_value_sigC174) {
  return !var_core_value_sigC174 || typeof var_core_value_sigC174 != 'object' ? {} : Object.fromEntries(Object.entries(var_core_value_sigC174).filter(var_core_value_sigCBED => Ja(var_core_value_sigCBED[1])));
}
;
function Xa(var_core_value_sig93EA) {
  return Ga.has(var_core_value_sig93EA.type) ? [...Ha, ...Ua] : var_core_value_sig93EA.type === e.BaseFieldType["Formula"] ? [...Ha, ...(fo(var_core_value_sig93EA) === "date" ? Wa : Ua)] : Ha;
}
;
function Za(var_core_value_sigA2DF, var_core_value_sigE813) {
  return Xa(var_core_value_sigA2DF).includes(var_core_value_sigE813);
}
;
function Qa(var_core_value_sig03AA, var_core_value_sig1055, var_core_value_sigC30C1) {
  if (!Za(var_core_value_sig03AA, var_core_value_sigC30C1)) return null;
  let var_core_value_sig1AD5 = var_core_value_sig1055.filter(var_core_value_sig6224 => !eo(var_core_value_sig03AA, var_core_value_sig6224));
  switch (var_core_value_sigC30C1) {
    ...
    case "unique":
      return new Set(var_core_value_sig1AD5.map(var_core_value_sig4169 => io(var_core_value_sig03AA, var_core_value_sig4169))).size;
    case "sum":
      {
        let var_core_value_sig6D19 = to(var_core_value_sig03AA, var_core_value_sig1AD5);
        return var_core_value_sig6D19.length ? ro(var_core_value_sig6D19) : null;
      }
    case "average":
      {
        let var_core_value_sig279C = to(var_core_value_sig03AA, var_core_value_sig1AD5);
        return var_core_value_sig279C.length ? ro(var_core_value_sig279C) / var_core_value_sig279C.length : null;
      }
    case "min":
      {
        let var_core_value_sigAC51 = to(var_core_value_sig03AA, var_core_value_sig1AD5);
        return var_core_value_sigAC51.length ? Math.min(...var_core_value_sigAC51) : null;
      }
    case "max":
      {
        let var_core_value_sig8986 = to(var_core_value_sig03AA, var_core_value_sig1AD5);
        return var_core_value_sig8986.length ? Math.max(...var_core_value_sig8986) : null;
      }
  }
}
;
function $a(var_core_value_sigAF2C, var_core_value_sigD893, var_core_value_sig9C29) {
  if (var_core_value_sig9C29 == null || !Number.isFinite(var_core_value_sig9C29)) return '-';
  if (Ha.includes(var_core_value_sigD893)) return String(var_core_value_sig9C29);
  switch (var_core_value_sigAF2C.type) {
    case e.BaseFieldType['Number']:
      return Pa(var_core_value_sig9C29, co(var_core_value_sigAF2C));
    case e.BaseFieldType["Currency"]:
      return Pa(var_core_value_sig9C29, lo(var_core_value_sigAF2C));
    case e.BaseFieldType["Progress"]:
      return za(var_core_value_sig9C29, var_core_value_sigAF2C.config);
    case e.BaseFieldType["Formula"]:
      return uo(var_core_value_sig9C29, var_core_value_sigAF2C);
    default:
      return mo(var_core_value_sig9C29);
  }
}
;
function eo(var_core_value_sigBE39, var_core_value_sig6945) {
  if (var_core_value_sig6945 == null) return true;
  if (typeof var_core_value_sig6945 == "string") return var_core_value_sig6945.trim() === '';
  if (Array.isArray(var_core_value_sig6945)) return var_core_value_sigBE39.type === e.BaseFieldType['Attachment'] ? !var_core_value_sig6945.some(so) : var_core_value_sig6945.length === 0;
  if (var_core_value_sigBE39.type === e.BaseFieldType["Link"] && typeof var_core_value_sig6945 == "object") {
...
;
function to(var_core_value_sigDED6, var_core_value_sig0A6B) {
  let var_core_value_sig2C8D = [];
  for (let var_core_value_sig4D33 of var_core_value_sig0A6B) {
    let var_core_value_sigED1C = no(var_core_value_sigDED6, var_core_value_sig4D33);
    var_core_value_sigED1C != null && var_core_value_sig2C8D.push(var_core_value_sigED1C);
  }
  return var_core_value_sig2C8D;
}
;
function no(var_core_value_sig1CC1, var_core_value_sigB460) {
  if (typeof var_core_value_sigB460 == "number") return Number.isFinite(var_core_value_sigB460) ? var_core_value_sigB460 : null;
  if (var_core_value_sig1CC1.type !== e.BaseFieldType["Formula"] && typeof var_core_value_sigB460 == "string" && var_core_value_sigB460.trim() !== '') {
...
;
function ro(var_core_value_sigBA9E) {
...
;
function io(var_core_value_sigB11D, var_core_value_sig2B33) {
  return Ka.has(var_core_value_sigB11D.type) && Array.isArray(var_core_value_sig2B33) ? oo([...new Set(var_core_value_sig2B33.map(var_core_value_sig2B5D => oo(ao(var_core_value_sig2B5D))))].sort()) : oo(ao(var_core_value_sig2B33));
}
;
function ao(var_core_value_sig705C) {
  return Array.isArray(var_core_value_sig705C) ? var_core_value_sig705C.map(ao) : var_core_value_sig705C && typeof var_core_value_sig705C == "object" ? Object.fromEntries(Object.entries(var_core_value_sig705C).sort(([var_core_value_sig9B0B], [var_core_value_sigF21D]) => var_core_value_sig9B0B.localeCompare(var_core_value_sigF21D)).map(([var_core_value_sig9B55, var_core_value_sigB8F41]) => [var_core_value_sig9B55, ao(var_core_value_sigB8F41)])) : var_core_value_sig705C;
}
;
function oo(var_core_value_sigD209) {
  return JSON.stringify(var_core_value_sigD209) ?? "undefined";
}
;
function so(var_core_value_sigD13E) {
...
;
function co(var_core_value_sig22EF) {
  let var_core_value_sig23DF = ho(var_core_value_sig22EF.config);
  return {
    'decimalPlaces': _o(var_core_value_sig23DF.decimalPlaces, 0, 20, 2),
...
;
function lo(var_core_value_sig1EB4) {
  let var_core_value_sigF12B = ho(var_core_value_sig1EB4.config);
  return {
    ...co(var_core_value_sig1EB4),
    'currencySymbol': String(var_core_value_sigF12B.currencySymbol ?? '$')
  };
}
;
function uo(var_core_value_sig170E, var_core_value_sig72DB) {
  let var_core_value_sigA272 = po(var_core_value_sig72DB);
  if (var_core_value_sigA272 === qa) return mo(var_core_value_sig170E);
  try {
    return String(e.numfmt["format"](var_core_value_sigA272, var_core_value_sig170E, {
      'throws': false
    }));
  } catch {
    return mo(var_core_value_sig170E);
  }
}
;
function fo(var_core_value_sig60C4) {
  let var_core_value_sig4340 = ho(ho(var_core_value_sig60C4.config).numfmt);
  return typeof var_core_value_sig4340.type == "string" ? var_core_value_sig4340.type : "general";
}
;
function po(var_core_value_sig1F11) {
  let var_core_value_sig3A1B = ho(ho(var_core_value_sig1F11.config).numfmt);
  return String(var_core_value_sig3A1B.pattern ?? qa).trim() || qa;
}
;
function mo(var_core_value_sig6543) {
...
;
function ho(var_core_value_sigA0E6) {
...
;
function go(var_core_value_sig9F46) {
...
;
function _o(var_core_value_sig3165, var_core_value_sigEF93, var_core_value_sig6711, var_core_value_sigE204) {
  let var_core_value_sig58C8 = go(var_core_value_sig3165);
...
;
function vo(var_core_value_sig19E9, var_core_value_sigBB40) {
  let var_core_value_sigA2E7 = e.Tools["deepClone"](var_core_value_sig19E9),
    var_core_value_sigB05D = var_core_value_sigBB40.includeRecords === true,
    var_core_value_sigD96B = new Map(),
    var_core_value_sig5F92 = var_core_value_sigBB40.createViewId ?? (() => "view-" + (0, e.generateRandomId)(8)),
...
const xo = {},
  So = {};
function Co(var_core_value_sigDA2B) {
  return new j().getAffectedRanges(var_core_value_sigDA2B);
}
;
function wo(var_core_value_sigF322) {
...
;
function To(var_core_value_sigE133, var_core_value_sigE50A1) {
  return {
...
let Eo = class extends e.Disposable {
  ...
  _getTable(var_core_value_sigAF1B, var_core_value_sig906D) {
    let var_core_value_sig6AFB = this._univerInstanceService['getUnit'](var_core_value_sigAF1B, e.UniverInstanceType["UNIVER_BASE"]);
  ...
  _getJson1DirtyData(var_core_value_sig2830) {
    ...
    let var_core_value_sig9C3A = Co(var_core_value_sig2830.op),
    ...
    if (var_core_value_sig0321.length) return {
      'clearDependencyTreeCache': To(var_core_value_sig2830.unitId, var_core_value_sig0321),
      'forceCalculation': true
    };
    let var_core_value_sig51CF = Object.entries(this._groupCellInvalidations(var_core_value_sig2830.unitId, var_core_value_sig9C3A)).flatMap(([var_core_value_sig038E, var_core_value_sigAA1E]) => wo({
  ...
  _toDirtyRangePatch(var_core_value_sig717C, var_core_value_sig23AE) {
    ...
    let var_core_value_sigC7E11 = me(var_core_value_sigCB54, var_core_value_sig23AE.recordId, var_core_value_sig23AE.fieldId);
  ...
  _getAllTableIds(var_core_value_sig6575) {
    let var_core_value_sigE901 = this._univerInstanceService['getUnit'](var_core_value_sig6575, e.UniverInstanceType["UNIVER_BASE"]);
  ...
  _getAllBaseDependencyTreeCacheMap() {
    let var_core_value_sigB7EC = this._univerInstanceService["getAllUnitsForType"](e.UniverInstanceType['UNIVER_BASE']).map(var_core_value_sig4A7C => To(var_core_value_sig4A7C.getUnitId(), Object.keys(var_core_value_sig4A7C.getSnapshot().tables)));
    return Object.assign({}, ...var_core_value_sigB7EC);
  }
};
Eo = U([H(0, t.IActiveDirtyManagerService), H(1, e.IUniverInstanceService)], Eo);
let Do = class extends e.Disposable {
  constructor(var_core_value_sigB018, var_core_value_sigE7BE, var_core_value_sigC88E, var_core_value_sigC4A6) {
    super(), this._commandService = var_core_value_sigB018, this._univerInstanceService = var_core_value_sigE7BE, this._formulaCalculationTriggerService = var_core_value_sigC88E, this._formulaCalculationSessionService = var_core_value_sigC4A6, L(this, "_formulaService", new Ur()), L(this, "_registeredSuperTableNames", new Map()), L(this, "_scheduledSuperTableSyncs", new Set()), L(this, '_formulaSyncQueue', Promise.resolve()), L(this, "_applyingFormulaResults", false), this._initialize();
  }
  _initialize() {
    this._univerInstanceService["getAllUnitsForType"](e.UniverInstanceType["UNIVER_BASE"]).forEach(var_core_value_sigF975 => {
      this._scheduleSuperTableSync(var_core_value_sigF975);
    }), this.disposeWithMe(this._univerInstanceService["getTypeOfUnitAdded$"](e.UniverInstanceType["UNIVER_BASE"]).subscribe(({
      unit: var_core_value_sigCDAF
    }) => {
      this._scheduleSuperTableSync(var_core_value_sigCDAF);
    })), this.disposeWithMe(this._univerInstanceService["getTypeOfUnitDisposed$"](e.UniverInstanceType['UNIVER_BASE']).subscribe(var_core_value_sigA298 => {
  ...
  _onCommandExecuted(var_core_value_sig1FE3) {
    if (var_core_value_sig1FE3.id === t.SetFormulaCalculationResultMutation['id']) {
      ko(var_core_value_sig1FE3.params) && this._applyFormulaResult(var_core_value_sig1FE3.params);
      return;
    }
    if (this._applyingFormulaResults || var_core_value_sig1FE3.id !== J.id) return;
    let var_core_value_sigF003 = Oo(var_core_value_sig1FE3.params) ? var_core_value_sig1FE3.params : undefined,
      var_core_value_sigE146 = var_core_value_sigF003 != null && var_core_value_sigF003.unitId ? [this._univerInstanceService["getUnit"](var_core_value_sigF003.unitId, e.UniverInstanceType["UNIVER_BASE"])].filter(var_core_value_sig330B => !!var_core_value_sig330B) : this._univerInstanceService['getAllUnitsForType'](e.UniverInstanceType["UNIVER_BASE"]),
    ...
    var_core_value_sigE146.forEach(var_core_value_sig3625 => {
      let var_core_value_sig0B4E = var_core_value_sigF6D5 ? Co(var_core_value_sigF6D5) : [];
  ...
  async _syncSuperTables(var_core_value_sigA99D) {
    let var_core_value_sigB23E = var_core_value_sigA99D.getUnitId(),
      var_core_value_sigDA56 = this._formulaService["getSuperTableRegistrations"](var_core_value_sigA99D.getSnapshot()),
      var_core_value_sig8D74 = new Set(var_core_value_sigDA56.map(({
    ...
    for (let var_core_value_sigE5BA of var_core_value_sigC3E8) if (!var_core_value_sig8D74.has(var_core_value_sigE5BA) && !(await this._executeSuperTableMutationWhileActive(t.RemoveSuperTableMutation['id'], {
    ...
    } of var_core_value_sigDA56) if (!(await this._executeSuperTableMutationWhileActive(t.SetSuperTableMutation['id'], {
      'unitId': var_core_value_sigB23E,
      'tableName': var_core_value_sig4A83,
      'reference': var_core_value_sig58AA
    }))) return;
  ...
  async _removeSuperTables(var_core_value_sig3FAF1) {
    ...
    for (let var_core_value_sig84C4 of var_core_value_sigC00C) if (!(await this._executeSuperTableMutationWhileActive(t.RemoveSuperTableMutation['id'], {
  ...
  _applyFormulaResult(var_core_value_sig4B7F) {
    let var_core_value_sig17D6 = this._univerInstanceService["getAllUnitsForType"](e.UniverInstanceType['UNIVER_BASE']);
    ...
    let var_core_value_sig8915 = var_core_value_sig17D6.flatMap(var_core_value_sig70D0 => Wr(var_core_value_sig70D0.getSnapshot(), var_core_value_sig4B7F));
    if (!var_core_value_sig8915.length) {
      this._formulaCalculationSessionService['markResultApplied'](a.FormulaResultApplicationType["BASE"], var_core_value_sig4B7F);
      return;
    }
    let var_core_value_sigC88F = new I(),
      var_core_value_sig1AFA = var_core_value_sig8915.flatMap(var_core_value_sig2A8A => wo({
    ...
    this._applyingFormulaResults = true, (async () => {
      for (let var_core_value_sigD7EA of var_core_value_sig8915) {
        let var_core_value_sig429F = this._univerInstanceService["getUnit"](var_core_value_sigD7EA.unitId, e.UniverInstanceType["UNIVER_BASE"]);
        var_core_value_sig429F && (await this._commandService["executeCommand"](J.id, {
      ...
      await this._commandService['executeCommand'](t.SetTriggerFormulaCalculationStartMutation['id'], {
        'dirtyRanges': var_core_value_sig1AFA
      }, {
        'onlyLocal': true
      });
    })().finally(() => {
      this._applyingFormulaResults = false, this._formulaCalculationSessionService["markResultApplied"](a.FormulaResultApplicationType['BASE'], var_core_value_sig4B7F);
    });
  }
};
Do = U([H(0, e.ICommandService), H(1, e.IUniverInstanceService), H(2, (0, e.Inject)(t.FormulaCalculationTriggerService)), H(3, (0, e.Inject)(a.FormulaCalculationSessionService))], Do);
function Oo(var_core_value_sig8383) {
...
;
function ko(var_core_value_sigA30F) {
...
let jo = class extends e.Disposable {
  constructor(var_core_value_sigBCF5, var_core_value_sig988A, var_core_value_sigFC02) {
    super(), this._commandService = var_core_value_sigBCF5, this._permissionService = var_core_value_sig988A, this._instanceService = var_core_value_sigFC02, this._instanceService["getAllUnitsForType"](e.UniverInstanceType['UNIVER_BASE']).forEach(var_core_value_sig3782 => this._registerUnitPermissionPoints(var_core_value_sig3782.getUnitId())), this.disposeWithMe(this._instanceService["getTypeOfUnitAdded$"](e.UniverInstanceType["UNIVER_BASE"]).subscribe(({
      unit: var_core_value_sigD22E
    }) => this._registerUnitPermissionPoints(var_core_value_sigD22E.getUnitId()))), this.disposeWithMe(this._commandService["beforeCommandExecuted"]((var_core_value_sig3455, var_core_value_sig5CEF) => this._check(var_core_value_sig3455, var_core_value_sig5CEF))), this.disposeWithMe(this._instanceService["getTypeOfUnitDisposed$"](e.UniverInstanceType["UNIVER_BASE"]).subscribe(var_core_value_sig43D51 => Pn(this._permissionService, var_core_value_sig43D51.getUnitId())));
  }
  _registerUnitPermissionPoints(var_core_value_sigF71C) {
    Sn.forEach(var_core_value_sig1395 => {
      let var_core_value_sig9FA0 = An(var_core_value_sigF71C, var_core_value_sigF71C, var_core_value_sig1395);
  ...
  _check(var_core_value_sigE634, var_core_value_sigF74F) {
    ...
    let var_core_value_sigF2B0 = Uo(var_core_value_sigE634.params) ? var_core_value_sigE634.params : undefined;
    if (var_core_value_sigF74F != null && var_core_value_sigF74F.onlyLocal && var_core_value_sigE634.id === 'base.mutation.apply-base-json1' && (var_core_value_sigF2B0 == null ? undefined : var_core_value_sigF2B0.trigger) === t.SetFormulaCalculationResultMutation['id']) return;
    let var_core_value_sigD77A = No(var_core_value_sigE634.id),
      var_core_value_sigF2C2 = Mo(var_core_value_sigF2B0 == null ? undefined : var_core_value_sigF2B0.unitId, var_core_value_sigF74F) ?? (var_core_value_sigD77A ? (var_core_value_sig89D7 = this._instanceService['getCurrentUnitOfType'](e.UniverInstanceType["UNIVER_BASE"])) == null ? undefined : var_core_value_sig89D7.getUnitId() : undefined);
    if (!var_core_value_sigF2C2 || this._instanceService["getUnitType"](var_core_value_sigF2C2) !== e.UniverInstanceType["UNIVER_BASE"]) return;
    if (var_core_value_sigD77A) {
      if (!jn(this._permissionService, var_core_value_sigF2C2, var_core_value_sigF2C2, var_core_value_sigD77A)) throw new e["CustomCommandExecutionError"]("Base " + n.UnitAction[var_core_value_sigD77A] + " permission denied.");
      return;
    }
    if (Ao.has(var_core_value_sigE634.id) || !var_core_value_sigE634.id["startsWith"]("base.command.") && !var_core_value_sigE634.id["startsWith"]("base.mutation.")) return;
    let var_core_value_sig2990 = this._instanceService["getUnit"](var_core_value_sigF2C2, e.UniverInstanceType["UNIVER_BASE"]);
    if (!var_core_value_sig2990 || !Fn(this._permissionService, var_core_value_sigF2C2, Po(var_core_value_sig2990, var_core_value_sigF2B0 ?? {}, var_core_value_sigE634.id))) throw new e["CustomCommandExecutionError"]("Base edit permission denied.");
  }
};
jo = U([H(0, e.ICommandService), H(1, e.IPermissionService), H(2, e.IUniverInstanceService)], jo);
function Mo(var_core_value_sig93DB, var_core_value_sigFBEC) {
...
;
function No(var_core_value_sig4E78) {
  if (var_core_value_sig4E78 === 'bases-exchange-client.operation.export-base' || var_core_value_sig4E78 === 'bases-exchange-client.operation.export-base-by-format') return n.UnitAction["Export"];
  if (var_core_value_sig4E78.startsWith("thread-comment.command.") || var_core_value_sig4E78.startsWith("thread-comment.mutation.")) return n.UnitAction["Comment"];
}
;
function Po(var_core_value_sigA1E7, var_core_value_sig1B4F, var_core_value_sigA6E0) {
  if (var_core_value_sigA6E0 === "base.mutation.apply-base-json1" && Ho(var_core_value_sig1B4F.op)) return Fo(var_core_value_sigA1E7, var_core_value_sig1B4F.op);
  let var_core_value_sig5B1A = new Set(),
    var_core_value_sig1004 = zo(var_core_value_sig1B4F, 'table'),
  ...
  if (var_core_value_sig1004.forEach(var_core_value_sigD300 => var_core_value_sig5B1A.add(R(var_core_value_sigD300))), !var_core_value_sigAE05) return [...var_core_value_sig5B1A];
  let var_core_value_sigE5C6 = var_core_value_sigA1E7.getSnapshot().tables[var_core_value_sigAE05],
    var_core_value_sig6FB9 = new Set(zo(var_core_value_sig1B4F, 'field')),
    var_core_value_sig0C7F = new Set(zo(var_core_value_sig1B4F, 'record')),
    var_core_value_sig41F0 = new Set(zo(var_core_value_sig1B4F, "view"));
  return Bo(var_core_value_sigE5C6, var_core_value_sig1B4F.patches, var_core_value_sig0C7F, var_core_value_sig6FB9), Vo(var_core_value_sig1B4F, var_core_value_sig6FB9), var_core_value_sig6FB9.forEach(var_core_value_sig6F77 => var_core_value_sig5B1A.add(z(var_core_value_sigAE05, var_core_value_sig6F77))), var_core_value_sig0C7F.forEach(var_core_value_sigFA4B => var_core_value_sig5B1A.add(B(var_core_value_sigAE05, var_core_value_sigFA4B))), var_core_value_sig41F0.forEach(var_core_value_sig2AB0 => var_core_value_sig5B1A.add(V(var_core_value_sigAE05, var_core_value_sig2AB0))), [...var_core_value_sig5B1A];
}
;
function Fo(var_core_value_sigA696, var_core_value_sig91AE) {
  let var_core_value_sigBC03 = var_core_value_sigA696.getSnapshot(),
    var_core_value_sig5CD8 = new j().getAffectedRanges(var_core_value_sig91AE),
    var_core_value_sigC707 = Io(var_core_value_sig91AE),
  ...
  return var_core_value_sig5CD8.forEach(var_core_value_sig853D => {
    ...
    var_core_value_sig37BD.add(R(var_core_value_sig79C0));
    ...
    var_core_value_sig6F1A && var_core_value_sig37BD.add(B(var_core_value_sig79C0, var_core_value_sig6F1A)), var_core_value_sig1802 && var_core_value_sig37BD.add(z(var_core_value_sig79C0, var_core_value_sig1802)), var_core_value_sig853D.viewId && var_core_value_sig37BD.add(V(var_core_value_sig79C0, var_core_value_sig853D.viewId)), (var_core_value_sig853D.reason === "table" || var_core_value_sigC707.has(var_core_value_sig79C0)) && var_core_value_sig173D && (Object.keys(var_core_value_sig173D.fields).forEach(var_core_value_sig055E => var_core_value_sig37BD.add(z(var_core_value_sig79C0, var_core_value_sig055E))), Object.keys(var_core_value_sig173D.records).forEach(var_core_value_sig7C77 => var_core_value_sig37BD.add(B(var_core_value_sig79C0, var_core_value_sig7C77))), Object.keys(var_core_value_sig173D.views).forEach(var_core_value_sig9578 => var_core_value_sig37BD.add(V(var_core_value_sig79C0, var_core_value_sig9578)))), var_core_value_sig853D.reason === "record" && var_core_value_sig173D && Object.keys(var_core_value_sig173D.fields).forEach(var_core_value_sigA2D31 => var_core_value_sig37BD.add(z(var_core_value_sig79C0, var_core_value_sigA2D31)));
  }), var_core_value_sig5CD8.length === 0 && Ro(var_core_value_sig91AE, "tableOrder") && Object.keys(var_core_value_sigBC03.tables).forEach(var_core_value_sigCFA7 => var_core_value_sig37BD.add(R(var_core_value_sigCFA7))), [...var_core_value_sig37BD];
}
;
function Io(var_core_value_sig03EA) {
  let var_core_value_sig6457 = new Set(),
    var_core_value_sig112F = var_core_value_sig31C2 => {
      Array.isArray(var_core_value_sig31C2) && var_core_value_sig31C2.forEach((var_core_value_sigC218, var_core_value_sigADEC) => {
        var_core_value_sigC218 === 'tables' && typeof var_core_value_sig31C2[var_core_value_sigADEC + 1] == 'string' && Lo(var_core_value_sig31C2[var_core_value_sigADEC + 2]) && var_core_value_sig6457.add(var_core_value_sig31C2[var_core_value_sigADEC + 1]), var_core_value_sig112F(var_core_value_sigC218);
      });
    };
  return var_core_value_sig112F(var_core_value_sig03EA), var_core_value_sig6457;
}
;
function Lo(var_core_value_sig04D3) {
...
;
function Ro(var_core_value_sig876A, var_core_value_sigB1F9) {
  return Array.isArray(var_core_value_sig876A) && var_core_value_sig876A.some(var_core_value_sigA677 => var_core_value_sigA677 === var_core_value_sigB1F9 || Ro(var_core_value_sigA677, var_core_value_sigB1F9));
}
;
function zo(var_core_value_sig635D, var_core_value_sig6923) {
  let var_core_value_sig338F = new Set(),
    ...
    var_core_value_sig5E4F = (var_core_value_sigC015, var_core_value_sigAEBC = '') => {
      ...
      Uo(var_core_value_sigC015) && Object.entries(var_core_value_sigC015).forEach(([var_core_value_sig3D8E, var_core_value_sig37E5]) => {
...
;
function Bo(var_core_value_sig3736, var_core_value_sig7D19, var_core_value_sig9E9F, var_core_value_sig4A92) {
  !var_core_value_sig3736 || !Array.isArray(var_core_value_sig7D19) || var_core_value_sig7D19.forEach(var_core_value_sig366A => {
    if (!Uo(var_core_value_sig366A)) return;
...
;
function Vo(var_core_value_sig652F, var_core_value_sigA8CE, var_core_value_sig1941 = '') {
  if (!(!var_core_value_sig652F || typeof var_core_value_sig652F != 'object')) {
    if (Array.isArray(var_core_value_sig652F)) {
      var_core_value_sig652F.forEach(var_core_value_sigE627 => Vo(var_core_value_sigE627, var_core_value_sigA8CE, var_core_value_sig1941));
      return;
    }
    Uo(var_core_value_sig652F) && Object.entries(var_core_value_sig652F).forEach(([var_core_value_sigC84D, var_core_value_sigF2BC]) => {
      var_core_value_sig1941 === "values" && var_core_value_sigA8CE.add(var_core_value_sigC84D), Vo(var_core_value_sigF2BC, var_core_value_sigA8CE, var_core_value_sigC84D);
    });
  }
}
;
function Ho(var_core_value_sigF945) {
  return Array.isArray(var_core_value_sigF945);
}
;
function Uo(var_core_value_sig6178) {
...
let Go = class {
  ...
  getBase(var_core_value_sig18A6) {
    return this._univerInstanceService["getUnit"](var_core_value_sig18A6, e.UniverInstanceType["UNIVER_BASE"]) ?? null;
  }
  getAllBases() {
    return this._univerInstanceService["getAllUnitsForType"](e.UniverInstanceType["UNIVER_BASE"]);
  }
  createBase(var_core_value_sigA98B) {
    return this._univerInstanceService['createUnit'](e.UniverInstanceType["UNIVER_BASE"], var_core_value_sigA98B);
  }
};
...
var qo = class extends e.Disposable {
  constructor(...var_core_value_sig458C) {
    super(...var_core_value_sig458C), L(this, "_plugins", new Map());
  }
  register(var_core_value_sig8DEC) {
    return this._plugins["set"](var_core_value_sig8DEC.type, var_core_value_sig8DEC), (0, e.toDisposable)(() => this._plugins["delete"](var_core_value_sig8DEC.type));
  }
  get(var_core_value_sig522F) {
    let var_core_value_sigD718 = this._plugins['get'](var_core_value_sig522F);
    if (!var_core_value_sigD718) throw Error('[BaseViewRegistryService]:\x20view\x20type\x20\x22' + var_core_value_sig522F + '\x22\x20is\x20not\x20registered.');
...
let X = class extends e.Plugin {
  constructor(var_core_value_sig41CF = xo, var_core_value_sig1EFD, var_core_value_sig38BB, var_core_value_sig017C, var_core_value_sig44BC, var_core_value_sigAB7B) {
    super(), this._config = var_core_value_sig41CF, this._injector = var_core_value_sig1EFD, this._commandService = var_core_value_sig38BB, this._univerInstanceService = var_core_value_sig017C, this._configService = var_core_value_sig44BC, this._dataSyncPrimaryController = var_core_value_sigAB7B, L(this, "_baseSyncDisposables", new Map());
    let {
      ...var_core_value_sig55EE
    } = (0, e.merge)({}, xo, this._config);
    this._configService["setConfig"]("bases.config", var_core_value_sig55EE), this._univerInstanceService["registerCtorForType"](e.UniverInstanceType['UNIVER_BASE'], e.BaseDataModel), this._initDependencies(), this._initCommands(), this._initRegistries(), this._initDataSync();
  }
  onReady() {
    (0, e.touchDependencies)(this._injector, [[Go], [Vn], [Eo]]), this._univerInstanceService["getAllUnitsForType"](e.UniverInstanceType["UNIVER_BASE"]).forEach(var_core_value_sigD37B => this._syncBaseUnit(var_core_value_sigD37B.getUnitId())), (0, e.touchDependencies)(this._injector, [[Do], [jo]]);
  }
  _initDependencies() {
    [[dn, {
      'useClass': fn
      ...
      'useClass': Vn
    }], [Eo], [Do], [jo]].forEach(var_core_value_sigFA28 => this._injector['add'](var_core_value_sigFA28));
  }
  _initCommands() {
    [Si, $i, Bi, ma, oa, aa, yi, _i, mi, zi, hi, Ui, va, Ji, vi, Hi, ga, ha, gi, Ri, qi, Ea, Li, Wi, ea, na, Vi, Qi, Ta, ba, ta, ra, _a, da, pa, fa, sa, la, ua, ca, ...Jo].forEach(var_core_value_sig93BE => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig93BE))), Jo.forEach(var_core_value_sigABEC => {
  ...
  _initDataSync() {
    this._dataSyncPrimaryController && (this.disposeWithMe(this._univerInstanceService["getTypeOfUnitAdded$"](e.UniverInstanceType['UNIVER_BASE']).subscribe(({
      unit: var_core_value_sig0B9E
    }) => {
      this._syncBaseUnit(var_core_value_sig0B9E.getUnitId());
    })), this.disposeWithMe(this._univerInstanceService['getTypeOfUnitDisposed$'](e.UniverInstanceType["UNIVER_BASE"]).subscribe(var_core_value_sigC545 => {
  ...
  _initRegistries() {
    let var_core_value_sig3BA9 = this._injector["get"](dn);
    Ft().forEach(var_core_value_sig6F4E => var_core_value_sig3BA9.register(var_core_value_sig6F4E));
    let var_core_value_sigE2301 = this._injector['get'](Ko),
      var_core_value_sig5AC8 = this._injector["get"](Qn);
    qn().forEach(var_core_value_sigA021 => {
      var_core_value_sigE2301.register(var_core_value_sigA021), var_core_value_sig5AC8.registerView(var_core_value_sigA021);
    });
  }
};
L(X, "pluginName", "BASES_PLUGIN"), L(X, "packageName", yo), L(X, "version", bo), L(X, "type", e.UniverInstanceType["UNIVER_BASE"]), X = U([(0, e.DependentOn)(r.UniverLicensePlugin, t.UniverProFormulaEnginePlugin), H(1, (0, e.Inject)(e.Injector)), H(2, e.ICommandService), H(3, e.IUniverInstanceService), H(4, e.IConfigService), H(5, (0, e.Optional)(i.DataSyncPrimaryController))], X);
let Z = class extends e.Plugin {
  constructor(var_core_value_sigE492 = So, var_core_value_sig3465, var_core_value_sig38DD, var_core_value_sig89AE, var_core_value_sig3A69) {
    ...
    } = (0, e.merge)({}, So, this._config);
    this._configService["setConfig"]('bases.remote.config', var_core_value_sigD64C), this._univerInstanceService["registerCtorForType"](e.UniverInstanceType["UNIVER_BASE"], e.BaseDataModel), [[dn, {
      'useClass': fn
    }], [Qn, {
      'useClass': tr
    }]].forEach(var_core_value_sig49D9 => this._injector['add'](var_core_value_sig49D9)), Jo.forEach(var_core_value_sig320C => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig320C)));
  }
};
L(Z, "pluginName", 'REMOTE_BASES_PLUGIN'), L(Z, "packageName", yo), L(Z, "version", bo), L(Z, "type", e.UniverInstanceType["UNIVER_BASE"]), Z = U([(0, e.DependentOn)(r.UniverLicensePlugin, t.UniverProFormulaEnginePlugin), H(1, (0, e.Inject)(e.Injector)), H(2, e.ICommandService), H(3, e.IConfigService), H(4, e.IUniverInstanceService)], Z);
function Yo(var_core_value_sig483F) {
  let var_core_value_sig2FD9 = cs(var_core_value_sig483F.query);
  ...
  var_core_value_sig483F.rows["forEach"]((var_core_value_sig1E7C, var_core_value_sigD3C4) => {
    var_core_value_sig5948.forEach(({
      ...
      let var_core_value_sigA45D = Xo(var_core_value_sig1E7C.values[var_core_value_sigE837.id], var_core_value_sigE837);
      if (!var_core_value_sigA45D) return;
      let var_core_value_sig1BC7 = ss(var_core_value_sig2FD9, var_core_value_sigA45D.searchTexts);
  ...
  return {
    ...
    'matches': us(var_core_value_sigFA04)
  };
}
;
function Xo(var_core_value_sig3986, var_core_value_sig1950) {
  let var_core_value_sigE263 = [];
  for (let var_core_value_sigCF06 of Qo(var_core_value_sig3986, var_core_value_sig1950)) {
    let var_core_value_sig4956 = cs(var_core_value_sigCF06);
    var_core_value_sig4956 && var_core_value_sigE263.push(var_core_value_sig4956);
  }
  return var_core_value_sigE263.length ? {
    'displayText': Zo(var_core_value_sig3986, var_core_value_sig1950),
    'searchTexts': ls(var_core_value_sigE263)
  } : null;
}
;
function Zo(var_core_value_sig86D3, var_core_value_sigE5A5) {
  switch (var_core_value_sigE5A5.type) {
    case e.BaseFieldType["SingleSelect"]:
    case e.BaseFieldType['MultiSelect']:
    case e.BaseFieldType["Group"]:
      return $o(var_core_value_sig86D3, var_core_value_sigE5A5).join(',\x20');
    case e.BaseFieldType["Link"]:
      return ns(var_core_value_sig86D3);
    case e.BaseFieldType['Date']:
    case e.BaseFieldType["CreatedAt"]:
    case e.BaseFieldType["UpdatedAt"]:
      return rs(var_core_value_sig86D3, var_core_value_sigE5A5);
    case e.BaseFieldType["Number"]:
    case e.BaseFieldType['Currency']:
      return is(var_core_value_sig86D3, var_core_value_sigE5A5);
    case e.BaseFieldType["Progress"]:
      return as(var_core_value_sig86D3, var_core_value_sigE5A5);
    case e.BaseFieldType["Checkbox"]:
      return var_core_value_sig86D3 ? "Checked" : 'Unchecked';
    case e.BaseFieldType['Attachment']:
      return os(var_core_value_sig86D3).join(',\x20');
    default:
      return Q(var_core_value_sig86D3);
  }
}
;
function Qo(var_core_value_sig1ABB, var_core_value_sig8781) {
  switch (var_core_value_sig8781.type) {
    case e.BaseFieldType['SingleSelect']:
    case e.BaseFieldType["MultiSelect"]:
    case e.BaseFieldType["Group"]:
      {
        let var_core_value_sigCC9E = $o(var_core_value_sig1ABB, var_core_value_sig8781);
    ...
    case e.BaseFieldType["Link"]:
      {
        let var_core_value_sig444C = ts(var_core_value_sig1ABB);
        return [var_core_value_sig444C.text, var_core_value_sig444C.url];
      }
    case e.BaseFieldType['Date']:
    case e.BaseFieldType["CreatedAt"]:
    case e.BaseFieldType["UpdatedAt"]:
      return [rs(var_core_value_sig1ABB, var_core_value_sig8781), Q(var_core_value_sig1ABB)];
    case e.BaseFieldType["Number"]:
    case e.BaseFieldType['Currency']:
      return [is(var_core_value_sig1ABB, var_core_value_sig8781), Q(var_core_value_sig1ABB)];
    case e.BaseFieldType["Progress"]:
      return [as(var_core_value_sig1ABB, var_core_value_sig8781), Q(var_core_value_sig1ABB)];
    case e.BaseFieldType["Checkbox"]:
      return var_core_value_sig1ABB ? ["Checked", "Yes", 'True'] : ["Unchecked", 'No', 'False'];
    case e.BaseFieldType["Attachment"]:
      return os(var_core_value_sig1ABB);
    default:
      return [Q(var_core_value_sig1ABB)];
  }
}
;
function $o(var_core_value_sig360F, var_core_value_sig79D71) {
  ...
  if (Array.isArray(var_core_value_sig360F)) {
    for (let var_core_value_sigE42E = 0; var_core_value_sigE42E < var_core_value_sig360F.length; var_core_value_sigE42E++) {
      ...
      var_core_value_sig273D && var_core_value_sig3105.push(es(var_core_value_sigCAD1, var_core_value_sig273D));
    }
    return var_core_value_sig3105;
  }
  if (var_core_value_sig360F != null) {
    let var_core_value_sig6BCD = String(var_core_value_sig360F);
    var_core_value_sig6BCD && var_core_value_sig3105.push(es(var_core_value_sigCAD1, var_core_value_sig6BCD));
  }
  return var_core_value_sig3105;
}
;
function es(var_core_value_sig4D9D, var_core_value_sig6D0D) {
...
;
function ts(var_core_value_sig5BA6) {
  ...
  return {
    'text': Q(var_core_value_sig5BA6),
    'url': Q(var_core_value_sig5BA6)
  };
}
;
function ns(var_core_value_sig33C81) {
  let var_core_value_sig851E = ts(var_core_value_sig33C81);
  return var_core_value_sig851E.text || var_core_value_sig851E.url;
}
;
function rs(var_core_value_sigD0FB, var_core_value_sig0A5F) {
  return typeof var_core_value_sigD0FB != 'number' || !Number.isFinite(var_core_value_sigD0FB) ? '' : ut(var_core_value_sigD0FB, var_core_value_sig0A5F.config);
}
;
function is(var_core_value_sig53D2, var_core_value_sigEDB2) {
  let var_core_value_sig71CD = typeof var_core_value_sig53D2 == "number" ? var_core_value_sig53D2 : Number(var_core_value_sig53D2);
  return Number.isFinite(var_core_value_sig71CD) ? Pa(var_core_value_sig71CD, var_core_value_sigEDB2.config) : '';
}
;
function as(var_core_value_sig6687, var_core_value_sigCFDD) {
  let var_core_value_sigDC0A = typeof var_core_value_sig6687 == "number" ? var_core_value_sig6687 : Number(var_core_value_sig6687);
  return Number.isFinite(var_core_value_sigDC0A) ? za(var_core_value_sigDC0A, var_core_value_sigCFDD.config) : '';
}
;
function os(var_core_value_sig644F) {
...
;
function Q(var_core_value_sigDB71) {
  ...
  if (Array.isArray(var_core_value_sigDB71)) {
    ...
    for (let var_core_value_sigF039 = 0; var_core_value_sigF039 < var_core_value_sigDB71.length; var_core_value_sigF039++) {
      ...
      let var_core_value_sigA319 = Q(var_core_value_sigDB71[var_core_value_sigF039]);
...
;
function ss(var_core_value_sig46F8, var_core_value_sig1F6D) {
...
;
function ds(var_core_value_sig0CA2) {
  return {
    'compress': true,
    'kind': "base-range-values-v1",
    'u': var_core_value_sig0CA2.unitId,
    't': var_core_value_sig0CA2.tableId,
    'p': var_core_value_sig0CA2.patches["map"](var_core_value_sig3F70 => [var_core_value_sig3F70.row, var_core_value_sig3F70.col, hs(var_core_value_sig3F70.value)]),
...
;
function fs(var_core_value_sig8FF7) {
  if (Ss(var_core_value_sig8FF7, "base-range-values-v1"), !ps(var_core_value_sig8FF7)) {
    if (!xs(var_core_value_sig8FF7)) throw Error('[BaseCompression]:\x20invalid\x20uncompressed\x20range\x20values\x20payload.');
  ...
  return {
    ...
    'patches': var_core_value_sig8FF7.p["map"](([var_core_value_sig9F91, var_core_value_sigC9C8, var_core_value_sigC444]) => ({
      ...
      'value': gs(var_core_value_sigC444)
    })),
...
;
function ps(var_core_value_sig02FD) {
  return !$(var_core_value_sig02FD) || var_core_value_sig02FD.compress !== true || var_core_value_sig02FD.kind !== 'base-range-values-v1' ? false : typeof var_core_value_sig02FD.u == 'string' && typeof var_core_value_sig02FD.t == "string" && (var_core_value_sig02FD.g === undefined || typeof var_core_value_sig02FD.g == "string") && Array.isArray(var_core_value_sig02FD.p) && var_core_value_sig02FD.p["every"](var_core_value_sig4B40 => Array.isArray(var_core_value_sig4B40) && var_core_value_sig4B40.length === 3 && Number.isInteger(var_core_value_sig4B40[0]) && Number.isInteger(var_core_value_sig4B40[1]));
}
;
function ms(var_core_value_sig1A37) {
  return !$(var_core_value_sig1A37) || var_core_value_sig1A37.compress !== true || var_core_value_sig1A37.kind !== "base-snapshot-v1" || !$(var_core_value_sig1A37.tables) ? false : Object.values(var_core_value_sig1A37.tables).every(var_core_value_sig9F6D => $(var_core_value_sig9F6D) && (var_core_value_sig9F6D.cd === undefined || Array.isArray(var_core_value_sig9F6D.cd) && var_core_value_sig9F6D.cd['every'](var_core_value_sigA321 => Array.isArray(var_core_value_sigA321) && var_core_value_sigA321.length === 3 && Number.isInteger(var_core_value_sigA321[0]) && Number.isInteger(var_core_value_sigA321[1]) && bs(var_core_value_sigA321[2]))));
}
;
function hs(var_core_value_sigF87C) {
  return ys(var_core_value_sigF87C) ? _s(var_core_value_sigF87C) : var_core_value_sigF87C;
}
;
function gs(var_core_value_sig563A) {
  return bs(var_core_value_sig563A) ? vs(var_core_value_sig563A) : var_core_value_sig563A;
}
;
function _s(var_core_value_sig8341) {
  return {
    'c': 1,
...
;
function vs(var_core_value_sig1BAA) {
  return {
...
;
function ys(var_core_value_sigF583) {
...
;
function bs(var_core_value_sig0BFC) {
  return $(var_core_value_sig0BFC) && var_core_value_sig0BFC.c === 1;
}
;
function xs(var_core_value_sigBA64) {
  return $(var_core_value_sigBA64) && typeof var_core_value_sigBA64.unitId == "string" && typeof var_core_value_sigBA64.tableId == "string" && (var_core_value_sigBA64.trigger === undefined || typeof var_core_value_sigBA64.trigger == "string") && Array.isArray(var_core_value_sigBA64.patches) && var_core_value_sigBA64.patches["every"](var_core_value_sigE1A2 => $(var_core_value_sigE1A2) && Number.isInteger(var_core_value_sigE1A2.row) && Number.isInteger(var_core_value_sigE1A2.col) && "value" in var_core_value_sigE1A2);
}
;
function Ss(var_core_value_sig9C5D, var_core_value_sig5B04) {
  if (!(!$(var_core_value_sig9C5D) || var_core_value_sig9C5D.compress !== true)) {
    ...
    if (!(var_core_value_sig5B04 === "base-range-values-v1" ? ps(var_core_value_sig9C5D) : ms(var_core_value_sig9C5D))) throw Error("[BaseCompression]: invalid compressed payload \"" + var_core_value_sig5B04 + '\x22.');
  }
}
;
function $(var_core_value_sig3D58) {
  return !!var_core_value_sig3D58 && typeof var_core_value_sig3D58 == 'object' && !Array.isArray(var_core_value_sig3D58);
}
exports.ApplyBaseJson1Mutation = J, exports.BASE_FIELD_STAT_TYPES = Va, exports.BASE_HIERARCHY_MAX_LEVELS = 5, exports.BASE_HIERARCHY_PARENT_FIELD_ID = p, exports.BASE_TABLE_NAME_REQUIREMENTS = "Base table names are exported as Excel worksheet names and must contain 1-31 characters, not start or end with an apostrophe, not contain : \\ / ? * [ ], and be unique (case-insensitive).", exports.BASE_UNIT_PERMISSION_ACTIONS = Sn, exports.BaseConditionalColorRuleUpdateType = ya, exports.BaseEventSource = g, exports.BaseFormulaService = Ur, exports.BaseHierarchyError = h, exports.BaseHierarchyErrorCode = m, exports.BaseHistoryAction = jr, exports.BaseJson1OpApplier = j, exports.BaseJson1OpFactory = I, exports.BatchCreateBaseRecordsCommand = mi, exports.BatchDeleteBaseRecordsCommand = hi, exports.ChangeBaseFieldTypeCommand = gi, exports.CreateBaseChildRecordCommand = _i, exports.CreateBaseFieldCommand = vi, exports.CreateBaseRecordCommand = yi, exports.CreateBaseTableCommand = Si, exports.CreateBaseViewCommand = Li, exports.DeleteBaseFieldCommand = Ri, exports.DeleteBaseRecordCommand = zi, exports.DeleteBaseTableCommand = Bi, exports.DeleteBaseViewCommand = Vi, exports.DuplicateBaseFieldCommand = Hi, exports.DuplicateBaseRecordCommand = Ui, exports.EMBED_BASES_TABLE_RESOURCE_KEY = Oa, exports.EnsureBaseTemporalViewDateFieldsCommand = Wi, exports.IBaseCommandService = G, exports.IBasePermissionService = In, exports.IBaseProjectionService = Qn, exports.IBaseViewRegistryService = Ko, exports.MoveBaseFieldCommand = qi, exports.MoveBaseHierarchyRecordCommand = Ji, exports.MoveBaseViewCommand = Qi, exports.RenameBaseTableCommand = $i, exports.RenameBaseViewCommand = ea, exports.SetBaseKanbanGroupFieldCommand = ta, exports.SetBaseNameCommand = na, exports.SetBasePermissionCommand = ra, exports.SetBaseRangeValuesCommand = aa, exports.SetBaseRecordValuesCommand = oa, exports.SetBaseTableHierarchyFieldCommand = sa, exports.SetBaseViewFieldOrderCommand = ca, exports.SetBaseViewFieldVisibleCommand = la, exports.SetBaseViewFieldWidthCommand = ua, exports.SetBaseViewFilterCommand = da, exports.SetBaseViewGroupCommand = fa, exports.SetBaseViewSortCommand = pa, Object.defineProperty(exports, 'UniverBasesPlugin', {
  'enumerable': true,
  'get': function () {
    return X;
  }
...
}), exports.UpdateBaseCellCommand = ma, exports.UpdateBaseFieldCommand = ga, exports.UpdateBaseFieldDescriptionCommand = ha, exports.UpdateBaseKanbanConfigCommand = _a, exports.UpdateBaseRecordOrderCommand = va, exports.UpdateBaseViewConditionalColorRulesCommand = ba, exports.UpdateBaseViewConfigCommand = Ta, exports.ValidateBaseFormulaCommand = Ea, exports.baseDateSerialToDateMs = st, exports.buildBaseHierarchyIndex = E, exports.calculateBaseFieldStat = Qa, exports.canEditBaseTargets = Fn, exports.compressBaseRangeValuesPayload = ds, exports.copyBaseTableSnapshot = vo, exports.createBaseHierarchyParentField = b, exports.createDefaultBaseTableSnapshot = Da, exports.createEmbedBasesTable = ka, exports.createEmbedBasesTableAddMutation = Aa, exports.createEmbedBasesTableRemoveMutation = ja, exports.createUniqueBaseTableName = xi, exports.dateToExcelSerial = M, exports.decompressBaseRangeValuesPayload = fs, exports.ensureBaseTableCellLayout = k, exports.findRecordLinkReferences = f, exports.formatBaseDateValue = ut, exports.formatBaseFieldStatValue = $a, exports.formatBaseNumberValue = Pa, exports.formatBaseProgressValue = za, exports.getActiveBaseHierarchyFieldIds = x, exports.getBaseCellFormulaValue = _e, exports.getBaseCellValue = ge, exports.getBaseConditionalColorOperators = mt, exports.getBaseDashboardPermissionObjectId = kn, exports.getBaseFieldPermissionObjectId = z, Object.defineProperty(exports, "getBaseFormulaTableName", {
  'enumerable': true,
  'get': function () {
    return e.getBaseFormulaTableName;
  }
}), exports.getBaseHierarchyDeletePromotions = T, exports.getBaseHierarchyFieldId = v, exports.getBasePermissionValue = jn, exports.getBaseRecordPermissionObjectId = B, exports.getBaseTablePermissionObjectId = R, exports.getBaseViewPermissionObjectId = V, exports.getRecordLinkFieldConfig = o, exports.getSupportedBaseFieldStatTypes = Xa, exports.getVisibleBaseHierarchyRows = ee, exports.inferBaseSeparatorStyle = Ra, exports.isBaseConditionalColorDateField = ht, exports.isBaseFieldStatEmptyValue = eo, exports.isBaseFieldStatSupported = Za, exports.isBaseFieldStatType = Ja, exports.isBaseHierarchyField = _, exports.isCompressedBaseRangeValuesPayload = ps, exports.matchesBaseCondition = _t, exports.normalizeBaseDateFieldConfig = lt, exports.normalizeBaseDateSerial = ot, exports.normalizeBaseFieldStatsConfig = Ya, exports.parseRecordLinkIds = s, exports.projectBaseHierarchy = D, exports.resolveBaseDateFieldConfig = ct, exports.resolveBaseHierarchyFieldId = y, exports.resolveBaseRangeHierarchyPatches = ia, exports.searchBaseTable = Yo, exports.serializeRecordLinkIds = c, exports.setBasePermissionValue = Mn, exports.traceBasePerformance = O, exports.uniqueFieldName = Ci, exports.validateBaseHierarchyMove = te, exports.validateBaseHierarchyRecordCreations = C, exports.validateBaseHierarchyRecordPatches = S, exports.validateBaseTableName = bi, exports.validateCanonicalRecordLinkValue = l, exports.validateRecordLinkField = u, exports.validateRecordLinkValue = d;
