...
function Ie(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463034, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463035) {
  if (typeof var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463034 != 'string') return {
    'valid': false,
    'reason': '[RecordLink]:\x20value\x20must\x20be\x20a\x20canonical\x20string.'
  };
  if (var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463034 === '') return {
    'valid': true
  };
  let var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036 = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463034.split(',');
  return !var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463035 && var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036.length > 1 ? {
    'valid': false,
    'reason': "[RecordLink]: a single link accepts only one record id."
  } : var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036.some(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46779 => !isValidBaseRecordId(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46779)) || new Set(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036).size !== var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036.length || Fe(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463036) !== var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463034 ? {
    'valid': false,
...
export { Ie as validateCanonicalRecordLinkValue };
