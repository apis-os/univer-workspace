...
import { Or } from "./bases-unit-permission-actions.js";
function Ar(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463840) {
  return '' + Or + encodeURIComponent(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463840);
}
export { Ar as getBaseDashboardPermissionObjectId };
