...
import { on } from "./internal-db-endo.js";
function cn(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463496, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463497 = DateSystem.Date1900) {
  let var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463498 = sn(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463496, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463497);
  return var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463498 == null ? null : on(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463498, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463497);
}
export { cn as baseDateSerialToDateMs };
