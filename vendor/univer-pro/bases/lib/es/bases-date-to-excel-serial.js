...
function z(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463480, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463481 = DateSystem.Date1900) {
  let var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463482 = dateKit(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463480).valueOf();
  return excelDateTimeSerial(new Date(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463482), var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463481);
}
export { z as dateToExcelSerial };
