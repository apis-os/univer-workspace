...
function Fo(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640) {
  return {
    'id': Q.id,
    'params': {
      'unitId': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.unitId,
      'op': JSON1.type['compose'](JSON1.insertOp(["tables", var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.table['id']], var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.table), JSON1.insertOp(["tableOrder", var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.index ?? var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.snapshot['tableOrder'].length], var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465640.table['id'])),
      'trigger': 'embed-ui'
    }
  };
}
export { Fo as createEmbedBasesTableAddMutation };
