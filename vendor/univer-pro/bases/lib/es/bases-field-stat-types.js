...
const Ko = ["count", "filled", "empty", 'unique', "sum", "average", "min", "max"],
  ...
  Yo = ["min", "max"],
  Xo = new Set([BaseFieldType.Number, BaseFieldType.Currency, BaseFieldType.Progress, BaseFieldType.Rating]),
  Zo = new Set([BaseFieldType.MultiSelect, BaseFieldType.Person, BaseFieldType.Group]),
  Qo = 'General';
