...
import { fn_L0_db_endo_routine_pure_O1_zalloc_nothrow_sigD23F7 } from "./bases-field-stat-type.js";
function es(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465702) {
  return !var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465702 || typeof var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465702 != "object" ? {} : Object.fromEntries(Object.entries(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D465702).filter(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D462792 => fn_L0_db_endo_routine_pure_O1_zalloc_nothrow_sigD23F7(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D462792[1])));
}
export { es as normalizeBaseFieldStatsConfig };
