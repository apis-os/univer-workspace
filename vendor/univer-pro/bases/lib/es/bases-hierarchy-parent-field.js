...
function Ke(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463090, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463091 = Ge(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463090), var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463092 = "Parent Items") {
  return {
    'id': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463091,
    'name': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463092,
    'type': BaseFieldType.RecordLink,
    'config': {
      'targetTableId': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463090.id,
      'multiple': false,
      'displayFieldId': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463090.primaryFieldId,
      'pickerFieldIds': [var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463090.primaryFieldId],
      'relationRole': BaseRecordLinkRole.Parent
    }
  };
}
export { Ke as createBaseHierarchyParentField };
