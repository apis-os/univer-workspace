...
function ze(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463066, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463067) {
  return Object.values(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463066.tables).flatMap(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46785 => Object.values(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46785.fields).flatMap(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46117 => {
    let var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46118 = var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46117.type === BaseFieldType.RecordLink ? M(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46117) : null;
    return (var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46118 == null ? undefined : var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46118.targetTableId) === var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463067 ? [{
      'tableId': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46785.id,
      'fieldId': var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D46117.id
    }] : [];
  }));
}
export { ze as findRecordLinkReferences };
