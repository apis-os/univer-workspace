...
import { Er } from "./bases-unit-permission-actions.js";
function q(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463832, var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463833) {
  return '' + Er + encodeURIComponent(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463832) + '/' + encodeURIComponent(var_L0_db_endo_value_pure_O1_zalloc_nothrow_sig0D463833);
}
export { q as getBaseRecordPermissionObjectId };
