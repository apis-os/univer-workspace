...
const Sr = [UnitAction.Edit, UnitAction.Copy, UnitAction.Export, UnitAction.Comment],
  Cr = new Set([UnitObject.Base, UnitObject.BaseTable, UnitObject.BaseField, UnitObject.BaseRecord, UnitObject.BaseView, UnitObject.BaseDashboard]),
  wr = "table/",
  Tr = 'field/',
  Er = "record/",
  Dr = "view/",
