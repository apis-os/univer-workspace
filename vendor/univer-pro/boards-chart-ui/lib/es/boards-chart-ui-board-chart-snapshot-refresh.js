...
let X = class extends Disposable {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46568, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46569) {
    super(), this._snapshotService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46568, this._modelService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46569, V(this, "_runtimeStateSubscriptions", new Map()), this._listenRuntimeData();
  }
  _listenRuntimeData() {
    this.disposeWithMe(this._modelService["chartModelAdded$"].subscribe(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4682 => this._bindRuntimeState(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4682))), this.disposeWithMe(this._modelService["chartModelRemoved$"].subscribe(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4683 => this._releaseRuntimeState(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4683))), this.disposeWithMe(toDisposable(() => {
      this._runtimeStateSubscriptions["forEach"](({
        subscription: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4613
      }) => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4613.unsubscribe()), this._runtimeStateSubscriptions["clear"]();
    }));
  }
  _bindRuntimeState(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572) {
    if (this._runtimeStateSubscriptions["has"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572)) return;
    let var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572.model["config"] == null ? 0 : 1,
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46573 = combineLatest([var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572.model["config$"].pipe(filter(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4684 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4684 != null)), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572.model["style$"]]).pipe(skip(var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D), auditTime(0)).subscribe(() => this._snapshotService["invalidateChart"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572.unitId, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572.chartId));
    this._runtimeStateSubscriptions["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572, {
      subscription: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46573
    });
  }
  _releaseRuntimeState(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46576) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46577;
    (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46577 = this._runtimeStateSubscriptions["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46576)) == null || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46577.subscription["unsubscribe"](), this._runtimeStateSubscriptions["delete"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46576);
  }
};
export { X as BoardChartSnapshotRefreshController };
