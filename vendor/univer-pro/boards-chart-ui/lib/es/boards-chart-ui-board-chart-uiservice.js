...
let Zn = class extends ChartUIService {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46194, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46195, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46196, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46197) {
    super(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46197), this._modelService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46194, this._resourceService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46195, this._commandService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46196;
  }
  ...
  executeChartUpdateConfig(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46202) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46203 = this._modelService["activeRuntimeModel"],
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46204 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46202.unitId ?? (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46203 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46203.unitId),
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46205 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46202.chartId ?? (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46203 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46203.chartId);
    !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46204 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46205 || this._commandService["executeCommand"](UpdateBoardChartConfigCommand.id, {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46202,
      unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46204,
      chartId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46205
    });
  }
};
export { Zn as BoardChartUIService };
