...
import { J, Q, U, V, X, Y, q, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289 } from "./boards-history-ui-boards-history-uiplugin.js";
var L = "@univerjs-pro/boards-history-ui",
  R = "1.0.0-insiders.20260907-70fc579";
function z(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46227, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46228) {
  return function (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4631, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4632) {
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46228(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4631, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4632, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46227);
  };
}
function B(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46231, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46232, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46233, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46234) {
...
V = B([z(0, Inject(Injector)), z(1, IUIPartsService)], V);
U = B([z(0, Inject(HistoryActionSummaryService)), z(1, Inject(LocaleService))], U);
J = B([z(0, Inject(BoardsHistoryDiffService)), z(1, Inject(HistoryRenderAdapterRegistryService)), z(2, Inject(SnapshotService)), z(3, IUniverInstanceService), z(4, Inject(HistoryCanvasHighlightService))], J);
q(Y, "pluginName", "UNIVER_BOARDS_HISTORY_VIEWER_PLUGIN"), q(Y, "packageName", L), q(Y, "version", R), q(Y, "type", UniverInstanceType.UNIVER_UNKNOWN), Y = B([DependentOn(UniverLicensePlugin, UniverBoardsHistoryPlugin, UniverBoardsUIPlugin), z(1, Inject(Injector)), z(2, IConfigService), z(3, ILogService)], Y);
X = B([z(0, IConfigService), z(1, Inject(HistoryRestoreService)), z(2, Inject(HistoryUnitAdapterRegistryService)), z(3, Inject(LocaleService)), z(4, Inject(ThemeService)), z(5, Inject(CollaborationController)), z(6, Inject(DataLoaderService)), z(7, IUniverInstanceService)], X);
Q = B([z(0, ICommandService), z(1, Inject(IBoardSettingsMenuContributionService)), z(2, Inject(LocaleService))], Q);
q(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289, "pluginName", "UNIVER_BOARDS_HISTORY_UI_PLUGIN"), q(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289, "packageName", L), q(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289, "version", R), q(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289, "type", UniverInstanceType.UNIVER_BOARD), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289 = B([DependentOn(UniverLicensePlugin, UniverCollaborationClientPlugin, UniverBoardsHistoryPlugin, UniverBoardsUIPlugin), z(1, Inject(Injector)), z(2, IConfigService)], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46289);
