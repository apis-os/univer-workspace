...
let br = class extends RxDisposable {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461614, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461615) {
    super(), this._commandService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461614, this._shortcutService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461615, this._init();
  }
  _init() {
  ...
  _createQuoteShortcut() {
    return {
      id: SHAPE_TEXT_EDITOR_QUOTE_COMMAND_ID,
      binding: KeyCode.ENTER | MetaKeys.SHIFT,
      priority: 1000,
      preconditions: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46382 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46382.getContextValue("FOCUSING_MIND_MAP_TEXT_EDITOR") && this._commandService["hasCommand"](SHAPE_TEXT_EDITOR_QUOTE_COMMAND_ID)
    };
  }
};
export { br };
