...
import { N } from "./boards-mind-mind-map-mode-id.js";
import { tt } from "./boards-mind-mind-map-plain-structure-kind.js";
function nt(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46841, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46842) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46843 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46842 ?? N.branchLineType;
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46843 === "curve" && !tt(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46841 ?? N.structureKind) ? N.branchLineType : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46843;
}
export { nt as resolveMindMapBranchLineTypeForStructure };
