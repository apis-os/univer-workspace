...
import { g, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB } from "./boards-thread-comment-plugin-config-key.js";
const S = "BOARD_" + TC_PLUGIN_NAME;
...
export { O as UniverBoardsThreadCommentPlugin };
export { C };
