...
export declare const BOARD_UNIVER_THREAD_COMMENT_PLUGIN = "BOARD_UNIVER_THREAD_COMMENT_PLUGIN";
export declare class BoardsThreadCommentResourceController extends Disposable {
