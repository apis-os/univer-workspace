...
function E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461225) {
  return typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461225 == "string" ? {
    isRichText: false,
    text: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461225
  } : {
    documentData: Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461225.getData()),
    isRichText: true,
    text: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461225.toPlainText()
  };
}
export { E as normalizeBoardFacadeTextContent };
