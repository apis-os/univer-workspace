...
var hr = class extends FUniver {
  createBoard(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461213 = {}, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461214) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461215 = this._injector["get"](IUniverInstanceService).createUnit(UniverInstanceType.UNIVER_BOARD, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461213, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461214);
    return this._injector["createInstance"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461811, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461215);
  }
  getActiveBoard() {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461219 = this._injector["get"](IUniverInstanceService).getCurrentUnitOfType(UniverInstanceType.UNIVER_BOARD);
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461219 ? this._injector["createInstance"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461811, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461219) : null;
  }
  getBoard(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461221) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461222 = this._injector["get"](IUniverInstanceService).getUnit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461221, UniverInstanceType.UNIVER_BOARD);
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461222 ? this._injector["createInstance"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461811, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461222) : null;
  }
};
export { hr as FUniverBoardsMixin };
