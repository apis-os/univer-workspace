const e = {
  "collaboration-client-ui": {
    ...
    conflict: {
      ...
      content: "Há\x20um\x20conflito\x20entre\x20sua\x20cópia\x20local\x20e\x20a\x20cópia\x20no\x20servidor.\x20Salve\x20suas\x20edições\x20locais,\x20pois\x20elas\x20serão\x20perdidas\x20ao\x20recarregar\x20a\x20página."
    },
    permission: {
      title: "Erro de autenticação",
      content: "Suas ações estão em conflito com as permissões do servidor. Salve suas edições locais em outro lugar, pois elas serão descartadas após atualizar a página."
    },
    collaboration: {
      "offline-data-not-saved": "Você\x20tem\x20edições\x20offline\x20que\x20não\x20foram\x20salvas\x20no\x20servidor.\x20Verifique\x20sua\x20rede\x20e\x20tente\x20novamente.",
      "single-unit": {
    ...
    auth: {
      needGotoLoginAlert: "Seu\x20login\x20expirou,\x20clique\x20em\x20OK\x20para\x20fazer\x20login\x20novamente,\x20clique\x20em\x20Cancelar\x20para\x20salvar\x20suas\x20edições\x20locais."
    },
    formula: {
      calculation: {
        started: "Cálculo\x20de\x20fórmula\x20iniciado.",
        waiting: "A fila de cálculo de fórmulas está cheia, aguardando slot disponível...",
