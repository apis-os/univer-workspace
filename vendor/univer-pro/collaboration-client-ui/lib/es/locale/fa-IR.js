const e = {
  "collaboration-client-ui": {
    ...
    snapshotLoading: {
      timeout: "بارگیری\x20داده‌ها\x20در\x20{0}/{1}\x20متوقف\x20شده\x20است.\x20برای\x20تلاش\x20دوباره\x20صفحه\x20را\x20تازه‌سازی\x20کنید.",
      refresh: "تازه‌سازی\x20صفحه"
    },
    session: {
      "connection-failed": "اتصال\x20ناموفق\x20بود،\x20لطفا\x20شبکه\x20خود\x20را\x20بررسی\x20کنید.",
