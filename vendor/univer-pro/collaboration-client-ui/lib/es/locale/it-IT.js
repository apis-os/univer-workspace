const e = {
  "collaboration-client-ui": {
    ...
    snapshotLoading: {
      timeout:
        "Il\x20caricamento\x20dei\x20dati\x20si\x20è\x20fermato\x20a\x20{0}/{1}.\x20Aggiorna\x20la\x20pagina\x20per\x20riprovare.",
    ...
    session: {
      ...
      "room-full":
        "La stanza di collaborazione è piena. Le tue modifiche verranno salvate localmente.",
    ...
    collaboration: {
      ...
      closeRoom:
        "I\x20privilegi\x20di\x20modifica\x20sono\x20stati\x20revocati\x20perché\x20la\x20stanza\x20di\x20collaborazione\x20è\x20stata\x20chiusa.",
    },
    auth: {
      needGotoLoginAlert:
        "Il\x20tuo\x20login\x20è\x20scaduto,\x20clicca\x20OK\x20per\x20effettuare\x20nuovamente\x20l\x27accesso,\x20clicca\x20Annulla\x20per\x20salvare\x20le\x20tue\x20modifiche\x20locali.",
    },
    formula: {
      calculation: {
