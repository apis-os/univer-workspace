const e = {
  "collaboration-client-ui": {
    ...
    session: {
      ...
      "room-full":
        "Pokój\x20współpracy\x20jest\x20pełny.\x20Twoje\x20zmiany\x20zostaną\x20zapisane\x20lokalnie.",
    ...
    collaboration: {
      ...
      closeRoom:
        "Uprawnienia do edycji zostały cofnięte, ponieważ pokój współpracy został zamknięty.",
    },
    auth: {
      needGotoLoginAlert:
    ...
    formula: {
      calculation: {
        ...
        waiting:
          "Kolejka\x20obliczania\x20formuł\x20jest\x20pełna,\x20oczekiwanie\x20na\x20wolne\x20miejsce...",
        unable:
          "Nie można teraz wykonać obliczania formuły. Spróbuj ponownie później.",
      },
    },
  },
};
