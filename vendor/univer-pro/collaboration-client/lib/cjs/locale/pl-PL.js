const e = {
  "collaboration-client": {
    ...
    conflict: {
      ...
      content: "Wystąpił\x20konflikt\x20między\x20Twoją\x20lokalną\x20kopią\x20a\x20kopią\x20na\x20serwerze.\x20Zapisz\x20lokalne\x20zmiany,\x20ponieważ\x20zostaną\x20utracone\x20po\x20odświeżeniu\x20strony."
    },
    permission: {
      title: "Błąd uwierzytelniania",
      content: "Twoje działania są sprzeczne z uprawnieniami serwera. Zapisz lokalne zmiany w innym miejscu, ponieważ zostaną odrzucone po odświeżeniu strony."
    },
    collaboration: {
      "single-unit": {
        warning: "Otworzyłeś ten sam plik w innej karcie. W przypadku utraty danych nie możesz edytować w tej karcie."
      },
      closeRoom: "Uprawnienia\x20do\x20edycji\x20zostały\x20cofnięte,\x20ponieważ\x20pokój\x20współpracy\x20został\x20zamknięty."
    },
    auth: {
      needGotoLoginAlert: "Twoje logowanie wygasło, kliknij OK, aby zalogować się ponownie, lub Anuluj, aby zapisać lokalne zmiany."
    }
  }
};
module.exports = e;
