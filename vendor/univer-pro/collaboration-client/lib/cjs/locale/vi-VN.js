const e = {
  "collaboration-client": {
    ...
    conflict: {
      ...
      content: "Có\x20sự\x20xung\x20đột\x20giữa\x20bản\x20sao\x20cục\x20bộ\x20của\x20bạn\x20và\x20bản\x20sao\x20trên\x20máy\x20chủ.\x20Vui\x20lòng\x20lưu\x20các\x20chỉnh\x20sửa\x20cục\x20bộ\x20của\x20bạn,\x20vì\x20chúng\x20sẽ\x20bị\x20mất\x20khi\x20bạn\x20tải\x20lại\x20trang."
    },
    permission: {
      title: "Lỗi xác thực",
      content: "Hành động của bạn xung đột với quyền của máy chủ. Vui lòng lưu các chỉnh sửa cục bộ của bạn ở nơi khác vì chúng sẽ bị hủy sau khi làm mới trang."
    },
    collaboration: {
      "single-unit": {
        warning: "Bạn đã mở cùng một tệp trong một tab khác. Để tránh mất dữ liệu, bạn không thể chỉnh sửa trên tab này."
      },
      closeRoom: "Quyền chỉnh sửa đã bị thu hồi vì phòng cộng tác đã đóng."
    },
    auth: {
      needGotoLoginAlert: "Phiên\x20đăng\x20nhập\x20của\x20bạn\x20đã\x20hết\x20hạn,\x20nhấp\x20OK\x20để\x20đăng\x20nhập\x20lại,\x20nhấp\x20Hủy\x20để\x20lưu\x20các\x20chỉnh\x20sửa\x20cục\x20bộ\x20của\x20bạn."
    }
  }
};
module.exports = e;
