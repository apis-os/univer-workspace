...
let Cn = class extends var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461962 {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461178, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461179, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461180, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461181, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461182, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461183, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461184, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461185, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461186, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461187, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461188, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461189, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461190, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461191) {
    super(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461178, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461180, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461179, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461181, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461182, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461183, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461184, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461185, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461186, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461187, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461188, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461189, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461190, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461191), this.unitID = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461178, this.type = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461179;
  }
  async _init() {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461206 = await super._init();
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46276, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46277) => {
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46276.type !== CommandType.MUTATION || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46277 != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46277.fromCollab || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46277 != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46277.onlyLocal) return;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46278 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46276.params;
      if ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46278 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46278.unitId) !== this.unitID) return;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46279 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46276,
        var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A10 = this._compressMutationService["interceptor"].fetchThroughInterceptors(this._compressMutationService["interceptor"].getInterceptPoints().COMPRESS_MUTATION_SEND)([var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46279], this._univerInstanceService) || [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46279];
      this._onLocalMutation(var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A10[0]);
    })), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461206;
  }
};
export { Cn as BoardCollaborationEntity };
