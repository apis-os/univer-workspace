...
function Mn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461925 = {}) {
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461925.resolveUnit ? {
    resolveUnit: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461925.resolveUnit
  } : {
    resolveUnit: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461290 => ({
      target: {
        unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461290.unitId,
        unitType: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461290.unitType
      }
    })
  };
}
export { Mn as createUniverCollaborationAdapter };
