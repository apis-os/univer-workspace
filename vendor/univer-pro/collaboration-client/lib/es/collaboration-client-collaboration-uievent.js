...
var B = class {
    constructor() {
      z(this, "_event$", new Subject()), z(this, "event$", this._event$["asObservable"]());
    }
    emitEvent(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46451) {
      this._event$["next"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46451);
    }
  },
  kt = class {
    constructor() {
      z(this, "_commentUpdate$", new Subject()), z(this, "commentUpdate$", this._commentUpdate$["asObservable"]());
    }
    onCommentUpdate(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46453) {
      this._commentUpdate$["next"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46453);
    }
  };
