const e = {
  "collaboration-client": {
    ...
    collabStatus: {
      ...
      offline: "Hors\x20ligne,\x20les\x20modifications\x20seront\x20enregistrées\x20localement"
    },
    session: {
      "connection-failed": "Échec de la connexion. Veuillez vérifier votre réseau.",
      "will-retry": "Échec\x20de\x20la\x20connexion.\x20Une\x20nouvelle\x20tentative\x20aura\x20lieu\x20dans\x20un\x20instant.",
      "room-full": "Ce\x20document\x20a\x20atteint\x20sa\x20limite\x20de\x20collaboration.\x20Vos\x20modifications\x20seront\x20enregistrées\x20localement.",
      ...
      "room-permission-denied": "Aucune autorisation de collaboration. Vos modifications seront enregistrées localement.",
    ...
    collaboration: {
      "single-unit": {
        warning: "Vous\x20avez\x20ouvert\x20le\x20même\x20fichier\x20dans\x20un\x20autre\x20onglet.\x20Pour\x20éviter\x20toute\x20perte\x20de\x20données,\x20vous\x20ne\x20pouvez\x20pas\x20modifier\x20dans\x20cet\x20onglet."
      },
