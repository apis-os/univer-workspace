const e = {
  "collaboration-client": {
    collabClient: { tooltip: { reconnect: "Clicca\x20per\x20riconnetterti" } },
    collabStatus: {
    ...
    session: {
      ...
      "join-failed":
        "Impossibile partecipare alla collaborazione. Riprova più tardi. Le tue modifiche verranno memorizzate in locale.",
      "room-not-exists":
      ...
      "room-permission-denied":
        "Nessuna autorizzazione alla collaborazione. Le tue modifiche verranno memorizzate in locale.",
      "room-cnt-exceeds":
    ...
    collaboration: {
      ...
      closeRoom:
        "I privilegi di modifica sono stati revocati perché la stanza collaborativa è stata chiusa.",
    },
    auth: {
      needGotoLoginAlert:
