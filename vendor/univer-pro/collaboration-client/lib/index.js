import { CollaborationEvent as var_core_value_sigA2A4, CompressMutationService as var_core_value_sigA1AC, EmptyMutationInfo as var_core_value_sig6180, ISnapshotServerService as var_core_value_sigB93D, ITransformService as var_core_value_sigB17C, RevisionService as var_core_value_sig69B6, SnapshotService as var_core_value_sig708D, UniverCollaborationPlugin as var_core_value_sig1ED2, b64DecodeUnicode as var_core_value_sig94C1, isTransformChangesetsSuccess as var_core_value_sigABAC, isTransformMutationsWithChangesetFailure as var_core_value_sigFAE6, isTransformMutationsWithChangesetSuccess as var_core_value_sig06AC, mapDocumentTypeToUniverInstanceType as var_core_value_sig57E2, parseChangesetToProtocol as var_core_value_sig01FC, parseProtocolChangeset as var_core_value_sig10FC, textEncoder as var_core_value_sig5374, uuidv4 as var_core_value_sigB66D } from "@univerjs-pro/collaboration";
import { CommandType as var_core_value_sigD0F0, DependentOn as var_core_value_sig8E31, Disposable as var_core_value_sig8339, DisposableCollection as var_core_value_sigA01E, IAuthzIoService as var_core_value_sigA41E, ICommandService as var_core_value_sig939C, IConfigService as var_core_value_sigA49E, IContextService as var_core_value_sig6DEB, IImageIoService as var_core_value_sig2F0D, ILogService as var_core_value_sig5141, IMentionIOService as var_core_value_sigA9E0, IPermissionService as var_core_value_sig751D, IUndoRedoService as var_core_value_sig2E9A, IUniverInstanceService as var_core_value_sigE105, ImageSourceType as var_core_value_sig0BD6, ImageUploadStatusType as var_core_value_sig3070, Inject as var_core_value_sigC66D, Injector as var_core_value_sig8EC5, JSONX as var_core_value_sig1056, LocalUndoRedoService as var_core_value_sig6EE5, LocaleService as var_core_value_sig9DD9, MentionType as var_core_value_sig09AC, Optional as var_core_value_sig1613, Plugin as var_core_value_sigADC6, Quantity as var_core_value_sig4620, Rectangle as var_core_value_sig07FB, RxDisposable as var_core_value_sig617E, Tools as var_core_value_sigC85E, UniverInstanceType as var_core_value_sig8293, UserManagerService as var_core_value_sig050D, Workbook as var_core_value_sig37AE, createIdentifier as var_core_value_sig5B51, generateRandomId as var_core_value_sig64FF, isInternalEditorID as var_core_value_sig86F4, merge as var_core_value_sig9E0F, mergeOverrideWithDependencies as var_core_value_sig3A42, registerDependencies as var_core_value_sig8802, resolveWithBasePath as var_core_value_sig95D5, sequenceExecute as var_core_value_sigE027, toDisposable as var_core_value_sigE537, touchDependencies as var_core_value_sig5D84 } from "@univerjs/core";
import { DocStateChangeManagerService as var_core_value_sigD120, RichTextEditingMutation as var_core_value_sigAA05 } from "@univerjs/docs";
import { InsertSheetMutation as var_core_value_sigC04C, SetSelectionsOperation as var_core_value_sig2069, SheetPermissionInitController as var_core_value_sig5176, SheetsSelectionsService as var_core_value_sig71A1, WorkbookEditablePermission as var_core_value_sig72AD } from "@univerjs/sheets";
import { BehaviorSubject as var_core_value_sig9ABE, ReplaySubject as var_core_value_sig8EF0, Subject as var_core_value_sig234B, concatMap as var_core_value_sig8169, firstValueFrom as var_core_value_sigC5FB, map as var_core_value_sig5453, merge as var_core_value_sig8725, of as var_core_value_sig513B, shareReplay as var_core_value_sig5501, take as var_core_value_sig7784, takeUntil as var_core_value_sigB706 } from "rxjs";
import { CmdRspCode as var_core_value_sig5FD0, CombCmd as var_core_value_sig77E3, ErrorCode as var_core_value_sigB071, FileSource as var_core_value_sig15FE, UnitAction as var_core_value_sigCF47, UnitObject as var_core_value_sigB0F9 } from "@univerjs/protocol";
import { ITelemetryService as var_core_value_sigAF12 } from "@univerjs/telemetry";
import { delay as var_core_value_sigC60C, filter as var_core_value_sig1C3C, map as var_core_value_sig71CF, take as var_core_value_sigC341, takeUntil as var_core_value_sigBA47 } from "rxjs/operators";
import { AddSlidePageMutation as var_core_value_sig3DF7, EnsureSlideMasterPageMutation as var_core_value_sigD49F, MoveSlidePageMutation as var_core_value_sigCECC, RemoveSlidePageMutation as var_core_value_sig0F47 } from "@univerjs-pro/slides";
import { HTTPRequest as var_core_value_sig6B29, HTTPService as var_core_value_sig28E2, ISocketService as var_core_value_sig1578, MergeInterceptorFactory as var_core_value_sig52ED, ThresholdInterceptorFactory as var_core_value_sig135F, UniverNetworkPlugin as var_core_value_sig416D } from "@univerjs/network";
import { UniverLicensePlugin as var_core_value_sigAD5D, getGlobalObject as var_core_value_sig1B8A } from "@univerjs-pro/license";
import { cbc as var_core_value_sigFB18 } from "@noble/ciphers/aes.js";
import { concatBytes as var_core_value_sig703C, randomBytes as var_core_value_sig96CF, utf8ToBytes as var_core_value_sig49F1 } from "@noble/ciphers/utils.js";
import { DRAWING_IMAGE_ALLOW_IMAGE_LIST as var_core_value_sig2F7B, getDrawingImageAllowSize as var_core_value_sigB0DF } from "@univerjs/drawing";
...
function wt(var_core_value_sig5A51) {
  return JSON.stringify(var_core_value_sig5A51).length;
}
function Tt(var_core_value_sigF1D1) {
  "@babel/helpers - typeof";

  return Tt = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigFF19) {
  ...
  }, Tt(var_core_value_sigF1D1);
}
function Et(var_core_value_sig370E, var_core_value_sigDE14) {
  if (Tt(var_core_value_sig370E) != "object" || !var_core_value_sig370E) return var_core_value_sig370E;
  ...
  if (var_core_value_sig02CB !== undefined) {
    ...
    if (Tt(var_core_value_sig6CBB) != "object") return var_core_value_sig6CBB;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sigDE14 === "string" ? String : Number)(var_core_value_sig370E);
}
function Dt(var_core_value_sig68DA) {
  var var_core_value_sig64D8 = Et(var_core_value_sig68DA, "string");
  return Tt(var_core_value_sig64D8) == "symbol" ? var_core_value_sig64D8 : var_core_value_sig64D8 + "";
}
function z(var_core_value_sigD755, var_core_value_sigF897, var_core_value_sigA578) {
  return (var_core_value_sigF897 = Dt(var_core_value_sigF897)) in var_core_value_sigD755 ? Object.defineProperty(var_core_value_sigD755, var_core_value_sigF897, {
...
let Ot = function (var_core_value_sig0260) {
...
var B = class {
    constructor() {
      z(this, "_event$", new var_core_value_sig234B()), z(this, "event$", this._event$["asObservable"]());
    }
  ...
  kt = class {
    constructor() {
      z(this, "_commentUpdate$", new var_core_value_sig234B()), z(this, "commentUpdate$", this._commentUpdate$["asObservable"]());
    }
...
function H(var_core_value_sig9975, var_core_value_sigD6D9, var_core_value_sig2637, var_core_value_sigAF1D) {
...
let At = class extends var_core_value_sig8339 {
  constructor(var_core_value_sig130F) {
    super(), this._univerInstanceService = var_core_value_sig130F, z(this, "_roomMembers", new Map()), z(this, "_roomCreated$", new var_core_value_sig234B()), this.disposeWithMe(var_core_value_sig8725(this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_SHEET).pipe(var_core_value_sig71CF(var_core_value_sig97A2 => var_core_value_sig97A2.getUnitId())), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_DOC).pipe(var_core_value_sig71CF(var_core_value_sig07E9 => var_core_value_sig07E9.getUnitId())), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_BOARD).pipe(var_core_value_sig71CF(var_core_value_sig4F59 => var_core_value_sig4F59.getUnitId())), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_BASE).pipe(var_core_value_sig71CF(var_core_value_sigF564 => var_core_value_sigF564.getUnitId()))).subscribe(var_core_value_sig8CFA => this._removeRoom(var_core_value_sig8CFA)));
  }
  waitForRoom$(var_core_value_sigC0E3) {
    return this._roomMembers["has"](var_core_value_sigC0E3) ? var_core_value_sig513B(this._roomMembers["get"](var_core_value_sigC0E3)) : this._roomCreated$["pipe"](var_core_value_sig71CF(var_core_value_sig2E11 => {
  ...
  updateMember(var_core_value_sig52F7, var_core_value_sig866F) {
    ...
    var_core_value_sigDE3D || (var_core_value_sigDE3D = new jt(), this._roomMembers["set"](var_core_value_sig52F7, var_core_value_sigDE3D), this._roomCreated$["next"](var_core_value_sig52F7)), var_core_value_sigDE3D.updateMember(var_core_value_sig866F);
  }
...
At = H([V(0, var_core_value_sigE105)], At);
var jt = class extends var_core_value_sig8339 {
  constructor(...var_core_value_sigC9ED) {
    super(...var_core_value_sigC9ED), z(this, "_members", new Map()), z(this, "_members$", new var_core_value_sig9ABE(this._members)), z(this, "members$", this._members$["asObservable"]());
  }
  dispose() {
...
function Mt(var_core_value_sig9DAA, var_core_value_sig1F8A) {
  if (Pt(var_core_value_sig9DAA)) return var_core_value_sig1F8A;
  if (var_core_value_sig1F8A.eventID === var_core_value_sigA2A4.SUBMIT_CHANGESET) {
    let var_core_value_sig7BE0 = zt(var_core_value_sig9DAA),
    ...
    return {
      ...
      data: {
        ...
        changeset: var_core_value_sig7BE0.toRemote(var_core_value_sig7D40.data["changeset"], Bt(var_core_value_sig9DAA))
      }
    };
  }
  if (var_core_value_sig1F8A.eventID === var_core_value_sigA2A4.FETCH_MISSING) {
...
function Nt(var_core_value_sigEBB4, var_core_value_sig2B74) {
  if (Pt(var_core_value_sigEBB4)) return [var_core_value_sig2B74];
  switch (var_core_value_sig2B74.eventID) {
    case var_core_value_sigA2A4.NEW_CHANGESETS:
      return [Ft(var_core_value_sigEBB4, var_core_value_sig2B74)];
    case var_core_value_sigA2A4.PSEUDO_FETCH_MISSING_RESULT:
      return [Lt(var_core_value_sigEBB4, var_core_value_sig2B74)];
    case var_core_value_sigA2A4.CHANGESET_SHOULD_RETRY:
      return [It(var_core_value_sigEBB4, var_core_value_sig2B74)];
    default:
      return [var_core_value_sig2B74];
  }
}
function Pt(var_core_value_sig0483) {
...
function Ft(var_core_value_sig4A48, var_core_value_sigD170) {
  return {
    ...var_core_value_sigD170,
    data: var_core_value_sig01FC(Rt(var_core_value_sig4A48, var_core_value_sig10FC(var_core_value_sigD170.data)))
  };
}
function It(var_core_value_sig90E5, var_core_value_sig7000) {
  return {
    ...var_core_value_sig7000,
    data: Rt(var_core_value_sig90E5, var_core_value_sig7000.data)
  };
}
function Lt(var_core_value_sigD7C5, var_core_value_sig3633) {
  let var_core_value_sig1DF5 = var_core_value_sig3633.data;
  return {
    ...var_core_value_sig3633,
    data: {
      ...var_core_value_sig1DF5,
      changesets: var_core_value_sig1DF5.changesets["map"](var_core_value_sig68BE => var_core_value_sig01FC(Rt(var_core_value_sigD7C5, var_core_value_sig10FC(var_core_value_sig68BE))))
    }
  };
}
function Rt(var_core_value_sig90A3, var_core_value_sig28BE) {
  return zt(var_core_value_sig90A3).toLocal(var_core_value_sig28BE, Bt(var_core_value_sig90A3));
}
function zt(var_core_value_sig0224) {
...
function Bt(var_core_value_sig854B) {
  return {
...
let Vt = function (var_core_value_sig1FF6) {
...
const Ht = {
  [var_core_value_sig5FD0.FAIL]: "session.join-failed",
  [var_core_value_sig5FD0.JOIN_ROOM_FULL]: "session.room-full",
  [var_core_value_sig5FD0.JOIN_ROOM_NOT_EXISTS]: "session.room-not-exists",
  [var_core_value_sig5FD0.JOIN_ROOM_PERMISSION_DENIED]: "session.room-permission-denied",
  [var_core_value_sig5FD0.GLOBAL_ROOMS_CNT_EXCEEDS]: "session.room-cnt-exceeds"
};
let Ut = class extends var_core_value_sig617E {
  get sessionStatus() {
  ...
  close() {
    ...
    this._throwTelemetryCollaborationNewChangeset(), (var_core_value_sig6884 = this._socket) == null || var_core_value_sig6884.send({
      cmd: var_core_value_sig77E3.LEAVE,
      data: {
  ...
  _onCombEvent(var_core_value_sig066E) {
    var_core_value_sig066E.cmd === var_core_value_sig77E3.JOIN ? this._onJoinRoomEvent(var_core_value_sig066E) : var_core_value_sig066E.cmd === var_core_value_sig77E3.RECV && this._onRecvEvent(var_core_value_sig066E);
  }
  _joinRoom(var_core_value_sig9B0D) {
    this._sessionStatus$["next"](1), var_core_value_sig9B0D.send({
      cmd: var_core_value_sig77E3.JOIN,
  ...
  _onJoinRoomEvent(var_core_value_sig3D2C) {
    ...
    if (var_core_value_sig3D2C.code in Ht) {
      this._collaborationUIEventService["emitEvent"]({
        id: "JOIN_ROOM_FAILED",
        data: Ht[var_core_value_sig3D2C.code]
  ...
  async send(var_core_value_sig0281, var_core_value_sigED71) {
    ...
    try {
      let var_core_value_sigB33B = Mt(this._identity, var_core_value_sig0281);
      var_core_value_sigB33B.eventID === var_core_value_sigA2A4.SUBMIT_CHANGESET && (this._scheduleCollaborationTimeoutTimer(), this._startTelemetryCollaborationNewChangeset(var_core_value_sigB33B)), this._socket["send"]({
        cmd: var_core_value_sig77E3.INGEST,
        routeKey: this._identity["target"].unitId,
        routeType: "",
  ...
  _startTelemetryCollaborationNewChangeset(var_core_value_sig281C) {
    ...
    this._telemetryInfo = {
      ...
      stopTime: 0,
      duration: 0,
      size: wt(var_core_value_sigE722)
    };
  }
...
Ut = H([V(2, var_core_value_sig5141), V(3, var_core_value_sigA49E), V(4, var_core_value_sigC66D(At)), V(5, var_core_value_sigC66D(kt)), V(6, var_core_value_sigC66D(B)), V(7, var_core_value_sig1613(var_core_value_sigAF12))], Ut);
const U = var_core_value_sig5B51("collaboration-client.local-cache-service");
function Wt(var_core_value_sig4B27) {
  return "unit-cache-" + var_core_value_sig4B27;
}
function Gt(var_core_value_sig3A41) {
  let {
...
let Kt = class {
  ...
  transformSelections(var_core_value_sigB683) {
    ...
    let var_core_value_sig36E7 = this._injector["get"](var_core_value_sig71A1),
      {
        unitId: var_core_value_sig6A78,
        subUnitId: var_core_value_sigF7EF
      } = Gt(var_core_value_sigB683),
    ...
    let var_core_value_sigB609 = [{
        id: var_core_value_sig2069.id,
        params: {
          unitId: var_core_value_sig6A78,
          subUnitId: var_core_value_sig393E,
          selections: var_core_value_sigC85E.deepClone(var_core_value_sig27F9)
        }
      }],
    ...
    if (!var_core_value_sig06AC(var_core_value_sig390D)) throw var_core_value_sig390D.error;
    ...
    if (Array.isArray(var_core_value_sigC928) && var_core_value_sigC928.length) {
      if (var_core_value_sigC928.length === var_core_value_sigB609[0].params["selections"].length && var_core_value_sigC928.every((var_core_value_sigF62A, var_core_value_sig8178) => var_core_value_sig07FB.equals(var_core_value_sigF62A.range, var_core_value_sigB609[0].params["selections"][var_core_value_sig8178].range))) return;
      this._injector["get"](var_core_value_sig939C).executeCommand(var_core_value_sig2069.id, {
        unitId: var_core_value_sig6A78,
        subUnitId: var_core_value_sig393E,
...
Kt = H([V(0, var_core_value_sigC66D(var_core_value_sig8EC5)), V(1, var_core_value_sigB17C), V(2, var_core_value_sigE105)], Kt);
const W = var_core_value_sig5B51("univer-pro.collaboration-client.single-active-unit-service");
let qt = function (var_core_value_sigD9BB) {
...
function Jt(var_core_value_sigF549) {
...
const Yt = new Set([var_core_value_sigC04C.id]),
  Xt = new Set([var_core_value_sig3DF7.id, var_core_value_sigD49F.id, var_core_value_sigCECC.id, var_core_value_sig0F47.id]);
function Zt(var_core_value_sigB63D, var_core_value_sig8255 = Yt) {
...
function Qt(var_core_value_sig933F, var_core_value_sig29DE, var_core_value_sig4AFB, var_core_value_sigC7EA, var_core_value_sigDAB9) {
  let var_core_value_sig9CF7 = Zt(var_core_value_sig933F),
  ...
  return {
    changeset: {
      ...
      type: var_core_value_sig57E2(var_core_value_sig4AFB.getUnitType(var_core_value_sig29DE)),
...
const $t = Qt;
function en(var_core_value_sig4E30, var_core_value_sig9730, var_core_value_sig8E4A, var_core_value_sig300B, var_core_value_sig8457) {
  let var_core_value_sigB30D = Zt(var_core_value_sig4E30, Xt),
  ...
  return {
    changeset: {
      ...
      type: var_core_value_sig57E2(var_core_value_sig8E4A.getUnitType(var_core_value_sig9730)),
...
function tn(var_core_value_sig838E, var_core_value_sig9A5B, var_core_value_sigC860, var_core_value_sigE64C, var_core_value_sigF39B) {
  let var_core_value_sig9B88 = var_core_value_sig838E.reduce((var_core_value_sig18E0, var_core_value_sigE161) => {
      ...
      if (var_core_value_sig1F40 && var_core_value_sig1F40 !== var_core_value_sig3FC7) throw Error("Cannot assemble a changeset from multiple mutations of different types: " + var_core_value_sig1F40 + " - " + var_core_value_sig3FC7 + ".");
      ...
      return nn(var_core_value_sig89E6, var_core_value_sig3B10) ? [...var_core_value_sig18E0.slice(0, -1), {
        ...var_core_value_sigBDEE,
        id: var_core_value_sig3FC7,
        type: var_core_value_sig1E1B,
        params: {
          unitId: var_core_value_sig3B10.unitId,
          textRanges: var_core_value_sig3B10.textRanges,
          actions: var_core_value_sig1056.compose(var_core_value_sig89E6.actions, var_core_value_sig3B10.actions)
        }
  ...
  return {
    changeset: {
      ...
      type: var_core_value_sig57E2(var_core_value_sigC860.getUnitType(var_core_value_sig9A5B)),
...
function nn(var_core_value_sigA724, var_core_value_sig385E) {
  return !rn(var_core_value_sigA724) && !rn(var_core_value_sig385E) && an(var_core_value_sigA724.actions, var_core_value_sig385E.actions);
}
function rn(var_core_value_sig10D3) {
  return var_core_value_sig10D3.isCompositionEnd !== undefined;
}
function an(var_core_value_sig41F2, var_core_value_sig32DD) {
  return on(var_core_value_sig41F2) && on(var_core_value_sig32DD) && !cn(var_core_value_sig41F2) && !cn(var_core_value_sig32DD) && !sn(var_core_value_sig41F2) && !sn(var_core_value_sig32DD);
}
function on(var_core_value_sig7A88) {
  return ln(var_core_value_sig7A88).some(var_core_value_sig4743 => un(var_core_value_sig4743) && var_core_value_sig4743.et === "text-x");
}
function sn(var_core_value_sig6CFC) {
  return ln(var_core_value_sig6CFC).some(var_core_value_sigEB6A => Array.isArray(var_core_value_sigEB6A) || typeof var_core_value_sigEB6A == "string" || typeof var_core_value_sigEB6A == "number");
}
function cn(var_core_value_sig3EC0) {
  return ln(var_core_value_sig3EC0).some(var_core_value_sig3D46 => !un(var_core_value_sig3D46) || var_core_value_sig3D46.et !== "text-x" || !Array.isArray(var_core_value_sig3D46.e) ? false : var_core_value_sig3D46.e["some"](var_core_value_sigE627 => !un(var_core_value_sigE627) || !un(var_core_value_sigE627.body) ? false : Object.prototype["hasOwnProperty"].call(var_core_value_sigE627.body, "tables") || Object.prototype["hasOwnProperty"].call(var_core_value_sigE627.body, "columnGroups") || Object.prototype["hasOwnProperty"].call(var_core_value_sigE627.body, "blockRanges")));
}
function ln(var_core_value_sigEA69) {
...
function un(var_core_value_sigC481) {
  return typeof var_core_value_sigC481 == "object" && !!var_core_value_sigC481 && !Array.isArray(var_core_value_sigC481);
}
function dn(var_core_value_sig27B7, var_core_value_sig2DAD) {
  let var_core_value_sig00DE = new var_core_value_sig8EF0(1);
  return setTimeout(() => var_core_value_sig00DE.next(var_core_value_sig2DAD), var_core_value_sig27B7), var_core_value_sig00DE.asObservable().pipe(var_core_value_sig7784(1));
}
var fn, pn, mn;
let hn = function (var_core_value_sigEF7C) {
...
var G = class {
  ...
  _syncEditingCollabCursor(var_core_value_sig5276) {
    if (this.type === var_core_value_sig8293.UNIVER_DOC) {
      let {
  ...
  _executeRemoteChangeset(var_core_value_sig9CCB) {
    ...
    let var_core_value_sigAEC8 = this._prepareTransformSelections(var_core_value_sigE718),
      var_core_value_sigB977 = var_core_value_sigE027(var_core_value_sigE718.mutations, this._commandService, {
        fromCollab: true
      });
...
let K = class extends G {
  constructor(var_core_value_sig2949, var_core_value_sig308A, var_core_value_sig528D, var_core_value_sigA309, var_core_value_sig9E20, var_core_value_sig26BB, var_core_value_sig19B4, var_core_value_sig218A, var_core_value_sig14CB, var_core_value_sigFDEE) {
    super(var_core_value_sig2949, var_core_value_sig308A, null, [], var_core_value_sig528D, var_core_value_sig19B4, var_core_value_sig26BB, var_core_value_sigA309, var_core_value_sigFDEE), this._injector = var_core_value_sig9E20, this._logService = var_core_value_sig218A, this._transformService = var_core_value_sig14CB, this.localCacheService = var_core_value_sigFDEE, z(this, "status", "synced");
  }
  appendMutation(var_core_value_sigA676) {
    let var_core_value_sigC27E = this._injector["createInstance"](q, this.unitID, this.type, [var_core_value_sigA676], this._handler);
  ...
  onRemoteChangeset(var_core_value_sigA70D) {
    if (this._checkMissing(var_core_value_sigA70D)) return this._injector["createInstance"](Q, this.unitID, this.type, null, [], null, [var_core_value_sigA70D], this._handler);
    try {
      let var_core_value_sig2D58 = this._transformService["transformMutationsWithChangeset"](var_core_value_sigA70D, [var_core_value_sig6180]);
      if (var_core_value_sig06AC(var_core_value_sig2D58)) {
        let {
  ...
  _onConflict(var_core_value_sigCE10) {
    return this._injector["createInstance"](X, this.unitID, this.type, null, [], this._handler, var_core_value_sigCE10);
  }
...
K = H([V(3, var_core_value_sigC66D(var_core_value_sig69B6)), V(4, var_core_value_sigC66D(var_core_value_sig8EC5)), V(5, var_core_value_sig2E9A), V(6, var_core_value_sig939C), V(7, var_core_value_sig5141), V(8, var_core_value_sigB17C), V(9, var_core_value_sig1613(U))], K);
let q = fn = class extends G {
  constructor(var_core_value_sig44DD, var_core_value_sig96FA, var_core_value_sigAB68, var_core_value_sig040A, var_core_value_sig2AE0, var_core_value_sigC349, var_core_value_sig9D96, var_core_value_sig2776, var_core_value_sig6FB2, var_core_value_sigEB43, var_core_value_sig4186, var_core_value_sigF963, var_core_value_sigB608, var_core_value_sigF866) {
    super(var_core_value_sig44DD, var_core_value_sig96FA, null, var_core_value_sigAB68, var_core_value_sig040A, var_core_value_sig6FB2, var_core_value_sigB608, var_core_value_sigC349, var_core_value_sigF866), this._injector = var_core_value_sig2AE0, this._userManagerService = var_core_value_sig9D96, this._logService = var_core_value_sig2776, this._configService = var_core_value_sigEB43, this._transformService = var_core_value_sig4186, this._univerInstanceService = var_core_value_sigF963, z(this, "status", "pending"), z(this, "_scheduleCompleteTimestamp", null), z(this, "_sendingTimer", null);
  }
  ...
  onRemoteChangeset(var_core_value_sig3A85) {
    if (this._checkMissing(var_core_value_sig3A85)) return this._clearScheduledTask(), this._injector["createInstance"](Q, this.unitID, this.type, null, this._pendingMutations, null, [var_core_value_sig3A85], this._handler);
    try {
      ...
      if (var_core_value_sig06AC(var_core_value_sigD749)) {
        let {
        ...
        let var_core_value_sigD873 = this._injector["createInstance"](fn, this.unitID, this.type, var_core_value_sig9572, this._handler);
  ...
  toggleOffline() {
    return this._clearScheduledTask(), this._injector["createInstance"](Z, this.unitID, this.type, null, this._pendingMutations, this._handler);
  }
  toggleOnline() {
    return this;
  }
  _schedule(var_core_value_sig4BB5) {
    ...
    this._scheduleCompleteTimestamp = new Date().getTime() + var_core_value_sig6709, this._sendingTimer = setTimeout(() => {
      ...
      switch (this.type) {
        case var_core_value_sig8293.UNIVER_SHEET:
          var_core_value_sig58C1 = Qt(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        case var_core_value_sig8293.UNIVER_DOC:
          var_core_value_sig58C1 = this._pendingMutations["every"](var_core_value_sigFBFA => var_core_value_sigFBFA.id === var_core_value_sigAA05.id) ? tn(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService) : Qt(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        case var_core_value_sig8293.UNIVER_SLIDE:
          var_core_value_sig58C1 = en(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        case var_core_value_sig8293.UNIVER_PDF:
          var_core_value_sig58C1 = $t(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        case var_core_value_sig8293.UNIVER_BOARD:
          var_core_value_sig58C1 = Qt(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        case var_core_value_sig8293.UNIVER_BASE:
          var_core_value_sig58C1 = Qt(this._pendingMutations, this.unitID, this._univerInstanceService, this._revisionService, this._userManagerService);
          break;
        default:
      ...
      let var_core_value_sigAD56 = var_core_value_sigC368.length ? this._injector["createInstance"](Y, this.unitID, this.type, var_core_value_sig5090, var_core_value_sigC368, this._handler, undefined) : this._injector["createInstance"](J, this.unitID, this.type, var_core_value_sig5090, this._handler);
  ...
  _getSendChangesetTimeout() {
    let var_core_value_sig52CA = this._configService["getConfig"](R);
  ...
  _onConflict(var_core_value_sigC030) {
    return this._clearScheduledTask(), this._injector["createInstance"](X, this.unitID, this.type, null, this._pendingMutations, this._handler, var_core_value_sigC030);
  }
};
q = fn = H([V(4, var_core_value_sigC66D(var_core_value_sig8EC5)), V(5, var_core_value_sigC66D(var_core_value_sig69B6)), V(6, var_core_value_sigC66D(var_core_value_sig050D)), V(7, var_core_value_sig5141), V(8, var_core_value_sig939C), V(9, var_core_value_sigA49E), V(10, var_core_value_sigB17C), V(11, var_core_value_sigE105), V(12, var_core_value_sig2E9A), V(13, var_core_value_sig1613(U))], q);
let J = pn = class extends G {
  constructor(var_core_value_sig88F6, var_core_value_sig37DB, var_core_value_sig5542, var_core_value_sigE0A9, var_core_value_sigA73E, var_core_value_sig7620, var_core_value_sigB9FC, var_core_value_sig5055, var_core_value_sig3801, var_core_value_sig45F0, var_core_value_sigBC91) {
    super(var_core_value_sig88F6, var_core_value_sig37DB, var_core_value_sig5542, [], var_core_value_sigE0A9, var_core_value_sigB9FC, var_core_value_sig45F0, var_core_value_sig7620, var_core_value_sigBC91), this._injector = var_core_value_sigA73E, this._logService = var_core_value_sig5055, this._transformService = var_core_value_sig3801, z(this, "status", "awaiting"), z(this, "_resendTimeout", 0), z(this, "_maxTotalRetryTimeout", 0), z(this, "_resendTimer", undefined), z(this, "_sender", undefined);
  }
  appendMutation(var_core_value_sigCB88) {
    this._clearScheduledTask();
    let var_core_value_sig8D65 = this._injector["createInstance"](Y, this.unitID, this.type, this._awaitingChangeset, [var_core_value_sigCB88], this._handler, this._resendTimer);
    return var_core_value_sig8D65._updateLocalCache(), var_core_value_sig8D65;
  }
  onRemoteChangeset(var_core_value_sig8122) {
    if (this._checkMissing(var_core_value_sig8122)) return this._clearScheduledTask(), this._injector["createInstance"](Q, this.unitID, this.type, this._awaitingChangeset, [], null, [var_core_value_sig8122], this._handler);
    try {
      ...
      if (var_core_value_sigABAC(var_core_value_sigDB4A)) {
        let {
        ...
        let var_core_value_sigF9C7 = this._injector["createInstance"](pn, this.unitID, this.type, var_core_value_sig6F91[0], this._handler);
  ...
  onRemoteAck(var_core_value_sigEDC6) {
    ...
    if (this._checkMissing(var_core_value_sigEDC6)) return this._injector["createInstance"](Q, this.unitID, this.type, this._awaitingChangeset, [], var_core_value_sigEDC6.revision, [], this._handler);
    this._incrementRevisionNumber();
    let var_core_value_sig6BD9 = this._injector["createInstance"](K, this.unitID, this.type, this._handler);
  ...
  onRemoteRetry(var_core_value_sig4161) {
    return this._maxTotalRetryTimeout > _n ? this.toggleOffline() : (this._resendTimer = dn(this._resendTimeout, {
  ...
  _onConflict(var_core_value_sig7580) {
    return this._clearScheduledTask(), this._injector["createInstance"](X, this.unitID, this.type, this._awaitingChangeset, [], this._handler, var_core_value_sig7580);
  }
  _resendWithTimeout(var_core_value_sig1F18, var_core_value_sigD5A0) {
    var var_core_value_sig81B2;
    var_core_value_sig1F18 === ((var_core_value_sig81B2 = this._awaitingChangeset) == null ? undefined : var_core_value_sig81B2.reqId) && (this.resend(), this._resendTimeout = var_core_value_sigD5A0 === 0 ? 1000 : Math.min(var_core_value_sigD5A0 * 2, gn), this._maxTotalRetryTimeout += this._resendTimeout);
  }
  _clearScheduledTask() {
...
J = pn = H([V(4, var_core_value_sigC66D(var_core_value_sig8EC5)), V(5, var_core_value_sigC66D(var_core_value_sig69B6)), V(6, var_core_value_sig939C), V(7, var_core_value_sig5141), V(8, var_core_value_sigB17C), V(9, var_core_value_sig2E9A), V(10, var_core_value_sig1613(U))], J);
let Y = mn = class extends G {
  ...
  onRemoteChangeset(var_core_value_sig6E68) {
    if (this._checkMissing(var_core_value_sig6E68)) return this._clearScheduledTask(), this._injector["createInstance"](Q, this.unitID, this.type, this._awaitingChangeset, this._pendingMutations, null, [var_core_value_sig6E68], this._handler);
    try {
      ...
      if (var_core_value_sigABAC(var_core_value_sigD65A)) {
        let {
        ...
        if (var_core_value_sig06AC(var_core_value_sig284F)) {
          let {
            c1Prime: var_core_value_sigF602,
            m2Prime: var_core_value_sig1BBD
          } = var_core_value_sig284F;
          return this._executeRemoteChangeset(var_core_value_sigF602), var_core_value_sigC80B[0].baseRev = this._getCurrentRevision(), this._clearScheduledTask(), this._injector["createInstance"](mn, this.unitID, this.type, var_core_value_sigC80B[0], var_core_value_sig1BBD, this._handler, undefined);
        }
  ...
  onRemoteAck(var_core_value_sig8DFE) {
    ...
    if (this._checkMissing(var_core_value_sig8DFE)) return this._injector["createInstance"](Q, this.unitID, this.type, this._awaitingChangeset, this._pendingMutations, var_core_value_sig8DFE.revision, [], this._handler);
    this._incrementRevisionNumber();
    let var_core_value_sig5E16 = this._injector["createInstance"](q, this.unitID, this.type, this._pendingMutations, this._handler);
  ...
  _onConflict(var_core_value_sigC5C4) {
    return this._clearScheduledTask(), this._injector["createInstance"](X, this.unitID, this.type, null, this._pendingMutations, this._handler, var_core_value_sigC5C4);
  }
  _resendWithTimeout(var_core_value_sig1617, var_core_value_sig4169) {
    var var_core_value_sig6D19;
    var_core_value_sig1617 === ((var_core_value_sig6D19 = this._awaitingChangeset) == null ? undefined : var_core_value_sig6D19.reqId) && (this.resend(), this._resendTimeout = var_core_value_sig4169 === 0 ? 1000 : Math.min(var_core_value_sig4169 * 2, gn), this._maxTotalRetryTimeout += this._resendTimeout);
  }
  _clearScheduledTask() {
...
Y = mn = H([V(6, var_core_value_sigC66D(var_core_value_sig8EC5)), V(7, var_core_value_sigC66D(var_core_value_sig69B6)), V(8, var_core_value_sig939C), V(9, var_core_value_sig5141), V(10, var_core_value_sigB17C), V(11, var_core_value_sig2E9A), V(12, var_core_value_sig1613(U))], Y);
let X = class extends G {
  ...
  _disableEditing() {
    this._permissionService["updatePermissionPoint"](new var_core_value_sig72AD(this.unitID).id, false);
  }
};
X = H([V(6, var_core_value_sigC66D(var_core_value_sig751D)), V(7, var_core_value_sig939C), V(8, var_core_value_sig2E9A), V(9, var_core_value_sigC66D(var_core_value_sig69B6)), V(10, var_core_value_sigC66D(var_core_value_sig9DD9)), V(11, var_core_value_sigC66D(B)), V(12, var_core_value_sig1613(U))], X);
let Z = class extends G {
  constructor(var_core_value_sigF975, var_core_value_sigCDAF, var_core_value_sigA298, var_core_value_sig0B40, var_core_value_sig330B, var_core_value_sig3625, var_core_value_sig0B4E, var_core_value_sig0E9F, var_core_value_sigE5BA, var_core_value_sig4A83) {
    super(var_core_value_sigF975, var_core_value_sigCDAF, var_core_value_sigA298, var_core_value_sig0B40, var_core_value_sig330B, var_core_value_sig0E9F, var_core_value_sigE5BA, var_core_value_sig0B4E, var_core_value_sig4A83), this._injector = var_core_value_sig3625, z(this, "status", "offline");
  }
  ...
  toggleOnline() {
    let {
      ...
      var_core_value_sig3455 = vn(var_core_value_sigB6F7, var_core_value_sig2A8A, var_core_value_sigD22E, var_core_value_sig70D0, var_core_value_sigB495, var_core_value_sig3782);
    return var_core_value_sig3455 instanceof q ? var_core_value_sig3455._schedule() : (var_core_value_sig3455 instanceof Y || var_core_value_sig3455 instanceof J) && var_core_value_sig3455.resend(), var_core_value_sig3455;
  }
  resend() {
    throw Error("[OfflineState]: invalid calling to `resend`.");
  }
};
Z = H([V(5, var_core_value_sigC66D(var_core_value_sig8EC5)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sig939C), V(8, var_core_value_sig2E9A), V(9, var_core_value_sig1613(U))], Z);
let Q = class extends G {
  ...
  onMissedChangesetFetched(var_core_value_sigC84D) {
    try {
      ...
      if (var_core_value_sigB512 && var_core_value_sigF2E6.length !== 0) var_core_value_sig34C8 = this._injector["createInstance"](Y, this.unitID, this.type, var_core_value_sigB512, var_core_value_sigF2E6, this._handler, undefined);else {
        if (var_core_value_sigB512 && var_core_value_sigF2E6.length === 0) var_core_value_sigB512.baseRev = this._getCurrentRevision(), var_core_value_sig34C8 = this._injector["createInstance"](J, this.unitID, this.type, var_core_value_sigB512, this._handler);else {
          if (var_core_value_sigF2E6.length !== 0) {
            let var_core_value_sig7524 = this._injector["createInstance"](q, this.unitID, this.type, var_core_value_sigF2E6, this._handler);
            var_core_value_sig7524._schedule(), var_core_value_sig34C8 = var_core_value_sig7524;
          } else var_core_value_sig34C8 = this._injector["createInstance"](K, this.unitID, this.type, this._handler);
        }
      }
      return var_core_value_sig34C8._updateLocalCache(), var_core_value_sig34C8;
    } catch (var_core_value_sigB744) {
      return this._logService["error"]("[FetchMissState]", "failed to apply missed changesets!", var_core_value_sigB744), this._injector["createInstance"](X, this.unitID, this.type, this._awaitingChangeset, this._pendingMutations, this._handler, false);
    }
  }
  ...
  _transformAndApplyRemoteChangeset(var_core_value_sigD37B) {
    ...
    if (var_core_value_sig93BE) {
      ...
      if (!var_core_value_sigABAC(var_core_value_sigE68A)) throw var_core_value_sigE68A.error;
    ...
    if (var_core_value_sigABEC.length) {
      ...
      if (!var_core_value_sig06AC(var_core_value_sig3E68)) throw var_core_value_sig3E68.error;
  ...
  _onConflict(var_core_value_sig320C) {
    return this._injector["createInstance"](X, this.unitID, this.type, this._awaitingChangeset, this._pendingMutations, this._handler, var_core_value_sig320C);
  }
};
Q = H([V(7, var_core_value_sigC66D(var_core_value_sig8EC5)), V(8, var_core_value_sigC66D(var_core_value_sig69B6)), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig2E9A), V(12, var_core_value_sigB17C), V(13, var_core_value_sig1613(U))], Q);
function vn(var_core_value_sig07E7, var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sigB591, var_core_value_sigB272, var_core_value_sig6F52) {
  return var_core_value_sigB591 && var_core_value_sigB272.length ? var_core_value_sig07E7.createInstance(Y, var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sigB591, var_core_value_sigB272, var_core_value_sig6F52, undefined) : var_core_value_sigB591 ? var_core_value_sig07E7.createInstance(J, var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sigB591, var_core_value_sig6F52) : var_core_value_sigB272.length ? var_core_value_sig07E7.createInstance(q, var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sigB272, var_core_value_sig6F52) : var_core_value_sig07E7.createInstance(K, var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sig6F52);
}
let $ = class extends var_core_value_sig617E {
  get state() {
    return this._state;
  }
  constructor(var_core_value_sigE7F0, var_core_value_sigE837, var_core_value_sig34F4, var_core_value_sigA45D, var_core_value_sig1BC7, var_core_value_sig4956, var_core_value_sigCC9E, var_core_value_sig444C, var_core_value_sigE42E, var_core_value_sigF039, var_core_value_sigA321, var_core_value_sigBF4C, var_core_value_sig3457, var_core_value_sig4A08) {
    super(), this.unitID = var_core_value_sigE7F0, this.session = var_core_value_sigE837, this._type = var_core_value_sig34F4, this._injector = var_core_value_sigA45D, this._compressMutationService = var_core_value_sig1BC7, this._localeService = var_core_value_sig4956, this._revisionService = var_core_value_sigCC9E, this._eventService = var_core_value_sig444C, this._univerInstanceService = var_core_value_sigE42E, this._logService = var_core_value_sigF039, this._commandService = var_core_value_sigA321, this._permissionService = var_core_value_sigBF4C, this._singleActiveUnitService = var_core_value_sig3457, this._localCacheService = var_core_value_sig4A08, z(this, "_state$", new var_core_value_sig9ABE(null)), z(this, "state$", this._state$["asObservable"]()), z(this, "_state", undefined), z(this, "_collaborationPaused", false), z(this, "_changesetSessionId", ""), z(this, "_changesetReqId", 0), z(this, "status$", this.state$["pipe"](var_core_value_sig5453(var_core_value_sig5410 => var_core_value_sig5410 ? var_core_value_sig5410.status : "offline"), var_core_value_sig5501({
      bufferSize: 1,
      refCount: true
  ...
  pauseCollaboration() {
    return this._collaborationPaused = true, var_core_value_sigE537(() => {
  ...
  async _init() {
    if (this._updateState(await this._createInitialState()), this._singleActiveUnitService) {
      ...
      (var_core_value_sigA5C3 = this._singleActiveUnitService) == null || var_core_value_sigA5C3.editingUnit(this.unitID), this.disposeWithMe(this._singleActiveUnitService["getUnitStatus$"](this.unitID).subscribe(var_core_value_sig9E2F => {
        ...
        }), this._permissionService["updatePermissionPoint"](new var_core_value_sig72AD(this.unitID).id, false), this._permissionService["setShowComponents"](false)) : (this._permissionService["updatePermissionPoint"](new var_core_value_sig72AD(this.unitID).id, true), this._permissionService["setShowComponents"](true));
      }));
    }
    ...
    return this.disposeWithMe(this.session["sessionStatus$"].subscribe(var_core_value_sig492F => {
      ...
      try {
        switch (var_core_value_sig8EA0.eventID) {
          case var_core_value_sigA2A4.NEW_CHANGESETS:
            this._onRemoteChangeset(var_core_value_sig10FC(var_core_value_sig8EA0.data));
            break;
          case var_core_value_sigA2A4.CHANGESET_ACK:
            this._onRemoteACK(var_core_value_sig8EA0.data);
            break;
          case var_core_value_sigA2A4.CHANGESET_REJ:
          ...
          case var_core_value_sigA2A4.CHANGESET_SHOULD_RETRY:
            ...
            break;
          case var_core_value_sigA2A4.PSEUDO_FETCH_MISSING_RESULT:
            this._onFetchMissResult(var_core_value_sig8EA0.data["changesets"].map(var_core_value_sig2AD8 => var_core_value_sig10FC(var_core_value_sig2AD8)));
            break;
          case var_core_value_sigA2A4.PERMISSION_REJ:
            this._onRemoteRejected({
              isPermissionRej: true
            });
            break;
          case var_core_value_sigA2A4.UNISCRIPT_RUN:
            break;
        }
  ...
  _toggleOnline(var_core_value_sig11D0 = false) {
    ...
    var_core_value_sig11D0 && var_core_value_sigB8ED instanceof K && (this._lockTransition(), this._updateState(var_core_value_sigB8ED.fetchMiss()), this._unlockTransition());
  }
  async _createInitialState() {
    return new Promise(var_core_value_sig74A8 => {
      this.session["sessionStatus$"].pipe(var_core_value_sig7784(1)).subscribe(async var_core_value_sigDBB7 => {
  ...
  _createHandler() {
    ...
    return {
      onStateChange: (var_core_value_sig21B2, var_core_value_sigDE08) => {
        if (var_core_value_sig21B2 !== this._state) throw Error("[CollaborationEntity]:\x20invalid\x20state\x20transition!\x20State\x20transferred\x20from\x20is\x20not\x20the\x20current\x20state.\x0aBefore:\x20" + var_core_value_sig21B2.status + "\nAfter: " + var_core_value_sigDE08.status + "\nCurrent: " + this._state["status"]);
      ...
      onSendChangeset: var_core_value_sigACCB => {
        ...
        let var_core_value_sig7F33 = {
          eventID: var_core_value_sigA2A4.SUBMIT_CHANGESET,
          data: {
      ...
      onMissingChangesets: ({
        ...
        let var_core_value_sig7A62 = {
          eventID: var_core_value_sigA2A4.FETCH_MISSING,
          data: {
  ...
  async _createInitialStateImpl(var_core_value_sig1CDD) {
    ...
    this._changesetSessionId = var_core_value_sigC753 ? var_core_value_sig32AE.sid : var_core_value_sigB66D(), this._changesetReqId = var_core_value_sigC753 ? var_core_value_sig32AE.reqId : 0;
    ...
    if (var_core_value_sig1CDD) {
      let var_core_value_sig7565 = vn(this._injector, var_core_value_sigFFD1, this._type, var_core_value_sig32AE, var_core_value_sigCC17, var_core_value_sig81AE);
      return var_core_value_sig7565 instanceof q ? var_core_value_sig7565._schedule() : (var_core_value_sig7565 instanceof Y || var_core_value_sig7565 instanceof J) && var_core_value_sig7565.resend(), var_core_value_sig7565;
    }
    return this._injector["createInstance"](Z, var_core_value_sigFFD1, this._type, var_core_value_sig32AE, var_core_value_sigCC17, var_core_value_sig81AE);
  }
...
$ = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sig1613(W)), V(13, var_core_value_sig1613(U))], $);
let yn = class extends $ {
  constructor(var_core_value_sigEAF8, var_core_value_sig0455, var_core_value_sig737C, var_core_value_sig5AF5, var_core_value_sig9DE4, var_core_value_sig77FA, var_core_value_sigA4A7, var_core_value_sigA4DF, var_core_value_sigCC9D, var_core_value_sig90F5, var_core_value_sigD2BA, var_core_value_sigCD3A, var_core_value_sig519D, var_core_value_sigC7E7, var_core_value_sig6E1C) {
    super(var_core_value_sigEAF8, var_core_value_sig737C, var_core_value_sig0455, var_core_value_sig5AF5, var_core_value_sig9DE4, var_core_value_sig77FA, var_core_value_sigA4A7, var_core_value_sigA4DF, var_core_value_sigCC9D, var_core_value_sig90F5, var_core_value_sigD2BA, var_core_value_sigCD3A, var_core_value_sigC7E7, var_core_value_sig6E1C), this.unitID = var_core_value_sigEAF8, this.type = var_core_value_sig0455, this._docStateChangeManagerService = var_core_value_sig519D, z(this, "_handlerCallback", null);
  }
    ...
    return this.disposeWithMe(this._docStateChangeManagerService["docStateChange$"].subscribe(var_core_value_sig08BA => {
      ...
      let {
        ...
        var_core_value_sigFEAB = {
          ...
          type: var_core_value_sigD0F0.MUTATION,
          params: {
            unitId: var_core_value_sig237B,
      ...
      if (var_core_value_sigE347.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sig3C5B != null && var_core_value_sig3C5B.fromCollab || var_core_value_sig3C5B != null && var_core_value_sig3C5B.onlyLocal || var_core_value_sigE347.id === var_core_value_sigAA05.id) return;
...
yn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sigC66D(var_core_value_sigD120)), V(13, var_core_value_sig1613(W)), V(14, var_core_value_sig1613(U))], yn);
let bn = class extends $ {
  constructor(var_core_value_sig8EF01, var_core_value_sig78AC, var_core_value_sig4CEF, var_core_value_sigD57D, var_core_value_sig2CC7, var_core_value_sig4784, var_core_value_sigC39E, var_core_value_sig16C7, var_core_value_sig7481, var_core_value_sig08A3, var_core_value_sig77D8, var_core_value_sig78A3, var_core_value_sig649B, var_core_value_sig6256) {
    super(var_core_value_sig8EF01, var_core_value_sig4CEF, var_core_value_sig78AC, var_core_value_sigD57D, var_core_value_sig2CC7, var_core_value_sig4784, var_core_value_sigC39E, var_core_value_sig16C7, var_core_value_sig7481, var_core_value_sig08A3, var_core_value_sig77D8, var_core_value_sig78A3, var_core_value_sig649B, var_core_value_sig6256), this.unitID = var_core_value_sig8EF01, this.type = var_core_value_sig78AC;
  }
  async _init() {
    ...
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_core_value_sigC4B1, var_core_value_sig1BD9) => {
      if (var_core_value_sigC4B1.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sig1BD9 != null && var_core_value_sig1BD9.fromCollab || var_core_value_sig1BD9 != null && var_core_value_sig1BD9.onlyLocal) return;
...
bn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sig1613(W)), V(13, var_core_value_sig1613(U))], bn);
let xn = class extends $ {
  ...
  async _init() {
    ...
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_core_value_sig48DD, var_core_value_sig5E6A) => {
      if (var_core_value_sig48DD.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sig5E6A != null && var_core_value_sig5E6A.fromCollab || var_core_value_sig5E6A != null && var_core_value_sig5E6A.onlyLocal) return;
...
xn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(Kt)), V(8, var_core_value_sigC66D(B)), V(9, var_core_value_sigE105), V(10, var_core_value_sig5141), V(11, var_core_value_sig939C), V(12, var_core_value_sig751D), V(13, var_core_value_sig1613(W)), V(14, var_core_value_sig1613(U))], xn);
let Sn = class extends $ {
  ...
  async _init() {
    ...
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_core_value_sig849B, var_core_value_sig5F1A) => {
      if (var_core_value_sig849B.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sig5F1A != null && var_core_value_sig5F1A.fromCollab || var_core_value_sig5F1A != null && var_core_value_sig5F1A.onlyLocal) return;
...
Sn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sig1613(W)), V(13, var_core_value_sig1613(U))], Sn);
let Cn = class extends $ {
  ...
  async _init() {
    ...
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_core_value_sigCEFB, var_core_value_sig1537) => {
      if (var_core_value_sigCEFB.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sig1537 != null && var_core_value_sig1537.fromCollab || var_core_value_sig1537 != null && var_core_value_sig1537.onlyLocal) return;
...
Cn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sig1613(W)), V(13, var_core_value_sig1613(U))], Cn);
let wn = class extends $ {
  ...
  async _init() {
    ...
    return this.disposeWithMe(this._commandService["onMutationExecutedForCollab"]((var_core_value_sig156F, var_core_value_sigDD51) => {
      if (var_core_value_sig156F.type !== var_core_value_sigD0F0.MUTATION || var_core_value_sigDD51 != null && var_core_value_sigDD51.fromCollab || var_core_value_sigDD51 != null && var_core_value_sigDD51.onlyLocal) return;
...
wn = H([V(3, var_core_value_sigC66D(var_core_value_sig8EC5)), V(4, var_core_value_sigC66D(var_core_value_sigA1AC)), V(5, var_core_value_sigC66D(var_core_value_sig9DD9)), V(6, var_core_value_sigC66D(var_core_value_sig69B6)), V(7, var_core_value_sigC66D(B)), V(8, var_core_value_sigE105), V(9, var_core_value_sig5141), V(10, var_core_value_sig939C), V(11, var_core_value_sig751D), V(12, var_core_value_sig1613(W)), V(13, var_core_value_sig1613(U))], wn);
const Tn = var_core_value_sig5B51("univer-pro.collaboration-client.network-condition.service");
function En(var_core_value_sig09C4) {
  ...
  switch (var_core_value_sigC3D3.cmd) {
    case var_core_value_sig77E3.HEARTBEAT:
    case var_core_value_sig77E3.HELLO:
      {
    ...
    case var_core_value_sig77E3.JOIN:
      {
    ...
    case var_core_value_sig77E3.RECV:
      {
        ...
        switch (var_core_value_sig1975.eventID) {
          ...
          case var_core_value_sigA2A4.UPDATE_CURSOR:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
          ...
          case var_core_value_sigA2A4.LIVESHARE_NEW_HOST:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
          ...
          case var_core_value_sigA2A4.LIVESHARE_FETCH_OPERATIONS:
          case var_core_value_sigA2A4.LIVESHARE_OPERATION:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
          ...
          case var_core_value_sigA2A4.LIVESHARE_TERMINATE:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
          ...
          case var_core_value_sigA2A4.UPDATE_PERMISSION_OBJ:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
          ...
          case var_core_value_sigA2A4.SHOULD_CLOSE_CONN:
            return {
              ...var_core_value_sigC3D3,
              data: {
                ...var_core_value_sig1975,
...
function Dn(var_core_value_sig4BFF) {
  switch (var_core_value_sig4BFF.cmd) {
    ...
    case var_core_value_sig77E3.INGEST:
      {
        let var_core_value_sig6EA1;
        switch (var_core_value_sig4BFF.data["eventID"]) {
          case var_core_value_sigA2A4.UPDATE_CURSOR:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.UPDATE_CURSOR,
              updateCursorEvent: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.USERS_LEAVE:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.USERS_LEAVE,
              leaveEvent: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.USERS_ENTER:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.USERS_ENTER,
              joinEvent: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.LIVESHARE_NEW_HOST:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.LIVESHARE_NEW_HOST,
              liveShareNewHost: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.LIVESHARE_OPERATION:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.LIVESHARE_OPERATION,
              liveShareOperation: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.LIVESHARE_TERMINATE:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.LIVESHARE_TERMINATE,
              liveShareTerminate: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.LIVESHARE_REQUEST_HOST:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.LIVESHARE_REQUEST_HOST,
              liveShareRequestHost: var_core_value_sig4BFF.data["data"]
            };
            break;
          case var_core_value_sigA2A4.LIVESHARE_FETCH_OPERATIONS:
            var_core_value_sig6EA1 = {
              eventID: var_core_value_sigA2A4.LIVESHARE_FETCH_OPERATIONS
            };
            break;
          default:
            var_core_value_sig6EA1 = {
    ...
    case var_core_value_sig77E3.LEAVE:
      return JSON.stringify({
        cmd: var_core_value_sig4BFF.cmd,
        routeKey: var_core_value_sig4BFF.routeKey,
...
const On = var_core_value_sig5B51("univer-pro.collaboration-client-socket-service");
function kn(var_core_value_sig40E7, var_core_value_sigEDBA, var_core_value_sigE863) {
  return var_core_value_sig40E7 + "/" + var_core_value_sigEDBA + "/unit/" + var_core_value_sigE863 + "/new_changes";
}
let An = class extends var_core_value_sig8339 {
  ...
  _doCreateSocket(var_core_value_sig537C) {
    let var_core_value_sigBBBC = this._injector["get"](var_core_value_sig1578);
    ...
    let var_core_value_sigE28B = new var_core_value_sigA01E(),
      var_core_value_sig0FD9 = new var_core_value_sig234B();
    var_core_value_sigE28B.add(var_core_value_sig5440.close$["subscribe"](var_core_value_sig029F => var_core_value_sig0FD9.next(var_core_value_sig029F))), var_core_value_sigE28B.add(var_core_value_sigE537(() => var_core_value_sig0FD9.complete()));
    let var_core_value_sig5649 = new var_core_value_sig234B();
    var_core_value_sigE28B.add(var_core_value_sig5440.error$["subscribe"](var_core_value_sig3767 => var_core_value_sig5649.next(var_core_value_sig3767))), var_core_value_sigE28B.add(var_core_value_sigE537(() => var_core_value_sig5649.complete()));
    let var_core_value_sigAF82 = new var_core_value_sig234B();
    var_core_value_sigE28B.add(var_core_value_sig5440.message$["subscribe"](var_core_value_sig670B => {
      let var_core_value_sig6912 = En(var_core_value_sig670B);
      var_core_value_sigAF82.next(var_core_value_sig6912);
    })), var_core_value_sigE28B.add(var_core_value_sigE537(() => var_core_value_sigAF82.complete()));
    let var_core_value_sig21A2,
      var_core_value_sig5C1D = () => {
        var_core_value_sig5649.next(new Event("connection error")), var_core_value_sig0FD9.next(new Event("connection error")), var_core_value_sig21A2.close();
      };
    return var_core_value_sig21A2 = {
      ...
      send: var_core_value_sigE235 => {
        if (var_core_value_sigE235.cmd === var_core_value_sig77E3.INGEST) {
          if (var_core_value_sigE235.data["eventID"] === var_core_value_sigA2A4.SUBMIT_CHANGESET) {
          ...
          if (var_core_value_sigE235.data["eventID"] === var_core_value_sigA2A4.FETCH_MISSING) {
            ...
            this._fetchMissChangesets(var_core_value_sigF704).then(var_core_value_sig3EEE => {
              var_core_value_sigAF82.next({
                cmd: var_core_value_sig77E3.RECV,
                code: var_core_value_sig5FD0.OK,
                routeKey: var_core_value_sigF704.data["unitID"],
                routeType: "",
                data: {
                  eventID: var_core_value_sigA2A4.PSEUDO_FETCH_MISSING_RESULT,
                  data: {
        ...
        var_core_value_sig5440.send(Dn(var_core_value_sigE235));
      },
      close: () => {
  ...
  async _submitChangeset(var_core_value_sig4CBA, var_core_value_sig8E65) {
    let {
      ...
      var_core_value_sigE532 = {
        ...
        changeset: var_core_value_sig01FC(var_core_value_sig44F9)
      },
      var_core_value_sigF381 = this._configService["getConfig"](R),
      var_core_value_sigCB92 = kn((var_core_value_sigF381 == null ? undefined : var_core_value_sigF381.collabSubmitChangesetUrl) ?? "/universer-api/comb", var_core_value_sig772C, var_core_value_sigF309);
    try {
...
An = H([V(0, var_core_value_sigC66D(var_core_value_sig8EC5)), V(1, var_core_value_sigC66D(var_core_value_sig28E2)), V(2, var_core_value_sigA49E), V(3, var_core_value_sig5141), V(4, var_core_value_sigB93D)], An);
const jn = var_core_value_sig5B51("univer-pro.collaboration-client-adapter-service");
function Mn(var_core_value_sig04B4 = {}) {
...
function Nn(var_core_value_sig1C07, var_core_value_sig93D6, var_core_value_sigDD05) {
...
let Pn = class extends var_core_value_sig8339 {
  constructor(var_core_value_sig7FB0, var_core_value_sig5215, var_core_value_sig5204, var_core_value_sig5E11, var_core_value_sig4D58, var_core_value_sig2DBD, var_core_value_sig424E) {
    super(), this._injector = var_core_value_sig7FB0, this._logService = var_core_value_sig5215, this._configService = var_core_value_sig5204, this._socketService = var_core_value_sig5E11, this._collaborationUIEventService = var_core_value_sig4D58, this._adapter = var_core_value_sig2DBD, this._networkConditionService = var_core_value_sig424E, z(this, "_sessions", new Map()), z(this, "_pendingSessions", new Map()), z(this, "_sessionChannels", new Map()), z(this, "_socketChannels", new Map()), z(this, "socket$", this._getSocketChannel(undefined).socket$["asObservable"]()), z(this, "_status$", new var_core_value_sig9ABE(0)), z(this, "status$", this._status$["asObservable"]()), this._listenToNetworkCondition();
  }
  ...
  async _createSession(var_core_value_sig6643, var_core_value_sig4124) {
    ...
    let var_core_value_sig9A01 = this._injector["createInstance"](Ut, var_core_value_sigBF1C, var_core_value_sigEEEF.socket$["asObservable"]());
  ...
  async _createSocket(var_core_value_sig2278) {
    let var_core_value_sig7053 = this._configService["getConfig"](R),
  ...
  async _tryEnsureSocket(var_core_value_sig1E84) {
    try {
      ...
      if (var_core_value_sigCF4E) {
        ...
        var_core_value_sigCF4E.send = var_core_value_sig2BCF => (var_core_value_sig2BCF.cmd !== var_core_value_sig77E3.LEAVE && this._rescheduleHeartbeat(var_core_value_sig1E84), var_core_value_sigF4B9.apply(var_core_value_sigCF4E, [var_core_value_sig2BCF])), (var_core_value_sig133B = var_core_value_sig1E84.socketMessageSubscription) == null || var_core_value_sig133B.unsubscribe(), var_core_value_sig1E84.socketMessageSubscription = null, var_core_value_sig1E84.socketMessageSubscription = var_core_value_sigCF4E.message$["subscribe"](var_core_value_sig0D69 => this._onMessage(var_core_value_sig1E84, var_core_value_sigCF4E, var_core_value_sig0D69)), var_core_value_sigCF4E.error$["pipe"](var_core_value_sigC341(1)).subscribe(var_core_value_sig480E => this._logService["error"]("[CollaborationSessionService]: socket error", var_core_value_sig480E)), var_core_value_sigCF4E.open$["pipe"](var_core_value_sigC341(1)).subscribe(() => {
          this._onConnectionOpen(var_core_value_sig1E84, var_core_value_sigCF4E);
        }), var_core_value_sigCF4E.close$["pipe"](var_core_value_sigC341(1)).subscribe(var_core_value_sig26DB => {
          this._logService["debug"]("[CollaborationSessionService]", "socket\x20close", var_core_value_sig26DB), this._onConnectionFailed(var_core_value_sig1E84);
        });
      }
  ...
  _onConnectionOpen(var_core_value_sig69B8, var_core_value_sig983D) {
    this._logService["debug"]("[CollaborationSessionService]", "socket open."), var_core_value_sig983D.send({
      cmd: var_core_value_sig77E3.HELLO
  ...
  _tryReconnect(var_core_value_sigF64A) {
    let var_core_value_sig25EC = var_core_value_sigF64A.retryCount,
      var_core_value_sigA790 = this._configService["getConfig"](R),
  ...
  async _resolveSessionIdentity(var_core_value_sig01B9, var_core_value_sigD6A9) {
    return Nn(var_core_value_sig01B9, var_core_value_sigD6A9, await this._adapter["resolveUnit"]({
  ...
  _onMessage(var_core_value_sig0FCF, var_core_value_sigCF96, var_core_value_sigC4E9) {
    ...
    var_core_value_sigF612 === var_core_value_sig77E3.HELLO && !var_core_value_sig0FCF.socketReady && (var_core_value_sigCF96.memberID = var_core_value_sigC4E9.data["memberID"], var_core_value_sig0FCF.socket$["next"](var_core_value_sigCF96), this._status$["next"](3), var_core_value_sig0FCF.socketReady = true, var_core_value_sig0FCF.candidateSocket = null), var_core_value_sigF612 === var_core_value_sig77E3.HEARTBEAT && this._clearTimeoutTimer(var_core_value_sig0FCF), this._rescheduleHeartbeat(var_core_value_sig0FCF);
  }
  ...
  _getSocketChannel(var_core_value_sig8BFA) {
    ...
    let var_core_value_sigFEA0 = {
      ...
      socket$: new var_core_value_sig9ABE(undefined),
  ...
  _sendHeartbeat(var_core_value_sigEE7D) {
    var_core_value_sigEE7D.socket$["getValue"]().send({
      cmd: var_core_value_sig77E3.HEARTBEAT
...
Pn = H([V(0, var_core_value_sigC66D(var_core_value_sig8EC5)), V(1, var_core_value_sig5141), V(2, var_core_value_sigA49E), V(3, On), V(4, var_core_value_sigC66D(B)), V(5, jn), V(6, var_core_value_sig1613(Tn))], Pn);
let Fn = class extends var_core_value_sig617E {
  ...
  getCollabEntity$(var_core_value_sigB1A2) {
    ...
    return var_core_value_sig526D ? var_core_value_sig513B(var_core_value_sig526D) : this._entityInit$["pipe"](var_core_value_sig1C3C(var_core_value_sigB2CE => var_core_value_sigB2CE.unitID === var_core_value_sigB1A2));
  }
  readyForCollab(var_core_value_sigBDB5) {
    return var_core_value_sigC5FB(this.getCollabEntity$(var_core_value_sigBDB5).pipe(var_core_value_sig71CF(() => undefined)));
  }
  _init() {
    this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_SHEET).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).subscribe(async var_core_value_sig443C => {
      let var_core_value_sig39B1 = var_core_value_sig443C.unit["getUnitId"](),
        var_core_value_sig210D = await this._startCollaboration(var_core_value_sig39B1, var_core_value_sig8293.UNIVER_SHEET);
      this._entities["set"](var_core_value_sig39B1, var_core_value_sig210D);
    }), this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_DOC).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).pipe(var_core_value_sig1C3C(var_core_value_sigB4B4 => !var_core_value_sigB4B4.unit["getUnitId"]().startsWith("__"))).subscribe(async var_core_value_sigD407 => {
      let var_core_value_sig63F3 = var_core_value_sigD407.unit["getUnitId"](),
        var_core_value_sig6A71 = await this._startCollaboration(var_core_value_sig63F3, var_core_value_sig8293.UNIVER_DOC);
      this._entities["set"](var_core_value_sig63F3, var_core_value_sig6A71);
    }), this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_SLIDE).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).subscribe(async var_core_value_sig3BF6 => {
      let var_core_value_sig38CE = var_core_value_sig3BF6.unit["getUnitId"](),
        var_core_value_sig62B7 = await this._startCollaboration(var_core_value_sig38CE, var_core_value_sig8293.UNIVER_SLIDE);
      this._entities["set"](var_core_value_sig38CE, var_core_value_sig62B7);
    }), this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_BOARD).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).subscribe(async var_core_value_sig37A8 => {
      let var_core_value_sigA90D = var_core_value_sig37A8.unit["getUnitId"](),
        var_core_value_sig7A3C = await this._startCollaboration(var_core_value_sigA90D, var_core_value_sig8293.UNIVER_BOARD);
      this._entities["set"](var_core_value_sigA90D, var_core_value_sig7A3C);
    }), this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_BASE).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).subscribe(async var_core_value_sig0511 => {
      let var_core_value_sig1F44 = var_core_value_sig0511.unit["getUnitId"](),
        var_core_value_sigCB04 = await this._startCollaboration(var_core_value_sig1F44, var_core_value_sig8293.UNIVER_BASE);
      this._entities["set"](var_core_value_sig1F44, var_core_value_sigCB04);
    }), this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig8293.UNIVER_PDF).pipe(var_core_value_sigB706(this.dispose$), var_core_value_sigC60C(16)).subscribe(async var_core_value_sig947E => {
      let var_core_value_sig4545 = var_core_value_sig947E.unit["getUnitId"](),
        var_core_value_sigF39A = await this._startCollaboration(var_core_value_sig4545, var_core_value_sig8293.UNIVER_PDF);
      this._entities["set"](var_core_value_sig4545, var_core_value_sigF39A);
    }), var_core_value_sig8725(this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_SHEET), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_DOC), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_SLIDE), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_BOARD), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_BASE), this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig8293.UNIVER_PDF)).pipe(var_core_value_sigB706(this.dispose$)).subscribe(var_core_value_sigF79C => {
...
Fn = H([V(0, var_core_value_sigC66D(var_core_value_sig8EC5)), V(1, var_core_value_sigC66D(Pn)), V(2, var_core_value_sigA49E), V(3, var_core_value_sigE105)], Fn);
var In = "@univerjs-pro/collaboration-client",
  Ln = "1.0.0-insiders.20260907-70fc579";
let Rn = class extends var_core_value_sig8339 {
  ...
  _init() {
    this.disposeWithMe(this._univerInstanceService["focused$"].subscribe(() => {
      ...
      var_core_value_sigDCF5 instanceof var_core_value_sig37AE && (var_core_value_sigC786 = var_core_value_sigDCF5.name), document.title = var_core_value_sigC786;
    }));
  }
};
Rn = H([V(0, var_core_value_sigE105), V(1, var_core_value_sigA49E)], Rn);
const zn = var_core_value_sig5B51("base-ui.attachment-io.service");
let Bn = class {
  ...
  async saveAttachment(var_core_value_sig3FCF) {
    ...
    if (Vn(var_core_value_sig3FCF, var_core_value_sig675A), var_core_value_sig675A.upload) return var_core_value_sig675A.upload(var_core_value_sig3FCF);
    ...
    return {
      ...
      sourceType: var_core_value_sig0BD6.UUID,
      source: var_core_value_sig837F
    };
  }
  async getAttachmentUrl(var_core_value_sig9D6E, var_core_value_sigB205) {
    if (var_core_value_sigB205 !== var_core_value_sig0BD6.UUID) return var_core_value_sig9D6E;
    let var_core_value_sigBF78 = (await this._httpService["get"](this._getSignURL().replace("{fileID}", var_core_value_sig9D6E))).body;
    if (var_core_value_sigBF78.error && var_core_value_sigBF78.error["code"] !== var_core_value_sigB071.OK) throw var_core_value_sigBF78.error;
    if (!var_core_value_sigBF78.url) throw Error("[CollaborationAttachmentIoService]:\x20failed\x20to\x20resolve\x20attachment\x20URL.");
    return var_core_value_sig95D5(var_core_value_sigBF78.url, this._getDownloadEndpointURL());
  }
  async _upload(var_core_value_sig8AF3) {
    ...
    let var_core_value_sig53A9 = this._getUploadFileURL() + "?size=" + var_core_value_sig8AF3.size["toString"]() + "&source=" + var_core_value_sig15FE.UnitEmbedded + "&assign=" + encodeURIComponent(var_core_value_sigB3A1),
...
Bn = H([V(0, var_core_value_sigC66D(var_core_value_sig28E2)), V(1, var_core_value_sigC66D(var_core_value_sigA49E)), V(2, var_core_value_sigC66D(var_core_value_sigE105))], Bn);
function Vn(var_core_value_sig48B2, var_core_value_sig57DF) {
...
let Hn = class {
  ...
  init() {
    this._httpService["registerHTTPInterceptor"]({
      priority: 1,
      interceptor: (var_core_value_sigC0D9, var_core_value_sigF0511) => var_core_value_sigF0511(var_core_value_sigC0D9).pipe(var_core_value_sig8169(async var_core_value_sig5CEE => {
        let var_core_value_sigE92A = var_core_value_sig5CEE;
        if (var_core_value_sigE92A.status === 401) {
          if (typeof window > "u") throw Error("[AuthServerService]: you should provide authentication info on Node.js.");
  ...
  _getLoginPath() {
    let var_core_value_sigF64E = this._configService["getConfig"](R);
    return (var_core_value_sigF64E == null ? undefined : var_core_value_sigF64E.loginUrlKey) ?? "/universer-api/oidc/authpage";
  }
};
Hn = H([V(0, var_core_value_sigA49E), V(1, var_core_value_sigC66D(var_core_value_sig28E2)), V(2, var_core_value_sigC66D(var_core_value_sig9DD9))], Hn);
let Un = class extends var_core_value_sig8339 {
  constructor(var_core_value_sig9B3D, var_core_value_sigB217) {
    super(), this._HTTPService = var_core_value_sig9B3D, this._configService = var_core_value_sigB217, z(this, "_cfgEnableObjInherit", false), this._initMergeInterceptor();
  }
  _initMergeInterceptor() {
    let var_core_value_sig1FE6 = this;
    this.disposeWithMe(this._HTTPService["registerHTTPInterceptor"]({
      priority: 999,
      interceptor: var_core_value_sig52ED({
        ...
        mergeParamsToRequest(var_core_value_sigE026, var_core_value_sig339E) {
          ...
          return new var_core_value_sig6B29("POST", var_core_value_sig7550, {
  ...
  _getAPIPrefixPath() {
    let var_core_value_sig2471 = this._configService["getConfig"](R);
...
Un = H([V(0, var_core_value_sigC66D(var_core_value_sig28E2)), V(1, var_core_value_sigC66D(var_core_value_sigA49E))], Un);
function Wn(var_core_value_sig8DA6) {
...
function Gn(var_core_value_sig9AFF) {
...
function Kn(var_core_value_sig5EE4, var_core_value_sig7EAB) {
  let var_core_value_sig56B9 = Wn(var_core_value_sig7EAB),
    var_core_value_sig90CF = var_core_value_sig96CF(16);
  return Gn(var_core_value_sig703C(var_core_value_sig90CF, var_core_value_sigFB18(var_core_value_sig56B9, var_core_value_sig90CF).encrypt(var_core_value_sig49F1(var_core_value_sig5EE4))));
}
function qn() {
  let var_core_value_sigA3861 = var_core_value_sig1B8A().__Key__;
  if (typeof window < "u" && window.location !== undefined && var_core_value_sigA3861) {
    let var_core_value_sig6C80 = {
      time: Math.floor(Date.now() / 1000),
      domain: location.hostname
    };
    return Kn(JSON.stringify(var_core_value_sig6C80), var_core_value_sigA3861);
  }
}
let Jn = class {
...
Yn = H([V(0, var_core_value_sig5141), V(1, var_core_value_sigC66D(var_core_value_sig708D)), V(2, var_core_value_sig1613(U))], Yn);
let Xn = class {
  constructor(var_core_value_sig36FE, var_core_value_sig3AF5, var_core_value_sig14E6) {
    this._httpService = var_core_value_sig36FE, this._configService = var_core_value_sig3AF5, this._univerInstanceService = var_core_value_sig14E6, z(this, "_waitCount", 0), z(this, "_change$", new var_core_value_sig234B()), z(this, "change$", this._change$), z(this, "_imageSourceCache", new Map());
  }
  ...
  getImageSourceCache(var_core_value_sigDF29, var_core_value_sigC0F8) {
    if (var_core_value_sigC0F8 === var_core_value_sig0BD6.BASE64) {
  ...
  addImageSourceCache(var_core_value_sig3C75, var_core_value_sig992D, var_core_value_sigE4E4) {
    var_core_value_sig992D !== var_core_value_sig0BD6.BASE64 && var_core_value_sigE4E4 != null && this._imageSourceCache["set"](var_core_value_sig3C75, var_core_value_sigE4E4);
  }
  async getImage(var_core_value_sigA4B0) {
    try {
      ...
      if (var_core_value_sig85B1.error && var_core_value_sig85B1.error["code"] === var_core_value_sigB071.OK) {
        let var_core_value_sig50AF = var_core_value_sig95D5(var_core_value_sig85B1.url, this._getDownloadEndpointURL());
  ...
  async saveImage(var_core_value_sig5F50) {
    ...
    if (!var_core_value_sig2F7B.includes(var_core_value_sig5F50.type)) return this._decreaseWaiting(), Promise.reject(Error(var_core_value_sig3070.ERROR_IMAGE_TYPE));
    if (var_core_value_sig5F50.size > var_core_value_sigB0DF()) return this._decreaseWaiting(), Promise.reject(Error(var_core_value_sig3070.ERROR_EXCEED_SIZE));
    try {
      ...
      let var_core_value_sig340D = this._getUploadFileURL() + "?size=" + var_core_value_sig5F50.size["toString"]() + "&source=" + var_core_value_sig15FE.UnitEmbedded + "&assign=" + encodeURIComponent(var_core_value_sig6774),
      ...
      if (typeof var_core_value_sigBDE4.FileId != "string") return this._decreaseWaiting(), Promise.reject(Error(var_core_value_sig3070.ERROR_IMAGE));
      var_core_value_sig4494 = var_core_value_sigBDE4.FileId;
    } catch {
      return this._decreaseWaiting(), Promise.reject(Error(var_core_value_sig3070.ERROR_IMAGE));
    }
    return new Promise((var_core_value_sig7DF1, var_core_value_sigDC86) => {
      ...
      var_core_value_sig0B0C.readAsDataURL(var_core_value_sig5F50), var_core_value_sig0B0C.onload = var_core_value_sigA942 => {
        ...
        if (var_core_value_sigBBFF == null) {
          this._decreaseWaiting(), var_core_value_sigDC86(Error(var_core_value_sig3070.ERROR_IMAGE));
          return;
        }
        var_core_value_sig7DF1({
          imageId: var_core_value_sig64FF(6),
          imageSourceType: var_core_value_sig0BD6.UUID,
          source: var_core_value_sig4494,
          base64Cache: var_core_value_sigBBFF,
          status: var_core_value_sig3070.SUCCUSS
        }), this._decreaseWaiting();
      };
    });
  }
  _getUploadFileURL() {
    let var_core_value_sigFFAF = this._configService["getConfig"](R);
    return (var_core_value_sigFFAF == null ? undefined : var_core_value_sigFFAF.uploadFileServerUrl) ?? "/universer-api/stream/file/upload";
  }
  _getSignURL() {
    let var_core_value_sig478B = this._configService["getConfig"](R);
    return (var_core_value_sig478B == null ? undefined : var_core_value_sig478B.signUrlServerUrl) ?? "/universer-api/file/{fileID}/sign-url";
  }
  _getDownloadEndpointURL() {
    let var_core_value_sig1E21 = this._configService["getConfig"](R);
...
Xn = H([V(0, var_core_value_sigC66D(var_core_value_sig28E2)), V(1, var_core_value_sigA49E), V(2, var_core_value_sigC66D(var_core_value_sigE105))], Xn);
let Zn = class {
  ...
  _getAPIPrefixPath() {
    let var_core_value_sig85D5 = this._configService["getConfig"](R);
    ...
    return {
      list: [{
        ...
        mentions: (await this._HTTPService["get"](var_core_value_sig7221, {
          ...
          objectType: var_core_value_sig09AC.PERSON
        })),
        metadata: {},
        type: var_core_value_sig09AC.PERSON
      }]
    };
  }
};
Zn = H([V(0, var_core_value_sigC66D(var_core_value_sigA49E)), V(1, var_core_value_sigC66D(var_core_value_sig28E2))], Zn);
let Qn = class extends var_core_value_sig617E {
  ...
  _initCloseConn() {
    let var_core_value_sigA975 = async (var_core_value_sigBBEE, var_core_value_sig011D) => {
      (await this._collaborationSessionService["requireSession"](var_core_value_sigBBEE)).event$["pipe"](var_core_value_sig1C3C(var_core_value_sig8889 => var_core_value_sig8889.eventID === var_core_value_sigA2A4.SHOULD_CLOSE_CONN), var_core_value_sigBA47(this.dispose$)).subscribe(var_core_value_sig32F8 => {
        let {
        ...
        let var_core_value_sig1758 = er(var_core_value_sig011D);
        var_core_value_sig1758 != null && this._updateUnitPermissionPoint(var_core_value_sigBBEE, var_core_value_sig1758, var_core_value_sigCF47.Edit, false), this._collaborationSessionService["closeSession"](var_core_value_sigBBEE);
      });
    };
    $n(this._univerInstanceService).pipe(var_core_value_sig1C3C(({
      unitId: var_core_value_sig6167
    }) => !var_core_value_sig86F4(var_core_value_sig6167)), var_core_value_sigBA47(this.dispose$)).subscribe(({
  ...
  _initUnitPermissionChange() {
    let var_core_value_sig1263 = async (var_core_value_sig7827, var_core_value_sig652C) => {
      ...
      if (var_core_value_sig652C === var_core_value_sig8293.UNIVER_SHEET) {
        let var_core_value_sig4805 = this._injector["get"](var_core_value_sig5176);
        await var_core_value_sig4805.initWorkbookPermissionChange(var_core_value_sig7827), var_core_value_sig7E32.event$["pipe"](var_core_value_sig1C3C(var_core_value_sig186C => var_core_value_sig186C.eventID === var_core_value_sigA2A4.UPDATE_PERMISSION_OBJ), var_core_value_sigBA47(this.dispose$)).subscribe(var_core_value_sigD955 => {
          let {
      ...
      await this._refreshUnitPermission(var_core_value_sig7827, var_core_value_sig652C), var_core_value_sig7E32.event$["pipe"](var_core_value_sig1C3C(var_core_value_sigE67E => var_core_value_sigE67E.eventID === var_core_value_sigA2A4.UPDATE_PERMISSION_OBJ), var_core_value_sigBA47(this.dispose$)).subscribe(var_core_value_sig2902 => {
        let {
    ...
    }) => !var_core_value_sig86F4(var_core_value_sig4C07)), var_core_value_sigBA47(this.dispose$)).subscribe(({
  ...
  async _refreshUnitPermission(var_core_value_sig457C, var_core_value_sigA4E6) {
    let var_core_value_sig934F = er(var_core_value_sigA4E6);
...
Qn = H([V(0, var_core_value_sigC66D(var_core_value_sig8EC5)), V(1, var_core_value_sigE105), V(2, var_core_value_sig751D), V(3, var_core_value_sigA41E), V(4, var_core_value_sigC66D(Pn)), V(5, var_core_value_sigC66D(B))], Qn);
function $n(var_core_value_sigCD6E) {
  return var_core_value_sig8725(...[var_core_value_sig8293.UNIVER_SHEET, var_core_value_sig8293.UNIVER_DOC, var_core_value_sig8293.UNIVER_SLIDE, var_core_value_sig8293.UNIVER_BOARD, var_core_value_sig8293.UNIVER_BASE].map(var_core_value_sig2EDD => var_core_value_sigCD6E.getTypeOfUnitAdded$(var_core_value_sig2EDD).pipe(var_core_value_sig71CF(var_core_value_sig6201 => ({
    type: var_core_value_sig2EDD,
    unitId: var_core_value_sig6201.unit["getUnitId"]()
  })))));
}
function er(var_core_value_sigFD9D) {
  switch (var_core_value_sigFD9D) {
    case var_core_value_sig8293.UNIVER_SHEET:
      return var_core_value_sigB0F9.Workbook;
    case var_core_value_sig8293.UNIVER_DOC:
      return var_core_value_sigB0F9.Document;
    case var_core_value_sig8293.UNIVER_SLIDE:
      return var_core_value_sigB0F9.Slide;
    case var_core_value_sig8293.UNIVER_BOARD:
      return var_core_value_sigB0F9.Board;
    case var_core_value_sig8293.UNIVER_BASE:
      return var_core_value_sigB0F9.Base;
    default:
      return;
  }
}
let tr = class {
  ...
  async getUnitOnRev(var_core_value_sig8B21, var_core_value_sigEB36) {
    ...
    if (var_core_value_sig5F6C) {
      ...
      var_core_value_sig5F6C.originalMeta = var_core_value_sig5374.encode(var_core_value_sig94C1(var_core_value_sig5151)), Object.entries(var_core_value_sig5F6C.sheets).forEach(([, var_core_value_sig20C8]) => {
        let var_core_value_sigE9A7 = var_core_value_sig20C8.originalMeta;
        var_core_value_sig20C8.originalMeta = var_core_value_sig5374.encode(var_core_value_sig94C1(var_core_value_sigE9A7));
      });
    }
  ...
  _getAPIPrefix() {
    let var_core_value_sig8078 = this._configService["getConfig"](R);
...
tr = H([V(0, var_core_value_sigA49E), V(1, var_core_value_sigC66D(var_core_value_sig28E2))], tr);
let nr = class extends var_core_value_sig6EE5 {
  ...
  _transformStack(var_core_value_sig5FD01, var_core_value_sigA7E3) {
    let var_core_value_sigA784 = [],
      var_core_value_sig4406 = var_core_value_sigA7E3,
      var_core_value_sig6806 = var_core_value_sigA7E3;
    for (let var_core_value_sigA56E = var_core_value_sig5FD01.length - 1; var_core_value_sigA56E >= 0; var_core_value_sigA56E--) {
      let {
          unitID: var_core_value_sigBECE,
          undoMutations: var_core_value_sig1B22,
          redoMutations: var_core_value_sig7F72
        } = var_core_value_sig5FD01[var_core_value_sigA56E],
      ...
      if (var_core_value_sigFAE6(var_core_value_sig7B2A) || var_core_value_sigFAE6(var_core_value_sig06CD)) {
        this._logService["error"]("[CollaborationUndoRedoService]", "transformStack\x20failed!", var_core_value_sig7B2A, var_core_value_sig06CD);
        break;
      }
...
nr = H([V(0, var_core_value_sigE105), V(1, var_core_value_sig939C), V(2, var_core_value_sig6DEB), V(3, var_core_value_sigA49E), V(4, var_core_value_sigB17C), V(5, var_core_value_sig5141)], nr);
let rr = class extends var_core_value_sigADC6 {
  constructor(var_core_value_sigD4AA = mt, var_core_value_sigDC41, var_core_value_sigFB47, var_core_value_sig9B3D1) {
    ...
    } = var_core_value_sig9E0F({}, mt, this._config);
    ...
    this._config = var_core_value_sigC1CF, this._configService["setConfig"](R, var_core_value_sigC1CF);
  }
  onStarting() {
  ...
  _registerDependencies() {
    ...
    this._injector["has"](var_core_value_sig2E9A) && this._logService["error"]("[UniverCollaborationClientPlugin]", "you\x20should\x20override\x20\x22IUndoRedoService\x22\x20provided\x20in\x20\x22core\x22\x20package!");
    let var_core_value_sigF047 = var_core_value_sig3A42([[var_core_value_sig2E9A, {
      useClass: nr
    }], [jn, {
      useValue: Mn()
    }], [Pn], [At], [Kt], [Hn], [Jn], [kt], [Qn], [B], [Yn], [On, {
      ...
      useClass: Zn
    }], [Fn], [Rn]], (var_core_value_sigEE12 = this._config) == null ? undefined : var_core_value_sigEE12.override);
    if (!((var_core_value_sigD70C = this._config) != null && var_core_value_sigD70C.enableSingleActiveInstanceLock)) {
      let var_core_value_sig1998 = var_core_value_sigF047.findIndex(([var_core_value_sigA5F1]) => var_core_value_sigA5F1 === W);
      var_core_value_sig1998 !== -1 && var_core_value_sigF047.splice(var_core_value_sig1998, 1);
    }
    var_core_value_sig8802(this._injector, var_core_value_sigF047);
  }
  _initDependencies() {
    var var_core_value_sigC2F9, var_core_value_sig1F51;
    if (this._injector["get"](var_core_value_sig28E2).registerHTTPInterceptor({
      priority: 20,
      interceptor: var_core_value_sig135F({
        maxParallel: 6
      })
    }), !((var_core_value_sigC2F9 = this._config) != null && var_core_value_sigC2F9.enableOfflineEditing)) {
      var var_core_value_sig29F5;
      (var_core_value_sig29F5 = this._injector["get"](U, var_core_value_sig4620.OPTIONAL)) == null || var_core_value_sig29F5.disableLocalCache();
    }
    (var_core_value_sig1F51 = this._config) != null && var_core_value_sig1F51.enableAuthServer && var_core_value_sig5D84(this._injector, [[Hn]]), var_core_value_sig5D84(this._injector, [[Jn], [Fn], [Qn]]);
  }
};
z(rr, "pluginName", "UNIVER_COLLABORATION_CLIENT_PLUGIN"), z(rr, "packageName", In), z(rr, "version", Ln), rr = H([var_core_value_sig8E31(var_core_value_sigAD5D, var_core_value_sig416D, var_core_value_sig1ED2), V(1, var_core_value_sig5141), V(2, var_core_value_sigC66D(var_core_value_sig8EC5)), V(3, var_core_value_sigA49E)], rr);
export { Un as AuthzIoHttpService, J as AwaitingState, Y as AwaitingWithPendingState, bn as BaseCollaborationEntity, Cn as BoardCollaborationEntity, R as COLLABORATION_CLIENT_PLUGIN_CONFIG_KEY, Bn as CollaborationAttachmentIoService, Fn as CollaborationController, $ as CollaborationEntity, Xn as CollaborationImageIoService, Ut as CollaborationSession, Pn as CollaborationSessionService, An as CollaborationSocketService, hn as CollaborationStatus, Ot as CollaborationUIEventId, B as CollaborationUIEventService, nr as CollaborativeUndoRedoService, kt as CommentService, X as ConflictState, ht as DEFAULT_COLLAB_WEB_SOCKET_URL, Ct as DEFAULT_REMOTE_UNISCRIPT_EXECUTION_ENDPOINT, gt as DEFAULT_WS_SESSION_TICKET_URL, Yn as DataLoaderService, yn as DocCollaborationEntity, Q as FetchingMissState, _t as HEARTBEAT_INTERVAL_KEY, vt as HEARTBEAT_TIMEOUT_KEY, zn as IAttachmentIoService, jn as ICollaborationClientAdapterService, On as ICollaborationSocketService, U as ILocalCacheService, Tn as INetworkConditionService, W as ISingleActiveUnitService, xt as LOCAL_CACHE_INTERVAL, bt as LOCAL_CACHE_INTERVAL_KEY, At as MemberService, Zn as MentionIoHttpService, Z as OfflineState, wn as PdfCollaborationEntity, q as PendingState, St as REMOTE_UNISCRIPT_EXECUTION_ENDPOINT_KEY, yt as RETRY_CONNECTING_MAX_COUNT_KEY, Vt as SessionStatus, xn as SheetCollaborationEntity, Kt as SheetTransformSelectionsService, Sn as SlideCollaborationEntity, tr as SnapshotServerOverHTTPService, K as SyncedState, qt as UnitStatus, rr as UniverCollaborationClientPlugin, Mn as createUniverCollaborationAdapter, En as deserializeToCombResponse, Wt as getLocalCacheKey, Dn as serializeCombRequest };
