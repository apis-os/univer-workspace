...
let A = class extends Plugin {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614 = g, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4615, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4616) {
    ...
    this._configService["setConfig"](h, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4617);
  }
  onStarting() {
    this.disposeWithMe(this._injector["get"](EmbedResourceRefProviderRegistryService).registerUnitProvider(S(this._injector["get"](SnapshotService), this._injector["get"](CollaborationController))));
  }
};
