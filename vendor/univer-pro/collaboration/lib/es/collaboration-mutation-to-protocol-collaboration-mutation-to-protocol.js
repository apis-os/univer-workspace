...
function Ju(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464973) {
  return {
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464973.id,
    data: JSON.stringify(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464973.params)
  };
}
export { Ju as parseMutationToProtocol };
