...
const qr=[pr];let Jr=class extends Disposable{constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46598){super(),this._transformService=var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46598,qr.forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46254=>{this._transformService["registerTransformAlgorithm"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46254);});}};
