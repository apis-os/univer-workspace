...
const Qu = {};
let Ef = class extends Plugin {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461714 = Qu, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461715, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461716) {
    super(), this._config = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461714, this._injector = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461715, this._configService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461716;
    let {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461717
    } = merge({}, Qu, this._config);
    this._configService["setConfig"]("collaboration.config", var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461717);
  }
  onStarting() {
    registerDependencies(this._injector, [[ud], [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465485], [Wn], [cr], [cu], [dr], [Jr], [Uu], [Tf], [fd], [In, {
      useClass: Ln
    }], [sd]]), touchDependencies(this._injector, [[Wn], [cr], [dr], [Jr], [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465485], [cu], [Uu]]);
  }
};
