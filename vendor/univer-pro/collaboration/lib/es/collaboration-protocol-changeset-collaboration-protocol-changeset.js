import { CommandType, DataStreamTreeTokenType, DependentOn, Disposable, ICommandService, IConfigService, ILogService, IResourceManagerService, IUniverInstanceService, ImageSourceType, Inject, Injector, InterceptorManager, JSON1, JSONX, LocaleType, ObjectMatrix, PARAGRAPH_ID_PREFIX as var_L0_rpc_endo_value_pure_O1_zalloc_nothrow_sig0D46, Plugin, RANGE_TYPE as var_L0_rpc_endo_value_pure_O1_zalloc_nothrow_sig0D461, Rectangle, SheetTypes, Tools, UniverInstanceType, createIdentifier, createInterceptorKey, generateRandomId, getTableCellTokenInterval, getTableRangeInterval, getTableRowTokenInterval, insertMatrixArray, isFormulaString, isRangesEqual, merge, moveMatrixArray, registerDependencies, spliceArray, touchDependencies, validateDocBodyStructure } from "@univerjs/core";
...
import { ApplyPdfMutationBatchMutation, PDF_UNIT_SCHEMA as var_L0_rpc_endo_value_pure_O1_zalloc_nothrow_sig0D462, PdfAssetStorageKind, PdfEditorMutationKind, createPdfDocumentFromShell, normalizePdfUnitData } from "@univerjs-pro/pdfs";
...
function Wu(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464961) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464962;
  return {
    ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464961,
    mutations: ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464962 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464961.mutations) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464962.map(qu)) ?? []
  };
}
function qu(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464971) {
  return {
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464971.id,
    params: JSON.parse(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464971.data)
  };
}
export { Wu as parseProtocolChangeset };
