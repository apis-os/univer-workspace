...
function Gu(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464965) {
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464965.map(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461336 => ({
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461336.id,
    params: JSON.parse(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461336.data)
  }));
}
export { Gu as parseProtocolCommand };
