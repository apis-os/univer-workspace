...
let ud = class {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461394) {
    this._univerInstanceService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461394;
  }
  getCurrentRevOfUnit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461396) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461397 = this._univerInstanceService["getUnit"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461396);
    if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461397) throw Error("[RevisionService]: cannot find document with unitId: " + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461396 + ".");
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461397.getRev();
  }
  incrementRevOfUnit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461400) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461401 = this._univerInstanceService["getUnit"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461400);
    if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461401) throw Error("[RevisionService]: cannot find document with unitID: " + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461400 + ".");
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461401.incrementRev(), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461401.getRev();
  }
  setRevOfUnit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461404, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461405) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461406 = this._univerInstanceService["getUnit"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461404);
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461406 && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461406.setRev(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461405);
  }
};
export { ud as RevisionService };
