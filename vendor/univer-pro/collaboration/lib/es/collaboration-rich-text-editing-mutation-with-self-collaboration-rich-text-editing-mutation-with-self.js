...
const lr = {
    m1: RichTextEditingMutation.id,
    m2: RichTextEditingMutation.id,
    handler(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462037, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462038) {
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462037.params["unitId"] !== var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462038.params["unitId"]) return {
        error: Error("Two\x20mutation\x20need\x20have\x20the\x20same\x20unitId!")
      };
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462037),
        var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462038);
      return {
        m1Prime: {
          ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039,
          params: {
            ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params,
            actions: JSONX.transform(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params["actions"], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params["actions"], "left"),
            textRanges: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params["textRanges"] ? transformDocumentTextRanges(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params["actions"], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params["textRanges"], "right") : null
          }
        },
        m2Prime: {
          ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040,
          params: {
            ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params,
            actions: JSONX.transform(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params["actions"], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params["actions"], "right"),
            textRanges: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params["textRanges"] ? transformDocumentTextRanges(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462039.params["actions"], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462040.params["textRanges"], "right") : null
          }
        }
      };
    }
  ...
  ur = [lr];
export { lr as RichTextEditingMutationWithSelf, ur };
