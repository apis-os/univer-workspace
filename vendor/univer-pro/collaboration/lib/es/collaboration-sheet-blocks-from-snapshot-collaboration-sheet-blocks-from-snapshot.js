...
async function bf(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465387, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465388) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465389 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465387.workbook;
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465389) throw Error("Workbook\x20metadata\x20is\x20not\x20available");
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A267 = [],
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A268 = [];
  return Object.entries(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465389.blockMeta).forEach(([var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461514, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461515]) => {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461516 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461515.blocks["map"](async var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46429 => {
      let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB16 = {
          unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465389.unitID,
          type: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465387.type,
          blockID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46429
        },
        {
          block: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46430
        } = await var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465388.getSheetBlock({}, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB16);
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46430) var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A267.push(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46430);else throw Error("Block\x20not\x20found");
    });
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A268.push(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461516);
  }), await Promise.all(var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A268), var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A267;
}
export { bf as getSheetBlocksFromSnapshot };
