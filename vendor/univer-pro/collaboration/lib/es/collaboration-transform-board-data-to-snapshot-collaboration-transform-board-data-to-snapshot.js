...
function yd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464997) {
  return pd.encode(JSON.stringify(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464997));
}
async function Xd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465265, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465266, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465267, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465268, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465269) {
  let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB655 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465267,
      rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465268,
      creator: "",
      name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465266.name,
      resources: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465266.resources ?? [],
      originalMeta: yd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465266)
    },
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB656 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465267,
      rev: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB655.rev,
      type: UniverInstanceType.UNIVER_BOARD,
      workbook: undefined,
      doc: undefined,
      slide: undefined,
      board: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB655,
      pdf: undefined
    },
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465270 = await var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465269.saveSnapshot({}, {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465267,
      type: UniverInstanceType.UNIVER_BOARD,
      snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB656
    });
  if (isError(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465270.error)) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465271, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465272;
    throw Error("transformBoardDataToSnapshot(): Failed to save snapshot.\nErrorCode: " + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465271 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465270.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465271.code) + ":" + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465272 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465270.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465272.message));
  }
  return {
    snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB656
  };
}
export { Xd as transformBoardDataToSnapshot };
