...
import { kn } from "./collaboration-transform-changesets-failure.js";
function An(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461876) {
  return !kn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461876);
}
export { An as isTransformChangesetsSuccess };
