...
import { fn_L0_core_endo_routine_pure_O1_zalloc_nothrow_sigD23F5 } from "./internal-core-endo.js";
async function qd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465229, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465230, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465231, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465232, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465233) {
  let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB647 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465230.id,
      rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465232,
      creator: "",
      name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465230.title ?? "",
      resources: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465230.resources || [],
      originalMeta: fn_L0_core_endo_routine_pure_O1_zalloc_nothrow_sigD23F5(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465230)
    },
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB648 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465231,
      rev: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB647.rev,
      type: UniverInstanceType.UNIVER_DOC,
      workbook: undefined,
      doc: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB647,
      slide: undefined,
      board: undefined,
      pdf: undefined
    },
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465234 = await var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465233.saveSnapshot(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465229, {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465231,
      type: UniverInstanceType.UNIVER_DOC,
      snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB648
    });
  if (isError(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465234.error)) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465235, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465236;
    throw Error("transformDocumentDataToSnapshot(): Failed to save snapshot.\nErrorCode: " + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465235 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465234.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465235.code) + ":" + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465236 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465234.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465236.message));
  }
  return {
    snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB648
  };
}
export { qd as transformDocumentDataToSnapshot };
