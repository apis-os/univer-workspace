...
function On(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461872) {
  return !Dn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461872);
}
export { On as isTransformMutationsSuccess };
