...
function vd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464995) {
  return pd.encode(JSON.stringify(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464995));
}
async function Jd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465245, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465246, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465247, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465248, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465249) {
  let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB651 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465247,
      rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465248,
      creator: "",
      name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465246.name,
      resources: [],
      originalMeta: vd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465246)
    },
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB652 = {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465247,
      rev: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB651.rev,
      type: UniverInstanceType.UNIVER_SLIDE,
      workbook: undefined,
      doc: undefined,
      slide: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB651,
      board: undefined,
      pdf: undefined
    },
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465250 = await var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465249.saveSnapshot({}, {
      unitID: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465247,
      type: UniverInstanceType.UNIVER_SLIDE,
      snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB652
    });
  if (isError(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465250.error)) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465251, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465252;
    throw Error("transformSlideDataToSnapshot(): Failed to save snapshot.\nErrorCode: " + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465251 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465250.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465251.code) + ":" + ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465252 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465250.error) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465252.message));
  }
  return {
    snapshot: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB652
  };
}
export { Jd as transformSlideDataToSnapshot };
