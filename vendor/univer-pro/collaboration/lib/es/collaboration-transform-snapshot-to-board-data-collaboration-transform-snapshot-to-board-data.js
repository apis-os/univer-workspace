...
function Ed(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465011) {
  return JSON.parse(typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465011 == "string" ? Md(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465011) : md.decode(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465011));
}
function Zd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465281) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465282 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465281.board ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465281.slide ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465281.doc;
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465282 == null) throw Error("transformSnapshotToBoardData(): snapshot.board, snapshot.slide, or snapshot.doc is undefined.");
  return {
    ...Ed(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465282.originalMeta),
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465282.unitID,
    rev: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465281.rev,
    name: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465282.name
  };
}
export { Zd as transformSnapshotToBoardData };
