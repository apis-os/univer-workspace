...
const Sn={id:"univer.mutation.create-unit",type:CommandType.MUTATION,handler:()=>true},Cn={id:"univer.mutation.revert-version",type:CommandType.MUTATION,handler:()=>true};
