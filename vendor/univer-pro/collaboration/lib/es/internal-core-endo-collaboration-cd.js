...
function Cd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465005) {
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465005 instanceof Uint8Array) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461446 = md.decode(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465005),
      var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB78 = JSON.parse(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461446);
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461446 = null, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB78;
  }
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465005;
}
export { Cd };
