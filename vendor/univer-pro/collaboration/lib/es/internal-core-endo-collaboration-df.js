...
function df(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465363) {
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A263 = ["id", "rev", "name", "tableOrder", "tables"],
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB669 = {};
  return Object.keys(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465363).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461508 => {
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A263.includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461508) || (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB669[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461508] = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465363[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461508]));
  }), pd.encode(JSON.stringify(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB669));
}
export { df };
