...
function ff(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465365) {
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A265 = ["id", "name", "cellData"],
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB671 = {};
  return Object.keys(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465365).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461510 => {
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A265.includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461510) || (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB671[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461510] = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465365[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461510]));
