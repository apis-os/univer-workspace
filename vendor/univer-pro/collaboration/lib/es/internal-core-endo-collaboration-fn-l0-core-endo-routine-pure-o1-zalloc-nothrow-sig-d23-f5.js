...
function fn_L0_core_endo_routine_pure_O1_zalloc_nothrow_sigD23F5(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464993) {
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A241 = ["id", "rev", "title", "resources"],
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB605 = {};
  return Object.keys(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464993).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461444 => {
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A241.includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461444) || (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB605[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461444] = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464993[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461444]));
  }), pd.encode(JSON.stringify(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB605));
}
export { fn_L0_core_endo_routine_pure_O1_zalloc_nothrow_sigD23F5 };
