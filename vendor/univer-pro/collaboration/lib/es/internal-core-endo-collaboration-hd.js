...
function hd(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464989) {
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A237 = ["id", "name", "rowCount", "columnCount", "cellData"],
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB601 = {};
  return Object.keys(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464989).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461440 => {
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A237.includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461440) || (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB601[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461440] = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464989[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461440]));
  }), pd.encode(JSON.stringify(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB601));
}
export { hd };
