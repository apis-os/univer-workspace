...
function Nn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461882) {
  "@babel/helpers - typeof";

  return Nn = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46470) {
    return typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46470;
  } : function (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46472) {
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46472 && typeof Symbol == "function" && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46472.constructor === Symbol && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46472 !== Symbol.prototype ? "symbol" : typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46472;
  }, Nn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461882);
}
function Pn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461885) {
  if (Nn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884) != "object" || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884;
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461886 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884[Symbol.toPrimitive];
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461886 !== undefined) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461887 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461886.call(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461885 || "default");
    if (Nn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461887) != "object") return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461887;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461885 === "string" ? String : Number)(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461884);
}
function Fn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461892) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461893 = Pn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461892, "string");
  return Nn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461893) == "symbol" ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461893 : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461893 + "";
}
function K(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461896, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461897, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461898) {
  return (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461897 = Fn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461897)) in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461896 ? Object.defineProperty(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461896, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461897, {
    value: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461898,
    enumerable: true,
    configurable: true,
    writable: true
  }) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461896[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461897] = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461898, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461896;
}
export { K };
