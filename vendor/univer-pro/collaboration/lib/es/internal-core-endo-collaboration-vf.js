...
function vf(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465377) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465378;
  return Math.max(((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465378 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465377.recordOrder) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465378.length) ?? gf(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465377.records), fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465377.rowId), fn_L0_core_endo_routine_pure_ON_zalloc_nothrow_sig2D1E(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D465377.cellData));
}
export { vf };
