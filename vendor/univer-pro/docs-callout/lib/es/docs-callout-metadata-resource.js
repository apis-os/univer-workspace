...
function b(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46171) {
  let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB3 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46171 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46171.callouts) ?? {};
  return {
    callouts: Object.fromEntries(Object.entries(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB3).map(([var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4615]) => [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614, x(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4615)]))
  };
}
export { b as normalizeDocsCalloutMetadataResource };
