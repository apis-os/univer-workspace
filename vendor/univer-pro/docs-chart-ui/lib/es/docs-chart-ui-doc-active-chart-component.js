...
const xi = "docs-chart-ui.active-chart",
  Si = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461429 => {
    let {
        unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461430,
        subUnitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461431,
        floatDomId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461432,
        chartId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461433,
        context: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461434
      } = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461429,
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461435 = useDependency(Q);
    return useEffect(() => {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46888 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461434.root["current"];
      if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46888) return;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46889 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461435.mountChart({
        unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461430,
        subUnitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461431,
        drawingId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461432,
        chartId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461433,
        root: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46888
      });
      return () => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46889.dispose();
    }, [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461435, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461433, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461434.root, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461432, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461431, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461430]), null;
  },
  Ci = () => null;
export { xi as DOC_ACTIVE_CHART_COMPONENT, Si as DocActiveChart, Ci as DocPrintChart };
