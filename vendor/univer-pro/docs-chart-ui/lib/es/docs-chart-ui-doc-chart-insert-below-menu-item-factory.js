...
import { ii } from "./docs-chart-ui-doc-chart-insert-menu-id.js";
import { L } from "./docs-chart-ui-open-doc-chart-insert-dialog-operation.js";
import { ai } from "./docs-chart-ui-doc-chart-insert-disabled-observable.js";
function ci(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461353) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461354 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461353.get(LocaleService).t("docs-chart-ui.common.insertChart");
  return {
    id: ii,
    commandId: L.id,
    type: MenuItemType.BUTTON,
    icon: "ChartIcon",
    title: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461354,
    tooltip: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461354,
    disabled$: ai(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461353),
    hidden$: getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461353, UniverInstanceType.UNIVER_DOC)
  };
}
export { ci as DocChartInsertBelowMenuItemFactory };
