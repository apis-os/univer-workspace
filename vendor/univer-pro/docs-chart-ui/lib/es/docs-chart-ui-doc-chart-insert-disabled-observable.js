...
function ai(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461339) {
  return combineLatest([disableMenuWhenHeaderFooterEditing(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461339), oi(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461339)]).pipe(map(([var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46597, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46598]) => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46597 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46598));
}
function oi(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461341) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461342 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461341.get(DocSelectionManagerService),
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461343 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461341.get(IUniverInstanceService);
  return new Observable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46599 => {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46600 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114 => {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46115 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461343.getCurrentUnitOfType(UniverInstanceType.UNIVER_DOC);
      if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46115) {
        var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46599.next(true);
        return;
      }
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46116 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46115.getUnitId(),
        var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A2 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114.unitId) === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46116 ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114.textRanges ?? [] : [...(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461342.getTextRanges({
      ...
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117 = var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A2.find(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4619 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4619.isActive) ?? var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A2[0];
      if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117.collapsed || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117.startOffset == null) {
        var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46599.next(true);
        return;
      }
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46118 = G(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46115, {
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117,
        segmentId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46117.segmentId ?? (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46114.segmentId) ?? ""
      });
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46599.next(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46118 == null);
    };
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46600();
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46601 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461342.textSelection$["subscribe"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46124 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46600(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46124));
    return () => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46601.unsubscribe();
  });
}
export { ai as getDocChartInsertDisabledObservable };
