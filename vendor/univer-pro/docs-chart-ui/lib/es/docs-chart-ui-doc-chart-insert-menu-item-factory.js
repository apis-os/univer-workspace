...
import { X } from "./docs-chart-ui-doc-chart-insert-menu-id.js";
...
function Z(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461349) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461350 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461349.get(LocaleService).t("docs-chart-ui.common.insertChart");
  return {
    id: X,
    commandId: L.id,
    type: MenuItemType.BUTTON,
    icon: "ChartIcon",
    title: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461350,
    tooltip: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461350,
    disabled$: ai(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461349),
    hidden$: getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461349, UniverInstanceType.UNIVER_DOC)
  };
}
export { Z as DocChartInsertMenuItemFactory };
