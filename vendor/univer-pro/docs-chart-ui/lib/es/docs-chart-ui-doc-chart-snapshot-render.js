...
var ni = class {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46555, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46556) {
    this._renderService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46555, this._renderModelManager = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46556;
  }
  async render(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560) {
    if (typeof document > "u") throw TypeError("Document\x20chart\x20snapshot\x20rendering\x20requires\x20a\x20browser\x20document.");
    let {
      chartConfig: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46561,
      chartStyle: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46562
    } = this._renderService["createRenderInput"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560);
    if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.format === ChartImageExportFormat.SVG) return (await this._renderModelManager["exportImage"]({
      chartId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560.chartId,
      config: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46561,
      style: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46562,
      width: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.width,
      height: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.height
    }, {
      format: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.format
    })).dataUrl;
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46563 = new DataUrlImageChartHost(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560.chartId, {
        width: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.width,
        height: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46559.height
      }),
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46564 = this._renderService["createChartInstance"](ChartRenderMode.Image);
    try {
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46564.bind(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46563), await var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46564.render({
        chartId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560.chartId,
        config: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46561,
        style: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46562
      });
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46110 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46563.getDataUrl();
      if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46110) throw Error("Failed\x20to\x20render\x20document\x20chart\x20snapshot:\x20" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560.unitId + "/" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46560.chartId);
      return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46110;
    } finally {
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46564.dispose(), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46563.dispose();
    }
  }
};
let Y = class extends ChartSnapshotQueue {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46571, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46573, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46574, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46575) {
    super(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46571, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46572, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46575 ?? new ni(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46573, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46574));
  }
  getCacheKey(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46581) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46582 = super.getCacheKey(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46581);
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46581.format === ChartImageExportFormat.SVG ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46582 + "::" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46581.format : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46582;
  }
};
export { Y as DocChartSnapshotRenderService };
