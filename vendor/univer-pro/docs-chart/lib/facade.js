import { DocChartInsertAnchorKind as var_core_value_sig273D, DocChartParagraphPosition as var_core_value_sig9A0D, DocumentChartConfigAdapter as var_core_value_sigA319, InsertDocChartCommand as var_core_value_sig2D58, assertValidOptionalDocChartSize as var_core_value_sig223F, normalizeDocumentChartValues as var_core_value_sigD749 } from "@univerjs-pro/docs-chart";
import { ChartDataSourceRuntimeStatus as var_core_value_sigCFFA, ChartResourceRepository as var_core_value_sig58C1, ChartTypeBits as var_core_value_sig5090, IChartDataSourceRuntimeService as var_core_value_sigC368, ResourceRefChartDataSourceAdapter as var_core_value_sigAD56, toChartDataItem as var_core_value_sigDB4A, toChartModelConfig as var_core_value_sig6418 } from "@univerjs-pro/engine-chart";
import { FChart as var_core_value_sig1896, createChartBuilder as var_core_value_sig0285 } from "@univerjs-pro/engine-chart/facade";
import { DrawingTypeEnum as var_core_value_sig777D, ICommandService as var_core_value_sig3F4C, PositionedObjectLayoutType as var_core_value_sigD65A, Tools as var_core_value_sig5A13, getParagraphContentStartOffset as var_core_value_sigF593 } from "@univerjs/core";
import { DocSelectionManagerService as var_core_value_sig3607, normalizeTextRange as var_core_value_sigB512 } from "@univerjs/docs";
import { FDocument as var_core_value_sigF2E6 } from "@univerjs/docs/facade";
import { filter as var_core_value_sig34C8, firstValueFrom as var_core_value_sigB744 } from "rxjs";
import { FEnum as var_core_value_sigEAE2 } from "@univerjs/core/facade";
function E(var_core_value_sig86D0) {
  "@babel/helpers - typeof";

  return E = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigF9C7) {
  ...
  }, E(var_core_value_sig86D0);
}
function D(var_core_value_sig4CD2, var_core_value_sig48CA) {
  if (E(var_core_value_sig4CD2) != "object" || !var_core_value_sig4CD2) return var_core_value_sig4CD2;
  ...
  if (var_core_value_sig50AF !== undefined) {
    ...
    if (E(var_core_value_sigA942) != "object") return var_core_value_sigA942;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig48CA === "string" ? String : Number)(var_core_value_sig4CD2);
}
function O(var_core_value_sigA621) {
  var var_core_value_sigBBFF = D(var_core_value_sigA621, "string");
  return E(var_core_value_sigBBFF) == "symbol" ? var_core_value_sigBBFF : var_core_value_sigBBFF + "";
}
function k(var_core_value_sig8889, var_core_value_sig32F8, var_core_value_sig5B67) {
  return (var_core_value_sig32F8 = O(var_core_value_sig32F8)) in var_core_value_sig8889 ? Object.defineProperty(var_core_value_sig8889, var_core_value_sig32F8, {
...
var A = class extends var_core_value_sig1896 {
    constructor(var_core_value_sigC80B, var_core_value_sig284F, var_core_value_sigE154, var_core_value_sig4632) {
      super(var_core_value_sigE154, () => new var_core_value_sigA319({
      ...
      }), (var_core_value_sig480E, var_core_value_sig26DB, var_core_value_sigF0F9) => var_core_value_sig0285({
        ...
        normalizeSource: var_core_value_sig3D7D => Array.isArray(var_core_value_sig3D7D) ? {
          values: var_core_value_sig5A13.deepClone(var_core_value_sig3D7D)
        } : {
          source: var_core_value_sigAD56.toReference(var_core_value_sig3D7D)
        },
        extension: ({
          ...
          setInline() {
            return var_core_value_sig8061("layoutType", var_core_value_sigD65A.INLINE), this;
          },
          setFloating() {
            return var_core_value_sig8061("layoutType", var_core_value_sigD65A.WRAP_SQUARE), this;
          }
        })
      }), var_core_value_sig4632), this._documentDataModel = var_core_value_sigC80B, this._drawingId = var_core_value_sig284F, this._chartId = var_core_value_sigE154, k(this, "unitId", undefined), this.unitId = var_core_value_sigC80B.getUnitId();
    }
    getDrawingId() {
      return this._drawingId;
    }
  },
  j = class extends var_core_value_sigF2E6 {
    newChart(var_core_value_sig12F2) {
      return var_core_value_sig0285({
        ...
        normalizeSource: var_core_value_sig1A0F => Array.isArray(var_core_value_sig1A0F) ? {
          values: var_core_value_sig5A13.deepClone(var_core_value_sig1A0F)
        } : {
          source: var_core_value_sigAD56.toReference(var_core_value_sig1A0F)
        },
        createInfo: () => ({
          anchor: undefined,
        ...
        extension: ({
          ...
          setInline() {
            return var_core_value_sig4383("layoutType", var_core_value_sigD65A.INLINE), this;
          },
          setFloating() {
            return var_core_value_sig4383("layoutType", var_core_value_sigD65A.WRAP_SQUARE), this;
          }
        })
      });
    }
    async insertChart(var_core_value_sig2259) {
      ...
      try {
        ...
        let var_core_value_sig48BD = M(var_core_value_sig2259, var_core_value_sig2259.dataSource["values"] ?? var_core_value_sig9E2F.values),
          var_core_value_sig429F = var_core_value_sigD749(var_core_value_sig48BD.values);
        ...
        let var_core_value_sigF62A = this.getDocumentDataModel(),
          var_core_value_sig8178 = P(var_core_value_sigF62A, this._injector, var_core_value_sig48BD.insert),
          var_core_value_sigE9ED = this._injector["get"](var_core_value_sig3F4C).syncExecuteCommand(var_core_value_sig2D58.id, {
            unitId: var_core_value_sigF62A.getUnitId(),
            chart: {
              chartType: var_core_value_sig48BD.chartType ?? var_core_value_sig5090.Column,
    ...
    getChart(var_core_value_sigD082) {
      let var_core_value_sigDBB7 = this.getDocumentDataModel(),
        var_core_value_sigD0A8 = B(var_core_value_sigDBB7, var_core_value_sigD082);
      return !var_core_value_sigD0A8 || !this._getChartResource(var_core_value_sigD0A8.chartId) ? null : this._injector["createInstance"](A, var_core_value_sigDBB7, var_core_value_sigD0A8.drawingId, var_core_value_sigD0A8.chartId, this._injector);
    }
    getCharts() {
      let var_core_value_sigF4B9 = this.getDocumentDataModel(),
        var_core_value_sig5CEE = var_core_value_sigF4B9.getDrawings() ?? {};
      return (var_core_value_sigF4B9.getDrawingsOrder() ?? Object.keys(var_core_value_sig5CEE)).map(var_core_value_sig9572 => var_core_value_sig5CEE[var_core_value_sig9572]).filter(V).filter(var_core_value_sigD873 => this._getChartResource(var_core_value_sigD873.chartId) != null).map(var_core_value_sigA12B => this._injector["createInstance"](A, var_core_value_sigF4B9, var_core_value_sigA12B.drawingId, var_core_value_sigA12B.chartId, this._injector));
    }
    _getChartResource(var_core_value_sigE92A) {
      return this._injector["get"](var_core_value_sig58C1).getChart(this.getDocumentDataModel().getUnitId(), var_core_value_sigE92A);
    }
    async _resolveReferencedValues(var_core_value_sig362B) {
      let var_core_value_sig5CA5 = this._injector["get"](var_core_value_sigC368).acquire(var_core_value_sig362B);
      try {
        let var_core_value_sigF230 = await var_core_value_sigB744(var_core_value_sig5CA5.state$["pipe"](var_core_value_sig34C8(({
          status: var_core_value_sig2BCF
        }) => var_core_value_sig2BCF !== var_core_value_sigCFFA.LOADING)));
        if (var_core_value_sigF230.status !== var_core_value_sigCFFA.READY || !var_core_value_sigF230.values) throw var_core_value_sigF230.error instanceof Error ? var_core_value_sigF230.error : Error(var_core_value_sig362B.kind);
        return {
...
function M(var_core_value_sig1758, var_core_value_sig4805) {
  ...
  return N(var_core_value_sig1758.config, {
...
function N(var_core_value_sig9989, var_core_value_sig698E, var_core_value_sig2809, var_core_value_sig2DAB) {
  let var_core_value_sig877E = var_core_value_sig2809,
    var_core_value_sig20C8 = (var_core_value_sig877E[0] ?? []).slice(1).map((var_core_value_sigE90F, var_core_value_sigEFD4) => {
      ...
      return {
        ...
        items: var_core_value_sig877E.slice(1).map(var_core_value_sig6F91 => var_core_value_sigDB4A(var_core_value_sig6F91[var_core_value_sig861B]))
      };
    }),
    var_core_value_sigE9A7 = var_core_value_sig6418({
      ...var_core_value_sig9989,
      series: var_core_value_sig5A13.deepClone(var_core_value_sig9989.series)
    }, {
...
function P(var_core_value_sigBECE, var_core_value_sig1B22, var_core_value_sig7F72) {
  ...
  return {
    textRange: var_core_value_sig07E9 ? I(var_core_value_sigBECE, var_core_value_sig1B22, var_core_value_sig07E9) : F(var_core_value_sig1B22),
    layout: z({
...
function F(var_core_value_sig4F59) {
  let var_core_value_sigF564 = var_core_value_sig4F59.get(var_core_value_sig3607).getActiveTextRange();
  return var_core_value_sigF564 && (var_core_value_sigF564.segmentId == null || var_core_value_sigF564.segmentId === "") ? var_core_value_sigB512(var_core_value_sigF564) : L(0);
}
function I(var_core_value_sig8CFA, var_core_value_sig2E11, var_core_value_sig5B69) {
  if (var_core_value_sig5B69.kind === var_core_value_sig273D.Selection) {
    let var_core_value_sig5237 = var_core_value_sig2E11.get(var_core_value_sig3607).getActiveTextRange();
    ...
    return var_core_value_sigB512(var_core_value_sig5237);
  }
  if (var_core_value_sig5B69.kind === var_core_value_sig273D.Paragraph) {
    ...
    if (!var_core_value_sig7E54) throw Error("Document paragraph at index " + var_core_value_sig5B69.index + " was not found.");
    let var_core_value_sig9A8D = var_core_value_sigBB00 ? var_core_value_sigF593(var_core_value_sigBB00, var_core_value_sig7E54) : 0;
    return L(var_core_value_sig5B69.where === var_core_value_sig9A0D.Before ? var_core_value_sig9A8D : var_core_value_sig7E54.startIndex);
  }
  if (var_core_value_sig5B69.kind === var_core_value_sig273D.TextRange) {
    let var_core_value_sigC259 = var_core_value_sig5B69.endOffset ?? var_core_value_sig5B69.startOffset;
    return R(var_core_value_sig5B69.startOffset), R(var_core_value_sigC259), {
  ...
  return R(var_core_value_sig5B69.offset), L(var_core_value_sig5B69.offset);
}
function L(var_core_value_sigCE71) {
  return R(var_core_value_sigCE71), {
...
function R(var_core_value_sig21D8) {
...
function z(var_core_value_sig2B65) {
  if (var_core_value_sig223F(var_core_value_sig2B65.width), var_core_value_sig223F(var_core_value_sig2B65.height), var_core_value_sig2B65.position && (!Number.isFinite(var_core_value_sig2B65.position["x"]) || !Number.isFinite(var_core_value_sig2B65.position["y"]))) throw Error("Document chart position must contain finite x and y values.");
  return var_core_value_sig2B65;
}
function B(var_core_value_sigD7EA, var_core_value_sigB33B) {
  ...
  return V(var_core_value_sigE627) ? var_core_value_sigE627 : Object.values(var_core_value_sig24B9).map(var_core_value_sig9C9F => var_core_value_sig9C9F).find(var_core_value_sigFDEA => V(var_core_value_sigFDEA) && var_core_value_sigFDEA.chartId === var_core_value_sigB33B) ?? null;
}
function V(var_core_value_sigEF3E) {
  return (var_core_value_sigEF3E == null ? undefined : var_core_value_sigEF3E.drawingType) === var_core_value_sig777D.DRAWING_CHART && typeof var_core_value_sigEF3E.chartId == "string";
}
var_core_value_sigF2E6.extend(j);
var H = class extends var_core_value_sigEAE2 {
  get DocsChartInsertAnchorKind() {
    return var_core_value_sig273D;
  }
  get DocsChartLayoutType() {
    return var_core_value_sigD65A;
  }
};
var_core_value_sigEAE2.extend(H);
