...
function Xe(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46496 = H(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495);
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495.columns["slice"](0, -1).map((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46140, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46141) => {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46142 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495.columns[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46141 + 1],
      var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB4 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46140.left + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46140.width + (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46142.left - var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46140.left - var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46140.width) / 2;
    return {
      columnGroupId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495.columnGroupId,
      separatorIndex: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46141,
      left: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495.left + var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB4,
      top: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46495.top,
      height: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46496
    };
  });
}
export { Xe as getColumnResizeHandles };
