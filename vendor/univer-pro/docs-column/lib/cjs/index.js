...
let e = require("@univerjs/core"),
  ...
  i = function (var_core_value_sig6201) {
...
function o(var_core_value_sig5151, var_core_value_sigB542) {
  ...
  if (!var_core_value_sigB8C7 || !var_core_value_sigA56E || var_core_value_sigA56E[var_core_value_sigB8C7.startIndex] !== a.COLUMN_GROUP_START || var_core_value_sigA56E[var_core_value_sigB8C7.endIndex] !== a.COLUMN_GROUP_END) return null;
  let var_core_value_sig1998 = (0, e.getColumnGroupRangeInterval)(var_core_value_sigB8C7);
  return s(var_core_value_sigA56E, var_core_value_sig1998.startOffset, var_core_value_sig1998.endOffset, var_core_value_sigB542, var_core_value_sigB8C7);
}
function s(var_core_value_sigFF19, var_core_value_sig43B8, var_core_value_sigD98F, var_core_value_sig66C0, var_core_value_sig9D15) {
  ...
  for (let var_core_value_sig32F8 = var_core_value_sig43B8; var_core_value_sig32F8 < var_core_value_sigD98F; var_core_value_sig32F8++) {
    ...
    if (var_core_value_sig48BD === a.COLUMN_START) {
      var_core_value_sig130F = var_core_value_sig32F8;
      continue;
    }
    if (var_core_value_sig48BD === a.COLUMN_END && var_core_value_sig130F >= 0) {
...
function c(var_core_value_sig52F7) {
  return {
    ...var_core_value_sig52F7,
    body: var_core_value_sig52F7.body ? l(var_core_value_sig52F7.body) : var_core_value_sig52F7.body
  };
}
function l(var_core_value_sig866F) {
  ...
  return {
    ...
    paragraphs: (var_core_value_sigDE3D = var_core_value_sig866F.paragraphs) == null ? undefined : var_core_value_sigDE3D.map(var_core_value_sig5B67 => ({
      ...
      bullet: u(var_core_value_sig5B67.bullet),
      paragraphStyle: u(var_core_value_sig5B67.paragraphStyle)
    })),
    ...
    columnGroups: (var_core_value_sig49B0 = var_core_value_sig866F.columnGroups) == null ? undefined : var_core_value_sig49B0.map(var_core_value_sig2902 => {
      ...
      return {
        ...
        columns: (var_core_value_sig9989 = var_core_value_sig2902.columns) == null ? undefined : var_core_value_sig9989.map(var_core_value_sig429F => u(var_core_value_sig429F))
      };
    }),
...
function u(var_core_value_sig880E) {
  return Array.isArray(var_core_value_sig880E) ? var_core_value_sig880E.map(var_core_value_sig20C8 => u(var_core_value_sig20C8)) : !var_core_value_sig880E || typeof var_core_value_sig880E != "object" ? var_core_value_sig880E : Object.fromEntries(Object.entries(var_core_value_sig880E).map(([var_core_value_sigE9A7, var_core_value_sigBECE]) => [var_core_value_sigE9A7, u(var_core_value_sigBECE)]));
}
const d = new Set([e.DataStreamTreeTokenType["BLOCK_END"], a.COLUMN_START, a.COLUMN_END, a.COLUMN_GROUP_END, e.DataStreamTreeTokenType["TABLE_ROW_START"], e.DataStreamTreeTokenType["TABLE_CELL_START"], e.DataStreamTreeTokenType["TABLE_CELL_END"], e.DataStreamTreeTokenType["TABLE_ROW_END"], e.DataStreamTreeTokenType["TABLE_END"]]);
function f(var_core_value_sigC9ED, var_core_value_sigB57B) {
  if (!x(var_core_value_sigC9ED)) return false;
  let var_core_value_sig780B = var_core_value_sigC9ED.body;
  return !(var_core_value_sig780B != null && var_core_value_sig780B.dataStream) || b(var_core_value_sig780B.dataStream[var_core_value_sigB57B]) ? false : !(var_core_value_sig780B.columnGroups ?? []).some(var_core_value_sig1B22 => (0, e.containsInteriorInsertionOffset)((0, e.getColumnGroupRangeInterval)(var_core_value_sig1B22), var_core_value_sigB57B)) && !(var_core_value_sig780B.tables ?? []).some(var_core_value_sig7F72 => (0, e.containsInteriorInsertionOffset)((0, e.getTableRangeInterval)(var_core_value_sig7F72), var_core_value_sigB57B)) && !(var_core_value_sig780B.blockRanges ?? []).some(var_core_value_sig7B2A => (0, e.containsInteriorInsertionOffset)((0, e.getBlockRangeInterval)(var_core_value_sig7B2A), var_core_value_sigB57B));
}
function p(var_core_value_sig7D1B) {
  let var_core_value_sig7BE0 = c(var_core_value_sig7D1B.documentData),
    var_core_value_sig7D40 = m(var_core_value_sig7BE0),
    var_core_value_sig6C7E = Math.max(0, Math.min(var_core_value_sig7D1B.offset, var_core_value_sig7D40.dataStream["length"]));
  if (!x(var_core_value_sig7BE0)) throw Error("[DocsColumn]: Column groups can only be inserted in modern documents.");
  if (!f(var_core_value_sig7BE0, var_core_value_sig6C7E)) throw Error("[DocsColumn]: Cannot insert a column group inside table, column group, or document block ranges.");
  ...
  let var_core_value_sig04C6 = h(var_core_value_sig7D1B.columnIds, var_core_value_sig68BE),
    var_core_value_sigCA05 = _(var_core_value_sig68BE, y(var_core_value_sig7D40), v(var_core_value_sig7D40, var_core_value_sig6C7E)),
  ...
  return var_core_value_sig7D40.dataStream = "" + var_core_value_sig7D40.dataStream["slice"](0, var_core_value_sig6C7E) + var_core_value_sig2F2B + var_core_value_sig7D40.dataStream["slice"](var_core_value_sig6C7E), var_core_value_sig7D40.paragraphs = [...S(var_core_value_sig7D40.paragraphs ?? [], var_core_value_sig6C7E, var_core_value_sig2F2B.length), ...var_core_value_sigCA05.paragraphs["map"](var_core_value_sig06CD => ({
    ...var_core_value_sig06CD,
    startIndex: var_core_value_sig06CD.startIndex + var_core_value_sig6C7E
  }))].sort((var_core_value_sigA5F1, var_core_value_sig97A2) => var_core_value_sigA5F1.startIndex - var_core_value_sig97A2.startIndex), var_core_value_sig7D40.sectionBreaks = [...S(var_core_value_sig7D40.sectionBreaks ?? [], var_core_value_sig6C7E, var_core_value_sig2F2B.length), ...var_core_value_sigCA05.sectionBreaks["map"](var_core_value_sig07E9 => ({
    ...var_core_value_sig07E9,
    startIndex: var_core_value_sig07E9.startIndex + var_core_value_sig6C7E
  }))].sort((var_core_value_sig4F59, var_core_value_sigF564) => var_core_value_sig4F59.startIndex - var_core_value_sigF564.startIndex), var_core_value_sig7D40.textRuns = C(var_core_value_sig7D40.textRuns ?? [], var_core_value_sig6C7E, var_core_value_sig2F2B.length), var_core_value_sig7D40.customBlocks = S(var_core_value_sig7D40.customBlocks ?? [], var_core_value_sig6C7E, var_core_value_sig2F2B.length), var_core_value_sig7D40.blockRanges = (var_core_value_sig7D40.blockRanges ?? []).map(var_core_value_sig8CFA => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig8CFA, var_core_value_sig6C7E, var_core_value_sig2F2B.length)), var_core_value_sig7D40.customRanges = (var_core_value_sig7D40.customRanges ?? []).map(var_core_value_sig2E11 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig2E11, var_core_value_sig6C7E, var_core_value_sig2F2B.length)), var_core_value_sig7D40.customDecorations = (var_core_value_sig7D40.customDecorations ?? []).map(var_core_value_sig5B69 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig5B69, var_core_value_sig6C7E, var_core_value_sig2F2B.length)), var_core_value_sig7D40.tables = (var_core_value_sig7D40.tables ?? []).map(var_core_value_sigB098 => (0, e.shiftExclusiveRangeOnInsert)(var_core_value_sigB098, var_core_value_sig6C7E, var_core_value_sig2F2B.length)), var_core_value_sig7D40.columnGroups = [...(var_core_value_sig7D40.columnGroups ?? []).map(var_core_value_sigCE71 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sigCE71, var_core_value_sig6C7E, var_core_value_sig2F2B.length)), {
    ...
    gap: {
      v: g(var_core_value_sig7D1B.gap)
    },
...
function m(var_core_value_sigD04E) {
  return var_core_value_sigD04E.body ??= {
    ...
    columnGroups: []
  }, var_core_value_sigD04E.body["dataStream"] ??= e.DataStreamTreeTokenType["SECTION_BREAK"], var_core_value_sigD04E.body["paragraphs"] ??= [], var_core_value_sigD04E.body["sectionBreaks"] ??= [], var_core_value_sigD04E.body["columnGroups"] ??= [], var_core_value_sigD04E.body;
}
function h(var_core_value_sigB99B, var_core_value_sig5A75) {
  return Array.from({
...
function g(var_core_value_sig7BAF) {
...
function _(var_core_value_sig8F69, var_core_value_sig6884, var_core_value_sig066E) {
  let var_core_value_sig9B0D = a.COLUMN_GROUP_START,
    var_core_value_sig3D2C = [],
    var_core_value_sigC56D = [];
  for (let var_core_value_sigE627 = 0; var_core_value_sigE627 < var_core_value_sig8F69; var_core_value_sigE627++) var_core_value_sig9B0D += "" + a.COLUMN_START + e.DataStreamTreeTokenType["PARAGRAPH"] + a.COLUMN_END, var_core_value_sig3D2C.push({
    startIndex: var_core_value_sig9B0D.length - 2,
    paragraphId: (0, e.createParagraphId)(var_core_value_sig6884)
  });
  var_core_value_sig9B0D += a.COLUMN_GROUP_END;
  let var_core_value_sig3A17 = var_core_value_sig9B0D.length - 1;
  return var_core_value_sig066E && (var_core_value_sig9B0D += e.DataStreamTreeTokenType["PARAGRAPH"], var_core_value_sig3D2C.push({
...
function v(var_core_value_sig938F, var_core_value_sigD948) {
  let var_core_value_sigBE5E = var_core_value_sig938F.dataStream[var_core_value_sigD948];
  return var_core_value_sigBE5E === e.DataStreamTreeTokenType["SECTION_BREAK"] || var_core_value_sigBE5E === undefined;
}
function y(var_core_value_sig0281) {
  return new Set((var_core_value_sig0281.paragraphs ?? []).map(var_core_value_sigEF3E => var_core_value_sigEF3E.paragraphId));
}
function b(var_core_value_sigED71) {
  return var_core_value_sigED71 != null && d.has(var_core_value_sigED71);
}
function x(var_core_value_sig281C) {
  var var_core_value_sig3C92;
  return ((var_core_value_sig3C92 = var_core_value_sig281C.documentStyle) == null ? undefined : var_core_value_sig3C92.documentFlavor) === e.DocumentFlavor["MODERN"];
}
function S(var_core_value_sigB16B, var_core_value_sig585D, var_core_value_sigE722) {
...
function C(var_core_value_sig062A, var_core_value_sig050A, var_core_value_sig8B32) {
...
function w(var_core_value_sig870F, var_core_value_sigB683) {
  let var_core_value_sig26EC = var_core_value_sig870F.get(e.IUniverInstanceService),
    var_core_value_sigEEDB = var_core_value_sigB683 ? var_core_value_sig26EC.getUnit(var_core_value_sigB683, e.UniverInstanceType["UNIVER_DOC"]) : var_core_value_sig26EC.getCurrentUnitOfType(e.UniverInstanceType["UNIVER_DOC"]),
  ...
  return !var_core_value_sig36E7 || !var_core_value_sig6A78 ? null : {
    commandService: var_core_value_sig870F.get(e.ICommandService),
    snapshot: var_core_value_sig36E7,
    unitId: var_core_value_sig6A78
  };
}
function T(var_core_value_sigF7EF, var_core_value_sig27F9, var_core_value_sig393E) {
  return var_core_value_sig27F9 ? !!var_core_value_sigF7EF.commandService["syncExecuteCommand"](t.RichTextEditingMutation["id"], {
    unitId: var_core_value_sigF7EF.unitId,
    actions: var_core_value_sig27F9,
    textRanges: var_core_value_sig393E
  }) : false;
}
function ee(var_core_value_sigB609, var_core_value_sig390D, var_core_value_sigC928) {
  var var_core_value_sig39B7, var_core_value_sig18E0;
  let var_core_value_sigE161 = e.JSONX["getInstance"](),
  ...
  }).filter(Boolean).reduce((var_core_value_sig58C1, var_core_value_sig5090) => e.JSONX["compose"](var_core_value_sig58C1, var_core_value_sig5090), null);
}
function te(var_core_value_sig3FC7, var_core_value_sig1E1B, var_core_value_sig3B10, var_core_value_sig89E6, var_core_value_sig4743) {
  var var_core_value_sigEB6A;
  let var_core_value_sig3D46 = var_core_value_sig3FC7.body,
    var_core_value_sigCC93 = o(var_core_value_sig3FC7, var_core_value_sig1E1B),
  ...
  let var_core_value_sigEA92 = var_core_value_sig89E6 === "left" ? var_core_value_sig2A26 : var_core_value_sig2A26 + 1,
    ...
    var_core_value_sig1AE5 = me(var_core_value_sig3D46),
    var_core_value_sig7100 = e.JSONX["getInstance"](),
    var_core_value_sigA19A = D(var_core_value_sig8FD9, var_core_value_sig1AE5, 0),
    var_core_value_sigD3F5 = {
      columnId: var_core_value_sig4743,
      widthRatio: 1
    };
  return {
    actions: O([var_core_value_sigA19A, var_core_value_sig7100.insertOp(["body", "columnGroups", var_core_value_sig808B, "columns", var_core_value_sigEA92], var_core_value_sigD3F5)]),
    cursorOffset: var_core_value_sig8FD9 + 1
  };
}
function ne(var_core_value_sig3082, var_core_value_sigF5D1, var_core_value_sig8775) {
  let var_core_value_sig481B = re(var_core_value_sig3082, var_core_value_sigF5D1);
  ...
  let var_core_value_sigFBA5 = var_core_value_sigD9DB.startOffset,
    ...
    var_core_value_sig770E = e.JSONX["getInstance"]();
  return {
    actions: O([D(var_core_value_sigFBA5, undefined, var_core_value_sigAC47 - var_core_value_sigFBA5), var_core_value_sig770E.removeOp(["body", "columnGroups", var_core_value_sig90C0, "columns", var_core_value_sigC2BB], A(var_core_value_sigA363))]),
...
function re(var_core_value_sig4654, var_core_value_sigB26B) {
  var var_core_value_sig019B;
  let var_core_value_sigC6BC = var_core_value_sig4654.body,
    var_core_value_sig8EC2 = o(var_core_value_sig4654, var_core_value_sigB26B),
...
function ie(var_core_value_sig031B, var_core_value_sig9DC0) {
...
function ae(var_core_value_sigAEC8, var_core_value_sigB977) {
  ...
  let var_core_value_sigA309 = var_core_value_sig528D.startIndex,
    var_core_value_sig9E20 = (0, e.getColumnGroupRangeInterval)(var_core_value_sig528D).endOffset;
  return {
    actions: D(var_core_value_sigA309, var_core_value_sig308A.dataStream["length"] === var_core_value_sig9E20 - var_core_value_sigA309 ? ge(var_core_value_sig308A) : undefined, var_core_value_sig9E20 - var_core_value_sigA309),
    cursorOffset: var_core_value_sigA309
  };
}
function oe(var_core_value_sig26BB) {
  ...
  let var_core_value_sig218A = var_core_value_sig19B4.dataStream ?? "",
    ...
    var_core_value_sigFDEE = se(var_core_value_sig14CB),
    var_core_value_sigA676 = new Set();
  var_core_value_sigFDEE.forEach(var_core_value_sig777D => {
    ce(var_core_value_sig218A, var_core_value_sig14CB[var_core_value_sig777D]).forEach(var_core_value_sigF62A => var_core_value_sigA676.add(var_core_value_sigF62A));
  }), var_core_value_sig14CB.forEach((var_core_value_sig3F4C, var_core_value_sigD65A) => {
    !var_core_value_sigFDEE.has(var_core_value_sigD65A) && le(var_core_value_sig218A, var_core_value_sig3F4C, var_core_value_sigA676) && (var_core_value_sigFDEE.add(var_core_value_sigD65A), ce(var_core_value_sig218A, var_core_value_sig3F4C).forEach(var_core_value_sig8178 => var_core_value_sigA676.add(var_core_value_sig8178)));
  });
  let var_core_value_sigC27E = [];
  var_core_value_sig14CB.forEach((var_core_value_sig5A13, var_core_value_sigF593) => {
    var_core_value_sigFDEE.has(var_core_value_sigF593) || ue(var_core_value_sigC27E, var_core_value_sig5A13, var_core_value_sigF593, var_core_value_sig218A, var_core_value_sigA676);
  });
  let var_core_value_sigA70D = e.JSONX["getInstance"]();
  [...var_core_value_sigFDEE].sort((var_core_value_sig3607, var_core_value_sigB512) => var_core_value_sigB512 - var_core_value_sig3607).forEach(var_core_value_sigF2E6 => {
    var_core_value_sigC27E.push(var_core_value_sigA70D.removeOp(["body", "columnGroups", var_core_value_sigF2E6], A(var_core_value_sig14CB[var_core_value_sigF2E6])));
  });
  let var_core_value_sigCE10 = pe(var_core_value_sig19B4, var_core_value_sigA676);
  return var_core_value_sigCE10 && var_core_value_sigC27E.push(var_core_value_sigCE10), var_core_value_sigC27E.length ? O(var_core_value_sigC27E) : null;
}
function se(var_core_value_sigA386) {
...
function ce(var_core_value_sig44DD, var_core_value_sig96FA) {
  let var_core_value_sigAB68 = (0, e.getColumnGroupRangeInterval)(var_core_value_sig96FA).endOffset,
    var_core_value_sig040A = new Set([a.COLUMN_GROUP_START, a.COLUMN_START, a.COLUMN_END, a.COLUMN_GROUP_END]),
...
function le(var_core_value_sigC349, var_core_value_sig9D96, var_core_value_sig2776) {
  let var_core_value_sig6FB2 = (0, e.getColumnGroupRangeInterval)(var_core_value_sig9D96).endOffset,
...
function ue(var_core_value_sigF963, var_core_value_sigB608, var_core_value_sigF866, var_core_value_sig5EFB, var_core_value_sig3A85) {
  var var_core_value_sig2682;
  let var_core_value_sig4BB5 = de(var_core_value_sig5EFB, var_core_value_sigB608, var_core_value_sig3A85);
  if (var_core_value_sig4BB5 === 0) return;
  let var_core_value_sig6709 = fe(var_core_value_sigB608, var_core_value_sig4BB5),
    ...
    var_core_value_sigC030 = e.JSONX["getInstance"]();
  E(var_core_value_sigF963, var_core_value_sigC030, ["body", "columnGroups", var_core_value_sigF866, "columns"], var_core_value_sigB608.columns, var_core_value_sig6709), E(var_core_value_sigF963, var_core_value_sigC030, ["body", "columnGroups", var_core_value_sigF866, "gap"], var_core_value_sigB608.gap, var_core_value_sig52CA), E(var_core_value_sigF963, var_core_value_sigC030, ["body", "columnGroups", var_core_value_sigF866, "layout"], var_core_value_sigB608.layout, var_core_value_sigB608.layout ?? e.ColumnLayoutType["FIXED"]), E(var_core_value_sigF963, var_core_value_sigC030, ["body", "columnGroups", var_core_value_sigF866, "responsive"], var_core_value_sigB608.responsive, var_core_value_sigB608.responsive ?? e.ColumnResponsiveType["STACK"]);
}
function de(var_core_value_sig88F6, var_core_value_sig37DB, var_core_value_sig5542) {
  let var_core_value_sigE0A9 = (0, e.getColumnGroupRangeInterval)(var_core_value_sig37DB).endOffset,
    var_core_value_sigA73E = 0;
  for (let var_core_value_sig3E68 = var_core_value_sig37DB.startIndex; var_core_value_sig3E68 < var_core_value_sigE0A9; var_core_value_sig3E68++) !var_core_value_sig5542.has(var_core_value_sig3E68) && var_core_value_sig88F6[var_core_value_sig3E68] === a.COLUMN_START && var_core_value_sigA73E++;
  return var_core_value_sigA73E;
}
function fe(var_core_value_sig7620, var_core_value_sigB9FC) {
  return Array.from({
...
function E(var_core_value_sig5055, var_core_value_sig3801, var_core_value_sig45F0, var_core_value_sigBC91, var_core_value_sigCB88) {
  e.Tools["diffValue"](var_core_value_sigBC91, var_core_value_sigCB88) || var_core_value_sig5055.push(var_core_value_sigBC91 == null ? var_core_value_sig3801.insertOp(var_core_value_sig45F0, A(var_core_value_sigCB88)) : var_core_value_sig3801.replaceOp(var_core_value_sig45F0, A(var_core_value_sigBC91), A(var_core_value_sigCB88)));
}
function pe(var_core_value_sig8D65, var_core_value_sig8122) {
  ...
  let var_core_value_sig7E56 = new e["TextX"](),
    var_core_value_sig4161 = 0;
  if (var_core_value_sig6BD9) {
    let var_core_value_sigE243 = ge(var_core_value_sig8D65);
  ...
  return e.JSONX["getInstance"]().editOp(var_core_value_sig7E56.serialize(), ["body"]);
}
function me(var_core_value_sig7580) {
  var var_core_value_sig1F18;
  let var_core_value_sigD5A0 = k(var_core_value_sig7580);
  return {
    dataStream: "" + a.COLUMN_START + e.DataStreamTreeTokenType["PARAGRAPH"] + e.DataStreamTreeTokenType["SECTION_BREAK"] + a.COLUMN_END,
    paragraphs: [{
      startIndex: 1,
      paragraphId: (0, e.createParagraphId)(var_core_value_sigD5A0)
    }],
    sectionBreaks: [{
      sectionId: (0, e.createSectionId)(new Set((var_core_value_sig1F18 = var_core_value_sig7580.sectionBreaks) == null ? undefined : var_core_value_sig1F18.map(var_core_value_sig21B2 => var_core_value_sig21B2.sectionId))),
      startIndex: 2
    }]
  };
}
function he(var_core_value_sig81B2, var_core_value_sigA0A5) {
  let var_core_value_sig10AA = k(var_core_value_sig81B2),
    ...
    var_core_value_sig8E91 = a.COLUMN_GROUP_START,
    var_core_value_sig00BE = [];
  for (let var_core_value_sig7F33 = 0; var_core_value_sig7F33 < var_core_value_sigA0A5.columnCount; var_core_value_sig7F33++) var_core_value_sig8E91 += "" + a.COLUMN_START + e.DataStreamTreeTokenType["PARAGRAPH"] + a.COLUMN_END, var_core_value_sig00BE.push({
    startIndex: var_core_value_sig8E91.length - 2,
    paragraphId: (0, e.createParagraphId)(var_core_value_sig10AA)
  });
  var_core_value_sig8E91 += a.COLUMN_GROUP_END;
  let var_core_value_sig7BB5 = var_core_value_sig8E91.length - 1;
  return v(var_core_value_sig81B2, var_core_value_sigA0A5.offset) && (var_core_value_sig8E91 += e.DataStreamTreeTokenType["PARAGRAPH"], var_core_value_sig00BE.push({
    ...
    columnGroups: [{
      ...
      gap: {
        v: _e(var_core_value_sigA0A5.gap)
      },
      layout: e.ColumnLayoutType["FIXED"],
      responsive: e.ColumnResponsiveType["STACK"]
    }]
...
function ge(var_core_value_sig6AAD) {
  var var_core_value_sig1157;
  return {
    dataStream: "" + e.DataStreamTreeTokenType["PARAGRAPH"] + e.DataStreamTreeTokenType["SECTION_BREAK"],
    paragraphs: [{
      startIndex: 0,
      paragraphId: (0, e.createParagraphId)(k(var_core_value_sig6AAD))
    }],
    sectionBreaks: [{
      sectionId: (0, e.createSectionId)(new Set((var_core_value_sig1157 = var_core_value_sig6AAD.sectionBreaks) == null ? undefined : var_core_value_sig1157.map(var_core_value_sig8109 => var_core_value_sig8109.sectionId))),
      startIndex: 1
    }]
  };
}
function D(var_core_value_sigA694, var_core_value_sig18E01, var_core_value_sig0428) {
  let var_core_value_sigBE07 = new e.TextX();
  return var_core_value_sigA694 > 0 && var_core_value_sigBE07.retain(var_core_value_sigA694), var_core_value_sig18E01 != null && var_core_value_sig18E01.dataStream["length"] && var_core_value_sigBE07.insert(var_core_value_sig18E01.dataStream["length"], var_core_value_sig18E01), var_core_value_sig0428 > 0 && var_core_value_sigBE07.delete(var_core_value_sig0428), e.JSONX["getInstance"]().editOp(var_core_value_sigBE07.serialize(), ["body"]);
}
function O(var_core_value_sig555F) {
  return var_core_value_sig555F.reduce((var_core_value_sig7565, var_core_value_sigD4FB) => e.JSONX["compose"](var_core_value_sig7565, var_core_value_sigD4FB), null);
}
function k(var_core_value_sig3D6F) {
  return new Set((var_core_value_sig3D6F.paragraphs ?? []).map(var_core_value_sig3E71 => var_core_value_sig3E71.paragraphId));
}
function _e(var_core_value_sig336C) {
...
function A(var_core_value_sig6E68) {
  return Array.isArray(var_core_value_sig6E68) ? var_core_value_sig6E68.map(var_core_value_sig01B3 => A(var_core_value_sig01B3)) : !var_core_value_sig6E68 || typeof var_core_value_sig6E68 != "object" ? var_core_value_sig6E68 : Object.fromEntries(Object.entries(var_core_value_sig6E68).map(([var_core_value_sig7442, var_core_value_sigDF87]) => [var_core_value_sig7442, A(var_core_value_sigDF87)]));
}
const ve = {
    id: "doc.command.resize-column-group",
    type: e.CommandType["COMMAND"],
    handler: (var_core_value_sig8DFE, var_core_value_sig48EA) => {
      let var_core_value_sig5E16 = w(var_core_value_sig8DFE, var_core_value_sig48EA == null ? undefined : var_core_value_sig48EA.unitId);
      return !var_core_value_sig5E16 || !var_core_value_sig48EA ? false : T(var_core_value_sig5E16, ee(var_core_value_sig5E16.snapshot, var_core_value_sig48EA.columnGroupId, var_core_value_sig48EA.widthRatios), []);
    }
  },
  j = {
    ...
    handler: (var_core_value_sig09F3, var_core_value_sig4592) => {
      let var_core_value_sigC5C4 = w(var_core_value_sig09F3, var_core_value_sig4592 == null ? undefined : var_core_value_sig4592.unitId);
      if (!var_core_value_sigC5C4 || !var_core_value_sig4592) return false;
      let var_core_value_sig1617 = var_core_value_sig4592.columnId ?? (0, e.generateRandomId)(6);
      try {
        let var_core_value_sig9EE0 = te(var_core_value_sigC5C4.snapshot, var_core_value_sig4592.columnGroupId, var_core_value_sig4592.targetColumnId, var_core_value_sig4592.position, var_core_value_sig1617);
        return var_core_value_sig9EE0 ? T(var_core_value_sigC5C4, var_core_value_sig9EE0.actions, [{
  ...
  M = {
    ...
    handler: (var_core_value_sig4169, var_core_value_sig6D19) => {
      let var_core_value_sig279C = w(var_core_value_sig4169, var_core_value_sig6D19 == null ? undefined : var_core_value_sig6D19.unitId);
      if (!var_core_value_sig279C || !var_core_value_sig6D19) return false;
      try {
        let var_core_value_sigF051 = ne(var_core_value_sig279C.snapshot, var_core_value_sig6D19.columnGroupId, var_core_value_sig6D19.columnId);
        return var_core_value_sigF051 ? T(var_core_value_sig279C, var_core_value_sigF051.actions, [{
  ...
  N = {
    ...
    handler: (var_core_value_sigAC51, var_core_value_sig8986) => {
      let var_core_value_sigCAF7 = w(var_core_value_sigAC51, var_core_value_sig8986 == null ? undefined : var_core_value_sig8986.unitId);
      ...
      try {
        ...
        return var_core_value_sig0B45 ? T(var_core_value_sigCAF7, var_core_value_sig0B45.actions, [{
  ...
  P = {
    ...
    handler: (var_core_value_sigED1C, var_core_value_sig726E) => {
      let var_core_value_sig2CD3 = w(var_core_value_sigED1C, var_core_value_sig726E == null ? undefined : var_core_value_sig726E.unitId);
      return var_core_value_sig2CD3 ? T(var_core_value_sig2CD3, oe(var_core_value_sig2CD3.snapshot)) : false;
    }
  },
  F = {
    ...
    handler: (var_core_value_sig038E, var_core_value_sigAA1E) => {
      let var_core_value_sigC9F5 = be(var_core_value_sigAA1E),
        var_core_value_sig7EEA = w(var_core_value_sig038E, var_core_value_sigC9F5.unitId);
      if (!var_core_value_sig7EEA) return false;
      let var_core_value_sig59CE = Ce(var_core_value_sig038E, var_core_value_sig7EEA.unitId, var_core_value_sigC9F5);
      if (typeof var_core_value_sig59CE != "number") return false;
      let var_core_value_sig33C8 = I(var_core_value_sig7EEA.snapshot, var_core_value_sig59CE, {
          snapToParagraphEnd: true
        }),
        var_core_value_sig957F = xe(var_core_value_sigC9F5),
        var_core_value_sig803B = var_core_value_sigC9F5.columnGroupId ?? (0, e.generateRandomId)(6),
        var_core_value_sig5830 = Array.from({
          ...
          return ((var_core_value_sigBB57 = var_core_value_sigC9F5.columnIds) == null ? undefined : var_core_value_sigBB57[var_core_value_sig03E1]) ?? (0, e.generateRandomId)(6);
        });
      try {
        let var_core_value_sig7C4A = ie(var_core_value_sig7EEA.snapshot, {
        ...
        return var_core_value_sig7C4A ? T(var_core_value_sig7EEA, var_core_value_sig7C4A.actions, [{
...
function ye(var_core_value_sig4A7C, var_core_value_sigF975) {
  return !var_core_value_sig4A7C || typeof var_core_value_sigF975 != "number" ? false : f(var_core_value_sig4A7C, I(var_core_value_sig4A7C, var_core_value_sigF975));
}
function I(var_core_value_sigCDAF, var_core_value_sigA298, var_core_value_sig0B40 = {}) {
  ...
  if (Te(var_core_value_sigCDAF, var_core_value_sigA298)) return var_core_value_sigA298 + 1;
  if (!var_core_value_sig0B40.snapToParagraphEnd) return var_core_value_sigA298;
  let var_core_value_sig3625 = [...(var_core_value_sig330B.paragraphs ?? [])].sort((var_core_value_sigE799, var_core_value_sigB601) => var_core_value_sigE799.startIndex - var_core_value_sigB601.startIndex).find(var_core_value_sig8B71 => var_core_value_sigA298 <= var_core_value_sig8B71.startIndex && !De(var_core_value_sig330B.dataStream, var_core_value_sigA298, var_core_value_sig8B71.startIndex));
  return var_core_value_sig3625 ? var_core_value_sig3625.startIndex + 1 : var_core_value_sigA298;
}
function be(var_core_value_sig0B4E) {
...
function xe(var_core_value_sig0E9F) {
  var var_core_value_sigE5BA;
  return var_core_value_sig0E9F.value == null ? var_core_value_sig0E9F.columnCount ?? Math.max(2, ((var_core_value_sigE5BA = var_core_value_sig0E9F.columnIds) == null ? undefined : var_core_value_sigE5BA.length) ?? 2) : Se(var_core_value_sig0E9F.value) ?? 2;
}
function Se(var_core_value_sig4A83) {
...
function Ce(var_core_value_sig84C4, var_core_value_sigB6F7, var_core_value_sigB495) {
  if (typeof var_core_value_sigB495.offset == "number") return var_core_value_sigB495.offset;
  let var_core_value_sig70D0 = (0, t.consumeContentInsertRange)(var_core_value_sig84C4, var_core_value_sigB6F7);
  if (var_core_value_sig70D0) return var_core_value_sig70D0.startOffset;
  let var_core_value_sig2A8A = we(var_core_value_sig84C4);
...
function we(var_core_value_sig3782) {
  try {
    return var_core_value_sig3782.get(t.DocSelectionManagerService).getActiveTextRange() ?? null;
  } catch {
    return null;
  }
}
function Te(var_core_value_sigD22E, var_core_value_sig3455) {
  ...
  return (var_core_value_sig43D5 === e.DataStreamTreeTokenType["TABLE_END"] || var_core_value_sig43D5 === a.COLUMN_GROUP_END || var_core_value_sig43D5 === e.DataStreamTreeTokenType["BLOCK_END"]) && f(var_core_value_sigD22E, var_core_value_sig3455 + 1);
}
const Ee = new Set([e.DataStreamTreeTokenType["BLOCK_START"], e.DataStreamTreeTokenType["BLOCK_END"], a.COLUMN_GROUP_START, a.COLUMN_START, a.COLUMN_END, a.COLUMN_GROUP_END, e.DataStreamTreeTokenType["TABLE_START"], e.DataStreamTreeTokenType["TABLE_ROW_START"], e.DataStreamTreeTokenType["TABLE_CELL_START"], e.DataStreamTreeTokenType["TABLE_CELL_END"], e.DataStreamTreeTokenType["TABLE_ROW_END"], e.DataStreamTreeTokenType["TABLE_END"]]);
function De(var_core_value_sig1395, var_core_value_sig9FA0, var_core_value_sig055E) {
  for (let var_core_value_sigAEFB = var_core_value_sig9FA0; var_core_value_sigAEFB <= var_core_value_sig055E; var_core_value_sigAEFB++) if (Ee.has(var_core_value_sig1395[var_core_value_sigAEFB])) return true;
  return false;
}
function Oe(var_core_value_sig7C77) {
  let var_core_value_sig9578 = c(var_core_value_sig7C77.documentData),
    var_core_value_sigA2D3 = var_core_value_sig9578.body,
    var_core_value_sigC218 = o(var_core_value_sig9578, var_core_value_sig7C77.columnGroupId),
  ...
  Me(var_core_value_sigC218.columns["length"], var_core_value_sigADEC.columns["length"]);
...
function ke(var_core_value_sigFA28, var_core_value_sig93BE) {
...
function Ae(var_core_value_sig2712) {
  return {
    dataStream: "" + a.COLUMN_START + e.DataStreamTreeTokenType["PARAGRAPH"] + e.DataStreamTreeTokenType["SECTION_BREAK"] + a.COLUMN_END,
    paragraphs: [{
      startIndex: 1,
      paragraphId: (0, e.createParagraphId)(var_core_value_sig2712)
    }],
    sectionBreaks: [{
      sectionId: (0, e.createSectionId)(new Set()),
      startIndex: 2
...
function L(var_core_value_sig6F4E, var_core_value_sigA021, var_core_value_sig49D9) {
...
function Ne(var_core_value_sig320C, var_core_value_sigE7F0, var_core_value_sigE837) {
...
function Pe(var_core_value_sig34F4) {
  ...
  let var_core_value_sigCC9E = Math.max(0, ((var_core_value_sigA45D = var_core_value_sig34F4.source["gap"]) == null ? undefined : var_core_value_sigA45D.v) ?? 0),
    ...
    var_core_value_sigE42E = Fe(var_core_value_sig1BC7.map(var_core_value_sigC97C => var_core_value_sigC97C.widthRatio), var_core_value_sig444C),
    ...
    var_core_value_sig9EAB = Le(var_core_value_sigE42E[var_core_value_sigA321] + var_core_value_sig34F4.delta, var_core_value_sig4A08, Math.max(var_core_value_sig4A08, var_core_value_sig3457 - var_core_value_sig1BC4));
...
function Fe(var_core_value_sigA5C3, var_core_value_sig3A1E) {
  let var_core_value_sigDC92 = var_core_value_sigA5C3.reduce((var_core_value_sigE43E, var_core_value_sigA937) => var_core_value_sigE43E + Ie(var_core_value_sigA937), 0) || var_core_value_sigA5C3.length;
  return var_core_value_sigA5C3.map(var_core_value_sigCAD5 => var_core_value_sig3A1E * Ie(var_core_value_sigCAD5) / var_core_value_sigDC92);
}
function Ie(var_core_value_sig3515) {
  return Math.max(0, var_core_value_sig3515 || 0) || 1;
}
function Le(var_core_value_sigC2A0, var_core_value_sig7C65, var_core_value_sig7F05) {
  return Math.min(var_core_value_sig7F05, Math.max(var_core_value_sig7C65, var_core_value_sigC2A0));
}
function Re(var_core_value_sig41F3, var_core_value_sigF455, var_core_value_sig6E78) {
  let {
  ...
  var_core_value_sig41F3.forEach((var_core_value_sigE503, var_core_value_sig48DD) => {
    ...
    R(var_core_value_sigE503, {
      pageIndex: var_core_value_sig48DD,
      pageLeft: var_core_value_sig9CD9,
      pageTop: var_core_value_sigB7FC,
      source: "page",
      getBounds: (var_core_value_sigF230, var_core_value_sig09B8, var_core_value_sig6F91) => He(var_core_value_sigF230, var_core_value_sig09B8, var_core_value_sig6F91.columns["length"], var_core_value_sig9CD9)
      ...
      Be(var_core_value_sigF9C7, var_core_value_sig8895, var_core_value_sig48DD, var_core_value_sig9CD9, var_core_value_sigB7FC, var_core_value_sigB3EE, var_core_value_sig11D0, var_core_value_sigB8ED, var_core_value_sig6E78);
    }), Ve(var_core_value_sigE503, var_core_value_sig9CD9, var_core_value_sigB7FC, (var_core_value_sigC80B, var_core_value_sig284F, var_core_value_sigE154, var_core_value_sig4632) => {
      var var_core_value_sig12F2;
      R(var_core_value_sigC80B, {
        pageIndex: var_core_value_sig48DD,
        pageLeft: var_core_value_sig284F,
        pageTop: var_core_value_sigE154,
        source: "column",
        getBounds: (var_core_value_sig2AD8, var_core_value_sig2AD0) => ({
          lineWidth: Math.max(B(var_core_value_sig2AD0.width), var_core_value_sig4632 - var_core_value_sig2AD0.left),
          visualLeft: var_core_value_sig284F + var_core_value_sig2AD0.left,
          visualWidth: Math.max(B(var_core_value_sig2AD0.width), var_core_value_sig4632 - var_core_value_sig2AD0.left)
        })
        ...
        Be(var_core_value_sig3EEE, var_core_value_sigBC46, var_core_value_sig48DD, var_core_value_sig284F, var_core_value_sigE154, var_core_value_sigB3EE, var_core_value_sig11D0, var_core_value_sigB8ED, var_core_value_sig6E78);
      });
    });
  });
}
function ze(var_core_value_sig8EAE, var_core_value_sig1CDD = {}) {
  let {
  ...
  return var_core_value_sig8EAE.forEach((var_core_value_sigFD0C, var_core_value_sig849B) => {
    ...
    var_core_value_sig4313 != null && z({
      ...
      tableCellInsetX: var_core_value_sig81AE,
      unitId: var_core_value_sigF79F
    }), Ve(var_core_value_sigFD0C, var_core_value_sigC6E5, var_core_value_sig5241, (var_core_value_sig2259, var_core_value_sig9E2F, var_core_value_sigD082) => {
      z({
        contexts: var_core_value_sig0E54,
        docsLeft: var_core_value_sigCC17,
...
function Be(var_core_value_sig3B17, var_core_value_sig6C4A, var_core_value_sig73D9, var_core_value_sigEAF8, var_core_value_sig0455, var_core_value_sig737C, var_core_value_sig5AF5, var_core_value_sig9DE4, var_core_value_sig77FA) {
  let var_core_value_sigA4A7 = (0, n.getDocsTableRenderViewport)(var_core_value_sig9DE4, Ge(var_core_value_sig3B17.tableId ?? var_core_value_sig6C4A)),
    var_core_value_sigA4DF = We(var_core_value_sigA4A7),
    var_core_value_sigCC9D = V(var_core_value_sigEAF8, var_core_value_sig3B17.left, var_core_value_sigA4A7, var_core_value_sig737C),
  ...
  var_core_value_sig3B17.rows["forEach"](var_core_value_sigFC87 => {
    var_core_value_sigFC87.cells["forEach"](var_core_value_sigDBB7 => {
      ...
      var_core_value_sig5237 <= 0 || Math.min(var_core_value_sig861B, var_core_value_sig7E54) <= Math.max(var_core_value_sigEFD4, var_core_value_sigBB00) || R(var_core_value_sigDBB7, {
...
function R(var_core_value_sigC7E7, var_core_value_sig6E1C, var_core_value_sigFABC) {
    ...
    var_core_value_sig156F.columns["forEach"](var_core_value_sig9A8D => {
      var_core_value_sig9A8D.lines["forEach"](var_core_value_sig3D7D => {
        ...
        var_core_value_sigFABC({
          ...
          lineWidth: (var_core_value_sig8061 == null ? undefined : var_core_value_sig8061.lineWidth) ?? (var_core_value_sig8061 == null ? undefined : var_core_value_sig8061.visualWidth) ?? B(var_core_value_sig9A8D.width),
...
function z(var_core_value_sig413D) {
  ...
  (var_core_value_sig5BCE = var_core_value_sig4CEF.skeTables) == null || var_core_value_sig5BCE.forEach((var_core_value_sigDD51, var_core_value_sigF057) => {
    let var_core_value_sig72F6 = var_core_value_sigDD51.tableId ?? var_core_value_sigF057,
      ...
      var_core_value_sigA2CE = Ge(var_core_value_sig72F6),
      var_core_value_sig1975 = var_core_value_sigC39E ? (0, n.getDocsTableRenderViewport)(var_core_value_sig77D8, var_core_value_sigA2CE) : null,
      var_core_value_sig6EA1 = We(var_core_value_sig1975),
      var_core_value_sig029F = V(var_core_value_sig2CC7, var_core_value_sigDD51.left, var_core_value_sig1975, var_core_value_sig78AC),
...
function Ve(var_core_value_sig78A3, var_core_value_sig649B, var_core_value_sig6256, var_core_value_sigE7A6) {
...
function He(var_core_value_sig7428, var_core_value_sig1DCE, var_core_value_sig0567, var_core_value_sigA7F3) {
...
function We(var_core_value_sig5EEE) {
  return var_core_value_sig5EEE != null && Ue(var_core_value_sig5EEE) > var_core_value_sig5EEE.viewportWidth;
}
function V(var_core_value_sig65B4, var_core_value_sigF98E, var_core_value_sigA470, var_core_value_sig19A1) {
...
function Ge(var_core_value_sigBE51) {
  return var_core_value_sigBE51.includes("#-#") ? var_core_value_sigBE51.split("#-#")[0] : var_core_value_sigBE51;
}
function Ke(var_core_value_sigAAD1) {
  let var_core_value_sigBC1A = c(var_core_value_sigAAD1),
  ...
  let var_core_value_sigA984 = qe(var_core_value_sigBC1A);
  var_core_value_sigA984 = Je(var_core_value_sigBC1A) || var_core_value_sigA984;
  let var_core_value_sigA504 = var_core_value_sig3F3A.columnGroups ?? [];
  if (var_core_value_sigA504.length === 0) return var_core_value_sigA984 = tt(var_core_value_sigBC1A) || var_core_value_sigA984, {
    nextDocumentData: var_core_value_sigBC1A,
    changed: var_core_value_sigA984
  };
  for (let var_core_value_sig7664 of var_core_value_sigA504) var_core_value_sigA984 = nt(var_core_value_sig7664, var_core_value_sig3F3A.dataStream) || var_core_value_sigA984;
  return var_core_value_sigA984 = tt(var_core_value_sigBC1A) || var_core_value_sigA984, {
    nextDocumentData: var_core_value_sigBC1A,
    changed: var_core_value_sigA984
  };
}
function qe(var_core_value_sig05FF) {
  let var_core_value_sigFBF0 = var_core_value_sig05FF.body,
    var_core_value_sig2F95 = Ye((var_core_value_sigFBF0 == null ? undefined : var_core_value_sigFBF0.columnGroups) ?? []);
  return !(var_core_value_sigFBF0 != null && var_core_value_sigFBF0.dataStream) || var_core_value_sig2F95.length === 0 ? false : (var_core_value_sig2F95.sort((var_core_value_sig2281, var_core_value_sig5E86) => var_core_value_sig5E86.startIndex - var_core_value_sig2281.startIndex).forEach(var_core_value_sig6998 => Xe(var_core_value_sig05FF, var_core_value_sig6998)), true);
}
function Je(var_core_value_sigF0E1) {
  ...
  let var_core_value_sigF449 = var_core_value_sigE5A6.filter(var_core_value_sigF639 => st(var_core_value_sig2D8D.dataStream, var_core_value_sigF639.startIndex, var_core_value_sigF639.endIndex));
  return var_core_value_sigF449.length === 0 ? false : (var_core_value_sigF449.sort((var_core_value_sigEAE5, var_core_value_sigE94C) => var_core_value_sigE94C.startIndex - var_core_value_sigEAE5.startIndex).forEach(var_core_value_sig6D47 => Ze(var_core_value_sigF0E1, var_core_value_sig6D47)), true);
}
function Ye(var_core_value_sig38C5) {
...
function Xe(var_core_value_sigC87D, var_core_value_sigCCDC) {
  Ze(var_core_value_sigC87D, var_core_value_sigCCDC);
}
function Ze(var_core_value_sigC310, var_core_value_sigA4E8) {
  let var_core_value_sigDC07 = var_core_value_sigC310.body,
    var_core_value_sig3474 = (0, e.getColumnGroupRangeInterval)(var_core_value_sigA4E8).endOffset,
    var_core_value_sig4E80 = Qe(var_core_value_sigDC07.dataStream, var_core_value_sigA4E8.startIndex, var_core_value_sig3474);
  var_core_value_sigDC07.dataStream = $e(var_core_value_sigDC07.dataStream, var_core_value_sig4E80), var_core_value_sigDC07.paragraphs = H(var_core_value_sigDC07.paragraphs ?? [], var_core_value_sig4E80), var_core_value_sigDC07.sectionBreaks = H(var_core_value_sigDC07.sectionBreaks ?? [], var_core_value_sig4E80), var_core_value_sigDC07.customBlocks = H(var_core_value_sigDC07.customBlocks ?? [], var_core_value_sig4E80), var_core_value_sigDC07.blockRanges = U(var_core_value_sigDC07.blockRanges ?? [], var_core_value_sig4E80), var_core_value_sigDC07.customRanges = U(var_core_value_sigDC07.customRanges ?? [], var_core_value_sig4E80), var_core_value_sigDC07.customDecorations = U(var_core_value_sigDC07.customDecorations ?? [], var_core_value_sig4E80), var_core_value_sigDC07.tables = U(var_core_value_sigDC07.tables ?? [], var_core_value_sig4E80), var_core_value_sigDC07.columnGroups = U((var_core_value_sigDC07.columnGroups ?? []).filter(var_core_value_sigCF4E => var_core_value_sigCF4E.columnGroupId !== var_core_value_sigA4E8.columnGroupId), var_core_value_sig4E80), var_core_value_sigDC07.textRuns = et(var_core_value_sigDC07.textRuns ?? [], var_core_value_sig4E80);
}
function Qe(var_core_value_sigD23B, var_core_value_sig2B2A, var_core_value_sig0B5C) {
  let var_core_value_sig7D42 = new Set([a.COLUMN_GROUP_START, a.COLUMN_START, a.COLUMN_END, a.COLUMN_GROUP_END]),
...
function $e(var_core_value_sig78E6, var_core_value_sig541F) {
...
function tt(var_core_value_sigF32D) {
  let var_core_value_sig9427 = var_core_value_sigF32D.body;
  return !var_core_value_sig9427 || var_core_value_sig9427.dataStream["length"] > 0 ? false : (var_core_value_sig9427.dataStream = "" + e.DataStreamTreeTokenType["PARAGRAPH"] + e.DataStreamTreeTokenType["SECTION_BREAK"], var_core_value_sig9427.paragraphs = [{
    startIndex: 0,
    paragraphId: (0, e.createParagraphId)(new Set((var_core_value_sig9427.paragraphs ?? []).map(var_core_value_sig38CE => var_core_value_sig38CE.paragraphId)))
  }], var_core_value_sig9427.sectionBreaks = [{
    sectionId: (0, e.createSectionId)(new Set()),
    startIndex: 1
  }], true);
}
function nt(var_core_value_sig21F4, var_core_value_sigA345) {
  var var_core_value_sigA468;
  let var_core_value_sig1561 = ot(var_core_value_sigA345, var_core_value_sig21F4.startIndex, var_core_value_sig21F4.endIndex);
  if (var_core_value_sig1561 === 0) return false;
  let var_core_value_sigDF14 = rt(var_core_value_sig21F4.columnGroupId, var_core_value_sig21F4.columns ?? [], var_core_value_sig1561),
    var_core_value_sig842F = at(var_core_value_sig21F4.gap),
    var_core_value_sigC4C0 = !ct(var_core_value_sig21F4.columns ?? [], var_core_value_sigDF14),
...
function at(var_core_value_sig0FD9) {
...
function ot(var_core_value_sig5649, var_core_value_sigAF82, var_core_value_sig21A2) {
  let var_core_value_sig5C1D = (0, e.getColumnGroupRangeInterval)({
      startIndex: var_core_value_sigAF82,
      endIndex: var_core_value_sig21A2
    }).endOffset,
    var_core_value_sig4CBA = 0;
  for (let var_core_value_sig7A3C = var_core_value_sigAF82; var_core_value_sig7A3C < var_core_value_sig5C1D; var_core_value_sig7A3C++) var_core_value_sig5649[var_core_value_sig7A3C] === a.COLUMN_START && var_core_value_sig4CBA++;
  return var_core_value_sig4CBA;
}
function st(var_core_value_sig8E65, var_core_value_sig772C, var_core_value_sigF309) {
  if (var_core_value_sig8E65[var_core_value_sig772C] !== a.COLUMN_GROUP_START || var_core_value_sig8E65[var_core_value_sigF309] !== a.COLUMN_GROUP_END) return true;
  let var_core_value_sig44F9 = (0, e.getColumnGroupRangeInterval)({
...
function ct(var_core_value_sigCB92, var_core_value_sigC844) {
  return var_core_value_sigCB92.length === var_core_value_sigC844.length && var_core_value_sigCB92.every((var_core_value_sig1F44, var_core_value_sigCB04) => {
    ...
    return var_core_value_sig1F44.columnId === var_core_value_sig947E.columnId && var_core_value_sig1F44.widthRatio === var_core_value_sig947E.widthRatio && e.Tools["diffValue"](var_core_value_sig1F44.minWidth, var_core_value_sig947E.minWidth);
  });
}
function lt(var_core_value_sig2ED4, var_core_value_sig0477 = {}) {
  var var_core_value_sig6FDF;
  let var_core_value_sig27C4 = Ke(var_core_value_sig2ED4).nextDocumentData,
    var_core_value_sig3E1A = c(var_core_value_sig27C4),
  ...
  if (!var_core_value_sig7FB0 || !var_core_value_sig5215 || !ut(var_core_value_sig7FB0.dataStream, var_core_value_sig5215.dataStream, var_core_value_sig5204)) return {
  ...
  let var_core_value_sig5E11 = {},
    ...
    var_core_value_sig2DBD = dt(var_core_value_sig5215.dataStream, var_core_value_sig5204),
    var_core_value_sig424E = var_core_value_sig5204.map(var_core_value_sig2E54 => {
      let var_core_value_sig7658 = _t(var_core_value_sig2E54.columnGroupId, var_core_value_sig4D58, var_core_value_sig0477.tableIdFactory);
      return var_core_value_sig5E11[var_core_value_sig2E54.columnGroupId] = var_core_value_sig7658, {
        startIndex: K(var_core_value_sig2E54.startIndex, var_core_value_sig5204),
        endIndex: K(G(var_core_value_sig2E54), var_core_value_sig5204),
        tableId: var_core_value_sig7658
      };
    });
  return var_core_value_sig7FB0.dataStream = var_core_value_sig2DBD, var_core_value_sig7FB0.paragraphs = q(var_core_value_sig7FB0.paragraphs ?? [], var_core_value_sig5204), var_core_value_sig7FB0.sectionBreaks = q(var_core_value_sig7FB0.sectionBreaks ?? [], var_core_value_sig5204), var_core_value_sig7FB0.customBlocks = q(var_core_value_sig7FB0.customBlocks ?? [], var_core_value_sig5204), var_core_value_sig7FB0.textRuns = bt(var_core_value_sig7FB0.textRuns ?? [], var_core_value_sig5204), var_core_value_sig7FB0.blockRanges = J(var_core_value_sig7FB0.blockRanges ?? [], var_core_value_sig5204), var_core_value_sig7FB0.customRanges = J(var_core_value_sig7FB0.customRanges ?? [], var_core_value_sig5204), var_core_value_sig7FB0.customDecorations = J(var_core_value_sig7FB0.customDecorations ?? [], var_core_value_sig5204), var_core_value_sig7FB0.tables = [...J(var_core_value_sig7FB0.tables ?? [], var_core_value_sig5204), ...var_core_value_sig424E].sort((var_core_value_sigDCF5, var_core_value_sigC786) => var_core_value_sigDCF5.startIndex - var_core_value_sigC786.startIndex), var_core_value_sig7FB0.columnGroups = [], var_core_value_sig3E1A.tableSource = {
    ...var_core_value_sig3E1A.tableSource,
    ...Object.fromEntries(var_core_value_sig5204.map(var_core_value_sigC0D9 => [var_core_value_sig5E11[var_core_value_sigC0D9.columnGroupId], pt(var_core_value_sig27C4, var_core_value_sigC0D9, var_core_value_sig5E11[var_core_value_sigC0D9.columnGroupId])]))
  }, {
    nextDocumentData: var_core_value_sig3E1A,
    tableIdsByColumnGroupId: var_core_value_sig5E11
  };
}
function ut(var_core_value_sigF481, var_core_value_sigD7F2, var_core_value_sig7CF3) {
  return !!(var_core_value_sigF481 && var_core_value_sigD7F2 && var_core_value_sig7CF3.length > 0);
}
function dt(var_core_value_sig9DC6, var_core_value_sig6643) {
  let var_core_value_sig4124 = 0,
    var_core_value_sigBF1C = "";
  return var_core_value_sig6643.forEach(var_core_value_sigF0511 => {
    var_core_value_sigBF1C += var_core_value_sig9DC6.slice(var_core_value_sig4124, var_core_value_sigF0511.startIndex), var_core_value_sigBF1C += ft(var_core_value_sig9DC6, var_core_value_sigF0511), var_core_value_sig4124 = G(var_core_value_sigF0511);
  }), var_core_value_sigBF1C + var_core_value_sig9DC6.slice(var_core_value_sig4124);
}
function ft(var_core_value_sigEEEF, var_core_value_sig9A01) {
  let var_core_value_sig674F = {
    ...
    var_core_value_sig8A26 = G(var_core_value_sig9A01);
...
function G(var_core_value_sigD073) {
  return (0, e.getColumnGroupRangeInterval)(var_core_value_sigD073).endOffset;
}
function pt(var_core_value_sigF631, var_core_value_sig2278, var_core_value_sig7053) {
  var var_core_value_sig52F1;
  let var_core_value_sig1E74 = var_core_value_sig2278.columns ?? [],
    var_core_value_sig1E84 = Math.max(1, var_core_value_sig1E74.length, vt(((var_core_value_sig52F1 = var_core_value_sigF631.body) == null ? undefined : var_core_value_sig52F1.dataStream) ?? "", var_core_value_sig2278)),
    var_core_value_sig133B = yt(var_core_value_sigF631),
    var_core_value_sig69B8 = Array.from({
      ...
      return mt((var_core_value_sig548A = var_core_value_sig1E74[var_core_value_sig73AF]) == null ? undefined : var_core_value_sig548A.widthRatio);
    }),
    ...
    var_core_value_sig9A03 = Array.from({
      ...
      return gt(var_core_value_sig133B * var_core_value_sigE1B0 / var_core_value_sig983D);
    });
  return {
    tableRows: [{
      ...
      trHeight: {
        ...
        hRule: e.TableRowHeightRule["AUTO"]
      }
    }],
    ...
    size: {
      type: e.TableSizeType["UNSPECIFIED"],
      width: {
...
function mt(var_core_value_sig3363) {
...
function gt(var_core_value_sigF64A) {
  return {
    size: {
...
function _t(var_core_value_sig25EC, var_core_value_sigA790, var_core_value_sig9A5E) {
...
function vt(var_core_value_sigCF96, var_core_value_sigC4E9) {
  let var_core_value_sigF612 = 0;
  for (let var_core_value_sigD4FF = var_core_value_sigC4E9.startIndex; var_core_value_sigD4FF < var_core_value_sigC4E9.endIndex; var_core_value_sigD4FF++) var_core_value_sigCF96[var_core_value_sigD4FF] === a.COLUMN_START && var_core_value_sigF612++;
  return var_core_value_sigF612;
}
function yt(var_core_value_sigAA6C) {
...
function K(var_core_value_sig31A8, var_core_value_sigA4DA) {
...
function q(var_core_value_sig6FC0, var_core_value_sig6217) {
  return var_core_value_sig6FC0.map(var_core_value_sig1F64 => ({
    ...var_core_value_sig1F64,
    startIndex: K(var_core_value_sig1F64.startIndex, var_core_value_sig6217)
  }));
}
function J(var_core_value_sigB805, var_core_value_sig4FAE) {
  return var_core_value_sigB805.map(var_core_value_sigDD1C => ({
    ...var_core_value_sigDD1C,
    startIndex: K(var_core_value_sigDD1C.startIndex, var_core_value_sig4FAE),
    endIndex: K(var_core_value_sigDD1C.endIndex, var_core_value_sig4FAE)
  }));
}
function bt(var_core_value_sig1FCC, var_core_value_sigB7F9) {
  return var_core_value_sig1FCC.map(var_core_value_sig2C39 => ({
    ...var_core_value_sig2C39,
    st: K(var_core_value_sig2C39.st, var_core_value_sigB7F9),
    ed: K(var_core_value_sig2C39.ed, var_core_value_sigB7F9)
  }));
}
const xt = new Set([a.COLUMN_GROUP_START, a.COLUMN_START, a.COLUMN_END, a.COLUMN_GROUP_END]);
function St(var_core_value_sigB1A2, var_core_value_sig526D) {
...
function Ct(var_core_value_sigBDB5, var_core_value_sig59CE1) {
  ...
  return var_core_value_sig04E4 != null && xt.has(var_core_value_sig04E4);
}
function wt(var_core_value_sigD8F0, var_core_value_sig1475, var_core_value_sig08B7) {
  return Tt(var_core_value_sigD8F0, var_core_value_sig08B7) != null && !Et(var_core_value_sigD8F0, var_core_value_sig1475);
}
function Tt(var_core_value_sig2008, var_core_value_sig496B) {
  ...
  for (let var_core_value_sig64F0 of var_core_value_sig2AB8) {
    let var_core_value_sigA942 = o(var_core_value_sig2008, var_core_value_sig64F0.columnGroupId);
    if (var_core_value_sigA942 && St(var_core_value_sigA942, var_core_value_sig496B)) return var_core_value_sigA942;
  }
  return null;
}
function Et(var_core_value_sig3FCF, var_core_value_sig675A) {
  ...
  for (let var_core_value_sig85B1 = var_core_value_sigBF78; var_core_value_sig85B1 <= var_core_value_sig8AF3; var_core_value_sig85B1++) if (Ct(var_core_value_sig3FCF, var_core_value_sig85B1)) return true;
  return (((var_core_value_sig9D6E = var_core_value_sig3FCF.body) == null ? undefined : var_core_value_sig9D6E.columnGroups) ?? []).some(var_core_value_sig3141 => Dt(var_core_value_sigBF78, var_core_value_sig8AF3, var_core_value_sig3141.startIndex, var_core_value_sig3141.endIndex));
}
function Dt(var_core_value_sigA0CC, var_core_value_sigB3A1, var_core_value_sig1FB9, var_core_value_sig53A9) {
  return var_core_value_sigA0CC <= var_core_value_sig1FB9 && var_core_value_sigB3A1 >= var_core_value_sig53A9;
}
function Ot(var_core_value_sigDACD) {
  let var_core_value_sig691E = c(var_core_value_sigDACD.documentData),
  ...
  let var_core_value_sig0347 = kt(var_core_value_sig691E);
  ...
  return var_core_value_sig0347.forEach(var_core_value_sig2EAD => {
    let var_core_value_sig6774 = var_core_value_sig2EAD + var_core_value_sigF64E,
      var_core_value_sig340D = jt(var_core_value_sig52A3);
    Mt(var_core_value_sigD6D6, var_core_value_sig6774, var_core_value_sig340D), var_core_value_sigAD91 = Nt(var_core_value_sigAD91, var_core_value_sig6774, var_core_value_sig340D.dataStream["length"]), var_core_value_sigF64E += var_core_value_sig340D.dataStream["length"];
  }), {
    nextDocumentData: var_core_value_sig691E,
...
function kt(var_core_value_sig9B3D) {
  ...
  for (let var_core_value_sig82D4 of (var_core_value_sigB217 == null ? undefined : var_core_value_sigB217.columnGroups) ?? []) {
    let var_core_value_sigA621 = o(var_core_value_sig9B3D, var_core_value_sig82D4.columnGroupId);
    var_core_value_sigA621 && var_core_value_sigA621.columns["forEach"](var_core_value_sigD955 => {
      At(var_core_value_sigB217, var_core_value_sigD955.startOffset, var_core_value_sigD955.endOffset) || var_core_value_sig1FE6.push(var_core_value_sigD955.endOffset);
    });
  }
...
function At(var_core_value_sig2471, var_core_value_sigD1FC, var_core_value_sigE2F9) {
...
function jt(var_core_value_sigD689) {
  let var_core_value_sig7AE3 = (0, e.createParagraphId)(var_core_value_sigD689);
...
function Mt(var_core_value_sig1EB3, var_core_value_sigE120, var_core_value_sigD6E7) {
  let var_core_value_sig3669 = var_core_value_sigD6E7.dataStream["length"];
  var_core_value_sig1EB3.dataStream = "" + var_core_value_sig1EB3.dataStream["slice"](0, var_core_value_sigE120) + var_core_value_sigD6E7.dataStream + var_core_value_sig1EB3.dataStream["slice"](var_core_value_sigE120), var_core_value_sig1EB3.paragraphs = [...Y(var_core_value_sig1EB3.paragraphs ?? [], var_core_value_sigE120, var_core_value_sig3669), ...var_core_value_sigD6E7.paragraphs["map"](var_core_value_sig0B0C => ({
    ...var_core_value_sig0B0C,
    startIndex: var_core_value_sig0B0C.startIndex + var_core_value_sigE120
  }))].sort((var_core_value_sigA39E, var_core_value_sigBBEE) => var_core_value_sigA39E.startIndex - var_core_value_sigBBEE.startIndex), var_core_value_sig1EB3.sectionBreaks = [...Y(var_core_value_sig1EB3.sectionBreaks ?? [], var_core_value_sigE120, var_core_value_sig3669), ...var_core_value_sigD6E7.sectionBreaks["map"](var_core_value_sig011D => ({
    ...var_core_value_sig011D,
    startIndex: var_core_value_sig011D.startIndex + var_core_value_sigE120
  }))].sort((var_core_value_sig6167, var_core_value_sig65A1) => var_core_value_sig6167.startIndex - var_core_value_sig65A1.startIndex), var_core_value_sig1EB3.textRuns = Pt(var_core_value_sig1EB3.textRuns ?? [], var_core_value_sigE120, var_core_value_sig3669), var_core_value_sig1EB3.customBlocks = Y(var_core_value_sig1EB3.customBlocks ?? [], var_core_value_sigE120, var_core_value_sig3669), var_core_value_sig1EB3.blockRanges = (var_core_value_sig1EB3.blockRanges ?? []).map(var_core_value_sig7F19 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig7F19, var_core_value_sigE120, var_core_value_sig3669)), var_core_value_sig1EB3.customRanges = (var_core_value_sig1EB3.customRanges ?? []).map(var_core_value_sig7827 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig7827, var_core_value_sigE120, var_core_value_sig3669)), var_core_value_sig1EB3.customDecorations = (var_core_value_sig1EB3.customDecorations ?? []).map(var_core_value_sig652C => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig652C, var_core_value_sigE120, var_core_value_sig3669)), var_core_value_sig1EB3.tables = (var_core_value_sig1EB3.tables ?? []).map(var_core_value_sig7E32 => (0, e.shiftExclusiveRangeOnInsert)(var_core_value_sig7E32, var_core_value_sigE120, var_core_value_sig3669)), var_core_value_sig1EB3.columnGroups = (var_core_value_sig1EB3.columnGroups ?? []).map(var_core_value_sig4C07 => (0, e.shiftInclusiveRangeOnInsert)(var_core_value_sig4C07, var_core_value_sigE120, var_core_value_sig3669));
}
function Nt(var_core_value_sig5CBC, var_core_value_sig20BE, var_core_value_sig6BD0) {
...
function Y(var_core_value_sig8C15, var_core_value_sig6DF7, var_core_value_sigB411) {
...
function Pt(var_core_value_sigA81B, var_core_value_sigFE8D, var_core_value_sig8595) {
...
const Lt = {};
function X(var_core_value_sigF8DE, var_core_value_sigFE76) {
...
function Rt(var_core_value_sig84C8, var_core_value_sig80C0, var_core_value_sig22B4, var_core_value_sigBB37) {
...
function zt(var_core_value_sig759E, var_core_value_sig6C80) {
...
function Bt(var_core_value_sig41AD) {
  var var_core_value_sigDBC2 = zt(var_core_value_sig41AD, "string");
...
function Q(var_core_value_sig7739, var_core_value_sig4040, var_core_value_sig1AAA) {
  return (var_core_value_sig4040 = Bt(var_core_value_sig4040)) in var_core_value_sig7739 ? Object.defineProperty(var_core_value_sig7739, var_core_value_sig4040, {
...
let $ = class extends e.Plugin {
  constructor(var_core_value_sigACC6 = Lt, var_core_value_sig1614, var_core_value_sig85C3, var_core_value_sigB996) {
    ...
    } = (0, e.merge)({}, Lt, this._config);
    this._configService["setConfig"]("docs-column.config", var_core_value_sig4BBA);
  }
  onStarting() {
    [F, j, M, N, ve, P].forEach(var_core_value_sigBBFF => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sigBBFF)));
  }
};
Q($, "pluginName", "DOCS_COLUMN_PLUGIN"), Q($, "packageName", Ft), Q($, "version", It), Q($, "type", e.UniverInstanceType["UNIVER_DOC"]), $ = Rt([(0, e.DependentOn)(r.UniverLicensePlugin, t.UniverDocsPlugin), X(1, (0, e.Inject)(e.Injector)), X(2, e.IConfigService), X(3, e.ICommandService)], $), exports.AddDocColumnCommand = j, exports.ColumnDataStreamTreeTokenType = a, exports.ColumnPosition = i, exports.DOCS_COLUMN_MAX_COLUMN_COUNT = 5, exports.DeleteDocColumnCommand = M, exports.DeleteDocColumnGroupCommand = N, exports.InsertDocColumnGroupCommand = F, exports.NormalizeDocColumnGroupCommand = P, exports.ResizeDocColumnGroupCommand = ve, Object.defineProperty(exports, "UniverDocsColumnPlugin", {
  enumerable: true,
  get: function () {
    return $;
  }
}), exports.buildInsertColumnActions = Oe, exports.buildInsertColumnGroupActions = p, exports.calculateResizeDragWidthRatios = Pe, exports.canMoveRangeToColumnContent = wt, exports.canResolveDocsColumnInsertOffset = ye, exports.documentSkeletonLineIterator = Re, exports.documentSkeletonTableIterator = ze, exports.downgradeColumnGroupsToTables = lt, exports.getColumnGroupRangeById = o, exports.isColumnStructuralOffset = Ct, exports.isOffsetInsideColumnContent = St, exports.normalizeDocsColumnInsertOffset = I, exports.normalizeEmptyColumnsAfterMove = Ot;
