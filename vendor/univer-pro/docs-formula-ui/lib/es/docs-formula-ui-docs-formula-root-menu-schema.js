...
function yt(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46478) {
  return {
    ...
    hidden$: getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46478, UniverInstanceType.UNIVER_DOC),
    disabled$: disableMenuWhenHeaderFooterEditing(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46478)
  };
}
const G = {
