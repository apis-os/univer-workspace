...
var Z = class extends Disposable {
  constructor(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46305) {
    super(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46305), k(this, "_presentedRanges", new Map());
  }
  markPresented(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46307, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46308, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46309) {
    let var_L0_core_endo_itemsMap_pure_O1_zalloc_nothrow_sig6B59 = this._presentedRanges["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46307) ?? new Map();
    var_L0_core_endo_itemsMap_pure_O1_zalloc_nothrow_sig6B59.set(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46308, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46309 ? {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46309,
      rangeId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46308
    } : undefined), this._presentedRanges["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46307, var_L0_core_endo_itemsMap_pure_O1_zalloc_nothrow_sig6B59);
  }
  clearUnit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46313) {
    this._presentedRanges["delete"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46313);
  }
  getPresentedCount(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46315) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46316;
    return ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46316 = this._presentedRanges["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46315)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46316.size) ?? 0;
  }
  getPresentedRects(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46319) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46320;
    return [...(((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46320 = this._presentedRanges["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46319)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46320.values()) ?? [])].filter(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4650 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4650 !== undefined);
  }
  dispose() {
    this._presentedRanges["clear"](), super.dispose();
  }
};
export { Z as DocsLatexPresentationService };
