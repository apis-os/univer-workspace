import { DOCS_LATEX_CUSTOM_RANGE_KIND as var_core_value_sig6418, DocsLatexModel as var_core_value_sig1896, InsertDocsLatexFormulaCommand as var_core_value_sig0285, RemoveDocsLatexFormulaCommand as var_core_value_sig777D, ReplaceDocsLatexFormulaWithTextCommand as var_core_value_sig3F4C, UpdateDocsLatexFormulaCommand as var_core_value_sigD65A, getFormulaLatexFromRange as var_core_value_sig5A13, isDocsLatexFormulaRange as var_core_value_sigF593, normalizeDocsLatexFormulaConfig as var_core_value_sig3607 } from "@univerjs-pro/docs-latex";
import { CustomRangeType as var_core_value_sigB512, ICommandService as var_core_value_sigF2E6, Inject as var_core_value_sig34C8, RichTextBuilder as var_core_value_sigB744, RichTextValue as var_core_value_sigEAE2, generateRandomId as var_core_value_sigE68A, getParagraphContentStartOffset as var_core_value_sig3E68 } from "@univerjs/core";
import { FDocument as var_core_value_sigF4C5, FDocumentParagraph as var_core_value_sig5410, FDocumentTextRange as var_core_value_sig492F } from "@univerjs/docs/facade";
function y(var_core_value_sigCE71) {
  "@babel/helpers - typeof";

  return y = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig4D4C) {
  ...
  }, y(var_core_value_sigCE71);
}
function b(var_core_value_sig21D8, var_core_value_sig2B65) {
  if (y(var_core_value_sig21D8) != "object" || !var_core_value_sig21D8) return var_core_value_sig21D8;
  ...
  if (var_core_value_sigD7EA !== undefined) {
    ...
    if (y(var_core_value_sigB33B) != "object") return var_core_value_sigB33B;
...
function x(var_core_value_sig24B9) {
  var var_core_value_sigE627 = b(var_core_value_sig24B9, "string");
  return y(var_core_value_sigE627) == "symbol" ? var_core_value_sigE627 : var_core_value_sigE627 + "";
}
function S(var_core_value_sigEF3E, var_core_value_sig273D, var_core_value_sig9A0D) {
  return (var_core_value_sig273D = x(var_core_value_sig273D)) in var_core_value_sigEF3E ? Object.defineProperty(var_core_value_sigEF3E, var_core_value_sig273D, {
...
function C(var_core_value_sigA319, var_core_value_sig2D58) {
...
function w(var_core_value_sig223F, var_core_value_sigD749, var_core_value_sigCFFA, var_core_value_sig58C1) {
...
let T = class {
  constructor(var_core_value_sigF602, var_core_value_sig1BBD, var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sig0D69) {
    this._document = var_core_value_sigF602, this._rangeId = var_core_value_sig1BBD, this._segmentId = var_core_value_sigF704, this._commandService = var_core_value_sig2BCF, this._model = var_core_value_sig0D69, S(this, "_unitId", undefined), this._unitId = this._document["getId"]();
  }
  getId() {
  ...
  getLatex() {
    ...
    return var_core_value_sig26DB ? var_core_value_sig5A13(var_core_value_sig26DB, var_core_value_sigF0F9) : "";
  }
  getConfig() {
    return {
      ...var_core_value_sig3607(this._model["getFormula"](this._unitId, this._rangeId)),
      latex: this.getLatex()
    };
  }
  describe() {
    ...
    let var_core_value_sigFBA4 = this._getContainingParagraph(),
      ...
      var_core_value_sig186C = var_core_value_sigFBA4 ? var_core_value_sig3E68(var_core_value_sig4383, var_core_value_sigFBA4) : var_core_value_sig1A0F.startOffset,
  ...
  update(var_core_value_sig48BD) {
    return this._commandService["syncExecuteCommand"](var_core_value_sigD65A.id, {
  ...
  remove() {
    return this._commandService["syncExecuteCommand"](var_core_value_sig777D.id, {
      rangeId: this._rangeId,
      segmentId: this._segmentId,
      unitId: this._unitId
    });
  ...
  replaceWithText(var_core_value_sig429F) {
    return this._commandService["syncExecuteCommand"](var_core_value_sig3F4C.id, {
      rangeId: this._rangeId,
      segmentId: this._segmentId,
  ...
  _getCustomRange() {
    ...
    return (var_core_value_sigF62A = this._getBody().customRanges) == null ? undefined : var_core_value_sigF62A.find(var_core_value_sig7524 => var_core_value_sig7524.rangeId === this._rangeId && var_core_value_sigF593(var_core_value_sig7524));
  }
  _getContainingParagraph() {
    ...
    return (var_core_value_sig8178 = var_core_value_sigB577.paragraphs) == null ? undefined : var_core_value_sig8178.find(var_core_value_sig2AD8 => var_core_value_sig3E68(var_core_value_sigB577, var_core_value_sig2AD8) <= var_core_value_sigE9ED.startIndex && var_core_value_sigE9ED.endIndex < var_core_value_sig2AD8.startIndex);
  }
};
T = w([C(3, var_core_value_sigF2E6), C(4, var_core_value_sig34C8(var_core_value_sig1896))], T);
var E = class extends var_core_value_sigF4C5 {
  constructor(...var_core_value_sig9572) {
    super(...var_core_value_sig9572), S(this, "_docsLatexCommandService", undefined);
  }
  _initialize(var_core_value_sigD873) {
    this._docsLatexCommandService = var_core_value_sigD873.get(var_core_value_sigF2E6);
  }
  ...
  _insertLatexFormula(var_core_value_sig5CEE) {
    let var_core_value_sigE92A = this._docsLatexCommandService["syncExecuteCommand"](var_core_value_sig0285.id, var_core_value_sig5CEE);
  ...
  _getLatexRanges(var_core_value_sig362B) {
    ...
    return ((var_core_value_sig5CA5 = this.getBody(var_core_value_sig362B).customRanges) == null ? undefined : var_core_value_sig5CA5.filter(var_core_value_sigF593)) ?? [];
  }
  _createFDocumentLatex(var_core_value_sigE90F, var_core_value_sigEFD4) {
    return this._injector["createInstance"](T, this, var_core_value_sigE90F, var_core_value_sigEFD4);
  }
  _getLatexFromRange(var_core_value_sig861B, var_core_value_sig5237) {
    return var_core_value_sig5A13(var_core_value_sig861B, this.getBody(var_core_value_sig5237).dataStream);
  }
};
var_core_value_sigF4C5.extend(E);
var D = class extends var_core_value_sig5410 {
  constructor(...var_core_value_sigBB00) {
    super(...var_core_value_sigBB00), S(this, "_docsLatexCommandService", undefined);
  }
  _initialize(var_core_value_sig7E54) {
    this._docsLatexCommandService = var_core_value_sig7E54.get(var_core_value_sigF2E6);
  }
  ...
  _insertLatex(var_core_value_sig48CA, var_core_value_sig50AF, var_core_value_sigA942) {
    let var_core_value_sigA621 = this.getSegmentId(),
      ...
      var_core_value_sig8889 = this._docsLatexCommandService["syncExecuteCommand"](var_core_value_sig0285.id, var_core_value_sigBBFF);
    return var_core_value_sig8889 ? this._injector["createInstance"](T, this._document, var_core_value_sig8889.rangeId, var_core_value_sig8889.segmentId) : null;
  }
};
var_core_value_sig5410.extend(D);
var O = class extends var_core_value_sig492F {
  constructor(...var_core_value_sig32F8) {
    super(...var_core_value_sig32F8), S(this, "_docsLatexCommandService", undefined);
  }
  _initialize(var_core_value_sig5B67) {
    this._docsLatexCommandService = var_core_value_sig5B67.get(var_core_value_sigF2E6);
  }
  ...
  _insertLatex(var_core_value_sig7F72, var_core_value_sig7B2A, var_core_value_sig06CD, var_core_value_sigA5F1, var_core_value_sig97A2) {
    let var_core_value_sig07E9 = {
      ...
      var_core_value_sig4F59 = this._docsLatexCommandService["syncExecuteCommand"](var_core_value_sig0285.id, var_core_value_sig07E9);
    return var_core_value_sig4F59 ? this._injector["createInstance"](T, this._document, var_core_value_sig4F59.rangeId, var_core_value_sig4F59.segmentId) : null;
  }
};
var_core_value_sig492F.extend(O);
var k = class extends var_core_value_sigB744 {
  latex(var_core_value_sigF564, var_core_value_sig8CFA = {}) {
    ...
    let var_core_value_sigB098 = ((var_core_value_sig2E11 = var_core_value_sig8CFA.rangeId) == null ? undefined : var_core_value_sig2E11.trim()) || var_core_value_sigE68A();
    return this.insertRichText(var_core_value_sigEAE2.create({
      id: "d",
      documentStyle: {},
      body: {
        ...
        customRanges: [{
          ...
          rangeType: var_core_value_sigB512.CUSTOM,
          wholeEntity: true,
          properties: {
            kind: var_core_value_sig6418
          }
        }]
      }
    }));
...
var_core_value_sigB744.extend(k);
