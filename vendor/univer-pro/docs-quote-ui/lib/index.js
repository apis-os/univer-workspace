import { DOCS_QUOTE_LINE_COLOR_TOKEN as var_core_value_sig48DD, DOCS_QUOTE_LINE_WIDTH as var_core_value_sig5E6A, DOCS_QUOTE_PLUGIN as var_core_value_sigB7FC, DocsQuoteCancelEmptyParagraphCommand as var_core_value_sig9CD9, DocsQuoteExitCommand as var_core_value_sigFD0C, DocsQuoteInsertBelowCommand as var_core_value_sig849B, DocsQuoteInsertCommand as var_core_value_sig5F1A, DocsQuoteRemoveCommand as var_core_value_sigB455, DocsQuoteUnwrapCommand as var_core_value_sig5241, DocsQuoteUpdateStyleCommand as var_core_value_sigC6E5, UniverDocsQuotePlugin as var_core_value_sigCEFB, buildCancelEmptyQuoteParagraphActions as var_core_value_sig1537, buildExitQuoteActions as var_core_value_sigE4C6 } from "@univerjs-pro/docs-quote";
import { DOC_CONTENT_INSERT_MENU_ID as var_core_value_sig4313, DOC_PARAGRAPH_T_EDIT_MENU_ID as var_core_value_sigFC87, DOC_PARAGRAPH_T_INSERT_BELOW_MENU_ID as var_core_value_sig156F, DOC_PARAGRAPH_T_INSERT_MENU_ID as var_core_value_sigDD51, DeleteCurrentParagraphCommand as var_core_value_sigF057, DeleteLeftCommand as var_core_value_sig72F6, DeleteRightCommand as var_core_value_sig9FBA, DocAutoFormatService as var_core_value_sigFE01, DocCanvasPopManagerService as var_core_value_sigA2CE, EMPTY_PARAGRAPH_MENU_ID as var_core_value_sig1975, EnterCommand as var_core_value_sig6EA1, FLOAT_TEXT_STYLE_MENU_ID as var_core_value_sig029F, FLOAT_TOOLBAR_MENU_POSITION as var_core_value_sig3767, INSERT_BELLOW_MENU_ID as var_core_value_sig670B, UniverDocsUIPlugin as var_core_value_sig6912, disableMenuWhenHeaderFooterEditing as var_core_value_sigE235, hideMenuWhenSelectionInBlockRange as var_core_value_sig7664 } from "@univerjs/docs-ui";
import { COLOR_PICKER_COMPONENT as var_core_value_sig2281, ComponentManager as var_core_value_sig5E86, ContextMenuGroup as var_core_value_sig6998, ContextMenuPosition as var_core_value_sigF639, IMenuManagerService as var_core_value_sigEAE5, IconManager as var_core_value_sigE94C, MenuItemType as var_core_value_sig6D47, MenuManagerPosition as var_core_value_sigCB82, RibbonInsertGroup as var_core_value_sigCF4E, RibbonPosition as var_core_value_sig6CAD, ToolbarButton as var_core_value_sig8CF5, getMenuHiddenObservable as var_core_value_sigDDD7, useDependency as var_core_value_sigB2CE } from "@univerjs/ui";
import { CommandType as var_core_value_sig443C, DEFAULT_STYLES as var_core_value_sig39B1, DependentOn as var_core_value_sig210D, Disposable as var_core_value_sigB4B4, DocumentBlockRangeType as var_core_value_sigD407, ICommandService as var_core_value_sig63F3, IConfigService as var_core_value_sig6A71, IPermissionService as var_core_value_sig3BF6, Inject as var_core_value_sig38CE, Injector as var_core_value_sig62B7, LocaleService as var_core_value_sig37A8, Plugin as var_core_value_sigA90D, ThemeService as var_core_value_sig7A3C, UniverInstanceType as var_core_value_sig0511, merge as var_core_value_sig1F44 } from "@univerjs/core";
import { combineLatest as var_core_value_sigCB04, map as var_core_value_sig947E } from "rxjs";
import { UniverLicensePlugin as var_core_value_sig4545 } from "@univerjs-pro/license";
import { DocSkeletonManagerService as var_core_value_sigF39A, UniverDocsPlugin as var_core_value_sigF79C, canEditDocumentTargets as var_core_value_sig2E54, getDocumentEntityParentPermissionObjectIds as var_core_value_sig7658, getDocumentEntityPermissionObjectId as var_core_value_sigDCF5 } from "@univerjs/docs";
import { Documents as var_core_value_sigC786, IRenderManagerService as var_core_value_sigC0D9, UniverRenderEnginePlugin as var_core_value_sigF051 } from "@univerjs/engine-render";
import { FontColorDoubleIcon as var_core_value_sig5825, LeftBorderDoubleIcon as var_core_value_sig4EB7, QuoteIcon as var_core_value_sig73AF, TextIcon as var_core_value_sig548A } from "@univerjs/icons";
import { useState as var_core_value_sigE026 } from "react";
import { jsx as var_core_value_sig339E, jsxs as var_core_value_sig7550 } from "react/jsx-runtime";
import { documentSkeletonLineIterator as var_core_value_sig2983 } from "@univerjs-pro/docs-column";
function L(var_core_value_sig2D58) {
  return {
    id: var_core_value_sig5F1A.id,
    type: var_core_value_sig6D47.BUTTON,
    icon: "QuoteIcon",
    title: "docs-quote-ui.menu.quote",
    tooltip: "docs-quote-ui.menu.quote",
    hidden$: var_core_value_sigDDD7(var_core_value_sig2D58, var_core_value_sig0511.UNIVER_DOC),
    disabled$: var_core_value_sigE235(var_core_value_sig2D58)
  };
}
function R(var_core_value_sig223F) {
  return {
    ...L(var_core_value_sig223F),
    hidden$: var_core_value_sigCB04([var_core_value_sigDDD7(var_core_value_sig223F, var_core_value_sig0511.UNIVER_DOC), var_core_value_sig7664(var_core_value_sig223F)]).pipe(var_core_value_sig947E(([var_core_value_sig12F2, var_core_value_sig2259]) => var_core_value_sig12F2 || var_core_value_sig2259))
  };
}
function z(var_core_value_sigD749) {
  return {
    id: var_core_value_sig849B.id,
    type: var_core_value_sig6D47.BUTTON,
    icon: "QuoteIcon",
    title: "docs-quote-ui.menu.quote",
    hidden$: var_core_value_sigDDD7(var_core_value_sigD749, var_core_value_sig0511.UNIVER_DOC),
    disabled$: var_core_value_sigE235(var_core_value_sigD749)
  };
}
const B = {
    [var_core_value_sigCF4E.MEDIA]: {
  ...
  Be = {
    [var_core_value_sigCB82.RIBBON]: {
      [var_core_value_sig6CAD.INSERT]: B
    },
  ...
  V = {
    ...
    [var_core_value_sigF639.PARAGRAPH]: {
      [var_core_value_sig6998.LAYOUT]: {
        [var_core_value_sig670B]: {
          [var_core_value_sig849B.id]: {
            order: 6,
            menuItemFactory: z
          }
        }
...
function Ue(var_core_value_sigCFFA) {
  let {
    ...
    var_core_value_sigDB4A = var_core_value_sigB2CE(var_core_value_sig63F3),
    var_core_value_sig6418 = var_core_value_sigB2CE(var_core_value_sig37A8),
    var_core_value_sig1896 = var_core_value_sigB2CE(var_core_value_sig5E86).get(var_core_value_sig2281),
    [var_core_value_sig0285, var_core_value_sig777D] = var_core_value_sigE026(var_core_value_sig5090),
    [var_core_value_sig3F4C, var_core_value_sigD65A] = var_core_value_sigE026(var_core_value_sigC368),
    [var_core_value_sig5A13, var_core_value_sigF593] = var_core_value_sigE026(null),
    ...
    var_core_value_sigB512 = async var_core_value_sigD082 => {
      let var_core_value_sigDBB7 = await var_core_value_sigDB4A.executeCommand(var_core_value_sigC6E5.id, {
  ...
  return var_core_value_sig7550("div", {
    "data-u-comp": U,
    role: "toolbar",
    ...
    children: [var_core_value_sig339E(var_core_value_sig8CF5, {
      ...
      onClick: () => var_core_value_sigDB4A.executeCommand(var_core_value_sig5241.id, {
        blockId: var_core_value_sig58C1,
        unitId: var_core_value_sigAD56
      }),
      children: var_core_value_sig339E(var_core_value_sig548A, {})
    }), var_core_value_sig5A13 && var_core_value_sig1896 ? var_core_value_sig339E("div", {
      ...
      children: var_core_value_sig339E(var_core_value_sig1896, {
...
function W(var_core_value_sigEAE2, var_core_value_sigE68A) {
...
function G(var_core_value_sig3E68, var_core_value_sigF4C5, var_core_value_sig5410, var_core_value_sig492F) {
...
let K = class extends var_core_value_sigB4B4 {
  ...
  _registerIcons() {
    this.disposeWithMe(this._iconManager["register"]({
      QuoteIcon: var_core_value_sig73AF
    }));
  }
  _registerComponents() {
...
K = G([W(0, var_core_value_sig38CE(var_core_value_sig5E86)), W(1, var_core_value_sig38CE(var_core_value_sigE94C))], K);
function We(var_core_value_sig74A8, var_core_value_sig21B2, var_core_value_sigDE08, var_core_value_sigACCB) {
    ...
    Array.from(new Set(var_core_value_sigEFD4.map(var_core_value_sig4383 => var_core_value_sig4383.pageIndex))).forEach(var_core_value_sig186C => {
      ...
      Array.from(new Set(var_core_value_sigD955.map(var_core_value_sig4D4C => var_core_value_sig4D4C.layoutFragment))).forEach(var_core_value_sigC9E0 => {
        let var_core_value_sig76BA = var_core_value_sigD955.filter(var_core_value_sig7524 => var_core_value_sig7524.layoutFragment === var_core_value_sigC9E0),
          ...
          var_core_value_sig2BCF = Ge(var_core_value_sig76BA);
...
function Ge(var_core_value_sig0C53) {
...
function q(var_core_value_sigD4FB) {
  "@babel/helpers - typeof";

  return q = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig9A8D) {
  ...
  }, q(var_core_value_sigD4FB);
}
function Ke(var_core_value_sig3E71, var_core_value_sig01B3) {
  if (q(var_core_value_sig3E71) != "object" || !var_core_value_sig3E71) return var_core_value_sig3E71;
  ...
  if (var_core_value_sig7442 !== undefined) {
    ...
    if (q(var_core_value_sigDF87) != "object") return var_core_value_sigDF87;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig01B3 === "string" ? String : Number)(var_core_value_sig3E71);
}
function J(var_core_value_sig9EE0) {
  var var_core_value_sigF0511 = Ke(var_core_value_sig9EE0, "string");
  return q(var_core_value_sigF0511) == "symbol" ? var_core_value_sigF0511 : var_core_value_sigF0511 + "";
}
function Y(var_core_value_sig0B45, var_core_value_sig36F8, var_core_value_sig03E1) {
  return (var_core_value_sig36F8 = J(var_core_value_sig36F8)) in var_core_value_sig0B45 ? Object.defineProperty(var_core_value_sig0B45, var_core_value_sig36F8, {
...
let X = class extends var_core_value_sigB4B4 {
  ...
  _initPointer() {
    ...
    this.disposeWithMe(var_core_value_sig50AF.onPointerDown$["subscribeEvent"]({
      next: ([var_core_value_sig48BD]) => {
        ...
        let var_core_value_sig429F = Ze(var_core_value_sig48BD.offsetX, var_core_value_sig48BD.offsetY, this._context["scene"]),
  ...
  _initRender() {
    ...
    var_core_value_sigA942 instanceof var_core_value_sigC786 && this.disposeWithMe(var_core_value_sigA942.pageRender$["subscribe"](var_core_value_sig8178 => this._drawPage(var_core_value_sig8178)));
  }
  _drawPage(var_core_value_sigA621) {
    var var_core_value_sigBBFF;
    let var_core_value_sig8889 = ((var_core_value_sigBBFF = this._context["unit"].getBody()) == null || (var_core_value_sigBBFF = var_core_value_sigBBFF.blockRanges) == null ? undefined : var_core_value_sigBBFF.filter(var_core_value_sigE9ED => var_core_value_sigE9ED.blockType === var_core_value_sigD407.QUOTE)) ?? [];
    ...
    let var_core_value_sig4805 = We(var_core_value_sig8889, this._collectLines(var_core_value_sig5B67, var_core_value_sig8889), 4, 0),
      var_core_value_sigE67E = Z(this._context["mainComponent"]);
    var_core_value_sig1758 === 0 && (this._hitRects = []), var_core_value_sig4805.filter(var_core_value_sigB577 => var_core_value_sigB577.pageIndex === var_core_value_sig1758).forEach(var_core_value_sig9572 => {
      ...
      Je(var_core_value_sigA621.ctx, var_core_value_sig9572, () => Xe(var_core_value_sigA621.ctx, var_core_value_sig9572.lineX, var_core_value_sig9572.top, var_core_value_sig9572.height, var_core_value_sigD873)), this._hitRects["push"]({
  ...
  _collectLines(var_core_value_sig2902, var_core_value_sig9989) {
    let var_core_value_sig698E = [],
      ...
      var_core_value_sig2DAB = Z(this._context["mainComponent"]);
    return var_core_value_sig2983(var_core_value_sig2902, {
      ...
      if (var_core_value_sigF230) {
        ...
        var_core_value_sig698E.push(qe(var_core_value_sigA12B, var_core_value_sigF230));
      }
  ...
  _getQuoteLineColor(var_core_value_sig1B22) {
    ...
    let var_core_value_sigA5F1 = this._context["unit"].getBody(),
      var_core_value_sig97A2 = var_core_value_sigA5F1 == null || (var_core_value_sig7F72 = var_core_value_sigA5F1.blockRanges) == null ? undefined : var_core_value_sig7F72.find(var_core_value_sig6F91 => var_core_value_sig6F91.blockId === var_core_value_sig1B22 && var_core_value_sig6F91.blockType === var_core_value_sigD407.QUOTE),
    ...
    return (var_core_value_sig07E9 == null || (var_core_value_sig06CD = var_core_value_sig07E9.paragraphStyle) == null || (var_core_value_sig06CD = var_core_value_sig06CD.borderLeft) == null ? undefined : var_core_value_sig06CD.color["rgb"]) ?? this._themeService["getColorFromTheme"](var_core_value_sig48DD);
  }
  ...
  _canEditBlock(var_core_value_sig8CFA) {
    return var_core_value_sig2E54(this._permissionService, this._context["unitId"], [...var_core_value_sig7658(this._context["unit"], "", "custom-block", var_core_value_sig8CFA), var_core_value_sigDCF5("", "custom-block", var_core_value_sig8CFA)]);
  }
  _getQuoteTextColor(var_core_value_sig2E11) {
    ...
    let var_core_value_sigCE71 = this._context["unit"].getBody(),
      var_core_value_sig21D8 = var_core_value_sigCE71 == null || (var_core_value_sig5B69 = var_core_value_sigCE71.blockRanges) == null ? undefined : var_core_value_sig5B69.find(var_core_value_sig8895 => var_core_value_sig8895.blockId === var_core_value_sig2E11 && var_core_value_sig8895.blockType === var_core_value_sigD407.QUOTE);
    return var_core_value_sig21D8 ? (var_core_value_sigCE71 == null || (var_core_value_sigB098 = var_core_value_sigCE71.textRuns) == null || (var_core_value_sigB098 = var_core_value_sigB098.find(var_core_value_sigC80B => var_core_value_sigC80B.ed > var_core_value_sig21D8.startIndex + 1 && var_core_value_sigC80B.st < var_core_value_sig21D8.endIndex)) == null || (var_core_value_sigB098 = var_core_value_sigB098.ts) == null || (var_core_value_sigB098 = var_core_value_sigB098.cl) == null ? undefined : var_core_value_sigB098.rgb) ?? var_core_value_sig39B1.cl["rgb"] : var_core_value_sig39B1.cl["rgb"];
  }
};
X = G([W(1, var_core_value_sig38CE(var_core_value_sigF39A)), W(2, var_core_value_sig38CE(var_core_value_sigA2CE)), W(3, var_core_value_sig38CE(var_core_value_sig7A3C)), W(4, var_core_value_sig3BF6)], X);
function qe(var_core_value_sigBB57, var_core_value_sig7C4A, var_core_value_sigE799) {
  let {
...
function Je(var_core_value_sig00CB, var_core_value_sig77EE, var_core_value_sig9F76) {
...
function Z(var_core_value_sig8721) {
  if (!Ye(var_core_value_sig8721)) return {
    docsLeft: 0,
    docsTop: 0,
    pageMarginTop: 0
  };
...
function Ye(var_core_value_sigDBB5) {
...
function Xe(var_core_value_sigCFAC, var_core_value_sig237B, var_core_value_sigFEAB, var_core_value_sigE347, var_core_value_sig3C5B) {
  var_core_value_sigCFAC.save(), var_core_value_sigCFAC.beginPath(), var_core_value_sigCFAC.strokeStyle = var_core_value_sig3C5B, var_core_value_sigCFAC.lineCap = "round", var_core_value_sigCFAC.lineWidth = var_core_value_sig5E6A, var_core_value_sigCFAC.moveTo(var_core_value_sig237B, var_core_value_sigFEAB), var_core_value_sigCFAC.lineTo(var_core_value_sig237B, var_core_value_sigFEAB + var_core_value_sigE347), var_core_value_sigCFAC.stroke(), var_core_value_sigCFAC.restore();
}
function Ze(var_core_value_sig200B, var_core_value_sig3863, var_core_value_sigC97C) {
  let {
...
const Qe = {
  id: var_core_value_sigF057.id,
  name: "docs-quote.command.delete-current-paragraph",
  type: var_core_value_sig443C.COMMAND,
  multi: true,
  priority: 100,
  handler: async (var_core_value_sigA937, var_core_value_sigCAD5) => {
    var var_core_value_sigE503;
    return (var_core_value_sigCAD5 == null || (var_core_value_sigE503 = var_core_value_sigCAD5.blockRange) == null ? undefined : var_core_value_sigE503.blockType) === var_core_value_sigD407.QUOTE ? (await var_core_value_sigA937.get(var_core_value_sig63F3).executeCommand(var_core_value_sigB455.id, {
      unitId: var_core_value_sigCAD5.unitId,
      blockId: var_core_value_sigCAD5.blockRange["blockId"]
    }), true) : false;
  }
};
let Q = class extends var_core_value_sigB4B4 {
  constructor(var_core_value_sig2B65, var_core_value_sigD7EA, var_core_value_sigB33B) {
    super(), this._docAutoFormatService = var_core_value_sig2B65, this._menuManagerService = var_core_value_sigD7EA, this._commandService = var_core_value_sigB33B, this._menuManagerService["mergeMenu"](V), this._menuManagerService["appendRootMenu"](Be), this._initExitQuoteAutoFormat(), this._initCancelEmptyQuoteParagraphAutoFormat(), this.disposeWithMe(this._commandService["registerMultipleCommand"](Qe));
  }
  _initExitQuoteAutoFormat() {
    this.disposeWithMe(this._docAutoFormatService["registerAutoFormat"]({
      id: var_core_value_sig6EA1.id,
      match: var_core_value_sig284F => var_core_value_sig284F.selection["collapsed"] ? var_core_value_sigE4C6({
  ...
  _initCancelEmptyQuoteParagraphAutoFormat() {
    [var_core_value_sig72F6.id, var_core_value_sig9FBA.id].forEach(var_core_value_sig4632 => {
      this.disposeWithMe(this._docAutoFormatService["registerAutoFormat"]({
        id: var_core_value_sig4632,
        match: var_core_value_sig26DB => var_core_value_sig26DB.selection["collapsed"] ? var_core_value_sig1537({
...
Q = G([W(0, var_core_value_sig38CE(var_core_value_sigFE01)), W(1, var_core_value_sigEAE5), W(2, var_core_value_sig63F3)], Q);
let $ = class extends var_core_value_sigA90D {
  constructor(var_core_value_sig24B9 = H, var_core_value_sigE627, var_core_value_sigEF3E, var_core_value_sig273D) {
    ...
    } = var_core_value_sig1F44({}, H, this._config);
  ...
  onRendered() {
    this.disposeWithMe(this._renderManagerService["registerRenderModule"](var_core_value_sig0511.UNIVER_DOC, [X]));
  }
};
Y($, "pluginName", var_core_value_sigB7FC + "_UI_PLUGIN"), Y($, "packageName", Ve), Y($, "version", He), Y($, "type", var_core_value_sig0511.UNIVER_DOC), $ = G([var_core_value_sig210D(var_core_value_sig4545, var_core_value_sigF79C, var_core_value_sigF051, var_core_value_sig6912, var_core_value_sigCEFB), W(1, var_core_value_sig38CE(var_core_value_sig62B7)), W(2, var_core_value_sigC0D9), W(3, var_core_value_sig6A71)], $);
