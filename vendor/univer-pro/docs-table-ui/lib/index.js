import { DOCS_TABLE_PLUGIN as var_core_value_sig991C, DocsTableBorderPreset as var_core_value_sigF909, DocsTableDeleteColumnsCommand as var_core_value_sigDD0E, DocsTableDeleteRowsCommand as var_core_value_sigF2A0, DocsTableDeleteTableCommand as var_core_value_sig116F, DocsTableInsertColumnsCommand as var_core_value_sigA64C, DocsTableInsertRowsCommand as var_core_value_sigAF94, DocsTableInsertTableCommand as var_core_value_sig1E9F, DocsTableInsertTablePosition as var_core_value_sig3CC6, DocsTableInsertTitleRowCommand as var_core_value_sig041B, DocsTableMergeCellsCommand as var_core_value_sig3610, DocsTableMoveColumnsCommand as var_core_value_sig62F3, DocsTableMoveRowsCommand as var_core_value_sig8063, DocsTableMoveTableCommand as var_core_value_sig555A, DocsTableResizeColumnCommand as var_core_value_sigF562, DocsTableResizeRowCommand as var_core_value_sig5913, DocsTableSelectionKind as var_core_value_sigA1AF, DocsTableSelectionService as var_core_value_sig6324, DocsTableSelectionSource as var_core_value_sig7EE4, DocsTableSetHeaderRowCountCommand as var_core_value_sigE3D7, DocsTableSetTableBackgroundCommand as var_core_value_sig54C6, DocsTableSetTableBorderColorCommand as var_core_value_sigE843, DocsTableSetTableBorderCommand as var_core_value_sig2EB2, DocsTableSetTableBorderStyleCommand as var_core_value_sig683A, DocsTableSetTableBorderWidthCommand as var_core_value_sig109B, DocsTableSetTableVerticalAlignCommand as var_core_value_sig6DD0, DocsTableSortDirection as var_core_value_sigB5D3, DocsTableSortTableCommand as var_core_value_sig6085, DocsTableUnmergeCellsCommand as var_core_value_sig2507, UniverDocsTablePlugin as var_core_value_sig5870, canMergeCells as var_core_value_sig827F, canUnmergeCells as var_core_value_sig2452, getTableRangeById as var_core_value_sig50D0 } from "@univerjs-pro/docs-table";
import { AlignMenuItemFactory as var_core_value_sig5EBB, AlignOperationCommand as var_core_value_sig5E99, BackgroundColorSelectorMenuItemFactory as var_core_value_sig3FB3, BoldMenuItemFactory as var_core_value_sig0214, BulletListCommand as var_core_value_sig5153, CheckListCommand as var_core_value_sigF323, DOC_CONTENT_INSERT_MENU_ID as var_core_value_sig0C32, DOC_PARAGRAPH_T_INSERT_BELOW_MENU_ID as var_core_value_sig1D89, DOC_PARAGRAPH_T_INSERT_MENU_ID as var_core_value_sig2616, DOC_TABLE_BLOCK_MENU_ID as var_core_value_sig97EF, DeleteLeftCommand as var_core_value_sigA0C0, DocCanvasPopManagerService as var_core_value_sigAD4B, DocCreateTableOperation as var_core_value_sig06EA, DocEventManagerService as var_core_value_sigF3C7, DocFloatMenuService as var_core_value_sig5633, DocParagraphMenuService as var_core_value_sig2492, DocSelectAllCommand as var_core_value_sig39F2, DocSelectionRenderService as var_core_value_sigAD47, EMPTY_PARAGRAPH_MENU_ID as var_core_value_sig1722, FloatTextStyleMenuItemFactory as var_core_value_sig7F86, FontFamilySelectorMenuItemFactory as var_core_value_sigF69D, FontSizeSelectorMenuItemFactory as var_core_value_sig7CB9, INSERT_BELLOW_MENU_ID as var_core_value_sigC1D8, ItalicMenuItemFactory as var_core_value_sigCF8B, OrderListCommand as var_core_value_sigCD15, ParagraphMenuInsertBelowSubmenuItemFactory as var_core_value_sig524D, SetDocZoomRatioOperation as var_core_value_sigD7F4, SetInlineFormatBoldCommand as var_core_value_sig7B87, SetInlineFormatFontFamilyCommand as var_core_value_sig933D, SetInlineFormatFontSizeCommand as var_core_value_sig6ACE, SetInlineFormatItalicCommand as var_core_value_sig7675, SetInlineFormatStrikethroughCommand as var_core_value_sig21B8, SetInlineFormatTextBackgroundColorCommand as var_core_value_sigD545, SetInlineFormatTextColorCommand as var_core_value_sig91C9, SetInlineFormatUnderlineCommand as var_core_value_sig64BA, SetParagraphNamedStyleCommand as var_core_value_sig3FD5, StrikeThroughMenuItemFactory as var_core_value_sig1008, TextColorSelectorMenuItemFactory as var_core_value_sigB9F4, UnderlineMenuItemFactory as var_core_value_sig2D23, UniverDocsUIPlugin as var_core_value_sigF2E0 } from "@univerjs/docs-ui";
import { COLOR_PICKER_COMPONENT as var_core_value_sig9214, ComponentManager as var_core_value_sigC8B1, ContextMenuGroup as var_core_value_sig35E2, ContextMenuPosition as var_core_value_sig9B13, IContextMenuService as var_core_value_sig60E6, IMenuManagerService as var_core_value_sig1F6E, IShortcutService as var_core_value_sig7A6B, IconManager as var_core_value_sig20F6, KeyCode as var_core_value_sigAEE0, MenuItemType as var_core_value_sig72B6, MenuManagerPosition as var_core_value_sig43E8, MetaKeys as var_core_value_sigB1FB, RibbonInsertGroup as var_core_value_sig6876, RibbonPosition as var_core_value_sig55FB, ToolbarButton as var_core_value_sig2870, ToolbarItem as var_core_value_sigC865, getMenuHiddenObservable as var_core_value_sig6788, useDependency as var_core_value_sig7B1F, useObservable as var_core_value_sig7E51 } from "@univerjs/ui";
import { ColorKit as var_core_value_sigAE87, CommandType as var_core_value_sigFD51, DEFAULT_STYLES as var_core_value_sigF6D6, DOC_RANGE_TYPE as var_core_value_sigCF95, DashStyleType as var_core_value_sig8793, DependentOn as var_core_value_sig1BE7, Disposable as var_core_value_sig34F8, DocumentBlockType as var_core_value_sig9F3D, DocumentFlavor as var_core_value_sig785C, EDITOR_ACTIVATED as var_core_value_sig6537, FOCUSING_DOC as var_core_value_sig72BB, FOCUSING_UNIVER_EDITOR as var_core_value_sigC0DF, HorizontalAlign as var_core_value_sig94B7, ICommandService as var_core_value_sig9865, IConfigService as var_core_value_sigA09D, IPermissionService as var_core_value_sig1429, IUniverInstanceService as var_core_value_sigA339, Inject as var_core_value_sig832A, Injector as var_core_value_sig7945, LocaleService as var_core_value_sig1166, NamedStyleType as var_core_value_sig7ABC, Plugin as var_core_value_sigF686, PresetListType as var_core_value_sigDFF0, ThemeService as var_core_value_sig0130, UniverInstanceType as var_core_value_sigFD90, VerticalAlignmentType as var_core_value_sig702C, merge as var_core_value_sig03A4, toDisposable as var_core_value_sigB6F5 } from "@univerjs/core";
import { Button as var_core_value_sig8293, ColorPicker as var_core_value_sig43AE, Dropdown as var_core_value_sigEF2E, InputNumber as var_core_value_sigD83C, Separator as var_core_value_sigAC2B, Tooltip as var_core_value_sigFBBE, borderClassName as var_core_value_sigC982, clsx as var_core_value_sig59DA } from "@univerjs/design";
import { useMemo as var_core_value_sig3002, useState as var_core_value_sig33D2 } from "react";
import { BehaviorSubject as var_core_value_sig8D4A, EMPTY as var_core_value_sigB5D7, Observable as var_core_value_sig797B, Subject as var_core_value_sig5094, combineLatest as var_core_value_sig8883, map as var_core_value_sig488F, of as var_core_value_sigB440, startWith as var_core_value_sigF5CC, switchMap as var_core_value_sigA1B6 } from "rxjs";
import { Fragment as var_core_value_sig66A0, jsx as var_core_value_sig7876, jsxs as var_core_value_sig2C69 } from "react/jsx-runtime";
import { UniverLicensePlugin as var_core_value_sigAF19 } from "@univerjs-pro/license";
import { DocSelectionManagerService as var_core_value_sigCE75, DocSkeletonManagerService as var_core_value_sigF27A, UniverDocsPlugin as var_core_value_sig47B3, canEditDocumentTargets as var_core_value_sig5E75, getDocumentEntityParentPermissionObjectIds as var_core_value_sigC266, getDocumentEntityPermissionObjectId as var_core_value_sig77A3 } from "@univerjs/docs";
import { CURSOR_TYPE as var_core_value_sigD85C, DocumentSkeletonPageType as var_core_value_sig3957, IRenderManagerService as var_core_value_sigA101, UniverRenderEnginePlugin as var_core_value_sig2ADC, Vector2 as var_core_value_sig1386, getTableIdAndSliceIndex as var_core_value_sig96F5, setDocsTableRenderViewportProvider as var_core_value_sig7F54 } from "@univerjs/engine-render";
import { AlignBottomIcon as var_core_value_sigEB45, AlignTextBothIcon as var_core_value_sig0623, AlignTopIcon as var_core_value_sigBF43, AllBorderIcon as var_core_value_sigBC08, BoldIcon as var_core_value_sig3F28, CalendarIcon as var_core_value_sig0A16, CancelMergeIcon as var_core_value_sig0A96, DeleteColumnDoubleIcon as var_core_value_sig72FE, DeleteRowDoubleIcon as var_core_value_sigE8ED, DownBorderDoubleIcon as var_core_value_sig6DD3, FontColorDoubleIcon as var_core_value_sig8E87, HorizontalBorderDoubleIcon as var_core_value_sigCDF2, HorizontallyIcon as var_core_value_sig1043, InnerBorderDoubleIcon as var_core_value_sig4289, ItalicIcon as var_core_value_sig2729, LeftBorderDoubleIcon as var_core_value_sig5BB6, LeftJustifyingIcon as var_core_value_sig5C75, MergeAllIcon as var_core_value_sigCB46, MoreDownIcon as var_core_value_sig0177, NoBorderIcon as var_core_value_sigC674, NoColorDoubleIcon as var_core_value_sigC11B, NumberIcon as var_core_value_sig5461, OuterBorderDoubleIcon as var_core_value_sigBA12, PaintBucketDoubleIcon as var_core_value_sig65CB, RightBorderDoubleIcon as var_core_value_sig8AF4, RightJustifyingIcon as var_core_value_sig7C2D, StrikethroughIcon as var_core_value_sig5F54, TableBorderStyleDashedIcon as var_core_value_sig668D, TableBorderStyleDottedIcon as var_core_value_sig6883, TableBorderStyleIcon as var_core_value_sig2A05, TableBorderStyleSolidIcon as var_core_value_sig9CA8, TableBorderWidthIcon as var_core_value_sig3C9C, TableIcon as var_core_value_sig7651, TextIcon as var_core_value_sig6E4E, UnderlineIcon as var_core_value_sigC2E8, UpBorderDoubleIcon as var_core_value_sig3A04, VerticalBorderDoubleIcon as var_core_value_sig935E, VerticalCenterIcon as var_core_value_sigDC45 } from "@univerjs/icons";
import { documentSkeletonTableIterator as var_core_value_sig7C31 } from "@univerjs-pro/docs-column";
function Yn(var_core_value_sig86D7, var_core_value_sig431B) {
  return var_core_value_sig86D7 + ":" + var_core_value_sig431B;
}
function Xn(var_core_value_sig5C7C) {
  ...
  if (Qn(var_core_value_sig87E2, var_core_value_sig2E04)) return {
  ...
  return Qn(var_core_value_sig2EDD, var_core_value_sig27D2) ? {
    colCount: var_core_value_sig27D2,
    rowCount: var_core_value_sig2EDD
  } : null;
}
function Zn(var_core_value_sig355D) {
...
function Qn(var_core_value_sigEB36, var_core_value_sig5C27) {
...
const z = {
    ...
    type: var_core_value_sigFD51.COMMAND,
    handler: async (var_core_value_sigD051, var_core_value_sig16D9) => {
      let var_core_value_sigF378 = var_core_value_sigD051.get(var_core_value_sig9865),
        var_core_value_sig5F6C = Xn(var_core_value_sig16D9);
      return var_core_value_sig5F6C ? var_core_value_sigF378.executeCommand(var_core_value_sig1E9F.id, {
        rows: var_core_value_sig5F6C.rowCount,
        columns: var_core_value_sig5F6C.colCount,
        position: var_core_value_sig3CC6.Selection
      }) : false;
    }
  },
  $n = "doc.menu.table",
...
function nr(var_core_value_sig7E85) {
  return {
    id: $n,
    commandId: z.id,
    selectionsCommandId: z.id,
    params: tr,
    type: var_core_value_sig72B6.SUBITEMS,
    icon: "TableIcon",
    tooltip: "docs-table-ui.table.main",
    slot: true,
    hidden$: ar(var_core_value_sig7E85),
    selections: [{
      label: {
        name: er,
        hoverable: false,
...
function rr(var_core_value_sigF204) {
  return {
    id: z.id,
    commandId: z.id,
    selectionsCommandId: z.id,
    params: tr,
    type: var_core_value_sig72B6.BUTTON_SELECTOR,
    icon: "TableIcon",
    title: "docs-table-ui.insertTable",
    hidden$: ar(var_core_value_sigF204),
    selections: [{
      label: {
        name: er,
        hoverable: false,
...
function ir(var_core_value_sig7A15) {
  return {
    id: z.id,
    commandId: z.id,
    selectionsCommandId: z.id,
    ...
    icon: "TableIcon",
    title: "docs-table-ui.insertTable",
    hidden$: ar(var_core_value_sig7A15),
    selections: [{
      label: {
        name: er,
        hoverable: false,
...
function ar(var_core_value_sigEEA6) {
  let var_core_value_sigEAE1 = var_core_value_sig6788(var_core_value_sigEEA6, var_core_value_sigFD90.UNIVER_DOC, undefined),
    var_core_value_sigC69F = or(var_core_value_sigEEA6);
  return var_core_value_sigC69F ? var_core_value_sig8883([var_core_value_sigEAE1, var_core_value_sigC69F.selectionChange$["pipe"](var_core_value_sigF5CC(var_core_value_sigC69F.getCurrentSelection()), var_core_value_sig488F(var_core_value_sig7F33 => !!(var_core_value_sig7F33 != null && var_core_value_sig7F33.tableId)))]).pipe(var_core_value_sig488F(([var_core_value_sig0C53, var_core_value_sigEA04]) => var_core_value_sig0C53 || var_core_value_sigEA04)) : var_core_value_sigEAE1;
}
function or(var_core_value_sig0442) {
  try {
    let var_core_value_sig7A62 = var_core_value_sig0442.get(var_core_value_sig6324);
...
function sr(var_core_value_sig697A) {
  let var_core_value_sigDB65 = var_core_value_sig7B1F(var_core_value_sig1166),
    var_core_value_sig045E = var_core_value_sig7E51(var_core_value_sigDB65.direction$, "ltr"),
    [var_core_value_sig4524, var_core_value_sig64D5] = var_core_value_sig33D2({
      colCount: 5,
      rowCount: 3
    }),
    [var_core_value_sig9678, var_core_value_sig5E74] = var_core_value_sig33D2(3),
    [var_core_value_sig75FC, var_core_value_sig639A] = var_core_value_sig33D2(5),
    var_core_value_sig567C = var_core_value_sig8109 => {
      var var_core_value_sig7565;
      (var_core_value_sig7565 = var_core_value_sig697A.onChange) == null || var_core_value_sig7565.call(var_core_value_sig697A, Yn(var_core_value_sig8109.rowCount, var_core_value_sig8109.colCount));
    };
  return var_core_value_sig2C69("section", {
    ...
    children: [var_core_value_sig7876("div", {
      ...
      children: [var_core_value_sig7876("div", {
        ...
        children: [var_core_value_sig2C69("label", {
          className: "univer-grid univer-gap-1 univer-text-xs univer-text-gray-500",
          children: [var_core_value_sig7876("span", {
            children: var_core_value_sigDB65.t("docs-table-ui.tableRows")
          }), var_core_value_sig7876(var_core_value_sigD83C, {
            className: "univer-w-full",
            min: 1,
            max: 20,
            precision: 0,
            value: var_core_value_sig9678,
            onChange: var_core_value_sigDF87 => var_core_value_sig5E74(Zn(var_core_value_sigDF87))
          })]
        }), var_core_value_sig2C69("label", {
          className: "univer-grid univer-gap-1 univer-text-xs univer-text-gray-500",
          children: [var_core_value_sig7876("span", {
            ...
            onChange: var_core_value_sig9EE0 => var_core_value_sig639A(Zn(var_core_value_sig9EE0))
          })]
        }), var_core_value_sig7876(var_core_value_sig8293, {
...
function _r(var_core_value_sig825F) {
  return {
    id: lr,
    type: var_core_value_sig72B6.SUBITEMS,
    title: "docs-table-ui.delete",
    hidden$: var_core_value_sig825F ? $r(var_core_value_sig825F) : undefined
  };
}
function vr(var_core_value_sig546D) {
  return {
    id: ur,
    type: var_core_value_sig72B6.SUBITEMS,
    title: "docs-table-ui.borders",
    icon: hr.all,
    hidden$: var_core_value_sig546D ? $r(var_core_value_sig546D) : undefined
  };
}
function yr() {
...
function Cr(var_core_value_sig8078) {
  return {
    ...B(var_core_value_sigA0C0.id, "docs-table-ui.clearContent", undefined, var_core_value_sig8078),
    id: var_core_value_sigA0C0.id,
    icon: "ClearFormatDoubleIcon"
  };
}
function wr(var_core_value_sigDCED) {
  return {
    ...B(var_core_value_sigAF94.id, "docs-table-ui.insertRowAbove", {
      position: "above"
    }, var_core_value_sigDCED),
    icon: "InsertRowAboveDoubleIcon"
  };
}
function Tr(var_core_value_sig2829) {
  return {
    ...B(var_core_value_sigAF94.id, "docs-table-ui.insertRowBelow", {
      position: "below"
    }, var_core_value_sig2829),
    icon: "InsertRowBelowDoubleIcon"
  };
}
function Er(var_core_value_sig6EE2) {
  return {
    ...B(var_core_value_sigA64C.id, "docs-table-ui.insertColumnLeft", {
      position: "left"
    }, var_core_value_sig6EE2),
    icon: "LeftInsertColumnDoubleIcon"
  };
}
function Dr(var_core_value_sig4CCC) {
  return {
    ...B(var_core_value_sigA64C.id, "docs-table-ui.insertColumnRight", {
      position: "right"
    }, var_core_value_sig4CCC),
    icon: "RightInsertColumnDoubleIcon"
  };
}
function Or(var_core_value_sig6E47) {
  return B(var_core_value_sigF2A0.id, "docs-table-ui.deleteRow", Yr(var_core_value_sig6E47), var_core_value_sig6E47);
}
function kr(var_core_value_sigB64D) {
  return B(var_core_value_sigDD0E.id, "docs-table-ui.deleteColumn", Yr(var_core_value_sigB64D), var_core_value_sigB64D);
}
function Ar(var_core_value_sig2407) {
  return B(var_core_value_sig116F.id, "docs-table-ui.deleteTable", Yr(var_core_value_sig2407), var_core_value_sig2407);
}
function jr(var_core_value_sigE4D0) {
  return B(var_core_value_sig3610.id, "docs-table-ui.mergeCells", undefined, var_core_value_sigE4D0, var_core_value_sigE4D0 ? ni(var_core_value_sigE4D0) : undefined);
}
function Mr(var_core_value_sigD5F1) {
  return B(var_core_value_sig2507.id, "docs-table-ui.unmergeCells", undefined, var_core_value_sigD5F1, var_core_value_sigD5F1 ? ri(var_core_value_sigD5F1) : undefined);
}
function Nr(var_core_value_sigBC19) {
  return B(var_core_value_sig041B.id, "docs-table-ui.insertTitleRow", undefined, var_core_value_sigBC19, undefined, var_core_value_sigBC19 ? ei(var_core_value_sigBC19) : undefined);
}
function Pr(var_core_value_sig4F3C) {
  return B(var_core_value_sigE3D7.id, "docs-table-ui.pinHeaderRows", undefined, var_core_value_sig4F3C, undefined, var_core_value_sig4F3C ? ei(var_core_value_sig4F3C) : undefined);
}
function Fr(var_core_value_sig8D44) {
  return V("docs-table-ui.borderAll", var_core_value_sigF909.All, var_core_value_sig8D44);
}
function Ir(var_core_value_sig1660) {
  return V("docs-table-ui.borderBottom", var_core_value_sigF909.Bottom, var_core_value_sig1660);
}
function Lr(var_core_value_sigEE7B) {
  return V("docs-table-ui.borderInner", var_core_value_sigF909.Inner, var_core_value_sigEE7B);
}
function Rr(var_core_value_sig44DF) {
  return V("docs-table-ui.borderInnerHorizontal", var_core_value_sigF909.InnerHorizontal, var_core_value_sig44DF);
}
function zr(var_core_value_sig7E48) {
  return V("docs-table-ui.borderInnerVertical", var_core_value_sigF909.InnerVertical, var_core_value_sig7E48);
}
function Br(var_core_value_sig7B9E) {
  return V("docs-table-ui.borderLeft", var_core_value_sigF909.Left, var_core_value_sig7B9E);
}
function Vr(var_core_value_sig5C3B) {
  return V("docs-table-ui.borderOuter", var_core_value_sigF909.Outer, var_core_value_sig5C3B);
}
function Hr(var_core_value_sig4002) {
  return V("docs-table-ui.borderNone", var_core_value_sigF909.None, var_core_value_sig4002);
}
function Ur(var_core_value_sig4153) {
  return V("docs-table-ui.borderRight", var_core_value_sigF909.Right, var_core_value_sig4153);
}
function Wr(var_core_value_sig2825) {
  return V("docs-table-ui.borderTop", var_core_value_sigF909.Top, var_core_value_sig2825);
}
function Gr(var_core_value_sig5FD0) {
  return Xr({
    accessor: var_core_value_sig5FD0,
    commandId: var_core_value_sig54C6.id,
    defaultColor: var_core_value_sigF6D6.bg["rgb"],
    icon: "PaintBucketDoubleIcon",
    tooltip: "docs-table-ui.tableBackgroundColor"
  });
}
function Kr(var_core_value_sigA7E3) {
  return Xr({
    accessor: var_core_value_sigA7E3,
    commandId: var_core_value_sigE843.id,
    defaultColor: "#1f1f1f",
    icon: "PaintBucketDoubleIcon",
    tooltip: "docs-table-ui.borderColor"
  });
}
function qr(var_core_value_sigA784) {
  return {
    id: var_core_value_sig109B.id,
    type: var_core_value_sig72B6.SELECTOR,
    ...
    value$: var_core_value_sigB440(1),
    hidden$: var_core_value_sigA784 ? $r(var_core_value_sigA784) : undefined
  };
}
function Jr(var_core_value_sig4406) {
  return {
    id: var_core_value_sig683A.id,
    type: var_core_value_sig72B6.SELECTOR,
    ...
    value$: var_core_value_sigB440("solid"),
    hidden$: var_core_value_sig4406 ? $r(var_core_value_sig4406) : undefined
  };
}
function B(var_core_value_sig6806, var_core_value_sigD4AA, var_core_value_sigDC41, var_core_value_sigFB47, var_core_value_sig9B3D, var_core_value_sigC1CF) {
  return {
    id: var_core_value_sig6806 + "." + var_core_value_sigD4AA.split(".").pop(),
    commandId: var_core_value_sig6806,
    type: var_core_value_sig72B6.BUTTON,
    title: var_core_value_sigD4AA,
    params: var_core_value_sigDC41,
    hidden$: var_core_value_sigC1CF ?? (var_core_value_sigFB47 ? $r(var_core_value_sigFB47) : undefined),
    disabled$: var_core_value_sig9B3D
  };
}
function Yr(var_core_value_sigEE12) {
  if (!var_core_value_sigEE12) return;
  let var_core_value_sigD70C = var_core_value_sigEE12.get(var_core_value_sig6324);
  return () => {
...
function V(var_core_value_sigF047, var_core_value_sigC2F9, var_core_value_sig1F51) {
  return {
    ...B(var_core_value_sig2EB2.id, var_core_value_sigF047, {
      preset: var_core_value_sigC2F9
    }, var_core_value_sig1F51),
    icon: hr[var_core_value_sigC2F9]
  };
}
function Xr(var_core_value_sig29F5) {
  ...
  return {
    ...
    selections: [{
      label: {
        name: var_core_value_sig9214,
        hoverable: false,
        selectable: false
      },
      value$: var_core_value_sigB440(var_core_value_sig5A51)
    }],
    value$: var_core_value_sig29F5.accessor ? new var_core_value_sig797B(var_core_value_sig36F8 => {
      let var_core_value_sig03E1 = var_core_value_sig29F5.accessor["get"](var_core_value_sigA339).focused$["subscribe"](() => var_core_value_sig36F8.next(var_core_value_sig5A51));
      return var_core_value_sig36F8.next(var_core_value_sig5A51), () => var_core_value_sig03E1.unsubscribe();
    }) : var_core_value_sigB440(var_core_value_sig5A51),
    hidden$: var_core_value_sig29F5.accessor ? $r(var_core_value_sig29F5.accessor) : undefined
  };
}
function Zr(var_core_value_sigF1D1, var_core_value_sig370E) {
  return {
    id: var_core_value_sigF1D1,
    type: var_core_value_sig72B6.SUBITEMS,
    title: var_core_value_sig370E,
    hidden$: var_core_value_sigB440(true)
  };
}
function Qr(var_core_value_sigDE14, var_core_value_sig02CB) {
  return {
...
function $r(var_core_value_sig6CBB) {
  let var_core_value_sig68DA = ii(var_core_value_sig6CBB);
  return var_core_value_sig8883([var_core_value_sig6788(var_core_value_sig6CBB, var_core_value_sigFD90.UNIVER_DOC), var_core_value_sig68DA.pipe(var_core_value_sig488F(var_core_value_sigBB57 => !(var_core_value_sigBB57 != null && var_core_value_sigBB57.tableId)))]).pipe(var_core_value_sig488F(([var_core_value_sig7C4A, var_core_value_sigE799]) => var_core_value_sig7C4A || var_core_value_sigE799));
}
function ei(var_core_value_sig64D8) {
  return var_core_value_sig8883([$r(var_core_value_sig64D8), ti(var_core_value_sig64D8)]).pipe(var_core_value_sig488F(([var_core_value_sigB601, var_core_value_sig8B71]) => var_core_value_sigB601 || var_core_value_sig8B71));
}
function ti(var_core_value_sigD755) {
  let var_core_value_sigF897 = var_core_value_sigD755.get(var_core_value_sigA339);
  return new var_core_value_sig797B(var_core_value_sigAEFB => {
    let var_core_value_sig826B = var_core_value_sig8178 => {
        var var_core_value_sigE9ED;
        let var_core_value_sigB577 = var_core_value_sig8178 ? var_core_value_sigF897.getUnit(var_core_value_sig8178, var_core_value_sigFD90.UNIVER_DOC) : var_core_value_sigF897.getCurrentUnitOfType(var_core_value_sigFD90.UNIVER_DOC),
        ...
        var_core_value_sigAEFB.next(var_core_value_sig9572 !== var_core_value_sig785C.TRADITIONAL);
      },
...
function ni(var_core_value_sigA578) {
  let var_core_value_sig0260 = var_core_value_sigA578.get(var_core_value_sigA339),
    var_core_value_sig034D = var_core_value_sigA578.get(var_core_value_sig6324);
  return ii(var_core_value_sigA578).pipe(var_core_value_sig488F(var_core_value_sig00CB => {
    let var_core_value_sig77EE = var_core_value_sig0260.getCurrentUnitOfType(var_core_value_sigFD90.UNIVER_DOC),
    ...
    return !var_core_value_sig77EE || !(var_core_value_sig9F76 != null && var_core_value_sig9F76.tableId) || !var_core_value_sig827F(var_core_value_sig77EE.getSnapshot(), var_core_value_sig9F76.tableId, var_core_value_sig9F76);
  }));
}
function ri(var_core_value_sig89EC) {
  let var_core_value_sig9975 = var_core_value_sig89EC.get(var_core_value_sigA339),
    var_core_value_sigD6D9 = var_core_value_sig89EC.get(var_core_value_sig6324);
  return ii(var_core_value_sig89EC).pipe(var_core_value_sig488F(var_core_value_sigB008 => {
    let var_core_value_sig8721 = var_core_value_sig9975.getCurrentUnitOfType(var_core_value_sigFD90.UNIVER_DOC),
    ...
    return !var_core_value_sig8721 || !(var_core_value_sig08BA != null && var_core_value_sig08BA.tableId) || !var_core_value_sig2452(var_core_value_sig8721.getSnapshot(), var_core_value_sig08BA.tableId, var_core_value_sig08BA);
  }));
}
function ii(var_core_value_sig2637) {
  let var_core_value_sigAF1D = var_core_value_sig2637.get(var_core_value_sig6324);
  return var_core_value_sigAF1D.selectionChange$["pipe"](var_core_value_sigF5CC(var_core_value_sigAF1D.getCurrentSelection()));
}
const ai = {
    [var_core_value_sig6876.MEDIA]: {
      [$n]: {
        order: 2,
        menuItemFactory: nr
      }
  ...
  oi = {
    [var_core_value_sig43E8.RIBBON]: {
      [var_core_value_sig55FB.INSERT]: ai,
      [var_core_value_sig55FB.START]: {
        "ribbon.start.docs-table-style": {
          order: 20,
          [var_core_value_sig54C6.id]: {
            order: 0,
            menuItemFactory: Gr
          },
          [var_core_value_sigE843.id]: {
            order: 1,
            menuItemFactory: Kr
          },
          [var_core_value_sig109B.id]: {
            order: 2,
            menuItemFactory: qr
          },
          [var_core_value_sig683A.id]: {
            order: 3,
            menuItemFactory: Jr
          }
        }
  ...
  si = {
    ...ai,
    [var_core_value_sig9B13.PARAGRAPH]: {
      [var_core_value_sig35E2.LAYOUT]: {
        [var_core_value_sigC1D8]: {
          [var_core_value_sig06EA.id]: {
            order: 4,
            menuItemFactory: rr
          }
        }
      },
      [var_core_value_sig1722]: {
        [var_core_value_sig35E2.LAYOUT]: {
          [var_core_value_sig06EA.id]: {
            order: 4,
            menuItemFactory: rr
      ...
      [var_core_value_sig1D89]: {
        insert: {
          [var_core_value_sig06EA.id + ".below"]: {
            order: 0,
            menuItemFactory: rr
          }
        }
      ...
      [var_core_value_sig97EF]: {
        [var_core_value_sig35E2.LAYOUT]: {
          [var_core_value_sigC1D8]: {
            order: 0,
            menuItemFactory: var_core_value_sig524D
          }
        }
      }
    },
    [var_core_value_sig9B13.MAIN_AREA]: {
      [var_core_value_sig35E2.DATA]: {
        [pr]: {
          order: 0,
          menuItemFactory: xr
        },
      ...
      [var_core_value_sig35E2.FORMAT]: {
        [var_core_value_sigA0C0.id]: {
          order: 0,
          menuItemFactory: Cr
        }
      },
...
const ui = {},
  ...
  pi = {
    all: var_core_value_sigBC08,
    bottom: var_core_value_sig6DD3,
    inner: var_core_value_sig4289,
    innerHorizontal: var_core_value_sigCDF2,
    innerVertical: var_core_value_sig935E,
    left: var_core_value_sig5BB6,
    none: var_core_value_sigC674,
    outer: var_core_value_sigBA12,
    right: var_core_value_sig8AF4,
    top: var_core_value_sig3A04
  },
  mi = [{
    label: "docs-table-ui.borderAll",
    preset: var_core_value_sigF909.All
  }, {
    label: "docs-table-ui.borderInner",
    preset: var_core_value_sigF909.Inner
  }, {
    label: "docs-table-ui.borderOuter",
    preset: var_core_value_sigF909.Outer
  }, {
    label: "docs-table-ui.borderNone",
    preset: var_core_value_sigF909.None
  }];
function hi(var_core_value_sigC92D) {
  ...
  let var_core_value_sig2841 = (var_core_value_sigEA3D = var_core_value_sigC92D.popup) == null ? undefined : var_core_value_sigEA3D.extraProps,
    var_core_value_sig9FE1 = (var_core_value_sig2841 == null ? undefined : var_core_value_sig2841.presets) ?? mi,
    var_core_value_sig9DAA = var_core_value_sig2841 == null ? undefined : var_core_value_sig2841.onSelect,
    var_core_value_sig1F8A = var_core_value_sig7B1F(var_core_value_sig1166);
  return var_core_value_sig7876("section", {
    ...
    children: var_core_value_sig9FE1.map(({
      ...
      let var_core_value_sig237B = pi[var_core_value_sigCFAC],
        var_core_value_sigFEAB = var_core_value_sig1F8A.t(var_core_value_sigDBB5);
      return var_core_value_sig7876(var_core_value_sig8293, {
        size: "icon",
        variant: "ghost",
        type: "button",
        ...
        children: var_core_value_sig7876(var_core_value_sig237B, {
...
const gi = "docs-table-ui.column-type-panel",
  _i = ["docs-table-ui.columnTypeText", "docs-table-ui.columnTypeNumber", "docs-table-ui.columnTypeDate", "docs-table-ui.columnTypeCheckbox", "docs-table-ui.columnTypeDropdown"];
function vi() {
  let var_core_value_sigEBB4 = var_core_value_sig7B1F(var_core_value_sig1166);
  return var_core_value_sig7876("section", {
    "data-u-comp": gi,
    children: _i.map(var_core_value_sigE347 => var_core_value_sig7876(var_core_value_sig8293, {
      type: "button",
...
const yi = {
    icon: "TextTypeIcon",
    value: var_core_value_sig7ABC.NORMAL_TEXT
  },
  bi = {
    [var_core_value_sigDFF0.ORDER_LIST]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_1]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_2]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_3]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_4]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_5]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_QUICK_2]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_QUICK_3]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_QUICK_4]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_QUICK_5]: "OrderIcon",
    [var_core_value_sigDFF0.ORDER_LIST_QUICK_6]: "OrderIcon",
    [var_core_value_sigDFF0.BULLET_LIST]: "UnorderIcon",
    [var_core_value_sigDFF0.BULLET_LIST_1]: "UnorderIcon",
    [var_core_value_sigDFF0.BULLET_LIST_2]: "UnorderIcon",
    [var_core_value_sigDFF0.BULLET_LIST_3]: "UnorderIcon",
    [var_core_value_sigDFF0.BULLET_LIST_4]: "UnorderIcon",
    [var_core_value_sigDFF0.BULLET_LIST_5]: "UnorderIcon",
    [var_core_value_sigDFF0.CHECK_LIST]: "TodoListDoubleIcon",
    [var_core_value_sigDFF0.CHECK_LIST_CHECKED]: "TodoListDoubleIcon"
  },
  xi = {
    [var_core_value_sig7ABC.NORMAL_TEXT]: "TextTypeIcon",
    [var_core_value_sig7ABC.HEADING_1]: "H1Icon",
    [var_core_value_sig7ABC.HEADING_2]: "H2Icon",
    [var_core_value_sig7ABC.HEADING_3]: "H3Icon",
    [var_core_value_sig7ABC.HEADING_4]: "H4Icon",
    [var_core_value_sig7ABC.HEADING_5]: "H5Icon",
    [var_core_value_sig7ABC.TITLE]: "TitleTypeIcon",
    [var_core_value_sig7ABC.SUBTITLE]: "SubtitleTypeIcon",
    [var_core_value_sig7ABC.NAMED_STYLE_TYPE_UNSPECIFIED]: "TextTypeIcon"
  };
function Si(var_core_value_sig2B74, var_core_value_sig0483) {
  var var_core_value_sig4A48;
  let var_core_value_sigD170 = Ti(var_core_value_sig2B74, var_core_value_sig0483);
  if (!var_core_value_sigD170) return yi;
  let var_core_value_sig90E5 = Oi(var_core_value_sigD170);
  return {
    icon: ki(var_core_value_sig90E5, (var_core_value_sig4A48 = var_core_value_sigD170.paragraphStyle) == null ? undefined : var_core_value_sig4A48.namedStyleType),
    value: var_core_value_sig90E5
  };
}
function Ci(var_core_value_sig7000, var_core_value_sigD7C5) {
  if (!var_core_value_sig7000 || !(var_core_value_sigD7C5 != null && var_core_value_sigD7C5.tableId)) return [];
  let var_core_value_sig3633 = var_core_value_sig50D0(var_core_value_sig7000, var_core_value_sigD7C5.tableId);
...
function wi(var_core_value_sig3A41, var_core_value_sig269A) {
  let var_core_value_sigBF53 = Di(var_core_value_sig3A41, var_core_value_sig269A);
...
function Ti(var_core_value_sigC125, var_core_value_sigB63D) {
  ...
  let var_core_value_sigBFC7 = (var_core_value_sig8255 = var_core_value_sigC125.body) == null ? undefined : var_core_value_sig8255.paragraphs,
    var_core_value_sig933F = Di(var_core_value_sigC125, var_core_value_sigB63D);
  return !var_core_value_sig933F || !(var_core_value_sigBFC7 != null && var_core_value_sigBFC7.length) ? null : Ei(var_core_value_sigBFC7, var_core_value_sig933F.startOffset + 1);
}
function Ei(var_core_value_sig29DE, var_core_value_sig4AFB) {
...
function Di(var_core_value_sigDAB9, var_core_value_sig9CF7) {
  ...
  let var_core_value_sig5933 = var_core_value_sig50D0(var_core_value_sigDAB9, var_core_value_sig9CF7.tableId),
...
function Oi(var_core_value_sig9730) {
  ...
  return var_core_value_sig8457 != null && var_core_value_sig8457.startsWith(var_core_value_sigDFF0.ORDER_LIST) ? var_core_value_sigDFF0.ORDER_LIST : var_core_value_sig8457 != null && var_core_value_sig8457.startsWith(var_core_value_sigDFF0.BULLET_LIST) ? var_core_value_sigDFF0.BULLET_LIST : var_core_value_sig8457 === var_core_value_sigDFF0.CHECK_LIST || var_core_value_sig8457 === var_core_value_sigDFF0.CHECK_LIST_CHECKED ? var_core_value_sigDFF0.CHECK_LIST : ((var_core_value_sig300B = var_core_value_sig9730.paragraphStyle) == null ? undefined : var_core_value_sig300B.namedStyleType) ?? var_core_value_sig7ABC.NORMAL_TEXT;
}
function ki(var_core_value_sigB30D, var_core_value_sigDB33) {
  return typeof var_core_value_sigB30D == "string" ? bi[var_core_value_sigB30D] ?? yi.icon : xi[var_core_value_sigB30D] ?? xi[var_core_value_sigDB33 ?? var_core_value_sig7ABC.NORMAL_TEXT] ?? yi.icon;
}
function H(var_core_value_sig6C8C) {
  return {
    ...
    handler: async (var_core_value_sigC4B1, var_core_value_sig1BD9) => {
      ...
      return Bi(var_core_value_sigC4B1, var_core_value_sig6C8C.targetCommandId, var_core_value_sigE43E);
    }
  };
}
const Ai = {
    ...
    handler: async (var_core_value_sig7A5E, var_core_value_sig838E) => {
      ...
      if (typeof var_core_value_sig9A5B == "number") return Bi(var_core_value_sig7A5E, var_core_value_sig3FD5.id, {
        value: var_core_value_sig9A5B
      }, "top-left");
      switch (var_core_value_sig9A5B) {
        case var_core_value_sigDFF0.ORDER_LIST:
          return Bi(var_core_value_sig7A5E, var_core_value_sigCD15.id, {
            value: var_core_value_sig9A5B
          }, "top-left");
        case var_core_value_sigDFF0.BULLET_LIST:
          return Bi(var_core_value_sig7A5E, var_core_value_sig5153.id, {
            value: var_core_value_sig9A5B
          }, "top-left");
        case var_core_value_sigDFF0.CHECK_LIST:
          return Bi(var_core_value_sig7A5E, var_core_value_sigF323.id, {
            value: var_core_value_sig9A5B
          }, "top-left");
        default:
          return false;
  ...
  ji = H({
    ...
    targetCommandId: var_core_value_sig7B87.id
  }),
  Mi = H({
    id: "docs-table-ui.command.floating-italic",
    targetCommandId: var_core_value_sig7675.id
  }),
  Ni = H({
    id: "docs-table-ui.command.floating-underline",
    targetCommandId: var_core_value_sig64BA.id
  }),
  Pi = H({
    id: "docs-table-ui.command.floating-strike-through",
    targetCommandId: var_core_value_sig21B8.id
  }),
  Fi = H({
    id: "docs-table-ui.command.floating-font-family",
    targetCommandId: var_core_value_sig933D.id
  }),
  Ii = H({
    id: "docs-table-ui.command.floating-font-size",
    targetCommandId: var_core_value_sig6ACE.id
  }),
  Li = H({
    id: "docs-table-ui.command.floating-align",
    targetCommandId: var_core_value_sig5E99.id,
  ...
  Ri = H({
    ...
    targetCommandId: var_core_value_sig91C9.id
  }),
  zi = H({
    id: "docs-table-ui.command.floating-text-background-color",
    targetCommandId: var_core_value_sigD545.id
  });
async function Bi(var_core_value_sigE64C, var_core_value_sigF39B, var_core_value_sig9B88, var_core_value_sig992A = "selection") {
  var var_core_value_sig6281;
  let var_core_value_sig9B01 = var_core_value_sigE64C.get(var_core_value_sig9865),
    var_core_value_sigA724 = var_core_value_sigE64C.get(var_core_value_sig6324),
    var_core_value_sig385E = var_core_value_sigE64C.get(var_core_value_sigA339),
    var_core_value_sig10D3 = var_core_value_sigE64C.get(var_core_value_sigCE75),
    var_core_value_sig41F2 = var_core_value_sig385E.getCurrentUnitOfType(var_core_value_sigFD90.UNIVER_DOC),
  ...
  let var_core_value_sig7A88 = var_core_value_sig41F2.getSnapshot(),
    var_core_value_sig6CFC = var_core_value_sig992A === "top-left" ? wi(var_core_value_sig7A88, var_core_value_sig32DD) : Ci(var_core_value_sig7A88, var_core_value_sig32DD);
...
function Vi(var_core_value_sig898E) {
  "@babel/helpers - typeof";

  return Vi = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigA937) {
  ...
  }, Vi(var_core_value_sig898E);
}
function Hi(var_core_value_sigC481, var_core_value_sig27B7) {
  if (Vi(var_core_value_sigC481) != "object" || !var_core_value_sigC481) return var_core_value_sigC481;
  ...
  if (var_core_value_sig2DAD !== undefined) {
    ...
    if (Vi(var_core_value_sig00DE) != "object") return var_core_value_sig00DE;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig27B7 === "string" ? String : Number)(var_core_value_sigC481);
}
function Ui(var_core_value_sigEF7C) {
  var var_core_value_sig07E7 = Hi(var_core_value_sigEF7C, "string");
  return Vi(var_core_value_sig07E7) == "symbol" ? var_core_value_sig07E7 : var_core_value_sig07E7 + "";
}
function U(var_core_value_sig6005, var_core_value_sig25A4, var_core_value_sigB591) {
  return (var_core_value_sig25A4 = Ui(var_core_value_sig25A4)) in var_core_value_sig6005 ? Object.defineProperty(var_core_value_sig6005, var_core_value_sig25A4, {
...
const Wi = {
  ...
  visible: false,
  tableId: "",
  selectionKind: var_core_value_sigA1AF.Range,
  selection: null,
  anchorRect: null,
  selectionRect: null,
  mergeAction: null,
...
var Gi = class extends var_core_value_sig34F8 {
  constructor(...var_core_value_sigE503) {
    super(...var_core_value_sigE503), U(this, "_state", Wi), U(this, "state$", new var_core_value_sig8D4A(Wi));
  }
  getState() {
    return this._state;
  }
...
function Ki({
  ...
  return var_core_value_sig7876("div", {
    className: "univer-flex univer-h-7 univer-flex-nowrap univer-items-center univer-gap-1 univer-px-1",
    children: var_core_value_sigB272.map(var_core_value_sig5F1A => var_core_value_sig7876(var_core_value_sigC865, {
...
function qi({
  ...
  return var_core_value_sig2C69("div", {
    className: "univer-flex univer-h-7 univer-flex-nowrap univer-items-center univer-gap-1 univer-px-1",
    children: [var_core_value_sig6F52 == null ? undefined : var_core_value_sig6F52.map(var_core_value_sigB455 => var_core_value_sig7876(var_core_value_sigC865, {
...
const Ji = [0, 0.5, 0.75, 1, 1.5, 2.25, 3, 4.5, 6],
  Yi = [{
    value: "solid",
    label: "docs-table-ui.borderStyleSolid",
    icon: var_core_value_sig9CA8
  }, {
    value: "dot",
    label: "docs-table-ui.borderStyleDotted",
    icon: var_core_value_sig6883
  }, {
    value: "dash",
    label: "docs-table-ui.borderStyleDashed",
    icon: var_core_value_sig668D
  }],
  Xi = [{
    label: "docs-table-ui.borderAll",
    preset: var_core_value_sigF909.All
    ...
    preset: var_core_value_sigF909.Top
  }, {
    label: "docs-table-ui.borderBottom",
    preset: var_core_value_sigF909.Bottom
  }, {
    label: "docs-table-ui.borderLeft",
    preset: var_core_value_sigF909.Left
  }, {
    label: "docs-table-ui.borderRight",
    preset: var_core_value_sigF909.Right
  }, {
    label: "docs-table-ui.borderInnerHorizontal",
    preset: var_core_value_sigF909.InnerHorizontal
  }, {
    label: "docs-table-ui.borderInnerVertical",
    preset: var_core_value_sigF909.InnerVertical
  }, {
    label: "docs-table-ui.borderNone",
    preset: var_core_value_sigF909.None
  }];
function Zi(var_core_value_sig8E3E) {
  let {
  ...
  return var_core_value_sig7876(var_core_value_sigFBBE, {
    title: var_core_value_sigEC1A,
    placement: "bottom",
    children: var_core_value_sig7876("span", {
      children: var_core_value_sig7876(var_core_value_sig8293, {
        size: "small",
        variant: "ghost",
        type: "button",
        ...
        disabled: var_core_value_sig1451,
        className: var_core_value_sig59DA({
...
function Qi(var_core_value_sigBDED) {
  let {
      itemId: var_core_value_sig4BFF,
      onClick: var_core_value_sig40E7
    } = var_core_value_sigBDED,
    var_core_value_sigEDBA = var_core_value_sig7B1F(var_core_value_sig1166);
  return var_core_value_sig2C69(var_core_value_sig8293, {
    size: "large",
    variant: "ghost",
    type: "button",
...
function $i(var_core_value_sigE863) {
  ...
  return var_core_value_sig2C69("div", {
    ...
    children: [var_core_value_sig7876("div", {
      ...
      children: var_core_value_sig7876(var_core_value_sig43AE, {
        value: var_core_value_sig04B4,
        onChange: var_core_value_sig1C07
      })
    }), var_core_value_sig7876(var_core_value_sigAC2B, {}), var_core_value_sig7876(Qi, {
      itemId: var_core_value_sigDD05,
      onClick: var_core_value_sig93D6
    })]
  });
}
function ea(var_core_value_sig3932) {
  let {
...
function ta(var_core_value_sig9AFF) {
  let {
  ...
  return var_core_value_sig7876(ea, {
    active: var_core_value_sig7E51(() => var_core_value_sig56B9.activated$ ?? var_core_value_sigB440(false), false, false, [var_core_value_sig56B9]),
    disabled: var_core_value_sig5EE4,
    itemId: var_core_value_sig90CF,
    label: var_core_value_sigA386,
...
function na(var_core_value_sigFD9D) {
  let {
    ...
    var_core_value_sig1ED2 = var_core_value_sig7B1F(var_core_value_sig1166),
    [var_core_value_sig94C1, var_core_value_sigABAC] = var_core_value_sig33D2(false),
    var_core_value_sigFAE6 = var_core_value_sig7E51(() => var_core_value_sigA2A4.value$ ?? var_core_value_sigB440(var_core_value_sig94B7.LEFT), var_core_value_sig94B7.LEFT, false, [var_core_value_sigA2A4]),
    var_core_value_sig06AC = [{
      icon: var_core_value_sig5C75,
      itemId: "text-align-left",
      label: "docs-table-ui.toolbar.alignLeft",
      value: var_core_value_sig94B7.LEFT
    }, {
      icon: var_core_value_sig1043,
      itemId: "text-align-center",
      label: "docs-table-ui.toolbar.alignCenter",
      value: var_core_value_sig94B7.CENTER
    }, {
      icon: var_core_value_sig7C2D,
      itemId: "text-align-right",
      label: "docs-table-ui.toolbar.alignRight",
      value: var_core_value_sig94B7.RIGHT
    }, {
      icon: var_core_value_sig0623,
      itemId: "text-align-justify",
      label: "docs-table-ui.toolbar.alignJustify",
      value: var_core_value_sig94B7.JUSTIFIED
    }],
    var_core_value_sig57E2 = [{
      icon: var_core_value_sigBF43,
      itemId: "vertical-align-top",
      label: "docs-table-ui.verticalAlignTop",
      value: var_core_value_sig702C.TOP
    }, {
      icon: var_core_value_sigDC45,
      itemId: "vertical-align-middle",
      label: "docs-table-ui.verticalAlignMiddle",
      value: var_core_value_sig702C.CENTER
    }, {
      icon: var_core_value_sigEB45,
      itemId: "vertical-align-bottom",
      label: "docs-table-ui.verticalAlignBottom",
      value: var_core_value_sig702C.BOTTOM
    }];
  return var_core_value_sig7876(var_core_value_sigEF2E, {
    disabled: var_core_value_sigA1AC,
    open: var_core_value_sig94C1,
    onOpenChange: var_core_value_sigABAC,
    overlay: var_core_value_sig2C69("section", {
      className: var_core_value_sig59DA("univer-box-border univer-grid univer-gap-2 univer-rounded-lg univer-bg-gray-0 univer-p-2 univer-shadow-lg dark:!univer-border-gray-700 dark:!univer-bg-gray-900", var_core_value_sigC982),
      onMouseDown: var_core_value_sig1537 => var_core_value_sig1537.stopPropagation(),
      children: [var_core_value_sig2C69("div", {
        className: "univer-flex univer-items-center univer-gap-1",
        children: [var_core_value_sig7876(ta, {
          commandId: ji.id,
          disabled: var_core_value_sigA1AC,
          icon: var_core_value_sig7876(var_core_value_sig3F28, {}),
        ...
        }), var_core_value_sig7876(ta, {
          commandId: Mi.id,
          disabled: var_core_value_sigA1AC,
          icon: var_core_value_sig7876(var_core_value_sig2729, {}),
          ...
          commandId: Ni.id,
          disabled: var_core_value_sigA1AC,
          icon: var_core_value_sig7876(var_core_value_sigC2E8, {}),
          ...
          commandId: Pi.id,
          disabled: var_core_value_sigA1AC,
          icon: var_core_value_sig7876(var_core_value_sig5F54, {}),
      ...
      }), var_core_value_sig7876(var_core_value_sigAC2B, {}), var_core_value_sig7876("div", {
        className: "univer-flex univer-items-center univer-gap-1",
        children: var_core_value_sig06AC.map(({
          ...
          children: var_core_value_sig7876(var_core_value_sigE4C6, {})
        ...
        children: var_core_value_sig57E2.map(({
          ...
          children: var_core_value_sig7876(var_core_value_sigDD51, {})
        }, var_core_value_sigF057))
      })]
    }),
    children: var_core_value_sig7876("span", {
      children: var_core_value_sig2C69(Zi, {
        title: var_core_value_sig1ED2.t("docs-table-ui.textFormat"),
        itemId: "floating-text-format-panel",
        open: var_core_value_sig94C1,
        disabled: var_core_value_sigA1AC,
        children: [var_core_value_sig7876(var_core_value_sig6E4E, {}), var_core_value_sig7876(var_core_value_sig0177, {
...
function ra(var_core_value_sig01FC) {
  let {
    ...
    var_core_value_sig8E31 = var_core_value_sig7B1F(var_core_value_sig1166),
    [var_core_value_sig8339, var_core_value_sigA01E] = var_core_value_sig33D2(false);
  return var_core_value_sig7876(var_core_value_sigEF2E, {
    disabled: var_core_value_sig5374,
    open: var_core_value_sig8339,
    onOpenChange: var_core_value_sigA01E,
    overlay: var_core_value_sig7876($i, {
      color: var_core_value_sig10FC,
    ...
    children: var_core_value_sig7876("span", {
      children: var_core_value_sig2C69(Zi, {
        ...
        open: var_core_value_sig8339,
        disabled: var_core_value_sig5374,
        children: [var_core_value_sig7876(var_core_value_sig65CB, {
          className: "univer-fill-primary-600",
          extend: {
            colorChannel1: var_core_value_sig10FC
          }
        }), var_core_value_sig7876(var_core_value_sig0177, {
          className: "univer-text-xs"
        })]
      })
    })
...
function ia(var_core_value_sigA41E) {
  ...
  let {
    ...
    var_core_value_sig3070 = var_core_value_sig7B1F(var_core_value_sig1166),
    [var_core_value_sigC66D, var_core_value_sig8EC5] = var_core_value_sig33D2(false),
    var_core_value_sig1056 = var_core_value_sig7E51(var_core_value_sig3070.direction$, var_core_value_sig3070.getDirection()),
    var_core_value_sig6EE5 = ((var_core_value_sig939C = Yi.find(var_core_value_sigFE01 => var_core_value_sigFE01.value === var_core_value_sigE105)) == null ? undefined : var_core_value_sig939C.icon) ?? var_core_value_sig9CA8;
  return var_core_value_sig7876(var_core_value_sigEF2E, {
    disabled: var_core_value_sig6DEB,
    ...
    overlay: var_core_value_sig2C69("section", {
      ...
      children: [var_core_value_sig7876("div", {
        ...
        children: Xi.map(({
          ...
          let var_core_value_sig029F = pi[var_core_value_sig6EA1],
          ...
          return var_core_value_sig7876(var_core_value_sigFBBE, {
            ...
            children: var_core_value_sig7876(var_core_value_sig8293, {
              ...
              children: var_core_value_sig7876(var_core_value_sig029F, {
      ...
      }), var_core_value_sig7876(var_core_value_sigAC2B, {}), var_core_value_sig2C69("div", {
        className: "univer-flex univer-items-center univer-gap-2",
        children: [var_core_value_sig7876(var_core_value_sigEF2E, {
          overlay: var_core_value_sig7876($i, {
            color: var_core_value_sigA49E,
          ...
          children: var_core_value_sig2C69(var_core_value_sig8293, {
            size: "small",
            variant: "ghost",
            type: "button",
        ...
        }), var_core_value_sig7876(var_core_value_sigEF2E, {
          overlay: var_core_value_sig7876("div", {
            ...
            children: Ji.map(var_core_value_sig6912 => var_core_value_sig2C69(var_core_value_sig8293, {
              size: "middle",
              variant: "ghost",
              type: "button",
              className: var_core_value_sig59DA("univer-min-w-16", {
          ...
          children: var_core_value_sig2C69(var_core_value_sig8293, {
            ...
            children: [var_core_value_sig7876(var_core_value_sig3C9C, {
              className: "univer-text-base"
            }), var_core_value_sig2C69("span", {
              className: "univer-text-xs",
          ...
          overlay: var_core_value_sig7876("div", {
            ...
            children: Yi.map(({
            ...
            }) => var_core_value_sig7876(var_core_value_sigFBBE, {
              ...
              children: var_core_value_sig7876(var_core_value_sig8293, {
                ...
                variant: "ghost",
                type: "button",
                className: var_core_value_sig59DA("univer-min-w-12", {
                ...
                children: var_core_value_sig7876(var_core_value_sigE235, {
                  className: "univer-text-base"
                })
              })
          ...
          children: var_core_value_sig2C69(var_core_value_sig8293, {
            ...
            children: [var_core_value_sig7876(var_core_value_sig6EE5, {
              className: "univer-text-base"
            }), var_core_value_sig7876(var_core_value_sig0177, {
              className: "univer-text-xs"
            })]
    ...
    children: var_core_value_sig7876("span", {
      children: var_core_value_sig2C69(Zi, {
        ...
        open: var_core_value_sigC66D,
        disabled: var_core_value_sig6DEB,
        children: [var_core_value_sig7876(var_core_value_sigBA12, {}), var_core_value_sig7876(var_core_value_sig0177, {
          className: "univer-text-xs"
        })]
      })
    })
...
function aa(var_core_value_sig9DD9) {
  let {
      ...
      title: var_core_value_sig82931
    } = var_core_value_sig9DD9,
    [var_core_value_sig050D, var_core_value_sig37AE] = var_core_value_sig33D2(false);
  return var_core_value_sig7876(var_core_value_sigEF2E, {
    disabled: var_core_value_sigADC6,
    ...
    children: var_core_value_sig7876("span", {
      children: var_core_value_sig2C69(Zi, {
        ...
        open: var_core_value_sig050D,
        disabled: var_core_value_sigADC6,
        children: [var_core_value_sig7876(var_core_value_sig4620 === "font" ? var_core_value_sig8E87 : var_core_value_sig65CB, {
          className: "univer-fill-primary-600",
          extend: {
...
function sa(var_core_value_sig5B51, var_core_value_sig64FF) {
  ...
  let var_core_value_sig3A42 = (var_core_value_sig86F4 = var_core_value_sig50D0(var_core_value_sig5B51, var_core_value_sig64FF.tableId)) == null ? undefined : var_core_value_sig86F4.tableSource;
...
function ca(var_core_value_sig8802) {
...
function la(var_core_value_sig95D5) {
  return var_core_value_sig95D5 === var_core_value_sig8793.DOT ? "dot" : var_core_value_sig95D5 === var_core_value_sig8793.DASH ? "dash" : "solid";
}
function W(var_core_value_sigE027, var_core_value_sigE537, var_core_value_sig5D84) {
  return {
    ...var_core_value_sigE537(var_core_value_sigE027),
    ...var_core_value_sig5D84
  };
}
function G(var_core_value_sigD120, var_core_value_sigAA05, var_core_value_sigC04C) {
  return {
...
const ua = {
  [var_core_value_sig7ABC.NORMAL_TEXT]: "docs-table-ui.toolbar.textStyle.normal",
  [var_core_value_sig7ABC.HEADING_1]: "docs-table-ui.toolbar.textStyle.heading1",
  [var_core_value_sig7ABC.HEADING_2]: "docs-table-ui.toolbar.textStyle.heading2",
  [var_core_value_sig7ABC.HEADING_3]: "docs-table-ui.toolbar.textStyle.heading3",
  [var_core_value_sig7ABC.HEADING_4]: "docs-table-ui.toolbar.textStyle.heading4",
  [var_core_value_sig7ABC.HEADING_5]: "docs-table-ui.toolbar.textStyle.heading5",
  [var_core_value_sigDFF0.ORDER_LIST]: "docs-table-ui.toolbar.textStyle.orderedList",
  [var_core_value_sigDFF0.BULLET_LIST]: "docs-table-ui.toolbar.textStyle.unorderedList",
  [var_core_value_sigDFF0.CHECK_LIST]: "docs-table-ui.toolbar.textStyle.checklist"
};
function da(var_core_value_sig2069) {
  let {
      label: var_core_value_sig5176,
      tooltip: var_core_value_sig71A1,
      ...var_core_value_sig72AD
    } = var_core_value_sig2069,
    var_core_value_sig9ABE = ua[String(var_core_value_sig2069.value)],
    var_core_value_sig8EF0 = var_core_value_sig2069.id === var_core_value_sigCD15.id || var_core_value_sig2069.id === var_core_value_sig5153.id || var_core_value_sig2069.id === var_core_value_sigF323.id ? Ai.id : var_core_value_sig2069.id;
  return {
    ...var_core_value_sig72AD,
...
function fa(var_core_value_sig234B) {
  return var_core_value_sig234B && (Array.isArray(var_core_value_sig234B) ? var_core_value_sig234B.map(da) : var_core_value_sig234B.pipe(var_core_value_sig488F(var_core_value_sigE94C => var_core_value_sigE94C.map(da))));
}
function pa() {
  ...
  let var_core_value_sigB706 = var_core_value_sig7B1F(var_core_value_sig9865),
    var_core_value_sig5FD01 = var_core_value_sig7B1F(var_core_value_sig1166),
    var_core_value_sig77E3 = var_core_value_sig7B1F(var_core_value_sig7945),
    var_core_value_sigB071 = var_core_value_sig7B1F(var_core_value_sigA339),
    var_core_value_sig15FE = var_core_value_sig7B1F(Gi),
    var_core_value_sigCF47 = var_core_value_sig7E51(() => var_core_value_sig15FE.state$, var_core_value_sig15FE.getState(), false, [var_core_value_sig15FE]),
    ...
    var_core_value_sigC60C = var_core_value_sig3002(() => var_core_value_sig15FE.state$["pipe"](var_core_value_sig488F(var_core_value_sig09B8 => !var_core_value_sig09B8.selection)), [var_core_value_sig15FE]),
    var_core_value_sig1C3C = var_core_value_sig3002(() => var_core_value_sig15FE.state$["pipe"](var_core_value_sig488F(var_core_value_sig6F91 => var_core_value_sig6F91.typeValue ?? var_core_value_sig7ABC.NORMAL_TEXT)), [var_core_value_sig15FE]),
    var_core_value_sig71CF = var_core_value_sig3002(() => {
      let var_core_value_sig6D47 = W(var_core_value_sigAF12, var_core_value_sig7F86);
      return {
        ...var_core_value_sig6D47,
        commandId: Ai.id,
        disabled$: var_core_value_sigC60C,
        icon: var_core_value_sigCF47.typeIcon ?? "TextTypeIcon",
        selections: fa(var_core_value_sig6D47.selections),
    ...
    var_core_value_sigC341 = var_core_value_sig3002(() => [G(W(var_core_value_sigAF12, var_core_value_sigF69D), Fi.id, var_core_value_sigC60C), G(W(var_core_value_sigAF12, var_core_value_sig7CB9), Ii.id, var_core_value_sigC60C)], [var_core_value_sigAF12, var_core_value_sigC60C]),
    var_core_value_sigBA47 = var_core_value_sig3002(() => ({
      align: G(W(var_core_value_sigAF12, var_core_value_sig5EBB), Li.id, var_core_value_sigC60C),
      bold: G(W(var_core_value_sigAF12, var_core_value_sig0214), ji.id, var_core_value_sigC60C),
      italic: G(W(var_core_value_sigAF12, var_core_value_sigCF8B), Mi.id, var_core_value_sigC60C),
      strike: G(W(var_core_value_sigAF12, var_core_value_sig1008), Pi.id, var_core_value_sigC60C),
      underline: G(W(var_core_value_sigAF12, var_core_value_sig2D23), Ni.id, var_core_value_sigC60C)
    }), [var_core_value_sigAF12, var_core_value_sigC60C]),
    var_core_value_sig3DF7 = var_core_value_sig3002(() => [G(W(var_core_value_sigAF12, var_core_value_sigB9F4), Ri.id, var_core_value_sigC60C), G(W(var_core_value_sigAF12, var_core_value_sig3FB3), zi.id, var_core_value_sigC60C)], [var_core_value_sigAF12, var_core_value_sigC60C]),
    var_core_value_sigD49F = var_core_value_sig7E51(() => {
      var var_core_value_sigCB82;
      return ((var_core_value_sigCB82 = var_core_value_sig3DF7[0]) == null ? undefined : var_core_value_sigCB82.value$) ?? var_core_value_sigB440(var_core_value_sigF6D6.cl["rgb"]);
    }, var_core_value_sigF6D6.cl["rgb"], false, [var_core_value_sig3DF7]),
    var_core_value_sigCECC = var_core_value_sig7E51(() => {
      var var_core_value_sigCF4E;
      return ((var_core_value_sigCF4E = var_core_value_sig3DF7[1]) == null ? undefined : var_core_value_sigCF4E.value$) ?? var_core_value_sigB440(var_core_value_sigF6D6.bg["rgb"]);
    }, var_core_value_sigF6D6.bg["rgb"], false, [var_core_value_sig3DF7]),
    var_core_value_sig0F47 = var_core_value_sig3002(() => {
      var var_core_value_sig6CAD;
      return sa((var_core_value_sig6CAD = var_core_value_sigB071.getCurrentUnitOfType(var_core_value_sigFD90.UNIVER_DOC)) == null ? undefined : var_core_value_sig6CAD.getSnapshot(), var_core_value_sigCF47.selection);
    }, [var_core_value_sigCF47.selection, var_core_value_sigB071]),
    var_core_value_sig6B29 = (var_core_value_sig0F47 == null || (var_core_value_sig8169 = var_core_value_sig0F47.backgroundColor) == null ? undefined : var_core_value_sig8169.rgb) ?? var_core_value_sigF6D6.bg["rgb"],
    var_core_value_sig28E2 = ca(var_core_value_sig0F47),
    ...
    var_core_value_sig135F = la(var_core_value_sig28E2 == null ? undefined : var_core_value_sig28E2.dashStyle),
    ...
    [var_core_value_sig1B8A, var_core_value_sigFB18] = var_core_value_sig33D2(var_core_value_sigAD5D),
  ...
  let var_core_value_sig49F1 = var_core_value_sigCF47.mergeAction === "unmerge" ? var_core_value_sig5FD01.t("docs-table-ui.unmergeCells") : var_core_value_sigCF47.mergeAction === "merge" ? var_core_value_sig5FD01.t("docs-table-ui.mergeCells") : null,
    ...
    var_core_value_sigB0DF = () => {
      !var_core_value_sigCF47.selection || !var_core_value_sigCF47.mergeAction || var_core_value_sigB706.executeCommand(var_core_value_sigCF47.mergeAction === "unmerge" ? var_core_value_sig2507.id : var_core_value_sig3610.id, var_core_value_sigCF47.selection);
    },
    var_core_value_sig2E44 = () => {
      !var_core_value_sigCF47.selection || !var_core_value_sigCF47.deleteTarget || var_core_value_sigB706.executeCommand(var_core_value_sigCF47.deleteTarget === "row" ? var_core_value_sigF2A0.id : var_core_value_sigDD0E.id, var_core_value_sigCF47.selection);
    },
    var_core_value_sig8560 = var_core_value_sigDDD7 => {
      var_core_value_sigCF47.selection && var_core_value_sigB706.executeCommand(var_core_value_sig6DD0.id, {
    ...
    var_core_value_sig1E26 = var_core_value_sig443C => {
      var_core_value_sigCF47.selection && var_core_value_sigB706.executeCommand(Li.id, {
    ...
    }), var_core_value_sigB706.executeCommand(var_core_value_sig54C6.id, {
  ...
  return var_core_value_sig2C69("div", {
    ...
    className: var_core_value_sig59DA("univer-box-border univer-flex univer-items-center univer-rounded univer-bg-gray-0 univer-px-1 univer-py-1 univer-shadow-sm dark:!univer-border-gray-700 dark:!univer-bg-gray-900", var_core_value_sigC982),
    children: [var_core_value_sig7876(qi, {
      items: [var_core_value_sig71CF],
      children: var_core_value_sig49F1 ? var_core_value_sig7876(var_core_value_sigFBBE, {
        title: var_core_value_sig49F1,
        placement: "bottom",
        children: var_core_value_sig7876("span", {
          children: var_core_value_sig7876(var_core_value_sig2870, {
            "data-toolbar-item": "merge-cells",
            "aria-label": var_core_value_sig49F1,
            onClick: var_core_value_sigB0DF,
            children: var_core_value_sigCF47.mergeAction === "unmerge" ? var_core_value_sig7876(var_core_value_sig0A96, {}) : var_core_value_sig7876(var_core_value_sigCB46, {})
          })
        })
      }) : null
    }), var_core_value_sig7876(var_core_value_sigAC2B, {
      orientation: "vertical"
    }), var_core_value_sig2C69(qi, {
      children: [var_core_value_sig7876(ra, {
      ...
      }), var_core_value_sig7876(ia, {
        color: var_core_value_sig703C.borderColor,
        width: var_core_value_sig703C.borderWidth,
        style: var_core_value_sig703C.borderStyle,
        disabled: !var_core_value_sigCF47.selection,
        onSelectPreset: var_core_value_sig63F3 => var_core_value_sigB706.executeCommand(var_core_value_sig2EB2.id, {
        ...
        }), var_core_value_sigB706.executeCommand(var_core_value_sigE843.id, {
        ...
        }), var_core_value_sigB706.executeCommand(var_core_value_sig109B.id, {
        ...
        }), var_core_value_sigB706.executeCommand(var_core_value_sig683A.id, {
          value: var_core_value_sig38CE
        }))
      })]
    }), var_core_value_sig7876(var_core_value_sigAC2B, {
      orientation: "vertical"
    }), var_core_value_sig7876(Ki, {
      items: var_core_value_sigC341
    }), var_core_value_sig7876(var_core_value_sigAC2B, {
      orientation: "vertical"
    }), var_core_value_sig7876(qi, {
      children: var_core_value_sig7876(na, {
      ...
      children: [var_core_value_sig7876(aa, {
    ...
    }), var_core_value_sigCF47.showDeleteAction && var_core_value_sig2F7B ? var_core_value_sig2C69(var_core_value_sig66A0, {
      children: [var_core_value_sig7876(var_core_value_sigAC2B, {
        orientation: "vertical"
      }), var_core_value_sig7876("div", {
        ...
        children: var_core_value_sig7876(var_core_value_sigFBBE, {
          ...
          children: var_core_value_sig7876("span", {
            children: var_core_value_sig7876(var_core_value_sig2870, {
              ...
              className: var_core_value_sig59DA("hover:!univer-bg-red-50 hover:!univer-text-red-500", "dark:hover:!univer-bg-red-950/40 dark:hover:!univer-text-red-400"),
              onClick: var_core_value_sig2E44,
              children: var_core_value_sigCF47.deleteTarget === "row" ? var_core_value_sig7876(var_core_value_sigE8ED, {
                extend: {
                  colorChannel1: "currentColor"
                }
              }) : var_core_value_sig7876(var_core_value_sig72FE, {
                extend: {
                  colorChannel1: "currentColor"
                }
              })
...
function ha() {
  let var_core_value_sig0278 = var_core_value_sig7B1F(var_core_value_sig1166);
  return var_core_value_sig7876("section", {
    "data-u-comp": ma,
    children: var_core_value_sig2C69("label", {
      children: [var_core_value_sig7876("span", {
...
function _a() {
  let var_core_value_sig08A6 = var_core_value_sig7B1F(var_core_value_sig1166);
  return var_core_value_sig2C69("div", {
    "data-u-comp": ga,
    children: [var_core_value_sig7876(var_core_value_sig8293, {
      size: "icon",
...
function K(var_core_value_sig04E1, var_core_value_sigC504) {
...
function va(var_core_value_sig0515, var_core_value_sig9F34, var_core_value_sig0247, var_core_value_sig6030) {
...
let ya = class extends var_core_value_sig34F8 {
  ...
  _registerComponents() {
    [[di, hi], [gi, vi], [oa, pa], [ma, ha], [ga, _a]].forEach(([var_core_value_sigF9C7, var_core_value_sig8895]) => {
  ...
  _registerIcons() {
    this.disposeWithMe(this._iconManager["register"]({
      TableIcon: var_core_value_sig7651,
      TableBorderWidthIcon: var_core_value_sig3C9C,
      TableBorderStyleIcon: var_core_value_sig2A05,
      TableBorderStyleSolidIcon: var_core_value_sig9CA8,
      TableBorderStyleDottedIcon: var_core_value_sig6883,
      TableBorderStyleDashedIcon: var_core_value_sig668D,
      CalendarIcon: var_core_value_sig0A16,
      NumberIcon: var_core_value_sig5461
    }));
  }
};
ya = va([K(0, var_core_value_sig832A(var_core_value_sigC8B1)), K(1, var_core_value_sig832A(var_core_value_sig20F6))], ya);
var ba = class {
    constructor() {
      U(this, "_handlers", []);
    }
    register(var_core_value_sig0511) {
      return this._handlers["push"](var_core_value_sig0511), this._sortHandlers(), var_core_value_sigB6F5(() => {
  ...
  xa = class extends var_core_value_sig34F8 {
    constructor(...var_core_value_sigCB04) {
      super(...var_core_value_sigCB04), U(this, "_states", new Map());
    }
...
const Sa = {
  [var_core_value_sigF909.All]: "AllBorderIcon",
  [var_core_value_sigF909.Bottom]: "DownBorderDoubleIcon",
  [var_core_value_sigF909.Inner]: "InnerBorderDoubleIcon",
  [var_core_value_sigF909.InnerHorizontal]: "HorizontalBorderDoubleIcon",
  [var_core_value_sigF909.InnerVertical]: "VerticalBorderDoubleIcon",
  [var_core_value_sigF909.Left]: "LeftBorderDoubleIcon",
  [var_core_value_sigF909.None]: "NoBorderIcon",
  [var_core_value_sigF909.Outer]: "OuterBorderDoubleIcon",
  [var_core_value_sigF909.Right]: "RightBorderDoubleIcon",
  [var_core_value_sigF909.Top]: "UpBorderDoubleIcon"
};
function Ca(var_core_value_sigECBC) {
  return Sa[var_core_value_sigECBC];
}
function wa(var_core_value_sig65D2, var_core_value_sig4306) {
...
function Ta(var_core_value_sig534C, var_core_value_sigABB7, var_core_value_sig9071) {
...
function Ea(var_core_value_sig01A9, var_core_value_sig9477, var_core_value_sig917C, var_core_value_sig27E2) {
  return {
...
function Da(var_core_value_sig10D7, var_core_value_sig5A1A, var_core_value_sig77D2) {
...
function ka(var_core_value_sig48DA, var_core_value_sigD327 = ja()) {
  if (!var_core_value_sigD327) return {
    dispose: () => undefined
  };
  let var_core_value_sig6694 = Oa.map(var_core_value_sigD98F => {
...
function Aa(var_core_value_sig2A21, var_core_value_sig0836 = ja()) {
...
function Ma(var_core_value_sig692E, var_core_value_sig3FAF, var_core_value_sig378B, var_core_value_sigDE50, var_core_value_sig3094 = 1) {
  return {
...
function Na(var_core_value_sig86CC, var_core_value_sig7868, var_core_value_sig9921) {
...
function Pa(var_core_value_sig59BF, var_core_value_sigF001, var_core_value_sigE511) {
  return var_core_value_sigE511 ? Na(var_core_value_sig59BF, var_core_value_sigE511.x, var_core_value_sigE511.y) : var_core_value_sigF001;
}
function Fa(var_core_value_sig1C81, var_core_value_sig2C6A, var_core_value_sig7207) {
  if (var_core_value_sig2C6A.kind === "resize-column") {
    var var_core_value_sig297F;
    let var_core_value_sigB785 = Ia(var_core_value_sig1C81.columnIndices, var_core_value_sig2C6A.column);
    ...
    let var_core_value_sig130F = var_core_value_sig7207 != null && var_core_value_sig7207.column === var_core_value_sig2C6A.column && var_core_value_sig7207.width != null ? var_core_value_sig7207.width : var_core_value_sig1C81.columnWidths[var_core_value_sigB785],
      var_core_value_sigC0E3 = za(var_core_value_sig1C81),
      var_core_value_sig52F7 = var_core_value_sig1C81.tableRect["x"] + La(var_core_value_sig1C81.columnWidths["slice"](0, var_core_value_sigB785)) + var_core_value_sig130F - 1 - (((var_core_value_sig297F = var_core_value_sig1C81.viewport) == null ? undefined : var_core_value_sig297F.scrollLeft) ?? 0);
    return var_core_value_sig52F7 < var_core_value_sigC0E3.x || var_core_value_sig52F7 > var_core_value_sigC0E3.x + var_core_value_sigC0E3.width ? null : {
      height: Ra(var_core_value_sig2C6A.rect["height"], var_core_value_sig1C81.tableRect["height"], La(var_core_value_sig1C81.rowHeights)),
      width: 2,
  ...
  if (var_core_value_sig2C6A.kind === "resize-row") {
    let var_core_value_sig866F = Ia(var_core_value_sig1C81.rowIndices, var_core_value_sig2C6A.row);
    ...
    let var_core_value_sigDE3D = var_core_value_sig7207 != null && var_core_value_sig7207.row === var_core_value_sig2C6A.row && var_core_value_sig7207.height != null ? var_core_value_sig7207.height : var_core_value_sig1C81.rowHeights[var_core_value_sig866F],
      var_core_value_sigF175 = Ba(var_core_value_sig1C81),
    ...
    return var_core_value_sig4E3D <= var_core_value_sig6A18 ? null : {
      ...
      y: var_core_value_sig1C81.tableRect["y"] + La(var_core_value_sig1C81.rowHeights["slice"](0, var_core_value_sig866F)) + var_core_value_sigDE3D - 1
    };
  }
  return null;
}
function Ia(var_core_value_sigA95A, var_core_value_sig94D6) {
...
function La(var_core_value_sigC22E) {
...
function Ba(var_core_value_sig31F8) {
  let var_core_value_sig6905 = za(var_core_value_sig31F8),
    var_core_value_sigC3C0 = var_core_value_sig31F8.viewport ? Math.max(var_core_value_sig6905.x, Va(var_core_value_sig31F8, 0)) : var_core_value_sig31F8.tableRect["x"],
    var_core_value_sig1F39 = var_core_value_sig31F8.viewport ? Math.min(var_core_value_sig6905.x + var_core_value_sig6905.width, Va(var_core_value_sig31F8, La(var_core_value_sig31F8.columnWidths))) : var_core_value_sig31F8.tableRect["x"] + La(var_core_value_sig31F8.columnWidths);
  return {
...
function Va(var_core_value_sig9256, var_core_value_sig98A0) {
...
function Ha(var_core_value_sig1AC3) {
...
function Ua(var_core_value_sig23B4, var_core_value_sig350C, var_core_value_sig2335) {
  return Ka(var_core_value_sig23B4.thumb, var_core_value_sig350C, var_core_value_sig2335) ? "thumb" : Ka(var_core_value_sig23B4.track, var_core_value_sig350C, var_core_value_sig2335) ? "track" : null;
}
function Wa(var_core_value_sig6233, var_core_value_sig4230, var_core_value_sig6136, var_core_value_sigD25E) {
...
function Ga(var_core_value_sigCF44, var_core_value_sig3C97) {
  var_core_value_sigCF44.save(), var_core_value_sigCF44.fillStyle = var_core_value_sig3C97.appearance === "active" ? "rgba(24, 28, 42, 0.40)" : var_core_value_sig3C97.appearance === "hover" ? "rgba(24, 28, 42, 0.30)" : "rgba(24, 28, 42, 0.20)", qa(var_core_value_sigCF44, var_core_value_sig3C97.thumb["x"], var_core_value_sig3C97.thumb["y"], var_core_value_sig3C97.thumb["width"], var_core_value_sig3C97.thumb["height"], var_core_value_sig3C97.thumb["height"] / 2), var_core_value_sigCF44.fill(), var_core_value_sigCF44.restore();
}
function Ka(var_core_value_sigA920, var_core_value_sigAD56, var_core_value_sig0454) {
...
function qa(var_core_value_sigEE1A, var_core_value_sig4107, var_core_value_sigF35C, var_core_value_sigEF8D, var_core_value_sigE025, var_core_value_sigD549) {
...
function Ja(var_core_value_sigC79E, var_core_value_sig9221 = {}) {
  return var_core_value_sig9221.suppressOverlay || var_core_value_sigC79E.source === var_core_value_sig7EE4.Text || var_core_value_sigC79E.kind === var_core_value_sigA1AF.Range && var_core_value_sigC79E.startRow === var_core_value_sigC79E.endRow && var_core_value_sigC79E.startColumn === var_core_value_sigC79E.endColumn ? false : var_core_value_sigC79E.kind === var_core_value_sigA1AF.Cell || var_core_value_sigC79E.kind === var_core_value_sigA1AF.Range || var_core_value_sigC79E.kind === var_core_value_sigA1AF.Table || var_core_value_sigC79E.kind === var_core_value_sigA1AF.Row || var_core_value_sigC79E.kind === var_core_value_sigA1AF.Column;
}
const Ya = new Set(["row-insert-dot", "column-insert-dot"]),
  Xa = new Set(["row-header", "column-header", "row-insert-dot", "column-insert-dot"]);
function Za(var_core_value_sig0351) {
  let var_core_value_sig4686 = var_core_value_sig0351.zoom ?? 1,
    ...
    var_core_value_sig323C = io(var_core_value_sig0351),
    var_core_value_sig015D = wo(var_core_value_sig0351.columnWidths, oo(var_core_value_sig0351, var_core_value_sig0351.tableRect["x"])),
    var_core_value_sigBF8B = wo(var_core_value_sig0351.rowHeights, var_core_value_sig0351.tableRect["y"]);
  return var_core_value_sigD719.push(...Qa(var_core_value_sig0351, var_core_value_sig323C, var_core_value_sigBF8B, var_core_value_sig4686)), var_core_value_sigD719.push(...$a(var_core_value_sig0351, var_core_value_sig323C, var_core_value_sig015D, var_core_value_sig4686)), var_core_value_sigD719.push(...eo(var_core_value_sig0351, var_core_value_sig323C, var_core_value_sigBF8B, var_core_value_sig4686)), var_core_value_sigD719.push(...to(var_core_value_sig0351, var_core_value_sig323C, var_core_value_sig015D, var_core_value_sig4686)), var_core_value_sig0351.rowHeights["forEach"]((var_core_value_sig3F79, var_core_value_sig880E) => {
    ...
    var_core_value_sigD719.push(...no(var_core_value_sig0351, var_core_value_sigB57B, var_core_value_sigBF8B[var_core_value_sig880E] + var_core_value_sig3F79 - var_core_value_sig8E1C / 2, var_core_value_sig8E1C));
    ...
    var_core_value_sigD719.push(...ro(var_core_value_sig0351, var_core_value_sig7D40, var_core_value_sig015D[var_core_value_sig7D1B] + var_core_value_sig780B - var_core_value_sig8E1C / 2, var_core_value_sig8E1C));
  }), var_core_value_sigD719;
}
function Qa(var_core_value_sigF7CE, var_core_value_sig7CF1, var_core_value_sigA552, var_core_value_sigAE32) {
  let var_core_value_sig9B4D = 10 / var_core_value_sigAE32,
    var_core_value_sig2704 = ao(var_core_value_sigF7CE);
...
function $a(var_core_value_sigD0CC, var_core_value_sigF347, var_core_value_sig80C6, var_core_value_sigEBFB) {
  ...
  return var_core_value_sigD0CC.columnWidths["flatMap"]((var_core_value_sigCA05, var_core_value_sig2F2B) => {
    ...
    return co(var_core_value_sigF347, var_core_value_sigD04E) ? [{
      kind: "column-header",
...
function eo(var_core_value_sigAE58, var_core_value_sig8E13, var_core_value_sig3AAF, var_core_value_sig134E) {
  let var_core_value_sigA3C0 = 6 / var_core_value_sig134E,
    ...
    var_core_value_sig9797 = ao(var_core_value_sigAE58);
...
function to(var_core_value_sig8533, var_core_value_sig57C5, var_core_value_sig0DE9, var_core_value_sigB00D) {
  ...
  return (var_core_value_sig8533.columnWidths["length"] === 0 ? [] : [{
    ...
    let var_core_value_sigBE5E = co(var_core_value_sig57C5, {
...
function no(var_core_value_sig7D59, var_core_value_sig5863, var_core_value_sig5BE7, var_core_value_sigC74A) {
  let var_core_value_sig8F6A = io(var_core_value_sig7D59),
    var_core_value_sig46EA = uo(var_core_value_sig7D59, var_core_value_sig5863).map(var_core_value_sig0281 => po(var_core_value_sig7D59, var_core_value_sig0281.startColumn, var_core_value_sig0281.endColumn)).filter(var_core_value_sigED71 => !!var_core_value_sigED71).sort((var_core_value_sig281C, var_core_value_sig3C92) => var_core_value_sig281C[0] - var_core_value_sig3C92[0]);
  return ho([var_core_value_sig8F6A.x, var_core_value_sig8F6A.x + var_core_value_sig8F6A.width], var_core_value_sig46EA).map(([var_core_value_sigB16B, var_core_value_sig585D]) => ({
    kind: "resize-row",
...
function ro(var_core_value_sig626C, var_core_value_sig9077, var_core_value_sigC76C, var_core_value_sigB23A) {
  if (!so(io(var_core_value_sig626C), var_core_value_sigC76C, var_core_value_sigC76C + var_core_value_sigB23A)) return [];
  let var_core_value_sigBA66 = fo(var_core_value_sig626C, var_core_value_sig9077).map(var_core_value_sigE722 => mo(var_core_value_sig626C, var_core_value_sigE722.startRow, var_core_value_sigE722.endRow)).filter(var_core_value_sig062A => !!var_core_value_sig062A).sort((var_core_value_sig050A, var_core_value_sig8B32) => var_core_value_sig050A[0] - var_core_value_sig8B32[0]);
  return ho([var_core_value_sig626C.tableRect["y"], var_core_value_sig626C.tableRect["y"] + var_core_value_sig626C.tableRect["height"]], var_core_value_sigBA66).map(([var_core_value_sig870F, var_core_value_sigB683]) => ({
    kind: "resize-column",
...
function io(var_core_value_sig3DF0) {
...
function ao(var_core_value_sigDF88) {
  return var_core_value_sigDF88.viewport ? oo(var_core_value_sigDF88, var_core_value_sigDF88.tableRect["x"]) : var_core_value_sigDF88.tableRect["x"];
}
function oo(var_core_value_sigDB93, var_core_value_sig67CF) {
...
function so(var_core_value_sig6C5E, var_core_value_sig4997, var_core_value_sig7290) {
...
function co(var_core_value_sigE835, var_core_value_sig4644) {
...
function lo(var_core_value_sig120E) {
  return Ya.has(var_core_value_sig120E);
}
function uo(var_core_value_sigD79B, var_core_value_sig92A3) {
...
function fo(var_core_value_sig8D1B, var_core_value_sigA915) {
...
function po(var_core_value_sig4BE7, var_core_value_sigF9FF, var_core_value_sigE0E3) {
  let var_core_value_sig3AB3 = yo(var_core_value_sig4BE7.columnIndices, var_core_value_sigF9FF),
    var_core_value_sig816E = yo(var_core_value_sig4BE7.columnIndices, var_core_value_sigE0E3);
  ...
  return [oo(var_core_value_sig4BE7, var_core_value_sig4BE7.tableRect["x"] + bo(var_core_value_sig4BE7.columnWidths["slice"](0, var_core_value_sigE6F3))), oo(var_core_value_sig4BE7, var_core_value_sig4BE7.tableRect["x"] + bo(var_core_value_sig4BE7.columnWidths["slice"](0, var_core_value_sig3EE1 + 1)))];
}
function mo(var_core_value_sig9673, var_core_value_sig4917, var_core_value_sig3BE6) {
  let var_core_value_sigA1C9 = yo(var_core_value_sig9673.rowIndices, var_core_value_sig4917),
    var_core_value_sig77D6 = yo(var_core_value_sig9673.rowIndices, var_core_value_sig3BE6);
  ...
  return [var_core_value_sig9673.tableRect["y"] + bo(var_core_value_sig9673.rowHeights["slice"](0, var_core_value_sigE3CE)), var_core_value_sig9673.tableRect["y"] + bo(var_core_value_sig9673.rowHeights["slice"](0, var_core_value_sig219B + 1))];
}
function ho(var_core_value_sig4493, var_core_value_sig8B9C) {
...
function go(var_core_value_sig82DD, var_core_value_sigAAC7, var_core_value_sig1999) {
  return [...var_core_value_sig82DD].sort((var_core_value_sigF7EF, var_core_value_sig27F9) => Co(var_core_value_sig27F9) - Co(var_core_value_sigF7EF)).find(var_core_value_sig393E => To(var_core_value_sig393E.rect, var_core_value_sigAAC7, var_core_value_sig1999)) ?? null;
}
function _o(var_core_value_sigFB45, var_core_value_sigB86C, var_core_value_sigD892) {
  return [...var_core_value_sigFB45].filter(var_core_value_sigB609 => So(var_core_value_sigB609.kind)).sort((var_core_value_sig390D, var_core_value_sigC928) => Co(var_core_value_sigC928) - Co(var_core_value_sig390D)).find(var_core_value_sig39B7 => Eo(var_core_value_sig39B7.rect, var_core_value_sigB86C, var_core_value_sigD892, 6)) ?? null;
}
function vo(var_core_value_sig6086, var_core_value_sigAED2, var_core_value_sig3516) {
  return [...var_core_value_sig6086].filter(var_core_value_sig18E0 => lo(var_core_value_sig18E0.kind)).sort((var_core_value_sigE161, var_core_value_sigBDEE) => Co(var_core_value_sigBDEE) - Co(var_core_value_sigE161)).find(var_core_value_sig1F40 => Eo(var_core_value_sig1F40.rect, var_core_value_sigAED2, var_core_value_sig3516, 6)) ?? null;
}
function yo(var_core_value_sigCDCD, var_core_value_sig206A) {
...
function bo(var_core_value_sig1EFE) {
...
function xo(var_core_value_sig9904, var_core_value_sig39C7, var_core_value_sigA022) {
  return _o(var_core_value_sig9904, var_core_value_sig39C7, var_core_value_sigA022) != null;
}
function So(var_core_value_sig913A) {
  return Xa.has(var_core_value_sig913A);
}
function Co(var_core_value_sig991D) {
...
function wo(var_core_value_sig3E9C, var_core_value_sig7835) {
...
function To(var_core_value_sigBFA3, var_core_value_sig6663, var_core_value_sigB250) {
...
function Eo(var_core_value_sig4EAB, var_core_value_sig2FD0, var_core_value_sig035C, var_core_value_sigA7F0) {
...
const Do = "viewMain",
  ...
  No = "#b8bec6",
  Po = new Map();
function Fo(var_core_value_sig6AE2, var_core_value_sigFD17) {
  let var_core_value_sigA5E0 = Po.get(var_core_value_sig6AE2);
...
function Io(var_core_value_sigC38F, var_core_value_sigFAFE) {
  let var_core_value_sig2B86 = Po.get(var_core_value_sigC38F) ?? [];
  return var_core_value_sig2B86.push(var_core_value_sigFAFE), Po.set(var_core_value_sigC38F, var_core_value_sig2B86), Po.size === 1 && var_core_value_sig2B86.length === 1 && var_core_value_sig7F54(Fo), {
    dispose: () => {
      let var_core_value_sigEB6A = Po.get(var_core_value_sigC38F);
      if (!var_core_value_sigEB6A) return;
      let var_core_value_sig3D46 = var_core_value_sigEB6A.indexOf(var_core_value_sigFAFE);
      var_core_value_sig3D46 >= 0 && var_core_value_sigEB6A.splice(var_core_value_sig3D46, 1), var_core_value_sigEB6A.length === 0 && Po.delete(var_core_value_sigC38F), Po.size === 0 && var_core_value_sig7F54(null);
    }
  };
}
let Lo = class extends var_core_value_sig34F8 {
  constructor(var_core_value_sigCC93, var_core_value_sig5964, var_core_value_sig808B, var_core_value_sig2A26, var_core_value_sig1179, var_core_value_sigEA92, var_core_value_sig8FD9, var_core_value_sig1AE5, var_core_value_sig7100, var_core_value_sigA19A, var_core_value_sigD3F5, var_core_value_sig3082, var_core_value_sigF5D1, var_core_value_sig8775, var_core_value_sig481B, var_core_value_sig13D7, var_core_value_sig90C0) {
    ...
    let var_core_value_sigF1B2 = Io(this._context["unitId"], (var_core_value_sigE92A, var_core_value_sig362B) => this._getOrCreateViewportState(var_core_value_sigE92A, var_core_value_sig362B)),
    ...
    this.disposeWithMe(this._docEventManagerService["hoverTableRealTime$"].subscribe(var_core_value_sigE90F => {
      if (!(!var_core_value_sigE90F && (this._dragState || this._moveDragState || this._rowColumnMoveState || this._scrollbarDragState || this._selectionDragState || this._headerSelectionDragState))) {
        if (var_core_value_sigE90F && this._shouldKeepActiveTableForSelection()) {
          ...
          if (var_core_value_sig96F5(var_core_value_sigE90F.tableId).tableId !== ((var_core_value_sigEFD4 = this._selection) == null ? undefined : var_core_value_sigEFD4.tableId)) {
            this._makeDirty();
            return;
          }
        }
  ...
  _initTableLayoutRefresh() {
    ...
    this.disposeWithMe(this._docSkeletonManagerService["currentSkeleton$"].subscribe(var_core_value_sigD9DB)), this.disposeWithMe(this._docSkeletonManagerService["currentSkeleton$"].pipe(var_core_value_sigA1B6(var_core_value_sig861B => (var_core_value_sig861B == null ? undefined : var_core_value_sig861B.dirty$) ?? var_core_value_sigB5D7)).subscribe(var_core_value_sigD9DB));
  }
  _refreshTableLayoutState() {
    ...
    let var_core_value_sig770E = this._docParagraphMenuService["activeTarget"],
      var_core_value_sig4654 = (var_core_value_sig770E == null ? undefined : var_core_value_sig770E.kind) === var_core_value_sig9F3D.TABLE ? (var_core_value_sigFBA5 = var_core_value_sig770E.table) == null ? undefined : var_core_value_sigFBA5.tableId : undefined;
  ...
  _initZoomStateReset() {
    this.disposeWithMe(this._commandService["onCommandExecuted"](var_core_value_sig7E54 => {
      ...
      if (var_core_value_sig7E54.id !== var_core_value_sigD7F4.id) return;
  ...
  _initPointerEvents() {
    let var_core_value_sigB26B = Ho(this._context);
    this.disposeWithMe(Aa(({
      ...
      next: ([var_core_value_sig48CA, var_core_value_sig50AF]) => {
        ...
        if (this._lastPointerPoint = var_core_value_sigA942, this._selectionDragState && !Go(var_core_value_sig48CA) && (this._selectionDragState = null, this._stopSelectionDragAutoScroll()), this._activeTable ||= this._buildActiveTableAtPoint(var_core_value_sigA942.x, var_core_value_sigA942.y), this._moveDragState) {
          ...
          this._moveDragPreview = var_core_value_sig8061 >= 4 ? Da(this._moveDragState, var_core_value_sigA942.x, var_core_value_sigA942.y) : null, this._moveDropTarget = this._moveDragPreview ? this._getTableDropTargetAtPoint(var_core_value_sigA942.x, var_core_value_sigA942.y) : null, this._setTableCursor(var_core_value_sigD85C.MOVE), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, var_core_value_sig48CA.preventDefault(), this._makeDirty();
          return;
        }
        if (this._scrollbarDragState) {
          this._updateScrollbarDrag(var_core_value_sigA942.x), this._setTableCursor(var_core_value_sigD85C.POINTER), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, var_core_value_sig48CA.preventDefault(), this._makeDirty();
          return;
        }
        if (this._pendingHandleSelection) {
          ...
          }, var_core_value_sigA942, 4) || (this._rowColumnMoveState = this._createRowColumnMoveState(this._pendingHandleSelection), this._rowColumnMoveTarget = this._getRowColumnMoveTarget(var_core_value_sigA942), this._pendingHandleSelection = null, this._setTableCursor(var_core_value_sigD85C.MOVE), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, var_core_value_sig48CA.preventDefault(), this._makeDirty());
          return;
        }
        if (this._dragState) {
          this._dragPreview = Na(this._dragState, var_core_value_sigA942.x, var_core_value_sigA942.y), this._setResizeCursor(this._dragState["trigger"]), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, var_core_value_sig48CA.preventDefault(), this._makeDirty();
          return;
        }
        ...
        this._headerSelectionDragState && (Go(var_core_value_sig48CA) ? this._updateHeaderSelectionDrag(var_core_value_sigA942) : (this._headerSelectionDragState = null, this._selectionService["setNativeSelectionSuppressed"](false)));
        ...
        if (var_core_value_sigA621) {
          ...
          }), this._setTableCursor(var_core_value_sigD85C.POINTER), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, this._makeDirty();
          return;
        }
        if (this._hitSortOption(var_core_value_sigA942.x, var_core_value_sigA942.y)) {
          this._setTooltip(null), this._setTableCursor(var_core_value_sigD85C.POINTER), var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, this._makeDirty();
          return;
        }
        ...
        var_core_value_sig50AF.stopPropagation(), var_core_value_sig50AF.skipNextObservers = true, var_core_value_sigBBFF.kind === "resize-column" || var_core_value_sigBBFF.kind === "resize-row" ? this._setResizeCursor(var_core_value_sigBBFF) : this._setTableCursor(var_core_value_sigD85C.POINTER);
      },
      priority: ko
      ...
      next: ([var_core_value_sig32F8, var_core_value_sig5B67]) => {
        ...
        if (var_core_value_sig9989 && this._sortPopover) {
          var_core_value_sig5B67.stopPropagation(), var_core_value_sig5B67.skipNextObservers = true, var_core_value_sig32F8.stopPropagation(), var_core_value_sig32F8.preventDefault(), this._selectColumn(this._sortPopover["tableId"], this._sortPopover["column"]), this._commandService["executeCommand"](var_core_value_sig6085.id, {
        ...
        if (this._selectionDragState = null, this._stopSelectionDragAutoScroll(), var_core_value_sig5B67.stopPropagation(), var_core_value_sig5B67.skipNextObservers = true, var_core_value_sig32F8.stopPropagation(), var_core_value_sig32F8.preventDefault(), var_core_value_sig698E.kind === "resize-column" || var_core_value_sig698E.kind === "resize-row") {
          ...
          this._selectionService["setNativeSelectionSuppressed"](true), this._pendingHandleSelection = null, this._selectionService["clearStructuralSelection"](), this._dragState = Ma(var_core_value_sig698E, var_core_value_sig4805.x, var_core_value_sig4805.y, var_core_value_sig76BA), this._dragSourceTableId = var_core_value_sig2809, this._dragPreview = Na(this._dragState, var_core_value_sig4805.x, var_core_value_sig4805.y), this._setResizeCursor(var_core_value_sig698E), this._makeDirty();
          return;
        }
        if (var_core_value_sig698E.kind === "table-select") {
          if (!this._activeTable) return;
          this._selectionService["setNativeSelectionSuppressed"](true), this._moveDragState = Ea(var_core_value_sig698E, var_core_value_sig4805.x, var_core_value_sig4805.y, this._activeTable["input"].tableRect), this._moveDragSourceTableId = var_core_value_sig2809, this._moveDragPreview = null, this._moveDropTarget = null, this._closeBorderPopover(), this._sortPopover = null, this._setTableCursor(var_core_value_sigD85C.MOVE), this._makeDirty();
          return;
        }
      ...
      next: ([var_core_value_sigE9A7, var_core_value_sigBECE]) => {
        ...
        !var_core_value_sig7F72 || !Z(Y(var_core_value_sig7F72.input), var_core_value_sig1B22.x, var_core_value_sig1B22.y) || this._viewportService["applyWheel"](this._context["unitId"], var_core_value_sig7F72.sourceTableId, {
  ...
  _handleEmbedPassiveWheel(var_core_value_sig019B) {
    ...
    if (!var_core_value_sig8EC2 || !Z(Y(var_core_value_sig8EC2.input), var_core_value_sigC6BC.x, var_core_value_sigC6BC.y)) return false;
    ...
    if (var_core_value_sig031B && (this._lastPointerPoint = var_core_value_sig031B, !(this._selectionDragState && (Go(var_core_value_sig5276) ? this._updateSelectionDrag(var_core_value_sig031B) || this._updateSelectionDragAutoScroll(var_core_value_sig031B) : (this._selectionDragState = null, this._stopSelectionDragAutoScroll()), !this._dragState && !this._moveDragState && !this._rowColumnMoveState && !this._pendingHandleSelection && !this._scrollbarDragState)) && !(this._headerSelectionDragState && (Go(var_core_value_sig5276) ? this._updateHeaderSelectionDrag(var_core_value_sig031B) : (this._headerSelectionDragState = null, this._selectionService["setNativeSelectionSuppressed"](false)), !this._dragState && !this._moveDragState && !this._rowColumnMoveState && !this._pendingHandleSelection && !this._scrollbarDragState)))) {
      ...
      if (this._pendingHandleSelection) {
        Ta({
          x: this._pendingHandleSelection["startX"],
          y: this._pendingHandleSelection["startY"]
        }, var_core_value_sig031B, 4) || (this._rowColumnMoveState = this._createRowColumnMoveState(this._pendingHandleSelection), this._rowColumnMoveTarget = this._getRowColumnMoveTarget(var_core_value_sig031B), this._pendingHandleSelection = null, this._setTableCursor(var_core_value_sigD85C.MOVE), this._makeDirty());
        return;
      }
      if (this._rowColumnMoveState) {
        Go(var_core_value_sig5276) ? (this._rowColumnMoveTarget = this._getRowColumnMoveTarget(var_core_value_sig031B), this._setTableCursor(var_core_value_sigD85C.MOVE)) : (this._rowColumnMoveState = null, this._rowColumnMoveTarget = null, this._restoreTableCursor()), this._makeDirty();
        return;
      }
      if (this._moveDragState) {
        ...
        this._moveDragPreview = var_core_value_sigFBFA >= 4 ? Da(this._moveDragState, var_core_value_sig031B.x, var_core_value_sig031B.y) : null, this._moveDropTarget = this._moveDragPreview ? this._getTableDropTargetAtPoint(var_core_value_sig031B.x, var_core_value_sig031B.y) : null, this._setTableCursor(var_core_value_sigD85C.MOVE), this._makeDirty();
        return;
      }
      this._dragState && (this._dragPreview = Na(this._dragState, var_core_value_sig031B.x, var_core_value_sig031B.y), this._setResizeCursor(this._dragState["trigger"]), this._makeDirty());
    }
  }
  _getDocumentPointFromWindowEvent(var_core_value_sig9DC0) {
    ...
    if (!ts(var_core_value_sig9DC0)) return null;
    ...
    return var_core_value_sigB977 ? Uo(var_core_value_sig9DC0.clientX - var_core_value_sigB977.left, var_core_value_sig9DC0.clientY - var_core_value_sigB977.top, this._context["scene"]) : null;
  }
  _getDocumentPointFromPointerEvent(var_core_value_sig2949) {
    return this._getDocumentPointFromWindowEvent(var_core_value_sig2949) ?? Uo(var_core_value_sig2949.offsetX, var_core_value_sig2949.offsetY, this._context["scene"]);
  }
  ...
  _releaseMoveDrag(var_core_value_sig218A, var_core_value_sig14CB) {
    if (var_core_value_sig14CB && this._moveDragState && this._moveDragSourceTableId) {
      let var_core_value_sig7B2A = var_core_value_sig218A ? Math.hypot(var_core_value_sig218A.x - this._moveDragState["startX"], var_core_value_sig218A.y - this._moveDragState["startY"]) : 0,
        var_core_value_sig06CD = this._moveDragPreview ?? (var_core_value_sig218A && var_core_value_sig7B2A >= 4 ? Da(this._moveDragState, var_core_value_sig218A.x, var_core_value_sig218A.y) : null),
      ...
      var_core_value_sigA5F1 ? this._commandService["executeCommand"](var_core_value_sig555A.id, {
        tableId: this._moveDragSourceTableId,
        targetOffset: var_core_value_sigA5F1.targetOffset
      }) : !var_core_value_sig06CD && Ta({
  ...
  _releaseHandleSelection(var_core_value_sigA70D, var_core_value_sigCE10) {
    ...
    var_core_value_sigCE10 && var_core_value_sigA3861 && Ta({
  ...
  _releaseRowColumnMove(var_core_value_sigCD82, var_core_value_sig44DD) {
    ...
    var_core_value_sig44DD && var_core_value_sig96FA && var_core_value_sigAB68 && var_core_value_sigAB68.index !== var_core_value_sig96FA.sourceIndex && (var_core_value_sig96FA.type === "row" ? this._commandService["executeCommand"](var_core_value_sig8063.id, {
      count: 1,
    ...
    }) : this._commandService["executeCommand"](var_core_value_sig62F3.id, {
      count: 1,
  ...
  _releaseResizeDrag(var_core_value_sig040A, var_core_value_sig2AE0) {
    let var_core_value_sigC349 = this._dragState ? Pa(this._dragState, this._dragPreview ?? null, var_core_value_sig040A ?? null) : this._dragPreview,
      var_core_value_sig9D96 = this._dragSourceTableId;
    var_core_value_sig2AE0 && var_core_value_sigC349 && var_core_value_sig9D96 && (var_core_value_sigC349.column != null && var_core_value_sigC349.width != null ? this._executeCommandAndRefreshActiveTable(var_core_value_sigF562.id, {
      column: var_core_value_sigC349.column,
      tableId: var_core_value_sig9D96,
      width: var_core_value_sigC349.width
    }, var_core_value_sig9D96) : var_core_value_sigC349.row != null && var_core_value_sigC349.height != null && this._executeCommandAndRefreshActiveTable(var_core_value_sig5913.id, {
  ...
  _openBorderPopover(var_core_value_sig2776) {
    ...
    let var_core_value_sig6FB2 = ds().map(({
  ...
  _ensureFloatingMenuPopup(var_core_value_sig4186) {
    let var_core_value_sigF963 = ss(var_core_value_sig4186 ?? this._floatingMenuService["getState"]().anchorRect ?? null);
  ...
  _applyBorderPreset(var_core_value_sigF866) {
    ...
    var_core_value_sig5EFB && (this._selectionService["setStructuralSelection"]({
      kind: var_core_value_sig5EFB.startRow === var_core_value_sig5EFB.endRow && var_core_value_sig5EFB.startColumn === var_core_value_sig5EFB.endColumn ? var_core_value_sigA1AF.Cell : var_core_value_sigA1AF.Range,
    ...
    }), this._commandService["executeCommand"](var_core_value_sig2EB2.id, {
      endColumn: var_core_value_sig5EFB.endColumn,
      endRow: var_core_value_sig5EFB.endRow,
  ...
  _handleTableContextMenuPointerDown(var_core_value_sig2682, var_core_value_sig4BB5) {
    ...
    let var_core_value_sigC030 = this._hitTest(var_core_value_sig52CA.x, var_core_value_sig52CA.y),
      ...
      var_core_value_sig5542 = is(var_core_value_sigC030);
    if (var_core_value_sig88F6 && var_core_value_sig5542) {
      if (!as(var_core_value_sig37DB, var_core_value_sig88F6, var_core_value_sig5542.axis, var_core_value_sig5542.index)) {
    ...
    return !var_core_value_sigA73E || !rs(var_core_value_sig37DB, var_core_value_sigA73E) ? false : (this._openTableContextMenu(var_core_value_sig2682, var_core_value_sig4BB5), true);
  }
  _openTableContextMenu(var_core_value_sig7620, var_core_value_sigB9FC) {
    this._consumePointerEvent(var_core_value_sigB9FC), var_core_value_sig7620.preventDefault(), this._contextMenuService["triggerContextMenu"](var_core_value_sig7620, var_core_value_sig9B13.MAIN_AREA, {
  ...
  _handleStructuralInsertTrigger(var_core_value_sig1F18, var_core_value_sigD5A0) {
    if (var_core_value_sig1F18.kind === "row-insert-dot" && var_core_value_sig1F18.row != null) {
      this._executeCommandAndRefreshActiveTable(var_core_value_sigAF94.id, {
        count: 1,
    ...
    var_core_value_sig1F18.kind === "column-insert-dot" && var_core_value_sig1F18.column != null && this._executeCommandAndRefreshActiveTable(var_core_value_sigA64C.id, {
  ...
  _buildActiveTable(var_core_value_sig00BE) {
    ...
    let {
      ...
      var_core_value_sigA694 = var_core_value_sig96F5(var_core_value_sig00BE.tableId).tableId,
      var_core_value_sig18E01 = Ro(var_core_value_sig1157),
      var_core_value_sig0428 = var_core_value_sig1157.rows["map"](var_core_value_sigCE71 => var_core_value_sigCE71.height),
      var_core_value_sigBE07 = X(var_core_value_sig18E01),
    ...
    return {
      ...
      input: {
        ...
        mergedCells: zo(var_core_value_sig1157),
  ...
  _collectSkeletonTables() {
    let var_core_value_sig8DFE = this._docSkeletonManagerService["getSkeleton"]().getSkeletonData(),
      ...
      var_core_value_sig5E16 = Bo(this._context["mainComponent"]);
    return var_core_value_sig7C31(var_core_value_sig48EA, {
  ...
  _syncViewportStatesFromSkeleton() {
    ...
    for (let var_core_value_sigE627 of this._collectSkeletonTables()) {
      let var_core_value_sigF602 = var_core_value_sig96F5(var_core_value_sigE627.tableId).tableId;
      var_core_value_sig6D19.add(var_core_value_sigF602);
      let var_core_value_sig1BBD = X(Ro(var_core_value_sigE627.table)),
      ...
      }), var_core_value_sig4169 ||= Qo(var_core_value_sigF704, var_core_value_sig2BCF);
    }
  ...
  _syncViewportStateForSourceTable(var_core_value_sig279C) {
    ...
    if (var_core_value_sig8986) return this._syncViewportState(var_core_value_sigAC51, var_core_value_sig279C, var_core_value_sig8986.page, var_core_value_sig8986.table, X(Ro(var_core_value_sig8986.table)));
  }
  ...
  _findTableSliceForSource(var_core_value_sig957F) {
    ...
    for (let var_core_value_sig273D of this._collectSkeletonTables()) var_core_value_sig96F5(var_core_value_sig273D.tableId).tableId === var_core_value_sig957F && var_core_value_sig803B.push({
  ...
  _isSourceTableSplitAcrossPages(var_core_value_sig5830) {
    ...
    for (let var_core_value_sig223F of this._collectSkeletonTables()) if (var_core_value_sig96F5(var_core_value_sig223F.tableId).tableId === var_core_value_sig5830 && (var_core_value_sig4A7C++, var_core_value_sig4A7C > 1)) return true;
    return false;
  }
  _isPointInTableControlRect(var_core_value_sigF975, var_core_value_sigCDAF, var_core_value_sigA298) {
    ...
    let var_core_value_sig330B = this._getCurrentZoom(),
      var_core_value_sig3625 = Ro(var_core_value_sig0B40.table).reduce((var_core_value_sigD749, var_core_value_sigCFFA) => var_core_value_sigD749 + var_core_value_sigCFFA, 0),
    ...
    return !!var_core_value_sigE5BA && Wa(var_core_value_sigE5BA, var_core_value_sigF975.rect["bottom"], var_core_value_sigCDAF, var_core_value_sigA298);
  }
  ...
  _hitTest(var_core_value_sigB495, var_core_value_sig70D0) {
    ...
    let var_core_value_sig2A8A = Za(this._getTriggerInput()),
      var_core_value_sig3782 = go(var_core_value_sig2A8A, var_core_value_sigB495, var_core_value_sig70D0);
    return (var_core_value_sig3782 == null ? undefined : var_core_value_sig3782.kind) === "resize-column" || (var_core_value_sig3782 == null ? undefined : var_core_value_sig3782.kind) === "resize-row" ? var_core_value_sig3782 : vo(var_core_value_sig2A8A, var_core_value_sigB495, var_core_value_sig70D0) ?? var_core_value_sig3782;
  }
  _hitTestHoverTrigger(var_core_value_sigD22E, var_core_value_sig3455) {
    if (!this._canEditDocument() || !this._activeTable) return null;
    let var_core_value_sig5CEF = Za(this._getTriggerInput()),
      var_core_value_sig43D5 = go(var_core_value_sig5CEF, var_core_value_sigD22E, var_core_value_sig3455);
    return (var_core_value_sig43D5 == null ? undefined : var_core_value_sig43D5.kind) === "resize-column" || (var_core_value_sig43D5 == null ? undefined : var_core_value_sig43D5.kind) === "resize-row" ? var_core_value_sig43D5 : _o(var_core_value_sig5CEF, var_core_value_sigD22E, var_core_value_sig3455) ?? var_core_value_sig43D5;
  }
  _hitScrollbar(var_core_value_sig1395, var_core_value_sig9FA0) {
    let var_core_value_sig055E = this._getScrollbarGeometry();
    return var_core_value_sig055E ? Ua(var_core_value_sig055E, var_core_value_sig1395, var_core_value_sig9FA0) : null;
  }
  ...
  _buildScrollbarGeometry(var_core_value_sig7C77) {
    ...
    return var_core_value_sig9578 ? Ha({
  ...
  _getScrollbarAppearance() {
    ...
    return var_core_value_sigA2D31 && Ua(var_core_value_sigA2D31, this._lastPointerPoint["x"], this._lastPointerPoint["y"]) ? "hover" : "idle";
  }
  _startOrJumpScrollbar(var_core_value_sigC218, var_core_value_sigADEC) {
    ...
    if (var_core_value_sigC218 === "thumb") {
      ...
      }, this._setTableCursor(var_core_value_sigD85C.POINTER), this._makeDirty();
      return;
    }
  ...
  _updateSelectionDrag(var_core_value_sigC545) {
    ...
    return var_core_value_sig12A7.structural = true, var_core_value_sigE837 && this._docSelectionRenderService["cancelPointerSelection"](), this._selectionService["setNativeSelectionSuppressed"](true), this._selectionService["setStructuralSelection"]({
      kind: var_core_value_sigA021 === var_core_value_sig49D9 && var_core_value_sig320C === var_core_value_sigE7F0 ? var_core_value_sigA1AF.Cell : var_core_value_sigA1AF.Range,
  ...
  _updateSelectionDragAutoScroll(var_core_value_sig34F4) {
    ...
    let var_core_value_sig1BC7 = Y(this._activeTable["input"]);
  ...
  _syncFloatingMenuFromSelection() {
    ...
    if (!(var_core_value_sig4956 != null && var_core_value_sig4956.tableId) || !this._canEditDocument(var_core_value_sig4956.tableId) || !ns(var_core_value_sig4956)) {
      this._floatingMenuService["hide"](), this._hideFloatingMenuPopup();
      return;
    }
    let var_core_value_sigCC9E = os(var_core_value_sig4956) ? this._getStructuralFloatingMenuAnchorRect(var_core_value_sig4956) : this._getFloatingMenuAnchorRect(var_core_value_sig4956),
    ...
    let var_core_value_sigE42E = var_core_value_sig4956.kind === var_core_value_sigA1AF.Row ? "row" : var_core_value_sig4956.kind === var_core_value_sigA1AF.Column ? "column" : null,
  ...
  _canEditDocument(var_core_value_sigBF4C = (() => {
    ...
    return var_core_value_sig5E75(this._permissionService, this._context["unitId"], var_core_value_sigBF4C ? [...var_core_value_sigC266(this._context["unit"], "", "table", var_core_value_sigBF4C), var_core_value_sig77A3("", "table", var_core_value_sigBF4C)] : []);
  }
  _syncParagraphTableMenuFromActiveTable() {
    let var_core_value_sig3457 = this._activeTable;
    if (!var_core_value_sig3457) return;
    let var_core_value_sig4A08 = Y(var_core_value_sig3457.input);
  ...
  _isPointWithinStructuralControlZone(var_core_value_sig7C65, var_core_value_sig7F05) {
    ...
    let var_core_value_sig6E78 = this._activeTable["input"],
      ...
      var_core_value_sigC50A = Y(var_core_value_sig6E78),
      var_core_value_sig11D0 = qo(var_core_value_sig6E78),
      var_core_value_sigB8ED = Jo(var_core_value_sig6E78);
    if (Z({
    ...
    return !!var_core_value_sig8EAE && Wa(var_core_value_sig8EAE, var_core_value_sigC50A.y + var_core_value_sigC50A.height, var_core_value_sig7C65, var_core_value_sig7F05);
  }
  _shouldKeepActiveTableForSelection() {
    let var_core_value_sig1CDD = this._selection;
    return !!this._activeTable && !!(var_core_value_sig1CDD != null && var_core_value_sig1CDD.tableId) && var_core_value_sig1CDD.tableId === this._activeTable["sourceTableId"] && (var_core_value_sig1CDD.kind === var_core_value_sigA1AF.Row || var_core_value_sig1CDD.kind === var_core_value_sigA1AF.Column || var_core_value_sig1CDD.kind === var_core_value_sigA1AF.Table || ns(var_core_value_sig1CDD));
  }
  ...
  _selectTable(var_core_value_sig0E54) {
    ...
    this._selectionService["setStructuralSelection"]({
      kind: var_core_value_sigA1AF.Table,
      segmentId: this._activeTable["segmentId"],
  ...
  _selectRow(var_core_value_sig737C, var_core_value_sig5AF5) {
    ...
    this._selectionService["setStructuralSelection"]({
      kind: var_core_value_sigA1AF.Row,
      segmentId: this._activeTable["segmentId"],
  ...
  _shouldPreserveFloatingHover(var_core_value_sig6E1C, var_core_value_sigFABC) {
    return this._activeTable ? xo(Za(this._getTriggerInput()), var_core_value_sig6E1C, var_core_value_sigFABC) || this._isPointWithinFloatingMenuHoverBridge(var_core_value_sig6E1C, var_core_value_sigFABC) || this._borderPopover && Z(cs(this._borderPopover), var_core_value_sig6E1C, var_core_value_sigFABC) ? true : this._sortPopover != null && Z(ls(this._sortPopover), var_core_value_sig6E1C, var_core_value_sigFABC) : false;
  }
  _isPointWithinFloatingMenuHoverBridge(var_core_value_sig413D, var_core_value_sig5BCE) {
    ...
    let var_core_value_sig78AC = this._getCurrentZoom(),
      ...
      var_core_value_sigD57D = Y(this._activeTable["input"]),
      var_core_value_sig2CC7 = qo(this._activeTable["input"]),
      var_core_value_sig4784 = Jo(this._activeTable["input"]),
  ...
  _getTableDropTargetAtPoint(var_core_value_sig77D8, var_core_value_sig78A3) {
    return wa(Array.from(this._docEventManagerService["paragraphBounds"].values()).flatMap(var_core_value_sigAD561 => {
  ...
  _drawStructuralHeaderBands(var_core_value_sig7428) {
    ...
    let var_core_value_sig1DCE = this._getTriggerInput(),
      ...
      var_core_value_sigA7F3 = Y(var_core_value_sig1DCE),
      var_core_value_sigEACD = qo(var_core_value_sig1DCE),
      var_core_value_sig901E = Jo(var_core_value_sig1DCE),
      var_core_value_sigF7BB = J({
  ...
  _drawStructuralHeaderTrigger(var_core_value_sig102B, var_core_value_sigA7DB) {
    let var_core_value_sig5EEE = J(var_core_value_sigA7DB.rect, this._context["scene"]),
  ...
  _drawSortPopover(var_core_value_sigA504) {
    ...
    let var_core_value_sig05FF = us(),
      var_core_value_sigFBF0 = J(ls(this._sortPopover), this._context["scene"]),
      var_core_value_sig2F95 = var_core_value_sigFBF0.height / var_core_value_sig05FF.length;
    var_core_value_sigA504.save(), var_core_value_sigA504.fillStyle = "#fff", var_core_value_sigA504.strokeStyle = Ao, var_core_value_sigA504.lineWidth = 1, var_core_value_sigA504.shadowColor = "rgba(60, 64, 67, 0.18)", var_core_value_sigA504.shadowBlur = 12, Zo(var_core_value_sigA504, var_core_value_sigFBF0.x, var_core_value_sigFBF0.y, var_core_value_sigFBF0.width, var_core_value_sigFBF0.height, 8), var_core_value_sigA504.fill(), var_core_value_sigA504.shadowBlur = 0, var_core_value_sigA504.stroke(), var_core_value_sigA504.font = "12px\x20Arial,\x20sans-serif", var_core_value_sigA504.fillStyle = jo, var_core_value_sig05FF.forEach((var_core_value_sig5A13, var_core_value_sigF593) => {
  ...
  _drawInsertTrigger(var_core_value_sig38C5, var_core_value_sigC87D) {
    let var_core_value_sigCCDC = J(var_core_value_sigC87D.rect, this._context["scene"]),
      ...
      var_core_value_sigDC07 = var_core_value_sigA4E8 ? q(var_core_value_sigA4E8.x, var_core_value_sigA4E8.y, this._context["scene"]) : {
  ...
  _drawInsertTriggerGuide(var_core_value_sigAA90, var_core_value_sigE92D) {
    ...
    let {
      ...
      var_core_value_sig682D = J(Y(var_core_value_sig9940), this._context["scene"]),
      var_core_value_sig1435 = q(Ko(var_core_value_sig9940), var_core_value_sig9940.tableRect["y"], this._context["scene"]).x,
      var_core_value_sig4082 = q(Jo(var_core_value_sig9940), var_core_value_sig9940.tableRect["y"], this._context["scene"]).x,
      var_core_value_sigC049 = this._getInsertTriggerDocumentCenter(var_core_value_sigE92D),
      var_core_value_sigE5C3 = var_core_value_sigC049 ? q(var_core_value_sigC049.x, var_core_value_sigC049.y, this._context["scene"]) : q(var_core_value_sigE92D.rect["x"] + var_core_value_sigE92D.rect["width"] / 2, var_core_value_sigE92D.rect["y"] + var_core_value_sigE92D.rect["height"] / 2, this._context["scene"]);
  ...
  _getTableAccentColor() {
    ...
    return ((var_core_value_sigCCAA = this._themeService) == null ? undefined : var_core_value_sigCCAA.getColorFromTheme("primary.600")) ?? Oo;
  }
  _getInsertTriggerDocumentCenter(var_core_value_sigF32D) {
    ...
    if (var_core_value_sigF32D.kind === "column-insert-dot" && var_core_value_sigF32D.column != null) {
      let var_core_value_sigF2E6 = $o(var_core_value_sig9427.columnIndices, var_core_value_sigF32D.column);
      return var_core_value_sigF2E6 < 0 ? null : {
        x: Xo(var_core_value_sig9427, X(var_core_value_sig9427.columnWidths["slice"](0, var_core_value_sigF32D.position === "left" ? var_core_value_sigF2E6 : var_core_value_sigF2E6 + 1))),
    ...
    if (var_core_value_sigF32D.kind === "row-insert-dot" && var_core_value_sigF32D.row != null) {
      let var_core_value_sig34C8 = $o(var_core_value_sig9427.rowIndices, var_core_value_sigF32D.row);
      return var_core_value_sig34C8 < 0 ? null : {
        x: var_core_value_sigF32D.rect["x"] + var_core_value_sigF32D.rect["width"] / 2,
        y: var_core_value_sig9427.tableRect["y"] + X(var_core_value_sig9427.rowHeights["slice"](0, var_core_value_sigF32D.position === "above" ? var_core_value_sig34C8 : var_core_value_sig34C8 + 1))
      };
    }
    return {
      x: var_core_value_sigF32D.rect["x"] + var_core_value_sigF32D.rect["width"] / 2,
  ...
  _getInsertTriggerIconRect(var_core_value_sig21F4, var_core_value_sigA345) {
    let var_core_value_sigA468 = this._getInsertTriggerDocumentCenter(var_core_value_sig21F4),
      var_core_value_sig1561 = J(var_core_value_sig21F4.rect, this._context["scene"]);
    if (!var_core_value_sigA468) return var_core_value_sig1561;
    let var_core_value_sigDF14 = q(var_core_value_sigA468.x, var_core_value_sigA468.y, this._context["scene"]),
  ...
  _drawTableSelectTrigger(var_core_value_sigC4C0, var_core_value_sig214A) {
    let var_core_value_sigCCC3 = J(var_core_value_sig214A.rect, this._context["scene"]);
    var_core_value_sigC4C0.save(), var_core_value_sigC4C0.fillStyle = "#fff", var_core_value_sigC4C0.strokeStyle = Ao, var_core_value_sigC4C0.lineWidth = 1, Zo(var_core_value_sigC4C0, var_core_value_sigCCC3.x, var_core_value_sigCCC3.y, var_core_value_sigCCC3.width, var_core_value_sigCCC3.height, 5), var_core_value_sigC4C0.fill(), var_core_value_sigC4C0.stroke(), this._drawSixDotDragHandle(var_core_value_sigC4C0, var_core_value_sigCCC3), var_core_value_sigC4C0.restore();
  }
  _isStructuralHeaderSelected(var_core_value_sig986E) {
    return !this._selection || !var_core_value_sig986E.tableId || this._selection["tableId"] !== var_core_value_sig986E.tableId ? false : var_core_value_sig986E.kind === "row-header" && var_core_value_sig986E.row != null ? this._selection["kind"] === var_core_value_sigA1AF.Row && var_core_value_sig986E.row >= this._selection["startRow"] && var_core_value_sig986E.row <= this._selection["endRow"] : var_core_value_sig986E.kind === "column-header" && var_core_value_sig986E.column != null && this._selection["kind"] === var_core_value_sigA1AF.Column && var_core_value_sig986E.column >= this._selection["startColumn"] && var_core_value_sig986E.column <= this._selection["endColumn"];
  }
  ...
  _drawSixDotDragHandle(var_core_value_sigBBBC, var_core_value_sig5440) {
    ...
    var_core_value_sigBBBC.save(), var_core_value_sigBBBC.fillStyle = No;
  ...
  _drawIconHoverBg(var_core_value_sigAF82, var_core_value_sig21A2, var_core_value_sig5C1D) {
    this._isSameTrigger(this._hoveredTrigger, var_core_value_sig5C1D) && (var_core_value_sigAF82.fillStyle = Mo, Zo(var_core_value_sigAF82, var_core_value_sig21A2.x - 2, var_core_value_sig21A2.y - 2, var_core_value_sig21A2.width + 4, var_core_value_sig21A2.height + 4, 5), var_core_value_sigAF82.fill());
  }
  _drawScrollbar(var_core_value_sig4CBA) {
    let var_core_value_sig8E65 = this._getScrollbarGeometry();
    var_core_value_sig8E65 && Ga(var_core_value_sig4CBA, Wo(var_core_value_sig8E65, this._context["scene"]));
  }
  _drawResizeGuide(var_core_value_sig772C, var_core_value_sigF309, var_core_value_sig44F9) {
    ...
    let var_core_value_sigF381 = J(var_core_value_sigE532, this._context["scene"]);
    var_core_value_sig772C.save(), var_core_value_sig772C.fillStyle = Oo, var_core_value_sig772C.globalAlpha = var_core_value_sig44F9, var_core_value_sig772C.fillRect(var_core_value_sigF381.x, var_core_value_sigF381.y, var_core_value_sigF381.width, var_core_value_sigF381.height), var_core_value_sig772C.restore();
  }
  _drawBorderPopover(var_core_value_sigCB92) {
    if (!this._borderPopover) return;
    let var_core_value_sigC844 = ds(),
      var_core_value_sig2ED4 = J(cs(this._borderPopover), this._context["scene"]),
      var_core_value_sig0477 = var_core_value_sig2ED4.width / 5,
      var_core_value_sig6FDF = var_core_value_sig2ED4.height / 2;
    var_core_value_sigCB92.save(), var_core_value_sigCB92.fillStyle = "#fff", var_core_value_sigCB92.strokeStyle = Ao, var_core_value_sigCB92.lineWidth = 1, var_core_value_sigCB92.shadowColor = "rgba(60,\x2064,\x2067,\x200.18)", var_core_value_sigCB92.shadowBlur = 12, Zo(var_core_value_sigCB92, var_core_value_sig2ED4.x, var_core_value_sig2ED4.y, var_core_value_sig2ED4.width, var_core_value_sig2ED4.height, 8), var_core_value_sigCB92.fill(), var_core_value_sigCB92.shadowBlur = 0, var_core_value_sigCB92.stroke(), var_core_value_sigC844.forEach((var_core_value_sigEAE2, var_core_value_sigE68A) => {
  ...
  _drawTooltip(var_core_value_sigBF1C) {
    ...
    var_core_value_sigBF1C.fillStyle = "rgba(32, 33, 36, 0.94)", Zo(var_core_value_sigBF1C, var_core_value_sigC8F6, var_core_value_sig8A26, var_core_value_sig674F, 28, 6), var_core_value_sigBF1C.fill(), var_core_value_sigBF1C.fillStyle = "#fff", var_core_value_sigBF1C.fillText(var_core_value_sigEEEF, var_core_value_sigC8F6 + 8, var_core_value_sig8A26 + 18), var_core_value_sigBF1C.restore();
  }
  _getCellAtPoint(var_core_value_sigD073, var_core_value_sigF631) {
    ...
    if (!this._activeTable || !Z(Y(this._activeTable["input"]), var_core_value_sigD073, var_core_value_sigF631)) return null;
    let {
        input: var_core_value_sig1E74,
        segmentId: var_core_value_sig1E84,
        sourceTableId: var_core_value_sig133B
      } = this._activeTable,
      var_core_value_sig69B8 = es(var_core_value_sig1E74.rowHeights, var_core_value_sigF631 - var_core_value_sig1E74.tableRect["y"]),
      var_core_value_sig983D = Yo(var_core_value_sig1E74, var_core_value_sigD073);
    if (var_core_value_sig983D == null) return null;
    let var_core_value_sig9A03 = es(var_core_value_sig1E74.columnWidths, var_core_value_sig983D);
  ...
  _updateHoverTarget(var_core_value_sigA790, var_core_value_sig9A5E) {
    ...
    let var_core_value_sig01B9 = this._getTriggerInput(),
      ...
      var_core_value_sig0FCF = Y(var_core_value_sig01B9),
      var_core_value_sigCF96 = qo(var_core_value_sig01B9),
      var_core_value_sigC4E9 = Jo(var_core_value_sig01B9),
  ...
  _getColumnAtX(var_core_value_sig8BFA) {
    ...
    let {
      ...
      var_core_value_sigFEA0 = Y(var_core_value_sig1951);
    ...
    let var_core_value_sig931A = Yo(var_core_value_sig1951, var_core_value_sig8BFA);
    if (var_core_value_sig931A == null) return null;
    let var_core_value_sigEE7D = es(var_core_value_sig1951.columnWidths, var_core_value_sig931A);
  ...
  _getRowMoveTargetAtY(var_core_value_sig6217) {
    ...
    let var_core_value_sig1FCC = es(var_core_value_sig4FAE.rowHeights, var_core_value_sig6217 - var_core_value_sig4FAE.tableRect["y"]);
    if (var_core_value_sig1FCC < 0) return null;
    let var_core_value_sigB7F9 = var_core_value_sig4FAE.tableRect["y"] + X(var_core_value_sig4FAE.rowHeights["slice"](0, var_core_value_sig1FCC)),
      ...
      var_core_value_sig59CE1 = Y(var_core_value_sig4FAE);
    return {
  ...
  _getColumnMoveTargetAtX(var_core_value_sig3AD7) {
    ...
    let {
      ...
      var_core_value_sig1475 = Y(var_core_value_sigD8F0);
    ...
    let var_core_value_sig08B7 = Yo(var_core_value_sigD8F0, var_core_value_sig3AD7);
    if (var_core_value_sig08B7 == null) return null;
    let var_core_value_sig2008 = es(var_core_value_sigD8F0.columnWidths, var_core_value_sig08B7);
    if (var_core_value_sig2008 < 0) return null;
    let var_core_value_sig496B = Xo(var_core_value_sigD8F0, X(var_core_value_sigD8F0.columnWidths["slice"](0, var_core_value_sig2008))),
  ...
  _getRowAtY(var_core_value_sig675A) {
    ...
    let var_core_value_sigB205 = es(var_core_value_sig9D6E.rowHeights, var_core_value_sig675A - var_core_value_sig9D6E.tableRect["y"]);
  ...
  _hitBorderPreset(var_core_value_sigBF78, var_core_value_sig8AF3) {
    ...
    let var_core_value_sigA0CC = cs(this._borderPopover);
    ...
    let var_core_value_sigB3A1 = Math.floor((var_core_value_sigBF78 - var_core_value_sigA0CC.x) / (var_core_value_sigA0CC.width / 5)),
      ...
      var_core_value_sig53A9 = ds()[var_core_value_sig1FB9 * 5 + var_core_value_sigB3A1];
  ...
  _buildTriggerTooltip(var_core_value_sigAD91) {
    ...
    let var_core_value_sigF64E = fs(var_core_value_sigAD91.kind);
  ...
  _getBorderPresetLabel(var_core_value_sig9B3D1) {
    let var_core_value_sigB217 = ps(var_core_value_sig9B3D1);
  ...
  _resolveFloatingMenuMergeAction(var_core_value_sig1FE6) {
    ...
    return var_core_value_sig2452(var_core_value_sig2471, var_core_value_sig1FE6.tableId, var_core_value_sig1FE6) ? "unmerge" : var_core_value_sig827F(var_core_value_sig2471, var_core_value_sig1FE6.tableId, var_core_value_sig1FE6) ? "merge" : null;
  }
  _resolveFloatingMenuTextStyle(var_core_value_sigD1FC) {
    return Si(this._context["unit"].getSnapshot(), var_core_value_sigD1FC);
  }
  ...
  _getSelectionRect(var_core_value_sigB411) {
    ...
    let {
      ...
      var_core_value_sigFE8D = $o(var_core_value_sigA81B.rowIndices, var_core_value_sigB411.startRow),
      var_core_value_sig8595 = $o(var_core_value_sigA81B.rowIndices, var_core_value_sigB411.endRow),
      var_core_value_sigF8DE = $o(var_core_value_sigA81B.columnIndices, var_core_value_sigB411.startColumn),
      var_core_value_sigFE76 = $o(var_core_value_sigA81B.columnIndices, var_core_value_sigB411.endColumn);
    ...
    return {
      x: Xo(var_core_value_sigA81B, X(var_core_value_sigA81B.columnWidths["slice"](0, var_core_value_sig84C8))),
      y: var_core_value_sigA81B.tableRect["y"] + X(var_core_value_sigA81B.rowHeights["slice"](0, var_core_value_sig22B4)),
      width: X(var_core_value_sigA81B.columnWidths["slice"](var_core_value_sig84C8, var_core_value_sig80C0 + 1)),
      height: X(var_core_value_sigA81B.rowHeights["slice"](var_core_value_sig22B4, var_core_value_sigBB37 + 1))
    };
  }
  _getResizeGuideRect(var_core_value_sig0C51) {
    return this._activeTable ? Fa(this._activeTable["input"], var_core_value_sig0C51, this._dragPreview ?? null) : null;
  }
  ...
  _buildViewportState(var_core_value_sig6B99, var_core_value_sig6ADC, var_core_value_sig41AD, var_core_value_sigDBC2, var_core_value_sig7739) {
    ...
    if (this._getDocumentFlavor() !== var_core_value_sig785C.MODERN || !Number.isFinite(var_core_value_sig6ADC.pageWidth) || var_core_value_sig6ADC.type === var_core_value_sig3957.CELL) return {
    ...
    let {
      ...
      var_core_value_sig6223 = Vo(this._context),
...
Lo = va([K(1, var_core_value_sig832A(var_core_value_sigF27A)), K(2, var_core_value_sig832A(var_core_value_sigCE75)), K(3, var_core_value_sig832A(var_core_value_sigF3C7)), K(4, var_core_value_sig832A(var_core_value_sig2492)), K(5, var_core_value_sig832A(var_core_value_sigAD4B)), K(6, var_core_value_sig832A(var_core_value_sig5633)), K(7, var_core_value_sig832A(var_core_value_sigAD47)), K(8, var_core_value_sig832A(var_core_value_sig6324)), K(9, var_core_value_sig832A(Gi)), K(10, var_core_value_sig832A(xa)), K(11, var_core_value_sig832A(var_core_value_sig1166)), K(12, var_core_value_sig832A(var_core_value_sig0130)), K(13, var_core_value_sig60E6), K(14, var_core_value_sig9865), K(15, var_core_value_sig832A(ba)), K(16, var_core_value_sig1429)], Lo);
function Ro(var_core_value_sig8873) {
...
function zo(var_core_value_sig1610) {
...
function Bo(var_core_value_sig03F7) {
...
function Vo(var_core_value_sig4950) {
  ...
  let var_core_value_sig3B2E = var_core_value_sig4950.scene["getAncestorScale"]().scaleX || 1,
    var_core_value_sig5A9A = ((var_core_value_sig4424 = var_core_value_sig4950.scene["getViewport"](Do)) == null ? undefined : var_core_value_sig4424.viewportScrollX) ?? 0,
...
function Ho(var_core_value_sigA4B8) {
  return var_core_value_sigA4B8.mainComponent ?? var_core_value_sigA4B8.scene;
}
function Uo(var_core_value_sigFF9C, var_core_value_sig278D, var_core_value_sigC0FE) {
  let var_core_value_sigDD22 = var_core_value_sigC0FE.getViewport(Do);
  if (!var_core_value_sigDD22) return {
    x: var_core_value_sigFF9C,
    y: var_core_value_sig278D
  };
  let var_core_value_sig2D35 = var_core_value_sigDD22.transformVector2SceneCoord(var_core_value_sig1386.FromArray([var_core_value_sigFF9C, var_core_value_sig278D]));
  return {
    x: var_core_value_sig2D35.x,
    y: var_core_value_sig2D35.y
  };
}
function q(var_core_value_sig7A4B, var_core_value_sigE50A, var_core_value_sigC8AC) {
  let {
      scaleX: var_core_value_sig8E63,
      scaleY: var_core_value_sig300D
    } = var_core_value_sigC8AC.getAncestorScale(),
    var_core_value_sig520B = var_core_value_sigC8AC.getViewport(Do);
...
function J(var_core_value_sigFE26, var_core_value_sig1019) {
  let var_core_value_sig32AB = q(var_core_value_sigFE26.x, var_core_value_sigFE26.y, var_core_value_sig1019),
    var_core_value_sig72BE = q(var_core_value_sigFE26.x + var_core_value_sigFE26.width, var_core_value_sigFE26.y + var_core_value_sigFE26.height, var_core_value_sig1019);
  return {
...
function Wo(var_core_value_sig3E4A, var_core_value_sig3171) {
  return {
    ...var_core_value_sig3E4A,
    thumb: J(var_core_value_sig3E4A.thumb, var_core_value_sig3171),
    track: J(var_core_value_sig3E4A.track, var_core_value_sig3171)
  };
}
function Go(var_core_value_sigEBC4) {
...
function Y(var_core_value_sig9A80) {
...
function Ko(var_core_value_sig3603) {
  ...
  return Math.max(var_core_value_sigC163, Xo(var_core_value_sig3603, 0));
}
function qo(var_core_value_sigF5F3) {
  return var_core_value_sigF5F3.viewport ? Xo(var_core_value_sigF5F3, 0) : var_core_value_sigF5F3.tableRect["x"];
}
function Jo(var_core_value_sig5E69) {
  ...
  let var_core_value_sig7B39 = (var_core_value_sig5E69.viewport["viewportLeft"] ?? var_core_value_sig5E69.tableRect["x"]) + var_core_value_sig5E69.viewport["viewportWidth"],
    var_core_value_sigDCAB = Xo(var_core_value_sig5E69, X(var_core_value_sig5E69.columnWidths));
  return Math.min(var_core_value_sig7B39, var_core_value_sigDCAB);
}
function Yo(var_core_value_sigF569, var_core_value_sig2A9F) {
  ...
  let var_core_value_sig4401 = var_core_value_sig2A9F - var_core_value_sigF569.tableRect["x"] + (((var_core_value_sigB14A = var_core_value_sigF569.viewport) == null ? undefined : var_core_value_sigB14A.scrollLeft) ?? 0),
    var_core_value_sig4D6A = X(var_core_value_sigF569.columnWidths);
  return var_core_value_sig4401 < 0 || var_core_value_sig4401 > var_core_value_sig4D6A ? null : var_core_value_sig4401;
}
function Xo(var_core_value_sigEF80, var_core_value_sig526D1) {
...
function Zo(var_core_value_sigCB8C, var_core_value_sigD217, var_core_value_sigEB0F, var_core_value_sigDC44, var_core_value_sigDEFC, var_core_value_sigE842) {
...
function X(var_core_value_sigA77A) {
...
function Qo(var_core_value_sig0701, var_core_value_sig5DCA) {
...
function $o(var_core_value_sigF1AB, var_core_value_sig902F) {
...
function es(var_core_value_sig6BD7, var_core_value_sig63E0) {
...
function ts(var_core_value_sig4D56) {
  return typeof var_core_value_sig4D56.clientX == "number" && typeof var_core_value_sig4D56.clientY == "number";
}
function ns(var_core_value_sig7C26) {
  return var_core_value_sig7C26.source === var_core_value_sig7EE4.Text || var_core_value_sig7C26.kind === var_core_value_sigA1AF.Text || var_core_value_sig7C26.kind === var_core_value_sigA1AF.None ? false : var_core_value_sig7C26.startRow >= 0 && var_core_value_sig7C26.endRow >= 0 && var_core_value_sig7C26.startColumn >= 0 && var_core_value_sig7C26.endColumn >= 0;
}
function rs(var_core_value_sigBC59, var_core_value_sig544E) {
  return !!(var_core_value_sigBC59 != null && var_core_value_sigBC59.tableId) && var_core_value_sigBC59.source !== var_core_value_sig7EE4.Text && var_core_value_sigBC59.tableId === var_core_value_sig544E.tableId && var_core_value_sig544E.row >= var_core_value_sigBC59.startRow && var_core_value_sig544E.row <= var_core_value_sigBC59.endRow && var_core_value_sig544E.column >= var_core_value_sigBC59.startColumn && var_core_value_sig544E.column <= var_core_value_sigBC59.endColumn;
}
function is(var_core_value_sigCE8A) {
...
function as(var_core_value_sig0718, var_core_value_sig1B221, var_core_value_sig8854, var_core_value_sig5275) {
  return !var_core_value_sig0718 || var_core_value_sig0718.tableId !== var_core_value_sig1B221 ? false : var_core_value_sig8854 === "row" ? (var_core_value_sig0718.kind === var_core_value_sigA1AF.Row || var_core_value_sig0718.kind === var_core_value_sigA1AF.Table) && var_core_value_sig5275 >= var_core_value_sig0718.startRow && var_core_value_sig5275 <= var_core_value_sig0718.endRow : (var_core_value_sig0718.kind === var_core_value_sigA1AF.Column || var_core_value_sig0718.kind === var_core_value_sigA1AF.Table) && var_core_value_sig5275 >= var_core_value_sig0718.startColumn && var_core_value_sig5275 <= var_core_value_sig0718.endColumn;
}
function os(var_core_value_sig4F9D) {
  return var_core_value_sig4F9D.kind === var_core_value_sigA1AF.Row || var_core_value_sig4F9D.kind === var_core_value_sigA1AF.Column || var_core_value_sig4F9D.kind === var_core_value_sigA1AF.Table;
}
function ss(var_core_value_sig278E) {
...
function cs(var_core_value_sig2921) {
  return {
...
function ls(var_core_value_sig3959) {
  return {
...
function us() {
  return [{
    direction: var_core_value_sigB5D3.Asc,
    labelKey: "docs-table-ui.sortAscending"
  }, {
    direction: var_core_value_sigB5D3.Desc,
    labelKey: "docs-table-ui.sortDescending"
  }];
}
function ds() {
  return [var_core_value_sigF909.All, var_core_value_sigF909.Inner, var_core_value_sigF909.Outer, var_core_value_sigF909.Top, var_core_value_sigF909.Bottom, var_core_value_sigF909.Left, var_core_value_sigF909.Right, var_core_value_sigF909.None, var_core_value_sigF909.InnerHorizontal, var_core_value_sigF909.InnerVertical].map(var_core_value_sig9DBF => ({
    iconName: Ca(var_core_value_sig9DBF),
    preset: var_core_value_sig9DBF
  }));
}
function fs(var_core_value_sig926F) {
  return {
...
function ps(var_core_value_sig9414) {
  return {
...
let ms = class extends var_core_value_sig34F8 {
  constructor(var_core_value_sig36CC) {
    super(), this._commandService = var_core_value_sig36CC, this.disposeWithMe(this._commandService["registerCommand"](z));
  }
};
ms = va([K(0, var_core_value_sig9865)], ms);
let hs = class extends var_core_value_sig34F8 {
  constructor(var_core_value_sigA568) {
    super(), this._commandService = var_core_value_sigA568, [Ai, ji, Mi, Ni, Pi, Fi, Ii, Li, Ri, zi].forEach(var_core_value_sig21B2 => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig21B2)));
  }
};
hs = va([K(0, var_core_value_sig9865)], hs);
let Q = null;
const gs = {
    ...
    handler: async var_core_value_sig32E7 => {
      ...
      let var_core_value_sig0642 = var_core_value_sig32E7.get(var_core_value_sig9865),
        var_core_value_sig786E = var_core_value_sig32E7.get(var_core_value_sigA339),
        var_core_value_sigFC47 = var_core_value_sig32E7.get(var_core_value_sigCE75),
        var_core_value_sig48E2 = var_core_value_sig32E7.get(var_core_value_sig6324),
        var_core_value_sig2FCA = (var_core_value_sigD8C3 = var_core_value_sig786E.getCurrentUnitOfType) == null ? undefined : var_core_value_sigD8C3.call(var_core_value_sig786E, var_core_value_sigFD90.UNIVER_DOC),
      ...
      if (!var_core_value_sig04F2 || !var_core_value_sig2CFC) return Q = null, vs(var_core_value_sig0642);
      bs(var_core_value_sigFC47, var_core_value_sig48E2, var_core_value_sig04F2);
      let var_core_value_sig5CEB = var_core_value_sig48E2.getCurrentSelection();
      if (!(var_core_value_sig5CEB != null && var_core_value_sig5CEB.tableId)) return Q = null, vs(var_core_value_sig0642);
      let var_core_value_sig4935 = var_core_value_sig50D0(var_core_value_sig04F2, var_core_value_sig5CEB.tableId);
      if (!var_core_value_sig4935) return Q = null, vs(var_core_value_sig0642);
      if (var_core_value_sig5CEB.source === var_core_value_sig7EE4.Structural) return (Q == null ? undefined : Q.phase) === "table" && ks(var_core_value_sig2CFC, var_core_value_sig5CEB) ? (Q = null, var_core_value_sig48E2.clearStructuralSelection({
        clearNativeSelection: false
      }), var_core_value_sig48E2.setNativeSelectionSuppressed(false), var_core_value_sig0642.executeCommand(var_core_value_sig39F2.id, {
        segmentId: var_core_value_sig5CEB.segmentId,
        wholeDocument: true
      })) : (Ds(var_core_value_sig48E2, var_core_value_sig4935, var_core_value_sig5CEB.segmentId), Q = {
        phase: "table",
        rangeKey: Os({
          startRow: 0,
      ...
      if (!var_core_value_sig1832) return vs(var_core_value_sig0642);
      let var_core_value_sig79D7 = ys(var_core_value_sigFC47);
      if (!var_core_value_sig79D7) return Es(var_core_value_sig48E2, var_core_value_sig5CEB.tableId, var_core_value_sig1832, var_core_value_sig5CEB.segmentId, var_core_value_sig2CFC), true;
      let var_core_value_sig5E01 = xs(var_core_value_sig1832, var_core_value_sig5CEB.segmentId);
      if (ws(var_core_value_sig79D7, var_core_value_sig5E01)) return Es(var_core_value_sig48E2, var_core_value_sig5CEB.tableId, var_core_value_sig1832, var_core_value_sig5CEB.segmentId, var_core_value_sig2CFC), true;
      let var_core_value_sigBBE4 = Ss(var_core_value_sig04F2, var_core_value_sig1832, var_core_value_sig5CEB.segmentId),
        var_core_value_sig96B3 = Cs(var_core_value_sigBBE4, var_core_value_sig79D7.startOffset ?? var_core_value_sig5E01.startOffset);
      return var_core_value_sig96B3 ? ws(var_core_value_sig79D7, var_core_value_sig96B3) ? (var_core_value_sigBBE4.length <= 1 ? Es(var_core_value_sig48E2, var_core_value_sig5CEB.tableId, var_core_value_sig1832, var_core_value_sig5CEB.segmentId, var_core_value_sig2CFC) : (Q = null, Ts(var_core_value_sigFC47, [var_core_value_sig5E01], var_core_value_sig2CFC)), true) : (Q = null, Ts(var_core_value_sigFC47, [var_core_value_sig96B3], var_core_value_sig2CFC), true) : (Ts(var_core_value_sigFC47, [var_core_value_sig5E01], var_core_value_sig2CFC), true);
    }
  },
  _s = {
    id: gs.id,
    binding: var_core_value_sigAEE0.A | var_core_value_sigB1FB.CTRL_COMMAND,
    priority: 100,
    preconditions: var_core_value_sig9CF2 => var_core_value_sig9CF2.getContextValue(var_core_value_sigC0DF) && (var_core_value_sig9CF2.getContextValue(var_core_value_sig72BB) || var_core_value_sig9CF2.getContextValue(var_core_value_sig6537))
  };
function vs(var_core_value_sig666D) {
  return var_core_value_sig666D.executeCommand(var_core_value_sig39F2.id);
}
function ys(var_core_value_sigBD53) {
...
function bs(var_core_value_sigF65B, var_core_value_sig4A94, var_core_value_sigEB59) {
  ...
  let var_core_value_sigCF1F = ys(var_core_value_sigF65B),
...
function xs(var_core_value_sig1293, var_core_value_sigC999) {
  ...
  return {
    ...
    rangeType: var_core_value_sigCF95.TEXT,
    segmentId: var_core_value_sigC999,
    startOffset: var_core_value_sig9D8F
  };
}
function Ss(var_core_value_sig95D9, var_core_value_sig0E92, var_core_value_sig45CD) {
  ...
  return var_core_value_sig15B6.length || var_core_value_sig15B6.push(xs(var_core_value_sig0E92, var_core_value_sig45CD)), var_core_value_sig15B6;
}
function Cs(var_core_value_sigBBA2, var_core_value_sigC9A1) {
...
function ws(var_core_value_sigE469, var_core_value_sigA499) {
...
function Ts(var_core_value_sig4CC3, var_core_value_sig70B3, var_core_value_sig422B) {
...
function Es(var_core_value_sigC3E6, var_core_value_sig3710, var_core_value_sig9726, var_core_value_sigFC9B, var_core_value_sig943E) {
  var_core_value_sigC3E6.setNativeSelectionSuppressed(true), var_core_value_sigC3E6.setStructuralSelection({
    kind: var_core_value_sigA1AF.Cell,
...
function Ds(var_core_value_sigEF36, var_core_value_sigD4B1, var_core_value_sigE5D8) {
...
function Os(var_core_value_sig74AF) {
...
function ks(var_core_value_sigBABA, var_core_value_sigA723) {
  return (Q == null ? undefined : Q.unitId) === var_core_value_sigBABA && Q.tableId === var_core_value_sigA723.tableId && Q.rangeKey === Os(var_core_value_sigA723);
}
let As = class extends var_core_value_sig34F8 {
  constructor(var_core_value_sig0A5A, var_core_value_sigE6D6) {
    super(), this._commandService = var_core_value_sig0A5A, this._shortcutService = var_core_value_sigE6D6, this.disposeWithMe(this._commandService["registerCommand"](gs)), this.disposeWithMe(this._shortcutService["registerShortcut"](_s));
  }
};
As = va([K(0, var_core_value_sig9865), K(1, var_core_value_sig7A6B)], As);
let js = class extends var_core_value_sig34F8 {
  constructor(var_core_value_sig8507, var_core_value_sig8A7F) {
    super(), this._menuManagerService = var_core_value_sig8507, this._selectionService = var_core_value_sig8A7F, this._menuManagerService["mergeMenu"](si), this._menuManagerService["appendRootMenu"](oi), this.disposeWithMe(this._selectionService["selectionChange$"].subscribe(var_core_value_sigDE08 => {
      var_core_value_sigDE08 != null && var_core_value_sigDE08.tableId && this._menuManagerService["mergeMenu"](si), this._menuManagerService["appendRootMenu"]({});
    }));
  }
};
js = va([K(0, var_core_value_sig1F6E), K(1, var_core_value_sig832A(var_core_value_sig6324))], js);
var Ms = class extends var_core_value_sig34F8 {
  constructor(...var_core_value_sig9E81) {
    super(...var_core_value_sig9E81), U(this, "_triggers", []), U(this, "_triggerChange$", new var_core_value_sig5094()), U(this, "triggerChange$", this._triggerChange$["asObservable"]());
  }
  updateTriggers(var_core_value_sig8295) {
    this._triggers = var_core_value_sig8295 ? Za(var_core_value_sig8295) : [], this._triggerChange$["next"](this._triggers);
  }
  getTriggers() {
    return this._triggers;
  }
  hitTest(var_core_value_sigA975, var_core_value_sig1263) {
    return go(this._triggers, var_core_value_sigA975, var_core_value_sig1263);
  }
  dispose() {
    super.dispose(), this._triggerChange$["complete"]();
  }
};
let $ = class extends var_core_value_sigF686 {
  constructor(var_core_value_sig457C = ui, var_core_value_sigA4E6, var_core_value_sig934F, var_core_value_sig74A7) {
    ...
    } = var_core_value_sig03A4({}, ui, this._config);
  ...
  onRendered() {
    this._injector["get"](js), this.disposeWithMe(this._renderManagerService["registerRenderModule"](var_core_value_sigFD90.UNIVER_DOC, [Lo]));
  }
};
U($, "pluginName", var_core_value_sig991C + "_UI_PLUGIN"), U($, "packageName", ci), U($, "version", li), U($, "type", var_core_value_sigFD90.UNIVER_DOC), $ = va([var_core_value_sig1BE7(var_core_value_sigAF19, var_core_value_sig47B3, var_core_value_sig2ADC, var_core_value_sigF2E0, var_core_value_sig5870), K(1, var_core_value_sig832A(var_core_value_sig7945)), K(2, var_core_value_sigA101), K(3, var_core_value_sigA09D)], $);
export { ba as DocsTablePassiveWheelService, si as DocsTableUIMenuSchema, $ as UniverDocsTableUIPlugin };
