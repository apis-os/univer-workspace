...
function sa(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463592) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463593 = new DOMParser().parseFromString(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463592, "text/html");
  return Array.from(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463593.querySelectorAll("table")).map(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46832 => fa(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46832));
}
