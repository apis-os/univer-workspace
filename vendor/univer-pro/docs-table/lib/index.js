import { BooleanNumber as var_core_value_sig2D2A, CommandType as var_core_value_sig1D22, DOC_RANGE_TYPE as var_core_value_sig91FE, DashStyleType as var_core_value_sig528C, DataStreamTreeTokenType as var_core_value_sig749D, DependentOn as var_core_value_sig1FB8, Disposable as var_core_value_sig032D, DocumentFlavor as var_core_value_sig27FA, ICommandService as var_core_value_sig533B, IConfigService as var_core_value_sig6434, IResourceManagerService as var_core_value_sig398A, IUniverInstanceService as var_core_value_sig1760, Inject as var_core_value_sig7C7A, Injector as var_core_value_sig78E8, JSONX as var_core_value_sigF002, ObjectRelativeFromH as var_core_value_sig715D, ObjectRelativeFromV as var_core_value_sigEB90, Plugin as var_core_value_sig9506, TableAlignmentType as var_core_value_sigC460, TableRowHeightRule as var_core_value_sig00D0, TableSizeType as var_core_value_sig2880, TableTextWrapType as var_core_value_sig76AC, TextX as var_core_value_sigEA39, Tools as var_core_value_sig252C, UniverInstanceType as var_core_value_sig87EA, containsInteriorInsertionOffset as var_core_value_sig4325, createParagraphId as var_core_value_sigAB8D, createSectionId as var_core_value_sig4B86, generateRandomId as var_core_value_sig240E, getBlockRangeInterval as var_core_value_sigDE46, getBodySliceForTextXAction as var_core_value_sigF30E, getCustomBlockIdsInSelections as var_core_value_sigA6B6, getParagraphContentStartOffset as var_core_value_sig1FDB, getTableCellTokenInterval as var_core_value_sig6B7D, getTableRangeInterval as var_core_value_sig0D1B, getTableRowTokenInterval as var_core_value_sigA5A1, merge as var_core_value_sig0C3A } from "@univerjs/core";
import { DocHistoryAction as var_core_value_sig5A20, DocSelectionManagerService as var_core_value_sig4037, RichTextEditingMutation as var_core_value_sig5F5F, UniverDocsPlugin as var_core_value_sig801E, getContentInsertRange as var_core_value_sigD8A7 } from "@univerjs/docs";
import { Subject as var_core_value_sig7D2D } from "rxjs";
import { UniverLicensePlugin as var_core_value_sig5BC4 } from "@univerjs-pro/license";
function w(var_core_value_sigE7A6, var_core_value_sigB505) {
  ...
  let var_core_value_sigF7BB = var_core_value_sig0D1B(var_core_value_sigA7F3);
  return var_core_value_sig901E[var_core_value_sigF7BB.startOffset] !== var_core_value_sig749D.TABLE_START || var_core_value_sig901E[var_core_value_sigF7BB.endOffset - 1] !== var_core_value_sig749D.TABLE_END ? null : xe(var_core_value_sig901E, var_core_value_sigF7BB.startOffset, var_core_value_sigF7BB.endOffset, var_core_value_sigB505, var_core_value_sigEACD);
}
function T(var_core_value_sigFA38, var_core_value_sig102B) {
...
function be(var_core_value_sig5EEE, var_core_value_sig65B4) {
  ...
  if (var_core_value_sigF98E.length === 0) throw Error("[DocsTable]: Column " + var_core_value_sig65B4 + "\x20is\x20out\x20of\x20range.");
  return {
...
function xe(var_core_value_sigA470, var_core_value_sig19A1, var_core_value_sig81F7, var_core_value_sigBE51, var_core_value_sigAAD1) {
  ...
  for (let var_core_value_sig01B3 = var_core_value_sig19A1 + 1; var_core_value_sig01B3 < var_core_value_sig81F7 - 1;) {
    let var_core_value_sig5CEE = var_core_value_sigA5A1(var_core_value_sigA470, var_core_value_sig01B3);
    ...
    for (let var_core_value_sig1A0F = var_core_value_sig5CEE.startOffset + 1; var_core_value_sig1A0F < var_core_value_sig5CEE.endOffset - 1;) {
      let var_core_value_sig8061 = var_core_value_sig6B7D(var_core_value_sigA470, var_core_value_sig1A0F);
...
function Se(var_core_value_sigA984, var_core_value_sigA504, var_core_value_sig05FF) {
  ...
  let var_core_value_sigFBF0 = w(var_core_value_sigA504, var_core_value_sigA984.tableId);
  if (!var_core_value_sigFBF0) return null;
  let var_core_value_sig2F95 = {
    ...var_core_value_sigA984
  };
  if (var_core_value_sig05FF.kind === "insert-rows") var_core_value_sig2F95.startRow = Ce(var_core_value_sig2F95.startRow, var_core_value_sig05FF.index, var_core_value_sig05FF.count), var_core_value_sig2F95.endRow = Ce(var_core_value_sig2F95.endRow, var_core_value_sig05FF.index, var_core_value_sig05FF.count);else {
    if (var_core_value_sig05FF.kind === "insert-columns") var_core_value_sig2F95.startColumn = Ce(var_core_value_sig2F95.startColumn, var_core_value_sig05FF.index, var_core_value_sig05FF.count), var_core_value_sig2F95.endColumn = Ce(var_core_value_sig2F95.endColumn, var_core_value_sig05FF.index, var_core_value_sig05FF.count);else {
      if (var_core_value_sig05FF.kind === "delete-rows") {
        let [var_core_value_sigFBA4, var_core_value_sig4383] = we(var_core_value_sig2F95.startRow, var_core_value_sig2F95.endRow, var_core_value_sig05FF.index, var_core_value_sig05FF.count);
        ...
        if (var_core_value_sig05FF.kind === "delete-columns") {
          let [var_core_value_sig4D4C, var_core_value_sigC9E0] = we(var_core_value_sig2F95.startColumn, var_core_value_sig2F95.endColumn, var_core_value_sig05FF.index, var_core_value_sig05FF.count);
  ...
  return var_core_value_sig2F95.startRow = Te(var_core_value_sig2F95.startRow, 0, var_core_value_sigF0E1 - 1), var_core_value_sig2F95.endRow = Te(var_core_value_sig2F95.endRow, 0, var_core_value_sigF0E1 - 1), var_core_value_sig2F95.startColumn = Te(var_core_value_sig2F95.startColumn, 0, var_core_value_sig2D8D - 1), var_core_value_sig2F95.endColumn = Te(var_core_value_sig2F95.endColumn, 0, var_core_value_sig2D8D - 1), var_core_value_sig2F95.startRow > var_core_value_sig2F95.endRow && (var_core_value_sig2F95.endRow = var_core_value_sig2F95.startRow), var_core_value_sig2F95.startColumn > var_core_value_sig2F95.endColumn && (var_core_value_sig2F95.endColumn = var_core_value_sig2F95.startColumn), var_core_value_sig2F95;
}
function Ce(var_core_value_sigE5A6, var_core_value_sigF449, var_core_value_sig38C5) {
...
function we(var_core_value_sigC87D, var_core_value_sigCCDC, var_core_value_sigC310, var_core_value_sigA4E8) {
...
function Te(var_core_value_sigD23B, var_core_value_sig2B2A, var_core_value_sig0B5C) {
  return Math.min(Math.max(var_core_value_sigD23B, var_core_value_sig2B2A), var_core_value_sig0B5C);
}
function Ee(var_core_value_sig7D42) {
  return var_core_value_sig7D42;
}
function E(var_core_value_sig8FDE, var_core_value_sig78E6 = {}) {
  var var_core_value_sig541F;
  let var_core_value_sig417B = {
    ...var_core_value_sig8FDE,
    body: var_core_value_sig78E6.cloneBody === false ? var_core_value_sig8FDE.body : var_core_value_sig8FDE.body ? De(var_core_value_sig8FDE.body) : var_core_value_sig8FDE.body
  };
  return (var_core_value_sig541F = var_core_value_sig78E6.tableIds) != null && var_core_value_sig541F.length && var_core_value_sig8FDE.tableSource && (var_core_value_sig417B.tableSource = {
    ...
    var_core_value_sig36F8 && (var_core_value_sig417B.tableSource[var_core_value_sigF051] = Oe(var_core_value_sig36F8));
  })), var_core_value_sig417B;
}
function De(var_core_value_sigAA90) {
  ...
  return {
    ...
    paragraphs: (var_core_value_sigE92D = var_core_value_sigAA90.paragraphs) == null ? undefined : var_core_value_sigE92D.map(var_core_value_sig03E1 => ({
      ...
      bullet: D(var_core_value_sig03E1.bullet),
      paragraphStyle: D(var_core_value_sig03E1.paragraphStyle)
    })),
    ...
    columnGroups: (var_core_value_sig4082 = var_core_value_sigAA90.columnGroups) == null ? undefined : var_core_value_sig4082.map(var_core_value_sigB601 => {
      ...
      return {
        ...
        columns: (var_core_value_sig8B71 = var_core_value_sigB601.columns) == null ? undefined : var_core_value_sig8B71.map(var_core_value_sig362B => D(var_core_value_sig362B))
      };
    }),
...
function Oe(var_core_value_sig9427) {
  return {
    ...var_core_value_sig9427,
    dist: D(var_core_value_sig9427.dist),
    position: D(var_core_value_sig9427.position),
    size: D(var_core_value_sig9427.size),
    tableColumns: var_core_value_sig9427.tableColumns["map"](ke),
    tableRows: var_core_value_sig9427.tableRows["map"](Ae)
  };
}
function ke(var_core_value_sig21F4) {
  return {
    ...var_core_value_sig21F4,
    size: D(var_core_value_sig21F4.size)
  };
}
function Ae(var_core_value_sigA345) {
  return {
    ...var_core_value_sigA345,
    trHeight: D(var_core_value_sigA345.trHeight),
    tableCells: var_core_value_sigA345.tableCells["map"](var_core_value_sig77EE => ({
      ...var_core_value_sig77EE,
      backgroundColor: D(var_core_value_sig77EE.backgroundColor),
      borderBottom: D(var_core_value_sig77EE.borderBottom),
      borderLeft: D(var_core_value_sig77EE.borderLeft),
      borderRight: D(var_core_value_sig77EE.borderRight),
      borderTop: D(var_core_value_sig77EE.borderTop),
      margin: D(var_core_value_sig77EE.margin)
    }))
  };
}
function D(var_core_value_sigA468) {
  return Array.isArray(var_core_value_sigA468) ? var_core_value_sigA468.map(var_core_value_sig9F76 => D(var_core_value_sig9F76)) : !var_core_value_sigA468 || typeof var_core_value_sigA468 != "object" ? var_core_value_sigA468 : Object.fromEntries(Object.entries(var_core_value_sigA468).map(([var_core_value_sigB008, var_core_value_sig8721]) => [var_core_value_sigB008, D(var_core_value_sig8721)]));
}
function je(var_core_value_sig1561, var_core_value_sigDF14, var_core_value_sig842F) {
  ...
  if (!var_core_value_sig214A || !Ye(var_core_value_sig842F)) return false;
  try {
    return Ze(var_core_value_sig214A, var_core_value_sig842F).every(var_core_value_sig5CA5 => j(var_core_value_sig5CA5) === 1 && M(var_core_value_sig5CA5) === 1);
  } catch {
    return false;
  }
}
function Me(var_core_value_sigCCC3, var_core_value_sig986E, var_core_value_sig537C) {
  ...
  try {
    let var_core_value_sig08BA = O(var_core_value_sig537C);
    var_core_value_sigE28B = ze(var_core_value_sig5440, var_core_value_sig08BA.startRow, var_core_value_sig08BA.startColumn);
  } catch {
    return false;
  }
  return !!var_core_value_sigE28B && Ye(var_core_value_sigE28B);
}
function Ne(var_core_value_sig0FD9) {
  let var_core_value_sig5649 = O(var_core_value_sig0FD9);
  if (!je(var_core_value_sig0FD9.documentData, var_core_value_sig0FD9.tableId, var_core_value_sig5649)) throw Error("[DocsTable]: Cannot merge a non-rectangular or already merged selection.");
  let var_core_value_sigAF82 = E(var_core_value_sig0FD9.documentData, {
      cloneBody: false,
      tableIds: [var_core_value_sig0FD9.tableId]
    }),
    var_core_value_sig21A2 = Xe(var_core_value_sigAF82, var_core_value_sig0FD9.tableId),
...
function Pe(var_core_value_sig4CBA) {
  var var_core_value_sig8E65;
  let var_core_value_sig772C = O(var_core_value_sig4CBA),
  ...
  if (!var_core_value_sigF309 || !je(var_core_value_sig4CBA.documentData, var_core_value_sig4CBA.tableId, var_core_value_sig772C)) return null;
  let var_core_value_sig44F9 = [];
  return A(var_core_value_sigF309, var_core_value_sig772C, (var_core_value_sigFEAB, var_core_value_sigE347, var_core_value_sig3C5B) => {
    ...
    Le(var_core_value_sig44F9, var_core_value_sig4CBA.tableId, var_core_value_sigE347, var_core_value_sig3C5B, "rowSpan", var_core_value_sigFEAB.rowSpan, var_core_value_sig200B ? var_core_value_sig772C.endRow - var_core_value_sig772C.startRow + 1 : 0), Le(var_core_value_sig44F9, var_core_value_sig4CBA.tableId, var_core_value_sigE347, var_core_value_sig3C5B, "columnSpan", var_core_value_sigFEAB.columnSpan, var_core_value_sig200B ? var_core_value_sig772C.endColumn - var_core_value_sig772C.startColumn + 1 : 0);
  }), {
    actions: Re(var_core_value_sig44F9),
    range: var_core_value_sig772C
  };
}
function Fe(var_core_value_sigE532) {
  let var_core_value_sigF381 = E(var_core_value_sigE532.documentData, {
      cloneBody: false,
      tableIds: [var_core_value_sigE532.tableId]
    }),
    var_core_value_sigCB92 = Xe(var_core_value_sigF381, var_core_value_sigE532.tableId),
    var_core_value_sigC844 = O(var_core_value_sigE532),
    var_core_value_sig2ED4 = ze(var_core_value_sigCB92, var_core_value_sigC844.startRow, var_core_value_sigC844.startColumn);
  if (!Me(var_core_value_sigE532.documentData, var_core_value_sigE532.tableId, var_core_value_sigC844) || !var_core_value_sig2ED4) throw Error("[DocsTable]:\x20Cannot\x20unmerge\x20an\x20unmerged\x20cell.");
  return A(var_core_value_sigCB92, var_core_value_sig2ED4, var_core_value_sig3863 => {
...
function Ie(var_core_value_sig0477) {
  ...
  let var_core_value_sig27C4 = (var_core_value_sig6FDF = var_core_value_sig0477.documentData["tableSource"]) == null ? undefined : var_core_value_sig6FDF[var_core_value_sig0477.tableId],
    var_core_value_sig3E1A = O(var_core_value_sig0477),
    var_core_value_sig7FB0 = var_core_value_sig27C4 ? ze(var_core_value_sig27C4, var_core_value_sig3E1A.startRow, var_core_value_sig3E1A.startColumn) : null;
  if (!var_core_value_sig27C4 || !var_core_value_sig7FB0 || !Me(var_core_value_sig0477.documentData, var_core_value_sig0477.tableId, var_core_value_sig3E1A)) return null;
  let var_core_value_sig5215 = [];
  return A(var_core_value_sig27C4, var_core_value_sig7FB0, (var_core_value_sigC97C, var_core_value_sigC4B1, var_core_value_sig1BD9) => {
    Le(var_core_value_sig5215, var_core_value_sig0477.tableId, var_core_value_sigC4B1, var_core_value_sig1BD9, "rowSpan", var_core_value_sigC97C.rowSpan, undefined), Le(var_core_value_sig5215, var_core_value_sig0477.tableId, var_core_value_sigC4B1, var_core_value_sig1BD9, "columnSpan", var_core_value_sigC97C.columnSpan, undefined);
  }), {
    actions: Re(var_core_value_sig5215),
    range: var_core_value_sig7FB0
  };
}
function Le(var_core_value_sig5204, var_core_value_sig5E11, var_core_value_sig4D58, var_core_value_sig2DBD, var_core_value_sig424E, var_core_value_sigF481, var_core_value_sigD7F2) {
  if (var_core_value_sigF481 === var_core_value_sigD7F2) return;
  let var_core_value_sig7CF3 = var_core_value_sigF002.getInstance(),
...
function Re(var_core_value_sig6643) {
  return var_core_value_sig6643.reduce((var_core_value_sigE43E, var_core_value_sigA937) => var_core_value_sigF002.compose(var_core_value_sigE43E, var_core_value_sigA937), null);
}
function ze(var_core_value_sig4124, var_core_value_sigBF1C, var_core_value_sigEEEF) {
  ...
  if (j(var_core_value_sig674F) > 1 || M(var_core_value_sig674F) > 1) return {
    startRow: var_core_value_sigBF1C,
    endRow: var_core_value_sigBF1C + j(var_core_value_sig674F) - 1,
    startColumn: var_core_value_sigEEEF,
    endColumn: var_core_value_sigEEEF + M(var_core_value_sig674F) - 1
  };
  ...
  for (let var_core_value_sigCAD5 = 0; var_core_value_sigCAD5 < var_core_value_sig4124.tableRows["length"]; var_core_value_sigCAD5++) {
    ...
    for (let var_core_value_sig186C = 0; var_core_value_sig186C < var_core_value_sigE90F.tableCells["length"]; var_core_value_sig186C++) {
      let var_core_value_sig76BA = var_core_value_sigE90F.tableCells[var_core_value_sig186C],
        var_core_value_sigFBFA = j(var_core_value_sig76BA),
        var_core_value_sigF602 = M(var_core_value_sig76BA);
...
function Be(var_core_value_sigC8F6, var_core_value_sig8A26) {
  let var_core_value_sigD073 = O(var_core_value_sig8A26),
    ...
    for (let var_core_value_sigD955 = 0; var_core_value_sigD955 < var_core_value_sigC8F6.tableRows["length"]; var_core_value_sigD955++) {
      ...
      for (let var_core_value_sig3D7D = 0; var_core_value_sig3D7D < var_core_value_sigF704.tableCells["length"]; var_core_value_sig3D7D++) {
        let var_core_value_sig7524 = var_core_value_sigF704.tableCells[var_core_value_sig3D7D],
          var_core_value_sig2AD8 = j(var_core_value_sig7524),
          var_core_value_sig2AD0 = M(var_core_value_sig7524);
        ...
        if (!Qe(var_core_value_sigD073, var_core_value_sig3EEE)) continue;
        ...
        $e(var_core_value_sigBC46, var_core_value_sigD073) || (var_core_value_sigD073 = var_core_value_sigBC46, var_core_value_sigF631 = true);
      }
    }
  }
  return var_core_value_sigD073;
}
function Ve(var_core_value_sig2278, var_core_value_sig7053, var_core_value_sig52F1, var_core_value_sig1E74 = k(var_core_value_sig2278)) {
  Ge(var_core_value_sig2278, var_core_value_sig1E74, var_core_value_sigE503 => var_core_value_sig7053 <= var_core_value_sigE503.startRow ? {
...
function He(var_core_value_sig1E84, var_core_value_sig133B, var_core_value_sig69B8, var_core_value_sig983D = k(var_core_value_sig1E84)) {
  Ge(var_core_value_sig1E84, var_core_value_sig983D, var_core_value_sig48DD => var_core_value_sig133B <= var_core_value_sig48DD.startColumn ? {
...
function Ue(var_core_value_sig9A03, var_core_value_sig3363, var_core_value_sigF64A, var_core_value_sig25EC = k(var_core_value_sig9A03)) {
  Ge(var_core_value_sig9A03, var_core_value_sig25EC, var_core_value_sig5E6A => {
    ...
    for (let var_core_value_sigEFD4 = var_core_value_sig5E6A.startRow; var_core_value_sigEFD4 <= var_core_value_sig5E6A.endRow; var_core_value_sigEFD4++) {
      let var_core_value_sig48BD = Je(var_core_value_sigEFD4, var_core_value_sig3363, var_core_value_sigF64A);
...
function We(var_core_value_sigA790, var_core_value_sig9A5E, var_core_value_sig01B9, var_core_value_sigD6A9 = k(var_core_value_sigA790)) {
  Ge(var_core_value_sigA790, var_core_value_sigD6A9, var_core_value_sig9CD9 => {
    ...
    for (let var_core_value_sig861B = var_core_value_sig9CD9.startColumn; var_core_value_sig861B <= var_core_value_sig9CD9.endColumn; var_core_value_sig861B++) {
      let var_core_value_sig429F = Je(var_core_value_sig861B, var_core_value_sig9A5E, var_core_value_sig01B9);
...
function O(var_core_value_sig0FCF) {
  return {
...
function Ge(var_core_value_sigCF96, var_core_value_sigC4E9, var_core_value_sigF612) {
  Ke(var_core_value_sigCF96), var_core_value_sigC4E9.forEach(var_core_value_sig849B => {
    let var_core_value_sig5F1A = var_core_value_sigF612(var_core_value_sig849B);
    var_core_value_sig5F1A && qe(var_core_value_sigCF96, var_core_value_sig5F1A);
  });
}
function k(var_core_value_sigAA6C) {
  ...
  return var_core_value_sigAA6C.tableRows["forEach"]((var_core_value_sigB455, var_core_value_sig5241) => {
    var_core_value_sigB455.tableCells["forEach"]((var_core_value_sig5237, var_core_value_sigBB00) => {
      let var_core_value_sig7E54 = j(var_core_value_sig5237),
        var_core_value_sig9A8D = M(var_core_value_sig5237);
...
function Ke(var_core_value_sig236B) {
...
function qe(var_core_value_sig1951, var_core_value_sigFEA0) {
  var var_core_value_sig931A;
  let var_core_value_sigEE7D = O(var_core_value_sigFEA0),
  ...
  var_core_value_sigA4DA && (var_core_value_sigA4DA.rowSpan = var_core_value_sig3585, var_core_value_sigA4DA.columnSpan = var_core_value_sig31A8, A(var_core_value_sig1951, var_core_value_sigEE7D, (var_core_value_sigCEFB, var_core_value_sig1537, var_core_value_sigE4C6) => {
...
function Je(var_core_value_sig6FC0, var_core_value_sig6217, var_core_value_sigB805) {
...
function Ye(var_core_value_sig4FAE) {
...
function Xe(var_core_value_sig1FCC, var_core_value_sigB7F9) {
  ...
  if (!var_core_value_sig526D) throw Error("[DocsTable]: Table " + var_core_value_sigB7F9 + "\x20is\x20not\x20found.");
  return var_core_value_sig526D;
}
function Ze(var_core_value_sigBDB5, var_core_value_sig59CE) {
  let var_core_value_sig3AD7 = [];
  return A(var_core_value_sigBDB5, var_core_value_sig59CE, var_core_value_sig4313 => var_core_value_sig3AD7.push(var_core_value_sig4313)), var_core_value_sig3AD7;
}
function A(var_core_value_sig04E4, var_core_value_sigD8F0, var_core_value_sig1475) {
...
function $e(var_core_value_sig3FCF, var_core_value_sig675A) {
...
function et(var_core_value_sig837F) {
  return {
...
function N(var_core_value_sig9D6E) {
  ...
  return Object.entries((var_core_value_sig9D6E == null ? undefined : var_core_value_sig9D6E.tables) ?? {}).forEach(([var_core_value_sig156F, var_core_value_sigDD51]) => {
    var_core_value_sigB205[var_core_value_sig156F] = et(var_core_value_sigDD51);
  }), {
    tables: var_core_value_sigB205
  };
}
function tt(var_core_value_sigBF78, var_core_value_sig8AF3, var_core_value_sigA0CC) {
  let var_core_value_sigB3A1 = N(var_core_value_sigBF78);
  return {
    tables: {
...
function nt(var_core_value_sig1FB9, var_core_value_sig53A9, var_core_value_sigDACD) {
  let var_core_value_sig691E = N(var_core_value_sig1FB9);
  return {
    tables: {
...
function rt(var_core_value_sigD6D6, var_core_value_sig0347, var_core_value_sig52A3, var_core_value_sigAD91) {
  let var_core_value_sigF64E = N(var_core_value_sigD6D6),
...
let it = function (var_core_value_sigB217) {
...
function st(var_core_value_sig1FE6) {
  let {
    ...
    var_core_value_sig1EB3 = E(var_core_value_sig2471, {
      tableIds: [var_core_value_sigD1FC]
    }),
    var_core_value_sigE120 = mt(var_core_value_sig1EB3, var_core_value_sigD1FC),
    var_core_value_sigD6E7 = P(var_core_value_sig1EB3, var_core_value_sigD1FC),
    ...
    }, () => ht(var_core_value_sig5CBC)),
    var_core_value_sig6BD0 = k(var_core_value_sigE120),
    var_core_value_sig8C15 = var_core_value_sig7AE3 === "above" ? T(var_core_value_sigD6E7, var_core_value_sigE2F9).startOffset : T(var_core_value_sigD6E7, var_core_value_sigE2F9).endOffset + 1,
    var_core_value_sig6DF7 = yt(_t(var_core_value_sigE120.tableColumns["length"]), var_core_value_sigD689);
  return var_core_value_sigE120.tableRows["splice"](var_core_value_sig3669, 0, ...var_core_value_sig20BE), Ve(var_core_value_sigE120, var_core_value_sig3669, var_core_value_sigD689, var_core_value_sig6BD0), wt(var_core_value_sig1EB3, var_core_value_sigD1FC, var_core_value_sig8C15, var_core_value_sig6DF7), {
    nextDocumentData: var_core_value_sig1EB3,
    nextMetadata: var_core_value_sig1FE6.metadata ? N(var_core_value_sig1FE6.metadata) : undefined,
    cursor: {
...
function ct(var_core_value_sigB411) {
  ...
  let {
    ...
    var_core_value_sig80C0 = E(var_core_value_sigFE8D, {
      tableIds: [var_core_value_sig8595]
    }),
    var_core_value_sig22B4 = mt(var_core_value_sig80C0, var_core_value_sig8595),
    var_core_value_sigBB37 = P(var_core_value_sig80C0, var_core_value_sig8595),
    ...
    var_core_value_sig495B = Array.from({
      ...
      let var_core_value_sigF057 = var_core_value_sig252C.deepClone(var_core_value_sigADA4);
      return var_core_value_sigF057.size["width"].v = var_core_value_sig0E48, var_core_value_sigF057;
    }),
    var_core_value_sig310C = k(var_core_value_sig22B4);
  return var_core_value_sig22B4.tableColumns["splice"](var_core_value_sig0C51, 0, ...var_core_value_sig495B), var_core_value_sig22B4.tableRows["forEach"](var_core_value_sig72F6 => {
    let var_core_value_sig9FBA = var_core_value_sig72F6.tableCells[Math.min(var_core_value_sigF8DE, var_core_value_sig72F6.tableCells["length"] - 1)],
      var_core_value_sigFE01 = Array.from({
        length: var_core_value_sigFE76
      }, () => gt(var_core_value_sig9FBA));
    var_core_value_sig72F6.tableCells["splice"](var_core_value_sig0C51, 0, ...var_core_value_sigFE01);
  }), He(var_core_value_sig22B4, var_core_value_sig0C51, var_core_value_sigFE76, var_core_value_sig310C), bt(var_core_value_sig80C0, var_core_value_sig8595, var_core_value_sigBB37, var_core_value_sigF8DE, var_core_value_sigFE76, var_core_value_sig84C8), var_core_value_sigB411.preserveTotalWidth ?? true ? Rt(var_core_value_sig22B4, var_core_value_sig0E48 * var_core_value_sigFE76) : (var_core_value_sigA81B = var_core_value_sig22B4.size) != null && var_core_value_sigA81B.width && (var_core_value_sig22B4.size["width"].v = var_core_value_sig22B4.tableColumns["reduce"]((var_core_value_sigA2CE, var_core_value_sig1975) => var_core_value_sigA2CE + var_core_value_sig1975.size["width"].v, 0)), {
    nextDocumentData: var_core_value_sig80C0,
    nextMetadata: var_core_value_sigB411.metadata ? N(var_core_value_sigB411.metadata) : undefined,
    cursor: {
      row: 0,
...
function lt(var_core_value_sig759E) {
  let {
      documentData: var_core_value_sig6C80,
      metadata: var_core_value_sig6B99,
      tableId: var_core_value_sig6ADC
    } = var_core_value_sig759E,
    var_core_value_sig41AD = E(var_core_value_sig6C80, {
      tableIds: [var_core_value_sig6ADC]
    }),
    var_core_value_sigDBC2 = mt(var_core_value_sig41AD, var_core_value_sig6ADC),
    ...
    var_core_value_sig58DB = k(var_core_value_sigDBC2);
  return var_core_value_sig1AAA >= var_core_value_sigDBC2.tableRows["length"] ? {
    ...
    deleteTable: true
  } : (xt(var_core_value_sig41AD, var_core_value_sig6ADC, var_core_value_sig7739, var_core_value_sig4040), var_core_value_sigDBC2.tableRows["splice"](var_core_value_sig7739, var_core_value_sig1AAA), Ue(var_core_value_sigDBC2, var_core_value_sig7739, var_core_value_sig4040, var_core_value_sig58DB), {
    nextDocumentData: var_core_value_sig41AD,
    nextMetadata: zt(var_core_value_sig6B99, var_core_value_sig6ADC, var_core_value_sig7739, var_core_value_sig4040),
    cursor: {
...
function ut(var_core_value_sig4840) {
  let {
      documentData: var_core_value_sigB76D,
      metadata: var_core_value_sig1015,
      tableId: var_core_value_sig6223
    } = var_core_value_sig4840,
    var_core_value_sigC6B6 = E(var_core_value_sigB76D, {
      tableIds: [var_core_value_sig6223]
    }),
    var_core_value_sig498A = mt(var_core_value_sigC6B6, var_core_value_sig6223),
    ...
    var_core_value_sig14E6 = k(var_core_value_sig498A);
  return var_core_value_sig3AF5 >= var_core_value_sig498A.tableColumns["length"] ? {
    ...
    deleteTable: true
  } : (St(var_core_value_sigC6B6, var_core_value_sig6223, var_core_value_sigEF45, var_core_value_sig36FE), var_core_value_sig498A.tableColumns["splice"](var_core_value_sigEF45, var_core_value_sig3AF5), var_core_value_sig498A.tableRows["forEach"](var_core_value_sig6EA1 => var_core_value_sig6EA1.tableCells["splice"](var_core_value_sigEF45, var_core_value_sig3AF5)), We(var_core_value_sig498A, var_core_value_sigEF45, var_core_value_sig36FE, var_core_value_sig14E6), {
    nextDocumentData: var_core_value_sigC6B6,
    nextMetadata: var_core_value_sig1015 ? N(var_core_value_sig1015) : undefined,
    cursor: {
      row: 0,
...
function dt(var_core_value_sig8690) {
  let {
      documentData: var_core_value_sigDF29,
      tableId: var_core_value_sigC0F8
    } = var_core_value_sig8690,
    var_core_value_sig3C75 = E(var_core_value_sigDF29),
    var_core_value_sig992D = {
      ...(var_core_value_sig3C75.tableSource ?? {})
    },
    var_core_value_sigE4E4 = var_core_value_sig8690.metadata ? N(var_core_value_sig8690.metadata) : undefined;
  return Ct(var_core_value_sig3C75, var_core_value_sigC0F8), delete var_core_value_sig992D[var_core_value_sigC0F8], var_core_value_sig3C75.tableSource = var_core_value_sig992D, var_core_value_sigE4E4 && delete var_core_value_sigE4E4.tables[var_core_value_sigC0F8], {
...
function ft(var_core_value_sigA4B0) {
  let var_core_value_sig5F50 = E(var_core_value_sigA4B0.documentData, {
      tableIds: [var_core_value_sigA4B0.tableId]
    }),
    var_core_value_sig4494 = mt(var_core_value_sig5F50, var_core_value_sigA4B0.tableId),
    var_core_value_sigFFAF = P(var_core_value_sig5F50, var_core_value_sigA4B0.tableId),
    var_core_value_sig478B = var_core_value_sigA4B0.count ?? 1,
    var_core_value_sig1E21 = kt(var_core_value_sigA4B0.fromRow, var_core_value_sig4494.tableRows["length"] - 1),
    var_core_value_sig9DBF = kt(var_core_value_sigA4B0.toRow, var_core_value_sig4494.tableRows["length"] - 1),
  ...
  if (var_core_value_sigA568 <= 0 || var_core_value_sigD22D >= var_core_value_sig1E21 && var_core_value_sigD22D <= var_core_value_sig36CC + 1) return {
    ...
    nextMetadata: var_core_value_sigA4B0.metadata ? N(var_core_value_sigA4B0.metadata) : undefined,
    cursor: {
  ...
  let var_core_value_sig7221 = T(var_core_value_sigFFAF, var_core_value_sig1E21).startOffset,
    var_core_value_sig0A5A = T(var_core_value_sigFFAF, var_core_value_sig36CC).endOffset + 1,
    var_core_value_sigE6D6 = var_core_value_sigD22D > var_core_value_sig36CC ? T(var_core_value_sigFFAF, Math.min(var_core_value_sig9DBF, var_core_value_sigFFAF.rowCount - 1)).endOffset + 1 : T(var_core_value_sigFFAF, var_core_value_sig9DBF).startOffset;
  return Ot(var_core_value_sig5F50.body, var_core_value_sig7221, var_core_value_sig0A5A, var_core_value_sigE6D6), {
    nextDocumentData: var_core_value_sig5F50,
    nextMetadata: var_core_value_sigA4B0.metadata ? N(var_core_value_sigA4B0.metadata) : undefined,
    cursor: {
...
function pt(var_core_value_sig8507) {
  let var_core_value_sig8A7F = E(var_core_value_sig8507.documentData, {
      tableIds: [var_core_value_sig8507.tableId]
    }),
    var_core_value_sig9E81 = mt(var_core_value_sig8A7F, var_core_value_sig8507.tableId),
    var_core_value_sig8295 = P(var_core_value_sig8A7F, var_core_value_sig8507.tableId),
    var_core_value_sigA975 = var_core_value_sig8507.count ?? 1,
    var_core_value_sig1263 = kt(var_core_value_sig8507.fromColumn, var_core_value_sig9E81.tableColumns["length"] - 1),
    var_core_value_sig457C = kt(var_core_value_sig8507.toColumn, var_core_value_sig9E81.tableColumns["length"] - 1),
  ...
  if (var_core_value_sig934F <= 0 || var_core_value_sig74A7 >= var_core_value_sig1263 && var_core_value_sig74A7 <= var_core_value_sigA4E6 + 1) return {
    ...
    nextMetadata: var_core_value_sig8507.metadata ? N(var_core_value_sig8507.metadata) : undefined,
    cursor: {
      row: 0,
  ...
  return var_core_value_sig9E81.tableColumns["splice"](var_core_value_sigC621, 0, ...var_core_value_sig3685), var_core_value_sig9E81.tableRows["forEach"](var_core_value_sig029F => {
    ...
    Ot(var_core_value_sig8A7F.body, var_core_value_sig6912, var_core_value_sigE235, var_core_value_sig7664);
  }), {
    nextDocumentData: var_core_value_sig8A7F,
    nextMetadata: var_core_value_sig8507.metadata ? N(var_core_value_sig8507.metadata) : undefined,
    cursor: {
...
function mt(var_core_value_sig86D7, var_core_value_sig431B) {
  ...
  if (!var_core_value_sig87E2) throw Error("[DocsTable]: Table " + var_core_value_sig431B + " is not found.");
  return var_core_value_sig87E2;
}
function P(var_core_value_sig2E04, var_core_value_sig2EDD) {
  let var_core_value_sig27D2 = w(var_core_value_sig2E04, var_core_value_sig2EDD);
...
function ht(var_core_value_sig355D) {
  let var_core_value_sig8B21 = var_core_value_sig252C.deepClone(var_core_value_sig355D);
  return var_core_value_sig8B21.tableCells = var_core_value_sig355D.tableCells["map"](var_core_value_sig2281 => gt(var_core_value_sig2281)), var_core_value_sig8B21;
}
function gt(var_core_value_sigEB36) {
  return var_core_value_sig252C.deepClone({
    ...var_core_value_sigEB36
  });
}
function _t(var_core_value_sig5C27) {
  return "" + var_core_value_sig749D.TABLE_ROW_START + yt(vt(), var_core_value_sig5C27) + var_core_value_sig749D.TABLE_ROW_END;
}
function vt() {
  return var_core_value_sig749D.TABLE_CELL_START + "\x0d\x0a" + var_core_value_sig749D.TABLE_CELL_END;
}
function yt(var_core_value_sigD494, var_core_value_sigBF6D) {
  return Array.from({
    length: var_core_value_sigBF6D
  }, () => var_core_value_sigD494).join("");
}
function bt(var_core_value_sigD051, var_core_value_sig16D9, var_core_value_sigF378, var_core_value_sig5F6C, var_core_value_sig7E85, var_core_value_sigF204) {
  let var_core_value_sig7A15 = yt(vt(), var_core_value_sig7E85),
  ...
  for (let var_core_value_sigE94C of var_core_value_sigEEA6) Et(var_core_value_sigD051.body, var_core_value_sigE94C, var_core_value_sig7A15), var_core_value_sigD051.body && (Mt(var_core_value_sigD051.body, var_core_value_sigE94C, var_core_value_sig7A15.length), Nt(var_core_value_sigD051.body, var_core_value_sigE94C, var_core_value_sig7A15));
  jt(var_core_value_sigD051, var_core_value_sig16D9, var_core_value_sigF378.endOffset, var_core_value_sig7A15.length * var_core_value_sigEEA6.length);
}
function xt(var_core_value_sigEAE1, var_core_value_sigC69F, var_core_value_sig0442, var_core_value_sig697A) {
  let var_core_value_sigDB65 = P(var_core_value_sigEAE1, var_core_value_sigC69F),
    var_core_value_sig045E = T(var_core_value_sigDB65, var_core_value_sig0442).startOffset;
  Tt(var_core_value_sigEAE1, var_core_value_sigC69F, var_core_value_sig045E, T(var_core_value_sigDB65, var_core_value_sig697A).endOffset + 1);
}
function St(var_core_value_sig4524, var_core_value_sig64D5, var_core_value_sig9678, var_core_value_sig5E74) {
  let var_core_value_sig75FC = P(var_core_value_sig4524, var_core_value_sig64D5),
    var_core_value_sig639A = [];
  for (let var_core_value_sig6D47 = var_core_value_sig9678; var_core_value_sig6D47 <= var_core_value_sig5E74; var_core_value_sig6D47++) var_core_value_sig639A.push(...be(var_core_value_sig75FC, var_core_value_sig6D47).cells["map"](var_core_value_sigFDEA => ({
  ...
  for (let var_core_value_sig6CAD of var_core_value_sig639A) {
    ...
    var_core_value_sig567C -= var_core_value_sig86D0, Dt(var_core_value_sig4524.body, var_core_value_sig6CAD.startOffset, var_core_value_sig6CAD.endOffset), var_core_value_sig4524.body && Mt(var_core_value_sig4524.body, var_core_value_sig6CAD.startOffset, var_core_value_sig86D0);
  }
  jt(var_core_value_sig4524, var_core_value_sig64D5, var_core_value_sig75FC.endOffset, -var_core_value_sig567C);
}
function Ct(var_core_value_sig825F, var_core_value_sig546D) {
  var var_core_value_sig8078;
  let var_core_value_sigDCED = P(var_core_value_sig825F, var_core_value_sig546D);
  Tt(var_core_value_sig825F, var_core_value_sig546D, var_core_value_sigDCED.startOffset, var_core_value_sigDCED.endOffset), (var_core_value_sig8078 = var_core_value_sig825F.body) != null && var_core_value_sig8078.tables && (var_core_value_sig825F.body["tables"] = var_core_value_sig825F.body["tables"].filter(var_core_value_sig8CF5 => var_core_value_sig8CF5.tableId !== var_core_value_sig546D));
}
function wt(var_core_value_sig2829, var_core_value_sig6EE2, var_core_value_sig4CCC, var_core_value_sig6E47) {
  Et(var_core_value_sig2829.body, var_core_value_sig4CCC, var_core_value_sig6E47), At(var_core_value_sig2829, var_core_value_sig6EE2, var_core_value_sig4CCC, var_core_value_sig6E47.length), var_core_value_sig2829.body && Nt(var_core_value_sig2829.body, var_core_value_sig4CCC, var_core_value_sig6E47);
}
function Tt(var_core_value_sigB64D, var_core_value_sig2407, var_core_value_sigE4D0, var_core_value_sigD5F1) {
  Dt(var_core_value_sigB64D.body, var_core_value_sigE4D0, var_core_value_sigD5F1), At(var_core_value_sigB64D, var_core_value_sig2407, var_core_value_sigE4D0, var_core_value_sigE4D0 - var_core_value_sigD5F1);
}
function Et(var_core_value_sigBC19, var_core_value_sig4F3C, var_core_value_sig8D44) {
...
function Dt(var_core_value_sig1660, var_core_value_sigEE7B, var_core_value_sig44DF) {
...
function kt(var_core_value_sigA7E3, var_core_value_sigA784) {
  return Math.min(Math.max(0, var_core_value_sigA7E3), Math.max(0, var_core_value_sigA784));
}
function At(var_core_value_sig4406, var_core_value_sig6806, var_core_value_sigD4AA, var_core_value_sigDC41) {
  let var_core_value_sigFB47 = var_core_value_sig4406.body;
  !var_core_value_sigFB47 || var_core_value_sigDC41 === 0 || (jt(var_core_value_sig4406, var_core_value_sig6806, var_core_value_sigD4AA, var_core_value_sigDC41), Mt(var_core_value_sigFB47, var_core_value_sigD4AA, var_core_value_sigDC41));
}
function jt(var_core_value_sig9B3D1, var_core_value_sigC1CF, var_core_value_sigEE12, var_core_value_sigD70C) {
...
function Mt(var_core_value_sigC2F9, var_core_value_sig1F51, var_core_value_sig29F5) {
  ...
  let var_core_value_sigD755 = Ee(var_core_value_sigC2F9);
  var_core_value_sigC2F9.paragraphs = (var_core_value_sig5A51 = var_core_value_sigC2F9.paragraphs) == null ? undefined : var_core_value_sig5A51.map(var_core_value_sigB2CE => {
    let var_core_value_sig443C = It(var_core_value_sigB2CE.startIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sigB4B4 = It(var_core_value_sig210D.startIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sig6A71 = It(var_core_value_sig63F3.startIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sig62B7 = Lt(var_core_value_sig38CE.startIndex, var_core_value_sig38CE.endIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sig7A3C = Lt(var_core_value_sigA90D.st, var_core_value_sigA90D.ed, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sigCB04 = Lt(var_core_value_sig1F44.startIndex, var_core_value_sig1F44.endIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sigF39A = Lt(var_core_value_sig4545.startIndex, var_core_value_sig4545.endIndex, var_core_value_sig1F51, var_core_value_sig29F5);
    ...
    let var_core_value_sig7658 = Lt(var_core_value_sig2E54.startIndex, var_core_value_sig2E54.endIndex, var_core_value_sig1F51, var_core_value_sig29F5);
...
function Nt(var_core_value_sigF897, var_core_value_sigA578, var_core_value_sig0260) {
  let var_core_value_sig034D = Pt(var_core_value_sigF897),
    ...
    var_core_value_sig9975 = Ft(var_core_value_sig0260, "\x0d").map(var_core_value_sigC0D9 => ({
      startIndex: var_core_value_sigA578 + var_core_value_sigC0D9,
      paragraphId: var_core_value_sigAB8D(var_core_value_sig034D)
    })),
    var_core_value_sigD6D9 = Ft(var_core_value_sig0260, "\x0a").map(var_core_value_sigF0511 => ({
      startIndex: var_core_value_sigA578 + var_core_value_sigF0511,
      sectionId: var_core_value_sig4B86(var_core_value_sig89EC)
    }));
...
function It(var_core_value_sig2841, var_core_value_sig9FE1, var_core_value_sig9DAA) {
...
function Lt(var_core_value_sigEBB4, var_core_value_sig2B74, var_core_value_sig0483, var_core_value_sig4A48) {
...
function Rt(var_core_value_sigD7C5, var_core_value_sig3633) {
...
function zt(var_core_value_sig28BE, var_core_value_sig0224, var_core_value_sig854B, var_core_value_sig1FF6) {
  var var_core_value_sig4B27;
  if (!var_core_value_sig28BE) return;
  let var_core_value_sig3A41 = N(var_core_value_sig28BE),
  ...
  return tt(var_core_value_sig3A41, var_core_value_sig0224, Math.max(0, var_core_value_sig269A - var_core_value_sigBF53));
}
function Bt(var_core_value_sigD9BB, var_core_value_sigF549 = ["body"]) {
  var var_core_value_sigC125, var_core_value_sigB63D;
  let var_core_value_sig8255 = w(var_core_value_sigD9BB.documentData, var_core_value_sigD9BB.tableId),
  ...
  if (!((var_core_value_sigB63D = var_core_value_sigD9BB.documentData["body"]) != null && var_core_value_sigB63D.dataStream) || !var_core_value_sig8255 || !var_core_value_sigBFC7) throw Error("[DocsTable]: Cell " + var_core_value_sigD9BB.row + ":" + var_core_value_sigD9BB.column + " is not found.");
  let var_core_value_sig933F = Ht(var_core_value_sigD9BB.text),
  ...
  return F(var_core_value_sigD9BB.documentData, [{
...
function F(var_core_value_sigC7EA, var_core_value_sigDAB9, var_core_value_sig9CF7 = ["body"]) {
  ...
  let var_core_value_sig884B = Wt(var_core_value_sigCCE5),
    ...
    var_core_value_sig9730 = new var_core_value_sigEA39(),
  ...
  for (let var_core_value_sigB7D1 of var_core_value_sig5933) {
    ...
    var_core_value_sig4CD2 > 0 && var_core_value_sig9730.retain(var_core_value_sig4CD2), var_core_value_sigB7D1.text["length"] > 0 && var_core_value_sig9730.insert(var_core_value_sigB7D1.text["length"], Gt(var_core_value_sigB7D1.text, var_core_value_sig884B, var_core_value_sig4E30));
  ...
  return var_core_value_sigF002.getInstance().editOp(var_core_value_sig9730.serialize(), var_core_value_sig9CF7);
}
function Vt(var_core_value_sig300B) {
  var var_core_value_sig8457;
  let var_core_value_sigB30D = E(var_core_value_sig300B.documentData),
    var_core_value_sigDB33 = var_core_value_sigB30D.body,
    var_core_value_sig6C8C = w(var_core_value_sigB30D, var_core_value_sig300B.tableId),
  ...
  if (!(var_core_value_sigDB33 != null && var_core_value_sigDB33.dataStream) || !var_core_value_sig6C8C || !var_core_value_sig7A5E) throw Error("[DocsTable]: Cell " + var_core_value_sig300B.row + ":" + var_core_value_sig300B.column + "\x20is\x20not\x20found.");
  let var_core_value_sig838E = var_core_value_sig7A5E.startOffset + 1,
    var_core_value_sig9A5B = var_core_value_sig7A5E.endOffset,
    var_core_value_sigC860 = Ht(var_core_value_sig300B.text),
    var_core_value_sigE64C = var_core_value_sigC860.length - (var_core_value_sig9A5B - var_core_value_sig838E);
  return var_core_value_sigDB33.dataStream = "" + var_core_value_sigDB33.dataStream["slice"](0, var_core_value_sig838E) + var_core_value_sigC860 + var_core_value_sigDB33.dataStream["slice"](var_core_value_sig9A5B), Ut(var_core_value_sigDB33, var_core_value_sig838E, var_core_value_sig9A5B, var_core_value_sigC860, var_core_value_sigE64C), Yt(var_core_value_sigB30D, var_core_value_sig300B.tableId, var_core_value_sig9A5B, var_core_value_sigE64C), {
    nextDocumentData: var_core_value_sigB30D
  };
}
function Ht(var_core_value_sigF39B) {
  return var_core_value_sigF39B.replace(/\r\n/g, "\x0a").replace(/\r/g, "\x0a").split("\x0a").join("\x0d\x0a") + "\x0d\x0a";
}
function Ut(var_core_value_sig9B88, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sig9B01, var_core_value_sigA724) {
  var var_core_value_sig385E, var_core_value_sig10D3, var_core_value_sig41F2, var_core_value_sig32DD;
  let var_core_value_sig7A88 = Wt(var_core_value_sig9B88),
    ...
    var_core_value_sig3EC0 = Ee(var_core_value_sig9B88);
  var_core_value_sig9B88.paragraphs = [...Kt(var_core_value_sig9B88.paragraphs ?? [], var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724), ...qt(var_core_value_sig9B01, "\x0d").map(var_core_value_sig85B1 => ({
    startIndex: var_core_value_sig992A + var_core_value_sig85B1,
    paragraphId: var_core_value_sigAB8D(var_core_value_sig7A88)
  }))].sort((var_core_value_sig3141, var_core_value_sig2162) => var_core_value_sig3141.startIndex - var_core_value_sig2162.startIndex), var_core_value_sig9B88.sectionBreaks = [...Kt(var_core_value_sig9B88.sectionBreaks ?? [], var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724), ...qt(var_core_value_sig9B01, "\x0a").map(var_core_value_sig2EAD => ({
    startIndex: var_core_value_sig992A + var_core_value_sig2EAD,
    sectionId: var_core_value_sig4B86(var_core_value_sig6CFC)
  }))].sort((var_core_value_sig6774, var_core_value_sig340D) => var_core_value_sig6774.startIndex - var_core_value_sig340D.startIndex), var_core_value_sig9B88.customBlocks = var_core_value_sig9B88.customBlocks ? Kt(var_core_value_sig9B88.customBlocks, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724) : undefined, var_core_value_sig9B88.textRuns = (var_core_value_sig385E = var_core_value_sig9B88.textRuns) == null ? undefined : var_core_value_sig385E.map(var_core_value_sig82D4 => {
    let var_core_value_sigBDE4 = Jt(var_core_value_sig82D4.st, var_core_value_sig82D4.ed, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724);
    ...
    let var_core_value_sig0B0C = Jt(var_core_value_sigDC86.startIndex, var_core_value_sigDC86.endIndex, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724);
    ...
    let var_core_value_sig011D = Jt(var_core_value_sigBBEE.startIndex, var_core_value_sigBBEE.endIndex, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724);
    ...
    let var_core_value_sig7F19 = Jt(var_core_value_sig65A1.startIndex, var_core_value_sig65A1.endIndex, var_core_value_sig992A, var_core_value_sig6281, var_core_value_sigA724);
...
function Wt(var_core_value_sigEA69) {
  return new Set((var_core_value_sigEA69.paragraphs ?? []).map(var_core_value_sig652C => var_core_value_sig652C.paragraphId));
}
function Gt(var_core_value_sigF42A, var_core_value_sig898E, var_core_value_sigC481) {
  return {
    dataStream: var_core_value_sigF42A,
    paragraphs: qt(var_core_value_sigF42A, "\x0d").map(var_core_value_sig7E32 => ({
      startIndex: var_core_value_sig7E32,
      paragraphId: var_core_value_sigAB8D(var_core_value_sig898E)
    })),
    sectionBreaks: qt(var_core_value_sigF42A, "\x0a").map(var_core_value_sig4C07 => ({
      startIndex: var_core_value_sig4C07,
      sectionId: var_core_value_sig4B86(var_core_value_sigC481)
    }))
  };
}
function Kt(var_core_value_sig27B7, var_core_value_sig2DAD, var_core_value_sig00DE, var_core_value_sigEF7C) {
...
function qt(var_core_value_sig07E7, var_core_value_sig6005) {
...
function Jt(var_core_value_sigB591, var_core_value_sigB272, var_core_value_sig6F52, var_core_value_sig09C4, var_core_value_sig8E3E) {
...
function Yt(var_core_value_sigAD57, var_core_value_sig58A8, var_core_value_sigEC1A, var_core_value_sigBDED) {
...
function Xt(var_core_value_sig40E7) {
  var var_core_value_sigEDBA;
  let var_core_value_sigE863 = st({
  ...
  if (!var_core_value_sig04B4) throw Error("[DocsTable]: Table " + var_core_value_sig40E7.tableId + " is not found.");
  ...
  return var_core_value_sig04B4.tableRows[0].tableCells["forEach"]((var_core_value_sig90CB, var_core_value_sigBDF5) => {
    ...
    nextMetadata: nt(var_core_value_sigE863.nextMetadata, var_core_value_sig40E7.tableId, true)
  };
}
function Zt(var_core_value_sig93D6) {
  var var_core_value_sigDD05;
  let var_core_value_sig3932 = E(var_core_value_sig93D6.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sig48B2) throw Error("[DocsTable]: Table " + var_core_value_sig93D6.tableId + "\x20is\x20not\x20found.");
  ...
  return var_core_value_sig48B2.tableRows["forEach"]((var_core_value_sigACC6, var_core_value_sig1614) => {
    var_core_value_sigACC6.repeatHeaderRow = var_core_value_sig1614 < var_core_value_sig57DF ? var_core_value_sig2D2A.TRUE : var_core_value_sig2D2A.FALSE, var_core_value_sig1614 < var_core_value_sig57DF ? var_core_value_sigACC6.isFirstRow = var_core_value_sig2D2A.TRUE : delete var_core_value_sigACC6.isFirstRow;
  }), {
    nextDocumentData: var_core_value_sig3932,
    nextMetadata: tt(var_core_value_sig93D6.metadata, var_core_value_sig93D6.tableId, var_core_value_sig57DF)
  };
}
function Qt(var_core_value_sigC985) {
  var var_core_value_sig8DA6;
  let var_core_value_sigCA69 = E(var_core_value_sigC985.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sigB77C) throw Error("[DocsTable]: Table " + var_core_value_sigC985.tableId + " is not found.");
  let var_core_value_sig9AFF = Math.min(var_core_value_sigC985.startRow, var_core_value_sigC985.endRow),
    ...
    var_core_value_sig7EAB = var_core_value_sig5EE4.reduce((var_core_value_sig85C3, var_core_value_sigB996) => var_core_value_sig85C3 + fn(var_core_value_sigB996), 0) / var_core_value_sig5EE4.length;
  return var_core_value_sig5EE4.forEach(var_core_value_sig4BBA => {
    var_core_value_sig4BBA.trHeight = {
      hRule: var_core_value_sig00D0.AT_LEAST,
      val: {
...
function $t(var_core_value_sig56B9) {
  var var_core_value_sig90CF;
  let var_core_value_sigA386 = E(var_core_value_sig56B9.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sigCD6E) throw Error("[DocsTable]: Table " + var_core_value_sig56B9.tableId + " is not found.");
...
function en(var_core_value_sigB93D) {
  var var_core_value_sigB17C;
  let var_core_value_sig69B6 = E(var_core_value_sigB93D.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sig708D) throw Error("[DocsTable]: Row " + var_core_value_sigB93D.row + "\x20is\x20not\x20found.");
...
function tn(var_core_value_sig1ED2) {
  var var_core_value_sig94C1;
  let var_core_value_sigABAC = E(var_core_value_sig1ED2.documentData, {
      cloneBody: false,
...
function nn(var_core_value_sig06AC) {
  var var_core_value_sig57E2;
  if (var_core_value_sig06AC.targetOffset != null) return rn(var_core_value_sig06AC);
  let var_core_value_sig01FC = E(var_core_value_sig06AC.documentData, {
      cloneBody: false,
...
function rn(var_core_value_sig5374) {
  ...
  let var_core_value_sigD0F0 = E(var_core_value_sig5374.documentData, {
    ...
    var_core_value_sigA01E = w(var_core_value_sigD0F0, var_core_value_sig5374.tableId);
  ...
  let var_core_value_sigA41E = var_core_value_sigA01E.startOffset,
    ...
    var_core_value_sig2F0D = un(var_core_value_sig5374.targetOffset, 0, var_core_value_sig8E31.dataStream["length"]);
  if (var_core_value_sig2F0D >= var_core_value_sigA41E && var_core_value_sig2F0D <= var_core_value_sig939C || !an(var_core_value_sig8E31, var_core_value_sig5374.tableId, var_core_value_sig2F0D)) return {
  ...
  return var_core_value_sig8E31.dataStream = var_core_value_sigA9E0.slice(0, var_core_value_sig5141) + var_core_value_sigA49E + var_core_value_sigA9E0.slice(var_core_value_sig5141), var_core_value_sig8E31.tables = var_core_value_sig8E31.tables["map"](var_core_value_sigBB6C => var_core_value_sigBB6C.tableId === var_core_value_sig5374.tableId ? {
    ...
    ...var_core_value_sigBB6C,
    startIndex: I(var_core_value_sigBB6C.startIndex, var_core_value_sigA41E, var_core_value_sig939C, var_core_value_sig2F0D, var_core_value_sig5141, var_core_value_sig6DEB),
    endIndex: I(var_core_value_sigBB6C.endIndex, var_core_value_sigA41E, var_core_value_sig939C, var_core_value_sig2F0D, var_core_value_sig5141, var_core_value_sig6DEB)
  }).sort((var_core_value_sigE2BF, var_core_value_sigB8C7) => var_core_value_sigE2BF.startIndex - var_core_value_sigB8C7.startIndex), ln(var_core_value_sig8E31, var_core_value_sigA41E, var_core_value_sig939C, var_core_value_sig2F0D, var_core_value_sig5141, var_core_value_sig6DEB), var_core_value_sig8339.textWrap = var_core_value_sig76AC.NONE, var_core_value_sig8339.position["positionH"].posOffset = 0, var_core_value_sig8339.position["positionV"].posOffset = 0, {
    nextDocumentData: var_core_value_sigD0F0
  };
}
function an(var_core_value_sig751D, var_core_value_sig2E9A, var_core_value_sigE105) {
  return !(on(var_core_value_sig751D.tables, var_core_value_sig2E9A, var_core_value_sigE105) || sn(var_core_value_sig751D.blockRanges, var_core_value_sigE105) || cn(var_core_value_sig751D.customBlocks, var_core_value_sigE105));
}
function on(var_core_value_sig0BD6, var_core_value_sig3070, var_core_value_sigC66D) {
...
function sn(var_core_value_sig8EC5, var_core_value_sig1056) {
...
function cn(var_core_value_sig6EE5, var_core_value_sig9DD9) {
...
function ln(var_core_value_sig09AC, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E) {
  ...
  let var_core_value_sig3A42 = Ee(var_core_value_sig09AC);
  var_core_value_sig09AC.paragraphs = (var_core_value_sigC85E = var_core_value_sig09AC.paragraphs) == null ? undefined : var_core_value_sigC85E.map(var_core_value_sig43B8 => ({
    ...
    startIndex: I(var_core_value_sig43B8.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sig9D15.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sigC0E3.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sigDE3D.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E),
    endIndex: I(var_core_value_sigDE3D.endIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    st: I(var_core_value_sig4E3D.st, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E),
    ed: I(var_core_value_sig4E3D.ed, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sigBCA9.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E),
    endIndex: I(var_core_value_sigBCA9.endIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sig880E.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E),
    endIndex: I(var_core_value_sig880E.endIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
    ...
    startIndex: I(var_core_value_sig780B.startIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E),
    endIndex: I(var_core_value_sig780B.endIndex, var_core_value_sig1613, var_core_value_sigADC6, var_core_value_sig4620, var_core_value_sig07FB, var_core_value_sig617E)
  })).sort((var_core_value_sig7D1B, var_core_value_sig7BE0) => var_core_value_sig7D1B.startIndex - var_core_value_sig7BE0.startIndex);
}
function I(var_core_value_sig8802, var_core_value_sig95D5, var_core_value_sigE027, var_core_value_sigE537, var_core_value_sig5D84, var_core_value_sigD120) {
...
function un(var_core_value_sigAA05, var_core_value_sigC04C, var_core_value_sig2069) {
  return Math.min(Math.max(var_core_value_sigAA05, var_core_value_sigC04C), var_core_value_sig2069);
}
function dn(var_core_value_sig5176, var_core_value_sig71A1) {
  var var_core_value_sig72AD;
  return ((var_core_value_sig72AD = N(var_core_value_sig5176).tables[var_core_value_sig71A1]) == null ? undefined : var_core_value_sig72AD.headerRowCount) ?? 0;
}
function fn(var_core_value_sig9ABE) {
...
let pn = function (var_core_value_sig234B) {
  ...
  mn = function (var_core_value_sig8169) {
  ...
  hn = function (var_core_value_sigC5FB) {
  ...
  gn = function (var_core_value_sig5453) {
    return var_core_value_sig5453.Asc = "asc", var_core_value_sig5453.Desc = "desc", var_core_value_sig5453;
  }({});
function _n(var_core_value_sig8725) {
  var var_core_value_sig513B, var_core_value_sig5501;
  let var_core_value_sig7784 = vn(var_core_value_sig8725),
    var_core_value_sigB706 = E(var_core_value_sig8725.documentData, {
    ...
    var_core_value_sig77E3 = w(var_core_value_sigB706, var_core_value_sig8725.tableId);
...
function vn(var_core_value_sigC60C) {
  ...
  let var_core_value_sigBA47 = (var_core_value_sig1C3C = var_core_value_sigC60C.documentData["tableSource"]) == null ? undefined : var_core_value_sig1C3C[var_core_value_sigC60C.tableId],
    var_core_value_sig3DF7 = w(var_core_value_sigC60C.documentData, var_core_value_sigC60C.tableId),
  ...
  if (!var_core_value_sigBA47 || !var_core_value_sig3DF7 || !var_core_value_sigD49F) throw Error("[DocsTable]: Table is not found.");
  yn(var_core_value_sigBA47.tableRows);
  let var_core_value_sigCECC = N(var_core_value_sigC60C.metadata).tables[var_core_value_sigC60C.tableId],
    var_core_value_sig0F47 = (var_core_value_sigCECC != null && var_core_value_sigCECC.titleRow ? 1 : 0) + dn(var_core_value_sigC60C.metadata, var_core_value_sigC60C.tableId),
  ...
  return var_core_value_sig1578.sort((var_core_value_sigD04E, var_core_value_sigB99B) => xn(var_core_value_sigD04E, var_core_value_sigB99B, var_core_value_sig28E2, var_core_value_sigC60C.direction)), {
...
function yn(var_core_value_sig52ED) {
  if (var_core_value_sig52ED.some(var_core_value_sig7BAF => var_core_value_sig7BAF.tableCells["some"](var_core_value_sig50AF => bn(var_core_value_sig50AF)))) throw Error("[DocsTable]: Cannot sort a table with row-spanning merged cells.");
}
function bn(var_core_value_sig135F) {
  return (var_core_value_sig135F.rowSpan ?? 1) > 1 || var_core_value_sig135F.rowSpan === 0;
}
function xn(var_core_value_sig416D, var_core_value_sigAD5D, var_core_value_sig1B8A, var_core_value_sigFB18) {
  let var_core_value_sig703C = var_core_value_sigFB18 === "asc" ? 1 : -1,
    var_core_value_sig96CF = Sn(var_core_value_sig416D.value, var_core_value_sigAD5D.value, var_core_value_sig1B8A);
...
function Sn(var_core_value_sig49F1, var_core_value_sig2F7B, var_core_value_sigB0DF) {
  return var_core_value_sigB0DF === "number" ? Cn(var_core_value_sig49F1) - Cn(var_core_value_sig2F7B) : var_core_value_sigB0DF === "date" ? wn(var_core_value_sig49F1) - wn(var_core_value_sig2F7B) : var_core_value_sigB0DF === "checkbox" ? Tn(var_core_value_sig49F1) - Tn(var_core_value_sig2F7B) : var_core_value_sig49F1.localeCompare(var_core_value_sig2F7B);
}
function Cn(var_core_value_sig2E44) {
...
function wn(var_core_value_sig138D) {
...
function Tn(var_core_value_sig5C6C) {
  return +!!["true", "1", "yes", "checked"].includes(var_core_value_sig5C6C.toLowerCase());
}
function L(var_core_value_sigBE85, var_core_value_sig56DE) {
...
function R(var_core_value_sig0278, var_core_value_sig08A6) {
...
function z(var_core_value_sig0247, var_core_value_sig6030 = "") {
...
function En(var_core_value_sigFCD3, var_core_value_sig147A, var_core_value_sig829F, var_core_value_sig534C) {
  ...
  let var_core_value_sig27E2 = var_core_value_sigF002.getInstance();
  return var_core_value_sig9477.size ? var_core_value_sig9477.size["width"] ? var_core_value_sig27E2.replaceOp(["tableSource", var_core_value_sig147A, "tableColumns", var_core_value_sig829F, "size", "width", "v"], (var_core_value_sig01A9 = var_core_value_sig9477.size) == null || (var_core_value_sig01A9 = var_core_value_sig01A9.width) == null ? undefined : var_core_value_sig01A9.v, var_core_value_sig917C) : var_core_value_sig27E2.insertOp(["tableSource", var_core_value_sig147A, "tableColumns", var_core_value_sig829F, "size", "width"], {
    ...
    type: var_core_value_sig2880.SPECIFIED,
    width: {
      v: var_core_value_sig917C
    }
  });
}
function Dn(var_core_value_sig10D7, var_core_value_sig5A1A, var_core_value_sig77D2, var_core_value_sig625E) {
  ...
  let var_core_value_sigD95C = var_core_value_sigF002.getInstance();
  return H([B(var_core_value_sigD95C, ["tableSource", var_core_value_sig5A1A, "textWrap"], var_core_value_sig0836.textWrap, var_core_value_sig76AC.WRAP), B(var_core_value_sigD95C, ["tableSource", var_core_value_sig5A1A, "position", "positionH", "posOffset"], (var_core_value_sig48DA = var_core_value_sig0836.position) == null || (var_core_value_sig48DA = var_core_value_sig48DA.positionH) == null ? undefined : var_core_value_sig48DA.posOffset, (((var_core_value_sigD327 = var_core_value_sig0836.position) == null || (var_core_value_sigD327 = var_core_value_sigD327.positionH) == null ? undefined : var_core_value_sigD327.posOffset) ?? 0) + var_core_value_sig77D2), B(var_core_value_sigD95C, ["tableSource", var_core_value_sig5A1A, "position", "positionV", "posOffset"], (var_core_value_sig6694 = var_core_value_sig0836.position) == null || (var_core_value_sig6694 = var_core_value_sig6694.positionV) == null ? undefined : var_core_value_sig6694.posOffset, (((var_core_value_sig2A21 = var_core_value_sig0836.position) == null || (var_core_value_sig2A21 = var_core_value_sig2A21.positionV) == null ? undefined : var_core_value_sig2A21.posOffset) ?? 0) + var_core_value_sig625E)].filter(Boolean));
}
function On(var_core_value_sig692E, var_core_value_sig3FAF, var_core_value_sig378B, var_core_value_sigDE50 = ["body"]) {
  ...
  let var_core_value_sig9921 = var_core_value_sig692E.body,
    ...
    var_core_value_sigF001 = w(var_core_value_sig692E, var_core_value_sig3FAF);
  ...
  if (var_core_value_sigE511 >= var_core_value_sigF001.startOffset && var_core_value_sigE511 <= var_core_value_sigF001.endOffset || !kn(var_core_value_sig9921, var_core_value_sig3FAF, var_core_value_sigE511)) return null;
  let var_core_value_sig1C81 = Kn(var_core_value_sig9921, var_core_value_sigF001.startOffset, var_core_value_sigF001.endOffset, var_core_value_sigE511, var_core_value_sigDE50);
  if (!var_core_value_sig1C81) return null;
  let var_core_value_sig2C6A = var_core_value_sigF002.getInstance();
  return H([var_core_value_sig1C81, B(var_core_value_sig2C6A, ["tableSource", var_core_value_sig3FAF, "textWrap"], var_core_value_sig59BF.textWrap, var_core_value_sig76AC.NONE), B(var_core_value_sig2C6A, ["tableSource", var_core_value_sig3FAF, "position", "positionH", "posOffset"], (var_core_value_sig86CC = var_core_value_sig59BF.position) == null || (var_core_value_sig86CC = var_core_value_sig86CC.positionH) == null ? undefined : var_core_value_sig86CC.posOffset, 0), B(var_core_value_sig2C6A, ["tableSource", var_core_value_sig3FAF, "position", "positionV", "posOffset"], (var_core_value_sig7868 = var_core_value_sig59BF.position) == null || (var_core_value_sig7868 = var_core_value_sig7868.positionV) == null ? undefined : var_core_value_sig7868.posOffset, 0)].filter(Boolean));
}
function kn(var_core_value_sig7207, var_core_value_sig297F, var_core_value_sigA95A) {
...
function An(var_core_value_sigFF33, var_core_value_sig16E0, var_core_value_sig213C, var_core_value_sig31F8, var_core_value_sig6905 = var_core_value_sig00D0.AT_LEAST) {
  ...
  return var_core_value_sig98A0.trHeight ? [B(var_core_value_sigF002.getInstance(), ["tableSource", var_core_value_sig16E0, "tableRows", var_core_value_sig213C, "trHeight", "hRule"], (var_core_value_sig1F39 = var_core_value_sig98A0.trHeight) == null ? undefined : var_core_value_sig1F39.hRule, var_core_value_sig3EBD.hRule), B(var_core_value_sigF002.getInstance(), ["tableSource", var_core_value_sig16E0, "tableRows", var_core_value_sig213C, "trHeight", "val", "v"], (var_core_value_sig9256 = var_core_value_sig98A0.trHeight) == null || (var_core_value_sig9256 = var_core_value_sig9256.val) == null ? undefined : var_core_value_sig9256.v, var_core_value_sig3EBD.val["v"])].filter(Boolean).reduce((var_core_value_sig9B0D, var_core_value_sig3D2C) => var_core_value_sigF002.compose(var_core_value_sig9B0D, var_core_value_sig3D2C), null) : var_core_value_sigF002.getInstance().insertOp(["tableSource", var_core_value_sig16E0, "tableRows", var_core_value_sig213C, "trHeight"], var_core_value_sig3EBD);
}
function jn(var_core_value_sig1AC3, var_core_value_sig66B8, var_core_value_sig4C7F, var_core_value_sig2543) {
  ...
  return var_core_value_sigB708.map((var_core_value_sigD948, var_core_value_sigBE5E) => An(var_core_value_sig1AC3, var_core_value_sig66B8, var_core_value_sig88CB + var_core_value_sigBE5E, var_core_value_sig60EF)).filter(Boolean).reduce((var_core_value_sig0281, var_core_value_sigED71) => var_core_value_sigF002.compose(var_core_value_sig0281, var_core_value_sigED71), null);
}
function Mn(var_core_value_sigA6FB, var_core_value_sigD6EA, var_core_value_sigA2D3, var_core_value_sig727A) {
  ...
  return var_core_value_sig2335.map((var_core_value_sig585D, var_core_value_sigE722) => En(var_core_value_sigA6FB, var_core_value_sigD6EA, var_core_value_sig23B4 + var_core_value_sigE722, var_core_value_sig6233)).filter(Boolean).reduce((var_core_value_sig062A, var_core_value_sig050A) => var_core_value_sigF002.compose(var_core_value_sig062A, var_core_value_sig050A), null);
}
function Nn(var_core_value_sig4230, var_core_value_sig6136, var_core_value_sigD25E) {
  ...
  let var_core_value_sig3C97 = Math.min(Math.max(0, var_core_value_sigD25E), var_core_value_sigCF44.tableRows["length"]),
    var_core_value_sigA920 = var_core_value_sigF002.getInstance(),
    var_core_value_sigAD56 = [];
  return var_core_value_sigCF44.tableRows["forEach"]((var_core_value_sig8B32, var_core_value_sig870F) => {
    let var_core_value_sigB683 = var_core_value_sig870F < var_core_value_sig3C97 ? var_core_value_sig2D2A.TRUE : var_core_value_sig2D2A.FALSE,
      var_core_value_sig26EC = var_core_value_sig870F < var_core_value_sig3C97 ? var_core_value_sig2D2A.TRUE : undefined,
      var_core_value_sigEEDB = B(var_core_value_sigA920, ["tableSource", var_core_value_sig6136, "tableRows", var_core_value_sig870F, "repeatHeaderRow"], var_core_value_sig8B32.repeatHeaderRow, var_core_value_sigB683),
      var_core_value_sig36E7 = B(var_core_value_sigA920, ["tableSource", var_core_value_sig6136, "tableRows", var_core_value_sig870F, "isFirstRow"], var_core_value_sig8B32.isFirstRow, var_core_value_sig26EC);
    ...
    actions: H(var_core_value_sigAD56),
    headerRowCount: var_core_value_sig3C97
  };
}
function Pn(var_core_value_sig0454, var_core_value_sigEE1A, var_core_value_sig4107, var_core_value_sigF35C, var_core_value_sigEF8D, var_core_value_sigE025 = {}) {
  ...
  let var_core_value_sigC79E = (var_core_value_sigD549 = var_core_value_sig0454.tableSource) == null ? undefined : var_core_value_sigD549[var_core_value_sigEE1A],
    var_core_value_sig9221 = w(var_core_value_sig0454, var_core_value_sigEE1A);
  ...
  let var_core_value_sig0351 = var_core_value_sigEF8D === "left" ? var_core_value_sig4107 : var_core_value_sig4107 + 1,
    ...
    var_core_value_sigBF8B = Fn(var_core_value_sigC79E, var_core_value_sig0351, var_core_value_sigF35C),
    var_core_value_sigF7CE = ar(var_core_value_sigC79E, var_core_value_sigBF8B, var_core_value_sig27F9 => var_core_value_sig27F9 >= var_core_value_sig0351 ? var_core_value_sig27F9 + var_core_value_sigF35C : var_core_value_sig27F9);
  In(var_core_value_sigF7CE, var_core_value_sigC79E, var_core_value_sigEE1A, var_core_value_sigD719, var_core_value_sig323C, var_core_value_sig8E1C, var_core_value_sigF35C, var_core_value_sig015D), Ln(var_core_value_sigF7CE, var_core_value_sigC79E, var_core_value_sigEE1A, var_core_value_sig4107, var_core_value_sig0351, var_core_value_sigF35C, var_core_value_sig8E1C, var_core_value_sig015D, var_core_value_sigBF8B);
  let var_core_value_sig7CF1 = F(var_core_value_sig0454, Rn(var_core_value_sig9221, var_core_value_sig4107, var_core_value_sigF35C, var_core_value_sigEF8D), var_core_value_sigE025.bodyPath ?? ["body"]);
  return var_core_value_sig7CF1 ? (var_core_value_sigF7CE.push(var_core_value_sig7CF1), {
    actions: H(var_core_value_sigF7CE),
    cursorColumn: var_core_value_sig0351
  }) : null;
}
function Fn(var_core_value_sigA552, var_core_value_sigAE32, var_core_value_sig9B4D) {
  return rr(k(var_core_value_sigA552).map(var_core_value_sig393E => var_core_value_sigAE32 <= var_core_value_sig393E.startColumn ? {
...
function In(var_core_value_sig2704, var_core_value_sigD0CC, var_core_value_sigF347, var_core_value_sig80C6, var_core_value_sigEBFB, var_core_value_sigF3BF, var_core_value_sigAE58, var_core_value_sig8E13) {
  var var_core_value_sig3AAF;
  let var_core_value_sig134E = var_core_value_sigF002.getInstance();
  if (var_core_value_sig80C6) {
    var_core_value_sigD0CC.tableColumns["forEach"]((var_core_value_sigA942, var_core_value_sigA621) => {
      let var_core_value_sigBBFF = B(var_core_value_sig134E, ["tableSource", var_core_value_sigF347, "tableColumns", var_core_value_sigA621, "size", "width", "v"], var_core_value_sigA942.size["width"].v, var_core_value_sigA942.size["width"].v * var_core_value_sig8E13);
  ...
  if ((var_core_value_sig3AAF = var_core_value_sigD0CC.size) != null && var_core_value_sig3AAF.width) {
    let var_core_value_sigB609 = B(var_core_value_sig134E, ["tableSource", var_core_value_sigF347, "size", "width", "v"], var_core_value_sigD0CC.size["width"].v, var_core_value_sigEBFB + var_core_value_sigF3BF * var_core_value_sigAE58);
    var_core_value_sigB609 && var_core_value_sig2704.push(var_core_value_sigB609);
  }
}
function Ln(var_core_value_sigA3C0, var_core_value_sig723F, var_core_value_sigD044, var_core_value_sig9797, var_core_value_sig8533, var_core_value_sig57C5, var_core_value_sig0DE9, var_core_value_sigB00D, var_core_value_sig57C8) {
  let var_core_value_sigC27D = var_core_value_sigF002.getInstance(),
  ...
  for (let var_core_value_sig390D = 0; var_core_value_sig390D < var_core_value_sig57C5; var_core_value_sig390D++) {
    let var_core_value_sig8889 = V(var_core_value_sig7B95);
  ...
  var_core_value_sig723F.tableRows["forEach"]((var_core_value_sigC928, var_core_value_sig39B7) => {
    for (let var_core_value_sig32F8 = 0; var_core_value_sig32F8 < var_core_value_sig57C5; var_core_value_sig32F8++) {
      let var_core_value_sig8178 = V(var_core_value_sigC928.tableCells[var_core_value_sig9797]);
      sr(var_core_value_sig8178, var_core_value_sig39B7, var_core_value_sig8533 + var_core_value_sig32F8, var_core_value_sig57C8), var_core_value_sigA3C0.push(var_core_value_sigC27D.insertOp(["tableSource", var_core_value_sigD044, "tableRows", var_core_value_sig39B7, "tableCells", var_core_value_sig8533 + var_core_value_sig32F8], var_core_value_sig8178));
    }
  });
}
function Rn(var_core_value_sig7D59, var_core_value_sig5863, var_core_value_sig5BE7, var_core_value_sigC74A) {
  let var_core_value_sig8F6A = fr(dr(), var_core_value_sig5BE7);
...
function zn(var_core_value_sig46EA, var_core_value_sig626C, var_core_value_sig9077, var_core_value_sigC76C, var_core_value_sigB23A = ["body"]) {
  ...
  let var_core_value_sig3DF0 = (var_core_value_sigBA66 = var_core_value_sig46EA.tableSource) == null ? undefined : var_core_value_sigBA66[var_core_value_sig626C],
    var_core_value_sig0512 = w(var_core_value_sig46EA, var_core_value_sig626C);
  ...
  if (var_core_value_sig67CF >= var_core_value_sig3DF0.tableColumns["length"]) {
    let var_core_value_sig1F40 = $n(var_core_value_sig46EA, var_core_value_sig626C, var_core_value_sigB23A);
  ...
  let var_core_value_sigCA96 = ar(var_core_value_sig3DF0, rr(k(var_core_value_sig3DF0).map(var_core_value_sig3FC7 => nr(var_core_value_sig3FC7, var_core_value_sig4B2B, var_core_value_sigDB93)).filter(var_core_value_sig1E1B => var_core_value_sig1E1B != null)), var_core_value_sig3B10 => var_core_value_sig3B10 < var_core_value_sig4B2B ? var_core_value_sig3B10 : var_core_value_sig3B10 > var_core_value_sigDB93 ? var_core_value_sig3B10 - var_core_value_sig67CF : null);
  Yn(var_core_value_sigCA96, var_core_value_sig3DF0, var_core_value_sig626C, var_core_value_sig4B2B, var_core_value_sigDB93);
  let var_core_value_sig6C5E = var_core_value_sig0512.rows["map"](var_core_value_sig89E6 => ({
    ...
    var_core_value_sig4997 = F(var_core_value_sig46EA, var_core_value_sig6C5E, var_core_value_sigB23A);
  return var_core_value_sig4997 ? (var_core_value_sigCA96.push(...er(var_core_value_sig46EA, var_core_value_sig6C5E.map(({
    ...
    actions: H(var_core_value_sigCA96),
    cursorColumn: Math.min(var_core_value_sig4B2B, var_core_value_sig3DF0.tableColumns["length"] - var_core_value_sig67CF - 1)
  }) : null;
}
function Bn(var_core_value_sig7290, var_core_value_sigE835, var_core_value_sig4644, var_core_value_sig9DED, var_core_value_sig7DE6, var_core_value_sig120E, var_core_value_sigD79B = ["body"]) {
  ...
  let var_core_value_sig8911 = (var_core_value_sig92A3 = var_core_value_sig7290.tableSource) == null ? undefined : var_core_value_sig92A3[var_core_value_sigE835],
    var_core_value_sig8D1B = w(var_core_value_sig7290, var_core_value_sigE835);
  if (!var_core_value_sig8911 || !var_core_value_sig8D1B || var_core_value_sig7DE6 <= 0) return null;
  let var_core_value_sigA915 = Gn(var_core_value_sig4644, var_core_value_sig8911.tableRows["length"] - 1),
    var_core_value_sigE1F7 = Gn(var_core_value_sig9DED, var_core_value_sig8911.tableRows["length"] - 1),
  ...
  Wn(var_core_value_sig816E, ["tableSource", var_core_value_sigE835, "tableRows"], var_core_value_sigA915, var_core_value_sigF9FF, var_core_value_sig3AB3);
  let var_core_value_sigE6F3 = T(var_core_value_sig8D1B, var_core_value_sigA915).startOffset,
    var_core_value_sig3EE1 = T(var_core_value_sig8D1B, var_core_value_sig4BE7).endOffset + 1,
    var_core_value_sig9673 = var_core_value_sigE0E3 > var_core_value_sig4BE7 ? T(var_core_value_sig8D1B, var_core_value_sigE1F7).endOffset + 1 : T(var_core_value_sig8D1B, var_core_value_sigE1F7).startOffset,
    var_core_value_sig4917 = Kn(var_core_value_sig7290.body, var_core_value_sigE6F3, var_core_value_sig3EE1, var_core_value_sig9673, var_core_value_sigD79B);
  return var_core_value_sig4917 ? (var_core_value_sig816E.push(var_core_value_sig4917), {
    actions: H(var_core_value_sig816E),
    cursorRow: var_core_value_sig3AB3
  }) : null;
}
function Vn(var_core_value_sig3BE6, var_core_value_sigA1C9, var_core_value_sig77D6, var_core_value_sigE3CE, var_core_value_sig219B, var_core_value_sig4493, var_core_value_sig8B9C = ["body"]) {
  ...
  let var_core_value_sig82DD = (var_core_value_sigA35B = var_core_value_sig3BE6.tableSource) == null ? undefined : var_core_value_sigA35B[var_core_value_sigA1C9],
    var_core_value_sigAAC7 = w(var_core_value_sig3BE6, var_core_value_sigA1C9);
  if (!var_core_value_sig82DD || !var_core_value_sigAAC7 || var_core_value_sig219B <= 0) return null;
  let var_core_value_sig1999 = Gn(var_core_value_sig77D6, var_core_value_sig82DD.tableColumns["length"] - 1),
    var_core_value_sigFB45 = Gn(var_core_value_sigE3CE, var_core_value_sig82DD.tableColumns["length"] - 1),
  ...
  return Wn(var_core_value_sig3516, ["tableSource", var_core_value_sigA1C9, "tableColumns"], var_core_value_sig1999, var_core_value_sigD892, var_core_value_sigAED2), var_core_value_sig82DD.tableRows["forEach"]((var_core_value_sig3D46, var_core_value_sigCC93) => Wn(var_core_value_sig3516, ["tableSource", var_core_value_sigA1C9, "tableRows", var_core_value_sigCC93, "tableCells"], var_core_value_sig1999, var_core_value_sigD892, var_core_value_sigAED2)), var_core_value_sigAAC7.rows["forEach"](var_core_value_sig5964 => {
    let var_core_value_sig808B = var_core_value_sig5964.cells[var_core_value_sig1999].startOffset,
      ...
      var_core_value_sigEA92 = Kn(var_core_value_sig3BE6.body, var_core_value_sig808B, var_core_value_sig2A26, var_core_value_sig1179, var_core_value_sig8B9C);
    var_core_value_sigEA92 && var_core_value_sig3516.push(var_core_value_sigEA92);
  }), {
    actions: H(var_core_value_sig3516),
    cursorColumn: var_core_value_sigAED2
  };
}
function Hn(var_core_value_sigCDCD, var_core_value_sig206A, var_core_value_sig1EFE, var_core_value_sig9904, var_core_value_sig39C7, var_core_value_sigA022 = ["body"]) {
  ...
  let var_core_value_sig991D = (var_core_value_sig913A = var_core_value_sigCDCD.tableSource) == null ? undefined : var_core_value_sig913A[var_core_value_sig1EFE],
    var_core_value_sig3E9C = w(var_core_value_sigCDCD, var_core_value_sig1EFE),
  ...
  let var_core_value_sig1257 = vn({
    ...
    var_core_value_sig97E2 = var_core_value_sig3E9C.rows["map"]((var_core_value_sig8FD9, var_core_value_sig1AE5) => ({
      body: Jn(V(var_core_value_sigF30E(var_core_value_sig7835, var_core_value_sig8FD9.startOffset, var_core_value_sig8FD9.endOffset + 1, false))),
  ...
  return var_core_value_sig1257.sortedRowIndexes["forEach"]((var_core_value_sig7100, var_core_value_sigA19A) => {
    ...
    let var_core_value_sigF5D1 = var_core_value_sigBFA3 + Un(var_core_value_sig97E2, var_core_value_sig3082),
      var_core_value_sig8775 = var_core_value_sigBFA3 + Un(var_core_value_sig97E2, var_core_value_sigD3F5),
      var_core_value_sig481B = var_core_value_sig97E2[var_core_value_sig3082],
      var_core_value_sig13D7 = qn(var_core_value_sigF5D1, var_core_value_sigF5D1 + var_core_value_sig481B.length, var_core_value_sig8775, var_core_value_sig481B.body, var_core_value_sigA022);
    var_core_value_sig13D7 && (var_core_value_sig6663.push(var_core_value_sigF002.getInstance().moveOp(["tableSource", var_core_value_sig1EFE, "tableRows", var_core_value_sig3082], ["tableSource", var_core_value_sig1EFE, "tableRows", var_core_value_sigD3F5])), var_core_value_sig6663.push(var_core_value_sig13D7)), var_core_value_sig97E2.splice(var_core_value_sigD3F5, 0, var_core_value_sig97E2.splice(var_core_value_sig3082, 1)[0]);
  }), H(var_core_value_sig6663);
}
function Un(var_core_value_sigB250, var_core_value_sig4EAB) {
...
function Wn(var_core_value_sig035C, var_core_value_sigA7F0, var_core_value_sig6AE2, var_core_value_sigFD17, var_core_value_sigA5E0) {
  let var_core_value_sigC38F = var_core_value_sigF002.getInstance();
...
function Gn(var_core_value_sigFAFE, var_core_value_sig2B86) {
  return Math.min(Math.max(0, var_core_value_sigFAFE), Math.max(0, var_core_value_sig2B86));
}
function Kn(var_core_value_sig8873, var_core_value_sigB9C5, var_core_value_sig511D, var_core_value_sig1610, var_core_value_sig23AB) {
  return !var_core_value_sig8873 || var_core_value_sig511D <= var_core_value_sigB9C5 || var_core_value_sig1610 >= var_core_value_sigB9C5 && var_core_value_sig1610 <= var_core_value_sig511D ? null : qn(var_core_value_sigB9C5, var_core_value_sig511D, var_core_value_sig1610, Jn(V(var_core_value_sigF30E(var_core_value_sig8873, var_core_value_sigB9C5, var_core_value_sig511D, false))), var_core_value_sig23AB);
}
function qn(var_core_value_sigA15D, var_core_value_sig7E90, var_core_value_sig03F7, var_core_value_sig756F, var_core_value_sig0DB1) {
...
function Yn(var_core_value_sig89BC, var_core_value_sig2191, var_core_value_sig3B2E, var_core_value_sig5A9A, var_core_value_sigB524) {
  let var_core_value_sig8CFB = var_core_value_sigF002.getInstance();
  for (let var_core_value_sigA363 = var_core_value_sigB524; var_core_value_sigA363 >= var_core_value_sig5A9A; var_core_value_sigA363--) var_core_value_sig89BC.push(var_core_value_sig8CFB.removeOp(["tableSource", var_core_value_sig3B2E, "tableColumns", var_core_value_sigA363], V(var_core_value_sig2191.tableColumns[var_core_value_sigA363])));
  var_core_value_sig2191.tableRows["forEach"]((var_core_value_sigFBA5, var_core_value_sigAC47) => {
    for (let var_core_value_sig4805 = var_core_value_sigB524; var_core_value_sig4805 >= var_core_value_sig5A9A; var_core_value_sig4805--) var_core_value_sig89BC.push(var_core_value_sig8CFB.removeOp(["tableSource", var_core_value_sig3B2E, "tableRows", var_core_value_sigAC47, "tableCells", var_core_value_sig4805], V(var_core_value_sigFBA5.tableCells[var_core_value_sig4805])));
  });
}
function Xn(var_core_value_sigB52C, var_core_value_sigA4B8, var_core_value_sigFF9C, var_core_value_sig278D, var_core_value_sigC0FE, var_core_value_sigDD22 = ["body"], var_core_value_sig2D35) {
  ...
  let var_core_value_sigE50A = (var_core_value_sig7A4B = var_core_value_sigB52C.tableSource) == null ? undefined : var_core_value_sig7A4B[var_core_value_sigA4B8],
    var_core_value_sigC8AC = w(var_core_value_sigB52C, var_core_value_sigA4B8);
  ...
  let var_core_value_sig8E63 = var_core_value_sigC0FE === "above" ? var_core_value_sigFF9C : var_core_value_sigFF9C + 1,
    var_core_value_sig300D = var_core_value_sigC0FE === "above" ? T(var_core_value_sigC8AC, var_core_value_sigFF9C).startOffset : T(var_core_value_sigC8AC, var_core_value_sigFF9C).endOffset + 1,
    var_core_value_sig520B = rr(k(var_core_value_sigE50A).map(var_core_value_sigA06F => var_core_value_sig8E63 <= var_core_value_sigA06F.startRow ? {
    ...
    var_core_value_sig1019 = Array.from({
      ...
      let var_core_value_sigB26B = V(var_core_value_sigFE26);
      return or(var_core_value_sigB26B, var_core_value_sig8E63 + var_core_value_sig4654, var_core_value_sig520B), var_core_value_sig2D35 == null || var_core_value_sig2D35(var_core_value_sigB26B, var_core_value_sig4654), var_core_value_sigB26B;
    }),
    var_core_value_sig32AB = ir(var_core_value_sigE50A, var_core_value_sig520B, var_core_value_sig019B => var_core_value_sig019B >= var_core_value_sig8E63 ? var_core_value_sig019B + var_core_value_sig278D : var_core_value_sig019B),
    var_core_value_sig72BE = var_core_value_sigF002.getInstance();
  ...
  let var_core_value_sig3E4A = F(var_core_value_sigB52C, [{
    startOffset: var_core_value_sig300D,
    endOffset: var_core_value_sig300D,
    text: fr(ur(var_core_value_sigE50A.tableColumns["length"]), var_core_value_sig278D)
  }], var_core_value_sigDD22);
  return var_core_value_sig3E4A ? (var_core_value_sig32AB.push(var_core_value_sig3E4A), {
    actions: H(var_core_value_sig32AB),
    cursorRow: var_core_value_sig8E63
  }) : null;
}
function Zn(var_core_value_sig3171, var_core_value_sigEBC4, var_core_value_sig788B = ["body"]) {
  ...
  return var_core_value_sig7C69 ? Xn(var_core_value_sig3171, var_core_value_sigEBC4, 0, 1, "above", var_core_value_sig788B, var_core_value_sigA8C3 => {
...
function Qn(var_core_value_sig01EF, var_core_value_sig3603, var_core_value_sigC163, var_core_value_sigF5F3, var_core_value_sig5E69 = ["body"]) {
  ...
  let var_core_value_sigDCAB = (var_core_value_sig7B39 = var_core_value_sig01EF.tableSource) == null ? undefined : var_core_value_sig7B39[var_core_value_sig3603],
    var_core_value_sigF569 = w(var_core_value_sig01EF, var_core_value_sig3603);
  ...
  if (var_core_value_sig4D6A >= var_core_value_sigDCAB.tableRows["length"]) return $n(var_core_value_sig01EF, var_core_value_sig3603, var_core_value_sig5E69);
  let var_core_value_sigEF80 = ir(var_core_value_sigDCAB, rr(k(var_core_value_sigDCAB).map(var_core_value_sig5276 => tr(var_core_value_sig5276, var_core_value_sig2A9F, var_core_value_sig4401)).filter(var_core_value_sig031B => var_core_value_sig031B != null)), var_core_value_sig9DC0 => var_core_value_sig9DC0 < var_core_value_sig2A9F ? var_core_value_sig9DC0 : var_core_value_sig9DC0 > var_core_value_sig4401 ? var_core_value_sig9DC0 - var_core_value_sig4D6A : null),
    var_core_value_sig526D1 = var_core_value_sigF002.getInstance();
  for (let var_core_value_sig95F0 = var_core_value_sig4401; var_core_value_sig95F0 >= var_core_value_sig2A9F; var_core_value_sig95F0--) var_core_value_sigEF80.push(var_core_value_sig526D1.removeOp(["tableSource", var_core_value_sig3603, "tableRows", var_core_value_sig95F0], V(var_core_value_sigDCAB.tableRows[var_core_value_sig95F0])));
  let var_core_value_sigD78B = T(var_core_value_sigF569, var_core_value_sig2A9F).startOffset,
    var_core_value_sigCB8C = T(var_core_value_sigF569, var_core_value_sig4401).endOffset + 1,
    var_core_value_sigD217 = F(var_core_value_sig01EF, [{
      startOffset: var_core_value_sigD78B,
      endOffset: var_core_value_sigCB8C,
      text: ""
    }], var_core_value_sig5E69);
  return var_core_value_sigD217 ? (var_core_value_sigEF80.push(...er(var_core_value_sig01EF, [{
    startOffset: var_core_value_sigD78B,
    endOffset: var_core_value_sigCB8C,
    collapsed: false
  }])), var_core_value_sigEF80.push(var_core_value_sigD217), {
    actions: H(var_core_value_sigEF80),
    cursorRow: Math.min(var_core_value_sig2A9F, var_core_value_sigDCAB.tableRows["length"] - var_core_value_sig4D6A - 1)
  }) : null;
}
function $n(var_core_value_sigEB0F, var_core_value_sigDC44, var_core_value_sigDEFC) {
  ...
  let var_core_value_sigA77A = (var_core_value_sigE842 = var_core_value_sigEB0F.tableSource) == null ? undefined : var_core_value_sigE842[var_core_value_sigDC44],
    var_core_value_sig0701 = w(var_core_value_sigEB0F, var_core_value_sigDC44);
  if (!var_core_value_sigA77A || !var_core_value_sig0701) return null;
  let var_core_value_sig5DCA = F(var_core_value_sigEB0F, [{
  ...
  let var_core_value_sigF1AB = er(var_core_value_sigEB0F, [{
    startOffset: var_core_value_sig0701.startOffset,
    endOffset: var_core_value_sig0701.endOffset,
    collapsed: false
  }]);
  return {
    actions: H([var_core_value_sigF002.getInstance().removeOp(["tableSource", var_core_value_sigDC44], V(var_core_value_sigA77A)), ...var_core_value_sigF1AB, var_core_value_sig5DCA]),
    cursorRow: 0,
    deleteTable: true
  };
}
function er(var_core_value_sig902F, var_core_value_sig6BD7) {
  ...
  let var_core_value_sig1B87 = var_core_value_sig902F.drawings ?? {},
    ...
    var_core_value_sig4836 = [...new Set(var_core_value_sigA6B6(var_core_value_sig63E0, var_core_value_sig6BD7))].sort((var_core_value_sig9CCB, var_core_value_sigE718) => var_core_value_sig580B.indexOf(var_core_value_sigE718) - var_core_value_sig580B.indexOf(var_core_value_sig9CCB)),
    var_core_value_sig4C06 = var_core_value_sigF002.getInstance(),
...
function tr(var_core_value_sig7C26, var_core_value_sigBC59, var_core_value_sig544E) {
...
function nr(var_core_value_sig1B22, var_core_value_sig8854, var_core_value_sig5275) {
...
function rr(var_core_value_sig2921) {
...
function ir(var_core_value_sig926F, var_core_value_sig9414, var_core_value_sig32E7) {
  let var_core_value_sigD8C3 = [],
    var_core_value_sig3A44 = var_core_value_sigF002.getInstance();
  return var_core_value_sig926F.tableRows["forEach"]((var_core_value_sig528D, var_core_value_sigA309) => {
    ...
    var_core_value_sig9E20 != null && var_core_value_sig528D.tableCells["forEach"]((var_core_value_sig877E, var_core_value_sig20C8) => {
      let var_core_value_sigE9A7 = var_core_value_sig9414.get(lr(var_core_value_sig9E20, var_core_value_sig20C8)),
        ...
        var_core_value_sig1B221 = B(var_core_value_sig3A44, [...var_core_value_sigBECE, "rowSpan"], var_core_value_sig877E.rowSpan, var_core_value_sigE9A7 == null ? undefined : var_core_value_sigE9A7.rowSpan),
        var_core_value_sig7F72 = B(var_core_value_sig3A44, [...var_core_value_sigBECE, "columnSpan"], var_core_value_sig877E.columnSpan, var_core_value_sigE9A7 == null ? undefined : var_core_value_sigE9A7.columnSpan);
...
function ar(var_core_value_sig0642, var_core_value_sig786E, var_core_value_sigFC47) {
  let var_core_value_sig48E2 = [],
    var_core_value_sig2FCA = var_core_value_sigF002.getInstance();
  return var_core_value_sig0642.tableRows["forEach"]((var_core_value_sig26BB, var_core_value_sig19B4) => {
    var_core_value_sig26BB.tableCells["forEach"]((var_core_value_sig7B2A, var_core_value_sig06CD) => {
      ...
      let var_core_value_sig97A2 = var_core_value_sig786E.get(lr(var_core_value_sig19B4, var_core_value_sigA5F1)),
        ...
        var_core_value_sig4F59 = B(var_core_value_sig2FCA, [...var_core_value_sig07E9, "rowSpan"], var_core_value_sig7B2A.rowSpan, var_core_value_sig97A2 == null ? undefined : var_core_value_sig97A2.rowSpan),
        var_core_value_sigF564 = B(var_core_value_sig2FCA, [...var_core_value_sig07E9, "columnSpan"], var_core_value_sig7B2A.columnSpan, var_core_value_sig97A2 == null ? undefined : var_core_value_sig97A2.columnSpan);
...
function or(var_core_value_sig04F2, var_core_value_sig2CFC, var_core_value_sig5CEB) {
  var_core_value_sig04F2.tableCells["forEach"]((var_core_value_sig218A, var_core_value_sig14CB) => {
    let var_core_value_sigFDEE = var_core_value_sig5CEB.get(lr(var_core_value_sig2CFC, var_core_value_sig14CB));
    cr(var_core_value_sig218A, "rowSpan", var_core_value_sigFDEE == null ? undefined : var_core_value_sigFDEE.rowSpan), cr(var_core_value_sig218A, "columnSpan", var_core_value_sigFDEE == null ? undefined : var_core_value_sigFDEE.columnSpan);
  });
}
function sr(var_core_value_sig4935, var_core_value_sig1832, var_core_value_sig79D7, var_core_value_sig5E01) {
  let var_core_value_sigBBE4 = var_core_value_sig5E01.get(lr(var_core_value_sig1832, var_core_value_sig79D7));
  cr(var_core_value_sig4935, "rowSpan", var_core_value_sigBBE4 == null ? undefined : var_core_value_sigBBE4.rowSpan), cr(var_core_value_sig4935, "columnSpan", var_core_value_sigBBE4 == null ? undefined : var_core_value_sigBBE4.columnSpan);
}
function cr(var_core_value_sig96B3, var_core_value_sig9CF2, var_core_value_sig666D) {
...
function lr(var_core_value_sigBD53, var_core_value_sigD11F) {
  return [var_core_value_sigBD53, var_core_value_sigD11F].join(":");
}
function ur(var_core_value_sig62231) {
  return [var_core_value_sig749D.TABLE_ROW_START, fr(dr(), var_core_value_sig62231), var_core_value_sig749D.TABLE_ROW_END].join("");
}
function dr() {
  return [var_core_value_sig749D.TABLE_CELL_START, "\x0d\x0a", var_core_value_sig749D.TABLE_CELL_END].join("");
}
function fr(var_core_value_sig7653, var_core_value_sigF65B) {
  return Array.from({
    length: var_core_value_sigF65B
  }, () => var_core_value_sig7653).join("");
}
function V(var_core_value_sig4A94) {
  return Array.isArray(var_core_value_sig4A94) ? var_core_value_sig4A94.map(var_core_value_sigA676 => V(var_core_value_sigA676)) : !var_core_value_sig4A94 || typeof var_core_value_sig4A94 != "object" ? var_core_value_sig4A94 : Object.fromEntries(Object.entries(var_core_value_sig4A94).map(([var_core_value_sigC27E, var_core_value_sigA70D]) => [var_core_value_sigC27E, V(var_core_value_sigA70D)]));
}
function H(var_core_value_sigEB59) {
  return var_core_value_sigEB59.reduce((var_core_value_sigCE10, var_core_value_sigA3861) => var_core_value_sigF002.compose(var_core_value_sigCE10, var_core_value_sigA3861), null);
}
function U(var_core_value_sigD9B0, var_core_value_sigB7D6, var_core_value_sigCF1F, var_core_value_sig4DD1, var_core_value_sig1293, var_core_value_sigC999, var_core_value_sig9D8F, var_core_value_sig8270) {
  if (!var_core_value_sig4DD1) return true;
  let var_core_value_sig95D9 = [];
  return var_core_value_sig1293 ? var_core_value_sig95D9 = mr(var_core_value_sigCF1F, var_core_value_sig1293) : var_core_value_sigC999 != null && (var_core_value_sig95D9 = [{
    startOffset: var_core_value_sigC999,
    endOffset: var_core_value_sigC999,
    collapsed: true
  }]), !!var_core_value_sigD9B0.syncExecuteCommand(var_core_value_sig5F5F.id, {
...
function W(var_core_value_sig0E92, var_core_value_sig45CD = "") {
...
function pr(var_core_value_sig36BD, var_core_value_sig0413) {
  return JSON.stringify(var_core_value_sig36BD) === JSON.stringify(var_core_value_sig0413);
}
function mr(var_core_value_sig15B6, var_core_value_sigFEBF) {
  var var_core_value_sigBBA2, var_core_value_sigC9A1, var_core_value_sigE469;
  let var_core_value_sigA499 = w(var_core_value_sig15B6, var_core_value_sigFEBF.tableId);
  ...
  return [{
    ...
    collapsed: false,
    rangeType: var_core_value_sig91FE.RECT,
...
function hr(var_core_value_sigBABA) {
  "@babel/helpers - typeof";

  return hr = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigCD82) {
  ...
  }, hr(var_core_value_sigBABA);
}
function gr(var_core_value_sigA723, var_core_value_sig991C) {
  if (hr(var_core_value_sigA723) != "object" || !var_core_value_sigA723) return var_core_value_sigA723;
  ...
  if (var_core_value_sigF909 !== undefined) {
    ...
    if (hr(var_core_value_sigDD0E) != "object") return var_core_value_sigDD0E;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig991C === "string" ? String : Number)(var_core_value_sigA723);
}
function _r(var_core_value_sigF2A0) {
  var var_core_value_sig116F = gr(var_core_value_sigF2A0, "string");
  return hr(var_core_value_sig116F) == "symbol" ? var_core_value_sig116F : var_core_value_sig116F + "";
}
function G(var_core_value_sigA64C, var_core_value_sigAF94, var_core_value_sig1E9F) {
  return (var_core_value_sigAF94 = _r(var_core_value_sigAF94)) in var_core_value_sigA64C ? Object.defineProperty(var_core_value_sigA64C, var_core_value_sigAF94, {
...
function K(var_core_value_sig3CC6, var_core_value_sig041B) {
...
function vr(var_core_value_sig3610, var_core_value_sig62F3, var_core_value_sig8063, var_core_value_sig555A) {
...
let q = class extends var_core_value_sig032D {
  constructor(var_core_value_sig040A, var_core_value_sig2AE0) {
    var var_core_value_sigC349;
    super(), this._univerInstanceService = var_core_value_sig040A, this._docSelectionManagerService = var_core_value_sig2AE0, G(this, "_selectionChange$", new var_core_value_sig7D2D()), G(this, "_structuralSelection", null), G(this, "_structuralSelectionTableShape", null), G(this, "_nativeSelectionSuppressed", false), G(this, "_preserveStructuralSelectionOnNextTextSelection", false), G(this, "selectionChange$", this._selectionChange$["asObservable"]()), this.disposeWithMe(((var_core_value_sigC349 = this._docSelectionManagerService["textSelection$"]) == null ? undefined : var_core_value_sigC349.subscribe(() => {
  ...
  getStableTableSelection() {
    ...
    return yr(var_core_value_sig5EFB) ? var_core_value_sig5EFB : null;
  }
  ...
  setStructuralSelection(var_core_value_sig2682, var_core_value_sig4BB5 = {}) {
    ...
    let var_core_value_sig52CA = this._getCurrentDoc(),
      ...
      var_core_value_sig88F6 = var_core_value_sigC030 ? Sr(var_core_value_sigC030, var_core_value_sig2682) : null;
    ...
    if (this._structuralSelection = {
      kind: Tr(var_core_value_sig2682.kind, var_core_value_sig88F6, var_core_value_sigC030),
      ...
      source: "structural"
    }, this._structuralSelectionTableShape = wr(var_core_value_sigC030), this._preserveStructuralSelectionOnNextTextSelection = !!var_core_value_sig4BB5.preserveOnTextSelection, var_core_value_sig4BB5.clearNativeSelection !== false) {
  ...
  _getCurrentDoc() {
    ...
    return ((var_core_value_sig81B2 = (var_core_value_sigA0A5 = this._univerInstanceService).getCurrentUnitOfType) == null ? undefined : var_core_value_sig81B2.call(var_core_value_sigA0A5, var_core_value_sig87EA.UNIVER_DOC)) ?? null;
  }
  ...
  _setDirectStructuralSelection(var_core_value_sig00BE, var_core_value_sig7BB5 = {}) {
    ...
    let var_core_value_sig1157 = this._getCurrentDoc(),
      ...
      var_core_value_sig18E01 = var_core_value_sigA694 ? Sr(var_core_value_sigA694, var_core_value_sig00BE) : null;
    ...
    if (this._structuralSelection = {
      ...
      source: "structural"
    }, this._structuralSelectionTableShape = wr(var_core_value_sigA694), this._preserveStructuralSelectionOnNextTextSelection = !!var_core_value_sig7BB5.preserveOnTextSelection, var_core_value_sig7BB5.clearNativeSelection !== false) {
  ...
  _getSelectionFromActiveTextRange(var_core_value_sig555F, var_core_value_sig3D6F) {
    ...
    let var_core_value_sig8DFE = z(var_core_value_sig555F, var_core_value_sig3D6F.segmentId) ?? var_core_value_sig555F.getSnapshot(),
    ...
    let var_core_value_sig5E16 = w(var_core_value_sig8DFE, var_core_value_sig48EA.tableId),
    ...
    let var_core_value_sig4592 = Be(var_core_value_sig5E16.tableSource, {
    ...
    return {
      kind: Tr("cell", var_core_value_sig4592, var_core_value_sig5E16.tableSource),
  ...
  _getSelectionFromRectRanges(var_core_value_sigC5C4, var_core_value_sig1617) {
    ...
    let var_core_value_sig8986 = var_core_value_sig1617.filter(var_core_value_sig2B65 => var_core_value_sig2B65.tableId === var_core_value_sig279C).map(var_core_value_sigD7EA => {
      let var_core_value_sigB33B = xr(var_core_value_sigAC51, var_core_value_sigD7EA);
    ...
    let var_core_value_sigCAF7 = var_core_value_sig8986.filter(var_core_value_sigE627 => var_core_value_sigE627 != null),
      ...
      var_core_value_sig726E = Be(var_core_value_sigAC51, {
      ...
      var_core_value_sig2CD3 = Tr("range", var_core_value_sig726E, var_core_value_sigAC51),
  ...
  _getValidStructuralSelection(var_core_value_sig5830) {
    ...
    let var_core_value_sigCDAF = (var_core_value_sig4A7C = var_core_value_sig5830.getSnapshot().tableSource) == null ? undefined : var_core_value_sig4A7C[var_core_value_sigF975.tableId],
      var_core_value_sigA298 = var_core_value_sigCDAF ? Sr(var_core_value_sigCDAF, var_core_value_sigF975) : null;
    return !var_core_value_sigCDAF || !var_core_value_sigA298 || this._structuralSelectionTableShape !== wr(var_core_value_sigCDAF) ? (this._clearStructuralSelectionState(true), null) : (this._structuralSelection = {
      ...var_core_value_sigF975,
      kind: Tr(var_core_value_sigF975.kind, var_core_value_sigA298, var_core_value_sigCDAF),
...
q = vr([K(0, var_core_value_sig1760), K(1, var_core_value_sig7C7A(var_core_value_sig4037))], q);
function yr(var_core_value_sig7EE4) {
...
function br(var_core_value_sigE3D7) {
  return {
...
function xr(var_core_value_sig54C6, var_core_value_sigE843) {
  let var_core_value_sig2EB2 = Cr(var_core_value_sig54C6, var_core_value_sigE843);
  return var_core_value_sig2EB2 ? Be(var_core_value_sig54C6, var_core_value_sig2EB2) : null;
}
function Sr(var_core_value_sig683A, var_core_value_sig109B) {
  let var_core_value_sig6DD0 = Cr(var_core_value_sig683A, var_core_value_sig109B);
  return var_core_value_sig6DD0 ? var_core_value_sig109B.kind === "row" || var_core_value_sig109B.kind === "column" ? var_core_value_sig6DD0 : Be(var_core_value_sig683A, var_core_value_sig6DD0) : null;
}
function Cr(var_core_value_sigB5D3, var_core_value_sig6085) {
  var var_core_value_sig2507;
  let var_core_value_sig5870 = br(var_core_value_sig6085),
...
function wr(var_core_value_sig50D0) {
...
function Tr(var_core_value_sig5EBB, var_core_value_sig5E99, var_core_value_sig3FB3) {
  ...
  if (var_core_value_sig5EBB === "cell" && (var_core_value_sig0214 || Dr(var_core_value_sig3FB3, var_core_value_sig5E99))) return "cell";
  let {
    spansEntireRow: var_core_value_sig5153,
    spansEntireColumn: var_core_value_sigF323
  } = Er(var_core_value_sig5E99, var_core_value_sig3FB3);
...
function Er(var_core_value_sig0C32, var_core_value_sig1D89) {
...
function Dr(var_core_value_sigAD4B, var_core_value_sig06EA) {
...
const Or = {
    ...
    type: var_core_value_sig1D22.COMMAND,
    handler: (var_core_value_sigF3C7, var_core_value_sig5633) => {
      if (!var_core_value_sig5633) return false;
      let var_core_value_sig2492 = var_core_value_sigF3C7.get(var_core_value_sig1760),
        var_core_value_sig39F2 = var_core_value_sigF3C7.get(var_core_value_sig533B),
        var_core_value_sigAD47 = var_core_value_sigF3C7.get(q),
        var_core_value_sig1722 = var_core_value_sig2492.getUnit(var_core_value_sig5633.unitId, var_core_value_sig87EA.UNIVER_DOC);
      ...
      let var_core_value_sig7F86 = var_core_value_sigAD47.getCurrentSelection(),
        ...
        var_core_value_sigD7F4 = z(var_core_value_sig1722, var_core_value_sig524D);
      if (!var_core_value_sigD7F4) return false;
      let var_core_value_sig7B87 = zn(var_core_value_sigD7F4, var_core_value_sigCF8B, var_core_value_sigC1D8, var_core_value_sig7CB9, W(var_core_value_sigCD15, var_core_value_sig524D));
      if (!var_core_value_sig7B87) return false;
      let var_core_value_sig933D = U(var_core_value_sig39F2, var_core_value_sig1722.getUnitId(), var_core_value_sigD7F4, var_core_value_sig7B87.actions, undefined, undefined, Or.id);
      if (var_core_value_sig933D && var_core_value_sigF69D) {
        let var_core_value_sig0E9F = Se(var_core_value_sigF69D, var_core_value_sigD7F4, var_core_value_sig7B87.deleteTable ? {
          kind: "delete-table",
          tableId: var_core_value_sigCF8B
        } : {
          kind: "delete-columns",
  ...
  kr = {
    ...
    handler: (var_core_value_sig6ACE, var_core_value_sig7675) => {
      ...
      let var_core_value_sig21B8 = var_core_value_sig6ACE.get(var_core_value_sig1760),
        var_core_value_sigD545 = var_core_value_sig6ACE.get(var_core_value_sig533B),
        var_core_value_sig91C9 = var_core_value_sig6ACE.get(q),
        var_core_value_sig64BA = var_core_value_sig21B8.getUnit(var_core_value_sig7675.unitId, var_core_value_sig87EA.UNIVER_DOC);
      ...
      let var_core_value_sig3FD5 = var_core_value_sig91C9.getCurrentSelection(),
        ...
        var_core_value_sig35E2 = z(var_core_value_sig64BA, var_core_value_sigC8B1);
      if (!var_core_value_sig35E2) return false;
      let var_core_value_sig9B13 = Qn(var_core_value_sig35E2, var_core_value_sigF2E0, var_core_value_sig2D23, var_core_value_sigB9F4, W(var_core_value_sig9214, var_core_value_sigC8B1));
      if (!var_core_value_sig9B13) return false;
      let var_core_value_sig60E6 = U(var_core_value_sigD545, var_core_value_sig64BA.getUnitId(), var_core_value_sig35E2, var_core_value_sig9B13.actions, undefined, undefined, kr.id);
      if (var_core_value_sig60E6 && var_core_value_sig1008) {
        let var_core_value_sigE5BA = Se(var_core_value_sig1008, var_core_value_sig35E2, var_core_value_sig9B13.deleteTable ? {
          kind: "delete-table",
          tableId: var_core_value_sigF2E0
        } : {
          kind: "delete-rows",
  ...
  Ar = {
    ...
    handler: (var_core_value_sig1F6E, var_core_value_sig7A6B) => {
      ...
      let var_core_value_sig20F6 = var_core_value_sig1F6E.get(var_core_value_sig1760),
        var_core_value_sigAEE0 = var_core_value_sig1F6E.get(var_core_value_sig533B),
        var_core_value_sig72B6 = var_core_value_sig1F6E.get(q),
        var_core_value_sig43E8 = var_core_value_sig20F6.getUnit(var_core_value_sig7A6B.unitId, var_core_value_sig87EA.UNIVER_DOC),
      ...
      let {
        ...
        var_core_value_sig6788 = z(var_core_value_sig43E8, var_core_value_sigC865);
      if (!var_core_value_sig6788) return false;
      let var_core_value_sig7B1F = $n(var_core_value_sig6788, var_core_value_sig55FB, W(var_core_value_sig2870, var_core_value_sigC865));
      if (!var_core_value_sig7B1F) return false;
      let var_core_value_sig7E51 = U(var_core_value_sigAEE0, var_core_value_sig43E8.getUnitId(), var_core_value_sig6788, var_core_value_sig7B1F.actions, undefined, undefined, Ar.id);
      if (var_core_value_sig7E51 && var_core_value_sig6876) {
        let var_core_value_sig4A83 = Se(var_core_value_sig6876, var_core_value_sig6788, {
          kind: "delete-table",
          tableId: var_core_value_sig55FB
        });
  ...
  jr = {
    ...
    handler: async (var_core_value_sigAE87, var_core_value_sigFD51) => {
      let var_core_value_sigF6D6 = var_core_value_sigAE87.get(var_core_value_sig1760),
        var_core_value_sigCF95 = var_core_value_sigAE87.get(var_core_value_sig533B),
        var_core_value_sig8793 = var_core_value_sigAE87.get(q),
        var_core_value_sig1BE7 = var_core_value_sigF6D6.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig72BB = z(var_core_value_sig1BE7, L(var_core_value_sigFD51, var_core_value_sig34F8));
      if (!var_core_value_sig72BB) return false;
      let var_core_value_sigC0DF = Mn(var_core_value_sig72BB, var_core_value_sig9F3D, var_core_value_sig785C, var_core_value_sig6537);
      return U(var_core_value_sigCF95, var_core_value_sig1BE7.getUnitId(), var_core_value_sig72BB, var_core_value_sigC0DF);
    }
  },
  Mr = {
    ...
    handler: async (var_core_value_sig94B7, var_core_value_sig9865) => {
      let var_core_value_sigA09D = var_core_value_sig94B7.get(var_core_value_sig1760),
        var_core_value_sig1429 = var_core_value_sig94B7.get(var_core_value_sig533B),
        var_core_value_sigA339 = var_core_value_sig94B7.get(q),
        var_core_value_sig832A = var_core_value_sigA09D.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigDFF0 = z(var_core_value_sig832A, L(var_core_value_sig9865, var_core_value_sig7945));
      if (!var_core_value_sigDFF0) return false;
      let var_core_value_sig0130 = jn(var_core_value_sigDFF0, var_core_value_sig1166, var_core_value_sig7ABC, var_core_value_sigF686);
      return U(var_core_value_sig1429, var_core_value_sig832A.getUnitId(), var_core_value_sigDFF0, var_core_value_sig0130);
    }
  },
  Nr = {
    ...
    handler: async (var_core_value_sigFD90, var_core_value_sig702C) => {
      ...
      let var_core_value_sigB6F5 = var_core_value_sigFD90.get(var_core_value_sig1760),
        var_core_value_sig82931 = var_core_value_sigFD90.get(var_core_value_sig533B),
        var_core_value_sig43AE = var_core_value_sigFD90.get(q),
        var_core_value_sigEF2E = var_core_value_sigB6F5.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigC982 = var_core_value_sigEF2E.getSnapshot(),
        var_core_value_sig59DA = L(var_core_value_sig702C, var_core_value_sigD83C),
        var_core_value_sig3002 = z(var_core_value_sigEF2E, var_core_value_sig59DA);
      ...
      let var_core_value_sig33D2 = var_core_value_sig702C.count ?? (var_core_value_sigD83C ? Math.max(1, var_core_value_sigD83C.endColumn - var_core_value_sigD83C.startColumn + 1) : 1),
        var_core_value_sig8D4A = ((var_core_value_sig03A4 = var_core_value_sigC982.documentStyle) == null ? undefined : var_core_value_sig03A4.documentFlavor) === var_core_value_sig27FA.MODERN,
        var_core_value_sigB5D7 = Pn(var_core_value_sig3002, var_core_value_sigAC2B, var_core_value_sigFBBE, var_core_value_sig33D2, var_core_value_sig702C.position, {
          bodyPath: W(var_core_value_sigC982, var_core_value_sig59DA),
          insertedColumnWidth: var_core_value_sig8D4A ? Pr(var_core_value_sigC982, var_core_value_sigAC2B, var_core_value_sigFBBE, var_core_value_sig702C.position) : undefined,
          preserveTotalWidth: !var_core_value_sig8D4A
        });
      if (!var_core_value_sigB5D7) return false;
      let var_core_value_sig797B = U(var_core_value_sig82931, var_core_value_sigEF2E.getUnitId(), var_core_value_sig3002, var_core_value_sigB5D7.actions);
      if (var_core_value_sig797B && var_core_value_sigD83C) {
        let var_core_value_sig58AA = Se(var_core_value_sigD83C, var_core_value_sig3002, {
          kind: "insert-columns",
...
function Pr(var_core_value_sig5094, var_core_value_sig8883, var_core_value_sig488F, var_core_value_sigB440) {
...
const Fr = {
    ...
    handler: async (var_core_value_sig7876, var_core_value_sig2C69) => {
      ...
      let var_core_value_sigAF19 = var_core_value_sig7876.get(var_core_value_sig1760),
        var_core_value_sigCE75 = var_core_value_sig7876.get(var_core_value_sig533B),
        var_core_value_sigF27A = var_core_value_sig7876.get(q),
        var_core_value_sig47B3 = var_core_value_sigAF19.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigD85C = var_core_value_sig47B3.getSnapshot(),
        var_core_value_sig3957 = L(var_core_value_sig2C69, var_core_value_sig5E75),
        var_core_value_sigA101 = z(var_core_value_sig47B3, var_core_value_sig3957);
      ...
      let var_core_value_sig2ADC = var_core_value_sig2C69.count ?? (var_core_value_sig5E75 ? Math.max(1, var_core_value_sig5E75.endRow - var_core_value_sig5E75.startRow + 1) : 1),
        var_core_value_sig1386 = Xn(var_core_value_sigA101, var_core_value_sigC266, var_core_value_sig77A3, var_core_value_sig2ADC, var_core_value_sig2C69.position, W(var_core_value_sigD85C, var_core_value_sig3957));
      if (!var_core_value_sig1386) return false;
      let var_core_value_sig96F5 = U(var_core_value_sigCE75, var_core_value_sig47B3.getUnitId(), var_core_value_sigA101, var_core_value_sig1386.actions);
      if (var_core_value_sig96F5 && var_core_value_sig5E75) {
        let var_core_value_sig84C4 = Se(var_core_value_sig5E75, var_core_value_sigA101, {
          kind: "insert-rows",
...
function Lr(var_core_value_sig7F54) {
  ...
  let var_core_value_sigBF43 = Vr(var_core_value_sig7F54),
    var_core_value_sigBC08 = [],
    var_core_value_sig3F28 = var_core_value_sigF002.getInstance();
  for (let var_core_value_sigB6F7 = var_core_value_sigBF43.startRow; var_core_value_sigB6F7 <= var_core_value_sigBF43.endRow; var_core_value_sigB6F7++) for (let var_core_value_sig3607 = var_core_value_sigBF43.startColumn; var_core_value_sig3607 <= var_core_value_sigBF43.endColumn; var_core_value_sig3607++) {
    ...
    zr(var_core_value_sigBC08, ["tableSource", var_core_value_sig7F54.tableId, "tableRows", var_core_value_sigB6F7, "tableCells", var_core_value_sig3607, "margin"], var_core_value_sigA12B.margin, var_core_value_sig7F54.margin ?? undefined, var_core_value_sig3F28);
  }
  return Br(var_core_value_sigBC08);
}
function Rr(var_core_value_sig0A96, var_core_value_sig72FE, var_core_value_sigE8ED) {
  ...
  return zr(var_core_value_sigCDF2, ["tableSource", var_core_value_sig72FE, "cellMargin"], var_core_value_sig8E87.cellMargin, var_core_value_sigE8ED ?? undefined, var_core_value_sigF002.getInstance()), Br(var_core_value_sigCDF2);
}
function zr(var_core_value_sig1043, var_core_value_sig4289, var_core_value_sig2729, var_core_value_sig5BB6, var_core_value_sig5C75) {
  JSON.stringify(var_core_value_sig2729) !== JSON.stringify(var_core_value_sig5BB6) && (var_core_value_sig2729 === undefined ? var_core_value_sig1043.push(var_core_value_sig5C75.insertOp(var_core_value_sig4289, var_core_value_sig252C.deepClone(var_core_value_sig5BB6))) : var_core_value_sig5BB6 === undefined ? var_core_value_sig1043.push(var_core_value_sig5C75.removeOp(var_core_value_sig4289, var_core_value_sig2729)) : var_core_value_sig1043.push(var_core_value_sig5C75.replaceOp(var_core_value_sig4289, var_core_value_sig2729, var_core_value_sig252C.deepClone(var_core_value_sig5BB6))));
}
function Br(var_core_value_sigCB46) {
  return var_core_value_sigCB46.reduce((var_core_value_sigB495, var_core_value_sig70D0) => var_core_value_sigF002.compose(var_core_value_sigB495, var_core_value_sig70D0), null);
}
function Vr(var_core_value_sig0177) {
  return {
...
let Hr = function (var_core_value_sigC674) {
...
function Wr(var_core_value_sigC11B, var_core_value_sig5461 = ["body"]) {
  var var_core_value_sigBA12, var_core_value_sig65CB;
  let var_core_value_sig8AF4 = var_core_value_sigC11B.documentData["body"] ?? qr(),
    var_core_value_sig7C2D = Yr(var_core_value_sigC11B),
    ...
    var_core_value_sig6883 = Xr(var_core_value_sig8AF4, var_core_value_sigC11B);
  Zr(var_core_value_sig8AF4, var_core_value_sig6883);
  let var_core_value_sig2A05 = Gr(var_core_value_sig8AF4, var_core_value_sigC11B, var_core_value_sig7C2D, var_core_value_sig6883),
    var_core_value_sig9CA8 = var_core_value_sigC11B.documentData["body"] ? Kr(var_core_value_sig2A05, var_core_value_sig6883, var_core_value_sig5461) : var_core_value_sigF002.getInstance().insertOp(var_core_value_sig5461, Jr(var_core_value_sig2A05)),
    var_core_value_sig3C9C = li(var_core_value_sigC11B, var_core_value_sig5F54, var_core_value_sig668D),
    var_core_value_sig7651 = var_core_value_sigF002.getInstance().insertOp(["tableSource", var_core_value_sigC11B.tableId], var_core_value_sig3C9C),
    var_core_value_sig6E4E = N(var_core_value_sigC11B.metadata),
    var_core_value_sigC2E8 = mi(var_core_value_sigC11B);
  return var_core_value_sigC2E8 && (var_core_value_sig6E4E.tables[var_core_value_sigC11B.tableId] = var_core_value_sigC2E8), {
    actions: var_core_value_sigF002.compose(var_core_value_sig9CA8, var_core_value_sig7651),
...
function Gr(var_core_value_sig3A04, var_core_value_sig935E, var_core_value_sigDC45, var_core_value_sig7C31) {
  let var_core_value_sig8B54 = si(var_core_value_sig3A04),
    var_core_value_sigC19B = oi(var_core_value_sigDC45, var_core_value_sig8B54, ci(var_core_value_sig3A04)),
    var_core_value_sigFB87 = ti(var_core_value_sig3A04, var_core_value_sig7C31) ? var_core_value_sig749D.PARAGRAPH : "",
    var_core_value_sigA318 = var_core_value_sigFB87 ? ri(var_core_value_sig3A04, var_core_value_sig7C31) : undefined,
    var_core_value_sig51A4 = ni(var_core_value_sig3A04, var_core_value_sig7C31) ? var_core_value_sig749D.PARAGRAPH : "",
  ...
  return {
    ...
    paragraphs: [...ii(0, var_core_value_sigFB87, var_core_value_sig8B54, var_core_value_sigA318), ...var_core_value_sigC19B.paragraphs["map"](var_core_value_sig3782 => ({
      ...var_core_value_sig3782,
      startIndex: var_core_value_sig3782.startIndex + var_core_value_sig2966
    })), ...ai(var_core_value_sigF4C4, var_core_value_sig51A4, var_core_value_sig8B54)],
...
function Kr(var_core_value_sig5617, var_core_value_sig450E, var_core_value_sig92A31) {
  let var_core_value_sig61E5 = new var_core_value_sigEA39();
  return var_core_value_sig450E > 0 && var_core_value_sig61E5.retain(var_core_value_sig450E), var_core_value_sig61E5.insert(var_core_value_sig5617.dataStream["length"], var_core_value_sig5617), var_core_value_sigF002.getInstance().editOp(var_core_value_sig61E5.serialize(), var_core_value_sig92A31);
}
function qr() {
  return {
    dataStream: var_core_value_sig749D.SECTION_BREAK,
    paragraphs: [],
    sectionBreaks: [{
      sectionId: var_core_value_sig4B86(new Set()),
      startIndex: 0
    }],
    tables: []
  };
}
function Jr(var_core_value_sig9E17) {
  var var_core_value_sigB97D;
  let var_core_value_sigFE1E = var_core_value_sig9E17.dataStream["length"];
  return {
    ...var_core_value_sig9E17,
    dataStream: var_core_value_sig9E17.dataStream + var_core_value_sig749D.SECTION_BREAK,
    sectionBreaks: [...(var_core_value_sig9E17.sectionBreaks ?? []), {
      sectionId: var_core_value_sig4B86(new Set((var_core_value_sigB97D = var_core_value_sig9E17.sectionBreaks) == null ? undefined : var_core_value_sigB97D.map(var_core_value_sig3455 => var_core_value_sig3455.sectionId))),
      startIndex: var_core_value_sigFE1E
    }]
  };
}
function Yr(var_core_value_sig5F541) {
...
function Xr(var_core_value_sigE5FE, var_core_value_sig78A5) {
  return typeof var_core_value_sig78A5.offset == "number" ? Math.max(0, Math.min(var_core_value_sig78A5.offset, var_core_value_sigE5FE.dataStream["length"])) : var_core_value_sigE5FE.dataStream["endsWith"](var_core_value_sig749D.SECTION_BREAK) ? var_core_value_sigE5FE.dataStream["length"] - 1 : var_core_value_sigE5FE.dataStream["length"];
}
function Zr(var_core_value_sig9A4C, var_core_value_sigC723) {
  if (Qr(var_core_value_sig9A4C.tables, var_core_value_sigC723) || $r(var_core_value_sig9A4C.blockRanges, var_core_value_sigC723) || ei(var_core_value_sig9A4C.customBlocks, var_core_value_sigC723)) throw new Ur();
}
function Qr(var_core_value_sig1E32, var_core_value_sig22AF) {
  return !!(var_core_value_sig1E32 != null && var_core_value_sig1E32.some(var_core_value_sig9FA0 => var_core_value_sig4325(var_core_value_sig0D1B(var_core_value_sig9FA0), var_core_value_sig22AF)));
}
function $r(var_core_value_sig0F31, var_core_value_sig8F25) {
  return !!(var_core_value_sig0F31 != null && var_core_value_sig0F31.some(var_core_value_sig055E => var_core_value_sig4325(var_core_value_sigDE46(var_core_value_sig055E), var_core_value_sig8F25)));
}
function ei(var_core_value_sigCBED, var_core_value_sig6224) {
...
function ti(var_core_value_sigFC3E, var_core_value_sig4D33) {
  return var_core_value_sig4D33 <= 0 || var_core_value_sigFC3E.dataStream[var_core_value_sig4D33 - 1] !== var_core_value_sig749D.PARAGRAPH;
}
function ni(var_core_value_sig08BF, var_core_value_sig1814) {
  return var_core_value_sig08BF.dataStream[var_core_value_sig1814] !== var_core_value_sig749D.PARAGRAPH;
}
function ri(var_core_value_sig2B5D, var_core_value_sig9B0B) {
  var var_core_value_sigF21D;
  return (var_core_value_sigF21D = var_core_value_sig2B5D.paragraphs) == null ? undefined : var_core_value_sigF21D.find(var_core_value_sig9578 => var_core_value_sig1FDB(var_core_value_sig2B5D, var_core_value_sig9578) < var_core_value_sig9B0B && var_core_value_sig9B0B <= var_core_value_sig9578.startIndex);
}
function ii(var_core_value_sig9B55, var_core_value_sigB8F4, var_core_value_sig5E41, var_core_value_sig310E) {
  if (!var_core_value_sigB8F4) return [];
  let var_core_value_sig2E97 = {
    startIndex: var_core_value_sig9B55,
    paragraphId: var_core_value_sigAB8D(var_core_value_sig5E41)
  };
  return var_core_value_sig310E != null && var_core_value_sig310E.bullet && (var_core_value_sig2E97.bullet = var_core_value_sig252C.deepClone(var_core_value_sig310E.bullet)), var_core_value_sig310E != null && var_core_value_sig310E.paragraphStyle && (var_core_value_sig2E97.paragraphStyle = var_core_value_sig252C.deepClone(var_core_value_sig310E.paragraphStyle), delete var_core_value_sig2E97.paragraphStyle["borderBottom"], var_core_value_sig310E.paragraphStyle["headingId"] && (var_core_value_sig2E97.paragraphStyle["headingId"] = var_core_value_sig240E(6))), [var_core_value_sig2E97];
}
function ai(var_core_value_sig4B00, var_core_value_sig9896, var_core_value_sigA725) {
  return var_core_value_sig9896 ? [{
    startIndex: var_core_value_sig4B00,
    paragraphId: var_core_value_sigAB8D(var_core_value_sigA725)
  }] : [];
}
function oi(var_core_value_sig9FB3, var_core_value_sig0E44, var_core_value_sig243C) {
  let var_core_value_sigB3A4 = var_core_value_sig749D.TABLE_START,
    var_core_value_sigAF1B = [],
    var_core_value_sig906D = [];
  return var_core_value_sig9FB3.forEach(var_core_value_sigA2D31 => {
    var_core_value_sigB3A4 += var_core_value_sig749D.TABLE_ROW_START, var_core_value_sigA2D31.forEach(var_core_value_sigB744 => {
      var_core_value_sigB3A4 += "" + var_core_value_sig749D.TABLE_CELL_START + var_core_value_sigB744 + var_core_value_sig749D.PARAGRAPH + var_core_value_sig749D.SECTION_BREAK + var_core_value_sig749D.TABLE_CELL_END, var_core_value_sigAF1B.push({
        startIndex: var_core_value_sigB3A4.length - 3,
        paragraphId: var_core_value_sigAB8D(var_core_value_sig0E44)
      }), var_core_value_sig906D.push({
        sectionId: var_core_value_sig4B86(var_core_value_sig243C),
        startIndex: var_core_value_sigB3A4.length - 2
      });
    }), var_core_value_sigB3A4 += var_core_value_sig749D.TABLE_ROW_END;
  }), var_core_value_sigB3A4 += var_core_value_sig749D.TABLE_END, {
    dataStream: var_core_value_sigB3A4,
    paragraphs: var_core_value_sigAF1B,
    sectionBreaks: var_core_value_sig906D
  };
}
function si(var_core_value_sig6AFB) {
  return new Set((var_core_value_sig6AFB.paragraphs ?? []).map(var_core_value_sigC218 => var_core_value_sigC218.paragraphId));
}
function ci(var_core_value_sig2830) {
  return new Set((var_core_value_sig2830.sectionBreaks ?? []).map(var_core_value_sigADEC => var_core_value_sigADEC.sectionId));
}
function li(var_core_value_sig9C3A, var_core_value_sig0321, var_core_value_sig51CF) {
  let var_core_value_sig3C61 = pi(var_core_value_sig9C3A, var_core_value_sig51CF);
  return {
    tableRows: Array.from({
      length: var_core_value_sig0321
    }, (var_core_value_sig3D8E, var_core_value_sig37E5) => ui(var_core_value_sig9C3A, var_core_value_sig37E5, var_core_value_sig51CF)),
    tableColumns: var_core_value_sig3C61.map(var_core_value_sigF079 => fi(var_core_value_sigF079)),
    tableId: var_core_value_sig9C3A.tableId,
    align: var_core_value_sigC460.START,
    indent: {
      v: 0
    },
    textWrap: var_core_value_sig76AC.NONE,
    position: {
      positionH: {
        relativeFrom: var_core_value_sig715D.PAGE,
        posOffset: 0
      },
      positionV: {
        relativeFrom: var_core_value_sigEB90.PAGE,
        posOffset: 0
      }
    },
    dist: {
    ...
    ...(var_core_value_sig9C3A.cellMargin == null ? {} : {
      cellMargin: var_core_value_sig252C.deepClone(var_core_value_sig9C3A.cellMargin)
    })
  };
}
function ui(var_core_value_sigDC70, var_core_value_sigD10E, var_core_value_sigBB93) {
  var var_core_value_sig4F88;
  return {
    tableCells: Array.from({
      length: var_core_value_sigBB93
    }, (var_core_value_sigF2BC, var_core_value_sigD37B) => di(var_core_value_sigDC70, var_core_value_sigD10E, var_core_value_sigD37B, var_core_value_sigBB93)),
    trHeight: {
      val: {
    ...
    repeatHeaderRow: var_core_value_sigD10E < (var_core_value_sigDC70.headerRowCount ?? 0) ? var_core_value_sig2D2A.TRUE : var_core_value_sig2D2A.FALSE
  };
}
function di(var_core_value_sig486C, var_core_value_sig717C, var_core_value_sig23AE, var_core_value_sigCB54) {
  ...
  return {
    ...(var_core_value_sig486C.cellMargin == null ? {
      margin: var_core_value_sig252C.deepClone(Ir)
    } : {}),
...
function fi(var_core_value_sig6575) {
  return {
    size: {
      type: var_core_value_sig2880.SPECIFIED,
      width: {
...
function pi(var_core_value_sigE901, var_core_value_sigB7EC) {
...
function mi(var_core_value_sigE7BE) {
...
var J = class extends var_core_value_sig032D {
  constructor(...var_core_value_sig2712) {
    super(...var_core_value_sig2712), G(this, "_resources", new Map()), G(this, "_change$", new var_core_value_sig7D2D()), G(this, "change$", this._change$["asObservable"]());
  }
  getTableMetadata(var_core_value_sig0B9E, var_core_value_sigC545) {
    ...
    if (var_core_value_sig6F4E) return N({
      tables: {
  ...
  setHeaderRowCount(var_core_value_sigA021, var_core_value_sig49D9, var_core_value_sig320C) {
    this._setResource(var_core_value_sigA021, var_core_value_sig49D9, tt(this._resources["get"](var_core_value_sigA021), var_core_value_sig49D9, var_core_value_sig320C));
  }
  setTitleRow(var_core_value_sigE7F0, var_core_value_sigE837, var_core_value_sig34F4) {
    this._setResource(var_core_value_sigE7F0, var_core_value_sigE837, nt(this._resources["get"](var_core_value_sigE7F0), var_core_value_sigE837, var_core_value_sig34F4));
  }
  setColumnType(var_core_value_sigA45D, var_core_value_sig1BC7, var_core_value_sig4956, var_core_value_sigCC9E) {
    this._setResource(var_core_value_sigA45D, var_core_value_sig1BC7, rt(this._resources["get"](var_core_value_sigA45D), var_core_value_sig1BC7, var_core_value_sig4956, var_core_value_sigCC9E));
  }
  serialize(var_core_value_sig444C) {
    return N(this._resources["get"](var_core_value_sig444C));
  }
  deserialize(var_core_value_sigE42E, var_core_value_sigF039) {
    this._resources["set"](var_core_value_sigE42E, N(var_core_value_sigF039)), this._change$["next"]({
...
const hi = {
  ...
  handler: (var_core_value_sigC88E, var_core_value_sigC4A6) => {
    let var_core_value_sig1FE3 = var_core_value_sigC88E.get(var_core_value_sig1760),
      var_core_value_sigF003 = var_core_value_sigC88E.get(var_core_value_sig533B),
      var_core_value_sigE146 = var_core_value_sigC88E.get(J),
      var_core_value_sigF6D5 = var_core_value_sigC4A6 != null && var_core_value_sigC4A6.unitId ? var_core_value_sig1FE3.getUnit(var_core_value_sigC4A6.unitId, var_core_value_sig87EA.UNIVER_DOC) : var_core_value_sig1FE3.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC);
    if (!var_core_value_sigF6D5) return false;
    let var_core_value_sig3B2F = var_core_value_sigF6D5.getSnapshot(),
      var_core_value_sigE558 = (var_core_value_sigC4A6 == null ? undefined : var_core_value_sigC4A6.tableId) ?? var_core_value_sig240E(6),
      var_core_value_sigA99D = gi(var_core_value_sigC88E, var_core_value_sigF6D5.getUnitId(), var_core_value_sigC4A6);
    if (!var_core_value_sigA99D) return false;
    let var_core_value_sigB23E;
    try {
      let var_core_value_sig1BC4 = z(var_core_value_sigF6D5, var_core_value_sigA99D.segmentId);
      if (!var_core_value_sig1BC4) return false;
      var_core_value_sigB23E = Wr({
      ...
      }, W(var_core_value_sig3B2F, var_core_value_sigA99D.segmentId));
    } catch (var_core_value_sig9EAB) {
      if (var_core_value_sig9EAB instanceof Ur) return false;
      throw var_core_value_sig9EAB;
    }
    let var_core_value_sigDA56 = z(var_core_value_sigF6D5, var_core_value_sigA99D.segmentId);
    if (!var_core_value_sigDA56) return false;
    let var_core_value_sig8D74 = U(var_core_value_sigF003, var_core_value_sigF6D5.getUnitId(), var_core_value_sigDA56, var_core_value_sigB23E.actions, undefined, var_core_value_sigB23E.cursorOffset, hi.id);
...
function gi(var_core_value_sigC3E8, var_core_value_sig3FAF1, var_core_value_sigC00C) {
  let {
  ...
  if (typeof var_core_value_sig080D == "number") {
    let var_core_value_sigA5C3 = _i(var_core_value_sigC3E8);
    return {
      offset: var_core_value_sig080D,
      position: "offset",
  ...
  if (var_core_value_sigCDBC === "selection") {
    let var_core_value_sig3A1E = var_core_value_sigD8A7(var_core_value_sigC3E8, var_core_value_sig3FAF1),
      var_core_value_sigDC92 = _i(var_core_value_sigC3E8),
  ...
  if (var_core_value_sigCDBC === "offset") {
    let var_core_value_sigC2A0 = var_core_value_sigD8A7(var_core_value_sigC3E8, var_core_value_sig3FAF1),
      var_core_value_sig7C65 = _i(var_core_value_sigC3E8),
...
function _i(var_core_value_sig4B7F) {
  try {
    var var_core_value_sig17D6, var_core_value_sig8915;
    let var_core_value_sig41F3 = (var_core_value_sig17D6 = (var_core_value_sig8915 = var_core_value_sig4B7F.get(var_core_value_sig4037)).getActiveTextRange) == null ? undefined : var_core_value_sig17D6.call(var_core_value_sig8915);
...
const vi = {
    ...
    handler: async (var_core_value_sigC88F, var_core_value_sig1AFA) => {
      let var_core_value_sigBCF5 = var_core_value_sigC88F.get(var_core_value_sig1760),
        var_core_value_sig988A = var_core_value_sigC88F.get(var_core_value_sig533B),
        var_core_value_sigFC02 = var_core_value_sigC88F.get(q),
        var_core_value_sigF71C = var_core_value_sigC88F.get(J),
        var_core_value_sigE634 = var_core_value_sigBCF5.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigF2B0 = var_core_value_sigE634.getSnapshot(),
        var_core_value_sigD77A = L(var_core_value_sig1AFA, var_core_value_sigF74F),
        var_core_value_sigF2C2 = z(var_core_value_sigE634, var_core_value_sigD77A);
      if (!var_core_value_sigF2C2) return false;
      let var_core_value_sig2990 = Zn(var_core_value_sigF2C2, var_core_value_sig89D7, W(var_core_value_sigF2B0, var_core_value_sigD77A));
      if (!var_core_value_sig2990) return false;
      let var_core_value_sigD300 = U(var_core_value_sig988A, var_core_value_sigE634.getUnitId(), var_core_value_sigF2C2, var_core_value_sig2990.actions);
  ...
  yi = {
    ...
    handler: async (var_core_value_sig6F77, var_core_value_sigFA4B) => {
      let var_core_value_sig2AB0 = var_core_value_sig6F77.get(var_core_value_sig1760),
        var_core_value_sig853D = var_core_value_sig6F77.get(var_core_value_sig533B),
        var_core_value_sigD1F0 = var_core_value_sig6F77.get(q),
        var_core_value_sig3D4E = var_core_value_sig2AB0.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        ...
        var_core_value_sig6F1A = R(var_core_value_sigFA4B, var_core_value_sig79C0);
      if (!var_core_value_sig3D4E || !var_core_value_sig173D || !var_core_value_sig6F1A) return false;
      let var_core_value_sig1802 = L(var_core_value_sigFA4B, var_core_value_sig79C0),
        var_core_value_sigCFA7 = z(var_core_value_sig3D4E, var_core_value_sig1802);
      if (!var_core_value_sigCFA7 || !je(var_core_value_sigCFA7, var_core_value_sig173D, var_core_value_sig6F1A)) return false;
      let var_core_value_sig31C2 = Pe({
      ...
      let var_core_value_sigA677 = U(var_core_value_sig853D, var_core_value_sig3D4E.getUnitId(), var_core_value_sigCFA7, var_core_value_sig31C2.actions, {
        tableId: var_core_value_sig173D,
  ...
  bi = {
    ...
    handler: async (var_core_value_sigC015, var_core_value_sigAEBC) => {
      ...
      let var_core_value_sig366A = var_core_value_sigC015.get(var_core_value_sig1760),
        var_core_value_sigA89C = var_core_value_sigC015.get(var_core_value_sig533B),
        var_core_value_sigDD3E = var_core_value_sigC015.get(q),
        var_core_value_sig182B = var_core_value_sig366A.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig458C = var_core_value_sig182B.getSnapshot(),
        var_core_value_sig8DEC = L(var_core_value_sigAEBC, var_core_value_sig2A99),
        var_core_value_sig522F = z(var_core_value_sig182B, var_core_value_sig8DEC);
      ...
      let var_core_value_sigD718 = var_core_value_sigAEBC.count ?? (var_core_value_sig2A99 ? Math.max(1, var_core_value_sig2A99.endColumn - var_core_value_sig2A99.startColumn + 1) : 1),
        var_core_value_sig41CF = Vn(var_core_value_sig522F, var_core_value_sig18A6, var_core_value_sigA98B, var_core_value_sigAEBC.toColumn, var_core_value_sigD718, var_core_value_sigAEBC.position, W(var_core_value_sig458C, var_core_value_sig8DEC));
      if (!var_core_value_sig41CF) return false;
      let var_core_value_sig1EFD = U(var_core_value_sigA89C, var_core_value_sig182B.getUnitId(), var_core_value_sig522F, var_core_value_sig41CF.actions);
  ...
  xi = {
    ...
    handler: async (var_core_value_sig38BB, var_core_value_sig017C) => {
      ...
      let var_core_value_sig44BC = var_core_value_sig38BB.get(var_core_value_sig1760),
        var_core_value_sigAB7B = var_core_value_sig38BB.get(var_core_value_sig533B),
        var_core_value_sig55EE = var_core_value_sig38BB.get(q),
        var_core_value_sigE9F6 = var_core_value_sig44BC.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigE492 = var_core_value_sigE9F6.getSnapshot(),
        var_core_value_sig3465 = L(var_core_value_sig017C, var_core_value_sig3BA9),
        var_core_value_sig38DD = z(var_core_value_sigE9F6, var_core_value_sig3465);
      ...
      let var_core_value_sig89AE = var_core_value_sig017C.count ?? (var_core_value_sig3BA9 ? Math.max(1, var_core_value_sig3BA9.endRow - var_core_value_sig3BA9.startRow + 1) : 1),
        var_core_value_sig3A69 = Bn(var_core_value_sig38DD, var_core_value_sigE230, var_core_value_sig5AC8, var_core_value_sig017C.toRow, var_core_value_sig89AE, var_core_value_sig017C.position, W(var_core_value_sigE492, var_core_value_sig3465));
      if (!var_core_value_sig3A69) return false;
      let var_core_value_sigD64C = U(var_core_value_sigAB7B, var_core_value_sigE9F6.getUnitId(), var_core_value_sig38DD, var_core_value_sig3A69.actions);
  ...
  Si = {
    ...
    handler: async (var_core_value_sig3B0B, var_core_value_sig1E7C) => {
      ...
      let var_core_value_sigD3C4 = var_core_value_sig3B0B.get(var_core_value_sig1760),
        var_core_value_sigBC8B = var_core_value_sig3B0B.get(var_core_value_sig533B),
        var_core_value_sigEE2E = var_core_value_sig3B0B.get(q),
        var_core_value_sigCF06 = var_core_value_sigD3C4.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig1B7B = var_core_value_sigCF06.getSnapshot(),
        var_core_value_sig1F31 = L(var_core_value_sig1E7C, var_core_value_sig6BCD),
        var_core_value_sigEA82 = z(var_core_value_sigCF06, var_core_value_sig1F31);
      if (!var_core_value_sigEA82) return false;
      if (var_core_value_sig1E7C.targetOffset == null) {
        let var_core_value_sigF455 = Dn(var_core_value_sigEA82, var_core_value_sigC664, var_core_value_sig1E7C.deltaX ?? 0, var_core_value_sig1E7C.deltaY ?? 0);
        return U(var_core_value_sigBC8B, var_core_value_sigCF06.getUnitId(), var_core_value_sigEA82, var_core_value_sigF455);
      }
      let var_core_value_sig65BB = On(var_core_value_sigEA82, var_core_value_sigC664, var_core_value_sig1E7C.targetOffset, W(var_core_value_sig1B7B, var_core_value_sig1F31));
      return U(var_core_value_sigBC8B, var_core_value_sigCF06.getUnitId(), var_core_value_sigEA82, var_core_value_sig65BB);
    }
  },
  Ci = {
    ...
    handler: async (var_core_value_sig69B1, var_core_value_sigAEDE) => {
      ...
      let var_core_value_sigF2D6 = var_core_value_sig69B1.get(var_core_value_sig1760),
        var_core_value_sig810E = var_core_value_sig69B1.get(var_core_value_sig533B),
        var_core_value_sigABB1 = var_core_value_sig69B1.get(q),
        var_core_value_sig3F70 = var_core_value_sigF2D6.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig4B40 = z(var_core_value_sig3F70, L(var_core_value_sigAEDE, var_core_value_sig9F91));
      return !var_core_value_sig4B40 || !((var_core_value_sig139C = var_core_value_sig4B40.tableSource) != null && (var_core_value_sig139C = var_core_value_sig139C[var_core_value_sigC9C8]) != null && var_core_value_sig139C.tableColumns[var_core_value_sigC444]) ? false : U(var_core_value_sig810E, var_core_value_sig3F70.getUnitId(), var_core_value_sig4B40, En(var_core_value_sig4B40, var_core_value_sigC9C8, var_core_value_sigC444, var_core_value_sigAEDE.width));
    }
  },
  wi = {
    ...
    handler: async (var_core_value_sig9F6D, var_core_value_sigE1A2) => {
      ...
      let var_core_value_sig2591 = var_core_value_sig9F6D.get(var_core_value_sig1760),
        var_core_value_sig7C12 = var_core_value_sig9F6D.get(var_core_value_sig533B),
        var_core_value_sig8EC51 = var_core_value_sig9F6D.get(q),
        var_core_value_sig4B1B = var_core_value_sig2591.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sigB489 = z(var_core_value_sig4B1B, L(var_core_value_sigE1A2, var_core_value_sig14C3));
      return !var_core_value_sigB489 || !((var_core_value_sig4767 = var_core_value_sigB489.tableSource) != null && (var_core_value_sig4767 = var_core_value_sig4767[var_core_value_sig95A8]) != null && var_core_value_sig4767.tableRows[var_core_value_sig3F90]) ? false : U(var_core_value_sig7C12, var_core_value_sig4B1B.getUnitId(), var_core_value_sigB489, An(var_core_value_sigB489, var_core_value_sig95A8, var_core_value_sig3F90, var_core_value_sigE1A2.height, var_core_value_sigE1A2.hRule));
    }
  },
  Ti = {
    ...
    handler: async (var_core_value_sig76E7, var_core_value_sig7E7F) => {
      ...
      let var_core_value_sig7947 = var_core_value_sig76E7.get(var_core_value_sig1760),
        var_core_value_sig7FEC = var_core_value_sig76E7.get(q),
        var_core_value_sig73D2 = var_core_value_sig76E7.get(J),
        var_core_value_sig6BDA = var_core_value_sig7947.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
  ...
  Ei = {
    ...
    handler: async (var_core_value_sig6140, var_core_value_sigDD84) => {
      let var_core_value_sig7BA5 = var_core_value_sig6140.get(var_core_value_sig1760),
        var_core_value_sig543F = var_core_value_sig6140.get(var_core_value_sig533B),
        var_core_value_sigBF30 = var_core_value_sig6140.get(q),
        var_core_value_sigAA0E = var_core_value_sig6140.get(J),
        var_core_value_sig3747 = var_core_value_sig7BA5.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig6881 = (var_core_value_sigDD84 == null ? undefined : var_core_value_sigDD84.headerRowCount) ?? var_core_value_sig09FA + 1,
        var_core_value_sigAB94 = z(var_core_value_sig3747, L(var_core_value_sigDD84, var_core_value_sig9B6A));
      if (!var_core_value_sigAB94) return false;
      let var_core_value_sigEE05 = Nn(var_core_value_sigAB94, var_core_value_sig7BFA, var_core_value_sig6881);
      if (!var_core_value_sigEE05) return false;
      let var_core_value_sig0F0E = U(var_core_value_sig543F, var_core_value_sig3747.getUnitId(), var_core_value_sigAB94, var_core_value_sigEE05.actions);
  ...
  Di = {
    ...
    handler: async (var_core_value_sig3A40, var_core_value_sig2377) => {
      ...
      let var_core_value_sigC58E = var_core_value_sig3A40.get(var_core_value_sig1760),
        var_core_value_sig9063 = var_core_value_sig3A40.get(var_core_value_sig533B),
        var_core_value_sig99CE = var_core_value_sig3A40.get(q),
        var_core_value_sigFB15 = var_core_value_sigC58E.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        var_core_value_sig9AF5 = Oi(var_core_value_sig99CE),
        ...
        var_core_value_sig60CE = R(var_core_value_sig2377, var_core_value_sig9AF5);
      if (!var_core_value_sigFB15 || !var_core_value_sigCD2E || !var_core_value_sig60CE) return false;
      let var_core_value_sigFA1B = L(var_core_value_sig2377, var_core_value_sig9AF5),
        var_core_value_sig5FEF = z(var_core_value_sigFB15, var_core_value_sigFA1B);
      if (!var_core_value_sig5FEF || !Ai(var_core_value_sig5FEF, var_core_value_sigCD2E, var_core_value_sig60CE)) return false;
      let var_core_value_sigD48C = ki(var_core_value_sig5FEF, {
          tableId: var_core_value_sigCD2E,
          ...var_core_value_sig60CE,
          value: var_core_value_sig4EEF
        }),
        var_core_value_sig41E9 = U(var_core_value_sig9063, var_core_value_sigFB15.getUnitId(), var_core_value_sig5FEF, var_core_value_sigD48C, {
          tableId: var_core_value_sigCD2E,
...
function Oi(var_core_value_sig3807) {
...
function ki(var_core_value_sig680F, var_core_value_sig2E36) {
  ...
  let var_core_value_sigA847 = (var_core_value_sigBA94 = var_core_value_sig680F.tableSource) == null ? undefined : var_core_value_sigBA94[var_core_value_sig2E36.tableId],
    var_core_value_sig1AB4 = R(var_core_value_sig2E36);
  if (!var_core_value_sigA847 || !var_core_value_sig1AB4) return null;
  let var_core_value_sig7272 = var_core_value_sigF002.getInstance(),
    var_core_value_sig885F = [],
    var_core_value_sigB7C7 = ji(var_core_value_sig1AB4);
  ...
  return var_core_value_sig885F.reduce((var_core_value_sigB3EE, var_core_value_sigC50A) => var_core_value_sigF002.compose(var_core_value_sigB3EE, var_core_value_sigC50A), null);
}
function Ai(var_core_value_sig2842, var_core_value_sigA5A3, var_core_value_sig590F) {
  ...
  let var_core_value_sig2017 = ji(var_core_value_sig590F);
...
function ji(var_core_value_sigA166) {
  return {
...
let Mi = function (var_core_value_sigEB84) {
...
function Pi(var_core_value_sig3B17) {
  var var_core_value_sig78681;
  let var_core_value_sig9AFE = E(var_core_value_sig3B17.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sig244E) throw Error("[DocsTable]:\x20Table\x20" + var_core_value_sig3B17.tableId + " is not found.");
  let var_core_value_sigD4E9 = Gi(var_core_value_sig3B17),
    var_core_value_sig969F = var_core_value_sig3B17.border ?? Ni;
  for (let var_core_value_sigB8ED = var_core_value_sigD4E9.startRow; var_core_value_sigB8ED <= var_core_value_sigD4E9.endRow; var_core_value_sigB8ED++) for (let var_core_value_sig3E68 = var_core_value_sigD4E9.startColumn; var_core_value_sig3E68 <= var_core_value_sigD4E9.endColumn; var_core_value_sig3E68++) {
    ...
    if (!var_core_value_sigF9C7) throw Error("[DocsTable]: Cell range is out of bounds.");
    var_core_value_sigF9C7.borderTop = Vi(var_core_value_sig3B17.preset, var_core_value_sigB8ED, var_core_value_sigD4E9) ? var_core_value_sig969F : Y, var_core_value_sigF9C7.borderBottom = Hi(var_core_value_sig3B17.preset, var_core_value_sigB8ED, var_core_value_sigD4E9) ? var_core_value_sig969F : Y, var_core_value_sigF9C7.borderLeft = Ui(var_core_value_sig3B17.preset, var_core_value_sig3E68, var_core_value_sigD4E9) ? var_core_value_sig969F : Y, var_core_value_sigF9C7.borderRight = Wi(var_core_value_sig3B17.preset, var_core_value_sig3E68, var_core_value_sigD4E9) ? var_core_value_sig969F : Y;
  }
  return qi(var_core_value_sig244E, var_core_value_sigD4E9, {
    top: Vi(var_core_value_sig3B17.preset, var_core_value_sigD4E9.startRow, var_core_value_sigD4E9) ? var_core_value_sig969F : Y,
    left: Ui(var_core_value_sig3B17.preset, var_core_value_sigD4E9.startColumn, var_core_value_sigD4E9) ? var_core_value_sig969F : Y
  }), {
    nextDocumentData: var_core_value_sig9AFE
  };
}
function Fi(var_core_value_sig3A441) {
  ...
  if (!var_core_value_sig8407) throw Error("[DocsTable]:\x20Table\x20" + var_core_value_sig3A441.tableId + " is not found.");
  let var_core_value_sig635F = Gi(var_core_value_sig3A441),
    var_core_value_sig79E0 = var_core_value_sig3A441.border ?? Ni,
  ...
  for (let var_core_value_sig8EAE = var_core_value_sig635F.startRow; var_core_value_sig8EAE <= var_core_value_sig635F.endRow; var_core_value_sig8EAE++) for (let var_core_value_sigF4C5 = var_core_value_sig635F.startColumn; var_core_value_sigF4C5 <= var_core_value_sig635F.endColumn; var_core_value_sigF4C5++) {
    ...
    Z(var_core_value_sig1E28, X(var_core_value_sig3A441.tableId, var_core_value_sig8EAE, var_core_value_sigF4C5, "borderTop"), var_core_value_sig8895.borderTop, Vi(var_core_value_sig3A441.preset, var_core_value_sig8EAE, var_core_value_sig635F) ? var_core_value_sig79E0 : Y), Z(var_core_value_sig1E28, X(var_core_value_sig3A441.tableId, var_core_value_sig8EAE, var_core_value_sigF4C5, "borderBottom"), var_core_value_sig8895.borderBottom, Hi(var_core_value_sig3A441.preset, var_core_value_sig8EAE, var_core_value_sig635F) ? var_core_value_sig79E0 : Y), Z(var_core_value_sig1E28, X(var_core_value_sig3A441.tableId, var_core_value_sig8EAE, var_core_value_sigF4C5, "borderLeft"), var_core_value_sig8895.borderLeft, Ui(var_core_value_sig3A441.preset, var_core_value_sigF4C5, var_core_value_sig635F) ? var_core_value_sig79E0 : Y), Z(var_core_value_sig1E28, X(var_core_value_sig3A441.tableId, var_core_value_sig8EAE, var_core_value_sigF4C5, "borderRight"), var_core_value_sig8895.borderRight, Wi(var_core_value_sig3A441.preset, var_core_value_sigF4C5, var_core_value_sig635F) ? var_core_value_sig79E0 : Y);
  }
  return Ri(var_core_value_sig1E28, var_core_value_sig8407, var_core_value_sig3A441.tableId, var_core_value_sig635F, {
    top: Vi(var_core_value_sig3A441.preset, var_core_value_sig635F.startRow, var_core_value_sig635F) ? var_core_value_sig79E0 : Y,
    left: Ui(var_core_value_sig3A441.preset, var_core_value_sig635F.startColumn, var_core_value_sig635F) ? var_core_value_sig79E0 : Y
  }), zi(var_core_value_sig1E28);
}
function Ii(var_core_value_sigFAEC) {
  var var_core_value_sig1282;
  let var_core_value_sig80D0 = E(var_core_value_sigFAEC.documentData, {
      cloneBody: false,
  ...
  if (!var_core_value_sig6CEE) throw Error("[DocsTable]: Table " + var_core_value_sigFAEC.tableId + " is not found.");
  return Ki(var_core_value_sigFAEC, (var_core_value_sig1CDD, var_core_value_sig0DB11) => {
    ...
    if (!var_core_value_sigCC17) throw Error("[DocsTable]: Cell range is out of bounds.");
...
function Li(var_core_value_sig4B271) {
  ...
  return Ki(var_core_value_sig4B271, (var_core_value_sig32AE, var_core_value_sigC753) => {
    ...
    Z(var_core_value_sig114E, X(var_core_value_sig4B271.tableId, var_core_value_sig32AE, var_core_value_sigC753, "borderTop"), var_core_value_sig81AE.borderTop, Q(var_core_value_sig81AE.borderTop, var_core_value_sig4B271.border)), Z(var_core_value_sig114E, X(var_core_value_sig4B271.tableId, var_core_value_sig32AE, var_core_value_sigC753, "borderBottom"), var_core_value_sig81AE.borderBottom, Q(var_core_value_sig81AE.borderBottom, var_core_value_sig4B271.border)), Z(var_core_value_sig114E, X(var_core_value_sig4B271.tableId, var_core_value_sig32AE, var_core_value_sigC753, "borderLeft"), var_core_value_sig81AE.borderLeft, Q(var_core_value_sig81AE.borderLeft, var_core_value_sig4B271.border)), Z(var_core_value_sig114E, X(var_core_value_sig4B271.tableId, var_core_value_sig32AE, var_core_value_sigC753, "borderRight"), var_core_value_sig81AE.borderRight, Q(var_core_value_sig81AE.borderRight, var_core_value_sig4B271.border));
  }), Ri(var_core_value_sig114E, var_core_value_sigC847, var_core_value_sig4B271.tableId, Gi(var_core_value_sig4B271), {
    top: var_core_value_sig4B271.border,
    left: var_core_value_sig4B271.border,
    merge: true
  }), zi(var_core_value_sig114E);
}
function Ri(var_core_value_sig88EA, var_core_value_sig4E97, var_core_value_sigBE44, var_core_value_sigE675, var_core_value_sig4346) {
  if (var_core_value_sigE675.startRow > 0) {
    ...
    for (let var_core_value_sig5410 = var_core_value_sigE675.startColumn; var_core_value_sig5410 <= var_core_value_sigE675.endColumn; var_core_value_sig5410++) {
      ...
      Z(var_core_value_sig88EA, X(var_core_value_sigBE44, var_core_value_sigE675.startRow - 1, var_core_value_sig5410, "borderBottom"), var_core_value_sigC80B.borderBottom, var_core_value_sig4346.merge ? Q(var_core_value_sigC80B.borderBottom, var_core_value_sig4346.top) : var_core_value_sig4346.top);
    }
  }
  if (var_core_value_sigE675.startColumn > 0) for (let var_core_value_sig0E54 = var_core_value_sigE675.startRow; var_core_value_sig0E54 <= var_core_value_sigE675.endRow; var_core_value_sig0E54++) {
    ...
    Z(var_core_value_sig88EA, X(var_core_value_sigBE44, var_core_value_sig0E54, var_core_value_sigE675.startColumn - 1, "borderRight"), var_core_value_sig492F.borderRight, var_core_value_sig4346.merge ? Q(var_core_value_sig492F.borderRight, var_core_value_sig4346.left) : var_core_value_sig4346.left);
  }
}
function X(var_core_value_sigA044, var_core_value_sigD2F3, var_core_value_sig27CD, var_core_value_sig8977) {
...
function Z(var_core_value_sigE931, var_core_value_sig9F9C, var_core_value_sig0728, var_core_value_sigDC83) {
  if (JSON.stringify(var_core_value_sig0728) === JSON.stringify(var_core_value_sigDC83)) return;
  let var_core_value_sig56A8 = var_core_value_sigF002.getInstance();
  if (var_core_value_sig0728 === undefined) {
    var_core_value_sigE931.push(var_core_value_sig56A8.insertOp(var_core_value_sig9F9C, Bi(var_core_value_sigDC83)));
    return;
  }
  ...
  var_core_value_sigE931.push(var_core_value_sig56A8.replaceOp(var_core_value_sig9F9C, var_core_value_sig0728, Bi(var_core_value_sigDC83)));
}
function zi(var_core_value_sigF487) {
  return var_core_value_sigF487.reduce((var_core_value_sig3B171, var_core_value_sig6C4A) => var_core_value_sigF002.compose(var_core_value_sig3B171, var_core_value_sig6C4A), null);
}
function Bi(var_core_value_sigC62E) {
  return Array.isArray(var_core_value_sigC62E) ? var_core_value_sigC62E.map(var_core_value_sig73D9 => Bi(var_core_value_sig73D9)) : !var_core_value_sigC62E || typeof var_core_value_sigC62E != "object" ? var_core_value_sigC62E : Object.fromEntries(Object.entries(var_core_value_sigC62E).map(([var_core_value_sigEAF8, var_core_value_sig0455]) => [var_core_value_sigEAF8, Bi(var_core_value_sig0455)]));
}
function Vi(var_core_value_sigCD50, var_core_value_sig51C4, var_core_value_sigEECD) {
...
function Hi(var_core_value_sigB655, var_core_value_sigF30A, var_core_value_sigD81A) {
...
function Ui(var_core_value_sigBE17, var_core_value_sigBB5E, var_core_value_sigB4401) {
...
function Wi(var_core_value_sig9D0F, var_core_value_sig0354, var_core_value_sig12F4) {
...
function Gi(var_core_value_sigDCEC) {
  return {
...
function Ki(var_core_value_sigB5C8, var_core_value_sig8320) {
  let var_core_value_sig1C1B = Gi(var_core_value_sigB5C8);
...
function Q(var_core_value_sig70FD, var_core_value_sig988F) {
  let var_core_value_sig50A1 = {
    color: Object.prototype["hasOwnProperty"].call(var_core_value_sig988F, "color") ? var_core_value_sig988F.color : (var_core_value_sig70FD == null ? undefined : var_core_value_sig70FD.color) ?? Ni.color,
    width: var_core_value_sig988F.width ?? (var_core_value_sig70FD == null ? undefined : var_core_value_sig70FD.width) ?? Ni.width,
...
function qi(var_core_value_sig71D2, var_core_value_sigC113, var_core_value_sig2326) {
  if (var_core_value_sigC113.startRow > 0) {
    ...
    for (let var_core_value_sigA6F6 = var_core_value_sigC113.startColumn; var_core_value_sigA6F6 <= var_core_value_sigC113.endColumn; var_core_value_sigA6F6++) {
      ...
      var_core_value_sig284F.borderBottom = var_core_value_sig2326.merge ? Q(var_core_value_sig284F.borderBottom, var_core_value_sig2326.top) : var_core_value_sig2326.top;
    }
  }
  if (var_core_value_sigC113.startColumn > 0) for (let var_core_value_sig9DE4 = var_core_value_sigC113.startRow; var_core_value_sig9DE4 <= var_core_value_sigC113.endRow; var_core_value_sig9DE4++) {
    ...
    var_core_value_sigCDDA.borderRight = var_core_value_sig2326.merge ? Q(var_core_value_sigCDDA.borderRight, var_core_value_sig2326.left) : var_core_value_sig2326.left;
  }
}
const Ji = {
  ...
  handler: async (var_core_value_sig8726, var_core_value_sig4358) => {
    ...
    return var_core_value_sig9574 !== undefined && Yi(var_core_value_sig8726, var_core_value_sig4358, var_core_value_sig9574 == null ? {
      clearColor: true
    } : {
      color: {
...
async function Yi(var_core_value_sigD610, var_core_value_sigAF55, var_core_value_sig7409) {
  let var_core_value_sigD106 = var_core_value_sigD610.get(var_core_value_sig1760),
    var_core_value_sig7552 = var_core_value_sigD610.get(var_core_value_sig533B),
    var_core_value_sig56D1 = var_core_value_sigD610.get(q),
    var_core_value_sig3D12 = var_core_value_sigD106.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
    var_core_value_sig8952 = Oi(var_core_value_sig56D1),
    ...
    var_core_value_sig3D2F = R(var_core_value_sigAF55, var_core_value_sig8952);
  if (!var_core_value_sig3D12 || !var_core_value_sigB409 || !var_core_value_sig3D2F) return false;
  let var_core_value_sigDBDA = L(var_core_value_sigAF55, var_core_value_sig8952),
    var_core_value_sig1EFA = z(var_core_value_sig3D12, var_core_value_sigDBDA);
  if (!var_core_value_sig1EFA) return false;
  let var_core_value_sig7CF4 = Li({
      documentData: var_core_value_sig1EFA,
      tableId: var_core_value_sigB409,
      ...var_core_value_sig3D2F,
      border: var_core_value_sig7409
    }),
    var_core_value_sigE956 = U(var_core_value_sig7552, var_core_value_sig3D12.getUnitId(), var_core_value_sig1EFA, var_core_value_sig7CF4, {
      tableId: var_core_value_sigB409,
...
const Xi = {
  ...
  handler: async (var_core_value_sig189D, var_core_value_sigE26F) => {
    ...
    return var_core_value_sig8212 != null && Yi(var_core_value_sig189D, var_core_value_sigE26F, {
      dashStyle: Zi(var_core_value_sig8212)
    });
  }
};
function Zi(var_core_value_sig9A60) {
  return typeof var_core_value_sig9A60 == "number" ? var_core_value_sig9A60 : var_core_value_sig9A60 === "dot" ? var_core_value_sig528C.DOT : var_core_value_sig9A60 === "dash" ? var_core_value_sig528C.DASH : var_core_value_sig528C.SOLID;
}
const Qi = {
    ...
    handler: async (var_core_value_sig5EF5, var_core_value_sig5324) => {
      ...
      return var_core_value_sig01301 != null && Yi(var_core_value_sig5EF5, var_core_value_sig5324, {
        width: {
  ...
  $i = {
    ...
    handler: async (var_core_value_sig5838, var_core_value_sigB9FE) => {
      ...
      let var_core_value_sig41A5 = var_core_value_sig5838.get(var_core_value_sig1760),
        var_core_value_sig6D3D = var_core_value_sig5838.get(var_core_value_sig533B),
        var_core_value_sigB191 = var_core_value_sig5838.get(q),
        var_core_value_sig949D = var_core_value_sig41A5.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        var_core_value_sig4113 = Oi(var_core_value_sigB191),
        ...
        var_core_value_sigC932 = R(var_core_value_sigB9FE, var_core_value_sig4113);
      if (!var_core_value_sig949D || !var_core_value_sigEC12 || !var_core_value_sigC932) return false;
      let var_core_value_sigDE39 = L(var_core_value_sigB9FE, var_core_value_sig4113),
        var_core_value_sig1529 = z(var_core_value_sig949D, var_core_value_sigDE39);
      if (!var_core_value_sig1529) return false;
      let var_core_value_sigAFD8 = Fi({
        ...
        var_core_value_sig6017 = U(var_core_value_sig6D3D, var_core_value_sig949D.getUnitId(), var_core_value_sig1529, var_core_value_sigAFD8, {
          tableId: var_core_value_sigEC12,
  ...
  ea = {
    ...
    handler: async (var_core_value_sigC66C, var_core_value_sigC5AC) => {
      ...
      let var_core_value_sigF7E2 = var_core_value_sigC66C.get(var_core_value_sig1760),
        var_core_value_sigDEEA = var_core_value_sigC66C.get(var_core_value_sig533B),
        var_core_value_sig49D1 = var_core_value_sigC66C.get(q),
        var_core_value_sigEDEC = var_core_value_sigF7E2.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        var_core_value_sig4F7B = ta(var_core_value_sig49D1),
        ...
        var_core_value_sigB092 = R(var_core_value_sigC5AC, var_core_value_sig4F7B);
      if (!var_core_value_sigEDEC || !var_core_value_sig8269 || !var_core_value_sigB092) return false;
      let var_core_value_sigC04F = L(var_core_value_sigC5AC, var_core_value_sig4F7B),
        var_core_value_sig8B16 = z(var_core_value_sigEDEC, var_core_value_sigC04F);
      if (!var_core_value_sig8B16 || !na(var_core_value_sig8B16, var_core_value_sig8269, var_core_value_sigB092)) return false;
      let var_core_value_sig9640 = ra(var_core_value_sig8B16, {
          tableId: var_core_value_sig8269,
          ...var_core_value_sigB092,
          value: var_core_value_sig5880
        }),
        var_core_value_sig34AB = U(var_core_value_sigDEEA, var_core_value_sigEDEC.getUnitId(), var_core_value_sig8B16, var_core_value_sig9640, {
          tableId: var_core_value_sig8269,
...
function ta(var_core_value_sig0BE5) {
...
function na(var_core_value_sig9511, var_core_value_sigAFDD, var_core_value_sig431B1) {
  ...
  let var_core_value_sigDDD2 = ia(var_core_value_sig431B1);
...
function ra(var_core_value_sigB80D, var_core_value_sigE0A2) {
  ...
  let var_core_value_sigB043 = var_core_value_sigF002.getInstance(),
    var_core_value_sig554B = ia(var_core_value_sigE0A2),
  ...
  return var_core_value_sig33F0.reduce((var_core_value_sigA4DF, var_core_value_sigCC9D) => var_core_value_sigF002.compose(var_core_value_sigA4DF, var_core_value_sigCC9D), null);
}
function ia(var_core_value_sigE1AD) {
  return {
...
const aa = {
    ...
    handler: async (var_core_value_sig90FF, var_core_value_sigA7F6) => {
      ...
      let var_core_value_sig5A0F = var_core_value_sig90FF.get(var_core_value_sig1760),
        var_core_value_sigCDF5 = var_core_value_sig90FF.get(var_core_value_sig533B),
        var_core_value_sig3802 = var_core_value_sig90FF.get(q),
        var_core_value_sigB642 = var_core_value_sig90FF.get(J),
        var_core_value_sig9026 = var_core_value_sig5A0F.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
      ...
      let var_core_value_sig2605 = var_core_value_sig9026.getSnapshot(),
        var_core_value_sig5F20 = L(var_core_value_sigA7F6, var_core_value_sigDCD6),
        var_core_value_sig019C = z(var_core_value_sig9026, var_core_value_sig5F20);
      if (!var_core_value_sig019C) return false;
      let var_core_value_sigB296 = Hn(var_core_value_sig019C, var_core_value_sigB642.serialize(var_core_value_sig9026.getUnitId()), var_core_value_sig048B, var_core_value_sig1334, var_core_value_sigA7F6.direction, W(var_core_value_sig2605, var_core_value_sig5F20));
      return U(var_core_value_sigCDF5, var_core_value_sig9026.getUnitId(), var_core_value_sig019C, var_core_value_sigB296);
    }
  },
  oa = {
    ...
    handler: async (var_core_value_sig7949, var_core_value_sig2DD9) => {
      let var_core_value_sigCD501 = var_core_value_sig7949.get(var_core_value_sig1760),
        var_core_value_sigD362 = var_core_value_sig7949.get(var_core_value_sig533B),
        var_core_value_sigC433 = var_core_value_sig7949.get(q),
        var_core_value_sigF543 = var_core_value_sigCD501.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        ...
        var_core_value_sig773E = R(var_core_value_sig2DD9, var_core_value_sig0806);
      if (!var_core_value_sigF543 || !var_core_value_sigE224 || !var_core_value_sig773E) return false;
      let var_core_value_sig83A7 = L(var_core_value_sig2DD9, var_core_value_sig0806),
        var_core_value_sigFE18 = z(var_core_value_sigF543, var_core_value_sig83A7);
      if (!var_core_value_sigFE18 || !Me(var_core_value_sigFE18, var_core_value_sigE224, var_core_value_sig773E)) return false;
      let var_core_value_sig816B = Ie({
      ...
      let var_core_value_sigA89B = U(var_core_value_sigD362, var_core_value_sigF543.getUnitId(), var_core_value_sigFE18, var_core_value_sig816B.actions, {
        tableId: var_core_value_sigE224,
...
function sa(var_core_value_sig5020) {
  let var_core_value_sig8FB1 = new DOMParser().parseFromString(var_core_value_sig5020, "text/html");
  return Array.from(var_core_value_sig8FB1.querySelectorAll("table")).map(var_core_value_sig90F5 => fa(var_core_value_sig90F5));
}
function ca(var_core_value_sig3D4B) {
  if (!var_core_value_sig3D4B.includes("\x09")) return null;
  let var_core_value_sigCD77 = var_core_value_sig3D4B.split(/\r\n|\r|\n/);
  return var_core_value_sigCD77[var_core_value_sigCD77.length - 1] === "" && var_core_value_sigCD77.pop(), var_core_value_sigCD77.length === 0 ? null : "<table><tbody>" + var_core_value_sigCD77.map(var_core_value_sigD2BA => "<tr>" + var_core_value_sigD2BA.split("\x09").map(var_core_value_sig21B2 => "<td>" + Ca(var_core_value_sig21B2) + "</td>").join("") + "</tr>").join("") + "</tbody></table>";
}
function la(var_core_value_sig9F28) {
  var var_core_value_sig8A50;
  let var_core_value_sig8AF9 = w(var_core_value_sig9F28.documentData, var_core_value_sig9F28.tableId),
  ...
  if (!var_core_value_sig8AF9 || !var_core_value_sigCF441) throw Error("[DocsTable]:\x20Table\x20" + var_core_value_sig9F28.tableId + " is not found.");
  let var_core_value_sig020B = pa(var_core_value_sig9F28),
  ...
  for (let var_core_value_sigCD3A = var_core_value_sig020B.startRow; var_core_value_sigCD3A <= var_core_value_sig020B.endRow; var_core_value_sigCD3A++) {
    ...
    for (let var_core_value_sig4632 = var_core_value_sig020B.startColumn; var_core_value_sig4632 <= var_core_value_sig020B.endColumn; var_core_value_sig4632++) {
      ...
      var_core_value_sigDE08.push(var_core_value_sig480E ? ma(var_core_value_sigCF441, var_core_value_sig480E.startOffset, var_core_value_sig480E.endOffset) : "");
    }
...
function ua(var_core_value_sig8A05, var_core_value_sig431F = ["body"]) {
  var var_core_value_sig855C;
  let var_core_value_sig222E = w(var_core_value_sig8A05.documentData, var_core_value_sig8A05.tableId);
  if (!var_core_value_sig222E || !((var_core_value_sig855C = var_core_value_sig8A05.documentData["body"]) != null && var_core_value_sig855C.dataStream)) throw Error("[DocsTable]: Table " + var_core_value_sig8A05.tableId + " is not found.");
  ...
  return F(var_core_value_sig8A05.documentData, var_core_value_sigE7EB, var_core_value_sig431F);
}
function da(var_core_value_sig5781) {
  let var_core_value_sig13AB = new DOMParser().parseFromString(var_core_value_sig5781, "text/html").querySelector("table");
  return var_core_value_sig13AB ? fa(var_core_value_sig13AB) : {
    rows: [],
    columnWidths: []
  };
}
function fa(var_core_value_sig7A4A) {
  let var_core_value_sigB7E2 = Array.from(var_core_value_sig7A4A.querySelectorAll("col")).map(var_core_value_sigFABC => ga(var_core_value_sigFABC.getAttribute("width"), var_core_value_sigFABC.getAttribute("style"), "width")),
  ...
  Array.from(var_core_value_sig7A4A.querySelectorAll("tr")).forEach((var_core_value_sig413D, var_core_value_sig5BCE) => {
    let var_core_value_sig8EF01 = {
        cells: [],
        height: ga(var_core_value_sig413D.getAttribute("height"), var_core_value_sig413D.getAttribute("style"), "height")
      },
    ...
    for (Array.from(var_core_value_sig413D.children).filter(var_core_value_sig2259 => var_core_value_sig2259.tagName["toLowerCase"]() === "td" || var_core_value_sig2259.tagName["toLowerCase"]() === "th").forEach(var_core_value_sig9E2F => {
      ...
      var_core_value_sig8EF01.cells[var_core_value_sig78AC] = {
        ...
        text: ha(var_core_value_sig9E2F.textContent ?? ""),
        rowSpan: var_core_value_sigD082,
        colSpan: var_core_value_sigDBB7,
        backgroundColor: _a(var_core_value_sigD0A8, "background-color") ?? _a(var_core_value_sigD0A8, "background"),
        borderColor: ya(var_core_value_sigD0A8),
        borderWidth: ba(var_core_value_sigD0A8)
      };
      let var_core_value_sigF4B9 = ga(var_core_value_sig9E2F.getAttribute("width"), var_core_value_sigD0A8, "width");
...
function pa(var_core_value_sig843F) {
  return {
...
function ma(var_core_value_sig9FB7, var_core_value_sigB7A4, var_core_value_sig295F) {
...
function ha(var_core_value_sigE36B) {
  return var_core_value_sigE36B.replace(/\u00A0/g, "\x20").replace(/\s+/g, "\x20").trim();
}
function ga(var_core_value_sigDA3B, var_core_value_sig9E32, var_core_value_sig26EC1) {
  let var_core_value_sigF226 = var_core_value_sig9E32 == null ? undefined : var_core_value_sig9E32.match(RegExp(var_core_value_sig26EC1 + "\x5cs*:\x5cs*([0-9.]+)\x5cs*(px|pt|in|cm|mm)?", "i"));
  if (var_core_value_sigF226) return xa(Number(var_core_value_sigF226[1]), var_core_value_sigF226[2]);
  if (!var_core_value_sigDA3B) return;
  let var_core_value_sig4773 = var_core_value_sigDA3B.match(/([0-9.]+)\s*(px|pt|in|cm|mm)?/i);
  return var_core_value_sig4773 ? xa(Number(var_core_value_sig4773[1]), var_core_value_sig4773[2]) : undefined;
}
function _a(var_core_value_sigB643, var_core_value_sigF92F) {
...
function va(var_core_value_sig7E16) {
...
function ya(var_core_value_sig3C23) {
  var var_core_value_sigDAE6;
  let var_core_value_sigDD81 = _a(var_core_value_sig3C23, "border-color");
  if (var_core_value_sigDD81) return var_core_value_sigDD81;
  let var_core_value_sig3870 = va(var_core_value_sig3C23);
...
function ba(var_core_value_sig13D1) {
  var var_core_value_sigECFC;
  let var_core_value_sig5E62 = ga(null, _a(var_core_value_sig13D1, "border-width") ?? null, "width");
  if (var_core_value_sig5E62 != null) return var_core_value_sig5E62;
  let var_core_value_sig3B89 = (var_core_value_sigECFC = va(var_core_value_sig13D1)) == null ? undefined : var_core_value_sigECFC.match(/([0-9.]+)\s*(px|pt|in|cm|mm)/i);
  return var_core_value_sig3B89 ? xa(Number(var_core_value_sig3B89[1]), var_core_value_sig3B89[2]) : undefined;
}
function xa(var_core_value_sig4B55, var_core_value_sig9E69) {
  switch (var_core_value_sig9E69 == null ? undefined : var_core_value_sig9E69.toLowerCase()) {
    case "pt":
      return Sa(var_core_value_sig4B55 * 4 / 3);
    case "in":
      return Sa(var_core_value_sig4B55 * 96);
    case "cm":
      return Sa(var_core_value_sig4B55 * 96 / 2.54);
    case "mm":
      return Sa(var_core_value_sig4B55 * 96 / 25.4);
    default:
      return Sa(var_core_value_sig4B55);
  }
}
function Sa(var_core_value_sig432A) {
  return Math.round(var_core_value_sig432A * 100) / 100;
}
function Ca(var_core_value_sig3B51) {
...
const Da = {
    ...
    handler: async (var_core_value_sig542D, var_core_value_sigB225) => {
      let var_core_value_sig8AAB = var_core_value_sig542D.get(var_core_value_sig1760),
        var_core_value_sigE82A = var_core_value_sig542D.get(q),
        var_core_value_sigB2CF = var_core_value_sig8AAB.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        ...
        var_core_value_sig2900 = R(var_core_value_sigB225, var_core_value_sig5955);
      if (!var_core_value_sigB2CF || !var_core_value_sigF829 || !var_core_value_sig2900) return false;
      let var_core_value_sig51D8 = z(var_core_value_sigB2CF, L(var_core_value_sigB225, var_core_value_sig5955));
      return var_core_value_sig51D8 ? la({
  ...
  Oa = {
    ...
    handler: async (var_core_value_sig8693, var_core_value_sigAACD) => {
      ...
      let var_core_value_sig895A = var_core_value_sig8693.get(var_core_value_sig1760),
        var_core_value_sigA764 = var_core_value_sig8693.get(var_core_value_sig533B),
        var_core_value_sigC3D9 = var_core_value_sig8693.get(q),
        var_core_value_sigA6C0 = var_core_value_sig895A.getCurrentUnitOfType(var_core_value_sig87EA.UNIVER_DOC),
        ...
        var_core_value_sig0276 = R(var_core_value_sigAACD, var_core_value_sigFF70);
      ...
      let var_core_value_sigFA20 = var_core_value_sigA6C0.getSnapshot(),
        var_core_value_sig2752 = L(var_core_value_sigAACD, var_core_value_sigFF70),
        var_core_value_sig0E1A = z(var_core_value_sigA6C0, var_core_value_sig2752);
      if (!var_core_value_sig0E1A) return false;
      let var_core_value_sig6A48 = ua({
        documentData: var_core_value_sig0E1A,
        tableId: var_core_value_sigB469,
        ...var_core_value_sig0276,
        text: var_core_value_sigAACD.text
      }, W(var_core_value_sigFA20, var_core_value_sig2752));
      return U(var_core_value_sigA764, var_core_value_sigA6C0.getUnitId(), var_core_value_sig0E1A, var_core_value_sig6A48, undefined, undefined, undefined, var_core_value_sig5A20.EditTableCell);
    }
  },
  ka = {};
let Aa = class extends var_core_value_sig032D {
  ...
  _initResource() {
    this.disposeWithMe(this._resourceManagerService["registerPluginResource"]({
      pluginName: wa,
      businesses: [var_core_value_sig87EA.UNIVER_DOC],
      toJson: var_core_value_sig7F33 => JSON.stringify(this._docsTableModel["serialize"](var_core_value_sig7F33)),
      parseJson: var_core_value_sig0C53 => N(JSON.parse(var_core_value_sig0C53)),
...
Aa = vr([K(0, var_core_value_sig398A), K(1, var_core_value_sig7C7A(J))], Aa);
let $ = class extends var_core_value_sig9506 {
  constructor(var_core_value_sig08A3 = ka, var_core_value_sig77D8, var_core_value_sig78A3, var_core_value_sig649B) {
    ...
    } = var_core_value_sig0C3A({}, ka, this._config);
    this._configService["setConfig"]("docs-table.config", var_core_value_sig6256);
  }
  onStarting() {
    this._injector["add"]([J]), this._injector["add"]([Aa]), this._injector["add"]([q]), this._injector["get"](J), this._injector["get"](Aa), this._injector["get"](q), this._initCommands();
  }
  _initCommands() {
    [Da, Or, kr, Ar, jr, Mr, Nr, Fr, hi, vi, yi, bi, xi, Si, Oa, Ci, wi, Ti, Ei, Di, $i, Ji, Xi, Qi, ea, aa, oa].forEach(var_core_value_sig7565 => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig7565)));
  }
};
G($, "pluginName", wa), G($, "packageName", Ta), G($, "version", Ea), G($, "type", var_core_value_sig87EA.UNIVER_DOC), $ = vr([var_core_value_sig1FB8(var_core_value_sig5BC4, var_core_value_sig801E), K(1, var_core_value_sig7C7A(var_core_value_sig78E8)), K(2, var_core_value_sig533B), K(3, var_core_value_sig6434)], $);
export { Ir as DEFAULT_DOCS_TABLE_CELL_MARGIN, wa as DOCS_TABLE_PLUGIN, Mi as DocsTableBorderPreset, ot as DocsTableColumnInsertPosition, pn as DocsTableColumnType, Or as DocsTableDeleteColumnsCommand, kr as DocsTableDeleteRowsCommand, Ar as DocsTableDeleteTableCommand, jr as DocsTableDistributeColumnsCommand, Mr as DocsTableDistributeRowsCommand, Nr as DocsTableInsertColumnsCommand, it as DocsTableInsertPosition, Fr as DocsTableInsertRowsCommand, hi as DocsTableInsertTableCommand, Hr as DocsTableInsertTablePosition, vi as DocsTableInsertTitleRowCommand, yi as DocsTableMergeCellsCommand, J as DocsTableModel, bi as DocsTableMoveColumnsCommand, xi as DocsTableMoveRowsCommand, Si as DocsTableMoveTableCommand, Ci as DocsTableResizeColumnCommand, wi as DocsTableResizeRowCommand, at as DocsTableRowInsertPosition, mn as DocsTableSelectionKind, q as DocsTableSelectionService, hn as DocsTableSelectionSource, Ti as DocsTableSetColumnTypeCommand, Ei as DocsTableSetHeaderRowCountCommand, Di as DocsTableSetTableBackgroundCommand, Ji as DocsTableSetTableBorderColorCommand, $i as DocsTableSetTableBorderCommand, Xi as DocsTableSetTableBorderStyleCommand, Qi as DocsTableSetTableBorderWidthCommand, ea as DocsTableSetTableVerticalAlignCommand, gn as DocsTableSortDirection, aa as DocsTableSortTableCommand, oa as DocsTableUnmergeCellsCommand, $ as UniverDocsTablePlugin, ut as buildDeleteColumnsActions, lt as buildDeleteRowsActions, dt as buildDeleteTableActions, zn as buildDeleteTableColumnsMutationActions, $n as buildDeleteTableMutationActions, Qn as buildDeleteTableRowsMutationActions, $t as buildDistributeColumnsActions, Qt as buildDistributeRowsActions, Mn as buildDistributeTableColumnsMutationActions, jn as buildDistributeTableRowsMutationActions, ct as buildInsertColumnsActions, st as buildInsertRowsActions, Pn as buildInsertTableColumnsMutationActions, Xn as buildInsertTableRowsMutationActions, Zn as buildInsertTableTitleRowMutationActions, Xt as buildInsertTitleRowActions, Ne as buildMergeCellsActions, Pe as buildMergeCellsMutationActions, pt as buildMoveColumnsActions, Dn as buildMoveFloatingTableMutationActions, ft as buildMoveRowsActions, nn as buildMoveTableActions, Vn as buildMoveTableColumnsMutationActions, Bn as buildMoveTableRowsMutationActions, On as buildMoveTableToOffsetMutationActions, ua as buildPastePlainTextTableMutationActions, tn as buildResizeColumnActions, en as buildResizeRowActions, En as buildResizeTableColumnActionsFromWidth, An as buildResizeTableRowActionsFromHeight, Zt as buildSetHeaderRowCountActions, ki as buildSetTableBackgroundMutationActions, Pi as buildSetTableBorderActions, Fi as buildSetTableBorderMutationActions, Ii as buildSetTableCellBackgroundActions, Lr as buildSetTableCellMarginMutationActions, Vt as buildSetTableCellTextActions, Bt as buildSetTableCellTextMutationActions, Rr as buildSetTableDefaultCellMarginMutationActions, Nn as buildSetTableHeaderRowCountMutationActions, _n as buildSortTableActions, Hn as buildSortTableMutationActions, Fe as buildUnmergeCellsActions, Ie as buildUnmergeCellsMutationActions, je as canMergeCells, Me as canUnmergeCells, ca as convertPlainTextTableToHtml, U as executeRichTextTableActions, W as getTableActionBodyPath, w as getTableRangeById, da as parseHtmlTableClipboard, sa as parseHtmlTablesClipboard };
