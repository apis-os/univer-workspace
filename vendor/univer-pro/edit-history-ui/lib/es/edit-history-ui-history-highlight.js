...
let Y = class extends Disposable {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46184) {
    super(), this._themeService = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46184, z(this, "_styles", {
      insert: {
        fill: "",
        stroke: ""
      },
  ...
  getStyle(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46186) {
    return this._styles[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46186];
  }
  _refreshStyles() {
    this._styles = {
  ...
  _createStyle(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46188) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46189 = this._themeService["getColorFromTheme"](et[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46188]);
    return {
      fill: new ColorKit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46189).setAlpha(0.5).toRgbString(),
      stroke: new ColorKit(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46189).setAlpha(0.9).toRgbString()
    };
  }
};
