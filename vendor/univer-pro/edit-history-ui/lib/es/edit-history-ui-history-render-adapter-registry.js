...
var B = class extends Disposable {
  constructor(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4663) {
    super(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4663), z(this, "_adapters", new Map());
  }
  register(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665) {
    if (this._adapters["has"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665.type)) throw Error("[HistoryRenderAdapterRegistryService]:\x20Adapter\x20for\x20unit\x20type\x20" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665.type + " is already registered.");
    return this._adapters["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665.type, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665), toDisposable(() => {
      this._adapters["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665.type) === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665 && this._adapters["delete"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4665.type);
    });
  }
  get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4667) {
    return this._adapters["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4667);
  }
  dispose() {
