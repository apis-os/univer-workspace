...
let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46764 = class extends Plugin {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46333 = q, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46334, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46335, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46336) {
    ...
    this._configService["setConfig"](Ue, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46337);
  }
  onStarting() {
    this.disposeWithMe(this._commandService["registerCommand"](Ke)), registerDependencies(this._injector, [[Y], [X], [Z], [J], [Q], [R], [K]]);
  }
};
