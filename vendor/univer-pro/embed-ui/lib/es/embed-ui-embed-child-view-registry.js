...
var Ic = class {
    ...
    register(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461643) {
      if (this._contributions["has"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461643.childType)) throw Error("Embed child view contribution already registered: " + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461643.childType);
      this._contributions["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461643.childType, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461643);
    }
    get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461645) {
      return this._contributions["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461645);
    }
    list() {
  ...
  Lc = class {
    ...
    register(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647) {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648 = this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647.hostType, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647.entry, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647.childType);
      if (this._contributions["has"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648)) throw Error("Embed floating menu contribution already registered: " + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648);
      return this._contributions["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647), toDisposable(() => {
        this._contributions["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648) === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461647 && this._contributions["delete"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461648);
      });
    }
    get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461651, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461652, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461653) {
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461653 != null) {
        let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46310 = this._contributions["get"](this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461651, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461652, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461653));
        if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46310) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46310;
      }
      return this._contributions["get"](this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461651, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461652));
    }
    hasExact(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461657, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461658, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461659) {
      return this._contributions["has"](this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461657, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461658, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461659));
    }
    list() {
      return [...this._contributions["values"]()];
    }
    _key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461663, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461664, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461665) {
      return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461665 == null ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461663 + ":" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461664 + ":*" : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461663 + ":" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461664 + ":" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461665;
    }
  },
  Rc = class {
    constructor() {
    ...
    register(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461669) {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461670 = this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461669.hostType, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461669.entry);
      if (this._contributions["has"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461670)) throw Error("Embed\x20host\x20container\x20contribution\x20already\x20registered:\x20" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461670);
      this._contributions["set"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461670, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461669);
    }
    get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461673, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461674) {
      return this._contributions["get"](this._key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461673, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461674));
    }
    list() {
      return [...this._contributions["values"]()];
    }
    supports(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461677, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461678, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461679) {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461680 = this.get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461677, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461678);
      return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461680 ? (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461680.supportedLayouts ?? [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461680.layout]).includes(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461679) : false;
    }
    _key(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461685, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461686) {
      return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461685 + ":" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461686;
    }
  },
  zc = class {
    constructor() {
    ...
    register(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461689, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461690) {
      let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19 = typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461689 == "string" ? {
        childUnitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461689,
        root: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461690
      } : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461689;
      return this._rootsByChildUnitId["set"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.childUnitId, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19), var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.embedId && this._rootsByEmbedId["set"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.embedId, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19), var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.hostAnchorId && this._rootsByHostAnchorId["set"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.hostAnchorId, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19), toDisposable(() => {
        this._rootsByChildUnitId["get"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.childUnitId) === var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19 && this._rootsByChildUnitId["delete"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.childUnitId), var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.embedId && this._rootsByEmbedId["get"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.embedId) === var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19 && this._rootsByEmbedId["delete"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.embedId), var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.hostAnchorId && this._rootsByHostAnchorId["get"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.hostAnchorId) === var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19 && this._rootsByHostAnchorId["delete"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB19.hostAnchorId);
      });
    }
    get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461693) {
      var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461694;
      return ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461694 = this._rootsByChildUnitId["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461693)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461694.root) ?? null;
    }
    getByEmbedId(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461697) {
      var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461698;
      return ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461698 = this._rootsByEmbedId["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461697)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461698.root) ?? null;
    }
    getByHostAnchorId(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461701) {
      var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461702;
      return ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461702 = this._rootsByHostAnchorId["get"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461701)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461702.root) ?? null;
    }
    contains(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461705, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706) {
      if (!(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461705 instanceof Node)) return false;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461707 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.embedId ? this.getByEmbedId(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.embedId) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.hostAnchorId ? this.getByHostAnchorId(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.hostAnchorId) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.childUnitId ? this.get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461706.childUnitId) : null;
      return !!(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461707 != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461707.contains(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461705));
    }
  };
export { Ic as EmbedChildViewRegistryService, Rc as EmbedHostContainerRegistryService };
export { zc, Lc };
