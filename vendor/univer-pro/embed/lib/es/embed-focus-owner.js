...
var da = class {
  constructor() {
    x(this, "_focusOwner$", new BehaviorSubject(null)), x(this, "focusOwner$", this._focusOwner$["asObservable"]());
  }
  getFocusOwner() {
    return this._focusOwner$["getValue"]();
  }
  setFocusOwner(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683 = this.getFocusOwner();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683 && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683.hostUnitId === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682.hostUnitId && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683.embedId === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682.embedId && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683.childUnitId === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682.childUnitId && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683.childType === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682.childType && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46683.reason === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682.reason || this._focusOwner$["next"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46682);
  }
  clearFocusOwner(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46686) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46687 = this.getFocusOwner();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46687 && (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46686 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46687.embedId === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46686) && this._focusOwner$["next"](null);
  }
};
export { da as EmbedFocusOwnerService };
