...
import { Fn } from "./internal-core-endo.js";
function In(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461589) {
  return R(Fn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461589)).unit["selector"];
}
export { In as getResourceRefInputUnitSelector };
