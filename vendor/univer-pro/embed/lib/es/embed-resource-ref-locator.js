...
import { Tn } from "./internal-core-endo.js";
import { R } from "./embed-resource-ref.js";
function Pn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461583) {
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461583 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461583.trim() !== var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461583) throw Error("RESOURCE_REF_LOCATOR_INVALID");
  return Tn(R(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461583));
}
export { Pn as normalizeResourceRefLocator };
