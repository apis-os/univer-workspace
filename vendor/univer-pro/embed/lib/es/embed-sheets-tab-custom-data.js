...
import { bi } from "./internal-core-endo.js";
function Ci(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462072) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462073;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462074 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462073 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462072.custom) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462073[bi];
  if (wi(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462074)) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462074;
}
function wi(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462078) {
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462078 || typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462078 != "object") return false;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462078;
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079.version === 1 && typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079.embedId == "string" && typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079.hostAnchorId == "string" && (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079.childType === undefined || typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462079.childType == "number");
}
export { Ci as getEmbedSheetsTabCustomData };
