...
function f(t) {
  return !t || typeof t != `object` || !(`qualifier` in t) || !(`sourceUnitId` in t) || !(`sourceUnitType` in t) ? !1 : typeof t.qualifier == `string` && t.qualifier.trim().length > 0 && !u(t.qualifier) && typeof t.sourceUnitId == `string` && t.sourceUnitId.length > 0 && (t.sourceUnitType === e.UniverInstanceType.UNIVER_SHEET || t.sourceUnitType === e.UniverInstanceType.UNIVER_BASE);
}
var p = class extends e.Disposable {
  constructor(...e) {
    super(...e), s(this, `_resources`, new Map()), s(this, `_rawResources`, new Map()), s(this, `_loadErrors`, new Map()), s(this, `_revisions`, new Map());
  }
  load(t, n) {
    return !n || typeof n != `object` ? (this._preserveInvalid(t, n, `invalid-resource`), !1) : !(`schemaVersion` in n) || n.schemaVersion !== 1 ? (this._preserveInvalid(t, n, `unsupported-version`), !1) : m(n) ? (this._resources.set(t, e.Tools.deepClone(n)), this._rawResources.delete(t), this._loadErrors.delete(t), this._bumpRevision(t), !0) : (this._preserveInvalid(t, n, `invalid-resource`), !1);
  }
  set(t, n) {
    return m(n) ? (this._resources.set(t, e.Tools.deepClone(n)), this._rawResources.delete(t), this._loadErrors.delete(t), this._bumpRevision(t), !0) : !1;
  }
  serialize(t) {
    let n = this._resources.get(t);
    return n ? e.Tools.deepClone(n) : this._rawResources.has(t) ? e.Tools.deepClone(this._rawResources.get(t)) : l();
  }
  get(t) {
    let n = this._resources.get(t);
  ...
  getAll() {
    return Object.fromEntries(Array.from(this._resources.entries(), ([t, n]) => [t, e.Tools.deepClone(n)]));
  }
  getLoadError(e) {
  ...
  resolveBinding(t, n) {
    ...
    let i = Object.entries(((r = this._resources.get(t)) == null ? void 0 : r.references) ?? {}),
      a = n.toLowerCase(),
  ...
  _preserveInvalid(t, n, r) {
    this._resources.delete(t), this._rawResources.set(t, e.Tools.deepClone(n)), this._loadErrors.set(t, r), this._bumpRevision(t);
  }
  _bumpRevision(e) {
...
const h = {
  ...
  g = {
    ...
    handler: (e, t) => b(e, t == null ? void 0 : t.unitId, t ? [{
  ...
  _ = {
    ...
    type: e.CommandType.COMMAND,
    handler: (e, t) => b(e, t == null ? void 0 : t.unitId, (t == null ? void 0 : t.references) ?? [])
  },
  v = {
    id: `formula.command.remove-host-external-reference`,
    type: e.CommandType.COMMAND,
    handler: (t, n) => {
      if (!(n != null && n.unitId) || !n.referenceId && !n.qualifier) return !1;
      let r = t.get(p);
...
function b(t, n, r) {
  if (!n) return !1;
  let i = x(t, n, r);
  return i ? !i.redoMutation || !i.undoMutation ? !0 : t.get(e.ICommandService).syncExecuteCommand(i.redoMutation.id, i.redoMutation.params) ? (t.get(e.IUndoRedoService).pushUndoRedo({
    unitID: n,
...
function C(t, n, r, i) {
  ...
  if (a.status === `ambiguous` || a.status === `resolved` && i.referenceId != null && i.referenceId !== a.referenceId) return null;
  if (a.status === `resolved` && a.reference.sourceUnitId === i.sourceUnitId && a.reference.sourceUnitType === i.sourceUnitType && a.reference.qualifier === i.qualifier) return !1;
  let o = i.referenceId ?? (a.status === `resolved` ? a.referenceId : (0, e.generateRandomId)());
  return r.references[o] = {
...
function w(t, n, r, i) {
  return t.get(e.ICommandService).syncExecuteCommand(h.id, {
    unitId: n,
    resource: i
  }) ? (t.get(e.IUndoRedoService).pushUndoRedo({
    unitID: n,
    undoMutations: [{
      id: h.id,
      params: {
...
var T = class extends e.Disposable {
  ...
  registerProvider(t) {
    return this._providers.add(t), (0, e.toDisposable)(() => this._providers.delete(t));
  }
  collectMutations(e) {
...
var D = class extends e.Disposable {
  constructor(...e) {
    super(...e), s(this, `_resources`, new Map()), s(this, `_loadErrors`, new Map());
  }
  load(e, t) {
    if (!t || typeof t != `object`) return this._loadErrors.set(e, `invalid-resource`), !1;
    let n = t;
    return n.schemaVersion === 1 ? !Array.isArray(n.links) || !n.links.every(re) ? (this._loadErrors.set(e, `invalid-resource`), !1) : (this._resources.set(e, n), this._loadErrors.delete(e), !0) : (this._loadErrors.set(e, `unsupported-version`), !1);
  }
  set(e, t) {
...
let A = class {
  constructor(e) {
    this._externalReferenceModel = e, s(this, `id`, `ooxml-external-cache`), s(this, `priority`, -100);
  }
  canRead(e) {
    var t;
...
function oe(t) {
  return typeof t == `number` ? e.CellValueType.NUMBER : typeof t == `boolean` ? e.CellValueType.BOOLEAN : e.CellValueType.STRING;
}
const j = (0, e.createIdentifier)(`univer-pro.formula.reference-data-service`),
  se = (0, e.createIdentifier)(`univer-pro.formula.reference-data-provider-registry`);
var ce = class extends e.Disposable {
  constructor(...e) {
    super(...e), s(this, `_providers`, new Map());
  }
  register(e) {
    return this._providers.set(e.id, e), {
      dispose: () => {
  ...
  getProviders(e) {
    return Array.from(this._providers.values()).filter(t => t.canRead(e)).sort((e, t) => (t.priority ?? 0) - (e.priority ?? 0));
  }
  dispose() {
...
let N = class extends e.Disposable {
  constructor(e, t) {
    super(), this._externalReferenceModel = e, this._superTableService = t, s(this, `_units`, new Map()), s(this, `_pendingDirtyRanges`, []);
  }
  apply(e, t) {
  ...
  getCellState(e, n, r, i) {
    ...
    return !s || !s.coverage.some(e => ue(e, r, i)) ? {
      covered: !1,
      value: t.ErrorType.NA
    } : {
      covered: !0,
      value: ((o = s.cellData.getValue(r, i)) == null ? void 0 : o.v) ?? null
    };
  }
  isRangeCovered(e, t, n) {
    ...
    if (!i) return !1;
    for (let e = n.startRow; e <= n.endRow; e++) for (let t = n.startColumn; t <= n.endColumn; t++) if (!i.coverage.some(n => ue(n, e, t))) return !1;
    return !0;
  }
  enforceLimits(e, t) {
    let n = 0;
    for (; this._coveredCellCount() > e || this._estimatedBytes() > t;) {
      ...
      for (let t = e.range.startRow; t <= e.range.endRow; t++) for (let n = e.range.startColumn; n <= e.range.endColumn; n++) e.sheet.coverage.some(e => ue(e, t, n)) || e.sheet.cellData.realDeleteValue(t, n);
  ...
  _queueDirty(e) {
    for (let t of e) this._pendingDirtyRanges.some(e => e.unitId === t.unitId && e.sheetId === t.sheetId && de(e.range, t.range)) || this._pendingDirtyRanges.push(t);
  }
  _mergeSheet(t, n) {
    ...
    r.name = n.name, r.rowCount = Math.max(r.rowCount, n.rowCount), r.columnCount = Math.max(r.columnCount, n.columnCount), r.coverage.push(...n.coverage);
    for (let {
      row: e,
      column: t,
      cell: i
    } of n.cells) r.cellData.setValue(e, t, i);
  ...
  _writeCoverageMisses(n, r, i, a) {
    for (let o of n.ranges) if (!(!o.range || o.sheetId && o.sheetId !== i.sheetId) && !(o.sheetName && o.sheetName.toLowerCase() !== i.name.toLowerCase())) for (let n = o.range.startRow; n <= o.range.endRow; n++) for (let s = o.range.startColumn; s <= o.range.endColumn; s++) (r.error || !a.some(e => ue(e, n, s))) && i.cellData.setValue(n, s, {
      v: t.ErrorType.NA,
...
let P = class extends e.Disposable {
  constructor(t, n, r) {
    ...
    for (let t of [e.UniverInstanceType.UNIVER_SHEET, e.UniverInstanceType.UNIVER_BASE]) this._univerInstanceService.getAllUnitsForType(t).forEach(e => {
      r.invalidateSourceMetadata(e.getUnitId()), this._watch(e, n, r);
    }), this.disposeWithMe(this._univerInstanceService.getTypeOfUnitAdded$(t).subscribe(({
      unit: e
    }) => {
      r.invalidateSourceMetadata(e.getUnitId()), this._watch(e, n, r);
    })), this.disposeWithMe(this._univerInstanceService.getTypeOfUnitDisposed$(t).subscribe(e => {
      r.invalidateSourceMetadata(e.getUnitId());
      let t = this._names.get(e.getUnitId());
      t && r.invalidateSourceMetadata(t), this._names.delete(e.getUnitId());
    }));
  }
  _watch(e, t, n) {
    let r = e.getUnitId();
    this.disposeWithMe(e.name$.subscribe(e => {
      ...
      if (i !== e) {
        ...
        for (let a of t.renameLiveTarget(r, i, e)) n.invalidateSyntheticUnit(E(a.hostUnitId, a.slot));
      }
    }));
  }
};
P = k([O(0, e.IUniverInstanceService), O(1, (0, e.Inject)(D)), O(2, (0, e.Inject)(N))], P);
let F = class extends e.Disposable {
  constructor(t, n, r) {
    super(), this.disposeWithMe(t.registerPluginResource({
      pluginName: te,
      businesses: [e.UniverInstanceType.UNIVER_SHEET, e.UniverInstanceType.UNIVER_BASE],
...
F = k([O(0, e.IResourceManagerService), O(1, (0, e.Inject)(D)), O(2, (0, e.Inject)(N))], F);
...
let ve = class extends e.Disposable {
  constructor(e, t, n) {
    super(), this._commandService = e, this._sessionService = t, s(this, `_lastPersistedSessionId`, 0), this.disposeWithMe(this._commandService.registerCommand(ee)), this.disposeWithMe(this._sessionService.resultApplied$.subscribe(() => {
      let e = this._sessionService.state.id;
      e < 1 || e === this._lastPersistedSessionId || (this._lastPersistedSessionId = e, this._commandService.syncExecuteCommand(ee.id, {
        sessionId: e
      }));
    }));
  }
};
ve = k([O(0, e.ICommandService), O(1, (0, e.Inject)(t.FormulaCalculationSessionService)), O(2, (0, e.Inject)(T))], ve);
let ye = class extends e.Disposable {
  constructor(t, n, r) {
    super(), t.register(h.id, {
      commandId: h.id,
      getDirtyData: e => {
        let {
            unitId: t
...
ye = k([O(0, t.IActiveDirtyManagerService), O(1, e.IUniverInstanceService), O(2, (0, e.Inject)(t.RegisterOtherFormulaService))], ye);
function be(t, n) {
  let r = n.getUnit(t, e.UniverInstanceType.UNIVER_SHEET);
  if (r) return r.getSheets().map(e => ({
    unitId: t,
  ...
  return i ? Object.values(i.getSnapshot().tables).map(e => {
    var n;
    return {
      unitId: t,
      sheetId: e.id,
      range: {
        startRow: 0,
        startColumn: 0,
        endRow: Math.max(0, (((n = e.recordOrder) == null ? void 0 : n.length) ?? 0) - 1),
...
let Se = class extends e.Disposable {
  constructor(e, n, r) {
    super(), this.disposeWithMe(e.onCommandExecuted((i, a) => {
      var o;
      if (i.id !== `sheet.mutation.set-range-values` || Ce(a)) return;
      let s = (o = i.params) == null ? void 0 : o.unitId;
      if (!s) return;
      let c = we(n, r, s);
      Object.keys(c).length > 0 && queueMicrotask(() => e.executeCommand(t.OtherFormulaMarkDirty.id, c, {
        onlyLocal: !0
      }));
    }));
  }
};
Se = k([O(0, e.ICommandService), O(1, (0, e.Inject)(p)), O(2, (0, e.Inject)(t.RegisterOtherFormulaService))], Se);
function Ce(e) {
...
let Te = class extends e.Disposable {
  constructor(t, n, r) {
    super(), [h, g, _, v].forEach(e => {
      this.disposeWithMe(t.registerCommand(e));
    }), this.disposeWithMe(n.registerPluginResource({
      pluginName: c,
      businesses: [e.UniverInstanceType.UNIVER_SHEET, e.UniverInstanceType.UNIVER_DOC, e.UniverInstanceType.UNIVER_SLIDE, e.UniverInstanceType.UNIVER_BASE, e.UniverInstanceType.UNIVER_BOARD],
...
Te = k([O(0, e.ICommandService), O(1, e.IResourceManagerService), O(2, (0, e.Inject)(p))], Te);
function Ee() {
  return {
    totalFormulaNodes: 0,
...
function ke(e, t) {
  ...
  let r = Ae(e.members),
    ...
    c = je(e, o, r.anchorCount, t, ((n = r.anchor) == null ? void 0 : n.item.f) ?? ``);
  return {
    groupId: e.groupId,
    unitId: e.unitId,
    sheetId: e.sheetId,
...
function Ae(e) {
  ...
  for (let s = 0; s < e.length; s++) {
    let c = e[s];
    t = Math.min(t, c.row), n = Math.max(n, c.row), r = Math.min(r, c.col), i = Math.max(i, c.col), Ne(c.item) && (a++, o = c);
  }
  return {
    minRow: t,
    maxRow: n,
...
const Ve = /\b(?:INDIRECT|ADDRESS|CELL|INFO|FORMULATEXT|RAND|RANDBETWEEN|NOW|TODAY)\s*\(/i,
  L = /(?:(?:'((?:[^']|'')+)'|([A-Za-z_][A-Za-z0-9_. ]*))!)?\$?([A-Z]{1,3})\$?([1-9]\d{0,6})(?::\$?([A-Z]{1,3})\$?([1-9]\d{0,6}))?/gi,
  He = /(?:(?:'((?:[^']|'')+)'|([A-Za-z_][A-Za-z0-9_. ]*))!)?\$?([A-Z]{1,3}):\$?([A-Z]{1,3})(?![A-Za-z0-9_.])/gi,
  Ue = /[A-Za-z_][A-Za-z0-9_.]*/g,
  We = /^(?:TRUE|FALSE)$/i,
  Ge = [t.FUNCTION_NAMES_LOOKUP.ROW, t.FUNCTION_NAMES_LOOKUP.ROWS, t.FUNCTION_NAMES_LOOKUP.COLUMN, t.FUNCTION_NAMES_LOOKUP.COLUMNS],
  Ke = new WeakMap();
function qe(e) {
...
function Je(t) {
  ...
  return n = r.length > 0 ? e.regexp.createRegExpFromSafeFragment(`(^|[^A-Za-z0-9_])${e.regexp.or(...r)}(\\s*\\[|$|[^A-Za-z0-9_])`, `i`) : null, Ke.set(t, n), n;
}
function R(e) {
  let t = globalThis;
...
var Ze = class extends t.FormulaDependencyGenerator {
  constructor(...e) {
    super(...e), s(this, `_featureFormulaDirtyDependencies`, []), s(this, `_calculationTreeCache`, new Map()), s(this, `_calculationNodeDataCache`, new Map()), s(this, `_forcedRecalculationNodeIndices`, new Set()), s(this, `_sharedFormulaCompressionMetrics`, Ee()), s(this, `_cacheDependencyTreeModelRangeList`, !1);
  }
  dispose() {
    super.dispose(), this._dependencyTreeCache.clear(), this._calculationTreeCache.clear(), this._calculationNodeDataCache = new Map(), this._featureFormulaDirtyDependencies.length = 0, this._forcedRecalculationNodeIndices.clear(), this._sharedFormulaCompressionMetrics = Ee();
  }
  ...
  async generatePro(e = !1) {
    this._featureFormulaDirtyDependencies.length = 0, Xe(`dependency.updateRangeFlatten`, () => this._updateRangeFlatten());
    let t = this._currentConfigService.getFormulaData(),
      n = Xe(`dependency.analyzeSharedFormulaGroups`, () => De(t));
    this._sharedFormulaCompressionMetrics = n.metrics, H(`dependency.formulaNodes`, n.metrics.totalFormulaNodes), H(`dependency.sharedFormulaGroups`, n.groups.length);
    ...
    try {
      await Ye(`dependency.generateTreeList`, () => this._generateTreeListPro(t, r, o, n));
    } finally {
      this._cacheDependencyTreeModelRangeList = !1;
    }
    await Ye(`dependency.markDirtyDependencies`, () => this._markDirtyDependenciesPro()), this._featureFormulaDirtyDependencies.length = 0, Xe(`dependency.clearArrayObjectCache`, () => this._runtimeService.clearArrayObjectCache());
    let s = Xe(`dependency.getCalculationOrder`, () => a.getCalculationOrder({
        detectCycles: !0
      })),
  ...
  _getFeatureFormulaTreePro(e, n, r) {
    let {
      ...
      c = new t.FormulaDependencyTree(n || (0, t.generateRandomDependencyTreeId)(this._dependencyManagerService));
    c.unitId = i, c.subUnitId = a, c.rangeList = o, c.getDirtyData = s;
    let l = s(this._currentConfigService.getDirtyData(), this._runtimeService.getAllRuntimeData()),
      u = this._convertDirtyRangesToUnitRange(l.dirtyRanges);
    c.featureDirtyRanges = u, c.featureId = e, c.type = t.FormulaDependencyTreeType.FEATURE_FORMULA;
    let d = this._dependencyManagerService.getFeatureFormulaDependencyPro(r.unitId, r.subUnitId, e),
      f;
    return d === void 0 && (d = this._dependencyManagerService.addFeatureFormulaDependencyPro(i, a, e, c), f = d), u.length > 0 && this._featureFormulaDirtyDependencies.push({
      node: this._dependencyManagerService.getFeatureFormulaDependencyNodePro(i, a, e),
      dirtyRanges: u
    }), this._cacheCalculationTree(d, c), this._releaseDependencyTree(c), f;
  }
      ...
      for (let e of i) {
        ...
        for (let n of c) {
          ...
          let {
              firstRow: d,
              firstColumn: f
            } = this._getFirstCellOfRange(l),
            p = new t.FormulaDependencyTree((0, t.generateRandomDependencyTreeId)(this._dependencyManagerService));
          for (let i = 0; i < l.length; i++) {
            ...
            for (let i = m; i <= g; i++) for (let a = h; a <= _; a++) {
              let o = a - f,
                s = i - d,
                l = this._dependencyManagerService.getOtherFormulaDependencyPro(r, e, n, o, s);
              if (o === 0 && s === 0) {
                p.formula = c, p.unitId = r, p.subUnitId = e, p.formulaId = n, p.type = t.FormulaDependencyTreeType.OTHER_FORMULA, p.isCache = u, p.node || (await this._initialAstNodeAndRanges(p));
                let i = this._getFeatureFormulaDependencyNodes(p.rangeList);
                l === void 0 ? l = this._dependencyManagerService.addOtherFormulaDependencyPro(r, e, n, p, i) : i.length > 0 && (l = this._dependencyManagerService.addOtherFormulaDependencyPro(r, e, n, p, i, `merge`)), this._cacheCalculationTree(l, p), this._syncForcedRecalculationNodeIndex(l, p);
                continue;
              }
              let m = new t.FormulaDependencyTreeVirtual();
              m.treeId = (0, t.generateRandomDependencyTreeId)(this._dependencyManagerService), m.refTree = p, m.refOffsetX = o, m.refOffsetY = s, m.isCache = u, m.type = t.FormulaDependencyTreeType.OTHER_FORMULA;
              let h = this._getFeatureFormulaDependencyNodes(m.rangeList);
              l === void 0 ? l = this._dependencyManagerService.addOtherFormulaDependencyPro(r, e, n, m, h) : h.length > 0 && (l = this._dependencyManagerService.addOtherFormulaDependencyPro(r, e, n, m, h, `merge`)), this._cacheCalculationTree(l, m), this._syncForcedRecalculationNodeIndex(l, m), this._releaseDependencyTree(m);
            }
          }
  ...
  async _registerFormulasPro(e, t, n, r = De(t)) {
    ...
    H(o ? `dependency.eagerCalculationTreeCache.enabled` : `dependency.eagerCalculationTreeCache.skipped`);
    for (let r of e) {
      let e = t[r];
      if (e == null) continue;
      let s = Object.keys(e);
      for (let t of s) {
        ...
        for (let e of p) {
          ...
          for (let e of h) {
            ...
            (o || T) && (H(`dependency.calculationTreeCache.normal`), this._cacheCalculationTree(w, b));
          }
        }
          ...
          for (let e of d) {
            ...
            if ((_ == null ? void 0 : _.mode) === `compressed` && g != null && s.has(g)) {
              if (o) {
                ...
                e !== void 0 && (H(`dependency.calculationTreeCache.compressedVirtual`), this._cacheCompressedVirtualCalculationTree(e, n, o, c));
              }
              continue;
            }
            ...
            (o || x) && (H(`dependency.calculationTreeCache.normal`), this._cacheCalculationTree(v, y)), this._releaseDependencyTree(y);
          }
        }
        ...
        V(`dependency.registerFormulas.compressedGroups`, B() - g), s.forEach(e => this._releaseDependencyTree(e)), s.clear();
      }
    }
  }
  ...
  _convertSharedFormulaPatterns(t) {
    ...
    for (let o = 0; o < t.rangeList.length; o++) {
      let s = t.rangeList[o];
      if ((s.range.rangeType ?? e.RANGE_TYPE.NORMAL) !== e.RANGE_TYPE.NORMAL) return;
      let c = this._normalizeSharedFormulaRange(s.range),
        l;
      l = c.startRow === c.endRow && c.startColumn === c.endColumn ? {
        kind: `cell`,
        unitId: s.unitId,
        sheetId: s.sheetId,
  ...
  _hasSharedFormulaSelfOverlap(t, n) {
    for (let r = 0; r < n.length; r++) {
      ...
      if (i.unitId === t.unitId && i.sheetId === t.sheetId && e.Rectangle.intersects(i.range, t.range)) return !0;
    }
    return !1;
  }
  ...
  _inferDependencyTreeTypePro(e) {
    return e.featureId == null ? e.formulaId == null ? t.FormulaDependencyTreeType.NORMAL_FORMULA : t.FormulaDependencyTreeType.OTHER_FORMULA : t.FormulaDependencyTreeType.FEATURE_FORMULA;
  }
  ...
  _rangesIntersectAny(t, n) {
    for (let r = 0; r < t.length; r++) {
      ...
      for (let t = 0; t < n.length; t++) {
        let r = n[t];
        if (i.unitId === r.unitId && i.sheetId === r.sheetId && e.Rectangle.intersects(i.range, r.range)) return !0;
      }
    }
    return !1;
  }
  ...
  _initializeAstNode(e) {
    ...
    let n = (0, t.generateAstNode)(e.unitId, e.formula, this._lexer, this._astTreeBuilder, this._currentConfigService, e.subUnitId, e.column, e.row);
    return e.node = n, e.addressFunctionNodes = this._getAddressFunctionNodeList(n), n;
  }
  ...
  _tryInitialStaticReferenceRanges(e) {
    ...
    let a = i.slice(1);
    if (a.indexOf(`[`) >= 0 || a.indexOf(`]`) >= 0 || a.indexOf(`{`) >= 0 || a.indexOf(`}`) >= 0 || a.indexOf(`#`) >= 0 || Ve.test(a)) return R(`static.skip.unsupportedSyntax`), z(`unsupportedSyntax`, i), !1;
    let o = this._replaceDoubleQuotedStrings(a),
      s = this._replaceQuotedSheetNames(o);
    if (qe(s) || !this._hasOnlyStaticReferenceSafeIdentifiers(s)) return R(`static.skip.identifier`), z(`identifier`, i), !1;
    let c = [],
      l = ((n = (r = this._currentConfigService).getSheetNameMap) == null ? void 0 : n.call(r)) ?? {},
    ...
    if (u) {
      ...
      if (n == null) {
        if (!this._hasOnlyStaticOffsetBases(e, l, o)) return R(`static.skip.offset`), z(`offset`, i), !1;
        this._initializeAstNode(e), d = !0, R(`static.dynamicOffset`);
      } else c.push(...n);
      f = this._replaceFunctionFirstArguments(f, t.FUNCTION_NAMES_LOOKUP.OFFSET);
    }
    for (let e of Ge) f = this._replaceFunctionFirstArguments(f, e);
    He.lastIndex = 0;
    let p;
    for (; (p = He.exec(f)) != null;) {
      if (!this._isStaticReferenceTokenBoundarySafe(f, p.index, He.lastIndex)) continue;
      let t = this._tryCreateStaticColumnReferenceRange(e, l, p);
      if (t == null) return R(`static.skip.referenceParse`), z(`referenceParse`, i), !1;
      c.push(t);
    }
    L.lastIndex = 0;
    let m;
    for (; (m = L.exec(f)) != null;) {
      if (!this._isStaticReferenceTokenBoundarySafe(f, m.index, L.lastIndex)) continue;
      let t = this._tryCreateStaticReferenceRange(e, l, m);
      if (t == null) return R(`static.skip.referenceParse`), z(`referenceParse`, i), !1;
      c.push(t);
    }
    return d || (e.addressFunctionNodes = []), e.rangeList.push(...this._dedupeStaticReferenceRanges(c)), !0;
  }
  ...
  _hasOnlyStaticReferenceSafeIdentifiers(e) {
    ...
    for (; (t = Ue.exec(e)) != null;) {
      ...
      if (!(a === `(` || a === `!` || We.test(n)) && !this._looksLikeA1ReferenceAt(e, r, i) && !this._looksLikeColumnReferencePart(e, r, i)) return !1;
    }
    return !0;
  }
  ...
  _tryCreateStaticReferenceRange(e, n, r) {
    ...
    if (!(c === void 0 || u === void 0 || l < 0 || d < 0 || Math.max(l, d) >= m.rowCount || Math.max(c, u) >= m.columnCount)) return {
      unitId: e.unitId,
      sheetId: s,
      range: {
  ...
  _tryCreateStaticColumnReferenceRange(n, r, i) {
    ...
    if (!(Math.max(l, u) >= f.columnCount || f.rowCount <= 0)) return {
      unitId: n.unitId,
      sheetId: c,
      range: {
        startRow: 0,
  ...
  _hasOnlyStaticOffsetBases(e, n, r) {
    ...
    return i.length > 0 && i.every(t => this._tryParseSingleStaticReference(e, n, t[0]) != null);
  }
  ...
  _tryParseSingleStaticReference(e, t, n) {
    ...
    L.lastIndex = 0;
    let i = L.exec(r);
    if (i != null && i.index === 0 && L.lastIndex === r.length) return this._tryCreateStaticReferenceRange(e, t, i);
  }
  ...
  _createFDtree(e, n, r, i, a, o) {
    let {
      ...
      c = new t.FormulaDependencyTree((0, t.generateRandomDependencyTreeId)(this._dependencyManagerService)),
      l = a[e][n];
    return c.formula = s, c.unitId = e, c.subUnitId = n, c.row = r, c.column = i, c.rowCount = l.rowCount, c.columnCount = l.columnCount, c;
  }
};
let Qe = class extends t.CalculateFormulaService {
  constructor(e, t, n, r, i, a, o, c) {
    super(e, t, n, r, i, a, o), this._externalReferenceDataLoader = c, s(this, `_dynamicRuntimeRanges`, void 0), s(this, `_runtimeExternalDataLoaded`, !1);
  }
  async execute(e) {
    this._runtimeService.setFormulaExecuteStage(t.FormulaExecuteStageType.START), this._executionInProgressListener$.next(this._runtimeService.getRuntimeState()), this._currentConfigService.load(e), this._runtimeService.reset();
    ...
    this._isCalculateTreeModel = e.isCalculateTreeModel || !1, this._executeLock.acquire(`FORMULA_EXECUTION_LOCK`, async () => {
      await this._executeStep(n), this._runtimeService.setFormulaExecuteStage(t.FormulaExecuteStageType.CALCULATION_COMPLETED), this._executionInProgressListener$.next(this._runtimeService.getRuntimeState()), this._executionCompleteListener$.next(this._runtimeService.getAllRuntimeData()), t.CELL_INVERTED_INDEX_CACHE.clear(), this._runtimeService.reset();
    });
  }
  async _executeStep(e = t.DEFAULT_CYCLE_REFERENCE_COUNT) {
    ...
    return i == null || i.length === 0 ? !0 : (t.FORMULA_REF_TO_ARRAY_CACHE.clear(), this._currentConfigService.loadDirtyRangesAndExcludedCell(i, a), await this._apply(!0, e), !0);
  }
  async _apply(e = !1, n = t.DEFAULT_CYCLE_REFERENCE_COUNT) {
    this._setFormulaExecuteStage(e, t.FormulaExecuteStageType.START_DEPENDENCY, t.FormulaExecuteStageType.START_DEPENDENCY_ARRAY_FORMULA), this._executionInProgressListener$.next(this._runtimeService.getRuntimeState());
    ...
    try {
      let {
          calculationOrderResult: r,
          dependencyTree: o
        } = await a.generatePro(this._isCalculateTreeModel),
        s = this._getCalculationPlanTreeCount(r, o, n);
      r.hasCycle && this._runtimeService.enableCycleDependency(), this._setFormulaExecuteStage(e, t.FormulaExecuteStageType.START_CALCULATION, t.FormulaExecuteStageType.START_CALCULATION_ARRAY_FORMULA), this._setTotalFormulasToCalculate(e, s), this._executionInProgressListener$.next(this._runtimeService.getRuntimeState());
      let c = [],
        l = [],
        u = new Set(),
        d = !1,
      ...
      for (this._runtimeService.setFormulaCycleIndex(0);;) {
        let m = !1,
          h = !1;
        if (await this._forEachCalculationPlanTree(r, o, n, async (t, r, o, s) => {
          if (this._runtimeService.setFormulaCycleIndex(o ?? 0), await this._waitForExecutionSlot(f, i, e, t, c)) return d = !0, !1;
          if (s) {
          ...
          this._runtimeExternalDataLoaded = !1, h ||= g, p && (g || this._shouldRescheduleAfterDynamicChange(a, r, u)) && (m = !0), u.has(r) || (u.add(r), l.push(r)), f++;
        }), r.calculationForest.length = 0, d || !m) break;
        if (p++, p > 8) throw Error(`Dynamic dependency did not stabilize`);
        h && t.FORMULA_REF_TO_ARRAY_CACHE.clear(), a.clearCachedCalculationNodeData(), r = a.getCalculationOrder(), r.hasCycle && this._runtimeService.enableCycleDependency(), s = this._getCalculationPlanTreeCount(r, o, n), this._setTotalFormulasToCalculate(e, s);
      }
      for (let e = 0; e < c.length; e++) c[e]();
      return l.length > 0 && a.clearCalculatedDirty(l), d ? void 0 : (s > 0 || l.length > 0 ? this._runtimeService.markedAsSuccessfullyExecuted() : e || this._runtimeService.markedAsNoFunctionsExecuted(), this._runtimeService.getAllRuntimeData());
    } finally {
      a.clearCachedCalculationNodeData(), a.clearCachedCalculationTree(), this._dynamicRuntimeRanges = void 0;
    }
  }
  ...
  async _forEachCalculationPlanTree(e, n, r, i) {
    ...
    for (let o = 0; o < e.calculationForest.length; o++) {
      let s = e.calculationForest[o],
        c = s.hasCycle && r <= t.DEFAULT_CYCLE_REFERENCE_COUNT && this._calculationPlanHasSelfReference(s);
  ...
  _collectAddressFunctionRuntimeReferencesInternal(e, n) {
    if (e.isAddress()) {
      let r = e.getValue();
      r instanceof t.BaseReferenceObject && n.push({
        ...r.toUnitRange(),
        sheetName: r.getForcedSheetName() || void 0
      });
    }
    for (let t of e.getChildren()) this._collectAddressFunctionRuntimeReferencesInternal(t, n);
  }
  ...
  async _waitForExecutionSlot(n, r, i, a, o) {
    return n % r === 0 ? (await new Promise(t => {
      let n = (0, e.requestImmediateMacroTask)(t);
      o.push(n);
    }), i ? (this._runtimeService.setFormulaExecuteStage(t.FormulaExecuteStageType.CURRENTLY_CALCULATING_ARRAY_FORMULA), this._runtimeService.setCompletedArrayFormulasCount(n + 1)) : (this._runtimeService.setFormulaExecuteStage(t.FormulaExecuteStageType.CURRENTLY_CALCULATING), this._runtimeService.setCompletedFormulasCount(n + 1)), this._executionInProgressListener$.next(this._runtimeService.getRuntimeState()), this._runtimeService.isStopExecution() || a.formula == null && a.getDirtyData == null ? (this._runtimeService.setFormulaExecuteStage(t.FormulaExecuteStageType.IDLE), this._runtimeService.markedAsStopFunctionsExecuted(), this._executionCompleteListener$.next(this._runtimeService.getAllRuntimeData()), !0) : !1) : !1;
  }
  async _calculateDependencyTree(e, n, r, i = t.DEFAULT_CYCLE_REFERENCE_COUNT) {
    let a = e.getDirtyData;
    if (this._runtimeService.setCurrent(e.row, e.column, e.rowCount, e.columnCount, e.subUnitId, e.unitId), a != null && e.featureId != null) {
      let t = e.featureId,
        {
          runtimeCellData: n,
          dirtyRanges: r
        } = a(this._currentConfigService.getDirtyData(), this._runtimeService.getAllRuntimeData());
    ...
    try {
      ...
      try {
        c = this._interpreter.checkAsyncNode(o.node) ? await this._interpreter.executeAsync(o) : this._interpreter.execute(o);
      } finally {
        a();
      }
      let {
      ...
      return (!u || i > t.DEFAULT_CYCLE_REFERENCE_COUNT) && (e.formulaId == null ? this._runtimeService.setRuntimeData(c) : this._runtimeService.setRuntimeOtherData(e.formulaId, e.refOffsetX, e.refOffsetY, c)), l;
    } finally {
  ...
  _getCalculationNodeData(e, n, r) {
    ...
    return (i == null ? void 0 : i.node) == null ? {
      node: (0, t.generateAstNode)(e.unitId, e.formula, this._lexer, this._astTreeBuilder, this._currentConfigService, e.subUnitId, e.column - e.refOffsetX, e.row - e.refOffsetY),
      refOffsetX: e.refOffsetX,
      refOffsetY: e.refOffsetY
    } : i;
  }
};
Qe = k([O(0, e.IConfigService), O(1, (0, e.Inject)(t.Lexer)), O(2, t.IFormulaCurrentConfigService), O(3, t.IFormulaRuntimeService), O(4, t.IFormulaDependencyGenerator), O(5, (0, e.Inject)(t.Interpreter)), O(6, (0, e.Inject)(t.AstTreeBuilder)), O(7, t.IFormulaExternalReferenceDataLoader)], Qe);
var $e = class {
  constructor(e, t) {
    s(this, `maxRows`, void 0), s(this, `maxCols`, void 0), s(this, `sheetSize`, void 0), s(this, `_sheetKeyById`, new Map()), s(this, `_sheetIdByKey`, []), this.maxRows = e, this.maxCols = t, this.sheetSize = e * t;
  }
  reset() {
...
var dt = class {
    constructor(e, t) {
      this._codec = e, this._indexToNodeId = t, s(this, `_rowBuckets`, new Map()), s(this, `_colBuckets`, new Map());
    }
    addFormulaCell(e, t) {
      let n = this._codec.decodeCell(e);
      K(this._rowBuckets, this._codec.encodeRow(n.unitId, n.sheetId, n.row), t), K(this._colBuckets, this._codec.encodeCol(n.unitId, n.sheetId, n.col), t);
    }
    addFormulaCellByPosition(e, t, n, r) {
      K(this._rowBuckets, this._codec.encodeRowBySheetKey(e, t), r), K(this._colBuckets, this._codec.encodeColBySheetKey(e, n), r);
    }
    removeFormulaCell(e, t) {
      let n = this._codec.decodeCell(e);
      q(this._rowBuckets, this._codec.encodeRow(n.unitId, n.sheetId, n.row), t), q(this._colBuckets, this._codec.encodeCol(n.unitId, n.sheetId, n.col), t);
    }
  ...
  ft = class {
    constructor(e, t) {
      this._codec = e, this._pointScanCellLimit = t, s(this, `_rowCells`, new Map()), s(this, `_colCells`, new Map());
    }
    add(e) {
      let t = this._codec.decodeCell(e);
      K(this._rowCells, this._codec.encodeRow(t.unitId, t.sheetId, t.row), e), K(this._colCells, this._codec.encodeCol(t.unitId, t.sheetId, t.col), e);
    }
    remove(e) {
      let t = this._codec.decodeCell(e);
      q(this._rowCells, this._codec.encodeRow(t.unitId, t.sheetId, t.row), e), q(this._colCells, this._codec.encodeCol(t.unitId, t.sheetId, t.col), e);
    }
  ...
  pt = class {
    constructor(e, t, n) {
      this._codec = e, this._maxIndexedSpan = n, s(this, `_wholeSheet`, new Map()), s(this, `_wholeCol`, new Map()), s(this, `_wholeRow`, new Map()), s(this, `_rowBuckets`, new Map()), s(this, `_colBuckets`, new Map()), s(this, `_largeRangeIds`, []), s(this, `_sheetArr`, void 0), s(this, `_startRowArr`, void 0), s(this, `_endRowArr`, void 0), s(this, `_startColArr`, void 0), s(this, `_endColArr`, void 0), s(this, `_nodeArr`, void 0), s(this, `_kindArr`, void 0), s(this, `_activeArr`, void 0), s(this, `_rangeSeenEpochArr`, void 0), s(this, `_rangeEpoch`, 1), s(this, `_nextRangeId`, 0), s(this, `_freeRangeIds`, []), s(this, `_nodeToRangeIds`, new Map()), s(this, `_nodeToWholeSheetKeys`, new Map()), s(this, `_nodeToWholeColKeys`, new Map()), s(this, `_nodeToWholeRowKeys`, new Map());
      let r = Math.max(16, t);
    ...
    addRange(e, t) {
      ...
      if (this._setRangeMeta(l, e, n), c > this._maxIndexedSpan) this._kindArr[l] = 3, this._largeRangeIds.push(l);else if (i <= a) {
        this._kindArr[l] = 1;
        for (let e = n.range.startRow; e <= n.range.endRow; e++) K(this._rowBuckets, this._codec.encodeRowBySheetKey(r, e), l);
      } else {
        this._kindArr[l] = 2;
        for (let e = n.range.startColumn; e <= n.range.endColumn; e++) K(this._colBuckets, this._codec.encodeColBySheetKey(r, e), l);
      }
    ...
    forEachPoint(e, t, n, r, i) {
      ...
      J(this._wholeSheet.get(a), i), J(this._wholeCol.get(this._codec.encodeColBySheetKey(a, r)), i), J(this._wholeRow.get(this._codec.encodeRowBySheetKey(a, n)), i);
    ...
    forEachRangesIntersecting(e, t) {
      ...
      for (let e = 0; e < n.length; e++) {
        ...
        J(this._wholeSheet.get(i), t), this._scanWholeCols(r, i, t), this._scanWholeRows(r, i, t), this._scanRowIndexedRanges(r, i, t), this._scanColIndexedRanges(r, i, t);
        for (let e = 0; e < this._largeRangeIds.length; e++) {
    ...
    _ensureRangeCapacity(e) {
      this._sheetArr = Z(this._sheetArr, e), this._startRowArr = Z(this._startRowArr, e), this._endRowArr = Z(this._endRowArr, e), this._startColArr = Z(this._startColArr, e), this._endColArr = Z(this._endColArr, e), this._nodeArr = Z(this._nodeArr, e), this._kindArr = X(this._kindArr, e), this._activeArr = X(this._activeArr, e), this._rangeSeenEpochArr = Z(this._rangeSeenEpochArr, e);
    }
    _setRangeMeta(e, t, n) {
    ...
    _removeRangeId(e) {
      ...
      let t = this._kindArr[e],
        n = this._sheetArr[e];
      if (t === 1) for (let t = this._startRowArr[e]; t <= this._endRowArr[e]; t++) q(this._rowBuckets, this._codec.encodeRowBySheetKey(n, t), e);else if (t === 2) for (let t = this._startColArr[e]; t <= this._endColArr[e]; t++) q(this._colBuckets, this._codec.encodeColBySheetKey(n, t), e);else t === 3 && rt(this._largeRangeIds, e);
    ...
    _scanWholeCols(e, t, n) {
      if (G(e) <= this._wholeCol.size) {
        for (let r = e.range.startColumn; r <= e.range.endColumn; r++) J(this._wholeCol.get(this._codec.encodeColBySheetKey(t, r)), n);
        return;
      }
    ...
    _scanWholeRows(e, t, n) {
      if (W(e) <= this._wholeRow.size) {
        for (let r = e.range.startRow; r <= e.range.endRow; r++) J(this._wholeRow.get(this._codec.encodeRowBySheetKey(t, r)), n);
        return;
      }
  ...
  mt = class {
    constructor(e) {
      s(this, `codec`, void 0), s(this, `_maxIndexedSpan`, void 0), s(this, `_pointScanCellLimit`, void 0), s(this, `_initialNodeCapacity`, void 0), s(this, `_initialRangeCapacity`, void 0), s(this, `directDeps`, void 0), s(this, `nodeDeps`, void 0), s(this, `rangeIndex`, void 0), s(this, `cellFormulaToIndex`, void 0), s(this, `otherFormulaToIndex`, void 0), s(this, `featureCalculationToIndex`, void 0), s(this, `indexToNodeId`, void 0), s(this, `dirty`, void 0), s(this, `inQueue`, void 0), s(this, `_indexToNodeType`, void 0), s(this, `_cellPrecedents`, void 0), s(this, `_rangePrecedents`, void 0), s(this, `_nodePrecedents`, void 0), s(this, `_dynamicDeps`, void 0), s(this, `_dynamicSignature`, void 0), s(this, `_runtimeDirectDeps`, void 0), s(this, `_runtimeNodeDeps`, void 0), s(this, `_runtimeRangeIndex`, void 0), s(this, `_runtimeCellPrecedents`, void 0), s(this, `_runtimeRangePrecedents`, void 0), s(this, `_runtimeNodePrecedents`, void 0), s(this, `_activeNode`, void 0), s(this, `_seenNodeEpoch`, void 0), s(this, `_visitNodeEpoch`, void 0), s(this, `_edgeSeenEpoch`, void 0), s(this, `_tarjanSeenEpoch`, void 0), s(this, `_tarjanIndexArr`, void 0), s(this, `_tarjanLowArr`, void 0), s(this, `_tarjanOnStack`, void 0), s(this, `_emitEpoch`, 1), s(this, `_visitEpoch`, 1), s(this, `_edgeEpoch`, 1), s(this, `_tarjanEpoch`, 1), s(this, `_propQueue`, []), s(this, `_dirtyList`, []), s(this, `_activeNodeCount`, 0), s(this, `_dirtyNodeCount`, 0), s(this, `_directPointIndex`, void 0), s(this, `_runtimeDirectPointIndex`, void 0), s(this, `_formulaCellIndex`, void 0), s(this, `_sharedFormulaGroups`, void 0), s(this, `_sharedFormulaGroupIndexById`, void 0), s(this, `_sharedFormulaMembershipByNode`, void 0), s(this, `_sharedFormulaSourceEntries`, void 0), s(this, `_sharedFormulaSourceRangeIndex`, void 0), this._maxIndexedSpan = e.maxIndexedSpan ?? 4096, this._pointScanCellLimit = e.pointScanCellLimit ?? 4096, this._initialNodeCapacity = Math.max(16, e.initialNodeCapacity ?? 1024), this._initialRangeCapacity = Math.max(16, e.initialRangeCapacity ?? 1024), this.codec = new $e(e.maxRows, e.maxCols), this.reset();
    }
    reset() {
      this.codec.reset(), this.directDeps = new Map(), this.nodeDeps = new Map(), this.rangeIndex = new pt(this.codec, this._initialRangeCapacity, this._maxIndexedSpan), this._runtimeDirectDeps = new Map(), this._runtimeNodeDeps = new Map(), this._runtimeRangeIndex = new pt(this.codec, this._initialRangeCapacity, this._maxIndexedSpan), this.cellFormulaToIndex = new Map(), this.otherFormulaToIndex = new Map(), this.featureCalculationToIndex = new Map(), this.indexToNodeId = [], this._indexToNodeType = new Uint8Array(this._initialNodeCapacity), this.dirty = new Uint8Array(this._initialNodeCapacity), this.inQueue = new Uint8Array(this._initialNodeCapacity), this._activeNode = new Uint8Array(this._initialNodeCapacity), this._cellPrecedents = [], this._rangePrecedents = [], this._nodePrecedents = [], this._dynamicDeps = [], this._dynamicSignature = [], this._runtimeCellPrecedents = [], this._runtimeRangePrecedents = [], this._runtimeNodePrecedents = [], this._seenNodeEpoch = new Uint32Array(this._initialNodeCapacity), this._visitNodeEpoch = new Uint32Array(this._initialNodeCapacity), this._edgeSeenEpoch = new Uint32Array(this._initialNodeCapacity), this._tarjanSeenEpoch = new Uint32Array(this._initialNodeCapacity), this._tarjanIndexArr = new Uint32Array(this._initialNodeCapacity), this._tarjanLowArr = new Uint32Array(this._initialNodeCapacity), this._tarjanOnStack = new Uint8Array(this._initialNodeCapacity), this._emitEpoch = 1, this._visitEpoch = 1, this._edgeEpoch = 1, this._tarjanEpoch = 1, this._propQueue.length = 0, this._dirtyList.length = 0, this._activeNodeCount = 0, this._dirtyNodeCount = 0, this._directPointIndex = new ft(this.codec, this._pointScanCellLimit), this._runtimeDirectPointIndex = new ft(this.codec, this._pointScanCellLimit), this._formulaCellIndex = new dt(this.codec, this.indexToNodeId), this._sharedFormulaGroups = [], this._sharedFormulaGroupIndexById = new Map(), this._sharedFormulaMembershipByNode = new Int32Array(this._initialNodeCapacity), this._sharedFormulaMembershipByNode.fill(-1), this._sharedFormulaSourceEntries = [], this._sharedFormulaSourceRangeIndex = new pt(this.codec, this._initialRangeCapacity, this._maxIndexedSpan);
    }
    encodeCell(e, t, n, r) {
    ...
    _setCalcNodeDepsByType(e, t, n, r, i, a) {
      ...
      return r && this._wouldCreateCycleForNewDeps(l, C, w, T) ? (u && this._addNodeDepsOnly(l, p, m, h), {
        nodeIndex: l,
        hasCycle: !0
      }) : (d && this._unregisterCompressedSharedFormulaGroupByNode(l), !u && e === 1 && (et(t), this._formulaCellIndex.addFormulaCell(t, l)), u || this._activeNodeCount++, this._activeNode[l] = 1, this._addNodeDepsOnly(l, C, w, T), this._setNodeDynamicDeps(l, S), i && (this._markNodeIndexDirty(l, !0), this._propagateDirtyQueue()), {
        nodeIndex: l,
        hasCycle: !1
      });
    }
    ...
    markRangesChanged(e, t) {
      if (e.length === 0) return;
      let n = (t == null ? void 0 : t.coalesce) === !1 ? this._normalizeRangeDeps(e) : ct(e);
      this._nextEmitEpoch();
      for (let e = 0; e < n.length; e++) {
        let r = n[e];
    ...
    refreshDynamicDeps(e, t) {
      ...
      i.cells = nt(i.cells), i.ranges = this._normalizeRangeDeps(i.ranges), i.nodes = this._mergeSortedUniqueNumbers([], i.nodes);
      let o = a.join(`|`),
    ...
    _ensureNodeCapacity(e) {
      ...
      this._indexToNodeType = X(this._indexToNodeType, e), this.dirty = X(this.dirty, e), this.inQueue = X(this.inQueue, e), this._activeNode = X(this._activeNode, e), this._seenNodeEpoch = Z(this._seenNodeEpoch, e), this._visitNodeEpoch = Z(this._visitNodeEpoch, e), this._edgeSeenEpoch = Z(this._edgeSeenEpoch, e), this._tarjanSeenEpoch = Z(this._tarjanSeenEpoch, e), this._tarjanIndexArr = Z(this._tarjanIndexArr, e), this._tarjanLowArr = Z(this._tarjanLowArr, e), this._tarjanOnStack = X(this._tarjanOnStack, e), this._sharedFormulaMembershipByNode = this._growIntThirtyTwoArray(this._sharedFormulaMembershipByNode, e, -1), this._sharedFormulaMembershipByNode.length > t && this._sharedFormulaMembershipByNode.fill(-1, t);
    }
    ...
    _collectDynamicResolveResult(e, t) {
      t.traceCells && e.cells.push(...t.traceCells), t.cells && e.cells.push(...t.cells), t.ranges && e.ranges.push(...t.ranges), t.nodes && e.nodes.push(...this._resolveExplicitNodeDeps(st(t.nodes)));
    }
    ...
    _addDirectEdge(e, t) {
      ...
      n === void 0 && this._directPointIndex.add(e), this.directDeps.set(e, it(n, t));
    }
    ...
    _addRuntimeDirectEdge(e, t) {
      ...
      n === void 0 && this._runtimeDirectPointIndex.add(e), this._runtimeDirectDeps.set(e, it(n, t));
    }
    ...
    _tryBuildAcyclicDirtyCalculationGraph(e) {
      ...
      let n = new Uint32Array(t),
        ...
        p = [],
        m = [],
        h = new pt(this.codec, this._initialRangeCapacity, this._maxIndexedSpan);
    ...
    _addAcyclicRangePrecedentGroups(e, t, n, r, i, a, o, s, c, l, u, d, f) {
      let p = [],
        m = m => {
          ...
          let g = s[h];
          g >= 0 && this._unionCalculationForestComponents(l, u, g, t), this._indexToNodeType[e] === 1 && tt(m, this.codec.decodeCell(this.indexToNodeId[e])) && (f[t] = 1);
        },
  ...
  ht = class extends t.DependencyManagerBaseService {
    constructor(...e) {
      super(...e), s(this, `_dependencyEngineCache`, new mt({
        maxRows: 1048576,
        maxCols: 16384
      }));
    }
...
let gt = class extends t.FormulaUnitReferenceResolver {
  ...
  resolve(n) {
    if (/^[1-9]\d*$/.test(n.qualifier)) {
      let r = this._externalReferenceModel.resolveBinding(n.hostUnitId, n.qualifier);
      if (r.status !== `resolved`) return t.ErrorType.REF;
      let {
        link: i
      } = r;
      if (n.referenceKind === `a1` && i.target.unitType === e.UniverInstanceType.UNIVER_BASE) return t.ErrorType.REF;
      if (i.target.liveUnitId) {
        let e = super.resolve({
          ...n,
          qualifier: i.target.liveUnitId
        });
        if (typeof e != `string`) return e;
      }
      let a = super.resolve({
        ...n,
        qualifier: i.target.name
      });
      return typeof a != `string` && (a.unitType == null || a.unitType === i.target.unitType) ? a : {
    ...
    let r = this._currentConfigService.getExternalReferences()[n.hostUnitId],
      ...
      o = i.filter(([, e]) => e.qualifier.toLowerCase() === a),
      s = o.length > 0 ? o : i.filter(([, e]) => (0, t.normalizeFormulaUnitName)(e.qualifier) === (0, t.normalizeFormulaUnitName)(n.qualifier));
    if (s.length > 1) return t.ErrorType.REF;
    if (s.length === 1) {
      let [r, i] = s[0];
      return n.referenceKind === `a1` && i.sourceUnitType === e.UniverInstanceType.UNIVER_BASE ? t.ErrorType.REF : {
...
const _t = new Set([t.FUNCTION_NAMES_DATE.NOW, t.FUNCTION_NAMES_DATE.TODAY, t.FUNCTION_NAMES_MATH.RAND, t.FUNCTION_NAMES_MATH.RANDARRAY, t.FUNCTION_NAMES_MATH.RANDBETWEEN]);
let vt = class {
  constructor(e) {
    this._lexerTreeBuilder = e;
  }
  assess(e, n) {
    if ((n == null ? void 0 : n.status) !== t.FormulaResultStatus.SUCCESS) return {
      eligible: !1,
      reason: `not-successful`
    };
    let r = e.startsWith(`=`) ? e.slice(1) : e;
    return (this._lexerTreeBuilder.sequenceNodesBuilder(r) ?? []).some(e => typeof e != `string` && e.nodeType === t.sequenceNodeType.FUNCTION && _t.has(e.token.toUpperCase())) ? {
      eligible: !1,
      reason: `volatile`
    } : {
      eligible: !0
...
let yt = class {
  constructor(e, t, n, r) {
    this._currentConfigService = e, this._referenceDataService = t, this._excelExternalReferenceModel = n, this._superTableService = r, s(this, `_requestCounter`, 0), s(this, `_generation`, -1), s(this, `_inflight`, new Map()), s(this, `_completed`, new Set());
  }
  async load(e) {
    let n = this._currentConfigService.getCalculationGeneration();
    n !== this._generation && (this._generation = n, this._inflight.clear(), this._completed.clear());
    let r = this._createRequest(e, n);
    if (!r) return t.ErrorType.REF;
    let i = [n, r.hostUnitId, r.syntheticUnitId, e.referenceKind, e.token].join(`\0`);
    if (this._completed.has(i)) return;
    let a = this._inflight.get(i);
    if (a) return a;
    let o = this._loadRequest(r, e.resolution, n).then(e => (e ?? this._completed.add(i), e)).finally(() => this._inflight.delete(i));
  ...
  _resolveRuntimeRange(e) {
    ...
    let a = (t = this._excelExternalReferenceModel.get(e.hostUnitId)) == null ? void 0 : t.links.find(t => E(e.hostUnitId, t.slot) === e.unitId);
    if (a) return {
      resolution: {
        unitId: e.unitId,
  ...
  _createA1RangeRequest(e) {
    try {
      let {
        sheetName: n,
        range: r
      } = (0, t.deserializeRangeWithSheetWithCache)(e);
      return !n || !Number.isFinite(r.startRow) || !Number.isFinite(r.endRow) || !Number.isFinite(r.startColumn) || !Number.isFinite(r.endColumn) ? void 0 : {
        sheetName: n,
        range: r
      };
    } catch {}
  ...
  async _loadRequest(e, n, r) {
    ...
    if (r !== this._currentConfigService.getCalculationGeneration() || i.calculationId !== e.calculationId) return t.ErrorType.NA;
  ...
  _materializeSheet(t, n) {
    ...
    t[n.sheetId] = {
      ...
      columnCount: Math.max((r == null ? void 0 : r.columnCount) ?? 0, n.columnCount),
      rowData: (r == null ? void 0 : r.rowData) ?? {},
      columnData: (r == null ? void 0 : r.columnData) ?? {}
    };
  }
};
yt = k([O(0, t.IFormulaCurrentConfigService), O(1, j), O(2, (0, e.Inject)(D)), O(3, t.ISuperTableService)], yt);
let Q = class {
  constructor(e, t, n) {
  ...
  _resolveLiveRange(e, t, n, r) {
    return t.tableName ? xt(e, t.tableName, r, this._superTableService) : St(e, t, n, r);
  }
};
Q = k([O(0, (0, e.Inject)(t.FormulaDataModel)), O(1, t.ISuperTableService), O(2, se)], Q);
...
function Ct(e, n, r) {
  if (e.target.sourceUnitId && r[e.target.sourceUnitId]) return e.target.sourceUnitId;
  if (e.target.liveUnitId && r[e.target.liveUnitId]) return e.target.liveUnitId;
  let i = Object.entries(n).filter(([t, n]) => !!r[t] && n.unitType === e.target.unitType),
    a = e.target.name.toLowerCase(),
    o = i.filter(([, e]) => e.name.toLowerCase() === a),
    s = o.length > 0 ? o : i.filter(([, n]) => (0, t.normalizeFormulaUnitName)(n.name) === (0, t.normalizeFormulaUnitName)(e.target.name));
...
let $ = class extends t.UniverFormulaEnginePlugin {
  ...
  _initializeWithOverride() {
    var e;
    if (this._injector.add([t.LexerTreeBuilder, {
      useClass: t.LexerTreeBuilder
    }]), this._injector.add([D]), this._injector.add([p]), this._injector.add([N]), this._injector.add([F]), this._injector.add([Te]), this._injector.add([xe]), this._injector.add([ye]), this._injector.add([Se]), this._injector.add([T]), this._injector.add([vt]), this._injector.add([ve]), this._injector.add([P]), this._injector.add([se, {
      useClass: ce
    }]), this._injector.add([A]), this._injector.add([M]), this._injector.add([Q]), this._config.notExecuteFormula === !0 ? this._injector.add([j, {
      useClass: Q
    }]) : this._injector.add([j, {
      useFactory: () => {
        try {
          return (0, n.toModule)(this._injector.get(n.IRPCChannelService).requestChannel(he));
        } catch {
          return this._injector.get(Q);
        }
      }
    }]), !((e = this._config) != null && e.notExecuteFormula)) {
      let e = [[t.ICalculateFormulaService, {
        useClass: Qe
      }], [t.IDependencyManagerService, {
        useClass: ht
      }], [t.IFormulaDependencyGenerator, {
        useClass: Ze
      }], [t.IFormulaUnitReferenceResolver, {
        useClass: gt
      }], [t.IFormulaExternalReferenceDataLoader, {
        useClass: yt
      }]];
  ...
  onReady() {
    super.onReady(), (0, e.touchDependencies)(this._injector, [[F], [P], [Te], [xe], [ye], [Se], [ve]]), (0, e.touchDependencies)(this._injector, [[M]]), this._config.notExecuteFormula === !0 && this._injector.has(n.IRPCChannelService) && (this._injector.add([I]), (0, e.touchDependencies)(this._injector, [[I]]));
  }
};
s($, `packageName`, ge), s($, `version`, _e), $ = k([(0, e.DependentOn)(r.UniverLicensePlugin)], $);
const wt = /'?\[([^\]]+)\]([^'!]+)'?!\$?([A-Za-z]+)\$?([1-9]\d*)(?:\s*:\s*\$?([A-Za-z]+)\$?([1-9]\d*))?/g,
  Tt = /(?:'((?:[^']|'')+)'|\[([^\]]+)\]|([A-Za-z0-9_.-]+))!([^\s!\[\]]+)\[/g,
  Et = /\bINDIRECT\s*\(\s*"((?:[^"]|"")*)"/gi;
function Dt(e) {
  let t = ``,
...
let Ot = class {
  constructor(e) {
    this._externalReferenceModel = e, s(this, `_calculationCounter`, 0), s(this, `_requestCounter`, 0);
  }
  plan(e) {
    ...
    for (let [r, i] of Object.entries(e.formulaData ?? {})) if (this._externalReferenceModel.get(r)) for (let e of Object.values(i ?? {})) for (let i of Object.values(e ?? {})) for (let e of Object.values(i ?? {})) {
      let i = kt(e);
      if (typeof i == `string`) for (let e of Dt(i)) this._collectA1(n, t, r, e), this._collectTables(n, t, r, e);
    }
...
let jt = class extends e.Disposable {
  constructor(e, t, n) {
    super(), this._referenceDataService = e, this._overlayModel = t, this._formulaDataModel = n, s(this, `_inflight`, new Map()), s(this, `_latestCalculation`, new Map());
  }
  async prefetch(e, t, n = {}) {
    ...
    let a = [],
      ...
      l = Array.from({
        ...
        for (; c < i.length;) {
          let e = i[c++],
            n = this._hasWorkerLiveUnit(e, t) ? Ft(e) : await this._readWithInflight(e, r.timeoutMs);
  ...
  _hasWorkerLiveUnit(e, n) {
    let r = n.allUnitData ?? {};
    if (e.target.liveUnitId && e.target.liveUnitId !== e.syntheticUnitId && r[e.target.liveUnitId]) return !0;
    let i = Object.entries(n.unitNameMap ?? {}).filter(([t, n]) => t !== e.syntheticUnitId && !t.startsWith(`external:`) && !!r[t] && n.unitType === e.target.unitType),
      a = e.target.name.toLowerCase(),
      o = i.filter(([, e]) => e.name.toLowerCase() === a);
    if (o.length > 0) return o.length === 1;
    let s = (0, t.normalizeFormulaUnitName)(e.target.name);
    return i.filter(([, e]) => (0, t.normalizeFormulaUnitName)(e.name) === s).length === 1;
  }
...
jt = k([O(0, j), O(1, (0, e.Inject)(N)), O(2, (0, e.Inject)(t.FormulaDataModel))], jt);
function Mt(e) {
  let t = new Map();
  for (let n of e) {
...
let It = function (e) {
  return e.SHEET_RANGE = `sheet-range`, e.TABLE_COLUMN = `table-column`, e;
}({});
function Lt(e) {
  let {
      hostUnitId: n,
    ...
    a = r.unitId === n;
  if (i.kind === `sheet-range`) return a ? (0, t.serializeRangeWithSheet)(i.sheetName, i.range) : (0, t.serializeRangeWithSpreadsheet)(r.formulaQualifier, i.sheetName, i.range);
  let o = i.endColumnName && i.endColumnName !== i.columnName ? `[[${zt(i.columnName)}]:[${zt(i.endColumnName)}]]` : `[${zt(i.columnName)}]`,
    s = `${Rt(i.tableName)}${o}`;
...
function Vt(t) {
  ...
  let a = Ht(t.result),
    ...
    l = ((n = t.numberFormat) == null ? void 0 : n.pattern) ?? qt(a) ?? ((r = t.lastValue) == null ? void 0 : r.pattern) ?? e.DEFAULT_NUMBER_FORMAT,
    u = o == null ? void 0 : o.v,
    d = u == null || (i = e.numfmt.formatColor(l, u, {
      throws: !1
    })) == null ? void 0 : i.toString();
  return u == null ? {
    text: ``,
    pattern: l,
    cell: o,
...
function Gt(e) {
  if (e.v !== null && typeof e.v != `string` && typeof e.v != `number` && typeof e.v != `boolean`) return null;
  let t = qt(e);
  return {
    v: e.v ?? null,
    ...(e.t == null ? null : {
...
function Jt(e) {
  ...
  for (let r of e) {
    ...
    let e = ``;
    r.nodeType === t.sequenceNodeType.REFERENCE ? e = (0, t.deserializeRangeWithSheet)(r.token).unitId : r.nodeType === t.sequenceNodeType.TABLE && (e = (0, t.splitTableStructuredRef)(r.token).unitQualifier);
    let i = e.trim();
    i && n.set(d(i), i);
  }
  return Array.from(n.values());
...
function Yt(e) {
  ...
  for (let n of e.explicitReferences) {
    let e = d(n.qualifier),
      r = t.get(e);
    if (r && (r.sourceUnitId !== n.sourceUnitId || r.sourceUnitType !== n.sourceUnitType)) return {
      status: `ambiguous`,
      qualifier: n.qualifier
    };
    t.set(e, n);
...
exports.EXTERNAL_REFERENCE_SCHEMA_VERSION = 1, Object.defineProperty(exports, "ExternalCacheReferenceDataProvider", {
  enumerable: !0,
  get: function () {
    return A;
  }
...
}), exports.ExternalReferenceModel = D, Object.defineProperty(exports, "ExternalReferenceOverlayModel", {
  enumerable: !0,
  get: function () {
    return N;
  }
...
}), exports.FORMULA_REFERENCE_DATA_RPC_CHANNEL = he, Object.defineProperty(exports, "FormulaCacheEligibilityService", {
  enumerable: !0,
  get: function () {
    return vt;
  }
...
}), exports.FormulaLastValuePersistenceService = T, exports.FormulaReferenceDataProviderRegistry = ce, Object.defineProperty(exports, "FormulaReferenceDataRpcController", {
  enumerable: !0,
  get: function () {
    return I;
  }
}), exports.FormulaReferenceType = It, exports.HOST_EXTERNAL_REFERENCE_SCHEMA_VERSION = 1, exports.HostExternalReferenceModel = p, Object.defineProperty(exports, "IActiveDirtyManagerService", {
  enumerable: !0,
  get: function () {
    return t.IActiveDirtyManagerService;
  }
}), exports.IFormulaReferenceDataProviderRegistry = se, exports.IFormulaReferenceDataService = j, Object.defineProperty(exports, "ISuperTableService", {
  enumerable: !0,
  get: function () {
...
}), exports.PersistFormulaLastValuesCommand = ee, exports.RemoveHostExternalReferenceCommand = v, Object.defineProperty(exports, "RemoveSuperTableMutation", {
  enumerable: !0,
  get: function () {
    return t.RemoveSuperTableMutation;
  }
}), exports.SHEET_EXTERNAL_DATA_PLUGIN = te, Object.defineProperty(exports, "SetFormulaCalculationResultMutation", {
  enumerable: !0,
  get: function () {
...
}), exports.UNIVER_EXTERNAL_REFERENCE_PLUGIN = c, Object.defineProperty(exports, "UniverProFormulaEnginePlugin", {
  enumerable: !0,
  get: function () {
    return $;
  }
}), exports.UpsertHostExternalReferenceCommand = g, exports.UpsertHostExternalReferencesCommand = _, exports.buildFormulaReference = Lt, exports.buildUpsertHostExternalReferenceMutations = x, exports.collectFormulaExternalReferenceQualifiers = Jt, exports.createEmptyExternalReferenceResource = ne, exports.createExternalSyntheticUnitId = E, exports.createUnavailableReferenceDataResponse = le, exports.getFormulaResultCell = Ht, exports.getScalarFormulaResultCell = Ut, exports.normalizeHostExternalReferenceQualifier = d, Object.defineProperty(exports, "refactorFormulaUnitQualifier", {
  enumerable: !0,
  get: function () {
    return t.refactorFormulaUnitQualifier;
  }
}), exports.resolveFormulaResultPresentation = Vt, exports.resolveHostFormulaExternalReferences = Yt, exports.toFormulaLastValue = Gt;
