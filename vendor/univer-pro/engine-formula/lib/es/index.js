import {
  AbsoluteRefType as e,
  CellValueType as t,
  CommandType as n,
  DEFAULT_NUMBER_FORMAT as r,
  DependentOn as i,
  Disposable as a,
  ICommandService as o,
  IConfigService as s,
  IResourceManagerService as c,
  IUndoRedoService as l,
  IUniverInstanceService as u,
  Inject as d,
  ObjectMatrix as f,
  RANGE_TYPE as p,
  Rectangle as m,
  Tools as h,
  UniverInstanceType as g,
  createIdentifier as _,
  generateRandomId as v,
  numfmt as y,
  regexp as b,
  requestImmediateMacroTask as x,
  toDisposable as S,
  touchDependencies as C,
} from "@univerjs/core";
import {
  AstTreeBuilder as w,
  BaseReferenceObject as ee,
  CELL_INVERTED_INDEX_CACHE as te,
  CalculateFormulaService as ne,
  DEFAULT_CYCLE_REFERENCE_COUNT as T,
  DEFAULT_INTERVAL_COUNT as re,
  DependencyManagerBaseService as ie,
  ENGINE_FORMULA_PLUGIN_CONFIG_KEY as ae,
  ErrorType as E,
  FORMULA_REF_TO_ARRAY_CACHE as oe,
  FUNCTION_NAMES_DATE as se,
  FUNCTION_NAMES_LOOKUP as D,
  FUNCTION_NAMES_MATH as ce,
  FormulaCalculationSessionService as le,
  FormulaCalculationTriggerService as ue,
  FormulaDataModel as de,
  FormulaDataModel as fe,
  FormulaDependencyGenerator as pe,
  FormulaDependencyTree as me,
  FormulaDependencyTreeType as O,
  FormulaDependencyTreeVirtual as he,
  FormulaExecuteStageType as k,
  FormulaResultStatus as ge,
  FormulaUnitReferenceResolver as _e,
  IActiveDirtyManagerService as ve,
  IActiveDirtyManagerService as ye,
  ICalculateFormulaService as be,
  IDependencyManagerService as xe,
  IFormulaCurrentConfigService as Se,
  IFormulaDependencyGenerator as Ce,
  IFormulaExternalReferenceDataLoader as we,
  IFormulaRuntimeService as Te,
  IFormulaUnitReferenceResolver as Ee,
  ISuperTableService as De,
  ISuperTableService as Oe,
  Interpreter as ke,
  Lexer as Ae,
  LexerTreeBuilder as je,
  OtherFormulaMarkDirty as Me,
  RegisterOtherFormulaService as Ne,
  RemoveSuperTableMutation as Pe,
  SetFormulaCalculationResultMutation as Fe,
  SetFormulaCalculationStartMutation as Ie,
  SetFormulaCalculationStartMutation as Le,
  SetFormulaDataMutation as Re,
  SetSuperTableMutation as ze,
  SetTriggerFormulaCalculationStartMutation as Be,
  UniverFormulaEnginePlugin as Ve,
  deserializeRangeWithSheet as He,
  deserializeRangeWithSheetWithCache as Ue,
  generateAstNode as We,
  generateRandomDependencyTreeId as Ge,
  getAbsoluteRefTypeWitString as Ke,
  normalizeFormulaUnitName as A,
  refactorFormulaUnitQualifier as qe,
  sequenceNodeType as Je,
  serializeRangeWithSheet as Ye,
  serializeRangeWithSpreadsheet as Xe,
  splitTableStructuredRef as Ze,
} from "@univerjs/engine-formula";
import {
  IRPCChannelService as Qe,
  fromModule as $e,
  toModule as et,
} from "@univerjs/rpc";
...
const at = `UNIVER_EXTERNAL_REFERENCE_PLUGIN`,
  ot = 1;
function st() {
...
function lt(e) {
  return !e ||
    ...
    !(`sourceUnitType` in e)
    ? !1
    : typeof e.qualifier == `string` &&
        e.qualifier.trim().length > 0 &&
        !ct(e.qualifier) &&
        typeof e.sourceUnitId == `string` &&
        e.sourceUnitId.length > 0 &&
        (e.sourceUnitType === g.UNIVER_SHEET ||
          e.sourceUnitType === g.UNIVER_BASE);
}
var N = class extends a {
  constructor(...e) {
    (super(...e),
      j(this, `_resources`, new Map()),
      j(this, `_rawResources`, new Map()),
      j(this, `_loadErrors`, new Map()),
      j(this, `_revisions`, new Map()));
  }
  load(e, t) {
    return !t || typeof t != `object`
      ? (this._preserveInvalid(e, t, `invalid-resource`), !1)
      : !(`schemaVersion` in t) || t.schemaVersion !== 1
        ? (this._preserveInvalid(e, t, `unsupported-version`), !1)
        : ut(t)
          ? (this._resources.set(e, h.deepClone(t)),
  ...
  serialize(e) {
    ...
    return t
      ? h.deepClone(t)
      : this._rawResources.has(e)
        ? h.deepClone(this._rawResources.get(e))
        : st();
  }
  get(e) {
    let t = this._resources.get(e);
  ...
  getAll() {
    return Object.fromEntries(
      Array.from(this._resources.entries(), ([e, t]) => [e, h.deepClone(t)]),
    );
  }
  getLoadError(e) {
  ...
  resolveBinding(e, t) {
    var n;
    if (ct(t)) return { status: `missing` };
    let r = Object.entries(
        ((n = this._resources.get(e)) == null ? void 0 : n.references) ?? {},
      ),
      i = t.toLowerCase(),
      a = r.filter(([, e]) => e.qualifier.toLowerCase() === i),
      o = a.length > 0 ? a : r.filter(([, e]) => M(e.qualifier) === M(t));
    if (o.length === 0) return { status: `missing` };
    if (o.length > 1) return { status: `ambiguous` };
    let [s, c] = o[0];
    return { status: `resolved`, referenceId: s, reference: h.deepClone(c) };
  }
  remove(e) {
  ...
  _preserveInvalid(e, t, n) {
    (this._resources.delete(e),
      this._rawResources.set(e, h.deepClone(t)),
      this._loadErrors.set(e, n),
      this._bumpRevision(e));
  }
  _bumpRevision(e) {
...
const P = {
  ...
  pt = {
    ...
    type: n.COMMAND,
    handler: (e, t) => {
      if (!(t != null && t.unitId) || (!t.referenceId && !t.qualifier))
        return !1;
      let n = e.get(N);
...
function ht(e, t, n) {
  ...
  let r = gt(e, t, n);
  return r
    ? !r.redoMutation || !r.undoMutation
      ? !0
      : e.get(o).syncExecuteCommand(r.redoMutation.id, r.redoMutation.params)
        ? (e
            .get(l)
            .pushUndoRedo({
              unitID: t,
...
function gt(e, t, n) {
  ...
  return s
    ? {
        redoMutation: { id: P.id, params: { unitId: t, resource: o } },
        undoMutation: { id: P.id, params: { unitId: t, resource: a } },
      }
    : {};
}
function _t(e, t) {
...
function vt(e, t, n, r) {
  ...
  if (
    i.status === `resolved` &&
    i.reference.sourceUnitId === r.sourceUnitId &&
    i.reference.sourceUnitType === r.sourceUnitType &&
    i.reference.qualifier === r.qualifier
  )
    return !1;
...
function yt(e, t, n, r) {
  return e.get(o).syncExecuteCommand(P.id, { unitId: t, resource: r })
    ? (e
        .get(l)
        .pushUndoRedo({
          unitID: t,
          undoMutations: [{ id: P.id, params: { unitId: t, resource: n } }],
          redoMutations: [{ id: P.id, params: { unitId: t, resource: r } }],
        }),
      !0)
    : !1;
}
var bt = class extends a {
  constructor(...e) {
    (super(...e), j(this, `_providers`, new Set()));
  }
  registerProvider(e) {
    return (this._providers.add(e), S(() => this._providers.delete(e)));
  }
  collectMutations(e) {
...
const xt = {
    ...
    type: n.COMMAND,
    handler: (e, t) => {
      let n = t == null ? void 0 : t.sessionId;
      if (!Number.isInteger(n) || n == null || n < 1) return !1;
      let r = e.get(o),
        i = e.get(bt).collectMutations(n),
        a = !0;
      for (let e of i) r.syncExecuteCommand(e.id, e.params) || (a = !1);
      return a;
    },
  },
  St = `SHEET_EXTERNAL_DATA_PLUGIN`,
  Ct = 1;
function wt() {
...
var I = class extends a {
  ...
  load(e, t) {
    ...
    return n.schemaVersion === 1
      ? !Array.isArray(n.links) || !n.links.every(Tt)
...
let Et = class {
  constructor(e) {
    ((this._externalReferenceModel = e),
      j(this, `id`, `ooxml-external-cache`),
      j(this, `priority`, -100));
  }
  canRead(e) {
    var t;
    ...
    for (let t of e.ranges) {
      ...
      i.push({
        ...
        cells: e.cells.map((e) => ({
          row: e.row,
          column: e.column,
          cell: { v: e.value, t: e.valueType ?? kt(e.value) },
        })),
      });
    }
    if (i.length !== 0)
...
const z = _(`univer-pro.formula.reference-data-service`),
  At = _(`univer-pro.formula.reference-data-provider-registry`);
var jt = class extends a {
  constructor(...e) {
    (super(...e), j(this, `_providers`, new Map()));
  }
  register(e) {
    return (
...
let B = class extends a {
  constructor(e, t) {
    (super(),
      ...
      j(this, `_units`, new Map()),
      j(this, `_pendingDirtyRanges`, []));
  }
  apply(e, t) {
  ...
  getCellState(e, t, n, r) {
    ...
    return !o || !o.coverage.some((e) => Pt(e, n, r))
      ? { covered: !1, value: E.NA }
      : {
          covered: !0,
          value:
            ((a = o.cellData.getValue(n, r)) == null ? void 0 : a.v) ?? null,
        };
  }
  isRangeCovered(e, t, n) {
    ...
    for (let e = n.startRow; e <= n.endRow; e++)
      for (let t = n.startColumn; t <= n.endColumn; t++)
        if (!i.coverage.some((n) => Pt(n, e, t))) return !1;
    return !0;
  }
  enforceLimits(e, t) {
    let n = 0;
    for (; this._coveredCellCount() > e || this._estimatedBytes() > t;) {
      ...
      for (let t = e.range.startRow; t <= e.range.endRow; t++)
        for (let n = e.range.startColumn; n <= e.range.endColumn; n++)
          e.sheet.coverage.some((e) => Pt(e, t, n)) ||
  ...
  _mergeSheet(e, t) {
    ...
    ((n.name = t.name),
      (n.rowCount = Math.max(n.rowCount, t.rowCount)),
      (n.columnCount = Math.max(n.columnCount, t.columnCount)),
      n.coverage.push(...t.coverage));
    for (let { row: e, column: r, cell: i } of t.cells)
      n.cellData.setValue(e, r, i);
  ...
  _writeCoverageMisses(e, n, r, i) {
    for (let a of e.ranges)
      if (
        !(!a.range || (a.sheetId && a.sheetId !== r.sheetId)) &&
        !(a.sheetName && a.sheetName.toLowerCase() !== r.name.toLowerCase())
      )
        for (let e = a.range.startRow; e <= a.range.endRow; e++)
          for (let o = a.range.startColumn; o <= a.range.endColumn; o++)
            (n.error || !i.some((t) => Pt(t, e, o))) &&
              r.cellData.setValue(e, o, { v: E.NA, t: t.STRING });
  }
...
let zt = class extends a {
  constructor(e, t, n) {
    ...
    for (let e of [g.UNIVER_SHEET, g.UNIVER_BASE])
      (this._univerInstanceService.getAllUnitsForType(e).forEach((e) => {
        ...
        this.disposeWithMe(
          this._univerInstanceService
            ...
            .subscribe((e) => {
              ...
              (t && n.invalidateSourceMetadata(t),
      ...
      e.name$.subscribe((e) => {
        ...
        if (i !== e) {
          ...
          for (let a of t.renameLiveTarget(r, i, e))
            n.invalidateSyntheticUnit(F(a.hostUnitId, a.slot));
        }
      }),
    );
  }
...
let Bt = class extends a {
  constructor(e, t, n) {
    (super(),
      this.disposeWithMe(
        e.registerPluginResource({
          pluginName: St,
          businesses: [g.UNIVER_SHEET, g.UNIVER_BASE],
          toJson: (e) => JSON.stringify(t.serialize(e)),
          parseJson: (e) => JSON.parse(e),
          onLoad: (e, r) => (n.invalidateHost(e), t.load(e, r)),
          onUnLoad: (e) => {
            (n.invalidateHost(e), t.remove(e));
          },
        }),
      ));
  }
...
const Vt = `univer-pro.formula.reference-data`;
let Ht = class extends a {
  constructor(e, t) {
    (super(), e.registerChannel(Vt, $e(t)));
  }
};
...
let Gt = class extends a {
  constructor(e, t, n) {
    (super(),
      ...
      j(this, `_lastPersistedSessionId`, 0),
      this.disposeWithMe(this._commandService.registerCommand(xt)),
      this.disposeWithMe(
        this._sessionService.resultApplied$.subscribe(() => {
          ...
          e < 1 ||
            ...
            this._commandService.syncExecuteCommand(xt.id, { sessionId: e }));
        }),
      ));
  }
};
        ...
        getDirtyData: (e) => {
          ...
          return {
            ...
            dirtyUnitOtherFormulaMap:
              Object.keys(a).length > 0 ? { [r]: a } : void 0,
            clearDependencyTreeCache:
              Object.keys(o).length > 0 ? { [r]: o } : void 0,
          };
        },
      }),
      this.disposeWithMe(
...
function qt(e, t) {
  ...
  return r
    ? Object.values(r.getSnapshot().tables).map((t) => {
        var n;
        return {
          unitId: e,
          sheetId: t.id,
          range: {
            ...
            endRow: Math.max(
              0,
              (((n = t.recordOrder) == null ? void 0 : n.length) ?? 0) - 1,
            ),
      ...
      this.disposeWithMe(
        e.onCommandExecuted((r, i) => {
          ...
          Object.keys(s).length > 0 &&
            queueMicrotask(() => e.executeCommand(Me.id, s, { onlyLocal: !0 }));
        }),
      ));
  }
};
...
function Sn(e) {
  ...
  return (
    (t =
      n.length > 0
        ? b.createRegExpFromSafeFragment(
            `(^|[^A-Za-z0-9_])${b.or(...n)}(\\s*\\[|$|[^A-Za-z0-9_])`,
            `i`,
          )
        : null),
    bn.set(e, t),
...
var Dn = class extends pe {
  constructor(...e) {
    (super(...e),
      j(this, `_featureFormulaDirtyDependencies`, []),
      j(this, `_calculationTreeCache`, new Map()),
      j(this, `_calculationNodeDataCache`, new Map()),
      j(this, `_forcedRecalculationNodeIndices`, new Set()),
      j(this, `_sharedFormulaCompressionMetrics`, $t()),
      j(this, `_cacheDependencyTreeModelRangeList`, !1));
  }
  dispose() {
    (super.dispose(),
      ...
      (this._sharedFormulaCompressionMetrics = $t()));
  }
  ...
  async generatePro(e = !1) {
    ((this._featureFormulaDirtyDependencies.length = 0),
      En(`dependency.updateRangeFlatten`, () => this._updateRangeFlatten()));
    ...
    ((this._sharedFormulaCompressionMetrics = n.metrics),
      W(`dependency.formulaNodes`, n.metrics.totalFormulaNodes),
      W(`dependency.sharedFormulaGroups`, n.groups.length));
    ...
    try {
      await Tn(`dependency.generateTreeList`, () =>
        this._generateTreeListPro(t, r, o, n),
      );
    } finally {
      this._cacheDependencyTreeModelRangeList = !1;
    }
    (await Tn(`dependency.markDirtyDependencies`, () =>
      this._markDirtyDependenciesPro(),
    ),
      (this._featureFormulaDirtyDependencies.length = 0),
      En(`dependency.clearArrayObjectCache`, () =>
        this._runtimeService.clearArrayObjectCache(),
      ));
    let s = En(`dependency.getCalculationOrder`, () =>
  ...
  _getFeatureFormulaTreePro(e, t, n) {
    let { unitId: r, subUnitId: i, dependencyRanges: a, getDirtyData: o } = n,
    ...
    ((s.featureDirtyRanges = l),
      (s.featureId = e),
      (s.type = O.FEATURE_FORMULA));
    let u = this._dependencyManagerService.getFeatureFormulaDependencyPro(
        n.unitId,
        n.subUnitId,
        e,
      ),
    ...
    return (
      u === void 0 &&
        ((u = this._dependencyManagerService.addFeatureFormulaDependencyPro(
          r,
          i,
          e,
          s,
      ...
      this._cacheCalculationTree(u, s),
      this._releaseDependencyTree(s),
      d
    );
  }
      ...
      for (let e of r) {
        ...
        for (let t of s) {
          let i = this._dependencyManagerService.hasOtherFormulaDataMainData(t),
            ...
            l = !1;
          i && (l = !0);
          let { firstRow: u, firstColumn: d } = this._getFirstCellOfRange(c),
            f = new me(Ge(this._dependencyManagerService));
          for (let r = 0; r < c.length; r++) {
            let i = c[r],
              { startRow: p, startColumn: m } = i,
              { endRow: h, endColumn: g } = i;
              ...
              for (let i = m; i <= g; i++) {
                ...
                if (a === 0 && o === 0) {
                  ((f.formula = s),
                    ...
                    (f.subUnitId = e),
                    (f.formulaId = t),
                    (f.type = O.OTHER_FORMULA),
                    (f.isCache = l),
                    f.node || (await this._initialAstNodeAndRanges(f)));
                  ...
                  (c === void 0
                    ...
                    this._cacheCalculationTree(c, f),
                    this._syncForcedRecalculationNodeIndex(c, f));
                  continue;
                }
                let p = new he();
                ((p.treeId = Ge(this._dependencyManagerService)),
                  (p.refTree = f),
                  (p.refOffsetX = a),
                  (p.refOffsetY = o),
                  (p.isCache = l),
                  (p.type = O.OTHER_FORMULA));
                ...
                (c === void 0
                  ...
                  this._cacheCalculationTree(c, p),
                  this._syncForcedRecalculationNodeIndex(c, p),
      ...
      for (let t of s) {
        ...
        for (let e of p) {
          ...
          for (let e of h) {
            ...
            (o || ee) &&
              (W(`dependency.calculationTreeCache.normal`),
            ...
            if (
              ...
              if (o) {
                let e = a.getFormulaDependencyPro(r, t, i, d),
                  ...
                  { x: o = 0, y: c = 0 } = f;
                e !== void 0 &&
                  (W(`dependency.calculationTreeCache.compressedVirtual`),
        ...
        (wn(`dependency.registerFormulas.compressedGroups`, U() - g),
  ...
  _convertSharedFormulaPatterns(e) {
    ...
    for (let a = 0; a < e.rangeList.length; a++) {
      ...
      let s = this._normalizeSharedFormulaRange(o.range),
        c;
      c =
        s.startRow === s.endRow && s.startColumn === s.endColumn
          ? {
              kind: `cell`,
              unitId: o.unitId,
              sheetId: o.sheetId,
  ...
  _initializeAstNode(e) {
    ...
    return (
      (e.node = t),
      (e.addressFunctionNodes = this._getAddressFunctionNodeList(t)),
      t
    );
  }
  ...
  _tryInitialStaticReferenceRanges(e) {
    ...
    if (
      ...
      return (
        H(`static.skip.unsupportedSyntax`),
        Cn(`unsupportedSyntax`, r),
        !1
      );
    let a = this._replaceDoubleQuotedStrings(i),
      o = this._replaceQuotedSheetNames(a);
    if (xn(o) || !this._hasOnlyStaticReferenceSafeIdentifiers(o))
      return (H(`static.skip.identifier`), Cn(`identifier`, r), !1);
    let s = [],
      c =
        ((t = (n = this._currentConfigService).getSheetNameMap) == null
          ? void 0
          : t.call(n)) ?? {},
    ...
    if (l) {
      ...
      if (t == null) {
        if (!this._hasOnlyStaticOffsetBases(e, c, a))
          return (H(`static.skip.offset`), Cn(`offset`, r), !1);
    ...
    for (; (f = gn.exec(d)) != null;) {
      if (!this._isStaticReferenceTokenBoundarySafe(d, f.index, gn.lastIndex))
        continue;
      let t = this._tryCreateStaticColumnReferenceRange(e, c, f);
      if (t == null)
        return (H(`static.skip.referenceParse`), Cn(`referenceParse`, r), !1);
      s.push(t);
    }
    V.lastIndex = 0;
    let p;
    for (; (p = V.exec(d)) != null;) {
      if (!this._isStaticReferenceTokenBoundarySafe(d, p.index, V.lastIndex))
        continue;
    ...
    return (
      u || (e.addressFunctionNodes = []),
      e.rangeList.push(...this._dedupeStaticReferenceRanges(s)),
      !0
    );
  }
  ...
  _tryCreateStaticReferenceRange(e, t, n) {
    ...
    if (!(
      ...
      c < 0 ||
      u < 0 ||
      Math.max(c, u) >= p.rowCount ||
      Math.max(s, l) >= p.columnCount
    ))
      return {
        unitId: e.unitId,
        sheetId: o,
  ...
  _tryCreateStaticColumnReferenceRange(e, t, n) {
    ...
    if (!(Math.max(s, c) >= u.columnCount || u.rowCount <= 0))
      return {
        unitId: e.unitId,
        sheetId: o,
        range: {
  ...
  _hasOnlyStaticOffsetBases(e, t, n) {
    ...
    return (
      r.length > 0 &&
      r.every((n) => this._tryParseSingleStaticReference(e, t, n[0]) != null)
    );
  }
  ...
  _tryParseSingleStaticReference(e, t, n) {
    ...
    V.lastIndex = 0;
    let i = V.exec(r);
    if (i != null && i.index === 0 && V.lastIndex === r.length)
  ...
  _createFDtree(e, t, n, r, i, a) {
    ...
    return (
      ...
      (s.row = n),
      (s.column = r),
      (s.rowCount = c.rowCount),
      (s.columnCount = c.columnCount),
      s
    );
  }
};
let On = class extends ne {
  constructor(e, t, n, r, i, a, o, s) {
    (super(e, t, n, r, i, a, o),
      (this._externalReferenceDataLoader = s),
      j(this, `_dynamicRuntimeRanges`, void 0),
      j(this, `_runtimeExternalDataLoaded`, !1));
  }
  async execute(e) {
    (this._runtimeService.setFormulaExecuteStage(k.START),
    ...
    ((this._isCalculateTreeModel = e.isCalculateTreeModel || !1),
      this._executeLock.acquire(`FORMULA_EXECUTION_LOCK`, async () => {
        (await this._executeStep(t),
          this._runtimeService.setFormulaExecuteStage(k.CALCULATION_COMPLETED),
          this._executionInProgressListener$.next(
            this._runtimeService.getRuntimeState(),
          ),
  ...
  async _executeStep(e = T) {
    ...
    if (t == null) return;
    let { arrayFormulaRange: n } = t,
      { dirtyRanges: r, excludedCell: i } =
        this._getArrayFormulaDirtyRangeAndExcludedRange(n, {});
    return r == null || r.length === 0
      ? !0
      : (oe.clear(),
        this._currentConfigService.loadDirtyRangesAndExcludedCell(r, i),
  ...
  async _apply(e = !1, t = T) {
    (this._setFormulaExecuteStage(
      e,
      k.START_DEPENDENCY,
      k.START_DEPENDENCY_ARRAY_FORMULA,
    ),
      this._executionInProgressListener$.next(
        this._runtimeService.getRuntimeState(),
      ));
    ...
    try {
      let { calculationOrderResult: n, dependencyTree: a } =
          await i.generatePro(this._isCalculateTreeModel),
        o = this._getCalculationPlanTreeCount(n, a, t);
      (n.hasCycle && this._runtimeService.enableCycleDependency(),
        this._setFormulaExecuteStage(
          e,
          k.START_CALCULATION,
          k.START_CALCULATION_ARRAY_FORMULA,
        ),
        this._setTotalFormulasToCalculate(e, o),
        this._executionInProgressListener$.next(
          this._runtimeService.getRuntimeState(),
        ));
      let s = [],
          ...
          (await this._forEachCalculationPlanTree(
            ...
            async (n, a, o, f) => {
              if (
                ...
                await this._waitForExecutionSlot(d, r, e, n, s))
              )
                return ((u = !0), !1);
              if (f) {
              ...
              ((this._runtimeExternalDataLoaded = !1),
                (m ||= g),
                h &&
                  (g || this._shouldRescheduleAfterDynamicChange(i, a, l)) &&
                  (p = !0),
                l.has(a) || (l.add(a), c.push(a)),
                d++);
            },
          ),
          (n.calculationForest.length = 0),
          u || !p)
        )
          break;
        if ((f++, f > 8)) throw Error(`Dynamic dependency did not stabilize`);
        (m && oe.clear(),
          i.clearCachedCalculationNodeData(),
          (n = i.getCalculationOrder()),
          n.hasCycle && this._runtimeService.enableCycleDependency(),
          (o = this._getCalculationPlanTreeCount(n, a, t)),
          this._setTotalFormulasToCalculate(e, o));
      }
      ...
      return (
        c.length > 0 && i.clearCalculatedDirty(c),
        u
          ? void 0
          : (o > 0 || c.length > 0
  ...
  _collectAddressFunctionRuntimeReferencesInternal(e, t) {
    ...
    for (let n of e.getChildren())
      this._collectAddressFunctionRuntimeReferencesInternal(n, t);
  }
      ...
      ? (await new Promise((e) => {
        ...
        n
          ? (this._runtimeService.setFormulaExecuteStage(
              k.CURRENTLY_CALCULATING_ARRAY_FORMULA,
            ),
            this._runtimeService.setCompletedArrayFormulasCount(e + 1))
          : (this._runtimeService.setFormulaExecuteStage(
              k.CURRENTLY_CALCULATING,
            ),
            this._runtimeService.setCompletedFormulasCount(e + 1)),
        this._executionInProgressListener$.next(
          this._runtimeService.getRuntimeState(),
        ),
        this._runtimeService.isStopExecution() ||
        (r.formula == null && r.getDirtyData == null)
          ? (this._runtimeService.setFormulaExecuteStage(k.IDLE),
  ...
  async _calculateDependencyTree(e, t, n, r = T) {
    ...
    if (
      ...
      i != null && e.featureId != null)
    ) {
      let t = e.featureId,
        { runtimeCellData: n, dirtyRanges: r } = i(
          this._currentConfigService.getDirtyData(),
          this._runtimeService.getAllRuntimeData(),
        );
      return (
    ...
    try {
      ...
      try {
        s = this._interpreter.checkAsyncNode(a.node)
          ? await this._interpreter.executeAsync(a)
          : this._interpreter.execute(a);
      } finally {
        i();
      }
      let { dynamicChanged: c, hasSelfReference: l } =
        await this._refreshDynamicDepsAfterCalculate(n, t, e, o);
      return (
        (!l || r > T) &&
          (e.formulaId == null
            ? this._runtimeService.setRuntimeData(s)
...
var kn = class {
  constructor(e, t) {
    (j(this, `maxRows`, void 0),
      j(this, `maxCols`, void 0),
      j(this, `sheetSize`, void 0),
      j(this, `_sheetKeyById`, new Map()),
      j(this, `_sheetIdByKey`, []),
      (this.maxRows = e),
      (this.maxCols = t),
      (this.sheetSize = e * t));
  }
...
var Hn = class {
    constructor(e, t) {
      ((this._codec = e),
        ...
        j(this, `_rowBuckets`, new Map()),
        j(this, `_colBuckets`, new Map()));
    }
    addFormulaCell(e, t) {
    ...
    addFormulaCellByPosition(e, t, n, r) {
      (J(this._rowBuckets, this._codec.encodeRowBySheetKey(e, t), r),
        J(this._colBuckets, this._codec.encodeColBySheetKey(e, n), r));
    }
  ...
  Un = class {
    constructor(e, t) {
      ((this._codec = e),
        ...
        j(this, `_rowCells`, new Map()),
        j(this, `_colCells`, new Map()));
    }
    add(e) {
      let t = this._codec.decodeCell(e);
      (J(this._rowCells, this._codec.encodeRow(t.unitId, t.sheetId, t.row), e),
        J(
          this._colCells,
    ...
    remove(e) {
      let t = this._codec.decodeCell(e);
      (Y(this._rowCells, this._codec.encodeRow(t.unitId, t.sheetId, t.row), e),
        Y(
          this._colCells,
          this._codec.encodeCol(t.unitId, t.sheetId, t.col),
          e,
  ...
  Wn = class {
    constructor(e, t, n) {
      ((this._codec = e),
        ...
        j(this, `_wholeSheet`, new Map()),
        j(this, `_wholeCol`, new Map()),
        j(this, `_wholeRow`, new Map()),
        j(this, `_rowBuckets`, new Map()),
        j(this, `_colBuckets`, new Map()),
        j(this, `_largeRangeIds`, []),
        j(this, `_sheetArr`, void 0),
        j(this, `_startRowArr`, void 0),
        j(this, `_endRowArr`, void 0),
        j(this, `_startColArr`, void 0),
        j(this, `_endColArr`, void 0),
        j(this, `_nodeArr`, void 0),
        j(this, `_kindArr`, void 0),
        j(this, `_activeArr`, void 0),
        j(this, `_rangeSeenEpochArr`, void 0),
        j(this, `_rangeEpoch`, 1),
        j(this, `_nextRangeId`, 0),
        j(this, `_freeRangeIds`, []),
        j(this, `_nodeToRangeIds`, new Map()),
        j(this, `_nodeToWholeSheetKeys`, new Map()),
        j(this, `_nodeToWholeColKeys`, new Map()),
        j(this, `_nodeToWholeRowKeys`, new Map()));
      let r = Math.max(16, t);
    ...
    addRange(e, t) {
      ...
      if ((this._setRangeMeta(l, e, n), c > this._maxIndexedSpan))
        ...
        this._kindArr[l] = 1;
        for (let e = n.range.startRow; e <= n.range.endRow; e++)
          J(this._rowBuckets, this._codec.encodeRowBySheetKey(r, e), l);
      } else {
        this._kindArr[l] = 2;
        for (let e = n.range.startColumn; e <= n.range.endColumn; e++)
          J(this._colBuckets, this._codec.encodeColBySheetKey(r, e), l);
      }
    ...
    forEachPoint(e, t, n, r, i) {
      ...
      (X(this._wholeSheet.get(a), i),
        X(this._wholeCol.get(this._codec.encodeColBySheetKey(a, r)), i),
        X(this._wholeRow.get(this._codec.encodeRowBySheetKey(a, n)), i));
    ...
    _ensureRangeCapacity(e) {
      ((this._sheetArr = Q(this._sheetArr, e)),
        (this._startRowArr = Q(this._startRowArr, e)),
        (this._endRowArr = Q(this._endRowArr, e)),
        (this._startColArr = Q(this._startColArr, e)),
        (this._endColArr = Q(this._endColArr, e)),
        (this._nodeArr = Q(this._nodeArr, e)),
        (this._kindArr = Z(this._kindArr, e)),
        (this._activeArr = Z(this._activeArr, e)),
        (this._rangeSeenEpochArr = Q(this._rangeSeenEpochArr, e)));
    }
    _setRangeMeta(e, t, n) {
    ...
    _removeRangeId(e) {
      ...
      if (t === 1)
        for (let t = this._startRowArr[e]; t <= this._endRowArr[e]; t++)
          Y(this._rowBuckets, this._codec.encodeRowBySheetKey(n, t), e);
      else if (t === 2)
        for (let t = this._startColArr[e]; t <= this._endColArr[e]; t++)
          Y(this._colBuckets, this._codec.encodeColBySheetKey(n, t), e);
      else t === 3 && Nn(this._largeRangeIds, e);
      ((this._activeArr[e] = 0),
        (this._kindArr[e] = 0),
    ...
    _scanWholeCols(e, t, n) {
      if (q(e) <= this._wholeCol.size) {
        for (let r = e.range.startColumn; r <= e.range.endColumn; r++)
          X(this._wholeCol.get(this._codec.encodeColBySheetKey(t, r)), n);
        return;
      }
    ...
    _scanWholeRows(e, t, n) {
      if (K(e) <= this._wholeRow.size) {
        for (let r = e.range.startRow; r <= e.range.endRow; r++)
          X(this._wholeRow.get(this._codec.encodeRowBySheetKey(t, r)), n);
        return;
      }
  ...
  Gn = class {
    constructor(e) {
      (j(this, `codec`, void 0),
        j(this, `_maxIndexedSpan`, void 0),
        j(this, `_pointScanCellLimit`, void 0),
        j(this, `_initialNodeCapacity`, void 0),
        j(this, `_initialRangeCapacity`, void 0),
        j(this, `directDeps`, void 0),
        j(this, `nodeDeps`, void 0),
        j(this, `rangeIndex`, void 0),
        j(this, `cellFormulaToIndex`, void 0),
        j(this, `otherFormulaToIndex`, void 0),
        j(this, `featureCalculationToIndex`, void 0),
        j(this, `indexToNodeId`, void 0),
        j(this, `dirty`, void 0),
        j(this, `inQueue`, void 0),
        j(this, `_indexToNodeType`, void 0),
        j(this, `_cellPrecedents`, void 0),
        j(this, `_rangePrecedents`, void 0),
        j(this, `_nodePrecedents`, void 0),
        j(this, `_dynamicDeps`, void 0),
        j(this, `_dynamicSignature`, void 0),
        j(this, `_runtimeDirectDeps`, void 0),
        j(this, `_runtimeNodeDeps`, void 0),
        j(this, `_runtimeRangeIndex`, void 0),
        j(this, `_runtimeCellPrecedents`, void 0),
        j(this, `_runtimeRangePrecedents`, void 0),
        j(this, `_runtimeNodePrecedents`, void 0),
        j(this, `_activeNode`, void 0),
        j(this, `_seenNodeEpoch`, void 0),
        j(this, `_visitNodeEpoch`, void 0),
        j(this, `_edgeSeenEpoch`, void 0),
        j(this, `_tarjanSeenEpoch`, void 0),
        j(this, `_tarjanIndexArr`, void 0),
        j(this, `_tarjanLowArr`, void 0),
        j(this, `_tarjanOnStack`, void 0),
        j(this, `_emitEpoch`, 1),
        j(this, `_visitEpoch`, 1),
        j(this, `_edgeEpoch`, 1),
        j(this, `_tarjanEpoch`, 1),
        j(this, `_propQueue`, []),
        j(this, `_dirtyList`, []),
        j(this, `_activeNodeCount`, 0),
        j(this, `_dirtyNodeCount`, 0),
        j(this, `_directPointIndex`, void 0),
        j(this, `_runtimeDirectPointIndex`, void 0),
        j(this, `_formulaCellIndex`, void 0),
        j(this, `_sharedFormulaGroups`, void 0),
        j(this, `_sharedFormulaGroupIndexById`, void 0),
        j(this, `_sharedFormulaMembershipByNode`, void 0),
        j(this, `_sharedFormulaSourceEntries`, void 0),
        j(this, `_sharedFormulaSourceRangeIndex`, void 0),
        ...
        (this.codec = new kn(e.maxRows, e.maxCols)),
        this.reset());
    }
    reset() {
      (this.codec.reset(),
        ...
        (this._runtimeRangeIndex = new Wn(
          this.codec,
          this._initialRangeCapacity,
          this._maxIndexedSpan,
        )),
        ...
        (this._directPointIndex = new Un(this.codec, this._pointScanCellLimit)),
        (this._runtimeDirectPointIndex = new Un(
          this.codec,
          this._pointScanCellLimit,
        )),
        (this._formulaCellIndex = new Hn(this.codec, this.indexToNodeId)),
        ...
        (this._sharedFormulaSourceRangeIndex = new Wn(
          this.codec,
          this._initialRangeCapacity,
          this._maxIndexedSpan,
        )));
    ...
    _ensureNodeCapacity(e) {
      ...
      ((this._indexToNodeType = Z(this._indexToNodeType, e)),
        (this.dirty = Z(this.dirty, e)),
        (this.inQueue = Z(this.inQueue, e)),
        (this._activeNode = Z(this._activeNode, e)),
        (this._seenNodeEpoch = Q(this._seenNodeEpoch, e)),
        (this._visitNodeEpoch = Q(this._visitNodeEpoch, e)),
        (this._edgeSeenEpoch = Q(this._edgeSeenEpoch, e)),
        (this._tarjanSeenEpoch = Q(this._tarjanSeenEpoch, e)),
        (this._tarjanIndexArr = Q(this._tarjanIndexArr, e)),
        (this._tarjanLowArr = Q(this._tarjanLowArr, e)),
        (this._tarjanOnStack = Z(this._tarjanOnStack, e)),
    ...
    _collectDynamicResolveResult(e, t) {
      (t.traceCells && e.cells.push(...t.traceCells),
        ...
        t.nodes && e.nodes.push(...this._resolveExplicitNodeDeps(Rn(t.nodes))));
    }
    ...
    _addRuntimeDirectEdge(e, t) {
      ...
      (n === void 0 && this._runtimeDirectPointIndex.add(e),
        this._runtimeDirectDeps.set(e, Pn(n, t)));
    }
      ...
      let p = [],
        m = (m) => {
          ...
          (g >= 0 && this._unionCalculationForestComponents(l, u, g, t),
            this._indexToNodeType[e] === 1 &&
              jn(m, this.codec.decodeCell(this.indexToNodeId[e])) &&
              (f[t] = 1));
        },
    ...
    constructor(...e) {
      (super(...e),
        j(
          ...
          new Gn({ maxRows: 1048576, maxCols: 16384 }),
        ));
    }
    reset() {
...
let qn = class extends _e {
  ...
  resolve(e) {
    if (/^[1-9]\d*$/.test(e.qualifier)) {
      let t = this._externalReferenceModel.resolveBinding(
        e.hostUnitId,
        e.qualifier,
      );
      if (t.status !== `resolved`) return E.REF;
      let { link: n } = t;
      if (e.referenceKind === `a1` && n.target.unitType === g.UNIVER_BASE)
        return E.REF;
      if (n.target.liveUnitId) {
        let t = super.resolve({ ...e, qualifier: n.target.liveUnitId });
        if (typeof t != `string`) return t;
      }
      let r = super.resolve({ ...e, qualifier: n.target.name });
      return typeof r != `string` &&
        (r.unitType == null || r.unitType === n.target.unitType)
        ? r
        : {
    ...
    let t = this._currentConfigService.getExternalReferences()[e.hostUnitId],
      ...
      a =
        i.length > 0
          ? i
          : n.filter(([, t]) => A(t.qualifier) === A(e.qualifier));
    if (a.length > 1) return E.REF;
    if (a.length === 1) {
      let [t, n] = a[0];
      return e.referenceKind === `a1` && n.sourceUnitType === g.UNIVER_BASE
        ? E.REF
        : {
...
const Jn = new Set([se.NOW, se.TODAY, ce.RAND, ce.RANDARRAY, ce.RANDBETWEEN]);
let Yn = class {
  constructor(e) {
    this._lexerTreeBuilder = e;
  }
  assess(e, t) {
    if ((t == null ? void 0 : t.status) !== ge.SUCCESS)
      return { eligible: !1, reason: `not-successful` };
    let n = e.startsWith(`=`) ? e.slice(1) : e;
    return (this._lexerTreeBuilder.sequenceNodesBuilder(n) ?? []).some(
      (e) =>
        typeof e != `string` &&
        e.nodeType === Je.FUNCTION &&
        Jn.has(e.token.toUpperCase()),
    )
...
let Xn = class {
  constructor(e, t, n, r) {
    ((this._currentConfigService = e),
      ...
      j(this, `_requestCounter`, 0),
      j(this, `_generation`, -1),
      j(this, `_inflight`, new Map()),
      j(this, `_completed`, new Set()));
  }
  async load(e) {
    let t = this._currentConfigService.getCalculationGeneration();
    t !== this._generation &&
      ((this._generation = t), this._inflight.clear(), this._completed.clear());
    let n = this._createRequest(e, t);
    if (!n) return E.REF;
    let r = [t, n.hostUnitId, n.syntheticUnitId, e.referenceKind, e.token].join(
      `\0`,
    );
    if (this._completed.has(r)) return;
    let i = this._inflight.get(r);
    if (i) return i;
    let a = this._loadRequest(n, e.resolution, t)
      .then((e) => (e ?? this._completed.add(r), e))
      .finally(() => this._inflight.delete(r));
  ...
  _resolveRuntimeRange(e) {
    ...
    let a =
      (t = this._excelExternalReferenceModel.get(e.hostUnitId)) == null
        ? void 0
        : t.links.find((t) => F(e.hostUnitId, t.slot) === e.unitId);
    if (a)
      return {
        resolution: {
          unitId: e.unitId,
  ...
  _createA1RangeRequest(e) {
    try {
      let { sheetName: t, range: n } = Ue(e);
      return !t ||
        !Number.isFinite(n.startRow) ||
        !Number.isFinite(n.endRow) ||
        !Number.isFinite(n.startColumn) ||
        !Number.isFinite(n.endColumn)
        ? void 0
        : { sheetName: t, range: n };
    } catch {}
  }
  async _loadRequest(e, t, n) {
    ...
    if (
      n !== this._currentConfigService.getCalculationGeneration() ||
      r.calculationId !== e.calculationId
    )
      return E.NA;
  ...
  _materializeSheet(e, t) {
    ...
    for (let { row: e, column: n, cell: i } of t.cells)
      r.setValue(e, n, { ...r.getValue(e, n), ...i });
    e[t.sheetId] = {
      cellData: r,
      rowCount: Math.max((n == null ? void 0 : n.rowCount) ?? 0, t.rowCount),
      columnCount: Math.max(
        (n == null ? void 0 : n.columnCount) ?? 0,
        t.columnCount,
      ),
...
let $ = class {
  ...
  _resolveLiveRange(e, t, n, r) {
    return t.tableName
      ? Qn(e, t.tableName, r, this._superTableService)
      : $n(e, t, n, r);
  }
};
...
function er(e, t, n) {
  if (e.target.sourceUnitId && n[e.target.sourceUnitId])
    return e.target.sourceUnitId;
  if (e.target.liveUnitId && n[e.target.liveUnitId]) return e.target.liveUnitId;
  let r = Object.entries(t).filter(
      ([t, r]) => !!n[t] && r.unitType === e.target.unitType,
    ),
...
let tr = class extends Ve {
  ...
  _initializeWithOverride() {
    var e;
    if (
      (this._injector.add([je, { useClass: je }]),
      this._injector.add([I]),
      this._injector.add([N]),
      this._injector.add([B]),
      this._injector.add([Bt]),
      this._injector.add([Qt]),
      this._injector.add([Jt]),
      this._injector.add([Kt]),
      this._injector.add([Yt]),
      this._injector.add([bt]),
      this._injector.add([Yn]),
      this._injector.add([Gt]),
      this._injector.add([zt]),
      this._injector.add([At, { useClass: jt }]),
      this._injector.add([Et]),
      this._injector.add([Nt]),
      this._injector.add([$]),
      this._config.notExecuteFormula === !0
        ? this._injector.add([z, { useClass: $ }])
        : this._injector.add([
            z,
            {
              useFactory: () => {
  ...
  onReady() {
    (super.onReady(),
      C(this._injector, [[Bt], [zt], [Qt], [Jt], [Kt], [Yt], [Gt]]),
      C(this._injector, [[Nt]]),
      this._config.notExecuteFormula === !0 &&
        this._injector.has(Qe) &&
        (this._injector.add([Ht]), C(this._injector, [[Ht]])));
  }
};
...
const cr = { maxCells: 1e5, maxBytes: 5e6, concurrency: 4, timeoutMs: 15e3 };
let lr = class extends a {
  constructor(e, t, n) {
    (super(),
      ...
      j(this, `_inflight`, new Map()),
      j(this, `_latestCalculation`, new Map()));
  }
  ...
  _hasWorkerLiveUnit(e, t) {
    ...
    if (
      ...
      n[e.target.liveUnitId]
    )
      return !0;
    let r = Object.entries(t.unitNameMap ?? {}).filter(
        ([t, r]) =>
          t !== e.syntheticUnitId &&
          !t.startsWith(`external:`) &&
          !!n[t] &&
          r.unitType === e.target.unitType,
      ),
      i = e.target.name.toLowerCase(),
      a = r.filter(([, e]) => e.name.toLowerCase() === i);
...
function hr(e) {
  let { hostUnitId: t, unit: n, target: r } = e,
    i = n.unitId === t;
  if (r.kind === `sheet-range`)
    return i
      ? Ye(r.sheetName, r.range)
      : Xe(n.formulaQualifier, r.sheetName, r.range);
  let a =
      r.endColumnName && r.endColumnName !== r.columnName
        ? `[[${_r(r.columnName)}]:[${_r(r.endColumnName)}]]`
        : `[${_r(r.columnName)}]`,
    o = `${gr(r.tableName)}${a}`;
  return i ? o : `[${vr(n.formulaQualifier)}]!${o}`;
}
function gr(e) {
...
function yr(e) {
  ...
  let o = br(e.result),
    ...
    u =
      ((n = e.numberFormat) == null ? void 0 : n.pattern) ??
      Tr(o) ??
      ((i = e.lastValue) == null ? void 0 : i.pattern) ??
      r,
    d = s == null ? void 0 : s.v,
    f =
      d == null || (a = y.formatColor(u, d, { throws: !1 })) == null
        ? void 0
        : a.toString();
  return d == null
    ? { text: ``, pattern: u, cell: s, source: c, stale: l }
...
function br(e) {
  let { cell: n, count: r } = Sr(e);
  return r > 1 ? { v: `#VALUE!`, t: t.STRING } : n;
}
function xr(e) {
  let { cell: t, count: n } = Sr(e);
  return n === 1 ? t : void 0;
}
function Sr(e) {
  if (!(e != null && e.result)) return { cell: void 0, count: 0 };
...
function Er(e) {
  ...
  for (let n of e) {
    ...
    let e = ``;
    n.nodeType === Je.REFERENCE
      ? (e = He(n.token).unitId)
      : n.nodeType === Je.TABLE && (e = Ze(n.token).unitQualifier);
    let r = e.trim();
    r && t.set(M(r), r);
  }
  return Array.from(t.values());
...
export {
  Ct as EXTERNAL_REFERENCE_SCHEMA_VERSION,
  Et as ExternalCacheReferenceDataProvider,
  qn as ExternalFormulaUnitReferenceResolver,
  Nt as ExternalReferenceDataProvidersController,
  I as ExternalReferenceModel,
  B as ExternalReferenceOverlayModel,
  or as ExternalReferencePrefetchPlanner,
  lr as ExternalReferencePrefetchService,
  zt as ExternalReferenceRenameController,
  Bt as ExternalReferenceResourceController,
  Vt as FORMULA_REFERENCE_DATA_RPC_CHANNEL,
  Yn as FormulaCacheEligibilityService,
  ue as FormulaCalculationTriggerService,
  de as FormulaDataModel,
  bt as FormulaLastValuePersistenceService,
  jt as FormulaReferenceDataProviderRegistry,
  Ht as FormulaReferenceDataRpcController,
  mr as FormulaReferenceType,
  ot as HOST_EXTERNAL_REFERENCE_SCHEMA_VERSION,
  N as HostExternalReferenceModel,
  ve as IActiveDirtyManagerService,
  At as IFormulaReferenceDataProviderRegistry,
  z as IFormulaReferenceDataService,
  De as ISuperTableService,
  $ as MainFormulaReferenceDataService,
  xt as PersistFormulaLastValuesCommand,
  pt as RemoveHostExternalReferenceCommand,
  Pe as RemoveSuperTableMutation,
  St as SHEET_EXTERNAL_DATA_PLUGIN,
  Fe as SetFormulaCalculationResultMutation,
  Ie as SetFormulaCalculationStartMutation,
  Re as SetFormulaDataMutation,
  ze as SetSuperTableMutation,
  Be as SetTriggerFormulaCalculationStartMutation,
  at as UNIVER_EXTERNAL_REFERENCE_PLUGIN,
  tr as UniverProFormulaEnginePlugin,
  dt as UpsertHostExternalReferenceCommand,
  ft as UpsertHostExternalReferencesCommand,
  hr as buildFormulaReference,
  gt as buildUpsertHostExternalReferenceMutations,
  Er as collectFormulaExternalReferenceQualifiers,
  wt as createEmptyExternalReferenceResource,
  F as createExternalSyntheticUnitId,
  Mt as createUnavailableReferenceDataResponse,
  br as getFormulaResultCell,
  xr as getScalarFormulaResultCell,
  M as normalizeHostExternalReferenceQualifier,
  qe as refactorFormulaUnitQualifier,
  yr as resolveFormulaResultPresentation,
  Dr as resolveHostFormulaExternalReferences,
  Cr as toFormulaLastValue,
};
