...
/**
 * The change of setting Show Values As information to a value field.
 */
export interface IPivotTableSetShowDataAsChange {
    /**
     * @property {PivotTableChangeTypeEnum} type The type of the change.
     */
    type: PivotTableChangeTypeEnum.SetShowDataAs;
    /**
     * @property {string} fieldId The pivot table field id.
     */
    fieldId: string;
    /**
     * @property {IPivotTableShowDataAsInfo} oldShowDataAs The previous Show Values As information.
     */
    oldShowDataAs: IPivotTableShowDataAsInfo;
    /**
     * @property {IPivotTableShowDataAsInfo} newShowDataAs The new Show Values As information.
     */
    newShowDataAs: IPivotTableShowDataAsInfo;
}
/**
...
export interface IPivotTableSetValueFilterChange {
    ...
    /**
     * The evaluation index occupied by the previous rule, or -1 when it did not exist.
     */
    oldIndex: number;
    /**
    ...
    /**
     * The evaluation index occupied by the new rule, or -1 when the rule was removed.
     */
    newIndex: number;
}
/**
...
export type IPivotTableChangeSet = IPivotTableAddFieldChange | IPivotTableSetSubtotalTypeChange | IPivotTableSetShowDataAsChange | IPivotTableRemoveFieldChange | IPivotTableRenameFieldChange | IPivotTableSetFilterInfoChange | IPivotTableSetSortInfoChange | IPivotTableUpdatePositionChange | IPivotTableUpdateValuePositionChange | IPivotTableSetOptionsChange | IPivotTableSetFormatChange | IPivotTableSetCollapseChange | IPivotUpdateSourceChange | IPivotTableSetValueFilterChange | IPivotTableSetLayoutChange;
