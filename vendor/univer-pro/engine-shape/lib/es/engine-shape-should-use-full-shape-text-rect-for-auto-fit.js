...
import { xe } from "./engine-shape-shape-text-body-behavior.js";
function we(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D466394) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D466395 = xe(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D466394);
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D466395.autoFitType === "spAutoFit" && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D466395.textWrap === 'none';
}
export { we as shouldUseFullShapeTextRectForAutoFit };
