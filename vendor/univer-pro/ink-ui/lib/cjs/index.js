...
const f = {};
function p(var_core_value_sig362B) {
  "@babel/helpers - typeof";

  return p = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig8061) {
  ...
  }, p(var_core_value_sig362B);
}
function m(var_core_value_sig5CA5, var_core_value_sigE90F) {
  if (p(var_core_value_sig5CA5) != "object" || !var_core_value_sig5CA5) return var_core_value_sig5CA5;
  ...
  if (var_core_value_sigEFD4 !== undefined) {
    ...
    if (p(var_core_value_sig861B) != "object") return var_core_value_sig861B;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sigE90F === "string" ? String : Number)(var_core_value_sig5CA5);
}
function h(var_core_value_sig5237) {
  var var_core_value_sigBB00 = m(var_core_value_sig5237, "string");
  return p(var_core_value_sigBB00) == "symbol" ? var_core_value_sigBB00 : var_core_value_sigBB00 + "";
}
function g(var_core_value_sig7E54, var_core_value_sig9A8D, var_core_value_sigC259) {
  return (var_core_value_sig9A8D = h(var_core_value_sig9A8D)) in var_core_value_sig7E54 ? Object.defineProperty(var_core_value_sig7E54, var_core_value_sig9A8D, {
...
function y(var_core_value_sig9C9F) {
...
var b = class extends n.Disposable {
  constructor(...var_core_value_sigC9E0) {
    super(...var_core_value_sigC9E0), g(this, "_state$", new i["BehaviorSubject"]({
      active: false,
  ...
  beginInkMode(var_core_value_sig76BA) {
    let var_core_value_sigFBFA = y(var_core_value_sig76BA.tool);
    this._state$["next"]({
      ...this.getState(),
      ...v[var_core_value_sigFBFA],
      active: true,
      toolbarVisible: true,
...
function x(var_core_value_sigFDEA, var_core_value_sig86D0) {
...
function S(var_core_value_sig4CD2, var_core_value_sig48CA, var_core_value_sig50AF, var_core_value_sigA942) {
...
const C = (0, n.createIdentifier)("ink-ui.outside-interaction.service"),
  w = ['[data-ink-floating-toolbar="true"]', '[data-ink-floating-toolbar-popup="true"]', '[data-ink-interactive-region="true"]'];
function T(var_core_value_sig5B67, var_core_value_sig1758) {
...
function E(var_core_value_sig4805, var_core_value_sigE67E) {
...
let D = class extends n.Disposable {
  constructor(var_core_value_sigF0F9) {
    if (super(), this._stateService = var_core_value_sigF0F9, g(this, "_interactiveRegions", new Set()), typeof window < "u") {
      ...
      window.addEventListener("pointerdown", var_core_value_sig2AD0, {
        capture: true
      }), this.disposeWithMe((0, n.toDisposable)(() => window.removeEventListener("pointerdown", var_core_value_sig2AD0, {
        capture: true
      })));
    }
  }
  registerInteractiveRegion(var_core_value_sig1A0F) {
    return var_core_value_sig1A0F.dataset["inkInteractiveRegion"] = "true", this._interactiveRegions["add"](var_core_value_sig1A0F), (0, n.toDisposable)(() => {
  ...
  _handlePointerDown(var_core_value_sigFBA4) {
    ...
    if (!w.some(var_core_value_sig3EEE => E(var_core_value_sig4383, var_core_value_sig3EEE))) {
      for (let var_core_value_sig2AD8 of this._interactiveRegions) if (T(var_core_value_sig4383, var_core_value_sig2AD8)) return;
...
O = S([x(0, _)], O);
function k(var_core_value_sig2902) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0 0 30 105",
...
function A(var_core_value_sig9989) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0 0 30 105",
...
function j(var_core_value_sig698E) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "107",
    viewBox: "0 0 30 107",
...
function M(var_core_value_sig2809) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0 0 30 105",
...
function N(var_core_value_sig2DAB) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    ...
    children: [(0, l.jsx)("mask", {
      ...
      children: [(0, l.jsxs)("filter", {
        ...
        children: [(0, l.jsx)("feFlood", {
          ...
          type: "matrix",
          values: "0\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200.747897\x200"
        }), (0, l.jsx)("feBlend", {
          mode: "normal",
          in2: "BackgroundImageFix",
          result: "effect1_dropShadow_0_1451"
...
function P(var_core_value_sig877E) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0\x200\x2030\x20105",
    ...
    children: [(0, l.jsx)("mask", {
      ...
      children: [(0, l.jsxs)("filter", {
        ...
        children: [(0, l.jsx)("feFlood", {
          ...
          type: "matrix",
          values: "0\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200\x200.25\x200"
        }), (0, l.jsx)("feBlend", {
          mode: "normal",
          in2: "BackgroundImageFix",
...
function F(var_core_value_sig20C8) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0 0 30 105",
...
function I(var_core_value_sigE9A7) {
  return (0, l.jsxs)("svg", {
    width: "30",
    height: "105",
    viewBox: "0 0 30 105",
...
const L = [{
  ...
  z = [{
    value: 2,
    icon: s.StrokeSize1Icon
  }, {
    value: 4,
    icon: s.StrokeSize2Icon
  }, {
    value: 8,
    icon: s.StrokeSize3Icon
  }, {
    value: 14,
    icon: s.StrokeSize4Icon
  }, {
    value: 24,
    icon: s.StrokeSize5Icon
  }];
function B(var_core_value_sigBECE) {
  return (0, o.clsx)("univer-group\x20univer-relative\x20univer-h-24\x20univer-w-12\x20univer-appearance-none", "univer-border-0 univer-bg-transparent univer-p-0 univer-shadow-none univer-outline-none", var_core_value_sigBECE && "univer-z-10");
}
function V(var_core_value_sig1B22) {
  return z.find(var_core_value_sig48BD => var_core_value_sig48BD.value === var_core_value_sig1B22) ?? z[0];
}
function H(var_core_value_sig7F72) {
  let var_core_value_sig7B2A = var_core_value_sig7F72.icon;
  return (0, l.jsx)("span", {
    "aria-hidden": "true",
    className: "univer-flex\x20univer-h-8\x20univer-w-8\x20univer-items-center\x20univer-justify-center\x20univer-text-gray-900\x20dark:!univer-text-gray-100",
    children: (0, l.jsx)(var_core_value_sig7B2A, {
      className: "univer-block univer-size-6"
    })
  });
}
function U(var_core_value_sig06CD) {
  ...
  return (0, l.jsx)(o.Tooltip, {
    ...
    children: (0, l.jsx)("span", {
      className: (0, o.clsx)("univer-flex univer-items-center univer-justify-center", var_core_value_sigA5F1 ? "univer-h-12 univer-w-[72px]" : "univer-h-12 univer-w-10"),
      "data-ink-toolbar-control-tooltip-anchor": "true",
      children: (0, l.jsx)(o.Button, {
        "aria-label": var_core_value_sig06CD.label,
        className: (0, o.clsx)("univer-relative univer-flex univer-items-center univer-justify-center univer-rounded-full univer-border-none univer-bg-transparent univer-text-gray-700 univer-transition-colors hover:univer-bg-gray-100 hover:univer-text-gray-900 dark:!univer-text-gray-100 dark:hover:!univer-bg-gray-800", "univer-h-10", var_core_value_sigA5F1 ? "!univer-w-[72px] !univer-min-w-[72px] !univer-pl-2.5 !univer-pr-2 rtl:!univer-pl-2 rtl:!univer-pr-2.5" : "!univer-w-10 !univer-min-w-10 !univer-p-0", var_core_value_sig06CD.active ? "univer-bg-gray-100 univer-text-gray-900 dark:!univer-bg-gray-800" : ""),
...
function W(var_core_value_sig97A2) {
  let {
    ...
    var_core_value_sigCE71 = V(var_core_value_sigF564),
    [var_core_value_sig21D8, var_core_value_sig2B65] = (0, c.useState)(null),
    [var_core_value_sigD7EA, var_core_value_sigB33B] = (0, c.useState)(null),
    var_core_value_sig24B9 = (0, r.useDependency)(n.LocaleService),
    var_core_value_sigE627 = (0, r.useObservable)(var_core_value_sig24B9.direction$, var_core_value_sig24B9.getDirection());
  ...
  return (0, l.jsxs)("div", {
    ...
    children: [(0, l.jsx)("div", {
      ...
      children: L.map(var_core_value_sig9572 => {
        let var_core_value_sigD873 = var_core_value_sig9572.icon,
          ...
          var_core_value_sig09B8 = var_core_value_sig24B9.t(R[var_core_value_sig9572.labelKey]);
        return (0, l.jsx)("div", {
          ...
          children: (0, l.jsx)(o.Tooltip, {
            ...
            children: (0, l.jsx)("button", {
              ...
              className: B(var_core_value_sigF230),
              type: "button",
              onClick: () => var_core_value_sig8CFA(var_core_value_sig9572.tool),
              children: (0, l.jsxs)("span", {
                className: (0, o.clsx)("univer-pointer-events-none univer-absolute univer-bottom-0 univer-left-1/2 univer-block univer--translate-x-1/2 univer-transition-transform univer-duration-200 univer-ease-out", var_core_value_sigF230 ? "univer-translate-y-[15px]" : "univer-translate-y-[35px] group-hover:univer-translate-y-[27px]"),
                children: [(0, l.jsx)(var_core_value_sigD873, {
                  className: "ink-tool-icon-light univer-block univer-w-auto univer-drop-shadow-lg dark:!univer-hidden"
                }), (0, l.jsx)(var_core_value_sigA12B, {
      ...
      children: [(0, l.jsx)(o.Dropdown, {
          ...
          children: (0, l.jsx)("div", {
            ...
            children: z.map(var_core_value_sigF9C7 => {
              ...
              return (0, l.jsx)(o.Button, {
                ...
                className: (0, o.clsx)("univer-rounded-md univer-text-gray-900 univer-transition-colors hover:univer-bg-gray-100 dark:!univer-text-gray-100 dark:hover:!univer-bg-gray-800", var_core_value_sigC80B ? "univer-bg-primary-50\x20univer-text-primary-600\x20dark:!univer-bg-gray-800" : ""),
                size: "icon",
                type: "button",
                variant: "ghost",
                onClick: () => {
                ...
                children: (0, l.jsx)(var_core_value_sig8895, {})
        ...
        className: (0, o.clsx)("univer-rounded-lg univer-p-3 !univer-shadow-none", "univer-z-[100001]"),
        "data-ink-floating-toolbar-popup": "true",
        ...
        children: (0, l.jsx)("span", {
          ...
          children: (0, l.jsxs)(U, {
            ...
            children: [(0, l.jsx)(s.ColorWheelMultiIcon, {
...
function G() {
  let var_core_value_sig9A0D = (0, r.useDependency)(_),
    var_core_value_sigA319 = (0, r.useObservable)(() => var_core_value_sig9A0D.state$, var_core_value_sig9A0D.getState(), false, [var_core_value_sig9A0D]);
  return var_core_value_sigA319.toolbarVisible ? (0, l.jsx)(W, {
...
let K = class extends n.Plugin {
  ...
  onStarting() {
    [[O], [_, {
      ...
      useClass: D
    }]].forEach(var_core_value_sig27E5 => this._injector["add"](var_core_value_sig27E5)), this.disposeWithMe(this._uiPartsService["registerComponent"](r.BuiltInUIPart["CONTENT"], () => (0, r.connectInjector)(G, this._injector)));
  }
};
g(K, "pluginName", "UNIVER_INK_UI_PLUGIN"), g(K, "packageName", u), g(K, "version", d), g(K, "type", n.UniverInstanceType["UNIVER_UNKNOWN"]), K = S([(0, n.DependentOn)(t.UniverLicensePlugin, e.UniverInkPlugin), x(1, (0, n.Inject)(n.Injector)), x(2, r.IUIPartsService), x(3, n.IConfigService)], K), exports.IInkOutsideInteractionService = C, exports.IInkUIStateService = _, Object.defineProperty(exports, "InkUIService", {
  enumerable: true,
  get: function () {
    return O;
  }
}), exports.InkUIStateService = b, Object.defineProperty(exports, "UniverInkUIPlugin", {
  enumerable: true,
  get: function () {
    return K;
  }
