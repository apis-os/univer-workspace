...
const r = 0.0001;
function i(var_core_value_sig2E11) {
  return {
    x: var_core_value_sig2E11.x,
    y: var_core_value_sig2E11.y
  };
}
function a(var_core_value_sig5B69) {
  return {
    ...var_core_value_sig5B69,
    in: var_core_value_sig5B69.in ? i(var_core_value_sig5B69.in) : undefined,
    out: var_core_value_sig5B69.out ? i(var_core_value_sig5B69.out) : undefined
  };
}
function o(var_core_value_sigB098) {
  return {
    kind: "pen",
    closed: var_core_value_sigB098.closed,
    anchors: var_core_value_sigB098.anchors["map"](a)
  };
}
function s(var_core_value_sigCE71, var_core_value_sig21D8, var_core_value_sig2B65) {
  return {
...
function u(var_core_value_sigEF3E, var_core_value_sig273D, var_core_value_sig9A0D = c(var_core_value_sigEF3E, var_core_value_sig273D)) {
  let var_core_value_sigA319 = l({
...
function f(var_core_value_sigCFFA, var_core_value_sig58C1) {
  let var_core_value_sig5090 = d(var_core_value_sigCFFA, var_core_value_sig58C1);
...
function ee(var_core_value_sigC368, var_core_value_sigAD56) {
  return var_core_value_sigAD56 === "anchor" ? var_core_value_sigC368 : var_core_value_sigC368[var_core_value_sigAD56] ?? null;
}
function p(var_core_value_sigDB4A, var_core_value_sig6418, var_core_value_sig1896) {
...
function m(var_core_value_sig0285, var_core_value_sig777D) {
  let [var_core_value_sig3F4C, var_core_value_sigD65A, var_core_value_sig5A13, var_core_value_sigF593] = var_core_value_sig0285,
    var_core_value_sig3607 = s(var_core_value_sig3F4C, var_core_value_sigD65A, var_core_value_sig777D),
    var_core_value_sigB512 = s(var_core_value_sigD65A, var_core_value_sig5A13, var_core_value_sig777D),
    var_core_value_sigF2E6 = s(var_core_value_sig5A13, var_core_value_sigF593, var_core_value_sig777D);
  return s(s(var_core_value_sig3607, var_core_value_sigB512, var_core_value_sig777D), s(var_core_value_sigB512, var_core_value_sigF2E6, var_core_value_sig777D), var_core_value_sig777D);
}
function h(var_core_value_sig34C8, var_core_value_sigB744) {
  let [var_core_value_sigEAE2, var_core_value_sigE68A, var_core_value_sig3E68, var_core_value_sigF4C5] = var_core_value_sig34C8,
    var_core_value_sig5410 = s(var_core_value_sigEAE2, var_core_value_sigE68A, var_core_value_sigB744),
    var_core_value_sig492F = s(var_core_value_sigE68A, var_core_value_sig3E68, var_core_value_sigB744),
    var_core_value_sig8EA0 = s(var_core_value_sig3E68, var_core_value_sigF4C5, var_core_value_sigB744),
    var_core_value_sigA6F6 = s(var_core_value_sig5410, var_core_value_sig492F, var_core_value_sigB744),
    var_core_value_sigCDDA = s(var_core_value_sig492F, var_core_value_sig8EA0, var_core_value_sigB744),
    var_core_value_sigE243 = s(var_core_value_sigA6F6, var_core_value_sigCDDA, var_core_value_sigB744);
  return {
...
function g(var_core_value_sig74A8, var_core_value_sig21B2, var_core_value_sigDE08) {
  let var_core_value_sigACCB = var_core_value_sigDE08.x - var_core_value_sig21B2.x,
    ...
    var_core_value_sigEA04 = var_core_value_sig0C53 <= r ? 0 : Math.max(0, Math.min(1, ((var_core_value_sig74A8.x - var_core_value_sig21B2.x) * var_core_value_sigACCB + (var_core_value_sig74A8.y - var_core_value_sig21B2.y) * var_core_value_sig7F33) / var_core_value_sig0C53)),
  ...
  return {
    ...
    distance: c(var_core_value_sig74A8, var_core_value_sig7A62)
  };
}
function te(var_core_value_sig8109, var_core_value_sig7565, var_core_value_sigD4FB) {
  return g(var_core_value_sig8109, var_core_value_sig7565, var_core_value_sigD4FB).distance ** 2;
}
function _(var_core_value_sig3E71, var_core_value_sig01B3) {
  if (var_core_value_sig3E71.length <= 2) return var_core_value_sig3E71.map(i);
  ...
  for (let var_core_value_sigDBB7 = 1; var_core_value_sigDBB7 < var_core_value_sig3E71.length - 1; var_core_value_sigDBB7++) {
    let var_core_value_sigC9E0 = te(var_core_value_sig3E71[var_core_value_sigDBB7], var_core_value_sig9EE0, var_core_value_sigF051);
  ...
  if (var_core_value_sig7442 <= var_core_value_sig0B45) return [i(var_core_value_sig9EE0), i(var_core_value_sigF051)];
  let var_core_value_sig36F8 = _(var_core_value_sig3E71.slice(0, var_core_value_sigDF87 + 1), var_core_value_sig01B3),
    var_core_value_sig03E1 = _(var_core_value_sig3E71.slice(var_core_value_sigDF87), var_core_value_sig01B3);
...
function v(var_core_value_sigAEFB, var_core_value_sig826B) {
...
function y(var_core_value_sig9F76, var_core_value_sigB008) {
  let var_core_value_sig8721 = var_core_value_sig9F76.anchors[var_core_value_sigB008],
    ...
    var_core_value_sig237B = var_core_value_sig08BA && var_core_value_sigDBB5 ? Math.max(50, c(var_core_value_sig08BA, var_core_value_sigDBB5) / 4) : 50;
  return {
    in: {
...
function b(var_core_value_sigFEAB, var_core_value_sigE347) {
  ...
  if (var_core_value_sig3C5B) {
    if (var_core_value_sigFEAB.pointType === "symmetric") {
      var_core_value_sigFEAB[var_core_value_sig200B] = u(var_core_value_sigFEAB, var_core_value_sig3C5B);
      return;
    }
    var_core_value_sigFEAB.pointType === "smooth" && (var_core_value_sigFEAB[var_core_value_sig200B] = u(var_core_value_sigFEAB, var_core_value_sig3C5B, var_core_value_sig3863 ? c(var_core_value_sigFEAB, var_core_value_sig3863) : c(var_core_value_sigFEAB, var_core_value_sig3C5B)));
  }
}
function x(var_core_value_sigC97C, var_core_value_sigC4B1) {
  let var_core_value_sig1BD9 = o(var_core_value_sigC97C);
...
function re(var_core_value_sigE43E, var_core_value_sigA937 = {}) {
  let var_core_value_sigCAD5 = Math.max(0, var_core_value_sigA937.tolerance ?? Math.max(4, var_core_value_sigE43E.width * 0.35)),
    ...
    var_core_value_sig48DD = _(var_core_value_sigE43E.points, var_core_value_sigCAD5),
...
function ie(var_core_value_sigB7FC, var_core_value_sig9CD9, var_core_value_sigFD0C) {
  ...
  return var_core_value_sigB7FC.anchors["forEach"]((var_core_value_sig362B, var_core_value_sig5CA5) => {
    var_core_value_sig5F1A.forEach(var_core_value_sig76BA => {
      if (!p(var_core_value_sigB7FC, var_core_value_sig5CA5, var_core_value_sig76BA)) return;
      let var_core_value_sigFBFA = ee(var_core_value_sig362B, var_core_value_sig76BA);
      if (!var_core_value_sigFBFA) return;
      let var_core_value_sigF602 = c(var_core_value_sig9CD9, var_core_value_sigFBFA);
      var_core_value_sigF602 > var_core_value_sigFD0C || var_core_value_sig849B && var_core_value_sigF602 >= var_core_value_sig849B.distance || (var_core_value_sig849B = {
        ...
        point: i(var_core_value_sigFBFA),
        distance: var_core_value_sigF602
      });
    });
  }), var_core_value_sig849B;
}
function S(var_core_value_sigB455, var_core_value_sig5241, var_core_value_sigC6E5) {
  ...
  for (let var_core_value_sigE90F = 0; var_core_value_sigE90F < var_core_value_sig1537; var_core_value_sigE90F++) {
    let var_core_value_sig1BBD = f(var_core_value_sigB455, var_core_value_sigE90F);
    if (!var_core_value_sig1BBD) continue;
    let var_core_value_sigF704 = m(var_core_value_sig1BBD, 0);
    for (let var_core_value_sig3EEE = 1; var_core_value_sig3EEE <= 32; var_core_value_sig3EEE++) {
      let var_core_value_sig7524 = m(var_core_value_sig1BBD, var_core_value_sig3EEE / 32),
        var_core_value_sig2AD8 = g(var_core_value_sig5241, var_core_value_sigF704, var_core_value_sig7524),
...
function C(var_core_value_sigE4C6, var_core_value_sig4313, var_core_value_sigFC87) {
  let var_core_value_sig156F = o(var_core_value_sigE4C6),
    var_core_value_sigDD51 = d(var_core_value_sig156F, var_core_value_sig4313.segmentIndex),
    var_core_value_sigF057 = f(var_core_value_sig156F, var_core_value_sig4313.segmentIndex);
  if (!var_core_value_sigDD51 || !var_core_value_sigF057) return var_core_value_sig156F;
  let var_core_value_sig72F6 = h(var_core_value_sigF057, Math.max(0, Math.min(1, var_core_value_sig4313.t))),
    var_core_value_sig9FBA = {
      id: var_core_value_sigFC87(),
      x: var_core_value_sig72F6.left[3].x,
      y: var_core_value_sig72F6.left[3].y,
      in: i(var_core_value_sig72F6.left[2]),
      out: i(var_core_value_sig72F6.right[1]),
      pointType: "free"
    };
  return var_core_value_sig156F.anchors[var_core_value_sigDD51.startIndex].out = i(var_core_value_sig72F6.left[1]), var_core_value_sig156F.anchors[var_core_value_sigDD51.endIndex].in = i(var_core_value_sig72F6.right[2]), var_core_value_sig156F.anchors["splice"](var_core_value_sigDD51.startIndex + 1, 0, var_core_value_sig9FBA), var_core_value_sig156F;
}
function w(var_core_value_sigFE01, var_core_value_sigA2CE) {
  let var_core_value_sig1975 = o(var_core_value_sigFE01);
...
function T(var_core_value_sig6EA1, var_core_value_sig029F, var_core_value_sig3767) {
  let var_core_value_sig670B = o(var_core_value_sig6EA1),
  ...
  let var_core_value_sig7664 = y(var_core_value_sig670B, var_core_value_sig6912);
  if (var_core_value_sigE235.in = var_core_value_sigE235.in ? i(var_core_value_sigE235.in) : var_core_value_sig7664.in, var_core_value_sigE235.out = var_core_value_sigE235.out ? i(var_core_value_sigE235.out) : var_core_value_sig7664.out, var_core_value_sig3767 === "symmetric") {
    let var_core_value_sig5237 = Math.max(c(var_core_value_sigE235, var_core_value_sigE235.in), c(var_core_value_sigE235, var_core_value_sigE235.out), 50),
      var_core_value_sigBB00 = l({
  ...
  } else var_core_value_sig3767 === "smooth" && b(var_core_value_sigE235, "out");
  return var_core_value_sig670B;
}
function E(var_core_value_sig2281, var_core_value_sig5E86) {
  ...
  return T(var_core_value_sig2281, var_core_value_sig5E86, var_core_value_sigF639 === "corner" ? "smooth" : var_core_value_sigF639 === "smooth" ? "symmetric" : var_core_value_sigF639 === "symmetric" ? "free" : "corner");
}
function ae(var_core_value_sigEAE5, var_core_value_sigE94C, var_core_value_sig6D47) {
  let var_core_value_sigCB82 = o(var_core_value_sigEAE5),
  ...
  return var_core_value_sigCF4E[var_core_value_sigE94C.kind] = i(var_core_value_sig6D47), var_core_value_sigCF4E.pointType === "corner" && (var_core_value_sigCF4E.pointType = "free"), b(var_core_value_sigCF4E, var_core_value_sigE94C.kind), var_core_value_sigCB82;
}
const D = 1e-9;
function O(var_core_value_sig6CAD) {
...
function k(var_core_value_sigDDD7) {
  return O(var_core_value_sigDDD7.x) + "\x20" + O(var_core_value_sigDDD7.y);
}
...
function j(var_core_value_sig39B1, var_core_value_sig210D, var_core_value_sigB4B4, var_core_value_sigD407, var_core_value_sig63F3) {
...
function M(var_core_value_sig3BF6, var_core_value_sig38CE, var_core_value_sig62B7, var_core_value_sig37A8) {
  ...
  if (Math.abs(var_core_value_sigA90D) < D) {
    if (Math.abs(var_core_value_sig7A3C) < D) return var_core_value_sig1F44;
  ...
  return var_core_value_sig4545 > 0 && var_core_value_sig4545 < 1 && var_core_value_sig1F44.push(var_core_value_sig4545), var_core_value_sigF39A > 0 && var_core_value_sigF39A < 1 && Math.abs(var_core_value_sigF39A - var_core_value_sig4545) > D && var_core_value_sig1F44.push(var_core_value_sigF39A), var_core_value_sig1F44;
}
function N(var_core_value_sigF79C, var_core_value_sig2E54, var_core_value_sig7658, var_core_value_sigDCF5, var_core_value_sigC786) {
  var_core_value_sigF79C.push(var_core_value_sig2E54, var_core_value_sigC786), new Set([...M(var_core_value_sig2E54.x, var_core_value_sig7658.x, var_core_value_sigDCF5.x, var_core_value_sigC786.x), ...M(var_core_value_sig2E54.y, var_core_value_sig7658.y, var_core_value_sigDCF5.y, var_core_value_sigC786.y)]).forEach(var_core_value_sigFDEA => {
    var_core_value_sigF79C.push(j(var_core_value_sig2E54, var_core_value_sig7658, var_core_value_sigDCF5, var_core_value_sigC786, var_core_value_sigFDEA));
  });
}
function P(var_core_value_sigC0D9) {
  ...
  for (let var_core_value_sig86D0 = 1; var_core_value_sig86D0 < var_core_value_sigF0511.length; var_core_value_sig86D0++) {
    ...
    N(var_core_value_sig5825, var_core_value_sig2BCF, var_core_value_sig2BCF.out ?? var_core_value_sig2BCF, var_core_value_sig0D69.in ?? var_core_value_sig0D69, var_core_value_sig0D69);
  }
  if (var_core_value_sigC0D9.closed && var_core_value_sigF0511.length > 1) {
    ...
    N(var_core_value_sig5825, var_core_value_sig4CD2, var_core_value_sig4CD2.out ?? var_core_value_sig4CD2, var_core_value_sig48CA.in ?? var_core_value_sig48CA, var_core_value_sig48CA);
  }
  return var_core_value_sig5825;
}
function F(var_core_value_sig4EB7) {
  ...
  for (let var_core_value_sig50AF = 0; var_core_value_sig50AF < var_core_value_sig73AF.length - 1; var_core_value_sig50AF++) {
    ...
    N(var_core_value_sig548A, var_core_value_sig480E, {
...
function I(var_core_value_sigE026) {
  return var_core_value_sigE026.kind === "pen" ? P(var_core_value_sigE026) : F(var_core_value_sigE026);
}
function L(var_core_value_sig339E) {
...
function R(var_core_value_sig2983) {
  let var_core_value_sigE1B0 = I(var_core_value_sig2983);
  ...
  return {
    left: L(var_core_value_sigD4FF),
    top: L(var_core_value_sig1E5B),
    width: L(Math.max(1, var_core_value_sigB680 - var_core_value_sigD4FF)),
    height: L(Math.max(1, var_core_value_sig1F64 - var_core_value_sig1E5B))
  };
}
function z(var_core_value_sigDD1C, var_core_value_sig2C39) {
  let var_core_value_sigB7D1 = var_core_value_sigDD1C.anchors;
  if (var_core_value_sigB7D1.length === 0) return "";
  let var_core_value_sig64F0 = ["M\x20" + k(A(var_core_value_sigB7D1[0], var_core_value_sig2C39))];
  for (let var_core_value_sig32F8 = 1; var_core_value_sig32F8 < var_core_value_sigB7D1.length; var_core_value_sig32F8++) {
    ...
    var_core_value_sig64F0.push("C\x20" + k(A(var_core_value_sig186C, var_core_value_sig2C39)) + "\x20" + k(A(var_core_value_sigD955, var_core_value_sig2C39)) + "\x20" + k(A(var_core_value_sig4383, var_core_value_sig2C39)));
  }
  if (var_core_value_sigDD1C.closed && var_core_value_sigB7D1.length > 1) {
    ...
    var_core_value_sig64F0.push("C\x20" + k(A(var_core_value_sig4805, var_core_value_sig2C39)) + "\x20" + k(A(var_core_value_sigE67E, var_core_value_sig2C39)) + "\x20" + k(A(var_core_value_sig1758, var_core_value_sig2C39))), var_core_value_sig64F0.push("Z");
  }
  return var_core_value_sig64F0.join("\x20");
}
function B(var_core_value_sig85B1, var_core_value_sig3141) {
  let var_core_value_sig2162 = var_core_value_sig85B1.points["map"](var_core_value_sig2902 => A(var_core_value_sig2902, var_core_value_sig3141));
  if (var_core_value_sig2162.length === 0) return "";
  if (var_core_value_sig2162.length === 1) return "M\x20" + k(var_core_value_sig2162[0]);
  let var_core_value_sig2EAD = ["M\x20" + k(var_core_value_sig2162[0])];
  for (let var_core_value_sig9989 = 0; var_core_value_sig9989 < var_core_value_sig2162.length - 1; var_core_value_sig9989++) {
    ...
    var_core_value_sig2EAD.push("C\x20" + k(var_core_value_sigE9ED) + "\x20" + k(var_core_value_sigB577) + "\x20" + k(var_core_value_sig429F));
  }
  return var_core_value_sig2EAD.join("\x20");
}
function V(var_core_value_sig6774, var_core_value_sig340D) {
  return var_core_value_sig6774.kind === "pen" ? z(var_core_value_sig6774, var_core_value_sig340D) : B(var_core_value_sig6774, var_core_value_sig340D);
}
function H(var_core_value_sig82D4, var_core_value_sigBDE4) {
...
function U(var_core_value_sig7DF1, var_core_value_sigDC86) {
...
function W(var_core_value_sig0B0C, var_core_value_sigA39E) {
...
function oe(var_core_value_sigBBEE, var_core_value_sig011D) {
  let var_core_value_sig6167 = R(var_core_value_sigBBEE),
    var_core_value_sig65A1 = V(var_core_value_sigBBEE, {
  ...
  return {
    ...
    customGeometry: {
      ...
      pathLst: [{
        ...
        dataArray: K(var_core_value_sigBBEE, {
          x: var_core_value_sig6167.left,
          y: var_core_value_sig6167.top
        })
      }]
    ...
    stroke: {
      color: H(var_core_value_sigBBEE, var_core_value_sig011D),
      width: U(var_core_value_sigBBEE, var_core_value_sig011D),
      opacity: W(var_core_value_sigBBEE, var_core_value_sig011D),
...
function G(var_core_value_sig652C, var_core_value_sig7E32) {
  return {
    x: var_core_value_sig652C.x - var_core_value_sig7E32.x,
    y: var_core_value_sig652C.y - var_core_value_sig7E32.y
  };
}
function K(var_core_value_sig4C07, var_core_value_sig79AB) {
  if (var_core_value_sig4C07.kind === "pen") {
    ...
    let var_core_value_sig2809 = G(var_core_value_sig698E[0], var_core_value_sig79AB),
    ...
    for (let var_core_value_sig9572 = 1; var_core_value_sig9572 < var_core_value_sig698E.length; var_core_value_sig9572++) {
      let var_core_value_sigBC46 = var_core_value_sig698E[var_core_value_sig9572 - 1],
        ...
        var_core_value_sig27E5 = G(var_core_value_sigBC46.out ?? var_core_value_sigBC46, var_core_value_sig79AB),
        var_core_value_sig8061 = G(var_core_value_sig3D7D.in ?? var_core_value_sig3D7D, var_core_value_sig79AB),
        var_core_value_sig4D4C = G(var_core_value_sig3D7D, var_core_value_sig79AB);
    ...
    if (var_core_value_sig4C07.closed && var_core_value_sig698E.length > 1) {
      let var_core_value_sigD873 = var_core_value_sig698E[var_core_value_sig698E.length - 1],
        ...
        var_core_value_sigF230 = G(var_core_value_sigD873.out ?? var_core_value_sigD873, var_core_value_sig79AB),
        var_core_value_sig09B8 = G(var_core_value_sigA12B.in ?? var_core_value_sigA12B, var_core_value_sig79AB),
        var_core_value_sig6F91 = G(var_core_value_sigA12B, var_core_value_sig79AB);
      var_core_value_sig2DAB.push({
        command: "C",
  ...
  let var_core_value_sig8E74 = var_core_value_sig4C07.points["map"](var_core_value_sig877E => G(var_core_value_sig877E, var_core_value_sig79AB));
...
function q(var_core_value_sig841D) {
  let {
    ...
    var_core_value_sig85C3 = R(var_core_value_sig90CB),
  ...
  return {
    ...
    shapeData: oe(var_core_value_sig90CB, var_core_value_sigBDF5),
    ink: {
      version: 1,
...
function J(var_core_value_sig4BBA) {
  "@babel/helpers - typeof";

  return J = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigE9A7) {
  ...
  }, J(var_core_value_sig4BBA);
}
function le(var_core_value_sig6201, var_core_value_sig5151) {
  if (J(var_core_value_sig6201) != "object" || !var_core_value_sig6201) return var_core_value_sig6201;
  ...
  if (var_core_value_sigB542 !== undefined) {
    ...
    if (J(var_core_value_sigBB6C) != "object") return var_core_value_sigBB6C;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig5151 === "string" ? String : Number)(var_core_value_sig6201);
}
function ue(var_core_value_sigE2BF) {
  var var_core_value_sigB8C7 = le(var_core_value_sigE2BF, "string");
  return J(var_core_value_sigB8C7) == "symbol" ? var_core_value_sigB8C7 : var_core_value_sigB8C7 + "";
}
function Y(var_core_value_sigA56E, var_core_value_sig1998, var_core_value_sigFF19) {
  return (var_core_value_sig1998 = ue(var_core_value_sig1998)) in var_core_value_sigA56E ? Object.defineProperty(var_core_value_sigA56E, var_core_value_sig1998, {
...
var de = class {
  ...
  registerAdapter(var_core_value_sig1B22) {
    return this._adapters["push"](var_core_value_sig1B22), (0, n.toDisposable)(() => {
...
function pe(var_core_value_sigB785, var_core_value_sig130F, var_core_value_sigC0E3, var_core_value_sig52F7) {
...
let $ = class extends n.Plugin {
  constructor(var_core_value_sig97A2 = Z, var_core_value_sig07E9, var_core_value_sig4F59, var_core_value_sigF564) {
    ...
    } = (0, n.merge)({}, Z, this._config);
    this._configService["setConfig"]("ink.config", var_core_value_sig8CFA);
  }
  onStarting() {
    [[X, {
      useClass: de
    }]].forEach(var_core_value_sigD082 => this._injector["add"](var_core_value_sigD082)), this.disposeWithMe(this._commandService["registerCommand"](fe));
  }
};
Y($, "pluginName", "UNIVER_INK_PLUGIN"), Y($, "packageName", se), Y($, "version", ce), Y($, "type", n.UniverInstanceType["UNIVER_UNKNOWN"]), $ = pe([(0, n.DependentOn)(t.UniverLicensePlugin), Q(1, (0, n.Inject)(n.Injector)), Q(2, n.ICommandService), Q(3, n.IConfigService)], $), exports.IInkHostAdapterService = X, Object.defineProperty(exports, "UniverInkPlugin", {
  enumerable: true,
  get: function () {
    return $;
  }
}), exports.buildInkCustomShapePayload = q, exports.convertBrushModelToPenModel = re, exports.cycleInkPenAnchorPointType = E, exports.deleteInkPenAnchor = w, exports.findClosestInkPenHandle = ie, exports.findClosestInkPenSegment = S, exports.getInkModelBounds = R, exports.getInkPenPreviewModel = x, exports.insertInkPenAnchorAt = C, exports.isInkPenHandleVisible = p, exports.moveInkPenAnchorPoint = ae, exports.setInkPenAnchorPointType = T;
