...
const v = "univer-pdf-document",
  y = 1,
  b = 914400,
  x = 12700,
  ee = 96,
  te = 9525;
export { v as PDF_DOCUMENT_SCHEMA, y as PDF_DOCUMENT_SCHEMA_VERSION, b as EMU_PER_INCH, x as EMU_PER_PT, ee as CSS_PX_PER_INCH, te as EMU_PER_CSS_PX };
