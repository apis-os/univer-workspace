const e = {
  "sheets-chart": {
    ...
    chartField: {
      ...
      missingSeriesFields: "這個圖表需要更多數值欄位。",
      invalidFieldIndex: "選取的圖表欄位已無法使用。",
      invalidValueFieldType: "選取的數值欄位不包含數值資料。",
      invalidDataStructure: "選取的欄位無法構成這個圖表所需的有效資料結構。",
      unsupportedChartType: "這個圖表類型沒有欄位使用規則。",
    },
  },
};
module.exports = e;
