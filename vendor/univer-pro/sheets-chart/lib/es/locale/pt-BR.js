const e = {
  "sheets-chart": {
    ...
    bubble: {
      emptyTips: "O gráfico de bolhas requer pelo menos 2 colunas: Eixo X, Eixo Y"
    },
    relation: {
    ...
    gauge: {
      label: "Etiqueta",
      value: "Valor",
      emptyDiagnostic: "O gráfico de medidor exige pelo menos um valor numérico finito.",
      mappingDiagnostic: "O gráfico de medidor exige um campo de rótulo e exatamente um campo de valor.",
      configDiagnostic: "A configuração do gráfico de medidor é inválida. Verifique a escala, os intervalos, as proporções e os tamanhos."
    },
    chord: {
    ...
    chartField: {
      ...
      invalidFieldIndex: "Um\x20campo\x20selecionado\x20do\x20gráfico\x20não\x20está\x20mais\x20disponível.",
      invalidValueFieldType: "O campo de valor selecionado não contém dados numéricos.",
