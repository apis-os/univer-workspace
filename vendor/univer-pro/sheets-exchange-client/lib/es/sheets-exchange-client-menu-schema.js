...
function W(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46163) {
  return {
    ...
    hidden$: getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46163, UniverInstanceType.UNIVER_SHEET),
    disabled$: getCurrentRangeDisable$(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46163, {
      workbookTypes: [WorkbookExportPermission]
    })
  };
}
function G() {
