...
import { var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461880 } from "./internal-core-endo.js";
const oa = {
    id: "univer.operation.toggle-edit-history",
    type: CommandType.OPERATION,
    handler: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461817 => {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461818 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461817.get(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461880),
        {
          unitId: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB20
        } = getSheetCommandTarget(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461817.get(IUniverInstanceService)) || {};
      return var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB20 ? (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461818.mountHistoryContent(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB20), true) : false;
    }
  },
  sa = {
...
export { oa as ToggleEditHistoryOperation };
export { sa };
