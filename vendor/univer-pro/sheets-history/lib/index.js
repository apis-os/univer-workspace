import { HistoryUnitAdapterRegistryService as var_core_value_sig2776, UnitComparisonAdapterRegistryService as var_core_value_sig6FB2, UnitComparisonDiagnosticCode as var_core_value_sigEB43, UnitComparisonEntityType as var_core_value_sig4186, UnitComparisonReadiness as var_core_value_sigF963, UniverEditHistoryPlugin as var_core_value_sigB608, alignComparisonIdentities as var_core_value_sigF866, asRecord as var_core_value_sig5EFB, buildScopedUnitComparison as var_core_value_sig3A85, buildSemanticComparisonItems as var_core_value_sig2682, recordComparisonEntries as var_core_value_sig4BB5, resourceComparisonEntries as var_core_value_sig6709, stableJson as var_core_value_sig52CA, withoutComparisonKeys as var_core_value_sigC030 } from "@univerjs-pro/edit-history";
import { UniverLicensePlugin as var_core_value_sig88F6 } from "@univerjs-pro/license";
import { DependentOn as var_core_value_sig37DB, Disposable as var_core_value_sig5542, ICommandService as var_core_value_sigE0A9, IConfigService as var_core_value_sigA73E, IPermissionService as var_core_value_sig7620, IUniverInstanceService as var_core_value_sigB9FC, Inject as var_core_value_sig5055, Injector as var_core_value_sig3801, Plugin as var_core_value_sig45F0, UniverInstanceType as var_core_value_sigBC91, merge as var_core_value_sigCB88, registerDependencies as var_core_value_sig8D65 } from "@univerjs/core";
import { RangeProtectionPermissionEditPoint as var_core_value_sig8122, RangeProtectionRuleModel as var_core_value_sigEDC6, SelectRangeCommand as var_core_value_sig611A, SetWorksheetActivateCommand as var_core_value_sig6BD9, SheetsSelectionsService as var_core_value_sig7E56, UniverSheetsPlugin as var_core_value_sig4161, WorkbookEditablePermission as var_core_value_sig7580, WorkbookRecoverHistoryPermission as var_core_value_sig1F18, WorkbookViewHistoryPermission as var_core_value_sigD5A0, WorksheetEditPermission as var_core_value_sig81B2 } from "@univerjs/sheets";
const w = "sheets-history.config",
  pe = {};
var me = "@univerjs-pro/sheets-history",
  he = "1.0.0-insiders.20260907-70fc579";
function T(var_core_value_sigCB82, var_core_value_sigCF4E) {
...
function ge(var_core_value_sig6CAD, var_core_value_sig8CF5, var_core_value_sigDDD7, var_core_value_sigB2CE) {
...
let E = class extends var_core_value_sig5542 {
  constructor(var_core_value_sigE9A7, var_core_value_sigBECE, var_core_value_sig1B22, var_core_value_sig7F72, var_core_value_sig7B2A, var_core_value_sig06CD) {
    super(), this._commandService = var_core_value_sigE9A7, this._permissionService = var_core_value_sig1B22, this._univerInstanceService = var_core_value_sig7F72, this._selectionService = var_core_value_sig7B2A, this._rangeProtectionRuleModel = var_core_value_sig06CD, this.disposeWithMe(var_core_value_sigBECE.register({
      type: var_core_value_sigBC91.UNIVER_SHEET,
      canView: var_core_value_sig4383 => this._hasPermission(new var_core_value_sigD5A0(var_core_value_sig4383).id),
      ...
      restoreLocation: (var_core_value_sig48BD, var_core_value_sig429F) => this._restoreLocation(var_core_value_sig48BD, _e(var_core_value_sig429F) ? var_core_value_sig429F : undefined)
    }));
  }
  _captureLocation(var_core_value_sigA5F1) {
    var var_core_value_sig97A2;
    let var_core_value_sig07E9 = this._univerInstanceService["getUnit"](var_core_value_sigA5F1, var_core_value_sigBC91.UNIVER_SHEET),
  ...
  async _restoreLocation(var_core_value_sigF564, var_core_value_sig8CFA) {
    var_core_value_sig8CFA && (await this._commandService["executeCommand"](var_core_value_sig6BD9.id, {
      unitId: var_core_value_sigF564,
      subUnitId: var_core_value_sig8CFA.subUnitId
    }), var_core_value_sig8CFA.range && (await this._commandService["executeCommand"](var_core_value_sig611A.id, {
      unitId: var_core_value_sigF564,
  ...
  _canRevert(var_core_value_sig5B69) {
    let var_core_value_sigB098 = this._univerInstanceService["getUnit"](var_core_value_sig5B69, var_core_value_sigBC91.UNIVER_SHEET);
    ...
    let var_core_value_sigCE71 = var_core_value_sigB098.getSheets().map(var_core_value_sig8178 => var_core_value_sig8178.getSheetId()),
      var_core_value_sig21D8 = var_core_value_sigCE71.map(var_core_value_sigE9ED => new var_core_value_sig81B2(var_core_value_sig5B69, var_core_value_sigE9ED).id),
      var_core_value_sig2B65 = var_core_value_sigCE71.flatMap(var_core_value_sigB577 => this._rangeProtectionRuleModel["getSubunitRuleList"](var_core_value_sig5B69, var_core_value_sigB577).map(var_core_value_sig27E5 => new var_core_value_sig8122(var_core_value_sig5B69, var_core_value_sigB577, var_core_value_sig27E5.permissionId).id)),
      var_core_value_sigD7EA = [new var_core_value_sig7580(var_core_value_sig5B69).id, ...var_core_value_sig21D8, ...var_core_value_sig2B65, new var_core_value_sig1F18(var_core_value_sig5B69).id];
...
E = ge([T(0, var_core_value_sigE0A9), T(1, var_core_value_sig5055(var_core_value_sig2776)), T(2, var_core_value_sig7620), T(3, var_core_value_sigB9FC), T(4, var_core_value_sig5055(var_core_value_sig7E56)), T(5, var_core_value_sig5055(var_core_value_sigEDC6))], E);
...
function D(var_core_value_sig63F3) {
  "@babel/helpers - typeof";

  return D = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sigB33B) {
  ...
  }, D(var_core_value_sig63F3);
}
function ve(var_core_value_sig6A71, var_core_value_sig3BF6) {
  if (D(var_core_value_sig6A71) != "object" || !var_core_value_sig6A71) return var_core_value_sig6A71;
  ...
  if (var_core_value_sig38CE !== undefined) {
    ...
    if (D(var_core_value_sig62B7) != "object") return var_core_value_sig62B7;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig3BF6 === "string" ? String : Number)(var_core_value_sig6A71);
}
function ye(var_core_value_sig37A8) {
  var var_core_value_sigA90D = ve(var_core_value_sig37A8, "string");
  return D(var_core_value_sigA90D) == "symbol" ? var_core_value_sigA90D : var_core_value_sigA90D + "";
}
function O(var_core_value_sig7A3C, var_core_value_sig0511, var_core_value_sig1F44) {
  return (var_core_value_sig0511 = ye(var_core_value_sig0511)) in var_core_value_sig7A3C ? Object.defineProperty(var_core_value_sig7A3C, var_core_value_sig0511, {
...
const be = [var_core_value_sig4186.WORKBOOK, var_core_value_sig4186.WORKSHEET, var_core_value_sig4186.CELL, var_core_value_sig4186.ROW_COLUMN, var_core_value_sig4186.CONDITION_FORMAT, var_core_value_sig4186.DATA_VALIDATION, var_core_value_sig4186.SPARKLINE, var_core_value_sig4186.TABLE, var_core_value_sig4186.SHAPE, var_core_value_sig4186.CHART, var_core_value_sig4186.PIVOT],
  xe = [[var_core_value_sig4186.CONDITION_FORMAT, "SHEET_CONDITIONAL_FORMATTING_PLUGIN"], [var_core_value_sig4186.DATA_VALIDATION, "SHEET_DATA_VALIDATION_PLUGIN"], [var_core_value_sig4186.SPARKLINE, "SHEET_SPARKLINE_PLUGIN"], [var_core_value_sig4186.TABLE, "SHEET_TABLE_PLUGIN"], [var_core_value_sig4186.SHAPE, "SHEET_DRAWING_PLUGIN"], [var_core_value_sig4186.CHART, "SHEET_CHART_PLUGIN"], [var_core_value_sig4186.PIVOT, "SHEET_PIVOT_TABLE_PLUGIN"]],
...
var j = class {
  constructor() {
    O(this, "type", var_core_value_sigBC91.UNIVER_SHEET);
  }
  compare(var_core_value_sigE627) {
    let var_core_value_sigEF3E = Ce(var_core_value_sigE627.leftData),
      var_core_value_sig273D = Ce(var_core_value_sigE627.rightData),
      var_core_value_sig9A0D = var_core_value_sig5EFB(var_core_value_sigEF3E == null ? undefined : var_core_value_sigEF3E.sheets),
      var_core_value_sigA319 = var_core_value_sig5EFB(var_core_value_sig273D == null ? undefined : var_core_value_sig273D.sheets),
      var_core_value_sig2D58 = var_core_value_sigC030("cellData", "rowData", "columnData"),
      var_core_value_sig223F = var_core_value_sig4BB5(var_core_value_sig9A0D, var_core_value_sigEF3E == null ? undefined : var_core_value_sigEF3E.sheetOrder, var_core_value_sig2D58),
      var_core_value_sigD749 = var_core_value_sig4BB5(var_core_value_sigA319, var_core_value_sig273D == null ? undefined : var_core_value_sig273D.sheetOrder, var_core_value_sig2D58),
      var_core_value_sigCFFA = new Set([...Object.keys(var_core_value_sig9A0D ?? {}), ...Object.keys(var_core_value_sigA319 ?? {})]),
      var_core_value_sig58C1 = Fe(var_core_value_sigE627.leftChangesets, var_core_value_sigEF3E),
      var_core_value_sig5090 = Fe(var_core_value_sigE627.rightChangesets, var_core_value_sig273D),
      var_core_value_sigC368 = [...var_core_value_sig58C1, ...var_core_value_sig5090].some(var_core_value_sigD873 => Se.has(var_core_value_sigD873.id)),
      var_core_value_sigAD56 = [...var_core_value_sigCFFA].map(var_core_value_sigA12B => Oe(var_core_value_sigA12B, var_core_value_sig9A0D, var_core_value_sigA319, var_core_value_sig58C1, var_core_value_sig5090, var_core_value_sigC368)),
      var_core_value_sigDB4A = [...we(var_core_value_sigEF3E, var_core_value_sig273D, var_core_value_sig9A0D, var_core_value_sigA319), ...var_core_value_sigAD56.flatMap(var_core_value_sigF230 => var_core_value_sigF230.items), ...xe.flatMap(([var_core_value_sig09B8, var_core_value_sig6F91]) => Te(var_core_value_sig09B8, var_core_value_sig6F91, var_core_value_sigE627.leftData, var_core_value_sigE627.rightData, [...var_core_value_sigCFFA]))],
      var_core_value_sig6418 = [...new Set([...J(var_core_value_sig58C1), ...J(var_core_value_sig5090), ...var_core_value_sigAD56.flatMap(var_core_value_sigF9C7 => var_core_value_sigF9C7.unsupportedMutationIds)])].sort(),
      var_core_value_sig1896 = [...var_core_value_sigCFFA].flatMap((var_core_value_sig8895, var_core_value_sigC80B) => {
        let var_core_value_sig284F = var_core_value_sigDB4A.filter(var_core_value_sig8061 => var_core_value_sig8061.parentStableId === var_core_value_sig8895 || var_core_value_sig8061.entityType === var_core_value_sig4186.WORKSHEET && var_core_value_sig8061.stableId === var_core_value_sig8895).length;
        if (!var_core_value_sig284F) return [];
        let var_core_value_sigE154 = var_core_value_sig5EFB(var_core_value_sig9A0D == null ? undefined : var_core_value_sig9A0D[var_core_value_sig8895]),
          var_core_value_sig4632 = var_core_value_sig5EFB(var_core_value_sigA319 == null ? undefined : var_core_value_sigA319[var_core_value_sig8895]);
        return [{
      ...
      var_core_value_sig777D = var_core_value_sig3A85({
        entityType: var_core_value_sig4186.WORKSHEET,
    ...
    return {
      ...
      ...(var_core_value_sig6418.length || var_core_value_sig0285 ? {
        ...
        readiness: var_core_value_sigF963.DEGRADED,
        diagnosticCodes: [...(var_core_value_sig6418.length ? [var_core_value_sigEB43.SHEET_STRUCTURAL_HISTORY_FALLBACK] : []), ...(var_core_value_sig0285 ? [var_core_value_sigEB43.SHEET_SNAPSHOT_AXIS_IDENTITY_AMBIGUOUS] : [])]
      } : {})
    };
  }
};
function Ce(var_core_value_sigCB04) {
  let var_core_value_sig947E = var_core_value_sig5EFB(var_core_value_sigCB04);
  if (var_core_value_sig947E === undefined) return;
  let var_core_value_sig4545 = var_core_value_sig5EFB(var_core_value_sig947E.styles) ?? {},
    {
      styles: var_core_value_sigF39A,
      ...var_core_value_sigF79C
    } = N(var_core_value_sig947E, var_core_value_sig4545, "defaultStyle");
  return {
    ...var_core_value_sigF79C,
    ...(var_core_value_sig947E.sheets === undefined ? {} : {
      sheets: P(var_core_value_sig947E.sheets, var_core_value_sig3F4C => {
        let var_core_value_sigD65A = var_core_value_sig5EFB(var_core_value_sig3F4C);
        return var_core_value_sigD65A === undefined ? var_core_value_sig3F4C : {
          ...N(var_core_value_sigD65A, var_core_value_sig4545, "defaultStyle"),
          ...(var_core_value_sigD65A.cellData === undefined ? {} : {
            cellData: P(var_core_value_sigD65A.cellData, var_core_value_sig2259 => P(var_core_value_sig2259, var_core_value_sig4D4C => M(var_core_value_sig4D4C, var_core_value_sig4545)))
          }),
          ...(var_core_value_sigD65A.rowData === undefined ? {} : {
            rowData: P(var_core_value_sigD65A.rowData, var_core_value_sig9E2F => M(var_core_value_sig9E2F, var_core_value_sig4545))
          }),
          ...(var_core_value_sigD65A.columnData === undefined ? {} : {
            columnData: P(var_core_value_sigD65A.columnData, var_core_value_sigD082 => M(var_core_value_sigD082, var_core_value_sig4545))
          })
        };
      })
    })
...
function M(var_core_value_sig2E54, var_core_value_sig7658) {
  let var_core_value_sigDCF5 = var_core_value_sig5EFB(var_core_value_sig2E54);
  return var_core_value_sigDCF5 === undefined ? var_core_value_sig2E54 : N(var_core_value_sigDCF5, var_core_value_sig7658, "s");
}
function N(var_core_value_sigC786, var_core_value_sigC0D9, var_core_value_sigF051) {
...
function P(var_core_value_sig4EB7, var_core_value_sig73AF) {
  let var_core_value_sig548A = var_core_value_sig5EFB(var_core_value_sig4EB7);
...
function we(var_core_value_sigE026, var_core_value_sig339E, var_core_value_sig7550, var_core_value_sig2983) {
  return [...var_core_value_sig2682({
    entityType: var_core_value_sig4186.WORKBOOK,
    left: var_core_value_sigE026 === undefined ? [] : [{
      stableId: "workbook",
      position: 0,
      value: var_core_value_sigC030("sheets", "sheetOrder", "resources", "rev")(var_core_value_sigE026)
    }],
    right: var_core_value_sig339E === undefined ? [] : [{
      stableId: "workbook",
      position: 0,
      value: var_core_value_sigC030("sheets", "sheetOrder", "resources", "rev")(var_core_value_sig339E)
    }]
  }), ...var_core_value_sig2682({
    entityType: var_core_value_sig4186.WORKSHEET,
    left: var_core_value_sig4BB5(var_core_value_sig7550, var_core_value_sigE026 == null ? undefined : var_core_value_sigE026.sheetOrder, var_core_value_sigC030("cellData", "rowData", "columnData")),
    right: var_core_value_sig4BB5(var_core_value_sig2983, var_core_value_sig339E == null ? undefined : var_core_value_sig339E.sheetOrder, var_core_value_sigC030("cellData", "rowData", "columnData"))
  })];
}
function Te(var_core_value_sigE1B0, var_core_value_sigD4FF, var_core_value_sig1E5B, var_core_value_sigB680, var_core_value_sig1F64) {
  let var_core_value_sigDD1C = L(var_core_value_sig1E5B, var_core_value_sigD4FF),
    var_core_value_sig2C39 = L(var_core_value_sigB680, var_core_value_sigD4FF);
  return var_core_value_sig1F64.some(var_core_value_sig3607 => R(var_core_value_sigDD1C, var_core_value_sig3607) || R(var_core_value_sig2C39, var_core_value_sig3607)) ? var_core_value_sig1F64.flatMap(var_core_value_sigB512 => var_core_value_sig2682({
    entityType: var_core_value_sigE1B0,
    parentStableId: var_core_value_sigB512,
    left: z(var_core_value_sigDD1C, var_core_value_sigB512, var_core_value_sigE1B0),
    right: z(var_core_value_sig2C39, var_core_value_sigB512, var_core_value_sigE1B0)
  }).map(F)) : var_core_value_sig2682({
    entityType: var_core_value_sigE1B0,
    left: var_core_value_sig6709(var_core_value_sig1E5B, var_core_value_sigD4FF),
    right: var_core_value_sig6709(var_core_value_sigB680, var_core_value_sigD4FF)
  }).map(F);
}
function F(var_core_value_sigB7D1) {
  let var_core_value_sig64F0 = var_core_value_sigF2E6 => {
    ...
    let var_core_value_sigB744 = var_core_value_sigB7D1.locations[var_core_value_sigF2E6],
      var_core_value_sigEAE2 = var_core_value_sig5EFB((var_core_value_sig34C8 = var_core_value_sigB7D1.values) == null ? undefined : var_core_value_sig34C8[var_core_value_sigF2E6]);
    if (var_core_value_sigB744 === null || var_core_value_sigEAE2 === undefined) return var_core_value_sigB744;
    let var_core_value_sigE68A = var_core_value_sig5EFB(var_core_value_sigEAE2.range),
      ...
      var_core_value_sig5410 = I(var_core_value_sigE68A),
      var_core_value_sig492F = var_core_value_sig3E68 == null ? undefined : var_core_value_sig3E68.map(I).filter(var_core_value_sigDBB7 => var_core_value_sigDBB7 !== undefined);
...
function I(var_core_value_sig85B1) {
  let var_core_value_sig3141 = var_core_value_sig5EFB(var_core_value_sig85B1);
...
function L(var_core_value_sig2162, var_core_value_sig2EAD) {
  ...
  let var_core_value_sig340D = Ee(var_core_value_sig2162, var_core_value_sig2EAD),
    var_core_value_sig82D4 = var_core_value_sig5EFB(var_core_value_sig340D);
  if (var_core_value_sig82D4 === undefined) return var_core_value_sig340D;
  let var_core_value_sigBDE4 = (var_core_value_sig6774 = var_core_value_sig5EFB(var_core_value_sig2162)) == null ? undefined : var_core_value_sig6774.id;
  if (var_core_value_sig2EAD === "SHEET_SPARKLINE_PLUGIN" && typeof var_core_value_sigBDE4 == "string" && var_core_value_sig5EFB(var_core_value_sig82D4[var_core_value_sigBDE4]) !== undefined) return var_core_value_sig82D4[var_core_value_sigBDE4];
  if (var_core_value_sig2EAD === "SHEET_TABLE_PLUGIN") return Object.fromEntries(Object.entries(var_core_value_sig82D4).map(([var_core_value_sig8EA0, var_core_value_sigA6F6]) => {
    let var_core_value_sigCDDA = var_core_value_sig5EFB(var_core_value_sigA6F6);
    return Array.isArray(var_core_value_sigCDDA == null ? undefined : var_core_value_sigCDDA.tables) ? [var_core_value_sig8EA0, var_core_value_sigCDDA.tables["map"](var_core_value_sigD0A8 => {
      let var_core_value_sigF4B9 = var_core_value_sig5EFB(var_core_value_sigD0A8);
      return var_core_value_sigF4B9 === undefined ? var_core_value_sigD0A8 : {
        ...var_core_value_sigF4B9,
        columns: Array.isArray(var_core_value_sigF4B9.columns) ? var_core_value_sigF4B9.columns["map"](var_core_value_sigC030("id")) : var_core_value_sigF4B9.columns
      };
    })] : [var_core_value_sig8EA0, var_core_value_sigA6F6];
  }));
  if (var_core_value_sig2EAD === "SHEET_PIVOT_TABLE_PLUGIN" && var_core_value_sig5EFB(var_core_value_sig82D4.pivotTableConfigs) !== undefined) {
    let var_core_value_sigE243 = var_core_value_sig5EFB(var_core_value_sig82D4.pivotTableConfigs),
      var_core_value_sig74A8 = var_core_value_sig5EFB(var_core_value_sig82D4.dataFieldManagerConfig) ?? {},
    ...
    for (let [var_core_value_sig5CEE, var_core_value_sigE92A] of Object.entries(var_core_value_sigE243)) {
      ...
      let var_core_value_sigC9E0 = var_core_value_sig5EFB((var_core_value_sig7DF1 = var_core_value_sig5EFB(var_core_value_sig74A8[var_core_value_sig5CEE])) == null ? undefined : var_core_value_sig7DF1.collections) ?? {};
      for (let [var_core_value_sig2AD0, var_core_value_sig3EEE] of Object.entries(var_core_value_sig5EFB(var_core_value_sigE92A) ?? {})) var_core_value_sig21B2[var_core_value_sig2AD0] = Object.fromEntries(Object.entries(var_core_value_sig5EFB(var_core_value_sig3EEE) ?? {}).map(([var_core_value_sig7524, var_core_value_sig2AD8]) => [var_core_value_sig7524, {
        ...var_core_value_sig5EFB(var_core_value_sig2AD8),
...
function Ee(var_core_value_sigDC86, var_core_value_sig0B0C) {
  var var_core_value_sigA39E;
  let var_core_value_sigBBEE = (Array.isArray((var_core_value_sigA39E = var_core_value_sig5EFB(var_core_value_sigDC86)) == null ? undefined : var_core_value_sigA39E.resources) ? var_core_value_sig5EFB(var_core_value_sigDC86).resources : []).map(var_core_value_sig5EFB).find(var_core_value_sigDE08 => (var_core_value_sigDE08 == null ? undefined : var_core_value_sigDE08.name) === var_core_value_sig0B0C);
...
function R(var_core_value_sig011D, var_core_value_sig6167) {
  let var_core_value_sig65A1 = var_core_value_sig5EFB(var_core_value_sig011D);
  return var_core_value_sig65A1 !== undefined && (Object.prototype["hasOwnProperty"].call(var_core_value_sig65A1, var_core_value_sig6167) || Object.values(var_core_value_sig65A1).some(var_core_value_sigACCB => {
    let var_core_value_sig7F33 = var_core_value_sig5EFB(var_core_value_sigACCB);
...
function z(var_core_value_sig7F19, var_core_value_sig7827, var_core_value_sig652C) {
  let var_core_value_sig7E32 = var_core_value_sig5EFB(var_core_value_sig7F19);
  return var_core_value_sig7E32 === undefined ? [] : Object.prototype["hasOwnProperty"].call(var_core_value_sig7E32, var_core_value_sig7827) ? var_core_value_sig652C === var_core_value_sig4186.SHAPE ? De(var_core_value_sig7E32[var_core_value_sig7827]) : B(var_core_value_sig7E32[var_core_value_sig7827]) : B(Object.fromEntries(Object.entries(var_core_value_sig7E32).filter(([, var_core_value_sig0C53]) => {
    let var_core_value_sigEA04 = var_core_value_sig5EFB(var_core_value_sig0C53);
...
function De(var_core_value_sig4C07) {
  let var_core_value_sig79AB = var_core_value_sig5EFB(var_core_value_sig4C07),
    var_core_value_sig8E74 = var_core_value_sig5EFB(var_core_value_sig79AB == null ? undefined : var_core_value_sig79AB.data);
  return var_core_value_sig8E74 === undefined ? B(var_core_value_sig4C07) : var_core_value_sig4BB5(var_core_value_sig8E74, Array.isArray(var_core_value_sig79AB == null ? undefined : var_core_value_sig79AB.order) ? var_core_value_sig79AB.order["filter"](var_core_value_sig7A62 => typeof var_core_value_sig7A62 == "string") : undefined);
}
function B(var_core_value_sig104C) {
  return (Array.isArray(var_core_value_sig104C) ? var_core_value_sig104C.map((var_core_value_sig8109, var_core_value_sig7565) => [String(var_core_value_sig7565), var_core_value_sig8109]) : var_core_value_sig4BB5(var_core_value_sig104C, undefined).map(var_core_value_sigD4FB => [var_core_value_sigD4FB.stableId, var_core_value_sigD4FB.value])).map(([var_core_value_sig3E71, var_core_value_sig01B3], var_core_value_sig7442) => {
    var var_core_value_sigDF87, var_core_value_sig9EE0, var_core_value_sigF0511;
    let var_core_value_sig0B45 = var_core_value_sig5EFB(var_core_value_sig01B3),
      ...
      var_core_value_sig03E1 = [var_core_value_sig0B45 == null ? undefined : var_core_value_sig0B45.name, var_core_value_sig0B45 == null ? undefined : var_core_value_sig0B45.title, (var_core_value_sigDF87 = var_core_value_sig5EFB((var_core_value_sig9EE0 = var_core_value_sig5EFB((var_core_value_sigF0511 = var_core_value_sig5EFB(var_core_value_sig0B45 == null ? undefined : var_core_value_sig0B45.style)) == null ? undefined : var_core_value_sigF0511.titles)) == null ? undefined : var_core_value_sig9EE0.title)) == null ? undefined : var_core_value_sigDF87.content].find(var_core_value_sigE90F => typeof var_core_value_sigE90F == "string");
    return {
...
function Oe(var_core_value_sig841D, var_core_value_sig90CB, var_core_value_sigBDF5, var_core_value_sigACC6, var_core_value_sig1614, var_core_value_sig85C3) {
  let var_core_value_sigB996 = var_core_value_sig5EFB(var_core_value_sig90CB == null ? undefined : var_core_value_sig90CB[var_core_value_sig841D]),
    var_core_value_sig4BBA = var_core_value_sig5EFB(var_core_value_sigBDF5 == null ? undefined : var_core_value_sigBDF5[var_core_value_sig841D]),
    var_core_value_sig6201 = ke(var_core_value_sigB996, var_core_value_sig4BBA, var_core_value_sig841D, var_core_value_sigACC6, var_core_value_sig1614, var_core_value_sig85C3),
    var_core_value_sig5151 = var_core_value_sig6201.leftRows === undefined ? V(var_core_value_sigB996, var_core_value_sig4BBA, "row") : undefined,
    var_core_value_sigB542 = var_core_value_sig6201.leftColumns === undefined ? V(var_core_value_sigB996, var_core_value_sig4BBA, "column") : undefined,
  ...
  return {
    ...
    items: [...var_core_value_sig2682({
      entityType: var_core_value_sig4186.CELL,
      parentStableId: var_core_value_sig841D,
      left: K(var_core_value_sigB996 == null ? undefined : var_core_value_sigB996.cellData, var_core_value_sigBB6C.leftRows, var_core_value_sigBB6C.leftColumns),
      right: K(var_core_value_sig4BBA == null ? undefined : var_core_value_sig4BBA.cellData, var_core_value_sigBB6C.rightRows, var_core_value_sigBB6C.rightColumns)
    }), ...q(var_core_value_sig841D, "row", var_core_value_sigB996 == null ? undefined : var_core_value_sigB996.rowData, var_core_value_sig4BBA == null ? undefined : var_core_value_sig4BBA.rowData, var_core_value_sigBB6C.leftRows, var_core_value_sigBB6C.rightRows), ...q(var_core_value_sig841D, "column", var_core_value_sigB996 == null ? undefined : var_core_value_sigB996.columnData, var_core_value_sig4BBA == null ? undefined : var_core_value_sig4BBA.columnData, var_core_value_sigBB6C.leftColumns, var_core_value_sigBB6C.rightColumns)],
    unsupportedMutationIds: var_core_value_sigBB6C.unsupportedMutationIds,
    rows: W(var_core_value_sigBB6C.leftRows, var_core_value_sigBB6C.rightRows, Z(var_core_value_sigB996, "row"), Z(var_core_value_sig4BBA, "row")),
    columns: W(var_core_value_sigBB6C.leftColumns, var_core_value_sigBB6C.rightColumns, Z(var_core_value_sigB996, "column"), Z(var_core_value_sig4BBA, "column"))
  };
}
function V(var_core_value_sigE2BF, var_core_value_sigB8C7, var_core_value_sigA56E) {
  if (var_core_value_sigE2BF === undefined || var_core_value_sigB8C7 === undefined) return;
  let var_core_value_sig1998 = H(var_core_value_sigE2BF, var_core_value_sigA56E),
    var_core_value_sigFF19 = H(var_core_value_sigB8C7, var_core_value_sigA56E);
  ...
  let var_core_value_sig43B8 = var_core_value_sig1998 < var_core_value_sigFF19,
    ...
    var_core_value_sig9D15 = U(var_core_value_sig43B8 ? var_core_value_sigE2BF : var_core_value_sigB8C7, var_core_value_sigA56E, var_core_value_sigD98F),
    var_core_value_sigB785 = U(var_core_value_sig43B8 ? var_core_value_sigB8C7 : var_core_value_sigE2BF, var_core_value_sigA56E, var_core_value_sigD98F + var_core_value_sig66C0),
  ...
  return X(var_core_value_sig4E3D, var_core_value_sigDE3D, 0, [{
...
function H(var_core_value_sig49B0, var_core_value_sig2547) {
...
function U(var_core_value_sig4CDF, var_core_value_sig3F79, var_core_value_sig880E) {
  let var_core_value_sigC9ED = new Map();
  for (let [var_core_value_sig9F76, var_core_value_sigB008] of Object.entries(var_core_value_sig5EFB(var_core_value_sig4CDF.cellData) ?? {})) for (let [var_core_value_sig5237, var_core_value_sigBB00] of Object.entries(var_core_value_sig5EFB(var_core_value_sigB008) ?? {})) {
  ...
  let var_core_value_sigB57B = var_core_value_sig5EFB(var_core_value_sig3F79 === "row" ? var_core_value_sig4CDF.rowData : var_core_value_sig4CDF.columnData) ?? {},
    var_core_value_sig780B = new Set([...var_core_value_sigC9ED.keys(), ...Object.keys(var_core_value_sigB57B).map(Number)]);
  return new Map([...var_core_value_sig780B].filter(var_core_value_sig8721 => Number.isInteger(var_core_value_sig8721) && var_core_value_sig8721 >= 0 && var_core_value_sig8721 < var_core_value_sig880E).map(var_core_value_sig08BA => [var_core_value_sig08BA, var_core_value_sig52CA({
...
function W(var_core_value_sig7D1B, var_core_value_sig7BE0, var_core_value_sig7D40, var_core_value_sig6C7E) {
  ...
  return var_core_value_sigF866(var_core_value_sigD04E.map(var_core_value_sig3C5B => var_core_value_sig3C5B.id), var_core_value_sigB99B.map(var_core_value_sig200B => var_core_value_sig200B.id)).map(var_core_value_sig3863 => ({
...
function ke(var_core_value_sig5A75, var_core_value_sig7BAF, var_core_value_sig8F69, var_core_value_sig6884, var_core_value_sig066E, var_core_value_sig9B0D) {
  if (!var_core_value_sig9B0D || var_core_value_sig5A75 === undefined || var_core_value_sig7BAF === undefined) return {
    unsupportedMutationIds: []
  };
  let var_core_value_sig3D2C = Y(var_core_value_sig5A75, var_core_value_sig8F69, "row", var_core_value_sig6884),
    var_core_value_sigC56D = Y(var_core_value_sig7BAF, var_core_value_sig8F69, "row", var_core_value_sig066E),
    var_core_value_sig3A17 = Y(var_core_value_sig5A75, var_core_value_sig8F69, "column", var_core_value_sig6884),
    var_core_value_sig938F = Y(var_core_value_sig7BAF, var_core_value_sig8F69, "column", var_core_value_sig066E),
  ...
  return {
    ...
    unsupportedMutationIds: [...var_core_value_sig3D2C.unsupportedMutationIds, ...var_core_value_sigC56D.unsupportedMutationIds, ...var_core_value_sig3A17.unsupportedMutationIds, ...var_core_value_sig938F.unsupportedMutationIds, ...(var_core_value_sigD948 ? [] : G(var_core_value_sig6884, var_core_value_sig066E, var_core_value_sig8F69, "row")), ...(var_core_value_sigBE5E ? [] : G(var_core_value_sig6884, var_core_value_sig066E, var_core_value_sig8F69, "column"))]
  };
}
function G(var_core_value_sig0281, var_core_value_sigED71, var_core_value_sig281C, var_core_value_sig3C92) {
  return [...var_core_value_sig0281, ...var_core_value_sigED71].filter(var_core_value_sigC97C => var_core_value_sigC97C.params["subUnitId"] === var_core_value_sig281C && ze(var_core_value_sigC97C.id, var_core_value_sig3C92)).map(var_core_value_sigC4B1 => var_core_value_sigC4B1.id);
}
function K(var_core_value_sigB16B, var_core_value_sig585D, var_core_value_sigE722) {
  let var_core_value_sig062A = var_core_value_sig5EFB(var_core_value_sigB16B) ?? {};
  return Object.keys(var_core_value_sig062A).map(Number).filter(Number.isInteger).sort((var_core_value_sig1BD9, var_core_value_sigE43E) => var_core_value_sig1BD9 - var_core_value_sigE43E).flatMap(var_core_value_sigA937 => {
    let var_core_value_sigCAD5 = var_core_value_sig5EFB(var_core_value_sig062A[String(var_core_value_sigA937)]) ?? {};
...
function Ae(var_core_value_sig050A) {
  let var_core_value_sig8B32 = var_core_value_sig5EFB(var_core_value_sig050A);
...
function q(var_core_value_sig6A78, var_core_value_sigF7EF, var_core_value_sig27F9, var_core_value_sig393E, var_core_value_sigB609, var_core_value_sig390D) {
  ...
  for (let [var_core_value_sigE503, var_core_value_sig48DD] of [[var_core_value_sigB609, var_core_value_sig27F9], [var_core_value_sig390D, var_core_value_sig393E]]) {
    ...
    for (let var_core_value_sig480E of Object.keys(var_core_value_sig5EFB(var_core_value_sig48DD) ?? {}).map(Number).filter(Number.isSafeInteger)) {
      let var_core_value_sig3D7D = Ne(var_core_value_sigE503, var_core_value_sig480E);
  ...
  let var_core_value_sig39B7 = new Map([...var_core_value_sigC928].map(([var_core_value_sig5E6A, var_core_value_sigB7FC]) => [var_core_value_sig5E6A, [...var_core_value_sigB7FC].sort((var_core_value_sig8889, var_core_value_sig32F8) => var_core_value_sig8889 - var_core_value_sig32F8)])),
    var_core_value_sig18E0 = Me(var_core_value_sig27F9, var_core_value_sigF7EF, var_core_value_sigB609, var_core_value_sig39B7),
    var_core_value_sigE161 = Me(var_core_value_sig393E, var_core_value_sigF7EF, var_core_value_sig390D, var_core_value_sig39B7),
  ...
  return var_core_value_sig2682({
    entityType: var_core_value_sig4186.ROW_COLUMN,
    ...
    locations: {
      left: je(var_core_value_sig849B.locations["left"], var_core_value_sigBDEE.get(var_core_value_sig849B.stableId), var_core_value_sigF7EF),
      right: je(var_core_value_sig849B.locations["right"], var_core_value_sig1F40.get(var_core_value_sig849B.stableId), var_core_value_sigF7EF)
    }
  }));
}
function je(var_core_value_sig3FC7, var_core_value_sig1E1B, var_core_value_sig3B10) {
...
function Me(var_core_value_sig4743, var_core_value_sigEB6A, var_core_value_sig3D46, var_core_value_sigCC93) {
  let var_core_value_sig5964 = var_core_value_sig5EFB(var_core_value_sig4743) ?? {};
...
function Pe(var_core_value_sig8FD9, var_core_value_sig1AE5) {
  let var_core_value_sig7100 = Ne(var_core_value_sig8FD9, var_core_value_sig1AE5);
  return var_core_value_sig7100 === undefined ? undefined : var_core_value_sig7100.prefix + ":" + var_core_value_sig7100.start;
}
function Fe(var_core_value_sigA19A, var_core_value_sigD3F5) {
  ...
  return var_core_value_sigA19A.flatMap(var_core_value_sig4313 => {
    ...
    let var_core_value_sig156F = (var_core_value_sigFC87 = var_core_value_sig5EFB(var_core_value_sig4313)) == null ? undefined : var_core_value_sigFC87.mutations;
    return (Array.isArray(var_core_value_sig156F) ? var_core_value_sig156F : []).flatMap(var_core_value_sig9989 => {
      let var_core_value_sig698E = var_core_value_sig5EFB(var_core_value_sig9989);
      if (typeof (var_core_value_sig698E == null ? undefined : var_core_value_sig698E.id) != "string") return [];
      var_core_value_sigF5D1 ??= Ve(var_core_value_sig52CA({
      ...
      return var_core_value_sig3082 += 1, [{
        ...
        params: Ie(var_core_value_sig698E.data),
        sequence: var_core_value_sig2809
      }];
    });
  });
}
function Ie(var_core_value_sig8775) {
  if (typeof var_core_value_sig8775 != "string") return var_core_value_sig5EFB(var_core_value_sig8775) ?? {};
  try {
    return var_core_value_sig5EFB(JSON.parse(var_core_value_sig8775)) ?? {};
  } catch {
    return {};
  }
}
function J(var_core_value_sig481B) {
  return var_core_value_sig481B.map(var_core_value_sigDD51 => var_core_value_sigDD51.id).filter(var_core_value_sigF057 => A.test(var_core_value_sigF057) && !k.has(var_core_value_sigF057));
}
function Y(var_core_value_sig13D7, var_core_value_sig90C0, var_core_value_sigF1B2, var_core_value_sigC2BB) {
  let var_core_value_sigD9DB = var_core_value_sigC2BB.filter(var_core_value_sig72F6 => var_core_value_sig72F6.params["subUnitId"] === var_core_value_sig90C0 && ze(var_core_value_sig72F6.id, var_core_value_sigF1B2)),
    var_core_value_sigA363 = Z(var_core_value_sig13D7, var_core_value_sigF1B2),
    var_core_value_sigFBA5 = var_core_value_sigC2BB.filter(var_core_value_sig9FBA => var_core_value_sig9FBA.id !== "sheet.mutation.insert-sheet" && var_core_value_sig9FBA.id !== "sheet.mutation.remove-sheet" && (var_core_value_sig9FBA.params["subUnitId"] === undefined || var_core_value_sig9FBA.params["subUnitId"] === var_core_value_sig90C0) && A.test(var_core_value_sig9FBA.id) && (!k.has(var_core_value_sig9FBA.id) || typeof var_core_value_sig9FBA.params["subUnitId"] != "string"));
  ...
  let var_core_value_sigAC47 = var_core_value_sigA363 - var_core_value_sigD9DB.reduce((var_core_value_sigA2CE, var_core_value_sig1975) => {
    let var_core_value_sig6EA1 = Q(var_core_value_sig1975.params["range"], var_core_value_sigF1B2);
  ...
  for (let var_core_value_sig670B of var_core_value_sigD9DB) {
    if (var_core_value_sig670B.id["startsWith"]("sheet.mutation.insert-")) {
      let var_core_value_sig26DB = Q(var_core_value_sig670B.params["range"], var_core_value_sigF1B2);
      ...
      X(var_core_value_sigA06F, var_core_value_sig26DB.start, 0, [{
        prefix: var_core_value_sigF1B2 + ":insert:" + Be(var_core_value_sig670B),
        start: 0,
    ...
    if (var_core_value_sig670B.id["startsWith"]("sheet.mutation.remove-")) {
      let var_core_value_sig1A0F = Q(var_core_value_sig670B.params["range"], var_core_value_sigF1B2);
      ...
      X(var_core_value_sigA06F, var_core_value_sig1A0F.start, var_core_value_sigFBA4, []), var_core_value_sig770E -= var_core_value_sigFBA4;
      continue;
    }
    if (!Le(var_core_value_sigA06F, var_core_value_sig670B, var_core_value_sigF1B2, var_core_value_sig770E)) return {
      unsupportedMutationIds: [var_core_value_sig670B.id]
    };
  }
...
function Le(var_core_value_sig4654, var_core_value_sigB26B, var_core_value_sig019B, var_core_value_sigC6BC) {
  let var_core_value_sig8EC2 = Q(var_core_value_sigB26B.params["sourceRange"], var_core_value_sig019B),
    var_core_value_sigA8C3 = Q(var_core_value_sigB26B.params["targetRange"], var_core_value_sig019B);
  ...
  let var_core_value_sig5276 = var_core_value_sig8EC2.end - var_core_value_sig8EC2.start + 1,
    var_core_value_sig031B = X(var_core_value_sig4654, var_core_value_sig8EC2.start, var_core_value_sig5276, []);
  return X(var_core_value_sig4654, var_core_value_sigA8C3.start > var_core_value_sig8EC2.start ? var_core_value_sigA8C3.start - var_core_value_sig5276 : var_core_value_sigA8C3.start, 0, var_core_value_sig031B), true;
}
function X(var_core_value_sig9DC0, var_core_value_sig95F0, var_core_value_sig9CCB, var_core_value_sigE718) {
  let var_core_value_sigAEC8 = Re(var_core_value_sig9DC0, var_core_value_sig95F0),
    var_core_value_sigB977 = Re(var_core_value_sig9DC0, var_core_value_sig95F0 + var_core_value_sig9CCB);
...
function Re(var_core_value_sig2949, var_core_value_sig308A) {
...
function ze(var_core_value_sigA309, var_core_value_sig9E20) {
...
function Z(var_core_value_sig26BB, var_core_value_sig19B4) {
  let var_core_value_sig218A = var_core_value_sig26BB == null ? undefined : var_core_value_sig26BB[var_core_value_sig19B4 === "row" ? "rowCount" : "columnCount"],
    var_core_value_sig14CB = var_core_value_sig5EFB(var_core_value_sig26BB == null ? undefined : var_core_value_sig26BB[var_core_value_sig19B4 === "row" ? "rowData" : "columnData"]),
    var_core_value_sigFDEE = var_core_value_sig5EFB(var_core_value_sig26BB == null ? undefined : var_core_value_sig26BB.cellData),
    var_core_value_sigA676 = var_core_value_sig19B4 === "row" ? Object.keys(var_core_value_sigFDEE ?? {}).map(Number) : Object.values(var_core_value_sigFDEE ?? {}).flatMap(var_core_value_sig7664 => Object.keys(var_core_value_sig5EFB(var_core_value_sig7664) ?? {}).map(Number));
...
function Q(var_core_value_sigC27E, var_core_value_sigA70D) {
  let var_core_value_sigCE10 = var_core_value_sig5EFB(var_core_value_sigC27E),
...
function Be(var_core_value_sig44DD) {
  return Ve(var_core_value_sig52CA({
...
function Ve(var_core_value_sig96FA) {
...
function He(var_core_value_sig040A, var_core_value_sig2AE0) {
...
let $ = class extends var_core_value_sig45F0 {
  constructor(var_core_value_sigF639 = pe, var_core_value_sigEAE5, var_core_value_sigE94C) {
    ...
    } = var_core_value_sigCB88({}, pe, this._config);
    this._configService["setConfig"](w, var_core_value_sig6D47);
  }
  onStarting() {
    var_core_value_sig8D65(this._injector, [[E], [j]]), this.disposeWithMe(this._injector["get"](var_core_value_sig6FB2).register(this._injector["get"](j))), this._injector["get"](E);
  }
};
O($, "pluginName", "UNIVER_SHEETS_HISTORY_PLUGIN"), O($, "packageName", me), O($, "version", he), O($, "type", var_core_value_sigBC91.UNIVER_SHEET), $ = ge([var_core_value_sig37DB(var_core_value_sig88F6, var_core_value_sigB608, var_core_value_sig4161), T(1, var_core_value_sig5055(var_core_value_sig3801)), T(2, var_core_value_sigA73E)], $);
export { w as SHEETS_HISTORY_PLUGIN_CONFIG_KEY, j as SheetsUnitComparisonAdapter, $ as UniverSheetsHistoryPlugin };
