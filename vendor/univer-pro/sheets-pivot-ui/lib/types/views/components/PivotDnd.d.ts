...
interface IDragDropContextProps {
    ...
    onDragEnd?: (result: IDropResult) => void | Promise<void>;
}
interface IDroppableProps {
    ...
    children: (provided: {
        ...
        droppableProps: HTMLAttributes<HTMLDivElement>;
...
export declare function DragDropContext(props: IDragDropContextProps): import("react").JSX.Element;
export declare function Droppable(props: IDroppableProps): import("react").JSX.Element;
