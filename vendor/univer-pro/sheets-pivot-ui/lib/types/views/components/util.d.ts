...
export declare function formatPivotSourceFieldName(template: string, sourceFieldName: string): string;
 ...
 */
export declare function isValidPivotSourceRange(sheet: Nullable<Worksheet>, range?: IRange): PivotSourceRangeErrorEnum;
