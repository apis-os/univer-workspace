...
import type { IAddPivotFieldMutationParams, IRemovePivotFieldMutationParams, IRenamePivotFieldMutationParams, ISetPivotCollapseMutation, ISetPivotFieldFormatMutationParams, ISetPivotFilterMutationParams, ISetPivotLayoutMutationParams, ISetPivotOptionMutationParams, ISetPivotShowDataAsMutationParams, ISetPivotSortMutationParams, ISetPivotSubtotalTypeMutationParams, ISetPivotValueFilterMutationParams, IUpdateFieldPositionMutationParams, IUpdatePivotFieldSourceInfoMutationParams, IUpdateValuePositionMutationParams } from '../../const/type';
...
export declare function applySetShowDataAsChangeSet(config: IPivotTableSnapshot, change: ISetPivotShowDataAsMutationParams): void;
