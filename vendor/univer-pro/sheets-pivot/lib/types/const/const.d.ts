...
export declare const generatorAdjustPositionData: (injector: Injector, data: PivotView, pivotTableConfig: IPivotTableConfig, textInfo: Record<string, string>, direction?: "ltr" | "rtl", dateSystem?: DateSystem) => IAdjustPivotTableRes;
export declare function transFromCellValue(cellData: IPivotViewCellData, isValue: boolean, format: string | undefined, textInfo: Record<string, string>, multipleGrandTotalLabel?: string, subtotalLabel?: string, dateSystem?: DateSystem): IPivotViewValueType;
