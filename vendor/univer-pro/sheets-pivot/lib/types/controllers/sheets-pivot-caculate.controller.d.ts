...
export declare class PivotCalculatorController extends Disposable {
    ...
    constructor(_sheetsPivotDataSourceModel: SheetsPivotDataSourceModel, _featureCalculationManagerService: IFeatureCalculationManagerService, _commandService: ICommandService, _globalComputingSrv: GlobalComputingStatusService, _injector: Injector, _univerInstanceService: IUniverInstanceService, _configService: IConfigService);
    private _isAutoDateGroupEnabled;
    private _setDateSystem;
    _init(): void;
