...
export declare class SheetsPivotTableAdaptorModel extends Disposable {
    ...
    private _initDirectionChange;
    private _initUnitDisposed;
    private _initLocale;
    updateRenderCache(config: IPivotTableConfigChangeInfo, emitUpdate?: boolean): {
