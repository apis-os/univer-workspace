...
function fn_L0_core_endo_routine_pure_O1_zalloc_nothrow_sigD23F(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46753) {
  let {
    ls: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB26,
    pbk: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB27
  } = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46753.get(IConfigService).getConfig(ox416cc7) ?? {};
  return Qt(3, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB26, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB27).isPro;
}
