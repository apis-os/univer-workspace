...
import type { IAccessor, IFreeze, IRange } from '@univerjs/core';
...
export interface IPrintSheetPageInfo {
    ...
    sheetPage: number;
    /** Whether page size includes row/column header dimensions (for screenshots) */
    includeHeaderDimensions?: boolean;
}
export declare class SheetPrintCanvasView extends Disposable {
    ...
    private _viewRowBottom;
    private _viewColumnRight;
    private _container;
    private _root;
    private _skeleton;
    ...
    private _effects;
    private readonly _resourceCollector;
    private get _watermarkConfig();
    get key(): string;
    get engine(): Engine;
