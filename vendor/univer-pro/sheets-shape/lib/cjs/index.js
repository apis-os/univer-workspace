...
function o(var_core_value_sig6C7E) {
  "@babel/helpers - typeof";

  return o = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig3607) {
  ...
  }, o(var_core_value_sig6C7E);
}
function s(var_core_value_sig68BE, var_core_value_sig04C6) {
  if (o(var_core_value_sig68BE) != "object" || !var_core_value_sig68BE) return var_core_value_sig68BE;
  ...
  if (var_core_value_sigCA05 !== undefined) {
    ...
    if (o(var_core_value_sig2F2B) != "object") return var_core_value_sig2F2B;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sig04C6 === "string" ? String : Number)(var_core_value_sig68BE);
}
function c(var_core_value_sig70AF) {
  var var_core_value_sigD04E = s(var_core_value_sig70AF, "string");
  return o(var_core_value_sigD04E) == "symbol" ? var_core_value_sigD04E : var_core_value_sigD04E + "";
}
function l(var_core_value_sigB99B, var_core_value_sig5A75, var_core_value_sig7BAF) {
  return (var_core_value_sig5A75 = c(var_core_value_sig5A75)) in var_core_value_sigB99B ? Object.defineProperty(var_core_value_sigB99B, var_core_value_sig5A75, {
...
var u = class extends t.Disposable {
  constructor() {
    super(), l(this, "_shapes", new Map()), l(this, "_linesIds", new Set()), l(this, "_groupIds", new Set());
  }
  addShape(var_core_value_sigF2E6, var_core_value_sig34C8, var_core_value_sigB744, var_core_value_sigEAE2) {
    let var_core_value_sigE68A = new e["ShapeModel"](var_core_value_sigF2E6, var_core_value_sig34C8, var_core_value_sigB744, var_core_value_sigEAE2);
    return this._shapes["set"](var_core_value_sig34C8, var_core_value_sigE68A), (0, e.isConnectorShape)(var_core_value_sigF2E6) && this._linesIds["add"](var_core_value_sig34C8), var_core_value_sigE68A;
  }
  ...
  removeShape(var_core_value_sig21B2) {
    ...
    var_core_value_sigDE08 && ((0, e.isConnectorShape)(var_core_value_sigDE08.getShapeType()) && this._linesIds["delete"](var_core_value_sig21B2), this._shapes["delete"](var_core_value_sig21B2));
  }
  toJSON() {
...
function d(var_core_value_sig8F69, var_core_value_sig6884) {
...
function f(var_core_value_sig066E, var_core_value_sig9B0D, var_core_value_sig3D2C, var_core_value_sigC56D) {
...
let p = class extends t.Disposable {
  constructor(var_core_value_sig7A62) {
    super(), this._resourcesManagerService = var_core_value_sig7A62, l(this, "_shapeModelManagerMap", new Map()), this._initSnapshot();
  }
  _ensureShapeModelManager(var_core_value_sig8109, var_core_value_sig7565) {
    ...
    return var_core_value_sig3E71 || (var_core_value_sig3E71 = new u(), var_core_value_sigD4FB.set(var_core_value_sig7565, var_core_value_sig3E71)), var_core_value_sig3E71;
  }
...
const m = {
    ...
    handler: (var_core_value_sig0281, var_core_value_sigED71) => {
      ...
      return var_core_value_sig0281.get(p).insertShape(var_core_value_sig281C, var_core_value_sig3C92, var_core_value_sigB16B, var_core_value_sig585D, t.Tools["deepClone"](var_core_value_sig062A), var_core_value_sigE722), true;
    }
  },
  h = {
    ...
    handler: (var_core_value_sig050A, var_core_value_sig8B32) => {
      ...
      return var_core_value_sig050A.get(p).removeShape(var_core_value_sig870F, var_core_value_sigB683, var_core_value_sig26EC), true;
    }
  },
  g = {
    ...
    handler: (var_core_value_sigEEDB, var_core_value_sig36E7) => {
      let var_core_value_sig6A78 = (0, n.getSheetCommandTarget)(var_core_value_sigEEDB.get(t.IUniverInstanceService), var_core_value_sig36E7);
      if (!var_core_value_sig6A78) return false;
      let var_core_value_sigF7EF = var_core_value_sigEEDB.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sig390D = var_core_value_sigEEDB.get(t.ICommandService),
        var_core_value_sigC928 = var_core_value_sigEEDB.get(t.IUndoRedoService),
        var_core_value_sig39B7 = var_core_value_sigEEDB.get(n.SheetInterceptorService),
        var_core_value_sig18E0 = var_core_value_sigEEDB.get(r.ISheetDrawingService),
        var_core_value_sigE161 = var_core_value_sigEEDB.get(p),
        {
          shapeType: var_core_value_sigBDEE
        } = var_core_value_sig36E7,
        var_core_value_sig1F40 = var_core_value_sig36E7.shapeData ?? (0, e.createDefaultInsertedShapeData)(var_core_value_sigBDEE),
        var_core_value_sig3FC7 = var_core_value_sig36E7.shapeId || (0, t.generateRandomId)(),
        var_core_value_sig1E1B = {
          unitId: var_core_value_sig27F9,
          subUnitId: var_core_value_sig393E,
          shapeId: var_core_value_sig3FC7,
          shapeName: var_core_value_sig36E7.shapeName ?? (0, e.createUniqueShapeName)(var_core_value_sigBDEE, var_core_value_sigE161.getShapeDisplayNames(var_core_value_sig27F9, var_core_value_sig393E)),
          shapeType: var_core_value_sigBDEE,
      ...
      let var_core_value_sig3D46 = {
        ...
        var_core_value_sigCC93 = (0, r.transformToDrawingPosition)(var_core_value_sig3D46, var_core_value_sigB609),
        var_core_value_sig5964 = (0, r.transformToAxisAlignPosition)(var_core_value_sig3D46, var_core_value_sigB609),
      ...
      return (0, t.sequenceExecute)(var_core_value_sig1AE5, var_core_value_sig390D).result ? (var_core_value_sigC928.pushUndoRedo({
        unitID: var_core_value_sig27F9,
  ...
  _ = {
    ...
    handler: (var_core_value_sigA19A, var_core_value_sigD3F5) => {
      let {
        ...
        var_core_value_sigC2BB = var_core_value_sigA19A.get(p).getShapeModel(var_core_value_sig3082, var_core_value_sigF5D1, var_core_value_sig481B);
      if (var_core_value_sigC2BB) {
        var var_core_value_sigD9DB;
        if (!(0, e.canApplyShapeFormulaLastValue)(var_core_value_sigA19A, {
        ...
        var_core_value_sig8775 !== undefined && var_core_value_sigC2BB.setShapeType(var_core_value_sig8775), var_core_value_sig13D7 && (var_core_value_sigC2BB == null || var_core_value_sigC2BB.setShapeData(t.Tools["deepClone"](var_core_value_sig13D7), !var_core_value_sig90C0));
      }
      return true;
    }
  },
  v = {
    ...
    handler: (var_core_value_sigA363, var_core_value_sigFBA5) => {
      let var_core_value_sigAC47 = (0, n.getSheetCommandTarget)(var_core_value_sigA363.get(t.IUniverInstanceService), var_core_value_sigFBA5);
      if (!var_core_value_sigAC47) return false;
      let var_core_value_sigA06F = var_core_value_sigA363.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sig019B = var_core_value_sigA363.get(p),
        {
      ...
      let var_core_value_sig9CCB = var_core_value_sigA363.get(t.ICommandService),
        var_core_value_sigE718 = var_core_value_sigA363.get(t.IUndoRedoService),
        var_core_value_sigAEC8 = var_core_value_sigA363.get(n.SheetInterceptorService),
        var_core_value_sigB977 = var_core_value_sigA363.get(r.ISheetDrawingService),
        ...
        var_core_value_sig19B4 = (0, r.transformToDrawingPosition)(var_core_value_sig26BB, var_core_value_sigB26B),
        var_core_value_sig218A = (0, r.transformToAxisAlignPosition)(var_core_value_sig26BB, var_core_value_sigB26B),
      ...
      return (0, t.sequenceExecute)(var_core_value_sigCE10, var_core_value_sig9CCB).result ? (var_core_value_sigE718.pushUndoRedo({
        unitID: var_core_value_sig770E,
  ...
  y = {
    ...
    handler: (var_core_value_sigCD82, var_core_value_sig44DD) => {
      let var_core_value_sig96FA = (0, n.getSheetCommandTarget)(var_core_value_sigCD82.get(t.IUniverInstanceService), var_core_value_sig44DD);
      if (!var_core_value_sig96FA) return false;
      let var_core_value_sigAB68 = var_core_value_sigCD82.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sig9D96 = var_core_value_sigCD82.get(r.ISheetDrawingService),
        {
      ...
      let var_core_value_sigF963 = var_core_value_sigCD82.get(p).getShapeModel(var_core_value_sig040A, var_core_value_sig2AE0, var_core_value_sig2776);
      if (!var_core_value_sigF963) return false;
      let var_core_value_sigB608 = var_core_value_sigCD82.get(t.ICommandService),
        var_core_value_sigF866 = var_core_value_sigCD82.get(t.IUndoRedoService),
        var_core_value_sig5EFB = var_core_value_sigCD82.get(n.SheetInterceptorService),
      ...
      let var_core_value_sig2682 = (0, r.transformToDrawingPosition)(var_core_value_sig3A85, var_core_value_sigC349),
        var_core_value_sig4BB5 = (0, r.transformToAxisAlignPosition)(var_core_value_sig3A85, var_core_value_sigC349),
      ...
      if ((0, e.isConnectorShape)(var_core_value_sig6709)) {
      ...
      return (0, t.sequenceExecute)(var_core_value_sigA73E, var_core_value_sigB608).result ? (var_core_value_sigF866.pushUndoRedo({
        unitID: var_core_value_sig040A,
  ...
  b = {
    ...
    handler: (var_core_value_sigB9FC, var_core_value_sig5055) => {
      let var_core_value_sig3801 = (0, n.getSheetCommandTarget)(var_core_value_sigB9FC.get(t.IUniverInstanceService), var_core_value_sig5055);
      if (!var_core_value_sig3801) return false;
      let var_core_value_sig45F0 = var_core_value_sigB9FC.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sig8122 = var_core_value_sigB9FC.get(r.ISheetDrawingService),
        {
      ...
      let var_core_value_sig7E56 = var_core_value_sigB9FC.get(p).getShapeModel(var_core_value_sigBC91, var_core_value_sigCB88, var_core_value_sigEDC6);
      if (!var_core_value_sig7E56) return false;
      let var_core_value_sig4161 = var_core_value_sigB9FC.get(t.ICommandService),
        var_core_value_sig7580 = var_core_value_sigB9FC.get(t.IUndoRedoService),
        var_core_value_sig1F18 = var_core_value_sigB9FC.get(n.SheetInterceptorService),
      ...
      let var_core_value_sig81B2 = (0, r.transformToDrawingPosition)(var_core_value_sigD5A0, var_core_value_sig8D65),
        var_core_value_sigA0A5 = (0, r.transformToAxisAlignPosition)(var_core_value_sigD5A0, var_core_value_sig8D65),
      ...
      return (0, t.sequenceExecute)(var_core_value_sigA694, var_core_value_sig4161).result ? (var_core_value_sig7580.pushUndoRedo({
        unitID: var_core_value_sigBC91,
  ...
  x = {
    ...
    handler: (var_core_value_sig0428, var_core_value_sigBE07) => {
      let var_core_value_sig555F = (0, n.getSheetCommandTarget)(var_core_value_sig0428.get(t.IUniverInstanceService), var_core_value_sigBE07);
      ...
      let {
        ...
        var_core_value_sig8DFE = var_core_value_sig0428.get(p).getShapeModel(var_core_value_sig3D6F, var_core_value_sig336C, var_core_value_sig6E68);
      ...
      let var_core_value_sig48EA = var_core_value_sig8DFE.getShapeTextData(),
        ...
        var_core_value_sig4592 = var_core_value_sig0428.get(t.ICommandService),
        var_core_value_sigC5C4 = var_core_value_sig0428.get(t.IUndoRedoService),
      ...
      return (0, t.sequenceExecute)(var_core_value_sig6D19, var_core_value_sig4592).result ? (var_core_value_sigC5C4.pushUndoRedo({
        unitID: var_core_value_sig3D6F,
  ...
  S = {
    ...
    handler: (var_core_value_sigAC51, var_core_value_sig8986) => {
      ...
      let var_core_value_sigED1C = (0, n.getSheetCommandTarget)(var_core_value_sigAC51.get(t.IUniverInstanceService), var_core_value_sig8986);
      if (!var_core_value_sigED1C) return false;
      let var_core_value_sig726E = var_core_value_sigAC51.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sigC9F5 = var_core_value_sigAC51.get(r.ISheetDrawingService),
        {
      ...
      let var_core_value_sigE5BA = var_core_value_sigAC51.get(p).getShapeModel(var_core_value_sig2CD3, var_core_value_sig038E, var_core_value_sig7EEA);
      if (!var_core_value_sigE5BA) return false;
      let var_core_value_sig4A83 = var_core_value_sigAC51.get(t.ICommandService),
        var_core_value_sig58AA = var_core_value_sigAC51.get(t.IUndoRedoService),
        var_core_value_sig84C4 = var_core_value_sigAC51.get(n.SheetInterceptorService),
        ...
        var_core_value_sigB495 = (0, r.transformToDrawingPosition)(var_core_value_sigB6F7, var_core_value_sigAA1E),
        var_core_value_sig70D0 = (0, r.transformToAxisAlignPosition)(var_core_value_sigB6F7, var_core_value_sigAA1E),
      ...
      return (0, t.sequenceExecute)(var_core_value_sig9FA0, var_core_value_sig4A83).result ? (var_core_value_sig58AA.pushUndoRedo({
        unitID: var_core_value_sig2CD3,
  ...
  C = {
    ...
    handler: (var_core_value_sig7C77, var_core_value_sig9578) => {
      let var_core_value_sigA2D3 = (0, n.getSheetCommandTarget)(var_core_value_sig7C77.get(t.IUniverInstanceService), var_core_value_sig9578);
      if (!var_core_value_sigA2D3) return false;
      let var_core_value_sigC218 = var_core_value_sig7C77.get(n.SheetSkeletonService),
        {
      ...
      let var_core_value_sigF079 = var_core_value_sig7C77.get(r.ISheetDrawingService),
        {
      ...
      let var_core_value_sig49D9 = var_core_value_sig7C77.get(p).getShapeModel(var_core_value_sigADEC, var_core_value_sig3D8E, var_core_value_sigFCA0);
      if (!var_core_value_sig49D9) return false;
      let var_core_value_sig320C = var_core_value_sig7C77.get(t.ICommandService),
        var_core_value_sigE7F0 = var_core_value_sig7C77.get(t.IUndoRedoService),
        var_core_value_sigE837 = var_core_value_sig7C77.get(n.SheetInterceptorService),
        ...
        var_core_value_sigA45D = (0, r.transformToDrawingPosition)(var_core_value_sig34F4, var_core_value_sig37E5),
        var_core_value_sig1BC7 = (0, r.transformToAxisAlignPosition)(var_core_value_sig34F4, var_core_value_sig37E5),
      ...
      return (0, t.sequenceExecute)(var_core_value_sig3457, var_core_value_sig320C).result ? (var_core_value_sigE7F0.pushUndoRedo({
        unitID: var_core_value_sigADEC,
  ...
  w = {
    ...
    handler: (var_core_value_sig1BC4, var_core_value_sig9EAB) => {
      let {
        ...
        var_core_value_sig7C65 = var_core_value_sig1BC4.get(p).getShapeModel(var_core_value_sigA5C3, var_core_value_sig3A1E, var_core_value_sig3515);
...
function D(var_core_value_sig7F05) {
...
let O = class {
  constructor(var_core_value_sig1537, var_core_value_sigE4C6, var_core_value_sig4313, var_core_value_sigFC87) {
    this._commandService = var_core_value_sig1537, this._shapeService = var_core_value_sigE4C6, this._drawingService = var_core_value_sig4313, this._instanceService = var_core_value_sigFC87, l(this, "hostType", t.UniverInstanceType["UNIVER_SHEET"]);
  }
  get shapeChanged$() {
    return {
      subscribe: var_core_value_sig5B69 => {
        let var_core_value_sigB098 = this._commandService["onCommandExecuted"](var_core_value_sig5CEE => {
          (var_core_value_sig5CEE.id === m.id || var_core_value_sig5CEE.id === h.id || var_core_value_sig5CEE.id === _.id || var_core_value_sig5CEE.id === w.id) && var_core_value_sig5B69({
  ...
  getShape(var_core_value_sig156F) {
    ...
    if (!var_core_value_sigF057 || var_core_value_sigF057.drawingType !== t.DrawingTypeEnum["DRAWING_SHAPE"] || !var_core_value_sig72F6) return null;
    let var_core_value_sig9FBA = var_core_value_sigF057.transform;
    return {
      ...var_core_value_sig156F,
      shapeType: var_core_value_sig72F6,
      shapeData: t.Tools["deepClone"](this._shapeService["getShapeDataById"](var_core_value_sig156F.unitId, var_core_value_sig156F.subUnitId, var_core_value_sig156F.shapeId) ?? {}),
  ...
  listShapes(var_core_value_sigFE01) {
    ...
    return Object.values(var_core_value_sigA2CE).filter(var_core_value_sigCE71 => (var_core_value_sigCE71 == null ? undefined : var_core_value_sigCE71.drawingType) === t.DrawingTypeEnum["DRAWING_SHAPE"]).map(var_core_value_sig21D8 => this.getShape({
  ...
  listShapesInUnit(var_core_value_sig1975) {
    let var_core_value_sig6EA1 = this._instanceService["getUnit"](var_core_value_sig1975, t.UniverInstanceType["UNIVER_SHEET"]);
  ...
  createShape(var_core_value_sig029F, var_core_value_sig3767) {
    let var_core_value_sig670B = (0, t.generateRandomId)(),
      var_core_value_sig6912 = D(var_core_value_sig3767),
      var_core_value_sigE235 = t.Tools["deepClone"](var_core_value_sig3767.shapeData ?? (0, e.createDefaultInsertedShapeData)(var_core_value_sig3767.shapeType));
      ...
      params: {
        ...
        shapeData: {
          ...
          formulaBinding: {
            ...
            lastValue: t.Tools["deepClone"](var_core_value_sig6D47)
          }
        },
        replace: true,
  ...
  removeShape(var_core_value_sig6CAD) {
    return this._commandService["syncExecuteCommand"](r.RemoveSheetDrawingCommand["id"], {
  ...
  bringToFront(var_core_value_sig8CF5) {
    return this._arrange(var_core_value_sig8CF5, t.ArrangeTypeEnum["front"]);
  }
  bringForward(var_core_value_sigDDD7) {
    return this._arrange(var_core_value_sigDDD7, t.ArrangeTypeEnum["forward"]);
  }
  sendBackward(var_core_value_sigB2CE) {
    return this._arrange(var_core_value_sigB2CE, t.ArrangeTypeEnum["backward"]);
  }
  sendToBack(var_core_value_sig443C) {
    return this._arrange(var_core_value_sig443C, t.ArrangeTypeEnum["back"]);
  }
  setZOrder(var_core_value_sig39B1, var_core_value_sig210D) {
    return this._commandService["syncExecuteCommand"](r.SetDrawingArrangeCommand["id"], {
...
O = f([d(0, t.ICommandService), d(1, (0, t.Inject)(p)), d(2, r.ISheetDrawingService), d(3, t.IUniverInstanceService)], O);
const k = {};
let A = class extends t.Disposable {
  ...
  _initCommands() {
    [g, v, y, b, x, S, C, m, h, w, _].forEach(var_core_value_sigB33B => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sigB33B)));
  }
  _initCommandInterceptor() {
    this.disposeWithMe(this._sheetInterceptorService["interceptCommand"]({
      getMutations: var_core_value_sig24B9 => {
        if (var_core_value_sig24B9.id === r.RemoveSheetDrawingCommand["id"]) {
          let {
              drawings: var_core_value_sigE92A
            } = var_core_value_sig24B9.params,
            var_core_value_sig362B = var_core_value_sigE92A.filter(var_core_value_sigFBA4 => var_core_value_sigFBA4.drawingType === t.DrawingTypeEnum["DRAWING_SHAPE"]);
        ...
        if (var_core_value_sig24B9.id === r.SetSheetDrawingCommand["id"]) {
          let {
              drawings: var_core_value_sigEFD4
            } = var_core_value_sig24B9.params,
            var_core_value_sig861B = var_core_value_sigEFD4.filter(var_core_value_sig8178 => var_core_value_sig8178.drawingType === t.DrawingTypeEnum["DRAWING_SHAPE"]);
          ...
          for (let var_core_value_sigE9ED of var_core_value_sig861B) {
            ...
            if ((0, e.isConnectorShape)(var_core_value_sig480E.getShapeType())) {
  ...
  _getConnectPointInfo(var_core_value_sig7A3C, var_core_value_sig0511, var_core_value_sig1F44, var_core_value_sigCB04, var_core_value_sig947E) {
    ...
    let var_core_value_sig7550 = (0, e.getBasicShapeRotateBound)({
  ...
  _addLineRerouteUpdates(var_core_value_sig2983, var_core_value_sigE1B0, var_core_value_sigD4FF, var_core_value_sig1E5B, var_core_value_sigB680, var_core_value_sig1F64, var_core_value_sigDD1C, var_core_value_sig2C39, var_core_value_sigB7D1, var_core_value_sig64F0) {
    ...
    if (var_core_value_sig340D && var_core_value_sig82D4) {
      let var_core_value_sig5090 = var_core_value_sig1E5B.getShapeType(),
        var_core_value_sigC368 = (0, e.routeConnectorLineShape)(var_core_value_sig340D, var_core_value_sig82D4, var_core_value_sig5090),
        var_core_value_sigAD56 = var_core_value_sig5090;
      if (var_core_value_sigC368) {
        let var_core_value_sig7E54 = (0, e.computeConnectorRouteLayout)(var_core_value_sigC368, var_core_value_sig1E5B.getShapeType()),
        ...
        if (var_core_value_sig9A8D && var_core_value_sig9A8D[var_core_value_sigD4FF]) {
          ...
          let var_core_value_sig9572 = {
            ...
            var_core_value_sigD873 = (0, r.transformToDrawingPosition)(var_core_value_sig9572, var_core_value_sig85B1),
            var_core_value_sigA12B = (0, r.transformToAxisAlignPosition)(var_core_value_sig9572, var_core_value_sig85B1),
    ...
    if (var_core_value_sig4C07 && !var_core_value_sig79AB && !var_core_value_sig8E74 && !var_core_value_sig104C) {
      ...
      if (var_core_value_sig1896 && var_core_value_sig1896[var_core_value_sigDC86]) {
        ...
        let var_core_value_sigC259 = var_core_value_sig1896[var_core_value_sigDC86],
          ...
          var_core_value_sigFDEA = (0, r.transformToDrawingPosition)(var_core_value_sig9C9F, var_core_value_sig652C),
          var_core_value_sig86D0 = (0, r.transformToAxisAlignPosition)(var_core_value_sig9C9F, var_core_value_sig652C),
...
A = f([d(0, t.ICommandService), d(1, (0, t.Inject)(n.SheetInterceptorService)), d(2, (0, t.Inject)(n.SheetSkeletonService)), d(3, (0, t.Inject)(p)), d(4, (0, t.Inject)(a.IDrawingManagerService)), d(5, (0, t.Inject)(e.IShapeHostAdapterRegistry)), d(6, (0, t.Inject)(O))], A);
let j = class extends t.Disposable {
  ...
  _planDeletes(var_core_value_sig4BBA, var_core_value_sig6201) {
    if (var_core_value_sig4BBA.mode === "command") for (let var_core_value_sig5A13 of var_core_value_sig4BBA.deletes) {
      ...
      (var_core_value_sig8889 == null ? undefined : var_core_value_sig8889.drawingType) !== t.DrawingTypeEnum["DRAWING_SHAPE"] || !var_core_value_sig32F8 || (var_core_value_sig6201.preRedos["push"]({
        id: h.id,
        params: {
        ...
        params: {
          ...
          shapeData: t.Tools["deepClone"](var_core_value_sig32F8.getShapeData())
        }
      }));
    }
  }
  _planConnector(var_core_value_sig5151, var_core_value_sigB542, var_core_value_sigBB6C, var_core_value_sigE2BF) {
    if (var_core_value_sigBB6C.drawingType !== t.DrawingTypeEnum["DRAWING_SHAPE"] || var_core_value_sig5151.deletes["has"](var_core_value_sigB542)) return;
    ...
    if (!var_core_value_sigB8C7 || !(0, e.isConnectorShape)(var_core_value_sigB8C7.getShapeType())) return;
    ...
    let var_core_value_sig43B8 = (0, e.resolveConnectorRoutePoints)(var_core_value_sigFF19);
    if (var_core_value_sig43B8.length < 2) return;
    let var_core_value_sigD98F = t.Tools["deepClone"](var_core_value_sigA56E ?? {}),
    ...
    let var_core_value_sigB785 = (0, e.buildConnectorEndpointUpdate)(var_core_value_sigFF19, var_core_value_sig66C0 || (0, e.createFreeConnectorPointInfo)((var_core_value_sig9D15 == null ? undefined : var_core_value_sig9D15.point) ?? var_core_value_sig43B8[var_core_value_sig43B8.length - 1], var_core_value_sig43B8[0]), var_core_value_sig9D15 || (0, e.createFreeConnectorPointInfo)((var_core_value_sig66C0 == null ? undefined : var_core_value_sig66C0.point) ?? var_core_value_sig43B8[0], var_core_value_sig43B8[var_core_value_sig43B8.length - 1]), var_core_value_sigD98F);
    if (!(!(var_core_value_sigB785 != null && var_core_value_sigB785.transform) || !var_core_value_sigB785.shapeType || !var_core_value_sigB785.shapeData)) {
      if (this._applyUpdate(var_core_value_sig5151, var_core_value_sig1998, var_core_value_sigB785), var_core_value_sig5151.mode === "refresh") {
        var_core_value_sigB8C7.setShapeType(var_core_value_sigB785.shapeType), var_core_value_sigB8C7.setShapeData(t.Tools["deepClone"](var_core_value_sigB785.shapeData), false);
        return;
      }
      var_core_value_sigE2BF.redos["push"]({
        ...
        params: {
          ...
          shapeData: t.Tools["deepClone"](var_core_value_sigB785.shapeData),
          replace: true
        }
        ...
        params: {
          ...
          shapeData: t.Tools["deepClone"](var_core_value_sigB8C7.getShapeData()),
          replace: true
        }
      });
    }
  ...
  _resolveBinding(var_core_value_sig130F, var_core_value_sigC0E3, var_core_value_sig52F7) {
    ...
    return var_core_value_sigDE3D ? (0, e.resolveShapeConnectionPoint)(var_core_value_sigDE3D, var_core_value_sig52F7) : null;
  }
  ...
  _applyUpdate(var_core_value_sig2547, var_core_value_sigBCA9, var_core_value_sig4CDF) {
    let var_core_value_sig3F79 = var_core_value_sigBCA9,
      ...
      var_core_value_sigC9ED = {
        ...
        sheetTransform: (0, r.transformToDrawingPosition)(var_core_value_sig880E, var_core_value_sig2547.skeleton),
        axisAlignSheetTransform: (0, r.transformToAxisAlignPosition)(var_core_value_sig880E, var_core_value_sig2547.skeleton),
        data: {
          ...var_core_value_sig3F79.data,
          shapeType: var_core_value_sig4CDF.shapeType,
          shapeData: t.Tools["deepClone"](var_core_value_sig4CDF.shapeData)
        }
      };
    var_core_value_sig2547.updates["set"](var_core_value_sigBCA9.drawingId, var_core_value_sigC9ED);
  }
};
j = f([d(0, (0, t.Inject)(p)), d(1, (0, t.Inject)(O)), d(2, (0, t.Inject)(r.SheetDrawingTransformPlanService))], j);
let M = class extends t.Plugin {
  constructor(var_core_value_sigB57B = k, var_core_value_sig780B, var_core_value_sig7D1B) {
  ...
  onStarting() {
    ...
    [[u], [p], [O], [j], [A]].forEach(var_core_value_sigF593 => var_core_value_sig7D40.add(var_core_value_sigF593)), (0, t.touchDependencies)(var_core_value_sig7D40, [[p], [j], [A]]);
  }
};
l(M, "type", t.UniverInstanceType["UNIVER_SHEET"]), l(M, "pluginName", "SHEET_SHAPE_PLUGIN"), l(M, "packageName", T), l(M, "version", E), M = f([(0, t.DependentOn)(i.UniverLicensePlugin, a.UniverDrawingPlugin, e.UniverShapePlugin, n.UniverSheetsPlugin, r.UniverSheetsDrawingPlugin), d(1, (0, t.Inject)(t.Injector)), d(2, t.IConfigService)], M), exports.DEFAULT_SHAPE_HEIGHT = 200, exports.DEFAULT_SHAPE_WIDTH = 200, exports.InsertShapeCommand = g, exports.InsertSheetsShapeMutation = m, exports.RemoveSheetsShapeMutation = h, exports.SetShapeDrawingDataCommand = v, exports.SetSheetsShapeRotateCommand = b, exports.SetSheetsShapeTextVerticalToggleCommand = x, Object.defineProperty(exports, "SheetsShapeService", {
  enumerable: true,
  get: function () {
    return p;
  }
}), exports.ToggleSheetsShapeFlipCommand = y, Object.defineProperty(exports, "UniverSheetsShapePlugin", {
  enumerable: true,
  get: function () {
    return M;
  }
}), exports.UpdateConnectorRelationCommand = S, exports.UpdateLineShapeResizeCommand = C, exports.UpdateSheetsShapeDataMutation = _, exports.UpdateSheetsShapeTypeMutation = w;
