...
function a(var_core_value_sig2B65, var_core_value_sigD7EA) {
...
function o(var_core_value_sigB33B, var_core_value_sig24B9, var_core_value_sigE627, var_core_value_sigEF3E) {
...
let s = class {
  ...
  changeDataSource(var_core_value_sigE90F, var_core_value_sigEFD4) {
    let var_core_value_sig861B = this._injector["get"](e.SparklineDataSourceModel),
      var_core_value_sig5237 = this._injector["get"](t.ICommandService),
    ...
    return var_core_value_sig5237.syncExecuteCommand(e.SetSheetSparklineCommand["id"], var_core_value_sig7E54), this._row = var_core_value_sigEFD4.startRow, this._col = var_core_value_sigEFD4.startColumn, this;
  }
  removeSparkline() {
    let var_core_value_sig9A8D = this._injector["get"](t.ICommandService),
    ...
    var_core_value_sig9A8D.syncExecuteCommand(e.RemoveSheetSparklineCommand["id"], var_core_value_sigC259);
  }
};
...
let c = class {
  ...
  changeDataSource(var_core_value_sigA942, var_core_value_sigA621) {
    let var_core_value_sigBBFF = this._injector["get"](e.SparklineDataSourceModel),
      var_core_value_sig8889 = this._injector["get"](t.ICommandService),
    ...
    return var_core_value_sig8889.syncExecuteCommand(e.SetSheetSparklineCommand["id"], var_core_value_sig5B67), this._row = var_core_value_sigA621[0].startRow, this._col = var_core_value_sigA621[0].startColumn, this;
  }
  removeSparklineGroup() {
    let var_core_value_sig1758 = this._injector["get"](t.ICommandService),
    ...
    var_core_value_sig1758.syncExecuteCommand(e.RemoveSheetSparklineCommand["id"], var_core_value_sig4805);
  }
  setConfig(var_core_value_sigE67E) {
    let var_core_value_sig2902 = this._injector["get"](e.SparklineDataSourceModel).getSparklineById(this._unitId, this._subUnitId, this._groupId);
    if (var_core_value_sig2902) {
      ...
      this._injector["get"](t.ICommandService).syncExecuteCommand(e.SetSheetSparklineCommand["id"], var_core_value_sigE154);
    }
    return this;
  }
};
...
var l = class extends n.FWorksheet {
  addSparkline(var_core_value_sig9989, var_core_value_sig698E, var_core_value_sig2809) {
    if (this._commandService["syncExecuteCommand"](e.AddSheetSparklineCommand["id"], {
  ...
  getAllSubSparkline() {
    return this._injector["get"](e.SparklineDataSourceModel).getSubUnitSparkline(this._workbook["getUnitId"](), this._worksheet["getSheetId"]());
  }
  composeSparkline(var_core_value_sig2DAB) {
    let var_core_value_sig877E = this._injector["get"](e.SparklineDataSourceModel),
      ...
      for (let var_core_value_sig8178 = var_core_value_sig9572; var_core_value_sig8178 <= var_core_value_sigD873; var_core_value_sig8178++) for (let var_core_value_sig0D69 = var_core_value_sigA12B; var_core_value_sig0D69 <= var_core_value_sigF230; var_core_value_sig0D69++) {
        ...
        if (var_core_value_sig3D7D) {
          ...
          if (var_core_value_sig2AD0) {
            var_core_value_sig20C8 = t.Tools["deepClone"](var_core_value_sig2AD0);
            break;
          }
        }
      }
    }
    var_core_value_sig20C8 && this._commandService["executeCommand"](e.SetSheetSparklineCommand["id"], {
  ...
  unComposeSparkline(var_core_value_sigE9A7) {
    let var_core_value_sigBECE = this._injector["get"](e.SparklineDataSourceModel),
      ...
      for (let var_core_value_sigE9ED = var_core_value_sig09B8; var_core_value_sigE9ED <= var_core_value_sig6F91; var_core_value_sigE9ED++) for (let var_core_value_sig480E = var_core_value_sigF9C7; var_core_value_sig480E <= var_core_value_sig8895; var_core_value_sig480E++) {
        ...
        if (var_core_value_sig27E5) {
          ...
          if (var_core_value_sig3EEE) {
            var_core_value_sig1B22 = t.Tools["deepClone"](var_core_value_sig3EEE);
            break;
          }
        }
      }
    }
    var_core_value_sig1B22 || this._commandService["executeCommand"](e.SetSheetSparklineCommand["id"], {
  ...
  getSparklineByCell(var_core_value_sig7F72, var_core_value_sig7B2A) {
    let var_core_value_sig06CD = this._injector["get"](e.SparklineDataSourceModel),
    ...
    if (var_core_value_sig07E9) return this._injector["createInstance"](s, var_core_value_sigA5F1, var_core_value_sig97A2, var_core_value_sig07E9, var_core_value_sig7F72, var_core_value_sig7B2A);
  }
  getSparklineGroupByCell(var_core_value_sig4F59, var_core_value_sigF564) {
    let var_core_value_sig8CFA = this._injector["get"](e.SparklineDataSourceModel),
    ...
    if (var_core_value_sigB098) return this._injector["createInstance"](c, var_core_value_sig2E11, var_core_value_sig5B69, var_core_value_sigB098, var_core_value_sig4F59, var_core_value_sigF564);
  }
};
...
var f = class extends r.FUniver {
  _initialize(var_core_value_sigCE71) {
    let var_core_value_sig21D8 = var_core_value_sigCE71.get(t.ICommandService);
    this.disposeWithMe(this.registerEventHandler(this.Event["SheetSparklineChanged"], () => var_core_value_sig21D8.onCommandExecuted(var_core_value_sigC80B => {
      if (var_core_value_sigC80B.id === e.SetSheetSparklineCommand["id"]) {
        ...
        if (!var_core_value_sigB577.isChangeDataSource) {
          ...
          let var_core_value_sig1A0F = var_core_value_sig26DB.getId(),
            ...
            var_core_value_sig4383 = this._injector["get"](i.SheetsSelectionsService),
            var_core_value_sig186C = this._injector["get"](e.SparklineDataSourceModel),
...
r.FUniver["extend"](f), Object.defineProperty(exports, "FSparkline", {
  enumerable: true,
  get: function () {
    return s;
  }
