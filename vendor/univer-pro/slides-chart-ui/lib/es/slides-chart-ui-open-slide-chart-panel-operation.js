...
const B = {
  ...
  Cn = {
    ...
    type: CommandType.OPERATION,
    handler(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461128) {
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461129 = bn(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461128);
      return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461129 ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461128.get(ICommandService).executeCommand(B.id, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D461129) : false;
    }
  },
  wn = "slide-chart.data-editor",
  Tn = "slide-chart.dialog.data-editor";
export { B as OpenSlideChartPanelOperation, xn as CloseSlideChartPanelOperation, Sn as OpenSlideChartDataEditorOperation, Cn as SlideContextMenuOpenChartPanelOperation, wn as SLIDE_CHART_DATA_EDITOR_COMPONENT, Tn as SLIDE_CHART_DATA_EDITOR_DIALOG_ID };
