...
const K = "slide-chart.edit-panel",
  ...
  q = {
    ...
    series: DEFAULT_CHART_SERIES_VALUES,
  ...
  Mn = [ChartTypeBits.Line, ChartTypeBits.Radar, ChartTypeBits.WordCloud, ChartTypeBits.Scatter, ChartTypeBits.Relation, ChartTypeBits.Sankey, ChartTypeBits.Heatmap, ChartTypeBits.Boxplot, ChartTypeBits.Candlestick, ChartTypeBits.Histogram, ChartTypeBits.Treemap, ChartTypeBits.Sunburst, ChartTypeBits.Gauge, ChartTypeBits.Chord];
export { K as SLIDE_CHART_EDIT_PANEL_COMPONENT };
export { Mn, q, jn };
