...
const s = {
    ...
    handler: (var_core_value_sigD4FB, var_core_value_sig3E71) => var_core_value_sigD4FB.get(o).removeDataSource(var_core_value_sig3E71.unitId, var_core_value_sig3E71.dataSourceId)
  },
  c = {
    id: "slide.mutation.set-slide-chart-data-source",
    type: n.CommandType["MUTATION"],
    handler: (var_core_value_sig01B3, var_core_value_sig7442) => (var_core_value_sig01B3.get(o).setDataSource(var_core_value_sig7442.unitId, var_core_value_sig7442.dataSource), true)
  },
  l = {
    id: "slide.mutation.set-slide-chart-snapshot",
    type: n.CommandType["MUTATION"],
    handler: (var_core_value_sigDF87, var_core_value_sig9EE0) => (var_core_value_sigDF87.get(o).setChart(var_core_value_sig9EE0.unitId, var_core_value_sig9EE0.chart), true)
  },
  u = {
    ...
    handler: (var_core_value_sigF051, var_core_value_sig0B45) => {
      ...
      let var_core_value_sig36F8 = (0, t.getSlideCommandTarget)(var_core_value_sigF051.get(n.IUniverInstanceService), var_core_value_sig0B45);
      if (!var_core_value_sig36F8) return false;
      let var_core_value_sig03E1 = var_core_value_sigF051.get(o),
      ...
      let var_core_value_sigE799 = var_core_value_sig03E1.isDataSourceShared(var_core_value_sig36F8.unitId, var_core_value_sig7C4A.id),
        var_core_value_sigB601 = var_core_value_sigE799 ? var_core_value_sig0B45.duplicateDataSourceId ?? (0, n.generateRandomId)() : var_core_value_sig7C4A.id,
        var_core_value_sig8B71 = d(var_core_value_sigB601, var_core_value_sig0B45.dataSource, var_core_value_sig0B45.name ?? var_core_value_sig7C4A.name),
        var_core_value_sigAEFB = var_core_value_sigF051.get(n.ICommandService),
      ...
      return var_core_value_sigF051.get(n.IUndoRedoService).pushUndoRedo({
        unitID: var_core_value_sig36F8.unitId,
...
function d(var_core_value_sig77EE, var_core_value_sig9F76, var_core_value_sigB008) {
  let var_core_value_sig8721 = (0, e.isInlineChartDataSource)(var_core_value_sig9F76) ? {
...
const f = {
    ...
    type: n.CommandType["MUTATION"],
    handler: (var_core_value_sig08BA, var_core_value_sigDBB5) => var_core_value_sig08BA.get(o).removeChart(var_core_value_sigDBB5.unitId, var_core_value_sigDBB5.chartId, {
  ...
  p = {
    ...
    handler: (var_core_value_sigCFAC, var_core_value_sig237B) => {
      ...
      let var_core_value_sigE347 = (0, t.getSlideCommandTarget)(var_core_value_sigCFAC.get(n.IUniverInstanceService), var_core_value_sig237B);
      if (!var_core_value_sigE347) return false;
      let var_core_value_sig3C5B = var_core_value_sigCFAC.get(o),
        var_core_value_sig200B = var_core_value_sigCFAC.get(t.ISlideDrawingService),
        {
      ...
      if (!var_core_value_sigA937 || !var_core_value_sigE503 || var_core_value_sigE503.type !== t.PageElementTypeEnum["Chart"] || var_core_value_sigE503.chartId !== var_core_value_sig1BD9) return false;
      let var_core_value_sig48DD = var_core_value_sigCFAC.get(n.ICommandService),
        var_core_value_sig5E6A = var_core_value_sigCFAC.get(n.IUndoRedoService),
      ...
      let var_core_value_sigC6E5 = {
        ...
        var_core_value_sigCEFB = {
          ...
          sourcePageType: (var_core_value_sigCAD5 == null ? undefined : var_core_value_sigCAD5.sourcePageType) ?? t.PageTypeEnum["Slide"],
        ...
        var_core_value_sigE4C6 = (0, n.sequenceExecute)(var_core_value_sigB455, var_core_value_sig48DD);
      ...
      }), true) : (var_core_value_sigE4C6.index === 1 && (0, n.sequenceExecute)([{
        id: t.AddSlideElementMutation["id"],
        params: var_core_value_sigCEFB
...
function h(var_core_value_sig4313) {
  return {
...
const g = {
    ...
    handler: (var_core_value_sigFC87, var_core_value_sig156F) => {
      ...
      let var_core_value_sigDD51 = (0, t.getSlideCommandTarget)(var_core_value_sigFC87.get(n.IUniverInstanceService), var_core_value_sig156F);
      ...
      let {
        ...
        var_core_value_sig9FBA = var_core_value_sig156F[m] === true,
        var_core_value_sigFE01 = var_core_value_sigFC87.get(o).getChart(var_core_value_sigF057, var_core_value_sig72F6);
      if (!var_core_value_sigFE01) return false;
      let var_core_value_sigA2CE = var_core_value_sigFC87.get(n.ICommandService),
        var_core_value_sig1975 = var_core_value_sigFC87.get(n.IUndoRedoService),
        var_core_value_sig6EA1 = e.chartConfigInterpreter["apply"](var_core_value_sigFE01, var_core_value_sig156F, var_core_value_sig9FBA);
      ...
      return (0, n.sequenceExecute)(var_core_value_sig670B, var_core_value_sigA2CE).result ? (var_core_value_sig1975.pushUndoRedo({
        unitID: var_core_value_sigF057,
  ...
  _ = {
    ...
    handler: (var_core_value_sigE235, var_core_value_sig7664) => {
      ...
      let var_core_value_sig2281 = (0, t.getSlideCommandTarget)(var_core_value_sigE235.get(n.IUniverInstanceService), var_core_value_sig7664);
      ...
      let {
        ...
        var_core_value_sigE94C = var_core_value_sigE235.get(o).getDataSource(var_core_value_sig5E86, var_core_value_sig6998);
      if (!var_core_value_sigE94C) return false;
      let var_core_value_sig6D47 = var_core_value_sigE235.get(n.ICommandService),
        var_core_value_sigCB82 = var_core_value_sigE235.get(n.IUndoRedoService),
      ...
      return (0, n.sequenceExecute)(var_core_value_sig8CF5, var_core_value_sig6D47).result ? (var_core_value_sigCB82.pushUndoRedo({
        unitID: var_core_value_sig5E86,
...
function v(var_core_value_sigB2CE) {
  "@babel/helpers - typeof";

  return v = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig1A0F) {
  ...
  }, v(var_core_value_sigB2CE);
}
function y(var_core_value_sig443C, var_core_value_sig39B1) {
  if (v(var_core_value_sig443C) != "object" || !var_core_value_sig443C) return var_core_value_sig443C;
  ...
  if (var_core_value_sig210D !== undefined) {
    ...
    if (v(var_core_value_sigB4B4) != "object") return var_core_value_sigB4B4;
...
function b(var_core_value_sigD407) {
  var var_core_value_sig63F3 = y(var_core_value_sigD407, "string");
  return v(var_core_value_sig63F3) == "symbol" ? var_core_value_sig63F3 : var_core_value_sig63F3 + "";
}
function x(var_core_value_sig6A71, var_core_value_sig3BF6, var_core_value_sig38CE) {
  return (var_core_value_sig3BF6 = b(var_core_value_sig3BF6)) in var_core_value_sig6A71 ? Object.defineProperty(var_core_value_sig6A71, var_core_value_sig3BF6, {
...
function C(var_core_value_sigA90D, var_core_value_sig7A3C, var_core_value_sig0511, var_core_value_sig1F44) {
...
let w = class extends e.ChartResourceRuntimeService {
  constructor(var_core_value_sigD955, var_core_value_sig48BD, var_core_value_sig429F) {
    super(var_core_value_sigD955, var_core_value_sig48BD, e.buildChartDataSetFromValues, var_core_value_sig429F), x(this, "_chartDataUpdated$", new r["Subject"]()), x(this, "chartDataUpdated$", this._chartDataUpdated$["asObservable"]());
  }
  dispose() {
...
w = C([S(0, (0, n.Inject)(o)), S(1, (0, n.Inject)(n.Injector)), S(2, (0, n.Inject)(e.IChartDataSourceRuntimeService))], w);
var T = class {
  ...
  describe(var_core_value_sigE9ED = {}, var_core_value_sigB577) {
    ...
    let {
      ...
      var_core_value_sigC80B = var_core_value_sig09B8.get(w).ensureChartModel(var_core_value_sig8895, var_core_value_sigA12B),
      var_core_value_sig284F = var_core_value_sig09B8.get(o).getChart(var_core_value_sig8895, var_core_value_sigA12B),
      var_core_value_sigE154 = var_core_value_sig284F ? var_core_value_sig09B8.get(o).getDataSource(var_core_value_sig8895, var_core_value_sig284F.dataSourceId) : null,
    ...
    return {
      ...
      placeholder: n.Tools["deepClone"](var_core_value_sig4632.placeholder),
      stroke: n.Tools["deepClone"](var_core_value_sig4632.stroke),
  ...
  getInfo() {
    ...
    return {
      ...
      dataSource: (0, e.isInlineChartDataSource)(var_core_value_sig9E2F) ? {
        values: n.Tools["deepClone"](var_core_value_sig9E2F.values)
      } : (0, e.isReferencedChartDataSource)(var_core_value_sig9E2F) ? {
        source: n.Tools["deepClone"](var_core_value_sig9E2F.source)
      } : (() => {
        throw Error("Invalid Chart data source: " + this._context["chartId"]);
      })(),
      position: n.Tools["deepClone"](var_core_value_sig2259.position),
      size: n.Tools["deepClone"](var_core_value_sig2259.size),
      placeholder: n.Tools["deepClone"](var_core_value_sig2259.placeholder),
      stroke: n.Tools["deepClone"](var_core_value_sig2259.stroke),
  ...
  getData() {
    let {
      ...
      var_core_value_sigF4B9 = var_core_value_sigDBB7.get(o).getChart(var_core_value_sigD0A8, var_core_value_sigD082),
      var_core_value_sig5CEE = var_core_value_sigF4B9 ? var_core_value_sigDBB7.get(o).getDataSource(var_core_value_sigD0A8, var_core_value_sigF4B9.dataSourceId) : null;
  ...
  getDataSource() {
    let {
      ...
      var_core_value_sigE90F = var_core_value_sig362B.get(o).getChart(var_core_value_sig5CA5, var_core_value_sigE92A);
    return (var_core_value_sigE90F ? var_core_value_sig362B.get(o).getDataSource(var_core_value_sig5CA5, var_core_value_sigE90F.dataSourceId) : null) ?? null;
  }
  ...
  refreshDataSource() {
    ...
    return var_core_value_sig50AF.get(w).refreshChartDataSource(var_core_value_sigA942, var_core_value_sig48CA);
  }
  commit(var_core_value_sigA621) {
    ...
    let {
      ...
      var_core_value_sig1758 = var_core_value_sig32F8.get(w).ensureChartModel(var_core_value_sig5B67, var_core_value_sig8889);
    if (!var_core_value_sig1758) throw Error("Chart not found: " + var_core_value_sig8889);
    ...
    if (!var_core_value_sig32F8.get(n.ICommandService).syncExecuteCommand(g.id, g.replaceConfig({
      unitId: var_core_value_sig5B67,
      chartId: var_core_value_sig8889,
  ...
  _replaceConfig(var_core_value_sig9989) {
    ...
    let {
      ...
      var_core_value_sig20C8 = var_core_value_sig2DAB.get(w).ensureChartModel(var_core_value_sig877E, var_core_value_sig2809);
    if (!var_core_value_sig20C8) throw Error("Chart not found: " + var_core_value_sig2809);
    let var_core_value_sigE9A7 = (0, e.toChartModelConfigReplacement)(var_core_value_sig9989, {
    ...
    if (!var_core_value_sig2DAB.get(n.ICommandService).syncExecuteCommand(g.id, g.replaceConfig({
      unitId: var_core_value_sig877E,
      chartId: var_core_value_sig2809,
  ...
  setDataSource(var_core_value_sigBECE) {
    return this.commitDataSource(Array.isArray(var_core_value_sigBECE) ? {
      ...
      source: e.ResourceRefChartDataSourceAdapter["toReference"](var_core_value_sigBECE)
    });
  }
  ...
  arrange(var_core_value_sigA5F1) {
    ...
    if (var_core_value_sig2E11 < 0) throw Error("Slide chart element not found: " + var_core_value_sig07E9);
    this.setZOrder((0, n.getDrawingOrderIndex)(var_core_value_sig2E11, var_core_value_sig8CFA.length, var_core_value_sigA5F1));
  }
  ...
  resolveData(var_core_value_sigB098, var_core_value_sigCE71) {
    let {
      ...
      var_core_value_sigB33B = var_core_value_sig2B65.get(w).ensureChartModel(var_core_value_sigD7EA, var_core_value_sig21D8);
    if (!var_core_value_sigB33B) throw Error("Chart not found: " + var_core_value_sig21D8);
    return (0, e.buildChartPreviewData)(var_core_value_sigB33B.model, var_core_value_sigB098, var_core_value_sigCE71);
  }
  resolveDataSet(var_core_value_sig24B9) {
    ...
    let {
      ...
      var_core_value_sig2D58 = var_core_value_sig9A0D.get(w).ensureChartModel(var_core_value_sigA319, var_core_value_sig273D),
      var_core_value_sig223F = var_core_value_sig9A0D.get(o).getChart(var_core_value_sigA319, var_core_value_sig273D);
    if (!var_core_value_sig2D58 || !var_core_value_sig223F) throw Error("Chart not found: " + var_core_value_sig273D);
    return (0, e.buildOrientedChartDataSet)(var_core_value_sig24B9, {
      headerRow: ((var_core_value_sigE627 = var_core_value_sig223F.context) == null ? undefined : var_core_value_sigE627.headerRow) ?? e.DEFAULT_CHART_RESOURCE_HEADER_ROW,
  ...
  commitHost(var_core_value_sigD749) {
    let {
      ...
      var_core_value_sig6418 = var_core_value_sig5090.get(n.ICommandService);
    if (var_core_value_sigD749.data !== undefined) {
      let var_core_value_sigBC46 = var_core_value_sig5090.get(o).getChart(var_core_value_sigDB4A, var_core_value_sigCFFA);
      if (!var_core_value_sigBC46 || !var_core_value_sig6418.syncExecuteCommand(_.id, {
        unitId: var_core_value_sigDB4A,
    ...
    if (var_core_value_sigD749.position || var_core_value_sigD749.size || "placeholder" in var_core_value_sigD749 || "stroke" in var_core_value_sigD749) {
      ...
      if (!var_core_value_sig3D7D) throw Error("Slide\x20chart\x20element\x20not\x20found:\x20" + var_core_value_sig58C1);
      ...
      if (!E(var_core_value_sig3D7D, var_core_value_sig27E5) && !var_core_value_sig6418.syncExecuteCommand(t.UpdateSlideDrawingCommand["id"], {
        patches: [{
          unitId: var_core_value_sigDB4A,
          subUnitId: var_core_value_sigAD56,
  ...
  remove() {
    ...
    return var_core_value_sig3F4C.get(n.ICommandService).syncExecuteCommand(p.id, {
      unitId: var_core_value_sig5A13,
      subUnitId: var_core_value_sigD65A,
      chartId: var_core_value_sig0285,
      elementId: var_core_value_sig777D
  ...
  _commitDataSource(var_core_value_sigF593) {
    ...
    if (!var_core_value_sigB512.get(n.ICommandService).syncExecuteCommand(u.id, {
      unitId: var_core_value_sigF2E6,
      chartId: var_core_value_sig3607,
  ...
  _commitZOrder(var_core_value_sig34C8) {
    ...
    if (!var_core_value_sig5410) throw Error("Slide not found: " + var_core_value_sig3E68);
    ...
    if (var_core_value_sig492F.splice((0, n.normalizeDrawingOrderIndex)(var_core_value_sig34C8, var_core_value_sig5410.elementOrder["length"]), 0, var_core_value_sigB744), !var_core_value_sig492F.every((var_core_value_sig4D4C, var_core_value_sigC9E0) => var_core_value_sig4D4C === var_core_value_sig5410.elementOrder[var_core_value_sigC9E0]) && !var_core_value_sigEAE2.get(n.ICommandService).syncExecuteCommand(t.ReorderSlideElementsCommand["id"], {
      unitId: var_core_value_sigF4C5,
      subUnitId: var_core_value_sig3E68,
...
function E(var_core_value_sigF79C, var_core_value_sig2E54) {
  return JSON.stringify(D(var_core_value_sigF79C)) === JSON.stringify(D(var_core_value_sig2E54));
}
function D(var_core_value_sig7658) {
  let var_core_value_sigDCF5 = n.Tools["deepClone"](var_core_value_sig7658);
...
const O = {
    ...
    handler: (var_core_value_sigC786, var_core_value_sigC0D9) => {
      ...
      let var_core_value_sigF0511 = (0, t.getSlideCommandTarget)(var_core_value_sigC786.get(n.IUniverInstanceService), var_core_value_sigC0D9);
      ...
      let {
        ...
        var_core_value_sig548A = var_core_value_sigC786.get(o),
      ...
      let var_core_value_sig2983 = var_core_value_sigC786.get(n.ICommandService),
        var_core_value_sigE1B0 = var_core_value_sigC786.get(n.IUndoRedoService),
      ...
      return (0, n.sequenceExecute)(var_core_value_sigDD1C, var_core_value_sig2983).result ? (var_core_value_sigE1B0.pushUndoRedo({
        unitID: var_core_value_sig5825,
  ...
  k = [["Category", "Value"], ["A", 12], ["B", 18], ["C", 9]],
  A = {
  ...
  j = {
    ...
    handler: (var_core_value_sigB7D1, var_core_value_sig64F0) => {
      ...
      let var_core_value_sig3141 = (0, t.getSlideCommandTarget)(var_core_value_sigB7D1.get(n.IUniverInstanceService), var_core_value_sig64F0);
      if (!var_core_value_sig3141) return false;
      let var_core_value_sig2162 = n.Tools["deepClone"](var_core_value_sig64F0.chart);
      if (!var_core_value_sig2162.chartType) return false;
      var_core_value_sig2162.id ||= (0, n.generateRandomId)(6), var_core_value_sig2162.context = {
        ...var_core_value_sig2162.context,
        headerRow: ((var_core_value_sig85B1 = var_core_value_sig2162.context) == null ? undefined : var_core_value_sig85B1.headerRow) ?? e.DEFAULT_CHART_RESOURCE_HEADER_ROW
      };
      let var_core_value_sig2EAD = var_core_value_sigB7D1.get(t.ISlideDrawingService),
        var_core_value_sig6774 = var_core_value_sigB7D1.get(n.ICommandService),
        var_core_value_sig340D = var_core_value_sigB7D1.get(n.IUndoRedoService),
        {
        ...
        var_core_value_sigBBEE = M(var_core_value_sig64F0.dataSource);
      var_core_value_sig2162.dataSourceId = var_core_value_sigBBEE.id;
      let var_core_value_sig011D = N({
        unitId: var_core_value_sig82D4,
        subUnitId: var_core_value_sigBDE4,
      ...
      let var_core_value_sig6167 = {
        ...
        var_core_value_sig4C07 = (0, n.sequenceExecute)(var_core_value_sig7F19, var_core_value_sig6774);
      ...
      }), true) : ((0, n.sequenceExecute)(var_core_value_sig4C07.index === 1 ? [{
        id: s.id,
        params: var_core_value_sig652C
...
function M(var_core_value_sig79AB) {
  let var_core_value_sig8E74 = (var_core_value_sig79AB == null ? undefined : var_core_value_sig79AB.id) ?? (0, n.generateRandomId)(6),
    ...
    var_core_value_sig841D = var_core_value_sig79AB != null && var_core_value_sig79AB.source ? {
      ...
      id: var_core_value_sig8E74,
      name: var_core_value_sig104C,
      values: ((var_core_value_sig79AB == null ? undefined : var_core_value_sig79AB.values) ?? k).map(var_core_value_sig8EA0 => [...var_core_value_sig8EA0])
    };
  return var_core_value_sig841D.name ?? delete var_core_value_sig841D.name, var_core_value_sig841D;
}
function N(var_core_value_sig90CB) {
  let {
    ...
    var_core_value_sig6201 = var_core_value_sig90CB.element ? n.Tools["deepClone"](var_core_value_sig90CB.element) : {},
    {
  ...
  if (var_core_value_sig85C3) {
    ...
    if ((var_core_value_sigA6F6 == null ? undefined : var_core_value_sigA6F6.sourcePageType) !== t.PageTypeEnum["Slide"]) return null;
    let var_core_value_sigCDDA = P({
        chartId: var_core_value_sig1614,
  ...
  var_core_value_sig6201.id ||= (0, n.generateRandomId)(6);
...
function P(var_core_value_sigA56E) {
  let {
    ...
    var_core_value_sig9D15 = {
      ...
      chartId: var_core_value_sig1998,
      stroke: var_core_value_sig43B8 ?? A,
      transform: {
...
const F = {
  ...
  handler: (var_core_value_sigB785, var_core_value_sig130F) => {
    ...
    let var_core_value_sigC0E3 = (0, t.getSlideCommandTarget)(var_core_value_sigB785.get(n.IUniverInstanceService), var_core_value_sig130F);
    ...
    let {
      ...
      var_core_value_sigF175 = var_core_value_sigB785.get(o).getChart(var_core_value_sig52F7, var_core_value_sig866F);
    if (!var_core_value_sigF175) return false;
    let var_core_value_sig6A18 = var_core_value_sigB785.get(n.ICommandService),
      var_core_value_sig4E3D = var_core_value_sigB785.get(n.IUndoRedoService),
    ...
    return (0, n.sequenceExecute)(var_core_value_sigBCA9, var_core_value_sig6A18).result ? (var_core_value_sig4E3D.pushUndoRedo({
      unitID: var_core_value_sig52F7,
...
let z = class extends n.Disposable {
  constructor(var_core_value_sig21B2, var_core_value_sigDE08, var_core_value_sigACCB) {
    super(), this._resourceManagerService = var_core_value_sig21B2, this._resourceService = var_core_value_sigDE08, this._modelService = var_core_value_sigACCB, x(this, "_resourceDisposable", null), this._initResource();
  }
  _initResource() {
...
z = C([S(0, n.IResourceManagerService), S(1, (0, n.Inject)(o)), S(2, (0, n.Inject)(w))], z);
let B = class extends n.Plugin {
  constructor(var_core_value_sig7F33 = R, var_core_value_sig0C53, var_core_value_sigEA04, var_core_value_sig7A62) {
  ...
  onStarting() {
    ...
    [[o], [w], [z]].forEach(var_core_value_sig2BCF => var_core_value_sig7565.add(var_core_value_sig2BCF)), (0, n.touchDependencies)(var_core_value_sig7565, [[o], [w], [z]]);
  }
  _initCommands() {
    [j, u, F, _, g, O, p, c, s, l, f].forEach(var_core_value_sig0D69 => {
      this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig0D69));
    });
  }
};
x(B, "type", n.UniverInstanceType["UNIVER_SLIDE"]), x(B, "pluginName", "UniverSlidesChartPlugin"), x(B, "packageName", I), x(B, "version", L), B = C([(0, n.DependentOn)(e.UniverChartPlugin, a.UniverLicensePlugin), S(1, (0, n.Inject)(n.Injector)), S(2, n.IConfigService), S(3, n.ICommandService)], B), exports.ChangeSlideChartDataSourceCommand = u, exports.DEFAULT_SLIDE_CHART_ELEMENT_HEIGHT = 320, exports.DEFAULT_SLIDE_CHART_ELEMENT_LEFT = 120, exports.DEFAULT_SLIDE_CHART_ELEMENT_TOP = 80, exports.DEFAULT_SLIDE_CHART_ELEMENT_WIDTH = 480, exports.DEFAULT_SLIDE_CHART_STROKE = A, exports.DEFAULT_SLIDE_CHART_VALUES = k, exports.DuplicateSlideChartDataSourceCommand = O, exports.InsertSlideChartCommand = j, exports.RemoveSlideChartCommand = p, exports.RemoveSlideChartDataSourceMutation = s, exports.RemoveSlideChartSnapshotMutation = f, exports.SetSlideChartDataSourceMutation = c, exports.SetSlideChartSnapshotMutation = l, exports.SlideChartConfigAdapter = T, Object.defineProperty(exports, "SlideChartModelService", {
  enumerable: true,
  get: function () {
    return w;
  }
}), exports.SlideChartResourceService = o, Object.defineProperty(exports, "UniverSlidesChartPlugin", {
  enumerable: true,
  get: function () {
    return B;
  }
}), exports.UpdateSlideChartConfigCommand = g, exports.UpdateSlideChartDataSourceCommand = _, exports.UpdateSlideChartSnapshotCommand = F;
