...
function R(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46103){return{id:L,type:MenuItemType.SUBITEMS,icon:"DirectExportIcon",tooltip:"slides-exchange-client.file",hidden$:getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46103,UniverInstanceType.UNIVER_SLIDE)};}function z(){return{id:F.id,type:MenuItemType.BUTTON,title:"slides-exchange-client.upload",icon:"FolderIcon"};}function B(){return{id:I.id,type:MenuItemType.BUTTON,title:"slides-exchange-client.download",icon:"ExportIcon"};}const V={[RibbonStartGroup.OTHERS]:{[L]:{order:0.3,gridLayout:{row:1,column:3,rowSpan:2,showLabel:true},menuItemFactory:R,[F.id]:{order:0,menuItemFactory:z},[I.id]:{order:1,menuItemFactory:B}}}};
