...
export interface IUniverSlidesHistoryViewerConfig extends IUniverEditHistoryUIConfig {
    collaborationClientConfig?: IUniverCollaborationClientConfig;
}
export declare class UniverSlidesHistoryViewerPlugin extends UniverEditHistoryUIPlugin {
    protected readonly _injector: Injector;
    static pluginName: string;
    static packageName: string;
    static version: string;
    static type: UniverInstanceType;
    constructor(viewerConfig: IUniverSlidesHistoryViewerConfig, _injector: Injector, configService: IConfigService, logService: ILogService);
    onStarting(): void;
}
