...
let e = require("@univerjs/core"),
  ...
  f = function (var_core_value_sig1537) {
...
function h(var_core_value_sig156F) {
  ...
  return {
    ...
    slidesPerPage: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.slidesPerPage, 2),
    handoutOrder: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.handoutOrder, "Horizontal"),
    paperSize: var_core_value_sig156F == null ? undefined : var_core_value_sig156F.paperSize,
    direction: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.direction, var_core_value_sigF057 ? n.PrintDirection["Landscape"] : n.PrintDirection["Portrait"]),
    margin: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.margin, var_core_value_sig156F != null && var_core_value_sig156F.paperSize ? n.PrintPaperMargin["Normal"] : n.PrintPaperMargin["None"]),
    marginCustom: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.marginCustom, {
      top: 0,
      right: 0,
      bottom: 0,
      left: 0
    }),
    frameSlides: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.frameSlides, !var_core_value_sigF057),
    showSlideNumber: m(var_core_value_sig156F == null ? undefined : var_core_value_sig156F.showSlideNumber, !var_core_value_sigF057)
  };
}
function g(var_core_value_sig72F6, var_core_value_sig9FBA, var_core_value_sigFE01, var_core_value_sigA2CE = var_core_value_sig480E => var_core_value_sig480E.length * 14 * 0.55) {
  let var_core_value_sig1975 = (0, r.resolveSlideLogicalPageSize)(var_core_value_sig9FBA),
    var_core_value_sig6EA1 = h(var_core_value_sigFE01);
  !(var_core_value_sigFE01 != null && var_core_value_sigFE01.direction) && var_core_value_sig6EA1.layout === "FullPage" && (var_core_value_sig6EA1.direction = var_core_value_sig1975.width >= var_core_value_sig1975.height ? n.PrintDirection["Landscape"] : n.PrintDirection["Portrait"]);
  let var_core_value_sig029F = v(var_core_value_sig1975, var_core_value_sig6EA1),
    var_core_value_sig3767 = var_core_value_sig6EA1.margin === n.PrintPaperMargin["Custom"] ? var_core_value_sig6EA1.marginCustom : n.PaperMarginMap[var_core_value_sig6EA1.margin],
    var_core_value_sig670B = y(var_core_value_sig029F, var_core_value_sig3767),
    var_core_value_sig6912;
  switch (var_core_value_sig6EA1.layout) {
    case "Handout":
      var_core_value_sig6912 = b(var_core_value_sig72F6, var_core_value_sig670B, var_core_value_sig6EA1.slidesPerPage, var_core_value_sig6EA1.handoutOrder);
      break;
    case "NotesPage":
      var_core_value_sig6912 = C(var_core_value_sig72F6, var_core_value_sig670B, var_core_value_sigA2CE);
      break;
    default:
...
function _(var_core_value_sigE235, var_core_value_sig7664) {
  let var_core_value_sig2281 = (0, r.resolveSlideLogicalPageSize)(var_core_value_sig7664);
  return var_core_value_sigE235.map(({
    ...
    let var_core_value_sig8889 = var_core_value_sigA621.getData(),
      var_core_value_sig32F8 = (0, r.resolveSlideLogicalPageSize)(var_core_value_sig8889.pageSize ?? var_core_value_sig2281);
    return {
      index: var_core_value_sigBBFF,
      page: var_core_value_sigA621,
...
function v(var_core_value_sig5E86, var_core_value_sig6998) {
  let var_core_value_sigF639 = var_core_value_sig6998.paperSize ? e.PAGE_SIZE[var_core_value_sig6998.paperSize] : var_core_value_sig5E86,
  ...
  return var_core_value_sig6998.direction === n.PrintDirection["Portrait"] ? {
...
function y(var_core_value_sig6D47, var_core_value_sigCB82) {
  return {
...
function b(var_core_value_sigCF4E, var_core_value_sig6CAD, var_core_value_sig8CF5, var_core_value_sigDDD7) {
  ...
  for (let var_core_value_sig5B67 = 0; var_core_value_sig5B67 < var_core_value_sigCF4E.length; var_core_value_sig5B67 += var_core_value_sig8CF5) {
    let var_core_value_sigF0F9 = var_core_value_sigCF4E.slice(var_core_value_sig5B67, var_core_value_sig5B67 + var_core_value_sig8CF5),
      var_core_value_sig1A0F = S(x(var_core_value_sig6CAD, var_core_value_sig8CF5), var_core_value_sig8CF5, var_core_value_sigDDD7);
...
function x(var_core_value_sig443C, var_core_value_sig39B1) {
...
function S(var_core_value_sig3BF6, var_core_value_sig38CE, var_core_value_sig62B7) {
...
function C(var_core_value_sig7A3C, var_core_value_sig0511, var_core_value_sig1F44) {
  ...
  for (let var_core_value_sig2902 of var_core_value_sig7A3C) {
    let var_core_value_sig4383 = var_core_value_sig0511.height * 0.42,
      ...
      var_core_value_sigD955 = ee(var_core_value_sig2902.speakerNotes, var_core_value_sig186C.width, var_core_value_sig1F44),
...
function ee(var_core_value_sig947E, var_core_value_sig4545, var_core_value_sigF39A) {
...
function T(var_core_value_sig7658) {
  "@babel/helpers - typeof";

  return T = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig2809) {
  ...
  }, T(var_core_value_sig7658);
}
function E(var_core_value_sigDCF5, var_core_value_sigC786) {
  if (T(var_core_value_sigDCF5) != "object" || !var_core_value_sigDCF5) return var_core_value_sigDCF5;
  ...
  if (var_core_value_sigC0D9 !== undefined) {
    ...
    if (T(var_core_value_sigF051) != "object") return var_core_value_sigF051;
    throw TypeError("@@toPrimitive must return a primitive value.");
  }
  return (var_core_value_sigC786 === "string" ? String : Number)(var_core_value_sigDCF5);
}
function D(var_core_value_sig5825) {
  var var_core_value_sig4EB7 = E(var_core_value_sig5825, "string");
  return T(var_core_value_sig4EB7) == "symbol" ? var_core_value_sig4EB7 : var_core_value_sig4EB7 + "";
}
function O(var_core_value_sig73AF, var_core_value_sig548A, var_core_value_sigE026) {
  return (var_core_value_sig548A = D(var_core_value_sig548A)) in var_core_value_sig73AF ? Object.defineProperty(var_core_value_sig73AF, var_core_value_sig548A, {
...
var A = class extends e.Disposable {
  constructor(...var_core_value_sig877E) {
    super(...var_core_value_sig877E), O(this, "_visible$", new t["BehaviorSubject"](false)), O(this, "_options$", new t["BehaviorSubject"](w())), O(this, "visible$", this._visible$["asObservable"]()), O(this, "options$", this._options$["asObservable"]());
  }
  get visible() {
...
const j = {
    ...
    handler(var_core_value_sig339E, var_core_value_sig7550) {
      return var_core_value_sig339E.get(k).open(var_core_value_sig7550), true;
    }
  },
  M = {
    ...
    handler(var_core_value_sig2983) {
      return var_core_value_sig2983.get(k).close(), true;
    }
  };
var N = class {
  constructor() {
  ...
  register(var_core_value_sigBECE) {
    return this._transformers["add"](var_core_value_sigBECE), (0, e.toDisposable)(() => this._transformers["delete"](var_core_value_sigBECE));
  }
...
function P(var_core_value_sigE1B0, var_core_value_sigD4FF) {
  ...
  return {
    ...
    order: var_core_value_sigD4FF.filter(var_core_value_sig7B2A => {
      ...
      return (0, r.isThumbnailRenderableDrawing)(var_core_value_sig06CD) ? (var_core_value_sig1E5B[var_core_value_sig7B2A] = var_core_value_sig06CD, true) : false;
    })
  };
}
function te(var_core_value_sigB680, var_core_value_sig1F64, var_core_value_sigDD1C) {
  ...
  if (var_core_value_sig85B1.some(var_core_value_sigA5F1 => !!var_core_value_sig64F0[var_core_value_sigA5F1])) return P(var_core_value_sig64F0, var_core_value_sig85B1);
  let var_core_value_sig3141 = (0, i.resolvedSlideLayersToDrawingMap)(var_core_value_sig2C39, var_core_value_sigB7D1, var_core_value_sigDD1C.resolveElements(), var_core_value_sig1F64.getThemeDataForPage(var_core_value_sigB7D1));
  return P(var_core_value_sig3141.data, var_core_value_sig3141.order);
}
var ne = class extends e.Disposable {
  ...
  get _pageSize() {
    return (0, r.resolveSlideLogicalPageSize)(this._slidePage["getData"]().pageSize ?? this._slideModel["getSnapshot"]().defaultPageSize);
  }
  constructor(var_core_value_sig97A2, var_core_value_sig07E9, var_core_value_sig4F59, var_core_value_sigF564, var_core_value_sig8CFA = false) {
    super(), this._injector = var_core_value_sig97A2, this._slideDrawingService = var_core_value_sig07E9, this._slideModel = var_core_value_sig4F59, this._slidePage = var_core_value_sigF564, this._autoRender = var_core_value_sig8CFA, O(this, "_container", document.createElement("div")), O(this, "_root", document.createElement("div")), O(this, "_engine", undefined), O(this, "_scene", undefined), O(this, "_objectProvider", undefined), O(this, "_renderObjectMap", new Map()), O(this, "_drawingTransformService", undefined), this._drawingTransformService = this._injector["get"](N), this._objectProvider = this._injector["createInstance"](r.ObjectProvider), this._initRenderer(), this.disposeWithMe({
      dispose: () => {
  ...
  _initRenderer() {
    let var_core_value_sig2E11 = "slide-print-" + (0, e.generateRandomId)(4),
      {
    ...
    this._engine = new a["Engine"]("", {
    ...
    }), this._scene = new a.Scene(var_core_value_sig2E11, this._engine), this._scene["disableObjectsEvent"](), this._scene["transformByState"]({
      width: var_core_value_sig5B69,
      height: var_core_value_sigB098,
      scaleX: 1,
      scaleY: 1
      ...
      height: var_core_value_sigB098,
      active: true
    }).openClip(), this._engine["mount"](this._container, false), this._engine["getCanvas"]().getContext().setId(var_core_value_sig2E11 + "_" + (0, e.generateRandomId)(4)), this._renderSlidePage();
  }
  _renderSlidePage() {
    let var_core_value_sigCE71 = this._slideModel["getUnitId"](),
      ...
      var_core_value_sig24B9 = this._injector["createInstance"](r.SlidePageBackgroundObject, "slide-print-page-background-" + var_core_value_sigCE71 + "-" + var_core_value_sig21D8, {
        left: 0,
        top: 0,
        width: var_core_value_sig2B65,
        height: var_core_value_sigD7EA,
    ...
    let {
      ...
      } = this._drawingTransformService["transform"](te(this._slideDrawingService, this._slideModel, this._slidePage), {
        slideModel: this._slideModel,
        slidePage: this._slidePage
      }),
      var_core_value_sig273D = (0, r.resolveGroupFillInheritance)(var_core_value_sigE627),
      var_core_value_sig9A0D = new r["SlidePageClipGroup"]("slide-print-page-clip-" + var_core_value_sigCE71 + "-" + var_core_value_sig21D8, {
        left: 0,
        top: 0,
        width: var_core_value_sig2B65,
        height: var_core_value_sigD7EA
    ...
    var_core_value_sigB33B.addObject(var_core_value_sig9A0D, 0), this._renderObjectMap["set"](var_core_value_sig9A0D.oKey, var_core_value_sig9A0D), this._objectProvider["convertToRenderObjects"](var_core_value_sig273D, var_core_value_sigEF3E, {
      ...
      var_core_value_sigB33B.addObject(var_core_value_sigD873, a.DRAWING_OBJECT_LAYER_INDEX), this._renderObjectMap["set"](var_core_value_sigD873.oKey, var_core_value_sigD873);
    }), (0, r.assembleGroupHierarchy)(var_core_value_sig273D, var_core_value_sigEF3E, var_core_value_sigB33B, {
      unitId: var_core_value_sigCE71,
      subUnitId: var_core_value_sig21D8,
      pageOffsetLeft: 0,
      pageOffsetTop: 0,
...
var I = class extends e.Disposable {
  ...
  _mountSlides() {
    this._plan["slots"].forEach(var_core_value_sig09B8 => {
      ...
      var_core_value_sig6F91.className = "univer-slide-print-slot", R(var_core_value_sig6F91, var_core_value_sig09B8.rect), var_core_value_sig6F91.style["overflow"] = "hidden", this.container["appendChild"](var_core_value_sig6F91);
  ...
  _mountHandoutLines(var_core_value_sigAD56) {
    ...
    R(var_core_value_sigDB4A, var_core_value_sigAD56), var_core_value_sigDB4A.style["display"] = "flex", var_core_value_sigDB4A.style["flexDirection"] = "column", var_core_value_sigDB4A.style["justifyContent"] = "space-evenly";
    for (let var_core_value_sig12F2 = 0; var_core_value_sig12F2 < 6; var_core_value_sig12F2++) {
      ...
      var_core_value_sig2BCF.style["borderBottom"] = "1px\x20solid\x20currentColor", var_core_value_sig2BCF.style["opacity"] = "0.4", var_core_value_sigDB4A.appendChild(var_core_value_sig2BCF);
    }
  ...
  _mountNotes() {
    ...
    R(var_core_value_sig1896, var_core_value_sig6418.rect), var_core_value_sig1896.style["boxSizing"] = "border-box", var_core_value_sig1896.style["font"] = "14px/21px Arial, sans-serif", var_core_value_sig1896.style["overflow"] = "hidden", var_core_value_sig1896.style["whiteSpace"] = "pre", var_core_value_sig1896.dir = "auto", var_core_value_sig6418.lines["forEach"](var_core_value_sig2259 => {
...
function L(var_core_value_sig2162, var_core_value_sig2EAD, var_core_value_sig6774) {
...
function R(var_core_value_sig7DF1, var_core_value_sigDC86) {
...
function z(var_core_value_sig0B0C, var_core_value_sigA39E, var_core_value_sigBBEE) {
  let var_core_value_sig011D = var_core_value_sig0B0C.createElement("style"),
    var_core_value_sig6167 = var_core_value_sigBBEE.paperSize ? "size:\x20" + var_core_value_sigBBEE.paperSize + "\x20" + var_core_value_sigBBEE.direction["toLowerCase"]() + ";" : "";
  return var_core_value_sig011D.className = "offline-printing-css", var_core_value_sig011D.textContent = "\n html, body {\n margin: 0;\n padding: 0;\n }\n ." + n.PRINT_CONTAINER_CLASS + "\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20position:\x20relative;\x0a\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20\x20\x20\x20\x20." + F + " {\n position: relative;\n width: " + var_core_value_sigA39E.width + "px;\n height: " + var_core_value_sigA39E.height + "px;\n overflow: hidden;\n }\n @media print {\n @page {\n size: " + var_core_value_sigA39E.width + "px\x20" + var_core_value_sigA39E.height + "px;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20" + var_core_value_sig6167 + "\n margin: 0;\n }\n ." + F + " {\n break-after: page;\n page-break-after: always;\n }\n ." + F + ":last-child\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20break-after:\x20auto;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20page-break-after:\x20auto;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20", var_core_value_sig011D;
}
function B(var_core_value_sig65A1) {
...
function V(var_core_value_sig7F19, var_core_value_sig7827) {
  return Math.max(0, Math.min(var_core_value_sig7827 - 1, var_core_value_sig7F19 - 1));
}
function H(var_core_value_sig652C, var_core_value_sig7E32) {
  ...
  return var_core_value_sig7E32.forEach(var_core_value_sig3F4C => {
    if (!B(var_core_value_sig3F4C) || var_core_value_sig3F4C.to < 1 || var_core_value_sig3F4C.from > var_core_value_sig652C) return;
    let var_core_value_sigD65A = V(var_core_value_sig3F4C.from, var_core_value_sig652C),
      var_core_value_sig5A13 = V(var_core_value_sig3F4C.to, var_core_value_sig652C);
...
function U(var_core_value_sig79AB, var_core_value_sig8E74) {
...
function W(var_core_value_sig104C, var_core_value_sig841D, var_core_value_sig90CB, var_core_value_sigBDF5) {
...
let G = class extends e.Disposable {
  constructor(var_core_value_sig34C8, var_core_value_sigB744, var_core_value_sigEAE2, var_core_value_sigE68A, var_core_value_sig3E68) {
    super(), this._univerInstanceService = var_core_value_sig34C8, this._injector = var_core_value_sigB744, this._slideDrawingService = var_core_value_sigEAE2, this._renderManagerService = var_core_value_sigE68A, this._printPreparationService = var_core_value_sig3E68, O(this, "_printing", false);
  }
  async print(var_core_value_sigF4C5, var_core_value_sig5410) {
    if (this._printing) return Promise.resolve(false);
    let var_core_value_sig492F = this._univerInstanceService["getUnit"](var_core_value_sigF4C5, e.UniverInstanceType["UNIVER_SLIDE"]);
    if (!var_core_value_sig492F) return Promise.resolve(false);
    let var_core_value_sig8EA0 = var_core_value_sig492F.getSnapshot(),
      var_core_value_sigA6F6 = H(var_core_value_sig8EA0.slideOrder["length"], var_core_value_sig5410 == null ? undefined : var_core_value_sig5410.range).map(var_core_value_sigDBB7 => ({
  ...
  _preparePrintResources(var_core_value_sigE243, var_core_value_sig74A8, var_core_value_sig21B2, var_core_value_sigDE08) {
    ...
    let var_core_value_sig0C53 = g(_(var_core_value_sig21B2, var_core_value_sigACCB.defaultPageSize), var_core_value_sigACCB.defaultPageSize, var_core_value_sigDE08, var_core_value_sig362B => (var_core_value_sig7F33 == null ? undefined : var_core_value_sig7F33.measureText(var_core_value_sig362B).width) ?? var_core_value_sig362B.length * 14 * 0.55),
      var_core_value_sigEA04 = z(var_core_value_sigE243.document, var_core_value_sig0C53.pageSize, var_core_value_sig0C53.options),
      var_core_value_sig7A62 = var_core_value_sigE243.document["createElement"]("div");
    var_core_value_sig7A62.className = n.PRINT_CONTAINER_CLASS;
    let var_core_value_sig8109 = var_core_value_sig0C53.pages["map"](var_core_value_sig5CA5 => new I(var_core_value_sigE243.document, this._injector, this._slideDrawingService, var_core_value_sig74A8, var_core_value_sig5CA5, var_core_value_sig0C53.pageSize, var_core_value_sig0C53.options));
...
G = W([U(0, e.IUniverInstanceService), U(1, (0, e.Inject)(e.Injector)), U(2, i.ISlideDrawingService), U(3, a.IRenderManagerService), U(4, n.IPrintPreparationService)], G);
const K = {
  id: "slide.operation.print",
  type: e.CommandType["OPERATION"],
  handler: async (var_core_value_sig4BBA, var_core_value_sig6201) => {
    let var_core_value_sig5151 = var_core_value_sig4BBA.get(e.IUniverInstanceService),
      var_core_value_sigB542 = var_core_value_sig4BBA.get(G),
      var_core_value_sigBB6C = var_core_value_sig5151.getCurrentUnitOfType(e.UniverInstanceType["UNIVER_SLIDE"]);
    return var_core_value_sigBB6C ? var_core_value_sigB542.print(var_core_value_sigBB6C.getUnitId(), var_core_value_sig6201) : false;
  }
};
function q(var_core_value_sigE2BF) {
  return {
    id: j.id,
    ...
    hidden$: (0, o.getMenuHiddenObservable)(var_core_value_sigE2BF, e.UniverInstanceType["UNIVER_SLIDE"])
  };
}
const J = {
...
function oe(var_core_value_sig43B8) {
...
function se({
  ...
  let var_core_value_sigB785 = (0, u.useRef)(null),
    var_core_value_sig130F = (0, o.useDependency)(e.Injector),
    var_core_value_sigC0E3 = (0, o.useDependency)(i.ISlideDrawingService),
  ...
  return (0, u.useEffect)(() => {
    ...
    let var_core_value_sig77EE = new I(document, var_core_value_sig130F, var_core_value_sigC0E3, var_core_value_sigD98F, var_core_value_sig66C0, var_core_value_sig9D15.pageSize, {
      ...var_core_value_sig9D15.options,
      preview: true
    });
    return var_core_value_sig77EE.container["style"].transform = "scale(" + var_core_value_sig52F7 + ")", var_core_value_sig77EE.container["style"].transformOrigin = "top\x20left", var_core_value_sig77EE.container["classList"].add("univer-shadow-sm"), var_core_value_sig00CB.appendChild(var_core_value_sig77EE.container), var_core_value_sig77EE.render(), () => var_core_value_sig77EE.dispose();
  }, [var_core_value_sig130F, var_core_value_sigD98F, var_core_value_sig66C0, var_core_value_sig9D15, var_core_value_sig52F7, var_core_value_sigC0E3]), (0, d.jsx)("div", {
...
function ce({
  ...
  let var_core_value_sigDE3D = (0, o.useDependency)(k),
    var_core_value_sigF175 = (0, o.useObservable)(var_core_value_sigDE3D.options$, var_core_value_sigDE3D.options),
    var_core_value_sig6A18 = (0, o.useDependency)(e.LocaleService),
    [var_core_value_sig4E3D, var_core_value_sig49B0] = (0, u.useState)(() => oe(var_core_value_sigF175.range)),
    [var_core_value_sig2547, var_core_value_sigBCA9] = (0, u.useState)(true),
  ...
  return (0, d.jsx)("div", {
    className: (0, l.clsx)("univer-h-full univer-overflow-y-auto", l.scrollbarClassName),
    children: (0, d.jsxs)("div", {
      className: "univer-p-4",
      children: [(0, d.jsxs)(l.FormLayout, {
        label: var_core_value_sig6A18.t("slides-print.settings.range"),
        children: [(0, d.jsx)(l.Input, {
          ...
          onChange: var_core_value_sig9F76 => {
            ...
            let var_core_value_sigB008 = ae(var_core_value_sig9F76, var_core_value_sig866F);
        ...
        }), !var_core_value_sig2547 && (0, d.jsx)("div", {
        ...
        children: (0, d.jsx)(l.Select, {
          ...
          onChange: var_core_value_sig8721 => {
            let var_core_value_sig08BA = Object.values(f).find(var_core_value_sig9C9F => var_core_value_sig9C9F === var_core_value_sig8721);
            var_core_value_sig08BA && var_core_value_sigDE3D.updateOptions({
              layout: var_core_value_sig08BA,
              direction: var_core_value_sig08BA === "FullPage" ? n.PrintDirection["Landscape"] : n.PrintDirection["Portrait"],
              frameSlides: var_core_value_sig08BA !== "FullPage",
              showSlideNumber: var_core_value_sig08BA !== "FullPage"
            });
          }
        })
      }), var_core_value_sig4CDF === "Handout" && (0, d.jsxs)(d.Fragment, {
        children: [(0, d.jsx)(l.FormLayout, {
        ...
        }), var_core_value_sig3F79 >= 4 && (0, d.jsx)(l.FormLayout, {
        ...
        children: (0, d.jsx)(l.Select, {
          className: "univer-w-full",
          value: var_core_value_sigF175.paperSize ?? e.PaperType["A4"],
          options: e.PAPER_TYPES["map"](var_core_value_sigE347 => ({
            label: var_core_value_sigE347,
            value: var_core_value_sigE347
          })),
          onChange: var_core_value_sig3C5B => {
            let var_core_value_sig200B = e.PAPER_TYPES["find"](var_core_value_sig86D0 => var_core_value_sig86D0 === var_core_value_sig3C5B);
        ...
        children: (0, d.jsxs)(l.RadioGroup, {
          value: var_core_value_sigF175.direction ?? n.PrintDirection["Landscape"],
          onChange: var_core_value_sig3863 => {
            (var_core_value_sig3863 === n.PrintDirection["Portrait"] || var_core_value_sig3863 === n.PrintDirection["Landscape"]) && var_core_value_sigDE3D.updateOptions({
        ...
        children: (0, d.jsx)(l.Select, {
          className: "univer-w-full",
          value: var_core_value_sigF175.margin ?? n.PrintPaperMargin["Normal"],
          options: [{
          ...
          onChange: var_core_value_sigC97C => {
            (var_core_value_sigC97C === n.PrintPaperMargin["Normal"] || var_core_value_sigC97C === n.PrintPaperMargin["Narrow"] || var_core_value_sigC97C === n.PrintPaperMargin["Wide"] || var_core_value_sigC97C === n.PrintPaperMargin["None"]) && var_core_value_sigDE3D.updateOptions({
...
function le() {
  let var_core_value_sig880E = (0, o.useDependency)(e.ICommandService),
    var_core_value_sigC9ED = (0, o.useDependency)(k),
    var_core_value_sigB57B = (0, o.useObservable)(var_core_value_sigC9ED.options$, var_core_value_sigC9ED.options),
    var_core_value_sig780B = (0, o.useDependency)(e.IUniverInstanceService),
    var_core_value_sig7D1B = (0, o.useDependency)(e.LocaleService),
    var_core_value_sig7BE0 = (0, o.useDependency)(n.IPrintPreparationService),
    [var_core_value_sig7D40, var_core_value_sig6C7E] = (0, u.useState)(false),
    [var_core_value_sig68BE, var_core_value_sig04C6] = (0, u.useState)(),
    [var_core_value_sigCA05] = (0, u.useState)(() => {
      var var_core_value_sigE43E;
      return (var_core_value_sigE43E = var_core_value_sig780B.getCurrentUnitOfType(e.UniverInstanceType["UNIVER_SLIDE"])) == null ? undefined : var_core_value_sigE43E.getUnitId();
    }),
    var_core_value_sig2F2B = var_core_value_sigCA05 ? var_core_value_sig780B.getUnit(var_core_value_sigCA05, e.UniverInstanceType["UNIVER_SLIDE"]) : undefined,
    var_core_value_sig70AF = var_core_value_sig2F2B == null ? undefined : var_core_value_sig2F2B.getSnapshot(),
    var_core_value_sigD04E = (0, u.useMemo)(() => {
      if (!var_core_value_sig2F2B || !var_core_value_sig70AF || var_core_value_sig68BE !== var_core_value_sigCA05) return;
      let var_core_value_sigA937 = (0, r.resolveSlideLogicalPageSize)(var_core_value_sig70AF.defaultPageSize),
        var_core_value_sigCAD5 = _(H(var_core_value_sig70AF.slideOrder["length"], var_core_value_sigB57B.range).map(var_core_value_sig4CD2 => ({
      ...
      return var_core_value_sigE503 && (var_core_value_sigE503.font = "14px Arial, sans-serif"), g(var_core_value_sigCAD5, var_core_value_sigA937, var_core_value_sigB57B, var_core_value_sig50AF => (var_core_value_sigE503 == null ? undefined : var_core_value_sigE503.measureText(var_core_value_sig50AF).width) ?? var_core_value_sig50AF.length * 14 * 0.55);
  ...
  return (0, u.useEffect)(() => {
  ...
  }, [var_core_value_sig2F2B, var_core_value_sig7BE0, var_core_value_sigCA05]), !var_core_value_sig2F2B || !var_core_value_sig70AF ? null : (0, d.jsxs)("div", {
    ...
    children: [(0, d.jsxs)("div", {
      className: (0, l.clsx)("univer-flex univer-h-16 univer-items-center univer-justify-between univer-bg-gray-0 univer-px-4 dark:!univer-bg-gray-900", l.borderBottomClassName),
      children: [(0, d.jsx)("div", {
        className: "univer-ml-2\x20univer-text-base\x20univer-font-medium\x20univer-text-gray-900\x20dark:!univer-text-gray-0",
        ...
        children: [(0, d.jsx)(l.Button, {
          ...
          onClick: () => var_core_value_sig880E.executeCommand(M.id),
          ...
          onClick: async () => {
            ...
            try {
              (await var_core_value_sig880E.executeCommand(K.id, var_core_value_sigB57B)) && (await var_core_value_sig880E.executeCommand(M.id));
            } finally {
      ...
      children: [(0, d.jsx)("div", {
        className: (0, l.clsx)("univer-flex-1 univer-overflow-auto univer-p-7", l.scrollbarClassName),
        "aria-busy": !var_core_value_sigD04E,
        children: var_core_value_sigD04E ? var_core_value_sigD04E.pages["map"](var_core_value_sig5E6A => (0, d.jsx)(se, {
          model: var_core_value_sig2F2B,
          page: var_core_value_sig5E6A,
          plan: var_core_value_sigD04E
        }, var_core_value_sig5E6A.key)) : (0, d.jsx)("div", {
...
function ue() {
  let var_core_value_sigB99B = (0, o.useDependency)(k);
  return (0, o.useObservable)(var_core_value_sigB99B.visible$, var_core_value_sigB99B.visible) ? (0, d.jsx)(le, {}) : null;
}
let Q = class extends e.Disposable {
  ...
  _initCommands() {
    [K, j, M].forEach(var_core_value_sigA942 => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sigA942)));
  }
  _initUIParts() {
    this.disposeWithMe(this._uiPartsService["registerComponent"](o.BuiltInUIPart["GLOBAL"], () => (0, o.connectInjector)(ue, this._injector)));
  }
  _initMenus() {
    this._menuManagerService["mergeMenu"](J);
  }
};
Q = W([U(0, e.ICommandService), U(1, o.IMenuManagerService), U(2, o.IUIPartsService), U(3, (0, e.Inject)(e.Injector))], Q);
let $ = class extends e.Plugin {
  constructor(var_core_value_sig5F1A = Y, var_core_value_sigB455, var_core_value_sig5241) {
  ...
  onStarting() {
    this._injector["has"](n.IPrintPreparationService) || this._injector["add"]([n.IPrintPreparationService, {
      useClass: n.PrintPreparationService
    }]), this._injector["add"]([X]), this._injector["get"](X), this._injector["has"](N) || this._injector["add"]([N]), (0, e.registerDependencies)(this._injector, [[G], [k, {
      useClass: A
    }], [Q]]);
  }
  onReady() {
...
O($, "pluginName", "SLIDES_PRINT_PLUGIN"), O($, "packageName", re), O($, "version", ie), O($, "type", e.UniverInstanceType["UNIVER_SLIDE"]), $ = W([(0, e.DependentOn)(s.UniverLicensePlugin, a.UniverRenderEnginePlugin, i.UniverSlidesPlugin, r.UniverSlidesUIPlugin), U(1, (0, e.Inject)(e.Injector)), U(2, e.IConfigService)], $), exports.OpenSlidePrintDialogOperation = j, exports.SlidePrintDrawingTransformService = N, exports.SlidePrintHandoutOrder = p, exports.SlidePrintLayoutType = f, exports.SlidePrintOperation = K, exports.SlidesPrintMenuSchema = J, Object.defineProperty(exports, "UniverSlidesPrintPlugin", {
  enumerable: true,
  get: function () {
    return $;
  }
