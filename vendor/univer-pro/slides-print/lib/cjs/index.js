...
function g(
  ...
  let _0x10cf1b = v(_0x50637d, _0x17b039),
    _0x5e2d0f =
      _0x17b039.margin === n.PrintPaperMargin["Custom"]
  ...
  _mountSlides() {
    this._plan["slots"].forEach((_0x217171) => {
      ...
      if (
        ...
        (_0x49309a.container["style"].transformOrigin = "top left"),
  ...
  return (
    (0, u.useEffect)(() => {
      ...
      return (
        ...
        (_0x53b300.container["style"].transformOrigin = "top\x20left"),
    ...
    children: (0, d.jsxs)("div", {
      ...
      children: [
        ...
        (0, d.jsx)(l.FormLayout, {
          ...
          children: (0, d.jsx)(l.Select, {
            className: "univer-w-full",
            value: _0x4e76a7.margin ?? n.PrintPaperMargin["Normal"],
            options: [
              {
