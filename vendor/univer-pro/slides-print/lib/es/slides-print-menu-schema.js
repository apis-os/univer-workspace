...
function ut(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46491) {
  return {
    id: V.id,
    ...
    hidden$: getMenuHiddenObservable(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46491, UniverInstanceType.UNIVER_SLIDE)
  };
}
const dt = {
