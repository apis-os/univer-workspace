...
const Y = {
  ...
  handler: async (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46481, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46482) => {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46483 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46481.get(IUniverInstanceService),
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46484 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46481.get(J),
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46485 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46483.getCurrentUnitOfType(UniverInstanceType.UNIVER_SLIDE);
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46485 ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46484.print(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46485.getUnitId(), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46482) : false;
  }
};
