...
function Va(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463537) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463538 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463537.stops[0];
  return {
    type: SlideTableFillTypeEnum.Gradient,
    color: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463538 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463538.color) ?? "#FFFFFF",
    alpha: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463538 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463538.opacity) ?? 1,
    picture: undefined,
    gradient: {
      type: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463537.type,
      angle: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463537.angle,
      stops: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463537.stops["map"](var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46732 => ({
        color: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46732.color,
        offset: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46732.offset,
        opacity: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46732.opacity
      }))
    }
  };
}
export { Va as gradientValueToSlideTableFill };
