...
import { Ys, ts } from "./internal-core-endo.js";
function Ws(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464040, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464041) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042;
  let var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB83 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464041.replace(/\r\n/g, "\x0d").replace(/\n/g, "\x0d") + "\x0d\x0a",
    var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D185 = Math.max(0, var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB83.length - 2),
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464043 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464040.body) == null || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042.textRuns) == null || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042.find(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46979 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46979.ts)) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464042.ts;
  return qs({
    ...Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464040),
    body: {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464040.body,
      dataStream: var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB83,
      paragraphs: Ys(var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB83),
      textRuns: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464043 && var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D185 > 0 ? [{
        st: 0,
        ed: var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D185,
        ts: {
          ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464043
        }
      }] : []
    }
  }, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464040.id ?? "SLIDE_TABLE_CELL");
}
export { Ws as replaceSlideTableCellDocumentText };
