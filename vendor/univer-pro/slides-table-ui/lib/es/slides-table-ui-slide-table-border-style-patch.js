...
function Lr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463121, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463122, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463123) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463124 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463121.rows);
  return iterateSelectedSlideTableCells(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463124, normalizeSlideTableCellRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463122), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46616 => {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46617;
    let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB6 = ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46617 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46616.style) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46617.borders) ?? {},
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46618 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4679 => ({
        ...getDefaultSlideTableBorder(),
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4679,
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463123
      });
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46616.style = mergeSlideTableCellStyle(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46616.style, {
      borders: {
        top: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46618(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB6.top),
        right: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46618(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB6.right),
        bottom: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46618(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB6.bottom),
        left: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46618(var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB6.left)
      }
    });
  }), {
    rows: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463124
  };
}
export { Lr as buildSlideTableBorderStylePatch };
