...
function Er(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033) {
  let var_L0_core_endo_isFlag_pure_O1_zalloc_nothrow_sigD81A19 = !!J(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032);
  return [qr(q.InsertRowAbove, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.insertRows, var_L0_core_endo_isFlag_pure_O1_zalloc_nothrow_sigD81A19), qr(q.InsertRowBelow, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.insertRows, var_L0_core_endo_isFlag_pure_O1_zalloc_nothrow_sigD81A19), qr(q.InsertColumnLeft, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.insertColumns, var_L0_core_endo_isFlag_pure_O1_zalloc_nothrow_sigD81A19), qr(q.InsertColumnRight, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.insertColumns, var_L0_core_endo_isFlag_pure_O1_zalloc_nothrow_sigD81A19), qr(q.DeleteRows, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.deleteRows, Ur(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032)), qr(q.DeleteColumns, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.deleteColumns, Wr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032)), qr(q.MergeCells, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.mergeCells, Vr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031)), qr(q.UnmergeCells, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.unmergeCells, Hr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032)), qr(q.DistributeRows, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.updateTable, Gr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032)), qr(q.DistributeColumns, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463033.updateTable, Kr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463031, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463032))];
}
function qr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463187, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463188, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463189) {
  return {
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463187,
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463188,
    enabled: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463189
  };
}
export { q as SLIDE_TABLE_CONTEXT_MENU_ACTIONS, Er as resolveSlideTableContextMenuActions };
