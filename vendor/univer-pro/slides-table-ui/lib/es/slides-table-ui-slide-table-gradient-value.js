...
function Ba(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463528) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463529, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463530, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463531;
  return {
    type: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527 == null || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463529 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.gradient) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463529.type) ?? "linear",
    angle: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527 == null || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463530 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.gradient) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463530.angle) ?? 0,
    stops: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527 != null && (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463531 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.gradient) != null && (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463531 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463531.stops) != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463531.length ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.gradient["stops"].map(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46731 => ({
      color: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46731.color,
      offset: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46731.offset,
      opacity: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46731.opacity
    })) : [{
      color: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.color) ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463528,
      offset: 0,
      opacity: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463527.alpha) ?? 1
    }, {
      color: "#000000",
      offset: 100,
      opacity: 1
...
export { Ba as getSlideTableGradientValue };
