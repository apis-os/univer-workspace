...
function wc(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256) {
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256.kind === "row-insert-dot" ? {
    visible: true,
    hoveredTrigger: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256,
    insertGuide: {
      kind: "row",
      index: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256.row + 1
    }
  } : {
    visible: true,
    hoveredTrigger: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256,
    insertGuide: {
      kind: "column",
      index: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464256.column + 1
    }
  };
}
export { wc as buildSlideTableInsertDotControlState };
