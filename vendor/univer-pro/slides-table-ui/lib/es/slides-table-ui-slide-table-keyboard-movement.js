...
function ua(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463399) {
  switch (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463399) {
    case "move-left":
      return {
        rowDelta: 0,
        columnDelta: -1,
...
export { ua as resolveSlideTableKeyboardMovement };
