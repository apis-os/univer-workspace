...
import { io } from "./internal-core-endo.js";
function eo(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463605, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463606) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463607 = io(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463606);
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463607) return null;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463608 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463605 ? to(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463605, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463607) : null;
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463608 ? {
    action: "unmerge",
    range: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463608
  } : isSlideTableMultiCellRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463607) ? {
    action: "merge",
    range: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463607
  } : null;
}
function to(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463613, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463614) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463615 = normalizeSlideTableCellRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463614);
  for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463615.startRow; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736 <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463615.endRow; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736 += 1) for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4692 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463615.startColumn; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4692 <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463615.endColumn; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4692 += 1) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4621 = findSlideTableMergeRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463613, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46736, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4692);
    if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4621 && isSlideTableMultiCellRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4621)) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4621;
  }
  return null;
}
export { eo as resolveSlideTableMergeToolbarAction };
