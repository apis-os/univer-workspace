...
import { Ya } from "./slides-table-ui-slide-table-unmerge-cells-command-params.js";
import { Ja } from "./slides-table-ui-slide-table-merge-cells-command-params.js";
function Xa(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463575, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463577) {
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463575 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576) return null;
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.action === "unmerge") {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46735 = Ya({
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463575,
      ranges: [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range],
      anchor: {
        row: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range["startRow"],
        column: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range["startColumn"]
      },
      focus: {
        row: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range["startRow"],
        column: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range["startColumn"]
    ...
    return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46735 ? {
      commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463577.unmergeCells,
      params: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46735
    } : null;
  }
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463578 = Ja({
    ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463575,
    ranges: [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463576.range]
  });
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463578 ? {
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463577.mergeCells,
    params: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463578
  } : null;
}
export { Xa as buildSlideTableMergeToolbarCommand };
