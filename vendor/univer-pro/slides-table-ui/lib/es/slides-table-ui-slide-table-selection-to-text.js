...
import { fc } from "./internal-core-endo.js";
function ac(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464146, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464147) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148 = fc(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464146, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464147);
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464146 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148) return "";
  let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A51 = [];
  for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46989 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148.startRow; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46989 <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148.endRow; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46989 += 1) {
    let var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A1 = [];
    for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4628 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148.startColumn; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4628 <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464148.endColumn; var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4628 += 1) {
      var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464149;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464149 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464146.rows[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46989]) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464149.cells[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4628];
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614 != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614.hMerge || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614 != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614.vMerge) {
        var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A1.push("");
        continue;
      }
      var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A1.push(gc(dc(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4614.textData)));
    }
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A51.push(var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A1.join("\x09"));
  }
  return var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A51.join("\x0a");
}
function dc(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464200) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464201;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464200 == null || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464201 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464200.body) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464201.dataStream;
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202 ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202.replace(/\r\n/g, "\x0a").replace(/\r/g, "\x0a").replace(/[\u0000-\u0008\u000B\u000C\u000E-\u001F]/g, "").replace(/\n+$/g, "") : "";
}
function gc(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464224) {
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464224.replace(/\t/g, "\x20").replace(/\n/g, "\x20");
}
export { ac as serializeSlideTableSelectionToText };
