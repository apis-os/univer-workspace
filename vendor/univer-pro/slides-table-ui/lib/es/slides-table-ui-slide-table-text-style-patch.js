...
import { ii, ri, ts } from "./internal-core-endo.js";
function ti(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463247, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463248, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463249) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463250 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463247.rows);
  return iterateSelectedSlideTableCells(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463250, normalizeSlideTableCellRange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463248), (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46628, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46629, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46630) => {
    let var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB41 = "SLIDE_TABLE_CELL_" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463247.id + "_" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46629 + "_" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46630;
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46628.textData = ni(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46628.textData, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463249, var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB41);
  }), {
    rows: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463250
  };
}
function ni(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463255, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463256, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463257) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463258, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463259;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463255 ?? ri(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463257)),
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260.body ?? {
      dataStream: "\x0d\x0a",
      paragraphs: [ii()],
      textRuns: []
    },
    var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB75 = var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50.dataStream ?? "\x0d\x0a",
    var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D155 = Math.max(0, var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB75.length - 2),
    var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A41 = (var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50.textRuns ?? []).map(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46634 => ({
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46634,
      ts: {
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46634.ts,
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463256
      }
    }));
  return var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D155 > 0 && var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A41.length === 0 && var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A41.push({
    st: 0,
    ed: var_L0_core_endo_countVal_pure_O1_zalloc_nothrow_sig108D155,
    ts: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463256
  }), {
    ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260,
    id: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260.id ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463257,
    body: {
      ...var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50,
      dataStream: var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB75,
      paragraphs: (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463258 = var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50.paragraphs) != null && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463258.length ? var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB50.paragraphs : [ii()],
      textRuns: var_L0_core_endo_itemsList_pure_O1_zalloc_nothrow_sigE78A41
    },
    documentStyle: {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260.documentStyle,
      textStyle: {
        ...((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463259 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463260.documentStyle) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463259.textStyle),
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463256
      }
    }
  };
}
export { ti as buildSlideTableTextStylePatch };
