...
function qa(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463563, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463564) {
  return [{
    id: Ka.MergeCells,
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463564.mergeCells,
    enabled: ro(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463563)
  }, {
    id: Ka.UnmergeCells,
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463564.unmergeCells,
    enabled: no(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463563)
  }, {
    id: Ka.SetCellStyle,
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463564.setCellStyle,
    enabled: no(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463563)
  }, {
    id: Ka.SetBorderPreset,
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463564.setBorderPreset,
    enabled: no(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463563)
  }];
}
function no(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463619) {
  return !!io(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463619);
}
function ro(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463621) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622 = io(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463621);
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622 ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622.startRow !== var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622.endRow || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622.startColumn !== var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463622.endColumn : false;
}
export { Ka as SLIDE_TABLE_TOOLBAR_ACTIONS, qa as resolveSlideTableToolbarActions };
