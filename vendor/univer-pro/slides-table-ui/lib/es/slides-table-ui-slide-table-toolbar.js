...
function Za(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463583, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463585) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586 = io(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584);
  return !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586 || !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463583 ? null : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.kind === "row" ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463583.rows["length"] <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.endRow - var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.startRow + 1 ? null : {
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463585.deleteRows,
    params: {
      unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.unitId,
      tableId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.tableId,
      startRow: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.startRow,
      endRow: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.endRow
    },
    kind: "row"
  } : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.kind === "column" ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463583.columns["length"] <= var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.endColumn - var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.startColumn + 1 ? null : {
    commandId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463585.deleteColumns,
    params: {
      unitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.unitId,
      tableId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463584.tableId,
      startColumn: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.startColumn,
      endColumn: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463586.endColumn
    },
    kind: "column"
  } : null;
}
export { Za as buildSlideTableDeleteToolbarCommand };
