...
function lo(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463643) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463644 = useRef(false),
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645 = useRef(null),
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463646 = useDependency(G);
  return useEffect(() => () => {
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current && clearTimeout(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current);
  }, []), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463643.children({
    handleOpenChange: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46737 => {
      !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46737 && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463644.current || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463643.onOpenChange(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46737);
    },
    markInternalInteraction: () => {
      var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463646.markTableInternalInteraction(), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463644.current = true, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current && clearTimeout(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current = setTimeout(() => {
        var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463644.current = false, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463645.current = null;
      }, 500);
    }
  });
}
export { lo as TableToolbarDropdownInteractionGuard };
