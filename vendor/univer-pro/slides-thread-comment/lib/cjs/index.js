...
function l(var_core_value_sig1BBD, var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sig0D69) {
  var var_core_value_sig480E = ox39a0f3,
    var_core_value_sig26DB = arguments[var_core_value_sig480E(314)],
    var_core_value_sigF0F9 = var_core_value_sig26DB < 3 ? var_core_value_sigF704 : var_core_value_sig0D69 === null ? var_core_value_sig0D69 = Object.getOwnPropertyDescriptor(var_core_value_sigF704, var_core_value_sig2BCF) : var_core_value_sig0D69,
    var_core_value_sig1A0F;
  if (typeof Reflect == var_core_value_sig480E(313) && typeof Reflect[var_core_value_sig480E(295)] == var_core_value_sig480E(283)) var_core_value_sigF0F9 = Reflect[var_core_value_sig480E(295)](var_core_value_sig1BBD, var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sig0D69);else {
    for (var var_core_value_sigFBA4 = var_core_value_sig1BBD[var_core_value_sig480E(314)] - 1; var_core_value_sigFBA4 >= 0; var_core_value_sigFBA4--) (var_core_value_sig1A0F = var_core_value_sig1BBD[var_core_value_sigFBA4]) && (var_core_value_sigF0F9 = (var_core_value_sig26DB < 3 ? var_core_value_sig1A0F(var_core_value_sigF0F9) : var_core_value_sig26DB > 3 ? var_core_value_sig1A0F(var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sigF0F9) : var_core_value_sig1A0F(var_core_value_sigF704, var_core_value_sig2BCF)) || var_core_value_sigF0F9);
  }
  return var_core_value_sig26DB > 3 && var_core_value_sigF0F9 && Object[var_core_value_sig480E(306)](var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sigF0F9), var_core_value_sigF0F9;
}
...
function m(var_core_value_sigF62A) {
  var var_core_value_sig8178 = ox39a0f3,
    var_core_value_sigE9ED = p(var_core_value_sigF62A, var_core_value_sig8178(263));
  return f(var_core_value_sigE9ED) == "symbol" ? var_core_value_sigE9ED : var_core_value_sigE9ED + "";
}
...
h(g, "pluginName", "UNIVER_SLIDES_THREAD_COMMENT_PLUGIN"), h(g, "packageName", o), h(g, "version", s), h(g, "type", n.UniverInstanceType["UNIVER_SLIDE"]), g = l([(0, n.DependentOn)(e.UniverLicensePlugin, r.UniverThreadCommentPlugin, t.UniverSlidesPlugin), c(1, (0, n.Inject)(n.Injector)), c(2, n.IConfigService)], g), exports.SLIDES_THREAD_COMMENT_PLUGIN_CONFIG_KEY = i, Object.defineProperty(exports, "UniverSlidesThreadCommentPlugin", {
  enumerable: true,
  get: function () {
    return g;
  }
