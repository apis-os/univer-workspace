import { UniverLicensePlugin as var_core_value_sigA12B } from "@univerjs-pro/license";
import { UniverSlidesPlugin as var_core_value_sigF230 } from "@univerjs-pro/slides";
...
function x(var_core_value_sig1BBD, var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sig0D69) {
  var var_core_value_sig480E = ox3561d6,
    var_core_value_sig26DB = arguments[var_core_value_sig480E(502)],
    var_core_value_sigF0F9 = var_core_value_sig26DB < 3 ? var_core_value_sigF704 : var_core_value_sig0D69 === null ? var_core_value_sig0D69 = Object[var_core_value_sig480E(491)](var_core_value_sigF704, var_core_value_sig2BCF) : var_core_value_sig0D69,
    var_core_value_sig1A0F;
  if (typeof Reflect == var_core_value_sig480E(532) && typeof Reflect[var_core_value_sig480E(512)] == "function") var_core_value_sigF0F9 = Reflect[var_core_value_sig480E(512)](var_core_value_sig1BBD, var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sig0D69);else {
    for (var var_core_value_sigFBA4 = var_core_value_sig1BBD.length - 1; var_core_value_sigFBA4 >= 0; var_core_value_sigFBA4--) (var_core_value_sig1A0F = var_core_value_sig1BBD[var_core_value_sigFBA4]) && (var_core_value_sigF0F9 = (var_core_value_sig26DB < 3 ? var_core_value_sig1A0F(var_core_value_sigF0F9) : var_core_value_sig26DB > 3 ? var_core_value_sig1A0F(var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sigF0F9) : var_core_value_sig1A0F(var_core_value_sigF704, var_core_value_sig2BCF)) || var_core_value_sigF0F9);
  }
  return var_core_value_sig26DB > 3 && var_core_value_sigF0F9 && Object[var_core_value_sig480E(510)](var_core_value_sigF704, var_core_value_sig2BCF, var_core_value_sigF0F9), var_core_value_sigF0F9;
}
const S = "SLIDE_" + var_core_value_sig9E2F;
...
function E(var_core_value_sigF62A) {
  var var_core_value_sig8178 = ox3561d6,
    var_core_value_sigE9ED = T(var_core_value_sigF62A, var_core_value_sig8178(529));
  return w(var_core_value_sigE9ED) == var_core_value_sig8178(504) ? var_core_value_sigE9ED : var_core_value_sigE9ED + "";
}
...
D(O, "pluginName", "UNIVER_SLIDES_THREAD_COMMENT_PLUGIN"), D(O, "packageName", v), D(O, "version", y), D(O, "type", var_core_value_sig4632.UNIVER_SLIDE), O = x([var_core_value_sig09B8(var_core_value_sigA12B, var_core_value_sigDBB7, var_core_value_sigF230), b(1, var_core_value_sigC80B(var_core_value_sig284F)), b(2, var_core_value_sigF9C7)], O);
export { g as SLIDES_THREAD_COMMENT_PLUGIN_CONFIG_KEY, O as UniverSlidesThreadCommentPlugin };
