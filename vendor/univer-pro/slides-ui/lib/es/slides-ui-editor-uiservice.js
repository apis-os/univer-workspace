...
var Hh = class extends Disposable {
  constructor(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464193) {
    super(...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464193), X(this, "_session$", new BehaviorSubject(null)), X(this, "session$", this._session$["asObservable"]()), X(this, "_sessionId", 0);
  }
  open(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464195) {
    let var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB78 = {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464195,
      editorUnitId: Wh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464195.editorId),
      sessionId: ++this._sessionId,
      documentData: Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464195.documentData),
      measurement: Gh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464195.layout),
      visible: true
    };
    return this._session$["next"](var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB78), {
      dispose: () => {
        this._session$["getValue"]() === var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB78 && this.close();
      }
    };
  }
  update(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198 = this._session$["getValue"]();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198 && this._session$["next"]({
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198,
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197,
      editorUnitId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.editorId ? Wh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.editorId) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198.editorUnitId,
      documentData: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.documentData ? Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.documentData) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198.documentData,
      layout: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.layout ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198.layout,
      measurement: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.layout ? Gh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464197.layout) : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198.measurement,
      sessionId: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464198.sessionId,
      visible: true
    });
  }
  setDocumentData(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464201) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202 = this._session$["getValue"]();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202 && this._session$["next"]({
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464202,
      documentData: Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464201)
    });
  }
  setLayoutMeasurement(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464205) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464206 = this._session$["getValue"]();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464206 && this._session$["next"]({
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464206,
      measurement: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464205
    });
  }
  complete(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464209, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464210, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464211) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464212;
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213 = this._session$["getValue"]();
    if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464211 !== undefined && var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.sessionId !== var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464211) return;
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464214 = Tools.deepClone(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464209 ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.documentData);
    (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464212 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.onComplete) == null || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464212.call(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464214, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.context, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464210 ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.measurement), this.close(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464213.sessionId);
  }
  cancel(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464221) {
    var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464222;
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223 = this._session$["getValue"]();
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223 && (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464221 === undefined || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223.sessionId === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464221) && ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464222 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223.onCancel) == null || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464222.call(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223.context), this.close(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464223.sessionId));
  }
  close(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464227) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464228 = this._session$["getValue"]();
    (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464227 === undefined || (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464228 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464228.sessionId) === var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D464227) && this._session$["next"](null);
  }
  getSession() {
...
function Wh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611001) {
  return isInternalEditorID(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611001) ? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611001 : createInternalEditorID("EDITOR_UI_" + var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611001);
}
function Gh(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611003) {
  return {
    width: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611003.rect["width"],
    minHeight: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611003.rect["height"],
    actualHeight: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611003.rect["height"],
    contentHeight: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4611003.rect["height"],
    marginTop: 0
  };
}
export { Hh as EditorUIService };
