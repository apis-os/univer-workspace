...
const Mp = ["groupFill", "pptxGroupFill", "shapeFill", "fill", "grpFill"],
  ...
  Pp = ["grpFill", "useGroupFill", "inheritGroupFill", "useGrpFill", "pptxGrpFill"];
function Fp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610195) {
  return !!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610195 && typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610195 == "object" && !Array.isArray(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610195);
}
function Ip(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610197) {
  let var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB234 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610197.trim();
  return /^[0-9a-f]{6}$/i.test(var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB234) ? "#" + var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB234 : var_L0_core_endo_strVal_pure_O1_zalloc_nothrow_sig12FB234;
}
function Lp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199) {
  return "fillType" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "color" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "opacity" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "gradientStops" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "fillImageSource" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "imageFillMode" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199 || "pattern" in var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610199;
}
function Rp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610201) {
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610201 && JSON.parse(JSON.stringify(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610201));
}
function zp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610204 = new Set()) {
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203) {
    if (typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203 == "string") return {
      fillType: ShapeFillEnum.SolidFill,
      color: Ip(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203)
    };
    if (!(!Fp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203) || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610204.has(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203))) {
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610204.add(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203), Lp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203)) return Rp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203);
      for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46144 of Np) {
        let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4627 = zp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610203[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46144], var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610204);
        if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4627) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4627;
      }
    }
  }
}
function Bp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610207, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610208) {
  if (!(!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610207 || !Fp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610207))) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610207[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610208];
}
function Vp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610211) {
  var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610212;
  for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463732 of Mp) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46619 = zp(Bp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610211.custom, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463732));
    if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46619) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46619;
  }
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610213 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610211;
  return zp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610213.fill) ?? zp((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610212 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610213.shapeData) == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610212.fill);
}
function Hp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610217) {
  if (!(!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610217 || !Fp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610217))) for (let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463733 of Pp) {
    let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46620 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610217[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463733];
    if (typeof var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46620 == "boolean") return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46620;
  }
}
function Up(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219) {
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219 || !Fp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219)) return false;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610220 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219.fillType ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219.type ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610219.kind;
  return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610220 === "grpFill" || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610220 === "groupFill";
}
function Wp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610223) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610224 = Hp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610223.custom);
  if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610224 !== undefined) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610224;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610225 = Object.getOwnPropertyDescriptor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610223.shapeData, "fill");
  if ((var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610225 == null ? undefined : var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610225.enumerable) === false) return true;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610226 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610223.shapeData["fill"];
  return !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610226 || Up(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610226);
}
function Gp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610231, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610232, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610233) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610234 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610231[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610232];
  if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610234 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610234.element["type"] !== PageElementTypeEnum.Shape) return var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610231;
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610235 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610234.element,
    var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB226 = {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610235,
      shapeData: {
        ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610235.shapeData,
        fill: Rp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610233)
      }
    };
  return {
    ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610231,
    [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610232]: {
      ...var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610234,
      element: var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB226
    }
  };
}
function Kp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610241) {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610242 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610241,
    var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610243 = (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463734, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463735, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463736) => {
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463736.has(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463734)) return;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463737 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610242[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463734];
      if (!var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463737) return;
      let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463737.element;
      if (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738.type === PageElementTypeEnum.Group) {
        var var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463739;
        let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46621 = Vp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738) ?? var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463735,
          var_L0_core_endo_itemsSet_pure_O1_zalloc_nothrow_sig9299 = new Set(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463736);
        var_L0_core_endo_itemsSet_pure_O1_zalloc_nothrow_sig9299.add(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463734), (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463739 = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738.children) == null || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463739.forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46145 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610243(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46145, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D46621, var_L0_core_endo_itemsSet_pure_O1_zalloc_nothrow_sig9299));
        return;
      }
      !var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463735 || var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738.type !== PageElementTypeEnum.Shape || Wp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463738) && (var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610242 = Gp(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610242, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463734, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463735));
    };
  return Object.values(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610241).filter(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463746 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463746.element["type"] === PageElementTypeEnum.Group).forEach(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463747 => var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610243(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D463747.drawingId, undefined, new Set())), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D4610242;
}
export { Kp as resolveGroupFillInheritance };
