...
var tD = class e extends Shape {
  constructor(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468603, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468604) {
    super(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468603, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468604), X(this, "elementId", undefined), X(this, "pageId", undefined), this.elementId = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468604.elementId, this.pageId = var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468604.pageId;
  }
  getRotateHandlePosition() {
    return {
      x: this.width / 2,
      y: -e.ROTATE_HANDLE_OFFSET_PX
    };
  }
  getConnectionSites() {
    return [{
  ...
  connectionSiteToLocalPixel(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468607) {
    return {
      x: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468607.x * this.width,
      y: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D468607.y * this.height
    };
  }
  getAdjustHandles() {
    return [];
