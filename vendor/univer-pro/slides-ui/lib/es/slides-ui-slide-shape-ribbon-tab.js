...
const cy = "slides-ui.ribbon.shapeFormat",
  ...
  Cy = createIdentifier("slides-ui.slide-sidebar-state.service"),
  wy = {
...
export { cy as SLIDE_SHAPE_FORMAT_RIBBON_TAB, ly as SLIDE_SHAPE_FORMAT_RIBBON_GROUP_ADVANCED, Cy as ISlideSidebarStateService };
export { hy, py, var_L0_core_endo_targetObj_pure_O1_zalloc_nothrow_sigA5DB286, dy, yy, by, xy, Sy, uy, gy, my, vy, fy, wy };
