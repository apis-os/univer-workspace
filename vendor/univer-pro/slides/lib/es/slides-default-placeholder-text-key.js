...
const Jr={'title':"slides.slide.placeholder.text.title",'centerTitle':"slides.slide.placeholder.text.title",'subtitle':"slides.slide.placeholder.text.subtitle",'body':'slides.slide.placeholder.text.body','text':"slides.slide.placeholder.text.text",'header':"slides.slide.placeholder.text.header",'footer':'slides.slide.placeholder.text.footer','date':"slides.slide.placeholder.text.date",'slideNumber':"slides.slide.placeholder.text.slideNumber"};function Yr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462316){return Jr[var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462316];}
