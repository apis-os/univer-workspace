...
function ei(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322) {
  return {
    'id': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.hostAnchorId,
    'type': 'text',
    'name': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.embedId,
    'text': '',
    'transform': {
      'left': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.left ?? 96,
      'top': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.top ?? 72,
      'width': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.width ?? 560,
      'height': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322.height ?? 315
    },
    'custom': {
      [Xr]: Qr(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462322)
    }
  };
}
