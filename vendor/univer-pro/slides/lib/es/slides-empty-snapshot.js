...
function oi(var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462340 = generateRandomId(6), var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462341 = LocaleType.EN_US, var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462342 = "Untitled Presentation") {
  let var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462343 = Xe({
    'layoutType': 'titleAndBody',
    'name': "Slide 1"
  });
  return {
    'id': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462340,
    'name': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462342,
    'appVersion': ai,
    'locale': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462341,
    'defaultPageSize': {
      'width': 960,
      'height': 540
    },
    'slideOrder': [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462343.id],
    'slides': {
      [var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462343.id]: var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462343
    },
    'activeSlideId': var_L0_core_endo_value_pure_O1_zalloc_nothrow_sig0D462343.id,
    ...Ze()
  };
}
