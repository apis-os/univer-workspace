...
const Hr={'isTextBox':true,'fill':{'fillType':ShapeFillEnum.SolidFill,'color':"#FFFFFF"},'stroke':{'lineStrokeType':ShapeLineTypeEnum.SolidLine,'width':1,'color':'#bcbcbc'},'shapeText':{'isHorizontal':true,'text':'','autoFitType':ShapeTextAutoFitType.SpAutoFit,'textWrap':ShapeTextWrapType.None,'dataModel':{'doc':{'id':"slide-text-box-default-document",'body':{'dataStream':'\x0d\x0a','textRuns':[{'st':0,'ed':1,'ts':{'fs':16,'cl':{'rgb':"#111827"}}}],'paragraphs':[{'startIndex':0,'paragraphStyle':{'horizontalAlign':HorizontalAlign.LEFT}}]},'documentStyle':{'marginBottom':0,'marginLeft':0,'marginRight':0,'marginTop':0,'textStyle':{'fs':16,'cl':{'rgb':"#111827"}},'renderConfig':{'horizontalAlign':HorizontalAlign.LEFT,'verticalAlign':VerticalAlign.TOP}}},'ha':HorizontalAlign.LEFT,'va':VerticalAlign.TOP}}},Ur={'picture':["image"],'chart':["chart"]},Wr={'picture':"image",'chart':"chart"},Gr={'image':'AddImageIcon','chart':"ChartIcon",'table':"TableIcon",'diagram':'RelationshipIcon','media':'RecordIcon'};
