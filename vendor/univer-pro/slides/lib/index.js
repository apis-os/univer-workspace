import { ArrangeTypeEnum as var_core_value_sig5EBB, BooleanNumber as var_core_value_sig5E99, CommandType as var_core_value_sig3FB3, CustomCommandExecutionError as var_core_value_sig0214, DependentOn as var_core_value_sig5153, Disposable as var_core_value_sigF323, DrawingTypeEnum as var_core_value_sig0C32, HorizontalAlign as var_core_value_sig1D89, ICommandService as var_core_value_sig2616, IConfigService as var_core_value_sig97EF, IPermissionService as var_core_value_sigA0C0, IResourceManagerService as var_core_value_sigAD4B, IUndoRedoService as var_core_value_sig06EA, IUniverInstanceService as var_core_value_sigF3C7, Inject as var_core_value_sig5633, Injector as var_core_value_sig2492, LocaleType as var_core_value_sig39F2, PermissionStatus as var_core_value_sigAD47, Plugin as var_core_value_sig1722, Tools as var_core_value_sig7F86, UnitModel as var_core_value_sigF69D, UniverInstanceType as var_core_value_sig7CB9, VerticalAlign as var_core_value_sigC1D8, createIdentifier as var_core_value_sigCF8B, createParagraphId as var_core_value_sigCD15, generateRandomId as var_core_value_sig524D, getDrawingOrderIndex as var_core_value_sigD7F4, merge as var_core_value_sig7B87, normalizeDrawingOrderIndex as var_core_value_sig933D, sequenceExecute as var_core_value_sig6ACE, shallowEqual as var_core_value_sig7675 } from '@univerjs/core';
import { UnitDrawingService as var_core_value_sig21B8 } from '@univerjs/drawing';
import { IShapeHostAdapterRegistry as var_core_value_sigD545, ShapeFillEnum as var_core_value_sig91C9, ShapeLineTypeEnum as var_core_value_sig64BA, ShapeModel as var_core_value_sig3FD5, ShapeTextAutoFitType as var_core_value_sig1008, ShapeTextWrapType as var_core_value_sigB9F4, ShapeTypeEnum as var_core_value_sig2D23, UniverShapePlugin as var_core_value_sigF2E0, applyDocumentToShapeText as var_core_value_sig9214, applySmartArtOperation as var_core_value_sigC8B1, canApplyShapeFormulaLastValue as var_core_value_sig35E2, convertSmartArtToShapes as var_core_value_sig9B13, createDefaultInsertedShapeData as var_core_value_sig60E6, createUniqueShapeName as var_core_value_sig1F6E, isConnectorShape as var_core_value_sig7A6B, isSmartArtShapeData as var_core_value_sig20F6, normalizeShapeTextData as var_core_value_sigAEE0 } from '@univerjs-pro/engine-shape';
import { transformObjectOutOfGroup as var_core_value_sig72B6 } from '@univerjs/engine-render';
import { UnitAction as var_core_value_sig43E8, UnitObject as var_core_value_sigB1FB } from '@univerjs/protocol';
import { BehaviorSubject as var_core_value_sig6876, Subject as var_core_value_sig55FB, map as var_core_value_sig2870, merge as var_core_value_sigC865, mergeMap as var_core_value_sig6788 } from 'rxjs';
import { UniverLicensePlugin as var_core_value_sig7B1F } from '@univerjs-pro/license';
let je = function (var_core_value_sigF455) {
  ...
  Me = function (var_core_value_sig6E78) {
  ...
  Ne = function (var_core_value_sigB3EE) {
  ...
  Pe = function (var_core_value_sigC50A) {
  ...
  Fe = function (var_core_value_sig11D0) {
  ...
  Ie = function (var_core_value_sigB8ED) {
  ...
  Le = function (var_core_value_sig8EAE) {
  ...
  Re = function (var_core_value_sig1CDD) {
  ...
  ze = function (var_core_value_sig0DB1) {
  ...
  Be = function (var_core_value_sig68A2) {
...
function D(var_core_value_sigCC17, var_core_value_sig32AE, var_core_value_sigC753, var_core_value_sigFFD1 = {}) {
  ...
  return {
    ...
    'fmtScheme': {
      'name': var_core_value_sig32AE,
      'fillStyleLst': [{
        'fillType': var_core_value_sig91C9.SolidFill,
        ...
        'fillType': var_core_value_sig91C9.GradientFill,
        'gradientAngle': 90,
        'gradientStops': [{
          'position': 0,
      ...
      'lnStyleLst': [{
        'lineStrokeType': var_core_value_sig64BA.SolidLine,
...
function He(var_core_value_sig0455) {
  return Ve.find(var_core_value_sig0B45 => var_core_value_sig0B45.id === var_core_value_sig0455);
}
const Ue = 960,
  We = 540,
  Ge = Ve[0].colorScheme,
...
function A(var_core_value_sig737C, var_core_value_sig5AF5, var_core_value_sig9DE4, var_core_value_sig77FA) {
  return {
...
function Xe(var_core_value_sigA4A7 = {}) {
  let {
      layoutType: var_core_value_sig90F5 = "titleAndBody",
      id: var_core_value_sigD2BA = var_core_value_sig524D(6),
      name: var_core_value_sigA4DF,
      masterPageId: var_core_value_sigCD3A = k,
      layoutPageId: var_core_value_sigCC9D
    } = var_core_value_sigA4A7,
    var_core_value_sig519D = var_core_value_sigCC9D ?? j[var_core_value_sig90F5],
    var_core_value_sigC7E7 = Je[var_core_value_sig90F5];
  return {
...
function Ze() {
  return {
    ...
    'layoutPageOrder': Ye.map(var_core_value_sig36F8 => j[var_core_value_sig36F8]),
    'layoutPages': Object.fromEntries(Ye.map(var_core_value_sig03E1 => [j[var_core_value_sig03E1], Je[var_core_value_sig03E1]]))
  };
}
;
function Qe(var_core_value_sig6E1C) {
...
;
function $e(var_core_value_sigFABC, var_core_value_sig413D, var_core_value_sig5BCE) {
...
;
function et(var_core_value_sig8EF0) {
  return {
    ...O,
...
;
function tt(var_core_value_sig78AC, var_core_value_sig4CEF) {
...
;
function nt(var_core_value_sig2CC7) {
  ...
  return {
    ...
    'fontSize': 18,
    'color': tt(var_core_value_sig2CC7, "lt1")
  };
}
;
function rt(var_core_value_sigC39E, var_core_value_sig16C7) {
  let var_core_value_sig7481 = et(var_core_value_sig16C7),
    var_core_value_sig08A3 = {
      ...var_core_value_sigC39E.shapeData
    };
  if (!var_core_value_sig08A3.fill) {
    var var_core_value_sig77D8;
    $e(var_core_value_sig08A3, 'fill', Qe(((var_core_value_sig77D8 = var_core_value_sig7481.fmtScheme) == null ? undefined : var_core_value_sig77D8.fillStyleLst[1]) ?? {
      'fillType': var_core_value_sig91C9.SolidFill,
      'color': tt(var_core_value_sig7481, "acc1")
    }));
  }
  if (!var_core_value_sig08A3.stroke) {
    var var_core_value_sig78A3;
    $e(var_core_value_sig08A3, "stroke", Qe(((var_core_value_sig78A3 = var_core_value_sig7481.fmtScheme) == null ? undefined : var_core_value_sig78A3.lnStyleLst[1]) ?? {
      'lineStrokeType': var_core_value_sig64BA.SolidLine,
      'color': tt(var_core_value_sig7481, "acc1"),
      'width': 1.5
    }));
  ...
  if (var_core_value_sig08A3.shapeText && 'isRichText' in var_core_value_sig08A3.shapeText && var_core_value_sig08A3.shapeText["isRichText"] === false) {
    let var_core_value_sigBB57 = nt(var_core_value_sig7481),
      var_core_value_sig7C4A = {
        ...var_core_value_sig08A3.shapeText
      };
    Object.keys(var_core_value_sigBB57).forEach(var_core_value_sigD955 => {
      var_core_value_sig7C4A[var_core_value_sigD955] === undefined && $e(var_core_value_sig7C4A, var_core_value_sigD955, var_core_value_sigBB57[var_core_value_sigD955]);
...
;
function it(var_core_value_sig649B) {
  return nt(et(var_core_value_sig649B));
}
;
function M(var_core_value_sig6256) {
  return (var_core_value_sig6256 == null ? undefined : var_core_value_sig6256.element["type"]) === "group";
}
;
function at(var_core_value_sigE7A6, var_core_value_sigB505) {
...
;
function ot(var_core_value_sig0567, var_core_value_sigA7F3, var_core_value_sigEACD) {
  ...
  return M(var_core_value_sig102B) && (var_core_value_sig102B.element["children"] ?? []).forEach(var_core_value_sigFA38), at(var_core_value_sig0567, var_core_value_sigEACD).forEach(var_core_value_sig826B => {
...
;
function st(var_core_value_sigA7DB, var_core_value_sig5EEE, var_core_value_sig65B4) {
  let var_core_value_sigF98E = [],
    var_core_value_sigA470 = new Set(),
    var_core_value_sig19A1 = var_core_value_sigCF89 => {
      ot(var_core_value_sigA7DB, var_core_value_sigCF89, var_core_value_sig65B4).forEach(var_core_value_sig48BD => {
        var_core_value_sigA470.has(var_core_value_sig48BD) || (var_core_value_sigA470.add(var_core_value_sig48BD), var_core_value_sigF98E.push(var_core_value_sig48BD), M(var_core_value_sigA7DB[var_core_value_sig48BD]) && var_core_value_sig19A1(var_core_value_sig48BD));
      });
    };
  return var_core_value_sig19A1(var_core_value_sig5EEE), var_core_value_sigF98E;
}
;
function ct(var_core_value_sig81F7, var_core_value_sigBE51, var_core_value_sigAAD1) {
  ...
  var_core_value_sigAAD1.forEach(var_core_value_sig00CB => {
    ...
    var_core_value_sig77EE && (var_core_value_sigBC1A.add(var_core_value_sig00CB), M(var_core_value_sig77EE) && st(var_core_value_sig81F7, var_core_value_sig00CB, var_core_value_sigBE51).forEach(var_core_value_sig429F => {
...
;
function lt(var_core_value_sigA984) {
  switch (var_core_value_sigA984) {
    case "image":
      return var_core_value_sig0C32.DRAWING_IMAGE;
    case "shape":
      return var_core_value_sig0C32.DRAWING_SHAPE;
    case "chart":
      return var_core_value_sig0C32.DRAWING_CHART;
    case "table":
      return var_core_value_sig0C32.DRAWING_TABLE;
    case "group":
      return var_core_value_sig0C32.DRAWING_GROUP;
    case "media":
      return var_core_value_sig0C32.DRAWING_VIDEO;
    default:
      return var_core_value_sig0C32.DRAWING_SHAPE;
  }
}
;
function N(var_core_value_sigA504, var_core_value_sig05FF, var_core_value_sigFBF0, var_core_value_sig2F95, var_core_value_sigF0E1) {
  let var_core_value_sig2D8D = var_core_value_sigFBF0.type === "shape" ? rt(var_core_value_sigFBF0, var_core_value_sigF0E1) : var_core_value_sigFBF0,
  ...
  return {
    ...
    'drawingType': lt(var_core_value_sig2D8D.type),
    'transform': {
...
;
function ut(var_core_value_sigF449, var_core_value_sig38C5) {
  return typeof var_core_value_sigF449 == "number" ? var_core_value_sigF449 * var_core_value_sig38C5 : var_core_value_sigF449;
}
;
function dt(var_core_value_sigC87D, var_core_value_sigCCDC, var_core_value_sigC310) {
  ...
  return {
    ...
    'transform': {
      ...
      'left': ut(var_core_value_sig3474.left, var_core_value_sigA4E8),
      'top': ut(var_core_value_sig3474.top, var_core_value_sigDC07),
      'width': ut(var_core_value_sig3474.width, var_core_value_sigA4E8),
      'height': ut(var_core_value_sig3474.height, var_core_value_sigDC07)
    }
  };
}
;
function ft(var_core_value_sig4E80, var_core_value_sigD23B, var_core_value_sig2B2A, var_core_value_sig0B5C) {
...
;
function pt(var_core_value_sig7D42, var_core_value_sig8FDE, var_core_value_sig78E6) {
...
;
function mt(var_core_value_sigAA90, var_core_value_sigE92D, var_core_value_sig9940, var_core_value_sig682D, var_core_value_sig1435 = {}) {
  ...
  let var_core_value_sigCCAA = {},
    ...
    var_core_value_sig9427 = (var_core_value_sigCFAC, var_core_value_sig237B, var_core_value_sigFEAB) => {
      ...
      var_core_value_sig237B.forEach((var_core_value_sigF62A, var_core_value_sig8178) => {
        var_core_value_sigE347.set(var_core_value_sigF62A.id, ft(var_core_value_sigCFAC, var_core_value_sigE92D, var_core_value_sig8178, var_core_value_sigF62A));
      }), var_core_value_sig237B.forEach((var_core_value_sigE9ED, var_core_value_sigB577) => {
        var var_core_value_sig9572;
        let var_core_value_sigD873 = ft(var_core_value_sigCFAC, var_core_value_sigE92D, var_core_value_sigB577, var_core_value_sigE9ED),
          var_core_value_sigA12B = pt(var_core_value_sigCFAC, var_core_value_sigCFAC === "slide" ? var_core_value_sigE9ED : dt(var_core_value_sigE9ED, var_core_value_sigFEAB, (var_core_value_sig9572 = var_core_value_sig1435.pageSize) == null ? undefined : var_core_value_sig9572.target), var_core_value_sigE347);
        var_core_value_sigCCAA[var_core_value_sigD873] = {
          ...N(var_core_value_sigAA90, var_core_value_sigE92D, var_core_value_sigA12B, var_core_value_sigCFAC, var_core_value_sig682D),
  ...
  return var_core_value_sig9427("master", var_core_value_sig9940.masterLayer, (var_core_value_sig4082 = var_core_value_sig1435.pageSize) == null ? undefined : var_core_value_sig4082.master), var_core_value_sig9427("layout", var_core_value_sig9940.layoutLayer, (var_core_value_sigC049 = var_core_value_sig1435.pageSize) == null ? undefined : var_core_value_sigC049.layout), var_core_value_sig9427('slide', var_core_value_sig9940.slideLayer, (var_core_value_sigE5C3 = var_core_value_sig1435.pageSize) == null ? undefined : var_core_value_sigE5C3.target), {
    'data': ht(var_core_value_sigCCAA, var_core_value_sigF32D),
    'order': var_core_value_sigF32D
  };
}
;
function ht(var_core_value_sig21F4, var_core_value_sigA345 = []) {
  ...
  Object.values(var_core_value_sigA468).forEach(var_core_value_sig3C5B => {
    M(var_core_value_sig3C5B) && ot(var_core_value_sigA468, var_core_value_sig3C5B.drawingId, var_core_value_sigA345).forEach(var_core_value_sigF230 => {
  ...
  let var_core_value_sigDF14 = [...var_core_value_sigA345, ...Object.keys(var_core_value_sigA468).filter(var_core_value_sig200B => !var_core_value_sigA345.includes(var_core_value_sig200B))],
    var_core_value_sig842F = (var_core_value_sig3863, var_core_value_sigC97C, var_core_value_sigC4B1) => {
      ...
      if (!M(var_core_value_sigA937)) return;
      let var_core_value_sigCAD5 = new Set(var_core_value_sigC4B1);
      var_core_value_sigCAD5.add(var_core_value_sig3863), ot(var_core_value_sigA468, var_core_value_sig3863, var_core_value_sigA345).forEach(var_core_value_sig09B8 => {
...
var gt = class extends var_core_value_sig21B8 {
  ...
  getDrawingsByGroup(var_core_value_sigC6E5) {
    ...
    return ot(var_core_value_sig4313, var_core_value_sigE4C6).map(var_core_value_sigD082 => var_core_value_sig4313[var_core_value_sigD082]).filter(var_core_value_sigDBB7 => !!var_core_value_sigDBB7);
  }
  getDrawingsByGroupNested(var_core_value_sigFC87) {
    ...
    let var_core_value_sig72F6 = this.getDrawingData(var_core_value_sig156F, var_core_value_sigDD51),
      ...
      var_core_value_sig6EA1 = var_core_value_sigD0A8 => {
        ...
        let var_core_value_sig5CEE = ot(var_core_value_sig72F6, var_core_value_sigF4B9);
...
const P = var_core_value_sigCF8B("slide.slide-drawing.service");
function _t(var_core_value_sigC4C0) {
...
;
function vt(var_core_value_sig214A) {
  return var_core_value_sig214A.name || var_core_value_sig214A.id;
}
;
function yt(var_core_value_sigCCC3, var_core_value_sig986E, var_core_value_sig537C = {}) {
  ...
  let var_core_value_sigE28B = ((var_core_value_sig5440 = var_core_value_sig537C.nameBase) == null ? undefined : var_core_value_sig5440.trim()) || _t(var_core_value_sigCCC3);
  return {
    ...var_core_value_sigCCC3,
    'name': var_core_value_sig1F6E(var_core_value_sigE28B, Array.from(var_core_value_sig986E).map(vt))
  };
}
const bt = new Set(Object.values(j)),
  xt = {
    'width': 960,
    'height': 540
  };
function St(var_core_value_sig0FD9, var_core_value_sig5649) {
  ...
  return {
    'pageSize': {
      ...
      'layout': (var_core_value_sig8E65 == null ? undefined : var_core_value_sig8E65.pageSize) ?? (var_core_value_sig8E65 && bt.has(var_core_value_sig8E65.id) ? xt : var_core_value_sig44F9),
      'master': (var_core_value_sigF309 == null ? undefined : var_core_value_sigF309.pageSize) ?? ((var_core_value_sigF309 == null ? undefined : var_core_value_sigF309.id) === "master-default" ? xt : var_core_value_sig44F9)
    }
  };
}
;
function Ct(var_core_value_sigE532, var_core_value_sigF381) {
  let var_core_value_sigCB92 = var_core_value_sigF381.getId();
  return mt(var_core_value_sigE532.getUnitId(), var_core_value_sigCB92, var_core_value_sigF381.resolveElements(), var_core_value_sigE532.getThemeDataForPage(var_core_value_sigCB92), St(var_core_value_sigE532, var_core_value_sigCB92));
}
;
function wt(var_core_value_sigC844, var_core_value_sig2ED4, var_core_value_sig0477) {
...
;
function F(var_core_value_sig6FDF, var_core_value_sig27C4, var_core_value_sig3E1A, var_core_value_sig7FB0) {
  ...
  let var_core_value_sig5204 = var_core_value_sig6FDF.getDrawingData(var_core_value_sig3E1A, var_core_value_sig7FB0),
    ...
    } = Ct(var_core_value_sig27C4, var_core_value_sig5215),
  ...
  return var_core_value_sigD7F2.length > 0 && var_core_value_sig6FDF.removeNotification(wt(var_core_value_sig3E1A, var_core_value_sig7FB0, var_core_value_sigD7F2)), var_core_value_sig7CF3.length > 0 && var_core_value_sig6FDF.addNotification(wt(var_core_value_sig3E1A, var_core_value_sig7FB0, var_core_value_sig7CF3)), var_core_value_sig9DC6.length > 0 && var_core_value_sig6FDF.updateNotification(wt(var_core_value_sig3E1A, var_core_value_sig7FB0, var_core_value_sig9DC6)), var_core_value_sigD7F2.length === 0 && var_core_value_sig7CF3.length === 0 && var_core_value_sig9DC6.length === 0 && var_core_value_sig424E.length > 0 && var_core_value_sig6FDF.updateNotification(wt(var_core_value_sig3E1A, var_core_value_sig7FB0, var_core_value_sig424E)), true;
}
;
function Tt(var_core_value_sig6643, var_core_value_sig4124) {
...
;
function I(var_core_value_sig9A01, var_core_value_sig674F, var_core_value_sigC8F6, var_core_value_sig8A26) {
  Tt(var_core_value_sig674F, var_core_value_sig8A26).forEach(var_core_value_sig5E86 => {
    F(var_core_value_sig9A01, var_core_value_sig674F, var_core_value_sigC8F6, var_core_value_sig5E86);
  });
}
;
function Et(var_core_value_sigD073) {
  ...
  try {
    let var_core_value_sig6998 = new var_core_value_sig3FD5(var_core_value_sigF631, var_core_value_sigD073.id, var_core_value_sigD073.shapeData, var_core_value_sigD073.name).toJSON().shapeData,
...
;
function Dt(var_core_value_sig2278) {
  var_core_value_sig2278 && Object.entries(var_core_value_sig2278.elements).forEach(([var_core_value_sigEAE5, var_core_value_sigE94C]) => {
    var_core_value_sig2278.elements[var_core_value_sigEAE5] = Ot(var_core_value_sigE94C);
  });
}
;
function Ot(var_core_value_sig7053) {
  return var_core_value_sig7053.type === "shape" ? Et(var_core_value_sig7053) : var_core_value_sig7053;
}
;
function kt(var_core_value_sig52F1) {
  return Object.values(var_core_value_sig52F1.slides).forEach(Dt), Object.values(var_core_value_sig52F1.masterPages ?? {}).forEach(Dt), Object.values(var_core_value_sig52F1.layoutPages ?? {}).forEach(Dt), Object.values(var_core_value_sig52F1.handoutMasterPages ?? {}).forEach(Dt), Object.values(var_core_value_sig52F1.notesMasterPages ?? {}).forEach(Dt), var_core_value_sig52F1;
}
;
function At(var_core_value_sig1E74, var_core_value_sig1E84, var_core_value_sig133B) {
...
;
function jt(var_core_value_sig9A03, var_core_value_sig3363) {
...
;
function Mt(var_core_value_sigF64A, var_core_value_sig25EC, var_core_value_sigA790) {
  ...
  if (var_core_value_sig25EC.sourcePageType === 'slide') {
    ...
    let var_core_value_sigCB82 = jt(var_core_value_sig25EC.element, var_core_value_sig25EC.transform);
  ...
  let var_core_value_sig01B9 = At(var_core_value_sig9A5E, var_core_value_sig25EC.sourcePageType, var_core_value_sig25EC.subUnitId);
  if (!var_core_value_sig01B9) return false;
  let var_core_value_sigD6A9 = Ot(jt(var_core_value_sig25EC.element, var_core_value_sig25EC.transform)),
...
;
function Nt(var_core_value_sigCF96, var_core_value_sigC4E9, var_core_value_sigF612, var_core_value_sigAA6C) {
  let var_core_value_sig8BFA = Ot(jt(var_core_value_sigF612, var_core_value_sigAA6C));
  ...
  let var_core_value_sig236B = At(var_core_value_sigCF96.getSnapshot(), var_core_value_sigC4E9.sourcePageType, var_core_value_sigC4E9.subUnitId);
...
;
function Pt(var_core_value_sig1951, var_core_value_sigFEA0) {
  ...
  let var_core_value_sig931A = At(var_core_value_sig1951.getSnapshot(), var_core_value_sigFEA0.sourcePageType, var_core_value_sigFEA0.subUnitId);
...
const L = {
    ...
    'type': var_core_value_sig3FB3.MUTATION,
    'handler': (var_core_value_sig3585, var_core_value_sig31A8) => {
      let {
        ...
        var_core_value_sig1FCC = var_core_value_sig3585.get(var_core_value_sigF3C7).getUnit(var_core_value_sigA4DA, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sig1FCC) return false;
      let var_core_value_sigB7F9 = var_core_value_sig3585.get(P),
        var_core_value_sigB1A2 = var_core_value_sig1FCC.pageManager['getSlide'](var_core_value_sig6FC0),
        var_core_value_sig526D = N(var_core_value_sigA4DA, var_core_value_sig6FC0, yt(var_core_value_sig31A8.element, Object.values((var_core_value_sigB1A2 == null ? undefined : var_core_value_sigB1A2.getData().elements) ?? {}), {
          'nameBase': var_core_value_sigB805
        }), var_core_value_sig4FAE);
      if (Mt(var_core_value_sig1FCC, var_core_value_sig526D, var_core_value_sig6217), var_core_value_sig4FAE === 'slide' && F(var_core_value_sigB7F9, var_core_value_sig1FCC, var_core_value_sigA4DA, var_core_value_sig6FC0)) return true;
      if (var_core_value_sig4FAE === "master" || var_core_value_sig4FAE === "layout") return I(var_core_value_sigB7F9, var_core_value_sig1FCC, var_core_value_sigA4DA, var_core_value_sig6FC0), true;
...
function It(var_core_value_sig3AD7) {
...
;
function Lt(var_core_value_sig04E4) {
...
;
function Rt(var_core_value_sigD8F0) {
  return var_core_value_sigD8F0.type, var_core_value_sigD8F0.placeholder;
}
;
function zt(var_core_value_sig1475) {
  let var_core_value_sig08B7 = Rt(var_core_value_sig1475);
...
;
function R(var_core_value_sig2008) {
  let var_core_value_sig496B = Rt(var_core_value_sig2008);
  if (var_core_value_sig496B != null && var_core_value_sig496B.type) return Lt(var_core_value_sig496B.type) + '::' + (var_core_value_sig496B.index ?? "__default__");
}
;
function Bt(var_core_value_sig7161) {
  let var_core_value_sig2AB8 = var_core_value_sig7161.custom,
    var_core_value_sig3FCF = [...It(var_core_value_sig2AB8 == null ? undefined : var_core_value_sig2AB8.pptxAbsentPlaceholderKeys), ...It(var_core_value_sig2AB8 == null ? undefined : var_core_value_sig2AB8[Ft])];
  return new Set(var_core_value_sig3FCF);
}
;
function Vt(var_core_value_sig675A, var_core_value_sig837F) {
  if (!zt(var_core_value_sig675A)) return false;
  let var_core_value_sig9D6E = R(var_core_value_sig675A);
  return !!var_core_value_sig9D6E && var_core_value_sig837F.has(var_core_value_sig9D6E);
}
;
function Ht(var_core_value_sigB205, var_core_value_sigBF78, var_core_value_sig8AF3) {
  let var_core_value_sigA0CC = {
      ...(var_core_value_sigB205 ?? {})
    },
    var_core_value_sigB3A1 = new Set(It(var_core_value_sigA0CC[Ft]));
  return var_core_value_sig8AF3 ? var_core_value_sigB3A1.add(var_core_value_sigBF78) : var_core_value_sigB3A1.delete(var_core_value_sigBF78), var_core_value_sigB3A1.size > 0 ? var_core_value_sigA0CC[Ft] = Array.from(var_core_value_sigB3A1) : delete var_core_value_sigA0CC[Ft], Object.keys(var_core_value_sigA0CC).length > 0 ? var_core_value_sigA0CC : undefined;
}
const z = {
  ...
  'handler': (var_core_value_sig1FB9, var_core_value_sig53A9) => {
    let {
      ...
      var_core_value_sig0347 = var_core_value_sig1FB9.get(P),
      var_core_value_sig52A3 = var_core_value_sig1FB9.get(var_core_value_sigF3C7).getUnit(var_core_value_sigDACD, var_core_value_sig7CB9.UNIVER_SLIDE);
    ...
    let var_core_value_sigAD91 = var_core_value_sig52A3.pageManager["getSlide"](var_core_value_sig691E),
      ...
      var_core_value_sig9B3D = var_core_value_sig0347.getDrawingByParam({
        ...
        'subUnitId': var_core_value_sig691E,
        'drawingId': var_core_value_sigD6D6
      }) ?? (var_core_value_sigF64E ? N(var_core_value_sigDACD, var_core_value_sig691E, var_core_value_sigF64E, "slide") : null);
    if (!var_core_value_sig9B3D) return false;
    let var_core_value_sigB217 = R(var_core_value_sig9B3D.element);
    if (var_core_value_sig9B3D.sourcePageType !== "slide" && var_core_value_sigB217 && zt(var_core_value_sig9B3D.element)) return var_core_value_sigAD91 ? (var_core_value_sigAD91.updatePageData({
      'custom': Ht(var_core_value_sigAD91.getData().custom, var_core_value_sigB217, true)
    }), F(var_core_value_sig0347, var_core_value_sig52A3, var_core_value_sigDACD, var_core_value_sig691E)) : false;
    let var_core_value_sig1FE6 = var_core_value_sig0347.getDrawingData(var_core_value_sigDACD, var_core_value_sig691E),
      var_core_value_sig2471 = ct(var_core_value_sig1FE6, var_core_value_sig0347.getDrawingOrder(var_core_value_sigDACD, var_core_value_sig691E), [var_core_value_sigD6D6]).map(var_core_value_sig39B1 => var_core_value_sig1FE6[var_core_value_sig39B1]).filter(var_core_value_sig210D => !!var_core_value_sig210D);
    if (var_core_value_sig2471.length === 0 && var_core_value_sig2471.push(var_core_value_sig9B3D), var_core_value_sig2471.forEach(var_core_value_sigB4B4 => {
      Pt(var_core_value_sig52A3, var_core_value_sigB4B4);
    }), var_core_value_sig9B3D.sourcePageType === "slide" && F(var_core_value_sig0347, var_core_value_sig52A3, var_core_value_sigDACD, var_core_value_sig691E)) return true;
    if (var_core_value_sig9B3D.sourcePageType === "master" || var_core_value_sig9B3D.sourcePageType === "layout") return I(var_core_value_sig0347, var_core_value_sig52A3, var_core_value_sigDACD, var_core_value_sig691E), true;
...
function B(var_core_value_sigE2F9, var_core_value_sigD689 = {}) {
  let {
      unitId: var_core_value_sig7AE3,
      subUnitId: var_core_value_sig1EB3
    } = var_core_value_sigD689,
    var_core_value_sigE120 = var_core_value_sig7AE3 ? var_core_value_sigE2F9.getUnit(var_core_value_sig7AE3, var_core_value_sig7CB9.UNIVER_SLIDE) : var_core_value_sigE2F9.getCurrentUnitOfType(var_core_value_sig7CB9.UNIVER_SLIDE);
...
const Ut = {
    ...
    'type': var_core_value_sig3FB3.COMMAND,
    'handler': (var_core_value_sig5CBC, var_core_value_sig20BE) => {
      if (!var_core_value_sig20BE) return false;
      let var_core_value_sig6BD0 = B(var_core_value_sig5CBC.get(var_core_value_sigF3C7), var_core_value_sig20BE);
      if (!var_core_value_sig6BD0) return false;
      let var_core_value_sig8C15 = var_core_value_sig5CBC.get(var_core_value_sig2616),
        var_core_value_sig6DF7 = var_core_value_sig5CBC.get(var_core_value_sig06EA),
        var_core_value_sigB411 = var_core_value_sig5CBC.get(P),
        {
        ...
        var_core_value_sig22B4 = yt(var_core_value_sig20BE.element, Object.values((var_core_value_sig80C0 == null ? undefined : var_core_value_sig80C0.getData().elements) ?? {}), {
          'nameBase': var_core_value_sigFE76
        }),
      ...
      return var_core_value_sig8C15.syncExecuteCommand(L.id, var_core_value_sigBB37) ? (var_core_value_sigF8DE && var_core_value_sigB411.focusDrawing([{
        'unitId': var_core_value_sigA81B,
        'subUnitId': var_core_value_sigFE8D,
        'drawingId': var_core_value_sig22B4.id
  ...
  V = {
    ...
    'handler': (var_core_value_sigADA4, var_core_value_sig0E48) => {
      let {
        ...
        var_core_value_sig6B99 = var_core_value_sigADA4.get(var_core_value_sigF3C7),
        var_core_value_sig6ADC = var_core_value_sigADA4.get(P),
        var_core_value_sig41AD = var_core_value_sig6B99.getUnit(var_core_value_sig495B, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sig41AD) return false;
      let {
        data: var_core_value_sigDBC2,
        order: var_core_value_sig7739
      } = Ct(var_core_value_sig41AD, var_core_value_sig41AD.pageManager["createSlide"](var_core_value_sig310C, var_core_value_sig759E));
  ...
  H = {
    ...
    'handler': (var_core_value_sig4040, var_core_value_sig1AAA) => {
      ...
      let {
        ...
        var_core_value_sig6223 = var_core_value_sig4040.get(var_core_value_sigF3C7),
        var_core_value_sigC6B6 = var_core_value_sig4040.get(P),
        var_core_value_sig498A = var_core_value_sig6223.getUnit(var_core_value_sig4840, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  Wt = {
    ...
    'handler': (var_core_value_sigEF45, var_core_value_sig36FE) => {
      ...
      let {
        ...
        var_core_value_sigC0F8 = var_core_value_sigEF45.get(var_core_value_sigF3C7).getUnit(var_core_value_sig3AF5, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      let var_core_value_sig992D = var_core_value_sigEF45.get(var_core_value_sig2616),
        var_core_value_sigE4E4 = var_core_value_sigEF45.get(var_core_value_sig06EA),
      ...
      return var_core_value_sig992D.syncExecuteCommand(V.id, var_core_value_sigA4B0) ? (var_core_value_sigE4E4.pushUndoRedo({
        'unitID': var_core_value_sig3AF5,
        'undoMutations': [{
          'id': H.id,
...
function Gt(var_core_value_sig4494, var_core_value_sigFFAF) {
...
;
function Kt(var_core_value_sig36CC) {
  ...
  return var_core_value_sig5D2E !== "shape" && var_core_value_sig5D2E !== "group" ? var_core_value_sig85D5 : Gt(var_core_value_sig85D5, (var_core_value_sigA568 == null ? undefined : var_core_value_sigA568.angle) ?? var_core_value_sigD22D.rotation ?? 0);
}
;
function qt(var_core_value_sig7221) {
...
;
function Jt(var_core_value_sigE6D6) {
...
;
function Yt(var_core_value_sig9E81, var_core_value_sig8295, var_core_value_sigA975, var_core_value_sig1263, var_core_value_sig457C, var_core_value_sigA4E6) {
  let var_core_value_sig934F = var_core_value_sigA4E6.flatMap(var_core_value_sig63F3 => {
    ...
    let var_core_value_sig3BF6 = var_core_value_sig6A71.transform || {
      ...
      var_core_value_sig38CE = Jt(var_core_value_sig6A71),
    ...
    return var_core_value_sig6A71.element["children"].map(var_core_value_sig362B => var_core_value_sig457C[var_core_value_sig362B]).filter(var_core_value_sig5CA5 => !!var_core_value_sig5CA5).map(var_core_value_sigE90F => {
      let var_core_value_sigEFD4 = var_core_value_sig72B6(var_core_value_sigE90F.transform || {
          'left': 0,
          'top': 0
  ...
  for (let var_core_value_sigA90D of var_core_value_sig934F) if (!Nt(var_core_value_sig9E81, var_core_value_sigA90D, var_core_value_sigA90D.element, var_core_value_sigA90D.transform)) return false;
...
const Xt = {
    ...
    'handler': (var_core_value_sig3685, var_core_value_sigC621) => {
      ...
      let var_core_value_sig2E04 = var_core_value_sig3685.get(P),
        var_core_value_sig2EDD = var_core_value_sig3685.get(var_core_value_sigF3C7).getUnit(var_core_value_sig431B, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      let var_core_value_sigEB36 = qt(var_core_value_sig355D),
        var_core_value_sig5C27 = var_core_value_sigC621.groupId ?? var_core_value_sig524D(6),
        var_core_value_sigD494 = var_core_value_sig355D.reduce((var_core_value_sigCB04, var_core_value_sig947E) => {
          let var_core_value_sig4545 = Kt(var_core_value_sig947E);
      ...
      let var_core_value_sigBF6D = {
        ...
        var_core_value_sigD051 = N(var_core_value_sig431B, var_core_value_sig5C7C, yt({
      ...
      if (!Mt(var_core_value_sig2EDD, var_core_value_sigD051)) return false;
  ...
  Zt = {
    ...
    'handler': (var_core_value_sigEEA6, var_core_value_sigEAE1) => {
      ...
      let var_core_value_sig045E = var_core_value_sigEEA6.get(P),
        var_core_value_sig4524 = var_core_value_sigEEA6.get(var_core_value_sigF3C7).getUnit(var_core_value_sig0442, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      if (!Yt(var_core_value_sig4524, var_core_value_sig045E, var_core_value_sig0442, var_core_value_sig697A, var_core_value_sig64D5, var_core_value_sig9678)) return false;
      var_core_value_sig5E74.forEach(var_core_value_sigDCF5 => {
        ...
        Pt(var_core_value_sig4524, var_core_value_sig5825);
      });
  ...
  Qt = {
    ...
    'handler': (var_core_value_sig2829, var_core_value_sig6EE2) => {
      ...
      let var_core_value_sig4CCC = B(var_core_value_sig2829.get(var_core_value_sigF3C7), var_core_value_sig6EE2);
      if (!var_core_value_sig4CCC) return false;
      let var_core_value_sig6E47 = var_core_value_sig2829.get(P),
      ...
      if (!var_core_value_sig20F6(var_core_value_sigE4D0)) return false;
      let var_core_value_sigD5F1 = var_core_value_sig9B13(var_core_value_sigE4D0.smartArt),
        var_core_value_sigBC19 = var_core_value_sig6EE2.childIds ?? var_core_value_sigD5F1.map(() => var_core_value_sig524D(6)),
        var_core_value_sig4F3C = var_core_value_sig6EE2.groupId ?? (var_core_value_sigD5F1.length > 1 ? var_core_value_sig524D(6) : undefined);
      ...
      let var_core_value_sig8D44 = var_core_value_sig2407.transform,
        var_core_value_sig1660 = var_core_value_sigD5F1.map((var_core_value_sig548A, var_core_value_sigE026) => {
          ...
          return {
            ...
            'transform': en(var_core_value_sig8D44, var_core_value_sig548A.transform),
      ...
      return var_core_value_sig6ACE(var_core_value_sig7E48, var_core_value_sig2829.get(var_core_value_sig2616)).result ? (var_core_value_sig2829.get(var_core_value_sig06EA).pushUndoRedo({
        'unitID': var_core_value_sig4CCC.unitId,
        'undoMutations': var_core_value_sig7B9E,
        'redoMutations': var_core_value_sig7E48
      }), true) : false;
...
function $t(var_core_value_sig5C3B) {
...
;
function en(var_core_value_sig4153, var_core_value_sig2825) {
...
const tn = {
    ...
    'handler': (var_core_value_sigC2F9, var_core_value_sig1F51) => {
      ...
      let {
        ...
        var_core_value_sig370E = var_core_value_sigC2F9.get(var_core_value_sigF3C7),
        var_core_value_sigDE14 = var_core_value_sigC2F9.get(var_core_value_sig2616),
        var_core_value_sig02CB = var_core_value_sigC2F9.get(var_core_value_sig06EA),
        var_core_value_sig6CBB = var_core_value_sig370E.getUnit(var_core_value_sig29F5, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      return var_core_value_sigDE14.syncExecuteCommand(V.id, var_core_value_sigF897) ? (var_core_value_sig02CB.pushUndoRedo({
        'unitID': var_core_value_sig29F5,
        'undoMutations': [{
          'id': H.id,
  ...
  nn = {
    ...
    'handler': (var_core_value_sig0260, var_core_value_sig034D) => {
      let {
        ...
        var_core_value_sig2637 = var_core_value_sig0260.get(var_core_value_sigF3C7).getUnit(var_core_value_sig89EC, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  rn = {
    ...
    'handler': (var_core_value_sigAF1D, var_core_value_sigC92D) => {
      ...
      let var_core_value_sigEA3D = B(var_core_value_sigAF1D.get(var_core_value_sigF3C7), var_core_value_sigC92D);
      if (!var_core_value_sigEA3D) return false;
      let var_core_value_sig2841 = var_core_value_sigAF1D.get(var_core_value_sig2616),
        var_core_value_sig9FE1 = var_core_value_sigAF1D.get(var_core_value_sig06EA),
        {
      ...
      return var_core_value_sig2841.syncExecuteCommand(nn.id, var_core_value_sig4A48) ? (var_core_value_sig9FE1.pushUndoRedo({
        'unitID': var_core_value_sig1F8A,
        'undoMutations': [{
          'id': nn.id,
  ...
  an = {
    ...
    'handler': (var_core_value_sig90E5, var_core_value_sig7000) => {
      let {
        ...
        var_core_value_sig28BE = var_core_value_sig90E5.get(P),
        var_core_value_sig0224 = var_core_value_sig90E5.get(var_core_value_sigF3C7).getUnit(var_core_value_sigD7C5, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      return var_core_value_sig854B ? (var_core_value_sig854B.updatePageData({
        'custom': Ht(var_core_value_sig854B.getData().custom, var_core_value_sig1DF5, var_core_value_sig90A3)
      }), F(var_core_value_sig28BE, var_core_value_sig0224, var_core_value_sigD7C5, var_core_value_sig3633)) : false;
    }
  };
function on(var_core_value_sig1FF6) {
  if (!(var_core_value_sig1FF6.sourcePageType === "slide" || !zt(var_core_value_sig1FF6.element))) return R(var_core_value_sig1FF6.element);
}
;
function sn(var_core_value_sig4B27, var_core_value_sig3A41, var_core_value_sig269A, var_core_value_sigBF53) {
...
;
function cn(var_core_value_sigD9BB, var_core_value_sigF549) {
  ...
  return var_core_value_sigF549.drawingIds["forEach"](var_core_value_sigD4FF => {
    st(var_core_value_sigC125, var_core_value_sigD4FF, var_core_value_sigB63D).forEach(var_core_value_sig9A8D => var_core_value_sig8255.add(var_core_value_sig9A8D));
  }), var_core_value_sigF549.drawingIds["filter"](var_core_value_sig1E5B => !var_core_value_sig8255.has(var_core_value_sig1E5B)).map(var_core_value_sigB680 => sn(var_core_value_sigD9BB, var_core_value_sigF549.unitId, var_core_value_sigF549.subUnitId, var_core_value_sigB680)).filter(var_core_value_sig1F64 => !!var_core_value_sig1F64);
}
;
function ln(var_core_value_sigBFC7, var_core_value_sig933F) {
  let var_core_value_sig29DE = var_core_value_sigBFC7.getDrawingData(var_core_value_sig933F.unitId, var_core_value_sig933F.subUnitId),
    ...
    var_core_value_sigC7EA = ct(var_core_value_sig29DE, var_core_value_sig4AFB, var_core_value_sig933F.drawingIds),
  ...
  return var_core_value_sig4AFB.forEach((var_core_value_sigDD1C, var_core_value_sig2C39) => var_core_value_sigCCE5.set(var_core_value_sigDD1C, var_core_value_sig2C39)), var_core_value_sigDAB9.map(var_core_value_sigB7D1 => {
    let var_core_value_sig64F0 = var_core_value_sig29DE[var_core_value_sigB7D1] ?? sn(var_core_value_sigBFC7, var_core_value_sig933F.unitId, var_core_value_sig933F.subUnitId, var_core_value_sigB7D1);
...
const un = {
    ...
    'handler': (var_core_value_sig5933, var_core_value_sig884B) => {
      ...
      let var_core_value_sig4E30 = B(var_core_value_sig5933.get(var_core_value_sigF3C7), var_core_value_sig884B);
      if (!var_core_value_sig4E30) return false;
      let var_core_value_sig9730 = var_core_value_sig5933.get(var_core_value_sig2616),
        var_core_value_sig8E4A = var_core_value_sig5933.get(var_core_value_sig06EA),
        var_core_value_sig300B = var_core_value_sig5933.get(P),
        {
        ...
        var_core_value_sig6C8C = cn(var_core_value_sig300B, var_core_value_sigDB33),
        var_core_value_sig7A5E = ln(var_core_value_sig300B, var_core_value_sigDB33);
      ...
      return var_core_value_sig6C8C.forEach(var_core_value_sig3141 => {
        let var_core_value_sig2162 = on(var_core_value_sig3141);
        ...
        let var_core_value_sig340D = on(var_core_value_sig2EAD);
      ...
      }), var_core_value_sig6ACE(var_core_value_sig838E, var_core_value_sig9730).result ? (var_core_value_sig8E4A.pushUndoRedo({
        'unitID': var_core_value_sig8457,
  ...
  dn = {
    ...
    'handler': (var_core_value_sigC860, var_core_value_sigE64C) => {
      ...
      let var_core_value_sigF39B = B(var_core_value_sigC860.get(var_core_value_sigF3C7), var_core_value_sigE64C);
      if (!var_core_value_sigF39B) return false;
      let var_core_value_sig9B88 = var_core_value_sigC860.get(var_core_value_sig2616),
        var_core_value_sig992A = var_core_value_sigC860.get(var_core_value_sig06EA),
        {
      ...
      return var_core_value_sig9B88.syncExecuteCommand(H.id, var_core_value_sig3EC0) ? (var_core_value_sig992A.pushUndoRedo({
        'unitID': var_core_value_sigA724,
        'undoMutations': [{
          'id': V.id,
...
function fn(var_core_value_sigF42A, var_core_value_sig898E) {
...
const pn = {
    ...
    'handler': (var_core_value_sig00DE, var_core_value_sigEF7C) => {
      let {
        ...
        var_core_value_sigB591 = var_core_value_sig00DE.get(var_core_value_sigF3C7),
        var_core_value_sigB272 = var_core_value_sig00DE.get(P),
        var_core_value_sig6F52 = var_core_value_sigB591.getUnit(var_core_value_sig07E7, var_core_value_sig7CB9.UNIVER_SLIDE),
      ...
      let var_core_value_sig8E3E = fn(var_core_value_sig09C4.getData().elementOrder, var_core_value_sig25A4);
      var_core_value_sig09C4.setElementOrder(var_core_value_sig8E3E);
      let var_core_value_sigC3D3 = Ct(var_core_value_sig6F52, var_core_value_sig09C4);
  ...
  mn = {
    ...
    'handler': (var_core_value_sig1451, var_core_value_sigAD57) => {
      ...
      let var_core_value_sig58A8 = B(var_core_value_sig1451.get(var_core_value_sigF3C7), var_core_value_sigAD57);
      ...
      let {
        ...
        var_core_value_sig40E7 = fn(var_core_value_sigEC1A.getData().elementOrder, var_core_value_sigAD57.drawingIds),
        var_core_value_sigEDBA = var_core_value_sig1451.get(var_core_value_sig2616),
        var_core_value_sigE863 = var_core_value_sig1451.get(var_core_value_sig06EA),
      ...
      return var_core_value_sigEDBA.syncExecuteCommand(pn.id, var_core_value_sig1C07) ? (var_core_value_sigE863.pushUndoRedo({
        'unitID': var_core_value_sigBDED,
        'undoMutations': [{
          'id': pn.id,
  ...
  hn = {
    ...
    'handler': (var_core_value_sigDD05, var_core_value_sig3932) => {
      ...
      let var_core_value_sig48B2 = var_core_value_sigDD05.get(var_core_value_sigF3C7).getUnit(var_core_value_sig3932.unitId, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  gn = {
    ...
    'handler': (var_core_value_sig57DF, var_core_value_sigC985) => {
      ...
      let var_core_value_sigCA69 = B(var_core_value_sig57DF.get(var_core_value_sigF3C7), var_core_value_sigC985);
      ...
      let var_core_value_sig7EAB = var_core_value_sig57DF.get(var_core_value_sig2616),
        var_core_value_sig56B9 = var_core_value_sig57DF.get(var_core_value_sig06EA),
      ...
      return var_core_value_sig7EAB.syncExecuteCommand(hn.id, var_core_value_sig90CF) ? (var_core_value_sig56B9.pushUndoRedo({
        'unitID': var_core_value_sig9AFF,
        'undoMutations': [{
          'id': hn.id,
...
let _n = function (var_core_value_sigCD6E) {
  ...
  vn = function (var_core_value_sigFD9D) {
...
function yn(var_core_value_sigA2A4) {
  return {
...
;
function U(var_core_value_sigA1AC) {
...
;
function bn(var_core_value_sigB93D, var_core_value_sigB17C, var_core_value_sig69B6) {
  return {
    ...
    'custom': yn(var_core_value_sigB93D)
  };
}
;
function xn(var_core_value_sig708D, var_core_value_sig1ED2, var_core_value_sig94C1) {
  let var_core_value_sigABAC = var_core_value_sig94C1.map((var_core_value_sigBDE4, var_core_value_sig7DF1) => bn(var_core_value_sigBDE4, var_core_value_sig1ED2, var_core_value_sig7DF1)),
  ...
  for (let var_core_value_sigDC86 of var_core_value_sig708D.elementOrder) {
    ...
    !var_core_value_sig4CD2 || U(var_core_value_sig4CD2) || (var_core_value_sigFAE6[var_core_value_sigDC86] = var_core_value_sig4CD2);
  }
  ...
  return {
    ...
    'elementOrder': [...var_core_value_sigABAC.map(var_core_value_sigA39E => var_core_value_sigA39E.id), ...var_core_value_sig708D.elementOrder["filter"](var_core_value_sigBBEE => {
      ...
      return var_core_value_sig011D && !U(var_core_value_sig011D);
    })],
    'elements': var_core_value_sigFAE6
  };
}
;
function Sn(var_core_value_sig06AC) {
  return var_core_value_sig06AC.elementOrder['map'](var_core_value_sig6167 => var_core_value_sig06AC.elements[var_core_value_sig6167]).filter(var_core_value_sig65A1 => !!var_core_value_sig65A1 && var_core_value_sig65A1.type === "image" && U(var_core_value_sig65A1)).map(var_core_value_sig7F19 => ({
...
;
function Cn(var_core_value_sig57E2, var_core_value_sig01FC = "allMasters", var_core_value_sig10FC) {
...
const wn = {
    ...
    'handler': (var_core_value_sig8339, var_core_value_sigA01E) => {
      ...
      let var_core_value_sigA41E = var_core_value_sig8339.get(var_core_value_sigF3C7).getUnit(var_core_value_sigA01E.unitId, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  Tn = {
    ...
    'handler': (var_core_value_sig6DEB, var_core_value_sig2F0D) => {
      let {
        ...
        var_core_value_sig2E9A = var_core_value_sig6DEB.get(var_core_value_sigF3C7).getUnit(var_core_value_sig5141, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      return !var_core_value_sig0BD6 || !var_core_value_sig0BD6[var_core_value_sigA9E0] ? false : (var_core_value_sig0BD6[var_core_value_sigA9E0] = xn(var_core_value_sig0BD6[var_core_value_sigA9E0], var_core_value_sig0BD6[var_core_value_sigA9E0].pageSize ?? var_core_value_sigE105.defaultPageSize, var_core_value_sig751D), I(var_core_value_sig6DEB.get(P), var_core_value_sig2E9A, var_core_value_sig5141, var_core_value_sigA9E0), true);
    }
  },
  En = {
    ...
    'handler': (var_core_value_sig3070, var_core_value_sigC66D) => {
      ...
      let {
        ...
        var_core_value_sig1613 = var_core_value_sig3070.get(var_core_value_sigF3C7).getUnit(var_core_value_sig1056, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sig1613) return false;
      let var_core_value_sigADC6 = var_core_value_sig3070.get(var_core_value_sig2616),
        var_core_value_sig4620 = var_core_value_sig3070.get(var_core_value_sig06EA),
        var_core_value_sig07FB = var_core_value_sig1613.getSnapshot(),
        var_core_value_sig617E = [],
        var_core_value_sigC85E = [],
        var_core_value_sig8293 = Cn(var_core_value_sig07FB, var_core_value_sig6EE5, var_core_value_sig9DD9);
      ...
      return var_core_value_sig8293.length === 0 ? false : (var_core_value_sig8293.forEach(var_core_value_sigB996 => {
        ...
        let var_core_value_sig6201 = (var_core_value_sig4BBA = var_core_value_sig07FB.masterPages) == null ? undefined : var_core_value_sig4BBA[var_core_value_sigB996],
          var_core_value_sig5151 = var_core_value_sig6201 ? Sn(var_core_value_sig6201) : [],
      ...
      }), var_core_value_sig6ACE(var_core_value_sig617E, var_core_value_sigADC6).result ? (var_core_value_sig4620.pushUndoRedo({
        'unitID': var_core_value_sig1056,
  ...
  Dn = {
    ...
    'handler': (var_core_value_sig050D, var_core_value_sig37AE) => {
      let var_core_value_sig5B51 = var_core_value_sig050D.get(var_core_value_sigF3C7).getUnit(var_core_value_sig37AE.unitId, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  On = {
    ...
    'handler': (var_core_value_sig64FF, var_core_value_sig86F4) => {
      ...
      let var_core_value_sig9E0F = B(var_core_value_sig64FF.get(var_core_value_sigF3C7), var_core_value_sig86F4);
      if (!var_core_value_sig9E0F) return false;
      let var_core_value_sig3A42 = var_core_value_sig64FF.get(var_core_value_sig2616),
        var_core_value_sig8802 = var_core_value_sig64FF.get(var_core_value_sig06EA),
        {
      ...
      return var_core_value_sig3A42.syncExecuteCommand(Dn.id, var_core_value_sigD120) ? (var_core_value_sig8802.pushUndoRedo({
        'unitID': var_core_value_sigE027,
        'redoMutations': [{
          'id': Dn.id,
...
function An(var_core_value_sigC04C) {
  return typeof var_core_value_sigC04C == 'number' && Number.isFinite(var_core_value_sigC04C) && var_core_value_sigC04C > 0;
}
;
function jn(var_core_value_sig2069) {
  if (var_core_value_sig2069 !== "custom") return kn[var_core_value_sig2069];
}
;
function Mn(var_core_value_sig5176) {
  let var_core_value_sig71A1 = jn(var_core_value_sig5176);
  return var_core_value_sig71A1 ? var_core_value_sig71A1.width / var_core_value_sig71A1.height : undefined;
}
;
function Nn(var_core_value_sig72AD) {
  ...
  for (let var_core_value_sigE2BF of ["standard4By3", "wideScreen16By9", "wideScreen16By10"]) {
    let var_core_value_sig48CA = Mn(var_core_value_sigE2BF);
...
;
function Pn(var_core_value_sig8EF01, var_core_value_sig234B) {
  if (!var_core_value_sig234B || var_core_value_sig234B === "custom") return;
  let var_core_value_sig8169 = Mn(var_core_value_sig234B);
  if (var_core_value_sig8169 !== undefined) {
    if (An(var_core_value_sig8EF01.width) && var_core_value_sig8EF01.height === undefined) return {
      'width': var_core_value_sig8EF01.width,
      'height': Math.round(var_core_value_sig8EF01.width / var_core_value_sig8169)
    };
    if (An(var_core_value_sig8EF01.height) && var_core_value_sig8EF01.width === undefined) return {
...
;
function Fn(var_core_value_sigC5FB) {
  ...
  if (var_core_value_sigC5FB !== undefined && (var_core_value_sigC5FB.width !== undefined || var_core_value_sigC5FB.height !== undefined)) {
    if (!An(var_core_value_sigC5FB == null ? undefined : var_core_value_sigC5FB.width) || !An(var_core_value_sigC5FB == null ? undefined : var_core_value_sigC5FB.height)) {
      let var_core_value_sig50AF = var_core_value_sigC5FB ? Pn(var_core_value_sigC5FB, var_core_value_sig5453) : undefined;
    ...
    return {
      ...
      'preset': Nn(var_core_value_sigB8C7)
    };
  }
  if (!var_core_value_sig5453) return;
  let var_core_value_sig8725 = jn(var_core_value_sig5453);
...
const In = {
    ...
    'handler': (var_core_value_sig513B, var_core_value_sig5501) => {
      let {
        ...
        var_core_value_sig77E3 = var_core_value_sig513B.get(var_core_value_sigF3C7).getUnit(var_core_value_sig7784, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      if (var_core_value_sigB706 === undefined) {
        ...
        let var_core_value_sigA56E = var_core_value_sig513B.get(P);
        return var_core_value_sig77E3.getSnapshot().slideOrder['forEach'](var_core_value_sigA942 => {
          F(var_core_value_sigA56E, var_core_value_sig77E3, var_core_value_sig7784, var_core_value_sigA942);
        }), true;
      }
      ...
      return var_core_value_sigB071 ? (var_core_value_sig5FD01 === undefined ? delete var_core_value_sigB071.pageSize : var_core_value_sigB071.pageSize = {
        ...var_core_value_sig5FD01
      }, I(var_core_value_sig513B.get(P), var_core_value_sig77E3, var_core_value_sig7784, var_core_value_sigB706), true) : false;
    }
  },
  Ln = {
    ...
    'handler': (var_core_value_sig15FE, var_core_value_sigCF47) => {
      ...
      let var_core_value_sigC341 = var_core_value_sig71CF ? Fn(var_core_value_sig1C3C) : undefined;
      if (var_core_value_sig71CF && !var_core_value_sigC341) return false;
      let var_core_value_sigBA47 = var_core_value_sig15FE.get(var_core_value_sigF3C7).getUnit(var_core_value_sigAF12, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sigBA47) return false;
      let var_core_value_sig3DF7 = var_core_value_sig15FE.get(var_core_value_sig2616),
        var_core_value_sigD49F = var_core_value_sig15FE.get(var_core_value_sig06EA),
      ...
      return var_core_value_sig3DF7.syncExecuteCommand(In.id, var_core_value_sig0F47) ? (var_core_value_sigD49F.pushUndoRedo({
        'unitID': var_core_value_sigAF12,
        'undoMutations': [{
          'id': In.id,
...
function Rn(var_core_value_sig28E2) {
  '@babel/helpers - typeof';

  return Rn = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function (var_core_value_sig1998) {
  ...
  }, Rn(var_core_value_sig28E2);
}
;
function zn(var_core_value_sig1578, var_core_value_sig52ED) {
  if (Rn(var_core_value_sig1578) != "object" || !var_core_value_sig1578) return var_core_value_sig1578;
  ...
  if (var_core_value_sig135F !== undefined) {
    ...
    if (Rn(var_core_value_sig416D) != "object") return var_core_value_sig416D;
...
;
function Bn(var_core_value_sigAD5D) {
  var var_core_value_sig1B8A = zn(var_core_value_sigAD5D, 'string');
  return Rn(var_core_value_sig1B8A) == 'symbol' ? var_core_value_sig1B8A : var_core_value_sig1B8A + '';
}
;
function W(var_core_value_sigFB18, var_core_value_sig703C, var_core_value_sig96CF) {
  return (var_core_value_sig703C = Bn(var_core_value_sig703C)) in var_core_value_sigFB18 ? Object.defineProperty(var_core_value_sigFB18, var_core_value_sig703C, {
...
var Vn = class {
    constructor(var_core_value_sig43B8, var_core_value_sigD98F) {
      this.unitId = var_core_value_sig43B8, this.objectId = var_core_value_sigD98F, W(this, "type", var_core_value_sigB1FB.SlideElement), W(this, "subType", var_core_value_sig43E8.Edit), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig43B8 + '_' + var_core_value_sigD98F;
    }
  },
  Hn = class {
    constructor(var_core_value_sig66C0, var_core_value_sig9D15) {
      this.unitId = var_core_value_sig66C0, this.objectId = var_core_value_sig9D15, W(this, 'type', var_core_value_sigB1FB.SlideMaster), W(this, "subType", var_core_value_sig43E8.Edit), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig66C0 + '_' + var_core_value_sig9D15;
    }
  },
  Un = class {
    constructor(var_core_value_sigB785, var_core_value_sig130F) {
      this.unitId = var_core_value_sigB785, this.objectId = var_core_value_sig130F, W(this, "type", var_core_value_sigB1FB.SlidePage), W(this, "subType", var_core_value_sig43E8.Edit), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigB785 + '_' + var_core_value_sig130F;
    }
  },
  Wn = class {
    constructor(var_core_value_sigC0E3) {
      this.unitId = var_core_value_sigC0E3, W(this, "type", var_core_value_sigB1FB.Slide), W(this, "subType", var_core_value_sig43E8.Comment), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigC0E3;
    }
  },
  Gn = class {
    constructor(var_core_value_sig52F7) {
      this.unitId = var_core_value_sig52F7, W(this, "type", var_core_value_sigB1FB.Slide), W(this, "subType", var_core_value_sig43E8.Copy), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, 'value', true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig52F7;
    }
  },
  Kn = class {
    constructor(var_core_value_sig866F) {
      this.unitId = var_core_value_sig866F, W(this, 'type', var_core_value_sigB1FB.Slide), W(this, "subType", var_core_value_sig43E8.Edit), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sig866F;
    }
  },
  qn = class {
    constructor(var_core_value_sigDE3D) {
      this.unitId = var_core_value_sigDE3D, W(this, "type", var_core_value_sigB1FB.Slide), W(this, "subType", var_core_value_sig43E8.Export), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigDE3D;
    }
  },
  Jn = class {
    constructor(var_core_value_sigF175) {
      this.unitId = var_core_value_sigF175, W(this, "type", var_core_value_sigB1FB.Slide), W(this, "subType", var_core_value_sig43E8.Print), W(this, "status", var_core_value_sigAD47.INIT), W(this, 'id', undefined), W(this, "value", true), this.id = this.type + '.' + this.subType + '_' + var_core_value_sigF175;
    }
  };
const Yn = [var_core_value_sig43E8.Edit, var_core_value_sig43E8.Copy, var_core_value_sig43E8.Print, var_core_value_sig43E8.Export, var_core_value_sig43E8.Comment],
  Xn = new Set([var_core_value_sigB1FB.Slide, var_core_value_sigB1FB.SlidePage, var_core_value_sigB1FB.SlideElement, var_core_value_sigB1FB.SlideMaster]),
  Zn = "page/",
  Qn = 'element/',
  $n = 'master-view';
function er(var_core_value_sig49F1) {
  return '' + Zn + encodeURIComponent(var_core_value_sig49F1);
}
;
function tr(var_core_value_sig2F7B, var_core_value_sigB0DF, var_core_value_sig2E44) {
  return '' + Qn + encodeURIComponent(var_core_value_sig2F7B) + '/' + encodeURIComponent(var_core_value_sigB0DF) + '/' + encodeURIComponent(var_core_value_sig2E44);
}
;
function nr(var_core_value_sig8560, var_core_value_sig138D, var_core_value_sig1E26) {
  return [var_core_value_sig8560 === "slide" ? er(var_core_value_sig138D) : $n, tr(var_core_value_sig8560, var_core_value_sig138D, var_core_value_sig1E26)];
}
;
function rr(var_core_value_sig5C6C, var_core_value_sigBE85, var_core_value_sig56DE) {
  if (var_core_value_sigBE85 === var_core_value_sig5C6C) switch (var_core_value_sig56DE) {
    case var_core_value_sig43E8.Edit:
      return new Kn(var_core_value_sig5C6C);
    case var_core_value_sig43E8.Copy:
      return new Gn(var_core_value_sig5C6C);
    case var_core_value_sig43E8.Print:
      return new Jn(var_core_value_sig5C6C);
    case var_core_value_sig43E8.Export:
      return new qn(var_core_value_sig5C6C);
    case var_core_value_sig43E8.Comment:
      return new Wn(var_core_value_sig5C6C);
    default:
      throw Error("Unsupported Slide permission action: " + var_core_value_sig56DE);
  }
  if (var_core_value_sig56DE !== var_core_value_sig43E8.Edit) throw Error("Slide object permissions only support Edit: " + var_core_value_sigBE85);
  if (var_core_value_sigBE85.startsWith(Zn)) return new Un(var_core_value_sig5C6C, var_core_value_sigBE85);
  if (var_core_value_sigBE85.startsWith(Qn)) return new Vn(var_core_value_sig5C6C, var_core_value_sigBE85);
  if (var_core_value_sigBE85 === 'master-view') return new Hn(var_core_value_sig5C6C, var_core_value_sigBE85);
  throw Error("Unsupported Slide permission object: " + var_core_value_sigBE85);
}
;
function ir(var_core_value_sig0278, var_core_value_sig08A6, var_core_value_sig04E1, var_core_value_sigC504) {
  var var_core_value_sig0515;
  return ((var_core_value_sig0515 = var_core_value_sig0278.getPermissionPoint(rr(var_core_value_sig08A6, var_core_value_sig04E1, var_core_value_sigC504).id)) == null ? undefined : var_core_value_sig0515.value) ?? true;
}
;
function ar(var_core_value_sig9F34, var_core_value_sig0247, var_core_value_sig6030, var_core_value_sig0137, var_core_value_sig14F3) {
  let var_core_value_sig34E8 = rr(var_core_value_sig0247, var_core_value_sig6030, var_core_value_sig0137);
...
;
function or(var_core_value_sigCFE7, var_core_value_sigECBC) {
  var_core_value_sigCFE7.getAllPermissionPoint().forEach((var_core_value_sig6A18, var_core_value_sig4E3D) => {
    var_core_value_sig6A18.subscribe(var_core_value_sigA621 => {
      Xn.has(var_core_value_sigA621.type) && "unitId" in var_core_value_sigA621 && var_core_value_sigA621.unitId === var_core_value_sigECBC && var_core_value_sigCFE7.deletePermissionPoint(var_core_value_sig4E3D);
    }).unsubscribe();
  });
}
;
function sr(var_core_value_sig65D2, var_core_value_sig4306, var_core_value_sigFCD3) {
  return ir(var_core_value_sig65D2, var_core_value_sig4306, var_core_value_sig4306, var_core_value_sig43E8.Edit) && Array.from(var_core_value_sigFCD3).every(var_core_value_sig49B0 => ir(var_core_value_sig65D2, var_core_value_sig4306, var_core_value_sig49B0, var_core_value_sig43E8.Edit));
}
const cr = {
    'type': var_core_value_sig3FB3.COMMAND,
    'id': "slide.command.set-permission",
    'handler'(var_core_value_sig147A, var_core_value_sig829F) {
      return !var_core_value_sig829F || !Yn.includes(var_core_value_sig829F.action) || var_core_value_sig829F.objectId !== var_core_value_sig829F.unitId && var_core_value_sig829F.action !== var_core_value_sig43E8.Edit ? false : (ar(var_core_value_sig147A.get(var_core_value_sigA0C0), var_core_value_sig829F.unitId, var_core_value_sig829F.objectId, var_core_value_sig829F.action, var_core_value_sig829F.value), true);
    }
  },
  lr = {
    ...
    'handler': (var_core_value_sig534C, var_core_value_sigABB7) => {
      let {
        ...
        var_core_value_sig917C = var_core_value_sig534C.get(var_core_value_sigF3C7).getUnit(var_core_value_sig9071, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  ur = {
    ...
    'handler': (var_core_value_sig10D7, var_core_value_sig5A1A) => {
      ...
      let var_core_value_sig77D2 = B(var_core_value_sig10D7.get(var_core_value_sigF3C7), var_core_value_sig5A1A);
      ...
      let var_core_value_sig2A21 = var_core_value_sig10D7.get(var_core_value_sig2616),
        var_core_value_sig0836 = var_core_value_sig10D7.get(var_core_value_sig06EA),
      ...
      return var_core_value_sig2A21.syncExecuteCommand(lr.id, var_core_value_sigD95C) ? (var_core_value_sig0836.pushUndoRedo({
        'unitID': var_core_value_sig6F04,
        'undoMutations': [{
          'id': lr.id,
...
function dr(var_core_value_sig3FAF) {
  return Array.isArray(var_core_value_sig3FAF) ? var_core_value_sig3FAF.map(var_core_value_sig2547 => dr(var_core_value_sig2547)) : !var_core_value_sig3FAF || typeof var_core_value_sig3FAF != "object" ? var_core_value_sig3FAF : Object.keys(var_core_value_sig3FAF).sort().reduce((var_core_value_sigBCA9, var_core_value_sig4CDF) => {
    let var_core_value_sig3F79 = var_core_value_sig3FAF[var_core_value_sig4CDF];
    return var_core_value_sig3F79 !== undefined && (var_core_value_sigBCA9[var_core_value_sig4CDF] = dr(var_core_value_sig3F79)), var_core_value_sigBCA9;
  }, {});
}
;
function fr(var_core_value_sig378B) {
  return JSON.stringify(dr(var_core_value_sig378B));
}
;
function pr(var_core_value_sigDE50) {
...
;
function mr(var_core_value_sig3094) {
  ...
  return pr(var_core_value_sig86CC.type) || delete var_core_value_sig86CC.direction, var_core_value_sig86CC;
}
;
function hr(var_core_value_sig7868, var_core_value_sig9921) {
  let var_core_value_sig59BF = mr(var_core_value_sig9921);
  if (!var_core_value_sig59BF) return;
  let var_core_value_sigF001 = var_core_value_sig7868.transitionRecords ?? {},
    var_core_value_sigE511 = fr(var_core_value_sig59BF),
    var_core_value_sig1C81 = Object.keys(var_core_value_sigF001).find(var_core_value_sig880E => fr(mr(var_core_value_sigF001[var_core_value_sig880E])) === var_core_value_sigE511);
  if (var_core_value_sig1C81) return var_core_value_sig1C81;
  let var_core_value_sig2C6A = "transition_" + var_core_value_sig524D(6);
...
;
function gr(var_core_value_sig7207, var_core_value_sig297F) {
  ...
  if (var_core_value_sigC22E) return mr((var_core_value_sig94D6 = var_core_value_sig7207.transitionRecords) == null ? undefined : var_core_value_sig94D6[var_core_value_sigC22E]);
}
;
function _r(var_core_value_sig2321) {
...
;
function vr(var_core_value_sig31F8, var_core_value_sig6905) {
...
const yr = {
    ...
    'handler': (var_core_value_sigC3C0, var_core_value_sig1F39) => {
      ...
      let var_core_value_sig9256 = var_core_value_sigC3C0.get(var_core_value_sigF3C7).getUnit(var_core_value_sig1F39.unitId, var_core_value_sig7CB9.UNIVER_SLIDE);
      return var_core_value_sig9256 ? (vr(var_core_value_sig9256.getSnapshot(), var_core_value_sig1F39), var_core_value_sig9256.timingSystem['loadFromDocument'](var_core_value_sig9256.getSnapshot()), true) : false;
    }
  },
  br = {
    ...
    'handler': (var_core_value_sig98A0, var_core_value_sig3EBD) => {
      ...
      let {
        ...
        var_core_value_sigB230 = var_core_value_sig98A0.get(var_core_value_sigF3C7).getUnit(var_core_value_sig1AC3, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sigB230) return false;
      let var_core_value_sig407E = xr(var_core_value_sigB230.getSnapshot(), var_core_value_sig66B8, var_core_value_sig4C7F, var_core_value_sig2543);
      if (!var_core_value_sig407E) return false;
      let var_core_value_sig88CB = var_core_value_sig98A0.get(var_core_value_sig2616),
        var_core_value_sigD615 = var_core_value_sig98A0.get(var_core_value_sig06EA),
        var_core_value_sigB708 = Sr(var_core_value_sigB230.getSnapshot()),
      ...
      return var_core_value_sig88CB.syncExecuteCommand(yr.id, var_core_value_sig60EF) ? (var_core_value_sigD615.pushUndoRedo({
        'unitID': var_core_value_sig1AC3,
        'redoMutations': [{
          'id': yr.id,
...
function xr(var_core_value_sigD6EA, var_core_value_sigA2D3, var_core_value_sig727A, var_core_value_sig6AF1) {
  ...
  let var_core_value_sig23B4 = {
    ...
    var_core_value_sig350C = mr(var_core_value_sig6AF1);
  if (!var_core_value_sig350C) {
    if (var_core_value_sig727A) return var_core_value_sig23B4.slideTransitionRefs = undefined, _r(var_core_value_sig23B4), Sr(var_core_value_sig23B4);
    let var_core_value_sig7D1B = {
      ...(var_core_value_sig23B4.slideTransitionRefs ?? {})
    };
    return var_core_value_sig3F6A.forEach(var_core_value_sigBBFF => delete var_core_value_sig7D1B[var_core_value_sigBBFF]), var_core_value_sig23B4.slideTransitionRefs = Object.keys(var_core_value_sig7D1B).length ? var_core_value_sig7D1B : undefined, _r(var_core_value_sig23B4), Sr(var_core_value_sig23B4);
  }
  let var_core_value_sig2335 = hr(var_core_value_sig23B4, var_core_value_sig350C);
  if (!var_core_value_sig2335) return null;
  if (var_core_value_sig727A) return var_core_value_sig23B4.slideTransitionRefs = var_core_value_sig3F6A.reduce((var_core_value_sig7BE0, var_core_value_sig7D40) => (var_core_value_sig7BE0[var_core_value_sig7D40] = var_core_value_sig2335, var_core_value_sig7BE0), {}), _r(var_core_value_sig23B4), Sr(var_core_value_sig23B4);
  ...
  }), var_core_value_sig23B4.slideTransitionRefs = var_core_value_sig6233, _r(var_core_value_sig23B4), Sr(var_core_value_sig23B4);
}
;
function Sr(var_core_value_sig4230) {
  return {
...
let Cr = function (var_core_value_sig6136) {
...
const wr = {
    ...
    'handler': (var_core_value_sigD25E, var_core_value_sigE1BC) => {
      let var_core_value_sigCF44 = var_core_value_sigD25E.get(P),
        var_core_value_sig3C97 = var_core_value_sigD25E.get(var_core_value_sigF3C7),
        {
        ...
        var_core_value_sigF35C = var_core_value_sig3C97.getUnit(var_core_value_sigAD56, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      switch (var_core_value_sigEE1A === 1 && var_core_value_sigEF8D.forEach(var_core_value_sig8889 => {
        ...
        case 0:
          var_core_value_sigEF8D.forEach(var_core_value_sig5B67 => {
            ...
            var_core_value_sig1758 && Mt(var_core_value_sigF35C, var_core_value_sig1758);
          }), var_core_value_sigCF44.addNotification(var_core_value_sig4107);
          break;
        case 1:
          var_core_value_sigE025.forEach(var_core_value_sig4805 => {
            Pt(var_core_value_sigF35C, var_core_value_sig4805);
        ...
        case 2:
          var_core_value_sigEF8D.forEach(var_core_value_sigE67E => {
            ...
            var_core_value_sig2902 && Nt(var_core_value_sigF35C, var_core_value_sig2902, var_core_value_sig2902.element, var_core_value_sig2902.transform);
  ...
  G = {
    ...
    'handler': (var_core_value_sigD549, var_core_value_sigC79E) => {
      ...
      let {
        ...
        var_core_value_sig7CF1 = var_core_value_sigD549.get(var_core_value_sigF3C7).getUnit(var_core_value_sig4686, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sig7CF1) return false;
      let var_core_value_sigA552 = var_core_value_sigD549.get(P),
      ...
      if (!var_core_value_sig35E2(var_core_value_sigD549, {
        'hostType': var_core_value_sig7CB9.UNIVER_SLIDE,
        'unitId': var_core_value_sig4686,
        'subUnitId': var_core_value_sig8E1C,
      ...
      let var_core_value_sigD0CC = {
        ...
        var_core_value_sigF347 = Tr(var_core_value_sigAE32.element, var_core_value_sig323C);
      if (var_core_value_sigBF8B || (Nt(var_core_value_sig7CF1, var_core_value_sigAE32, var_core_value_sig323C, var_core_value_sig015D), var_core_value_sigAE32.sourcePageType === 'slide' && !var_core_value_sigF347 && F(var_core_value_sigA552, var_core_value_sig7CF1, var_core_value_sig4686, var_core_value_sig8E1C))) return true;
      if (var_core_value_sigAE32.sourcePageType === "master" || var_core_value_sigAE32.sourcePageType === "layout") return I(var_core_value_sigA552, var_core_value_sig7CF1, var_core_value_sig4686, var_core_value_sig8E1C), true;
...
function Tr(var_core_value_sigEBFB, var_core_value_sigF3BF) {
  let {
  ...
  return var_core_value_sig7675(var_core_value_sig8E13, var_core_value_sig134E);
}
const Er = {
  ...
  'handler': (var_core_value_sigA3C0, var_core_value_sig723F) => {
    ...
    let var_core_value_sigD044 = var_core_value_sigA3C0.get(var_core_value_sig2616),
      var_core_value_sig9797 = var_core_value_sigA3C0.get(var_core_value_sig06EA),
      var_core_value_sig8533 = var_core_value_sigA3C0.get(P),
      {
    ...
    for (let var_core_value_sig68BE of var_core_value_sig57C5) {
      ...
      let var_core_value_sigE9A7 = var_core_value_sig2DAB ?? var_core_value_sig20C8.element,
        var_core_value_sigBECE = Or(var_core_value_sig20C8, var_core_value_sig2DAB, var_core_value_sig877E);
      if (kr(var_core_value_sig20C8.element, var_core_value_sigE9A7) && jr(var_core_value_sig20C8.transform, var_core_value_sigBECE)) continue;
    ...
    } = var_core_value_sigD044.hasCommand(wr.id) ? Dr(var_core_value_sig8533, var_core_value_sig0DE9) : {
      'redoMutations': var_core_value_sigB00D,
      'undoMutations': var_core_value_sig57C8
    };
    return var_core_value_sigC27D.length && var_core_value_sig6ACE(var_core_value_sigC27D, var_core_value_sigD044).result ? (var_core_value_sig9797.pushUndoRedo({
...
function Dr(var_core_value_sig7D59, var_core_value_sig5863) {
...
;
function Or(var_core_value_sig8F6A, var_core_value_sig46EA, var_core_value_sig626C) {
...
;
function kr(var_core_value_sig9077, var_core_value_sigC76C) {
  return JSON.stringify(Ar(var_core_value_sig9077)) === JSON.stringify(Ar(var_core_value_sigC76C));
}
;
function Ar(var_core_value_sigB23A) {
...
;
function jr(var_core_value_sig0512, var_core_value_sig4B2B) {
  return JSON.stringify(Mr(var_core_value_sig0512)) === JSON.stringify(Mr(var_core_value_sig4B2B));
}
;
function Mr(var_core_value_sigDF88) {
  return {
...
;
function Nr(var_core_value_sigDB93, var_core_value_sig67CF, var_core_value_sigCA96, var_core_value_sig6C5E) {
  let var_core_value_sig4997 = Tt(var_core_value_sig67CF, var_core_value_sig6C5E);
...
const Pr = {
    ...
    'handler': (var_core_value_sig7290, var_core_value_sigE835) => {
      ...
      let {
        ...
        var_core_value_sigA915 = var_core_value_sig7290.get(var_core_value_sigF3C7).getUnit(var_core_value_sigD79B, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      let var_core_value_sig4BE7 = var_core_value_sig7290.get(P),
  ...
  Fr = {
    ...
    'handler': (var_core_value_sig816E, var_core_value_sigE6F3) => {
      ...
      let {
        ...
        var_core_value_sig3BE6 = var_core_value_sig816E.get(var_core_value_sigF3C7).getUnit(var_core_value_sig4917, var_core_value_sig7CB9.UNIVER_SLIDE);
      if (!var_core_value_sig3BE6) return false;
      let var_core_value_sigA1C9 = var_core_value_sig816E.get(var_core_value_sig2616),
        var_core_value_sig77D6 = var_core_value_sig816E.get(var_core_value_sig06EA),
      ...
      return var_core_value_sig6ACE(var_core_value_sigE3CE, var_core_value_sigA1C9).result ? (var_core_value_sig77D6.pushUndoRedo({
        'unitID': var_core_value_sig4917,
  ...
  Ir = {
    ...
    'handler': (var_core_value_sig4493, var_core_value_sig8B9C) => {
      ...
      let var_core_value_sigA35B = var_core_value_sig4493.get(P).getDrawingByParam(var_core_value_sig8B9C);
      if (!var_core_value_sigA35B || var_core_value_sigA35B.sourcePageType !== "slide" || var_core_value_sigA35B.element['type'] !== "shape" || !var_core_value_sig20F6(var_core_value_sigA35B.element['shapeData'])) return false;
      let var_core_value_sig82DD = var_core_value_sigA35B.element['shapeData'].smartArt;
      try {
        for (let var_core_value_sig21D8 of var_core_value_sig8B9C.operations) var_core_value_sig82DD = var_core_value_sigC8B1(var_core_value_sig82DD, var_core_value_sig21D8);
      } catch {
        return false;
      }
      ...
      return var_core_value_sig6ACE(var_core_value_sigB86C, var_core_value_sig4493.get(var_core_value_sig2616)).result ? (var_core_value_sig4493.get(var_core_value_sig06EA).pushUndoRedo({
        'unitID': var_core_value_sig8B9C.unitId,
  ...
  Lr = {
    ...
    'handler': (var_core_value_sig6086, var_core_value_sigAED2) => {
      ...
      let var_core_value_sig39C7 = var_core_value_sig6086.get(P),
        var_core_value_sigA022 = var_core_value_sig6086.get(var_core_value_sigF3C7).getUnit(var_core_value_sigCDCD, var_core_value_sig7CB9.UNIVER_SLIDE);
      ...
      if (var_core_value_sig1EFE.forEach((var_core_value_sig5A75, var_core_value_sig7BAF) => {
        let var_core_value_sig8F69 = yt(var_core_value_sig5A75.element, var_core_value_sig913A),
          var_core_value_sig6884 = {
            ...var_core_value_sig5A75,
            'element': var_core_value_sig8F69
          };
        var_core_value_sig913A = [...var_core_value_sig913A, var_core_value_sig8F69], var_core_value_sig991D.push(var_core_value_sig6884), Mt(var_core_value_sigA022, var_core_value_sig6884, var_core_value_sig9904 === undefined ? undefined : var_core_value_sig9904 + var_core_value_sig7BAF);
      }), var_core_value_sig991D.every(var_core_value_sig066E => var_core_value_sig066E.sourcePageType === "slide" && var_core_value_sig066E.unitId === var_core_value_sigCDCD && var_core_value_sig066E.subUnitId === var_core_value_sig206A) && F(var_core_value_sig39C7, var_core_value_sigA022, var_core_value_sigCDCD, var_core_value_sig206A)) return true;
  ...
  Rr = {
    ...
    'type': var_core_value_sig3FB3.OPERATION,
    'handler': (var_core_value_sig1257, var_core_value_sig97E2) => {
      if (!var_core_value_sig97E2) return false;
      let var_core_value_sigBFA3 = var_core_value_sig1257.get(var_core_value_sigF3C7).getUnit(var_core_value_sig97E2.unitId, var_core_value_sig7CB9.UNIVER_SLIDE);
...
const zr = 'SLIDE_FONT_PLUGIN';
let Br = class extends var_core_value_sigF323 {
  constructor(var_core_value_sigC56D) {
    super(), W(this, "_resources", new Map()), this.disposeWithMe(var_core_value_sigC56D.registerPluginResource({
      'pluginName': zr,
      'businesses': [var_core_value_sig7CB9.UNIVER_SLIDE],
...
Br = q([K(0, var_core_value_sigAD4B)], Br);
const J = {
  'shapeWidth': 220,
  'shapeHeight': 120,
  'textBoxWidth': 260,
...
function Vr(var_core_value_sigFAFE = true) {
...
const Hr = {
    ...
    'shapeText': {
      'isHorizontal': true,
      'text': '',
      'autoFitType': var_core_value_sig1008.SpAutoFit,
      'textWrap': var_core_value_sigB9F4.None,
      'dataModel': {
        'doc': {
          ...
          'body': {
            ...
            'paragraphs': [{
              'startIndex': 0,
              'paragraphStyle': {
                'horizontalAlign': var_core_value_sig1D89.LEFT
              }
            }]
          },
          'documentStyle': {
            ...
            'renderConfig': {
              'horizontalAlign': var_core_value_sig1D89.LEFT,
              'verticalAlign': var_core_value_sigC1D8.TOP
            }
          }
        },
        'ha': var_core_value_sig1D89.LEFT,
        'va': var_core_value_sigC1D8.TOP
      }
    }
  },
  Ur = {
...
function Kr(var_core_value_sig2B86) {
  return (Ur[var_core_value_sig2B86] ?? []).map(var_core_value_sig3A17 => ({
    'key': var_core_value_sig3A17,
    'labelKey': "slides.placeholder.icon." + var_core_value_sig3A17
  }));
}
;
function qr(var_core_value_sig8873) {
  var var_core_value_sigB9C5;
  let var_core_value_sig511D = Wr[var_core_value_sig8873.type];
  if (!var_core_value_sig511D) return [];
  let var_core_value_sig1610 = ((var_core_value_sigB9C5 = var_core_value_sig8873.icons) != null && var_core_value_sigB9C5.length ? var_core_value_sig8873.icons : Kr(var_core_value_sig8873.type)).find(var_core_value_sig938F => var_core_value_sig938F.enabled !== false && var_core_value_sig938F.key === var_core_value_sig511D);
...
function Yr(var_core_value_sig23AB) {
  return Jr[var_core_value_sig23AB];
}
const Xr = 'UNIVER_EMBED_SLIDES_FLOATING',
  Zr = "UNIVER_EMBED_SLIDES_PAGE";
function Qr(var_core_value_sigA15D) {
  return {
    'version': 1,
...
;
function $r(var_core_value_sig7E90) {
  return {
    ...
    'elements': {},
    'custom': {
      [Zr]: Qr(var_core_value_sig7E90)
    }
  };
}
;
function ei(var_core_value_sig03F7) {
  return {
    ...
    'custom': {
      [Xr]: Qr(var_core_value_sig03F7)
    }
  };
}
;
function ti(var_core_value_sig756F) {
  var var_core_value_sig0DB11;
  let var_core_value_sig4950 = (var_core_value_sig0DB11 = var_core_value_sig756F.custom) == null ? undefined : var_core_value_sig0DB11[Zr];
  return ri(var_core_value_sig4950) ? var_core_value_sig4950 : undefined;
}
;
function ni(var_core_value_sig4424) {
  var var_core_value_sig57E8;
  let var_core_value_sig76B6 = (var_core_value_sig57E8 = var_core_value_sig4424.custom) == null ? undefined : var_core_value_sig57E8[Xr];
  return ri(var_core_value_sig76B6) ? var_core_value_sig76B6 : undefined;
}
;
function ri(var_core_value_sig89BC) {
...
var ii = '@univerjs-pro/slides',
  ai = "1.0.0-insiders.20260907-70fc579";
function oi(var_core_value_sig3B2E = var_core_value_sig524D(6), var_core_value_sig5A9A = var_core_value_sig39F2.EN_US, var_core_value_sigB524 = "Untitled Presentation") {
  let var_core_value_sig8CFB = Xe({
...
var si = class extends var_core_value_sigF323 {
    constructor(var_core_value_sigD948 = {}) {
      super(), W(this, "_data$", undefined), W(this, "data$", undefined), this._data$ = new var_core_value_sig6876(var_core_value_sigD948), this.data$ = this._data$["asObservable"]();
    }
    getData() {
  ...
  ci = class extends var_core_value_sigF323 {
    constructor(...var_core_value_sig26EC) {
      super(...var_core_value_sig26EC), W(this, "_transitions", new Map()), W(this, "_sequences", new Map()), W(this, "_changed$", new var_core_value_sig55FB()), W(this, "changed$", this._changed$['asObservable']());
    }
    ...
    loadFromDocument(var_core_value_sig18E0) {
      ...
      for (let var_core_value_sigEF3E of var_core_value_sig18E0.slideOrder) {
        ...
        let var_core_value_sigBC46 = gr(var_core_value_sig18E0, var_core_value_sigEF3E);
...
function li(var_core_value_sigB52C) {
...
;
function ui(var_core_value_sigA4B8, var_core_value_sigFF9C) {
...
;
function di(var_core_value_sig278D, var_core_value_sigC0FE, var_core_value_sigDD22) {
...
;
function pi(var_core_value_sig1019, var_core_value_sig32AB, var_core_value_sig72BE, var_core_value_sig3E4A) {
...
;
function mi(var_core_value_sig3171, var_core_value_sigEBC4) {
          ...
          'doc': var_core_value_sig01EF.dataModel["doc"] && {
            ...
            'body': var_core_value_sig3603 && var_core_value_sig7B39 >= 0 ? {
              ...
              'textRuns': (var_core_value_sig9A80 = var_core_value_sig3603.textRuns) == null ? undefined : var_core_value_sig9A80.map(var_core_value_sig1E1B => ({
                ...
                'st': pi(var_core_value_sig1E1B.st, var_core_value_sig7B39, var_core_value_sigDCAB, var_core_value_sigEBC4.length),
                'ed': pi(var_core_value_sig1E1B.ed, var_core_value_sig7B39, var_core_value_sigDCAB, var_core_value_sigEBC4.length)
              })),
              'paragraphs': (var_core_value_sig7C69 = var_core_value_sig3603.paragraphs) == null ? undefined : var_core_value_sig7C69.map(var_core_value_sig3B10 => ({
                ...
                'startIndex': pi(var_core_value_sig3B10.startIndex, var_core_value_sig7B39, var_core_value_sigDCAB, var_core_value_sigEBC4.length)
              }))
            } : var_core_value_sig3603
          }
        }
...
;
function hi(var_core_value_sigF569, var_core_value_sig2A9F, var_core_value_sigB14A) {
  let var_core_value_sig4401 = Rt(var_core_value_sigF569);
  if (!var_core_value_sig4401) return var_core_value_sigF569;
  let var_core_value_sig4D6A = li(var_core_value_sig4401.type);
  ...
  } : var_core_value_sig4401.type === 'slideNumber' && var_core_value_sigB14A ? mi(var_core_value_sigF569, var_core_value_sigB14A) : var_core_value_sigF569 : null;
}
;
function gi(var_core_value_sigCB8C) {
  let var_core_value_sigD217 = new Set();
  for (let var_core_value_sig89E6 of Object.values(var_core_value_sigCB8C)) {
    let var_core_value_sig9A0D = R(var_core_value_sig89E6);
    var_core_value_sig9A0D && var_core_value_sigD217.add(var_core_value_sig9A0D);
  }
  return var_core_value_sigD217;
}
;
function _i(var_core_value_sigEB0F, var_core_value_sigDC44) {
  if (var_core_value_sigEB0F) {
    ...
    if (var_core_value_sigEB0F.pageType === 'slide' && 'layoutPageId' in var_core_value_sigEB0F && var_core_value_sigEB0F.layoutPageId) {
      let var_core_value_sigA319 = _i(var_core_value_sigDC44.getLayoutPage(var_core_value_sigEB0F.layoutPageId), var_core_value_sigDC44);
      if (var_core_value_sigA319) return var_core_value_sigA319;
    }
    if ((var_core_value_sigEB0F.pageType === 'slide' || var_core_value_sigEB0F.pageType === "layout") && "masterPageId" in var_core_value_sigEB0F && var_core_value_sigEB0F.masterPageId) return _i(var_core_value_sigDC44.getMasterPage(var_core_value_sigEB0F.masterPageId), var_core_value_sigDC44);
  }
}
;
function vi(var_core_value_sigDEFC) {
  return var_core_value_sigDEFC.showMasterSp ?? true;
}
;
function yi(var_core_value_sigE842) {
  return U(var_core_value_sigE842) || !Rt(var_core_value_sigE842);
}
var bi = class extends var_core_value_sigF323 {
    ...
    resolveBackground() {
      return _i(this._data, this._ctx);
    }
    ...
    resolveElements() {
      let var_core_value_sig90C0 = this._data['masterPageId'] ? this._ctx['getMasterPage'](this._data['masterPageId']) : undefined,
        ...
        var_core_value_sigC2BB = var_core_value_sigF1B2 ? gi(var_core_value_sigF1B2.elements) : new Set(),
        var_core_value_sigD9DB = gi(this._data["elements"]),
        var_core_value_sigA363 = Bt(this._data),
        var_core_value_sigFBA5 = vi(this._data),
        var_core_value_sigAC47 = !var_core_value_sigF1B2 || vi(var_core_value_sigF1B2),
        var_core_value_sigA06F = var_core_value_sigFBA5 && var_core_value_sigAC47,
        var_core_value_sig770E = var_core_value_sigFBA5,
        var_core_value_sig4654 = di(this._data, var_core_value_sigF1B2, var_core_value_sig90C0),
        var_core_value_sigB26B = fi(this._data, this._ctx),
      ...
      if (var_core_value_sig90C0) for (let var_core_value_sigCFFA of var_core_value_sig90C0.elementOrder) {
        ...
        if (!var_core_value_sig8061 || Vt(var_core_value_sig8061, var_core_value_sigA363)) continue;
        let var_core_value_sig4D4C = hi(var_core_value_sig8061, var_core_value_sig4654, var_core_value_sigB26B);
        if (!var_core_value_sig4D4C || !var_core_value_sigFBA5 && yi(var_core_value_sig8061) || !var_core_value_sigA06F && U(var_core_value_sig8061)) continue;
        let var_core_value_sigC9E0 = R(var_core_value_sig8061);
      ...
      if (var_core_value_sigF1B2) for (let var_core_value_sig58C1 of var_core_value_sigF1B2.elementOrder) {
        ...
        if (!var_core_value_sig76BA || Vt(var_core_value_sig76BA, var_core_value_sigA363)) continue;
        let var_core_value_sigFBFA = hi(var_core_value_sig76BA, var_core_value_sig4654, var_core_value_sigB26B);
        if (!var_core_value_sigFBFA || !var_core_value_sigFBA5 && yi(var_core_value_sig76BA) || !var_core_value_sig770E && U(var_core_value_sig76BA)) continue;
        let var_core_value_sigF602 = R(var_core_value_sig76BA);
  ...
  xi = class extends var_core_value_sigF323 {
    constructor(var_core_value_sig5276) {
      super(), this._snapshot = var_core_value_sig5276, W(this, '_pages', new Map()), W(this, "_activeSlideId$", undefined), W(this, "_slideOrder$", undefined), W(this, "activeSlideId$", undefined), W(this, "slideOrder$", undefined);
      for (let var_core_value_sigC368 of var_core_value_sig5276.slideOrder) this._initPage(var_core_value_sigC368);
      this._activeSlideId$ = new var_core_value_sig6876(var_core_value_sig5276.activeSlideId ?? var_core_value_sig5276.slideOrder[0]), this._slideOrder$ = new var_core_value_sig6876([...var_core_value_sig5276.slideOrder]), this.activeSlideId$ = this._activeSlideId$["asObservable"](), this.slideOrder$ = this._slideOrder$["asObservable"]();
    }
    ...
    createSlide(var_core_value_sig44DD = {}, var_core_value_sig96FA) {
      let var_core_value_sigAB68 = var_core_value_sig44DD.id ?? var_core_value_sig524D(6),
    ...
    duplicateSlide(var_core_value_sig3A85) {
      ...
      return this.createSlide({
        ...
        'id': var_core_value_sig524D(6),
        'name': var_core_value_sig2682.name + '\x20(copy)',
        'elements': {
    ...
    _initPage(var_core_value_sig52CA) {
      ...
      if (!var_core_value_sigC030) throw Error('[SlidePageManager]\x20No\x20slide\x20data\x20found\x20for\x20id\x20\x22' + var_core_value_sig52CA + '\x22');
      let var_core_value_sig88F6 = new bi(var_core_value_sigC030, this, var_core_value_sigD65A => {
  ...
  Si = class extends var_core_value_sigF69D {
    constructor(var_core_value_sig37DB) {
      super(), W(this, 'type', var_core_value_sig7CB9.UNIVER_SLIDE), W(this, "_snapshot", undefined), W(this, "_name$", undefined), W(this, 'name$', undefined), W(this, '_zoomRatio$', undefined), W(this, "zoomRatio$", undefined), W(this, "pageManager", undefined), W(this, "theme", undefined), W(this, "timingSystem", undefined);
      let var_core_value_sig5542 = oi();
      this._snapshot = var_core_value_sig7F86.isEmptyObject(var_core_value_sig37DB) ? var_core_value_sig5542 : var_core_value_sig7F86.commonExtend(var_core_value_sig5542, var_core_value_sig37DB), (this._snapshot['id'] === undefined || this._snapshot['id'] === null || this._snapshot['id'] === '') && (this._snapshot['id'] = var_core_value_sig524D(6)), this._snapshot["activeSlideId"] && !this._snapshot["slides"][this._snapshot["activeSlideId"]] && (this._snapshot["activeSlideId"] = this._snapshot["slideOrder"][0]), kt(this._snapshot), this._name$ = new var_core_value_sig6876(this._snapshot["name"]), this.name$ = this._name$["asObservable"](), this._zoomRatio$ = new var_core_value_sig6876(this._snapshot["zoomRatio"] ?? 1), this.zoomRatio$ = this._zoomRatio$["asObservable"](), this.pageManager = new xi(this._snapshot), this.disposeWithMe(this.pageManager), this.theme = new si(this._snapshot['theme'] ?? O), this.disposeWithMe(this.theme), this.timingSystem = new ci(), this.disposeWithMe(this.timingSystem), this.timingSystem['loadFromDocument'](this._snapshot);
    }
    getUnitId() {
...
let Ci = class {
  constructor(var_core_value_sigEDC6, var_core_value_sig611A, var_core_value_sig6BD9) {
    this._commandService = var_core_value_sigEDC6, this._drawingService = var_core_value_sig611A, this._instanceService = var_core_value_sig6BD9, W(this, "hostType", var_core_value_sig7CB9.UNIVER_SLIDE);
  }
  get shapeChanged$() {
    return var_core_value_sigC865(this._drawingService["add$"], this._drawingService['update$'], this._drawingService["remove$"]).pipe(var_core_value_sig6788(var_core_value_sigF593 => [...new Set(var_core_value_sigF593.map(({
      unitId: var_core_value_sig480E
    }) => var_core_value_sig480E))]), var_core_value_sig2870(var_core_value_sig3607 => ({
  ...
  getShape(var_core_value_sig7E56) {
    ...
    return {
      ...
      'shapeType': var_core_value_sig1F18.shapeType ?? var_core_value_sig2D23.Rect,
      'shapeData': var_core_value_sig7F86.deepClone(var_core_value_sig1F18),
  ...
  listShapesInUnit(var_core_value_sig10AA) {
    let var_core_value_sigE6D0 = this._instanceService["getUnit"](var_core_value_sig10AA, var_core_value_sig7CB9.UNIVER_SLIDE);
  ...
  createShape(var_core_value_sig8E91, var_core_value_sig00BE) {
    let var_core_value_sig7BB5 = var_core_value_sig524D(6),
      var_core_value_sig6AAD = wi(var_core_value_sig00BE.transform),
      var_core_value_sig1157 = {
        ...var_core_value_sig7F86.deepClone(var_core_value_sig00BE.shapeData ?? var_core_value_sig60E6(var_core_value_sig00BE.shapeType)),
        'shapeType': var_core_value_sig00BE.shapeType
      },
      var_core_value_sigA694 = var_core_value_sig7A6B(var_core_value_sig00BE.shapeType) ? {
  ...
  updateShape(var_core_value_sig18E01, var_core_value_sig0428) {
    ...
    if (var_core_value_sig0428.smartArtOperations) return this._commandService["syncExecuteCommand"](Ir.id, {
    ...
    return this._commandService["syncExecuteCommand"](Er.id, {
      'patches': [{
        'unitId': var_core_value_sig18E01.unitId,
        'subUnitId': var_core_value_sig18E01.subUnitId,
        'drawingId': var_core_value_sig18E01.shapeId,
  ...
  convertSmartArtToShapes(var_core_value_sig48EA) {
    ...
    if (!var_core_value_sig5E16 || var_core_value_sig5E16.shapeType !== var_core_value_sig2D23.SmartArt || !('smartArt' in var_core_value_sig5E16.shapeData)) return null;
    let var_core_value_sig09F3 = var_core_value_sig5E16.shapeData["smartArt"].presentationShapeOrder['map'](() => var_core_value_sig524D(6));
    if (var_core_value_sig09F3.length === 0) return null;
    let var_core_value_sig4592 = var_core_value_sig09F3.length > 1 ? var_core_value_sig524D(6) : undefined;
  ...
  createFormulaLastValueMutation(var_core_value_sigC5C4, var_core_value_sig1617, var_core_value_sig4169) {
    ...
    let var_core_value_sigCAF7 = {
        ...
        'formulaBinding': {
          ...
          'lastValue': var_core_value_sig7F86.deepClone(var_core_value_sig4169)
        }
      },
  ...
  bringToFront(var_core_value_sig2CD3) {
    return this._arrange(var_core_value_sig2CD3, var_core_value_sig5EBB.front);
  }
  bringForward(var_core_value_sig038E) {
    return this._arrange(var_core_value_sig038E, var_core_value_sig5EBB.forward);
  }
  sendBackward(var_core_value_sigAA1E) {
    return this._arrange(var_core_value_sigAA1E, var_core_value_sig5EBB.backward);
  }
  sendToBack(var_core_value_sigC9F5) {
    return this._arrange(var_core_value_sigC9F5, var_core_value_sig5EBB.back);
  }
  ...
  _arrange(var_core_value_sig4A7C, var_core_value_sigF975) {
    ...
    return var_core_value_sigA298 < 0 ? false : this._reorder(var_core_value_sig4A7C, var_core_value_sigCDAF, var_core_value_sigD7F4(var_core_value_sigA298, var_core_value_sigCDAF.length, var_core_value_sigF975));
  }
  _reorder(var_core_value_sig0B40, var_core_value_sig330B, var_core_value_sig3625) {
    ...
    return var_core_value_sig0B4E < 0 ? false : (var_core_value_sig330B.splice(var_core_value_sig0B4E, 1), var_core_value_sig330B.splice(var_core_value_sig933D(var_core_value_sig3625, var_core_value_sig330B.length + 1), 0, var_core_value_sig0B40.shapeId), this._commandService['syncExecuteCommand'](mn.id, {
...
Ci = q([K(0, var_core_value_sig2616), K(1, P), K(2, var_core_value_sigF3C7)], Ci);
function wi(var_core_value_sigA77A) {
  return {
...
const Ti = {};
let Ei = class extends var_core_value_sigF323 {
  ...
  _initUnitListener() {
    this._instanceSrv["getAllUnitsForType"](var_core_value_sig7CB9.UNIVER_SLIDE).forEach(var_core_value_sigF4C5 => this._loadUnit(var_core_value_sigF4C5)), this.disposeWithMe(this._instanceSrv["getTypeOfUnitAdded$"](var_core_value_sig7CB9.UNIVER_SLIDE).subscribe(var_core_value_sig5410 => this._loadUnit(var_core_value_sig5410.unit))), this.disposeWithMe(this._instanceSrv["getTypeOfUnitDisposed$"](var_core_value_sig7CB9.UNIVER_SLIDE).subscribe(var_core_value_sig492F => {
  ...
  _loadUnit(var_core_value_sig4A83) {
    ...
    for (let var_core_value_sig8EA0 of var_core_value_sigB6F7) {
      let var_core_value_sig26DB = var_core_value_sig8EA0.getId(),
        ...
        } = Ct(var_core_value_sig4A83, var_core_value_sig8EA0);
...
Ei = q([K(0, var_core_value_sigF3C7), K(1, P)], Ei);
const Di = new Set([cr.id, gn.id, hn.id]);
let Oi = class extends var_core_value_sigF323 {
  constructor(var_core_value_sigB495, var_core_value_sig70D0, var_core_value_sig2A8A) {
    super(), this._commandService = var_core_value_sigB495, this._permissionService = var_core_value_sig70D0, this._univerInstanceService = var_core_value_sig2A8A, this._univerInstanceService["getAllUnitsForType"](var_core_value_sig7CB9.UNIVER_SLIDE).forEach(var_core_value_sigA6F6 => this._registerUnitPermissionPoints(var_core_value_sigA6F6.getUnitId())), this.disposeWithMe(this._univerInstanceService["getTypeOfUnitAdded$"](var_core_value_sig7CB9.UNIVER_SLIDE).subscribe(({
      unit: var_core_value_sigCDDA
    }) => this._registerUnitPermissionPoints(var_core_value_sigCDDA.getUnitId()))), this.disposeWithMe(this._commandService["beforeCommandExecuted"]((var_core_value_sigE243, var_core_value_sig74A8) => this._check(var_core_value_sigE243, var_core_value_sig74A8))), this.disposeWithMe(this._univerInstanceService["getTypeOfUnitDisposed$"](var_core_value_sig7CB9.UNIVER_SLIDE).subscribe(var_core_value_sig21B2 => or(this._permissionService, var_core_value_sig21B2.getUnitId())));
  }
  _registerUnitPermissionPoints(var_core_value_sig3782) {
    Yn.forEach(var_core_value_sigDE08 => {
      let var_core_value_sigACCB = rr(var_core_value_sig3782, var_core_value_sig3782, var_core_value_sigDE08);
  ...
  _check(var_core_value_sigD22E, var_core_value_sig3455) {
    ...
    let var_core_value_sig1395 = Ai(var_core_value_sigD22E.id, var_core_value_sig43D5),
      var_core_value_sig9FA0 = ki(var_core_value_sig3455),
      var_core_value_sig055E = (var_core_value_sig43D5 ? X(var_core_value_sig43D5, "unitId") : undefined) ?? var_core_value_sig9FA0 ?? (var_core_value_sig1395 ? (var_core_value_sig5CEF = this._univerInstanceService["getCurrentUnitOfType"](var_core_value_sig7CB9.UNIVER_SLIDE)) == null ? undefined : var_core_value_sig5CEF.getUnitId() : undefined);
    if (!var_core_value_sig055E || this._univerInstanceService["getUnitType"](var_core_value_sig055E) !== var_core_value_sig7CB9.UNIVER_SLIDE) return;
    if (var_core_value_sig1395) {
      if (!ir(this._permissionService, var_core_value_sig055E, var_core_value_sig055E, var_core_value_sig1395)) throw new var_core_value_sig0214("Presentation " + var_core_value_sig43E8[var_core_value_sig1395] + '\x20permission\x20denied.');
      if (var_core_value_sigD22E.id === "slide.operation.cut-selection" && !ir(this._permissionService, var_core_value_sig055E, var_core_value_sig055E, var_core_value_sig43E8.Edit)) throw new var_core_value_sig0214("Presentation Edit permission denied.");
      return;
    }
    if (Di.has(var_core_value_sigD22E.id) || !var_core_value_sigD22E.id["startsWith"]("slide.command.") && !var_core_value_sigD22E.id['startsWith']('slide.mutation.')) return;
    let var_core_value_sig7C77 = this._univerInstanceService["getUnit"](var_core_value_sig055E, var_core_value_sig7CB9.UNIVER_SLIDE);
    if (!var_core_value_sig7C77 || !sr(this._permissionService, var_core_value_sig055E, ji(var_core_value_sig7C77, var_core_value_sig43D5 ?? {}, var_core_value_sigD22E.id))) throw new var_core_value_sig0214("Presentation edit permission denied.");
  }
};
Oi = q([K(0, var_core_value_sig2616), K(1, var_core_value_sigA0C0), K(2, var_core_value_sigF3C7)], Oi);
function ki(var_core_value_sig0701) {
...
;
function Ai(var_core_value_sig5DCA, var_core_value_sigF1AB) {
  if (var_core_value_sig5DCA === "slide.operation.copy-selection" || var_core_value_sig5DCA === "slide.operation.cut-selection" || var_core_value_sig5DCA === "slide.operation.slide-table-copy-table") return var_core_value_sig43E8.Copy;
  if (var_core_value_sig5DCA === "slide-table.operation.keyboard") {
    if ((var_core_value_sigF1AB == null ? undefined : var_core_value_sigF1AB.action) === "copy-cells") return var_core_value_sig43E8.Copy;
    if ((var_core_value_sigF1AB == null ? undefined : var_core_value_sigF1AB.action) === 'edit-cell' || (var_core_value_sigF1AB == null ? undefined : var_core_value_sigF1AB.action) === "clear-cells" || (var_core_value_sigF1AB == null ? undefined : var_core_value_sigF1AB.action) === 'paste-cells') return var_core_value_sig43E8.Edit;
  }
  if (var_core_value_sig5DCA === "slide.operation.print") return var_core_value_sig43E8.Print;
  if (var_core_value_sig5DCA === "slides-exchange-client.operation.export-slide") return var_core_value_sig43E8.Export;
  if (var_core_value_sig5DCA.startsWith("thread-comment.command.") || var_core_value_sig5DCA.startsWith("thread-comment.mutation.") || var_core_value_sig5DCA === "slide.operation.start-comment-placement" || var_core_value_sig5DCA === "slide.operation.add-element-comment") return var_core_value_sig43E8.Comment;
}
;
function ji(var_core_value_sig902F, var_core_value_sig6BD7, var_core_value_sig63E0) {
  ...
  Ii(var_core_value_sig6BD7, "masterPageIds").forEach(var_core_value_sigA2D31 => var_core_value_sig4836.add(var_core_value_sigA2D31));
  ...
  let var_core_value_sig7C26 = Li(var_core_value_sig6BD7.sourcePageType) ? var_core_value_sig6BD7.sourcePageType : undefined;
  for (let var_core_value_sig3D8E of var_core_value_sig4836) {
    let var_core_value_sig7F33 = var_core_value_sig7C26 ?? Pi(var_core_value_sig902F, var_core_value_sig3D8E);
    var_core_value_sig7F33 === "master" || var_core_value_sig7F33 === "layout" ? var_core_value_sig1B87.add($n) : var_core_value_sig7F33 === 'slide' && var_core_value_sig1B87.add(er(var_core_value_sig3D8E));
  }
  ...
  if (var_core_value_sig544E) {
    let var_core_value_sigD37B = var_core_value_sig7C26 ?? Pi(var_core_value_sig902F, var_core_value_sig544E) ?? "slide";
    ...
    Ni(var_core_value_sig902F, var_core_value_sig544E, var_core_value_sigD37B, var_core_value_sigBC59, var_core_value_sig1B87);
  } else var_core_value_sigBC59.size && Mi(var_core_value_sig902F, var_core_value_sigFA28 => var_core_value_sigBC59.has(var_core_value_sigFA28.id), var_core_value_sig1B87);
  ...
  var_core_value_sigCE8A.size && Mi(var_core_value_sig902F, var_core_value_sig2712 => var_core_value_sigCE8A.has(String(var_core_value_sig2712.chartId ?? '')) || var_core_value_sigCE8A.has(String(var_core_value_sig2712.tableId ?? '')) || var_core_value_sigCE8A.has(String(var_core_value_sig2712.smartArtId ?? '')), var_core_value_sig1B87);
  ...
  if (var_core_value_sig0718 && var_core_value_sig1B221) {
    let var_core_value_sig0B9E = Li(var_core_value_sig0718.pageType) ? var_core_value_sig0718.pageType : 'slide';
    var_core_value_sig1B87.add(var_core_value_sig0B9E === "slide" ? er(var_core_value_sig1B221) : $n);
    ...
    Object.keys(var_core_value_sigC545).forEach(var_core_value_sigEA04 => {
      var_core_value_sig1B87.add(tr(var_core_value_sig0B9E, var_core_value_sig1B221, var_core_value_sigEA04));
    });
  }
  return [...var_core_value_sig1B87];
}
;
function Mi(var_core_value_sig8854, var_core_value_sig5275, var_core_value_sig4F9D) {
    ...
    var_core_value_sig2921 = (var_core_value_sig12A7, var_core_value_sig6F4E) => {
      Object.entries(var_core_value_sig12A7 ?? {}).forEach(([var_core_value_sig7A62, var_core_value_sig8109]) => {
        ...
        Object.values(var_core_value_sig8109.elements ?? {}).forEach(var_core_value_sig4383 => {
          !Fi(var_core_value_sig4383) || !var_core_value_sig5275(var_core_value_sig4383) || var_core_value_sig7565.add(var_core_value_sig4383.id);
        }), Ni(var_core_value_sig8854, var_core_value_sig7A62, var_core_value_sig6F4E, var_core_value_sig7565, var_core_value_sig4F9D);
      });
    };
...
;
function Ni(var_core_value_sig3959, var_core_value_sig926F, var_core_value_sig9414, var_core_value_sig32E7, var_core_value_sigD8C3) {
  ...
  }), var_core_value_sigD8C3.add(var_core_value_sig9414 === "slide" ? er(var_core_value_sig926F) : $n), var_core_value_sig04F2.forEach(var_core_value_sigE837 => var_core_value_sigD8C3.add(tr(var_core_value_sig9414, var_core_value_sig926F, var_core_value_sigE837)));
}
;
function Pi(var_core_value_sig4935, var_core_value_sig1832) {
...
;
function Fi(var_core_value_sig9CF2) {
...
;
function Ii(var_core_value_sig62231, var_core_value_sig7653) {
...
;
function Li(var_core_value_sig4A94) {
  return Object.values(Pe).some(var_core_value_sigA45D => var_core_value_sigA45D === var_core_value_sig4A94);
}
let Ri = class extends var_core_value_sigF323 {
...
Ri = q([K(0, var_core_value_sig5633(var_core_value_sigD545)), K(1, var_core_value_sig5633(Ci))], Ri);
let Z = class extends var_core_value_sig1722 {
  constructor(var_core_value_sigCC9E = Ti, var_core_value_sig444C, var_core_value_sigE42E, var_core_value_sigF039, var_core_value_sigA321) {
    ...
    } = var_core_value_sig7B87({}, Ti, this._config);
    this._configService["setConfig"]("slides.config", var_core_value_sigBF4C);
  }
  onStarting() {
    this._univerInstanceService["registerCtorForType"](var_core_value_sig7CB9.UNIVER_SLIDE, Si), [[P, {
      'useClass': gt
    }], [Ei], [Br], [Ci], [Ri], [Oi]].forEach(var_core_value_sigDF87 => this._injector['add'](var_core_value_sigDF87)), [L, Lr, z, hn, G, wr, Xt, Zt, pn, Dn, In, an, lr, yr, Tn, V, wn, H, nn, Pr, Ut, un, gn, En, On, cr, Ln, ur, br, Er, Ir, Fr, mn, Wt, dn, rn, tn, Qt, Rr].forEach(var_core_value_sig9EE0 => this.disposeWithMe(this._commandService["registerCommand"](var_core_value_sig9EE0))), this._injector["get"](Ri), this._injector["get"](Ei), this._injector["get"](Br), this._injector["get"](Oi);
  }
};
W(Z, 'pluginName', 'UNIVER_SLIDES_PLUGIN'), W(Z, "packageName", ii), W(Z, "version", ai), W(Z, 'type', var_core_value_sig7CB9.UNIVER_SLIDE), Z = q([var_core_value_sig5153(var_core_value_sig7B1F, var_core_value_sigF2E0), K(1, var_core_value_sig5633(var_core_value_sig2492)), K(2, var_core_value_sig2616), K(3, var_core_value_sig97EF), K(4, var_core_value_sigF3C7)], Z);
const zi = {
  'dk1': '#000000',
  'dk2': "#44546a",
  'lt1': "#ffffff",
...
function Q(var_core_value_sigEB59, var_core_value_sigD9B0) {
  ...
  return (var_core_value_sigEB59 == null || (var_core_value_sigB7D6 = var_core_value_sigEB59.colorScheme) == null ? undefined : var_core_value_sigB7D6[var_core_value_sigD9B0]) ?? zi[var_core_value_sigD9B0];
}
;
function Bi(var_core_value_sigCF1F) {
...
;
function Vi(var_core_value_sig4DD1) {
...
;
function Hi(var_core_value_sig1293) {
  ...
  let var_core_value_sig8270 = Q(var_core_value_sig1293, "acc1"),
    ...
    var_core_value_sig0413 = Bi(var_core_value_sig1293 == null || (var_core_value_sigC999 = var_core_value_sig1293.fmtScheme) == null ? undefined : var_core_value_sigC999.fillStyleLst[1]) ?? var_core_value_sig8270,
    var_core_value_sig15B6 = Vi(var_core_value_sig1293 == null || (var_core_value_sig9D8F = var_core_value_sig1293.fmtScheme) == null ? undefined : var_core_value_sig9D8F.lnStyleLst[1]) ?? Q(var_core_value_sig1293, "dk2");
  return {
...
function Wi(var_core_value_sigFEBF) {
  ...
  let var_core_value_sigC9A1 = var_core_value_sigBBA2[Ui];
...
;
function Gi(var_core_value_sigA499, var_core_value_sig4CC3) {
  ...
  return var_core_value_sig70B3[Ui] = var_core_value_sig4CC3, {
...
function Ji(var_core_value_sig422B) {
...
function $(var_core_value_sigFC9B, var_core_value_sig943E = {}) {
  let var_core_value_sigEF36 = ea(var_core_value_sigFC9B).split('\x0a'),
    ...
    var_core_value_sigA723 = (var_core_value_sigBABA == null ? undefined : var_core_value_sigBABA.listId) ?? (var_core_value_sig943E.id ?? Ki) + '-list',
    ...
    var_core_value_sigF909 = var_core_value_sigEF36.map(var_core_value_sig1BC4 => {
      let var_core_value_sig9EAB = {
        ...
        'paragraphId': var_core_value_sigCD15(var_core_value_sig991C),
  ...
  return {
    'id': var_core_value_sig943E.id ?? Ki,
    'body': {
...
;
function Yi(var_core_value_sigF2A0) {
...
;
function Xi(var_core_value_sigAF94, var_core_value_sig1E9F = {}) {
  if (var_core_value_sigAF94.type === "text") return $i(var_core_value_sigAF94.textData) ?? $(var_core_value_sigAF94.text ?? '', {
    'id': var_core_value_sigAF94.id,
    'textStyle': na(var_core_value_sigAF94.textStyle)
  });
  if (var_core_value_sigAF94.type === "shape") {
    var var_core_value_sig3CC6;
    let var_core_value_sigA5C3 = var_core_value_sigAEE0(var_core_value_sigAF94.shapeData["shapeText"]);
    if (var_core_value_sigA5C3 != null && (var_core_value_sig3CC6 = var_core_value_sigA5C3.dataModel) != null && var_core_value_sig3CC6.doc) return var_core_value_sig7F86.deepClone(var_core_value_sigA5C3.dataModel["doc"]);
    let var_core_value_sig3A1E = it(var_core_value_sig1E9F.themeData);
    return $(var_core_value_sig3A1E.text ?? '', {
      'id': var_core_value_sigAF94.id,
      'textStyle': na(var_core_value_sig3A1E),
      'horizontalAlign': var_core_value_sig1D89.CENTER,
      'verticalAlign': var_core_value_sigC1D8.MIDDLE
    });
  }
...
;
function Zi(var_core_value_sig3610, var_core_value_sig62F3) {
  let var_core_value_sig8063 = var_core_value_sig7F86.deepClone(var_core_value_sig62F3),
    var_core_value_sig555A = Yi(var_core_value_sig8063);
  ...
  if (var_core_value_sig3610.type === 'shape') {
    let var_core_value_sig3515 = var_core_value_sig9214(var_core_value_sigAEE0(var_core_value_sig3610.shapeData['shapeText']) ?? undefined, var_core_value_sig8063);
    return {
      ...var_core_value_sig3610,
      'shapeData': {
...
;
function Qi(var_core_value_sigF562, var_core_value_sig5913, var_core_value_sigA1AF) {
  return Zi(var_core_value_sigF562, $(var_core_value_sig5913, ta(var_core_value_sigF562, var_core_value_sigA1AF)));
}
;
function $i(var_core_value_sig6324) {
  return var_core_value_sig6324 ? var_core_value_sig7F86.deepClone(var_core_value_sig6324) : null;
}
;
function ea(var_core_value_sig7EE4) {
  return var_core_value_sig7EE4.replace(/\r\n/g, '\x0a').replace(/\r/g, '\x0a');
}
;
function ta(var_core_value_sigE3D7, var_core_value_sig54C6 = {}) {
  if (var_core_value_sigE3D7.type === "text") {
    ...
    return {
      ...
      'textStyle': var_core_value_sig54C6.textStyle ?? ((var_core_value_sig2EB2 = var_core_value_sigE3D7.textData) == null || (var_core_value_sig2EB2 = var_core_value_sig2EB2.documentStyle) == null ? undefined : var_core_value_sig2EB2.textStyle) ?? na(var_core_value_sigE3D7.textStyle),
  ...
  if (var_core_value_sigE3D7.type === 'shape') {
    ...
    let var_core_value_sig7C65 = var_core_value_sigAEE0(var_core_value_sigE3D7.shapeData["shapeText"]),
...
;
function na(var_core_value_sig50D0) {
  if (var_core_value_sig50D0) return {
    ...
    ...(var_core_value_sig50D0.bold === undefined ? {} : {
      'bl': var_core_value_sig50D0.bold ? var_core_value_sig5E99.TRUE : var_core_value_sig5E99.FALSE
    }),
    ...(var_core_value_sig50D0.italic === undefined ? {} : {
      'it': var_core_value_sig50D0.italic ? var_core_value_sig5E99.TRUE : var_core_value_sig5E99.FALSE
    }),
    ...(var_core_value_sig50D0.underline === undefined ? {} : {
      'ul': {
        's': var_core_value_sig50D0.underline ? var_core_value_sig5E99.TRUE : var_core_value_sig5E99.FALSE
      }
    })
  };
}
export { Ut as AddSlideElementCommand, L as AddSlideElementMutation, Wt as AddSlidePageCommand, V as AddSlidePageMutation, Zt as CancelSlideGroupMutation, Qt as ConvertSlideSmartArtToShapesCommand, tn as CreateSlideByLayoutCommand, Ye as DEFAULT_LAYOUT_ORDER, qe as DEFAULT_MASTER_PAGE, k as DEFAULT_MASTER_PAGE_ID, We as DEFAULT_SLIDE_PAGE_HEIGHT, Ue as DEFAULT_SLIDE_PAGE_WIDTH, O as DEFAULT_SLIDE_THEME, Xr as EMBED_SLIDES_FLOATING_CUSTOM_KEY, wn as EnsureSlideMasterPageMutation, P as ISlideDrawingService, Lr as InsertDrawingObjectMutation, j as LAYOUT_PAGE_IDS, rn as MoveSlidePageCommand, nn as MoveSlidePageMutation, Me as PageElementTypeEnum, Pe as PageTypeEnum, je as PlaceholderTypeEnum, un as RemoveSlideElementCommand, z as RemoveSlideElementMutation, dn as RemoveSlidePageCommand, H as RemoveSlidePageMutation, mn as ReorderSlideElementsCommand, zr as SLIDE_FONT_PLUGIN_NAME, J as SLIDE_INSERT_DEFAULT_SIZE, $n as SLIDE_MASTER_VIEW_PERMISSION_OBJECT_ID, Gr as SLIDE_PLACEHOLDER_ICON_COMPONENT_NAME_BY_KEY, Hr as SLIDE_TEXT_BOX_DEFAULT_STYLE, Ve as SLIDE_THEME_PRESETS, Yn as SLIDE_UNIT_PERMISSION_ACTIONS, gn as SetActiveSlideCommand, En as SetPresentationBackgroundGraphicsCommand, wr as SetSlideDrawingApplyMutation, pn as SetSlideElementOrderMutation, Xt as SetSlideGroupMutation, On as SetSlideNameCommand, Ln as SetSlidePageSizeCommand, In as SetSlidePageSizeMutation, cr as SetSlidePermissionCommand, ur as SetSlideSpeakerNotesCommand, lr as SetSlideSpeakerNotesMutation, br as SetSlideTransitionCommand, Rr as SetSlideZoomRatioOperation, Ne as SlideBackgroundTypeEnum, Cr as SlideDrawingApplyType, Br as SlideFontResourceController, Si as SlideModel, bi as SlidePage, Fe as SlidePageLayoutTypeEnum, Ie as SlidePageSizePresetEnum, _n as SlidePresentationBackgroundGraphicFitEnum, vn as SlidePresentationBackgroundGraphicsTargetEnum, Be as SlideSceneTypeEnum, Re as SlideTransitionDirectionEnum, ze as SlideTransitionSpeedEnum, Le as SlideTransitionTypeEnum, Z as UniverSlidesPlugin, Er as UpdateSlideDrawingCommand, G as UpdateSlideElementMutation, Fr as UpdateSlidePageBackgroundCommand, Pr as UpdateSlidePageBackgroundMutation, Ir as UpdateSlideSmartArtCommand, Qi as applySlideElementPlainText, Zi as applySlideElementTextDocument, Ze as buildDefaultSlideDocumentLayers, Ct as buildResolvedSlideDrawingMap, sr as canEditSlideTargets, Qr as createEmbedSlidesCustomData, ei as createEmbedSlidesFloatingElement, $r as createEmbedSlidesPage, Xe as createSlideByLayout, ni as getEmbedSlidesFloatingCustomData, ti as getEmbedSlidesPageCustomData, oi as getEmptySnapshot, oi as getSlidesEmptySnapshot, Wi as getPlaceholderImageContent, Sn as getPresentationBackgroundGraphics, B as getSlideCommandTarget, vt as getSlideElementDisplayName, nr as getSlideElementEditPermissionObjectIds, tr as getSlideElementPermissionObjectId, er as getSlidePagePermissionObjectId, ir as getSlidePermissionValue, He as getSlideThemePreset, U as isPresentationBackgroundGraphic, Ji as normalizeSlideDocumentDataStream, $ as plainTextToSlideDocumentData, Yr as resolveDefaultPlaceholderTextKey, qr as resolvePlaceholderActionIcons, Cn as resolvePresentationBackgroundTargetMasterIds, Xi as resolveSlideElementTextDocument, St as resolveSlideLayerPageSizeOptions, Vr as resolveSlideTextBoxDefaultSize, Hi as resolveSlideThemePreviewColors, gr as resolveSlideTransition, it as resolveThemeDefaultShapeText, mt as resolvedSlideLayersToDrawingMap, Gi as setPlaceholderImageContent, ar as setSlidePermissionValue, Yi as slideDocumentDataToPlainText, N as slideElementToDrawing };
