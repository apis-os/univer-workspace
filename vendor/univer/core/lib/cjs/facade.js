...
var FEnum = class FEnum {
	...
	*/
	get NamedStyleType() {
		return _univerjs_core.NamedStyleType;
	}
	/**
	...
	*/
	get SpacingRule() {
		return _univerjs_core.SpacingRule;
	}
	/**
	...
	*/
	get NumberUnitType() {
		return _univerjs_core.NumberUnitType;
	}
	/**
	...
	*/
	get PresetListType() {
		return _univerjs_core.PresetListType;
	}
	/**
...
let FUniver = _FUniver = class FUniver extends _univerjs_core.Disposable {
	...
	*/
	static extend(source) {
		Object.getOwnPropertyNames(source.prototype).forEach((name) => {
			...
			} else if (name !== "constructor") Reflect.set(this.prototype, name, Reflect.get(source.prototype, name));
		});
		Object.getOwnPropertyNames(source).forEach((name) => {
			if (name !== "prototype" && name !== "name" && name !== "length") Reflect.set(this, name, Reflect.get(source, name));
		});
	}
	constructor(_injector, _commandService, _univerInstanceService, _lifecycleService) {
		...
		if (initializers) initializers.forEach((fn) => {
	...
	*/
	setTheme(theme) {
		this._injector.get(_univerjs_core.ThemeService).setTheme(theme);
	}
	/**
	...
	*/
	getCurrentTheme() {
		return this._injector.get(_univerjs_core.ThemeService).getCurrentTheme();
	}
	/**
	...
	*/
	isDarkMode() {
		return this._injector.get(_univerjs_core.ThemeService).darkMode;
	}
	/**
	...
	*/
	setRegion(region) {
		this._injector.get(_univerjs_core.RegionService).setRegion(region);
	}
	/**
	...
	*/
	getCurrentRegion() {
		return this._injector.get(_univerjs_core.RegionService).getCurrentRegion();
	}
	/**
	...
	*/
	setDirection(direction) {
		this._injector.get(_univerjs_core.LocaleService).setDirection(direction);
	}
	/**
	...
	*/
	newRichText() {
		return _univerjs_core.RichTextBuilder.create();
	}
	/**
