...
let FUniver = _FUniver = class FUniver extends Disposable {
	...
	*/
	setTheme(theme) {
		this._injector.get(ThemeService).setTheme(theme);
	}
	/**
	...
	*/
	getCurrentTheme() {
		return this._injector.get(ThemeService).getCurrentTheme();
	}
	/**
	...
	*/
	isDarkMode() {
		return this._injector.get(ThemeService).darkMode;
	}
	/**
	...
	*/
	getCurrentRegion() {
		return this._injector.get(RegionService).getCurrentRegion();
	}
	/**
	...
	*/
	setDirection(direction) {
		this._injector.get(LocaleService).setDirection(direction);
	}
	/**
