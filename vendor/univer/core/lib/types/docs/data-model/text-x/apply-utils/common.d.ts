 ...
 */
import type { ICustomBlock, ICustomColumnGroup, ICustomDecoration, ICustomRange, ICustomTable, IDocumentBlockRange, IDocumentBody, IDocxExportExcludedRange, IDocxRawBlock, IParagraph, ISectionBreak, ITextRun } from '../../../../types/interfaces';
...
export declare function insertDocxRawCustomBlocks(body: IDocumentBody, insertBody: IDocumentBody, textLength: number, currentIndex: number): void;
export declare function insertDocxRawBlocks(body: IDocumentBody, insertBody: IDocumentBody, textLength: number, currentIndex: number): void;
export declare function insertDocxExportExcludedRanges(body: IDocumentBody, insertBody: IDocumentBody, textLength: number, currentIndex: number): void;
...
export declare function deleteCustomBlocks(body: IDocumentBody, textLength: number, currentIndex: number): ICustomBlock[] | undefined;
export declare function deleteDocxRawCustomBlocks(body: IDocumentBody, textLength: number, currentIndex: number): ICustomBlock[] | undefined;
export declare function deleteDocxRawBlocks(body: IDocumentBody, textLength: number, currentIndex: number): IDocxRawBlock[] | undefined;
export declare function deleteDocxExportExcludedRanges(body: IDocumentBody, textLength: number, currentIndex: number): IDocxExportExcludedRange[] | undefined;
