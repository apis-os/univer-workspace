...
export declare function getNumfmtLocaleTag(locale: LocaleType): INumfmtLocaleTag;
/**
 ...
 */
export declare const getNumfmtParseValueFilter: (value: string, options?: ParseOptions) => ParseData | null;
