...
import { Disposable, ICommandService, IContextService, IImageIoService, IPermissionService, LocaleService } from '@univerjs/core';
...
export declare class DocDrawingUpdateRenderController extends Disposable implements IRenderModule {
    ...
    private _indexDrawingShapes;
    private _recordReadOnlyDrawing;
    private _attachTransformerIfEditable;
    private _clearReadOnlyDrawingFocus;
    private _setTransformerEditable;
    private _scheduleDrawingsEditStatusUpdate;
    private _canInsertDocImage;
