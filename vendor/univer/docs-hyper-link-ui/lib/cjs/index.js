...
const AddDocHyperLinkCommand = {
	...
	id: _univerjs_docs_hyper_link.DocHyperLinkCommandId.Add,
...
const UpdateDocHyperLinkCommand = {
	id: _univerjs_docs_hyper_link.DocHyperLinkCommandId.Update,
	type: _univerjs_core.CommandType.COMMAND,
...
const DeleteDocHyperLinkCommand = {
	type: _univerjs_core.CommandType.COMMAND,
	id: _univerjs_docs_hyper_link.DocHyperLinkCommandId.Delete,
	async handler(accessor, params) {
		if (!params) return false;
...
const DocLinkPopup = () => {
	...
	const doc = univerInstanceService.getUnit(unitId, _univerjs_core.UniverInstanceType.UNIVER_DOC);
	const body = doc instanceof _univerjs_core.DocumentDataModel ? (_doc$getSelfOrHeaderF = doc.getSelfOrHeaderFooterModel(segmentId)) === null || _doc$getSelfOrHeaderF === void 0 ? void 0 : _doc$getSelfOrHeaderF.getBody() : void 0;
	...
	const canCopy = (0, _univerjs_docs.getDocumentPermissionValue)(permissionService, unitId, unitId, _univerjs_protocol.UnitAction.Copy);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			}), canEdit && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
let DocHyperLinkPopupService = class DocHyperLinkPopupService extends _univerjs_core.Disposable {
	...
	showInfoPopup(info, options) {
		...
		if (!(this._univerInstanceService.getUnit(unitId, _univerjs_core.UniverInstanceType.UNIVER_DOC) instanceof _univerjs_core.DocumentDataModel)) return;
	...
	canEditLink(unitId, linkInfo) {
		const document = this._univerInstanceService.getUnit(unitId, _univerjs_core.UniverInstanceType.UNIVER_DOC);
		if (!(document instanceof _univerjs_core.DocumentDataModel)) return false;
		if (!linkInfo) return (0, _univerjs_docs.canEditDocumentTargets)(this._permissionService, unitId, []);
		const segmentId = linkInfo.segmentId ?? "";
		return (0, _univerjs_docs.canEditDocumentTargets)(this._permissionService, unitId, [...(0, _univerjs_docs.getDocumentEntityParentPermissionObjectIds)(document, segmentId, "custom-range", linkInfo.linkId), (0, _univerjs_docs.getDocumentEntityPermissionObjectId)(segmentId, "custom-range", linkInfo.linkId)]);
	}
};
		...
		this.disposeWithMe(this._commandService.onCommandExecuted((commandInfo) => {
			if (commandInfo.id === _univerjs_docs.SetTextSelectionsOperation.id) {
				...
				if ((primary === null || primary === void 0 ? void 0 : primary.collapsed) && doc) {
					...
					const customRange = ((showing === null || showing === void 0 ? void 0 : showing.unitId) === unitId && (showing.segmentId ?? "") === segmentId && showing.segmentPage === segmentPage && showing.endIndex === endOffset - 1 ? customRanges === null || customRanges === void 0 ? void 0 : customRanges.find((value) => value.rangeId === showing.linkId && value.rangeType === _univerjs_core.CustomRangeType.HYPERLINK && value.startIndex <= startOffset && value.endIndex === endOffset - 1) : void 0) ?? (customRanges === null || customRanges === void 0 ? void 0 : customRanges.find((value) => value.rangeType === _univerjs_core.CustomRangeType.HYPERLINK && value.startIndex <= startOffset && value.endIndex > endOffset - 1));
					if (customRange) {
...
let DocHyperLinkEventRenderController = class DocHyperLinkEventRenderController extends _univerjs_core.Disposable {
	...
	_initClick() {
		this.disposeWithMe(this._docEventManagerService.clickCustomRanges$.subscribe((range) => {
			...
			if (link.rangeType !== _univerjs_core.CustomRangeType.HYPERLINK) return;
...
DocHyperLinkRenderController = __decorate([__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_docs.DocInterceptorService)), __decorateParam(2, (0, _univerjs_core.Inject)(DocHyperLinkPopupService))], DocHyperLinkRenderController);
