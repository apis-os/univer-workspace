...
* limitations under the License.
*/
let DocHyperLinkCommandId = /* @__PURE__ */ function(DocHyperLinkCommandId) {
	DocHyperLinkCommandId["Add"] = "docs.command.add-hyper-link";
	DocHyperLinkCommandId["Update"] = "docs.command.update-hyper-link";
	DocHyperLinkCommandId["Delete"] = "docs.command.delete-hyper-link";
	return DocHyperLinkCommandId;
}({});

//#endregion
export { DocHyperLinkCommandId, UniverDocsHyperLinkPlugin };