...
export declare const DOC_UNIVER_THREAD_COMMENT_PLUGIN = "DOC_UNIVER_THREAD_COMMENT_PLUGIN";
export declare class DocsThreadCommentResourceController extends Disposable {
