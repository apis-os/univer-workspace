...
export declare class DocContextMenuRenderController extends Disposable implements IRenderModule {
    ...
    constructor(_context: IRenderContext<Workbook>, _contextMenuService: IContextMenuService, _commandService: ICommandService, _docEventManagerService: DocEventManagerService, _docSelectionManagerService: DocSelectionManagerService, _contextService: IContextService, _univerInstanceService: IUniverInstanceService);
