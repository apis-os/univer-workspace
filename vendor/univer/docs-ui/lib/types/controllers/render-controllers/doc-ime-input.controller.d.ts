...
export declare class DocIMEInputController extends Disposable implements IRenderModule {
    ...
    constructor(_context: IRenderContext<DocumentDataModel>, _docSelectionRenderService: DocSelectionRenderService, _docImeInputManagerService: DocIMEInputManagerService, _docSkeletonManagerService: DocSkeletonManagerService, _docStateEmitService: DocStateEmitService, _docSelectionManagerService: DocSelectionManagerService, _commandService: ICommandService);
    dispose(): void;
    private _initialize;
