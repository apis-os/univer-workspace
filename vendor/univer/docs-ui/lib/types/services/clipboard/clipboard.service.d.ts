...
import { Disposable, ErrorService, ICommandService, ILogService, ImageSourceType, IPermissionService, IUniverInstanceService, SliceBodyType } from '@univerjs/core';
import { DocSelectionManagerService } from '@univerjs/docs';
import { IClipboardInterfaceService } from '@univerjs/ui';
import { DocHtmlExportService } from './udm-to-html/doc-html-export.service';
export declare function convertClipboardHtmlToDocumentData(html: string, unitId?: string): Partial<IDocumentData>;
export declare function removeClipboardHtmlImages(html: string): string;
...
export declare class DocClipboardService extends Disposable implements IDocClipboardService {
    ...
    constructor(_univerInstanceService: IUniverInstanceService, _logService: ILogService, _commandService: ICommandService, _permissionService: IPermissionService, _clipboardInterfaceService: IClipboardInterfaceService, _errorService: ErrorService, docHtmlExportService: DocHtmlExportService, _docSelectionManagerService: DocSelectionManagerService);
    copy(sliceType?: SliceBodyType, ranges?: ITextRangeWithStyle[]): Promise<boolean>;
    cut(ranges?: ITextRangeWithStyle[]): Promise<boolean>;
    paste(items?: ClipboardItem[]): Promise<boolean>;
    legacyPaste(options: {
    ...
    private _getCurrentDocumentUnitId;
