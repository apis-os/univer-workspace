...
export declare class DocEventManagerService extends Disposable implements IRenderModule {
    ...
    readonly clickCustomRanges$: import("rxjs").Observable<ICustomRangeClickEvent>;
    private readonly _pointerDownCustomRanges$;
    readonly pointerDownCustomRanges$: import("rxjs").Observable<ICustomRangeActive[]>;
    ...
    private _tableParagraphBoundsByIndex;
    private _segmentParagraphBounds;
    private _tableViewportSignature;
    private _tableCellBounds;
    private _tableCellGeometries;
    private _tableCellPages;
    ...
    private _buildTableCellsForPage;
    private _buildTableCellsForDocumentRange;
