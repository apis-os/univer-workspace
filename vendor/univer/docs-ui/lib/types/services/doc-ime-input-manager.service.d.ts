...
export declare class DocIMEInputManagerService extends RxDisposable implements IRenderModule {
    ...
    private _previousDocRanges;
    private _compositionRange;
    private _previousSelectionOptions;
    ...
    getPreviousSelectionOptions(): Nullable<{
        [key: string]: boolean;
    }>;
    setPreviousSelectionOptions(options: Nullable<{
        [key: string]: boolean;
    }>): void;
    ...
    fetchComposedUndoRedoMutationParams(): {
        ...
        previousDocRanges: ITextRangeWithStyle[];
        previousSelectionOptions: Nullable<{
            [key: string]: boolean;
        }>;
    } | null;
    dispose(): void;
