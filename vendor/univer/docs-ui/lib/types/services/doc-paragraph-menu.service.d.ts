...
import { Disposable, DocumentBlockType, IPermissionService } from '@univerjs/core';
...
export declare class DocParagraphMenuService extends Disposable implements IRenderModule {
    ...
    private _docLayoutInteractionService;
