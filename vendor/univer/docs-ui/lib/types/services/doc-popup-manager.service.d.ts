...
export declare class DocCanvasPopManagerService extends Disposable {
    ...
    private readonly _popupCountByUnit;
    private readonly _popupUnits$;
    readonly popupUnits$: import("rxjs").Observable<ReadonlySet<string>>;
    ...
    dispose(): void;
    private _beginPopupActivity;
    private _publishPopupUnits;
    ...
    private _resolvePopupManagerService;
}
