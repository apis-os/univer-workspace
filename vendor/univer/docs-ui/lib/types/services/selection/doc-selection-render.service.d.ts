...
export declare class DocSelectionRenderService extends RxDisposable implements IRenderModule {
    ...
    constructor(_context: IRenderContext<DocumentDataModel>, _layoutService: ILayoutService, _logService: ILogService, _univerInstanceService: IUniverInstanceService, _docSkeletonManagerService: DocSkeletonManagerService, _docSelectionManagerService: DocSelectionManagerService, _embedInteractionBoundaryService?: IDocEmbedInteractionBoundaryService | undefined, _embedRuntimeFocusCoordinator?: IDocEmbedRuntimeFocusCoordinator | undefined);
    ...
    replaceDocRanges(ranges: ISuccinctDocRangeParam[], isEditing?: boolean, options?: {
        [key: string]: boolean;
    }): boolean;
    private _getPendingSelection;
    ...
    private _clearUnresolvedSelection;
    ...
    private _isAnotherEditorFocused;
