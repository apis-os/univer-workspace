...
export { DocLayoutExecutorService, DocLayoutExecutorState, DocLayoutExecutorType, DocLayoutSessionStatus, } from './services/doc-layout-executor.service';
export type { IDocLayoutCancelRequest, IDocLayoutCreateSessionRequest, IDocLayoutCustomRangePresentation, IDocLayoutCustomRangePresentationContext, IDocLayoutCustomRangePresentationEntry, IDocLayoutCustomRangePresentationPatch, IDocLayoutDisposeMountRequest, IDocLayoutDisposeSessionRequest, IDocLayoutExecutor, IDocLayoutExecutorStatus, IDocLayoutMountIdentity, IDocLayoutMutationProjection, IDocLayoutPageRequest, IDocLayoutPageResult, IDocLayoutPerformanceMetrics, IDocLayoutRecordPatch, IDocLayoutStartOptions, IDocLayoutStartRequest, IDocLayoutStartResult, IDocLayoutStepRequest, IDocLayoutStepResult, } from './services/doc-layout-executor.service';
...
export { canEditDocumentTargets, createDocumentPermissionPoint, DOCUMENT_UNIT_PERMISSION_ACTIONS, getDocumentEntityPermissionObjectId, getDocumentParagraphPermissionObjectId, getDocumentPermissionValue, getDocumentSectionPermissionObjectId, setDocumentPermissionValue, } from './services/permission/document-permission';
export type { DocumentUnitPermissionAction } from './services/permission/document-permission';
export { getDocumentDrawingSegmentId, getDocumentEditTargetObjectIds, getDocumentEntityParentPermissionObjectIds, getDocumentParagraphParentPermissionObjectIds, } from './services/permission/document-permission-resolver';
