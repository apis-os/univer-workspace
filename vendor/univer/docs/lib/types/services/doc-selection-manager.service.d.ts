...
export declare class DocSelectionManagerService extends RxDisposable {
    ...
    refreshSelection(params?: Nullable<IDocSelectionManagerSearchParam>, isEditing?: boolean): void;
     ...
     */
    replaceSelectionInfoWithoutRefresh(selectionInfo: IDocSelectionInnerParam, params?: Nullable<IDocSelectionManagerSearchParam>): void;
