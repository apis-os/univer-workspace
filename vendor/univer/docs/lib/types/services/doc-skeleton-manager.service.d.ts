...
export declare class DocSkeletonManagerService extends RxDisposable implements IRenderModule {
    ...
    constructor(_context: Pick<IRenderContext<DocumentDataModel>, 'type' | 'unit' | 'unitId'>, _localeService: LocaleService, _univerInstanceService: IUniverInstanceService, _docLayoutExecutorService: DocLayoutExecutorService);
    dispose(): void;
