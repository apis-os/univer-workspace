...
export declare class FormulaController extends Disposable {
    ...
    private readonly _syncedOtherFormulaUnits;
    constructor(_commandService: ICommandService, _functionService: IFunctionService, _configService: IConfigService, _dataSyncPrimaryController: FormulaDataSyncController | undefined, _registerOtherFormulaService: RegisterOtherFormulaService);
    private _initialize;
    private _syncOtherFormulaUnits;
