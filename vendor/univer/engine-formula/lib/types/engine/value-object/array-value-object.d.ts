...
export declare function transformToValueObject(array?: Array<Array<number | string | boolean | null>>, isIgnoreNumberPattern?: boolean, dateSystem?: DateSystem): BaseValueObject[][];
...
export declare class ArrayValueObject extends BaseValueObject {
     ...
     * @returns
     */
    static create(rawValue: string | IArrayValueObject, dateSystem?: DateSystem): ArrayValueObject;
    /**
...
export declare class ValueObjectFactory {
    static create(rawValue: string | number | boolean | null, isIgnoreNumberPattern?: boolean, dateSystem?: DateSystem): BaseValueObject;
}
