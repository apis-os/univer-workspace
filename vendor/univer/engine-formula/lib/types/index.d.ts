 ...
 */
export type { FormulaUnitType, IArrayFormulaEmbeddedMap, IArrayFormulaRangeType, IArrayFormulaUnitCellType, IDirtyUnitDefinedNameMap, IDirtyUnitFeatureMap, IDirtyUnitOtherFormulaMap, IDirtyUnitSheetNameMap, IDirtyUnitSuperTableMap, IFeatureDirtyRangeType, IFormulaData, IFormulaDataItem, IFormulaDatasetConfig, IFormulaExecuteResultMap, IFormulaExternalReferenceBinding, IFormulaExternalReferenceResource, IFormulaExternalReferences, IFormulaStringMap, IFormulaUnitNameMap, IFormulaUnitNameMapItem, IRuntimeImageFormulaDataType, IRuntimeUnitDataType, ISheetData, IUnitData, IUnitImageFormulaDataType, IUnitSheetNameMap, } from './basics/common';
...
export { buildFormulaTextRuns, findFormulaStructuredReferences, getFormulaHighlightDataStream, getFormulaReferenceIndex, getFormulaReplaceResult, getFormulaSequenceCharacterAtOffset, getFormulaSequenceNodeIndex, isFormulaReferenceAddingContext, isFormulaReferenceAddingTextContext, resolveFormulaReferenceEditingContext, searchFormulaFunctions, } from './formula-editor-helpers';
export type { FormulaReferenceEditingMode, FormulaSequenceNode, IFormulaHighlightColors, IFormulaReferenceEditingContext, IFormulaRefSelection, IFormulaStructuredReferenceRange, } from './formula-editor-helpers';
...
export { IFormulaExternalReferenceDataLoader, NoopFormulaExternalReferenceDataLoader, } from './services/external-reference-data-loader.service';
...
export { FormulaCalculationSessionService, FormulaResultApplicationType, } from './services/formula/formula-calculation-session.service';
...
export { IRegisterFunctionService, RegisterFunctionService, } from './services/formula/register-function.service';
export type { IRegisterAsyncFunction, IRegisterFunction, IRegisterFunctionParams, ISingleFunctionRegisterParams, IUnregisterFunctionParams, } from './services/formula/register-function.service';
