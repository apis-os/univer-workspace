...
export declare class FormulaDataModel extends Disposable {
    ...
    initSheetFormulaData(formulaData: IFormulaData, unitId: string, sheetId: string, cellMatrix: ObjectMatrix<Nullable<ICellData>>): IFormulaData;
    clearFormulaIdMap(unitId: string, sheetId?: string): void;
