...
import type { FormulaUnitReferenceKind, IFormulaUnitReferenceResolution } from './unit-reference-resolver.service';
...
export declare const IFormulaExternalReferenceDataLoader: import("@wendellhu/redi").IdentifierDecorator<IFormulaExternalReferenceDataLoader>;
export declare class NoopFormulaExternalReferenceDataLoader implements IFormulaExternalReferenceDataLoader {
    load(): Promise<void>;
}
