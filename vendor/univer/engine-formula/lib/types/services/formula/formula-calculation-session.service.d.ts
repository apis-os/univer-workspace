...
export declare enum FormulaResultApplicationType {
    SHEET = "sheet",
    BASE = "base",
...
export declare class FormulaCalculationSessionService extends Disposable {
    ...
    private _pendingResultApplicationTypes;
    private _preAppliedSessionTypes;
    private readonly _preAppliedResultTypes;
    ...
    markResultEmitted(result: ISetFormulaCalculationResultMutation, pendingApplications: boolean | Iterable<FormulaResultApplicationType>): void;
    markResultApplied(type?: FormulaResultApplicationType, result?: ISetFormulaCalculationResultMutation): void;
