...
export type IDocumentLayoutPageRange = Pick<IDocumentLayoutProtectedPageRange, 'startPageIndex' | 'endPageIndex'>;
export interface IDocumentLayoutProtectedContinuousRange {
    mode: 'continuous';
    startOffset: number;
    endOffset: number;
}
export type IDocumentLayoutProtectedRange = IDocumentLayoutProtectedPageRange | IDocumentLayoutProtectedContinuousRange;
