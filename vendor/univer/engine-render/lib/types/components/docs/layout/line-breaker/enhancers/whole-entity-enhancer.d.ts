 ...
 */
export declare class LineBreakerWholeEntityEnhancer implements IBreakPoints {
    private readonly _lineBreaker;
    private readonly _contentStartIndex;
    readonly content: string;
    private readonly _ranges;
    private _rangeIndex;
    constructor(_lineBreaker: IBreakPoints, ranges: readonly ICustomRange[], _contentStartIndex: number);
    nextBreakPoint(): Nullable<Break>;
    private _isInsideWholeEntity;
}
