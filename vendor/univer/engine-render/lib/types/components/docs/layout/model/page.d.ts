...
export declare function startSkeletonCellPagesBuild(ctx: ILayoutContext, viewModel: DocumentViewModel, cellNode: DataStreamTreeNode, sectionBreakConfig: ISectionBreakConfig, tableConfig: ITable, row: number, col: number, availableHeight?: number, maxCellPageHeight?: number): ICellSkeletonBuildState;
export declare function stepSkeletonCellPagesBuild(state: ICellSkeletonBuildState): boolean;
