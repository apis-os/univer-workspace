...
function getFindReplaceDialogDefaultPosition(direction) {
	const { innerWidth } = window;
	return {
		x: direction === "rtl" ? FIND_REPLACE_PANEL_HORIZONTAL_PADDING : innerWidth - FIND_REPLACE_PANEL_WIDTH - FIND_REPLACE_PANEL_HORIZONTAL_PADDING,
...
const FIND_SCOPE_OPTIONS = [{
	label: "find-replace.dialog.find-scope.current-sheet",
	value: "subunit"
}, {
	label: "find-replace.dialog.find-scope.workbook",
	value: "unit"
}];
const FIND_DIRECTION_OPTIONS = [{
	label: "find-replace.dialog.find-direction.row",
	value: "row"
}, {
	label: "find-replace.dialog.find-direction.column",
	value: "column"
}];
const FIND_BY_OPTIONS = [{
	label: "find-replace.dialog.find-by.value",
	value: "value"
}, {
	label: "find-replace.dialog.find-by.formula",
	value: "formula"
}];
...
exports.FindReplaceMenuSchema = menuSchema;
