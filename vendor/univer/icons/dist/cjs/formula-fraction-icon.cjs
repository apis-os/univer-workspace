...
//#region ts/formula-fraction-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const FormulaFractionIcon = (0, react.forwardRef)(function FormulaFractionIcon(props, ref) {
...
FormulaFractionIcon.displayName = "FormulaFractionIcon";
//#endregion
