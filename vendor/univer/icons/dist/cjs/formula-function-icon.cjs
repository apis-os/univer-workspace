...
//#region ts/formula-function-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const FormulaFunctionIcon = (0, react.forwardRef)(function FormulaFunctionIcon(props, ref) {
...
FormulaFunctionIcon.displayName = "FormulaFunctionIcon";
//#endregion
