...
//#region ts/formula-integral-icon.tsx
const element = {
	"tag": "svg",
	"attrs": {
...
const FormulaIntegralIcon = (0, react.forwardRef)(function FormulaIntegralIcon(props, ref) {
...
FormulaIntegralIcon.displayName = "FormulaIntegralIcon";
//#endregion
