...
let UniverType = /* @__PURE__ */ function(UniverType) {
	...
	UniverType[UniverType["UNIVER_BASE"] = 5] = "UNIVER_BASE";
	UniverType[UniverType["UNIVER_BOARD"] = 6] = "UNIVER_BOARD";
	UniverType[UniverType["UNIVER_PDF"] = 7] = "UNIVER_PDF";
...
let UnitObject = /* @__PURE__ */ function(UnitObject) {
	...
	UnitObject[UnitObject["Base"] = 6] = "Base";
	UnitObject[UnitObject["Board"] = 7] = "Board";
	UnitObject[UnitObject["Pdf"] = 8] = "Pdf";
	UnitObject[UnitObject["DocumentSection"] = 9] = "DocumentSection";
	UnitObject[UnitObject["DocumentParagraph"] = 10] = "DocumentParagraph";
	UnitObject[UnitObject["DocumentEntity"] = 11] = "DocumentEntity";
	UnitObject[UnitObject["SlidePage"] = 12] = "SlidePage";
	UnitObject[UnitObject["SlideElement"] = 13] = "SlideElement";
	UnitObject[UnitObject["SlideMaster"] = 14] = "SlideMaster";
	UnitObject[UnitObject["BaseTable"] = 15] = "BaseTable";
	UnitObject[UnitObject["BaseField"] = 16] = "BaseField";
	UnitObject[UnitObject["BaseRecord"] = 17] = "BaseRecord";
	UnitObject[UnitObject["BaseView"] = 18] = "BaseView";
	UnitObject[UnitObject["BaseDashboard"] = 19] = "BaseDashboard";
	UnitObject[UnitObject["BoardElement"] = 20] = "BoardElement";
