...
export type { ICollaMsg, ICollaMsgErrorEvent, ICollaMsgJoin, ICollaMsgLeave, ICommentUpdate, ILiveShareNewHost, ILiveShareOperation, ILiveShareOperationOperation, ILiveShareRequestHost, ILiveShareTerminate, IShouldCloseConn, IUniscriptRun, IUpdateCursor, IUpdatePermissionObj, } from './ts/univer/colla-msg';
...
export type { ICombJoinRequest, ICombJoinResponse, ICombLeaveRequest, ICombService, IMember, INewChangesRequest, INewChangesResponse, } from './ts/universer/v1/comb';
