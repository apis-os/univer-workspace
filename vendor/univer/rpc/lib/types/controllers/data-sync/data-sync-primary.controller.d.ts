 ...
 */
import type { IDisposable, IMutation, IMutationInfo } from '@univerjs/core';
...
export declare class DataSyncPrimaryController extends RxDisposable {
    ...
    syncMutation(commandInfo: IMutationInfo, options?: IRemoteSyncMutationOptions): Promise<boolean>;
