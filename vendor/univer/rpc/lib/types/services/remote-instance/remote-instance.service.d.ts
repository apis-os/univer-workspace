...
import { ICommandService, ILogService, IUniverInstanceService, LifecycleService, UniverInstanceType } from '@univerjs/core';
...
export declare class WebWorkerRemoteInstanceService implements IRemoteInstanceService {
    ...
    constructor(_univerInstanceService: IUniverInstanceService, _commandService: ICommandService, _logService: ILogService, _lifecycleService: LifecycleService);
    whenReady(): Promise<true>;
    syncMutation(params: {
        mutationInfo: IMutationInfo;
    }, options?: IExecutionOptions): Promise<boolean>;
