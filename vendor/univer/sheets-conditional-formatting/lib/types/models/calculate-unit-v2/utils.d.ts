...
import { ColorKit, DateSystem, ObjectMatrix } from '@univerjs/core';
...
export declare const isNullable: (v: Nullable<CellValue>) => boolean;
export declare const getCellValue: (cell?: ICellData) => Nullable<CellValue>;
export declare const serialTimeToTimestamp: (value: number, dateSystem?: DateSystem) => number;
