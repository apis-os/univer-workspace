...
const locale = { "sheets-data-validation-ui": {
	...
	validFail: { formulaError: "Phạm vi tham chiếu chứa dữ liệu không hiển thị, vui lòng điều chỉnh lại phạm vi" },
	panel: {
	...
	showTime: { label: "Hiển thị lựa chọn thởi gian" },
