...
export declare class SheetCellImageHoverRenderController extends Disposable implements IRenderModule {
    ...
    constructor(_context: IRenderContext<Workbook>, _hoverManagerService: HoverManagerService, _selectionsService: SheetsSelectionsService, _drawingRenderService: DrawingRenderService, _sheetSkeletonManagerService: SheetSkeletonManagerService);
    private _initHover;
