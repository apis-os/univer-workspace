...
export declare class SheetCellImageController extends Disposable {
    ...
    constructor(_sheetInterceptorService: SheetInterceptorService, _injector: Injector, _drawingManagerService: IDrawingManagerService, _docDrawingController: DocDrawingController, _editorBridgeService: IEditorBridgeService);
