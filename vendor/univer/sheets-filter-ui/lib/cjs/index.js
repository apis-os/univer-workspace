...
function FilterSyncSwitch() {
	...
	const visible = (0, _univerjs_ui.useObservable)(sheetsFilterSyncController.visible$, void 0, true);
	const localeService = (0, _univerjs_ui.useDependency)(_univerjs_core.LocaleService);
...
//#endregion
//#region src/controllers/mobile-menu.controller.ts
/**
* Copyright 2023-present DreamNum Co., Ltd.
*
* Licensed under the Apache License, Version 2.0 (the "License");
...
* limitations under the License.
*/
let SheetsFilterMobileMenuController = class SheetsFilterMobileMenuController extends _univerjs_core.Disposable {
	constructor(commandService, menuManagerService) {
		super();
		this.disposeWithMe(commandService.registerCommand(_univerjs_sheets_filter.SmartToggleSheetsFilterCommand));
		menuManagerService.mergeMenu(menuSchema);
	}
};
SheetsFilterMobileMenuController = __decorate([__decorateParam(0, _univerjs_core.ICommandService), __decorateParam(1, _univerjs_ui.IMenuManagerService)], SheetsFilterMobileMenuController);
...
UniverSheetsFilterMobileUIPlugin = __decorate([
	(0, _univerjs_core.DependentOn)(_univerjs_engine_render.UniverRenderEnginePlugin, _univerjs_sheets.UniverSheetsPlugin, _univerjs_ui.UniverMobileUIPlugin, _univerjs_sheets_filter.UniverSheetsFilterPlugin, _univerjs_sheets_ui.UniverSheetsMobileUIPlugin),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
...
UniverSheetsFilterUIWorkerPlugin = __decorate([
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, _univerjs_core.IConfigService),
	__decorateParam(3, _univerjs_rpc.IRPCChannelService)
