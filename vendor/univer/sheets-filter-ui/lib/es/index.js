...
* limitations under the License.
*/
let SheetsFilterMobileMenuController = class SheetsFilterMobileMenuController extends Disposable {
...
SheetsFilterMobileMenuController = __decorate([__decorateParam(0, ICommandService), __decorateParam(1, IMenuManagerService)], SheetsFilterMobileMenuController);
...
UniverSheetsFilterMobileUIPlugin = __decorate([
	DependentOn(UniverRenderEnginePlugin, UniverSheetsPlugin, UniverMobileUIPlugin, UniverSheetsFilterPlugin, UniverSheetsMobileUIPlugin),
	__decorateParam(1, Inject(Injector)),
