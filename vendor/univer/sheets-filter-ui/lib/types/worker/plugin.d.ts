...
export declare class UniverSheetsFilterUIWorkerPlugin extends Plugin {
    ...
    constructor(_config: Partial<IUniverSheetsFilterUIConfig> | undefined, _injector: Injector, _configService: IConfigService, _rpcChannelService: IRPCChannelService);
    onStarting(): void;
    onReady(): void;
}
