...
export declare function buildFormulaFunctionInsertion(formulaText: string, selection: Pick<ITextRange, 'startOffset' | 'endOffset'> | undefined, functionName: string): {
    text: string;
    caretOffset: number;
};
export declare function buildFormulaOperatorInsertion(formulaText: string, selection: Pick<ITextRange, 'startOffset' | 'endOffset'> | undefined, value: string): {
    text: string;
    caretOffset: number;
};
