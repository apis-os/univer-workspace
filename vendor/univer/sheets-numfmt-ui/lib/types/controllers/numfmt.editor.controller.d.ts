...
export declare class NumfmtEditorController extends Disposable {
    ...
    constructor(_sheetInterceptorService: SheetInterceptorService, _numfmtService: INumfmtService, _univerInstanceService: IUniverInstanceService, _injector: Injector, _sheetsNumfmtCellContentController: SheetsNumfmtCellContentController, _editorBridgeService?: IEditorBridgeService | undefined);
