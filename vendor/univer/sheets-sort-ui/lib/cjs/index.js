		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				overlay: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
					className: (0, _univerjs_design.clsx)("univer-my-0 univer-box-border univer-grid univer-max-h-[310px] univer-w-[--radix-popper-anchor-width] univer-items-center univer-gap-1 univer-overflow-y-auto univer-overflow-x-hidden univer-rounded-lg univer-border univer-bg-gray-0 univer-p-1 univer-text-base univer-shadow-lg", _univerjs_design.scrollbarClassName),
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: (0, _univerjs_design.clsx)("univer-ml-2 univer-flex univer-w-full univer-items-center univer-justify-between univer-overflow-hidden univer-rounded-md univer-py-1.5 univer-text-sm univer-text-gray-900 dark:!univer-text-gray-0"),
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: "univer-max-w-[220px] univer-truncate",
						children: itemLabel
...
UniverSheetsSortUIPlugin = __decorate([
	(0, _univerjs_core.DependentOn)(_univerjs_sheets.UniverSheetsPlugin, _univerjs_sheets_sort.UniverSheetsSortPlugin, _univerjs_sheets_ui.UniverSheetsUIPlugin),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
	__decorateParam(2, _univerjs_core.IConfigService)
], UniverSheetsSortUIPlugin);

//#endregion
exports.SheetsSortUIMenuSchema = menuSchema;
