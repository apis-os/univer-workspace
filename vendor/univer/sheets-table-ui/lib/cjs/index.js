...
function getSheetTableRowColOperationHidden$(accessor) {
	...
	return accessor.get(_univerjs_core.IUniverInstanceService).getCurrentTypeOfUnit$(_univerjs_core.UniverInstanceType.UNIVER_SHEET).pipe((0, rxjs.switchMap)((workbook) => {
		...
		return workbook.activeSheet$.pipe((0, rxjs.switchMap)((sheet) => {
			...
			return sheetsSelectionsService.selectionMoveEnd$.pipe((0, rxjs.startWith)(sheetsSelectionsService.getCurrentSelections()), (0, rxjs.switchMap)((selections) => {
...
let SheetsTableComponentController = class SheetsTableComponentController extends _univerjs_core.Disposable {
	...
	_openFilterPopup() {
		...
		if (this._contextService.getContextValue(_univerjs_ui.MOBILE_UI_MODE)) {
...
const SheetTableConditionPanel = (props) => {
	...
	const handleChange = (value) => {
		...
		handleConditionInfo(info, value[0], value[1] ?? _univerjs_sheets_table.TableStringCompareTypeEnum.Equal);
	};
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_univerjs_design.Dropdown, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, _univerjs_design.clsx)("univer-box-border univer-flex univer-h-8 univer-w-full univer-items-center univer-justify-between univer-rounded-md univer-bg-gray-0 univer-px-2 univer-text-sm univer-transition-colors univer-duration-200 hover:univer-border-primary-600 focus:univer-border-primary-600 focus:univer-outline-none focus:univer-ring-2 dark:!univer-bg-gray-700 dark:!univer-text-gray-0", _univerjs_design.borderClassName),
...
function MobileSheetTableMenu({ menu }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: ACTIONS.map((action) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_univerjs_design.MobileActionRow, {
...
function SheetTableMenu({ popup }) {
	...
	if (!menu) return null;
	if (mobile) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MobileSheetTableMenu, { menu });
...
function SheetTableRenameDialog(props) {
	...
	const [value, setValue] = (0, react.useState)((table === null || table === void 0 ? void 0 : table.getDisplayName()) ?? "");
	...
	const customThemeRows = [
		{
			...
			onChange: (value) => {
				const headerRowStyle = (0, _univerjs_sheets_table.processStyleWithBorderStyle)("headerRowStyle", {
					bg: { rgb: value },
					cl: { rgb: new _univerjs_core.ColorKit(value).isDark() ? "#fff" : "#000" }
				});
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h5", {
				...
				children: defaultRangeThemes.map((item) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						className: (0, _univerjs_design.clsx)("univer-flex univer-h-12 univer-w-full univer-cursor-pointer univer-flex-col univer-overflow-hidden univer-rounded-lg univer-bg-gray-0 univer-p-1 univer-shadow-sm univer-transition-all hover:univer-border-gray-400 hover:univer-shadow-md focus:univer-outline-none focus:univer-ring-2 focus:univer-ring-primary-200 dark:!univer-bg-gray-800", _univerjs_design.borderClassName, { "!univer-border-primary-500 univer-ring-2 univer-ring-primary-100": selected }),
						onClick: () => handleThemeChange(item),
						children: rowBackgrounds.map((background, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_univerjs_icons.IncreaseIcon, { className: "univer-size-4" })
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								"aria-label": item,
								"aria-pressed": selected,
								className: (0, _univerjs_design.clsx)("univer-flex univer-size-full univer-cursor-pointer univer-flex-col univer-overflow-hidden univer-rounded-lg univer-bg-gray-0 univer-p-1 univer-shadow-sm univer-transition-all hover:univer-border-gray-400 hover:univer-shadow-md focus:univer-outline-none focus:univer-ring-2 focus:univer-ring-primary-200 dark:!univer-bg-gray-900", _univerjs_design.borderClassName, { "!univer-border-primary-500 univer-ring-2 univer-ring-primary-100": selected }),
								onClick: () => handleThemeChange(item),
								children: rowBackgrounds.map((background, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: "univer-min-h-0 univer-w-full univer-flex-1",
									style: {
				...
				customSelected && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: customThemeRows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "univer-flex univer-h-10 univer-min-w-0 univer-gap-2",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: (0, _univerjs_design.clsx)("univer-flex univer-min-w-0 univer-flex-1 univer-items-center univer-rounded-md univer-px-3 univer-text-sm univer-font-medium rtl:univer-text-right", _univerjs_design.borderClassName, {
							...
							overlay: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_univerjs_design.ColorPicker, {
									value: new _univerjs_core.ColorKit(row.background).toHexString(),
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								className: (0, _univerjs_design.clsx)("univer-flex univer-h-10 univer-cursor-pointer univer-items-center univer-gap-2 univer-rounded-md univer-bg-gray-0 univer-px-2 univer-text-gray-600 univer-transition-colors hover:univer-bg-gray-100 focus:univer-outline-none focus:univer-ring-2 focus:univer-ring-primary-200 dark:!univer-bg-gray-900 dark:!univer-text-gray-300", _univerjs_design.borderClassName),
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: (0, _univerjs_design.clsx)("univer-size-4 univer-rounded-full", _univerjs_design.borderClassName),
									style: { background: row.background }
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_univerjs_icons.DownIcon, { className: "univer-size-3" })]
							})
						})]
					}, row.key))
				})
...
const SELECTION_ONLY_COMMANDS = /* @__PURE__ */ new Set([
	_univerjs_sheets_ui.MoveSelectionCommand.id,
	_univerjs_sheets_ui.MoveSelectionEnterAndTabCommand.id,
	_univerjs_sheets_ui.ExpandSelectionCommand.id,
	_univerjs_sheets_ui.SelectAllCommand.id,
	_univerjs_sheets.SelectRangeCommand.id
]);
...
let SheetTableControlsRenderController = class SheetTableControlsRenderController extends _univerjs_core.Disposable {
	...
	_initShape() {
		...
		this.disposeWithMe(((_this$_context$compon = this._context.components.get(_univerjs_sheets_ui.SHEET_VIEW_KEY.MAIN)) === null || _this$_context$compon === void 0 ? void 0 : _this$_context$compon.onPointerMove$.subscribeEvent((evt) => {
	...
	_toggleTableMenu(unitId, subUnitId, tableId) {
		...
		if (this._contextService.getContextValue(_univerjs_ui.MOBILE_UI_MODE)) {
			...
			this._menuPopup = (0, _univerjs_core.toDisposable)(() => this._dialogService.close(SHEET_TABLE_MOBILE_MENU_DIALOG_ID));
			return;
		}
...
SheetTableControlsRenderController = __decorate([
	...
	__decorateParam(12, _univerjs_core.IContextService),
	__decorateParam(13, _univerjs_ui.IDialogService),
	__decorateParam(14, _univerjs_ui.ISidebarService),
	__decorateParam(15, (0, _univerjs_core.Inject)(_univerjs_sheets_ui.SheetCanvasPopManagerService))
...
SheetTableMenuController = __decorate([__decorateParam(0, (0, _univerjs_core.Inject)(_univerjs_ui.IMenuManagerService))], SheetTableMenuController);
...
UniverSheetsTableUIPlugin = __decorate([
	(0, _univerjs_core.DependentOn)(_univerjs_engine_render.UniverRenderEnginePlugin, _univerjs_sheets.UniverSheetsPlugin, _univerjs_sheets_table.UniverSheetsTablePlugin, _univerjs_sheets_ui.UniverSheetsUIPlugin),
	__decorateParam(1, (0, _univerjs_core.Inject)(_univerjs_core.Injector)),
...
//#endregion
exports.SheetsTableUIMenuSchema = menuSchema;
