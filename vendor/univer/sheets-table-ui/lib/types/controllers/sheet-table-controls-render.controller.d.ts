...
import { Disposable, ICommandService, IContextService, Injector, IPermissionService, LocaleService } from '@univerjs/core';
...
import { ISheetSelectionRenderService, SheetCanvasPopManagerService, SheetSkeletonManagerService } from '@univerjs/sheets-ui';
...
export declare class SheetTableControlsRenderController extends Disposable implements IRenderModule {
    ...
    private _handleHit;
    private _toggleTableMenu;
    private _handleTableMenuAction;
