...
export declare function sheetTableToolbarInsertMenuFactory(accessor: IAccessor): IMenuItem<LocaleKey>;
export declare function SheetTableInsertContextMenuFactory(accessor: IAccessor): IMenuSelectorItem<LocaleKey>;
export declare function SheetTableRemoveContextMenuFactory(accessor: IAccessor): IMenuSelectorItem<LocaleKey>;
...
export declare function SheetTableInsertColMenuFactory(): {
    id: string;
    title: string;
    type: MenuItemType;
};
...
export declare function SheetTableRemoveColMenuFactory(): {
    id: string;
    title: string;
    type: MenuItemType;
};
