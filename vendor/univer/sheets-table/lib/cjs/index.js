...
const textEqual = (compareValue, expectedValue) => {
	return _univerjs_core.regexp.createFromWildcard(expectedValue).test(compareValue);
};
...
Object.defineProperty(exports, 'SheetsTableThemeController', {
  enumerable: true,
  get: function () {
    return SheetsTableThemeController;
  }
});
