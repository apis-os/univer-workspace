import { BorderStyleTypes, CellValueType, CommandType, DateSystem, DependentOn, Disposable, ICommandService, IConfigService, ILogService, IResourceManagerService, IUndoRedoService, IUniverInstanceService, Inject, Injector, InterceptorEffectEnum, LocaleService, Plugin, RTree, Rectangle, UniverInstanceType, customNameCharacterCheck, excelSerialToDateTime, generateRandomId, merge, regexp, registerDependencies, sequenceExecute, touchDependencies } from "@univerjs/core";
...
const textEqual = (compareValue, expectedValue) => {
	return regexp.createFromWildcard(expectedValue).test(compareValue);
};
...
const NumberDynamicFilterCompareTypeSet = /* @__PURE__ */ new Set([
	"above",
	"below",
	"topN"
]);
const DateDynamicFilterCompareTypeSet = /* @__PURE__ */ new Set([
	"today",
	"yesterday",
	"tomorrow",
	"thisWeek",
...
function getCellValueWithConditionType(sheet, row, col, conditionType, dateSystem = DateSystem.Date1900) {
...
function excelSerialToDateTimeLocal(serial, dateSystem = DateSystem.Date1900) {
...
var TableFilters = class {
	...
	doFilter(sheet, range, dateSystem = DateSystem.Date1900) {
	...
	doColumnFilter(sheet, range, columnIndex, filterOutRows, dateSystem = DateSystem.Date1900) {
