...
export declare function getCellValueWithConditionType(sheet: Worksheet, row: number, col: number, conditionType: TableConditionTypeEnum, dateSystem?: DateSystem): string | number | Date | null | undefined;
export declare const getStringFromDataStream: (data: IDocumentData) => string;
declare function excelSerialToDateTimeLocal(serial: number, dateSystem?: DateSystem): Date;
