...
export declare class TableFilters {
    ...
    doFilter(sheet: Worksheet, range: ITableRange, dateSystem?: DateSystem): Set<number>;
    doColumnFilter(sheet: Worksheet, range: ITableRange, columnIndex: number, filterOutRows: Set<number>, dateSystem?: DateSystem): void;
