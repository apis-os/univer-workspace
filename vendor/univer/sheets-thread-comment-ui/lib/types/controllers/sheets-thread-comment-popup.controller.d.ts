...
export declare function resolveFocusedSheetComment(activeComment: ActiveCommentInfo, hoveredComment: ActiveCommentInfo, unitId: string | undefined, subUnitId: string | undefined): Exclude<ActiveCommentInfo, null | undefined> | undefined;
