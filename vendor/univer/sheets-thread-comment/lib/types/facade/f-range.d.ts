...
export type ISheetCellCommentCreateOptions = Pick<ThreadComment.ICreateThreadCommentOptions, 'attachments' | 'dateTime' | 'id' | 'personId' | 'threadId'>;
/**
 * @ignore
 */
...
export declare class FRangeSheetsThreadCommentMixin extends FRange implements IFRangeSheetsThreadCommentMixin {
    ...
    _initialize(injector: UniverCore.Injector): void;
    private _getCommentDataInRange;
    private _getStartCellCommentData;
    getComment(): UniverCore.Nullable<FThreadComment>;
    getComments(): FThreadComment[];
    addCommentAsync(content: ThreadComment.ThreadCommentContent | FTheadCommentBuilder, options?: ISheetCellCommentCreateOptions): Promise<boolean>;
    clearCommentAsync(): Promise<boolean>;
