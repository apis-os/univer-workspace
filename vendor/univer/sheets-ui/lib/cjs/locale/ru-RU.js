...
const locale = { "sheets-ui": {
	toolbar: {
		...
		border: { main: "Граница" },
		mergeCell: { main: "Объединить ячейки" },
		horizontalAlignMode: { main: "Горизонтальное выравнивание" },
		verticalAlignMode: { main: "Вертикальное выравнивание" },
		textWrapMode: { main: "Перенос текста" },
		shrinkToFit: "Уменьшить до размера ячейки",
		textRotateMode: { main: "Поворот текста" },
