...
const locale = { "sheets-ui": {
	toolbar: {
		...
		fillColor: { main: "Màu ô" },
		border: { main: "Đường viền" },
		mergeCell: { main: "Hợp nhất ô" },
		horizontalAlignMode: { main: "Căn ngang" },
		verticalAlignMode: { main: "Căn dọc" },
		textWrapMode: { main: "Ngắt dòng văn bản" },
		shrinkToFit: "Thu nhỏ để vừa",
		textRotateMode: { main: "Xoay văn bản" },
