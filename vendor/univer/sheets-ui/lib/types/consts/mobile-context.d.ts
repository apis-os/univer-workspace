...
export declare const MOBILE_SHEET_FX_EDITOR = "MOBILE_SHEET_FX_EDITOR";
/** Whether the software keyboard currently occupies the mobile visual viewport. */
export declare const MOBILE_KEYBOARD_VISIBLE = "MOBILE_KEYBOARD_VISIBLE";
/** Whether the mobile formula editor currently occupies the immersive full-screen surface. */
export declare const MOBILE_FX_EDITOR_EXPANDED = "MOBILE_FX_EDITOR_EXPANDED";
/** Whether the compact mobile formula operator strip is currently visible. */
export declare const MOBILE_FORMULA_OPERATORS_VISIBLE = "MOBILE_FORMULA_OPERATORS_VISIBLE";
/** Height of the compact mobile formula operator strip in pixels. */
export declare const MOBILE_FORMULA_OPERATOR_BAR_HEIGHT = 36;
/** Submit the compact mobile formula bar without unmounting its input. */
export declare const MOBILE_FORMULA_BAR_SUBMIT_COMMAND_ID = "sheet.command.mobile-formula-bar-submit";
