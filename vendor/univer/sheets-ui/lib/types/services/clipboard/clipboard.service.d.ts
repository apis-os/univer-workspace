...
export declare const FORMULA_CLIPBOARD_MIME_TYPE = "web application/x-univer-sheets-formula";
...
export interface ISheetClipboardService {
    ...
    legacyPaste(html?: string, text?: string, files?: File[], formulaClipboardPayload?: string): Promise<boolean>;
