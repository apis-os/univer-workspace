...
export declare class HtmlToUSMService {
    ...
    private _styleMap;
    private _selectorStyleValueCache;
    private _styleObjectCache;
    private _computedStyleStringCache;
    private _cellStyleDataCache;
    private _styleCache;
    private _styleRules;
    ...
    private _getNumfmtParseOptions?;
    private _numfmtParseOptions?;
    ...
    private _getStyleObject;
    private _getStyle;
    private _getCellStyleData;
    private _parseTable;
