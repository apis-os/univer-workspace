...
export declare class FThreadCommentEnumMixin extends FEnum implements IFThreadCommentEnumMixin {
    /** @inheritdoc */
    get ThreadCommentAnchorKind(): typeof ThreadCommentAnchorKind;
}
