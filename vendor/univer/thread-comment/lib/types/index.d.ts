...
export { createThreadCommentResourceHook, } from './common/tc-resource';
...
export type { ICreateThreadCommentOptions, IDeleteThreadCommentOptions, IFacadeThreadCommentInfo, IReplyThreadCommentOptions, IResolveThreadCommentOptions, IUpdateThreadCommentOptions, ThreadCommentContent, } from './services/thread-comment-api.service';
export { deserializeThreadCommentAnchor, isThreadCommentAnchor, serializeThreadCommentAnchor, ThreadCommentAnchorKind, } from './types/comment-anchor';
