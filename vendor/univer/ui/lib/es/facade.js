import { CommandType, ICommandService, IConfigService, IUniverInstanceService, Inject, Injector, UniverInstanceType, generateRandomId } from "@univerjs/core";
import { FBase, FEnum, FUniver } from "@univerjs/core/facade";
import { IRenderManagerService } from "@univerjs/engine-render";
import { BuiltInUIPart, ComponentManager, CopyCommand, IDialogService, IFontService, IMenuManagerService, IMessageService, IShortcutService, ISidebarService, IUIPartsService, KeyCode, MenuItemType, MenuManagerPosition, PasteCommand, RibbonPosition, RibbonStartGroup, UI_PLUGIN_CONFIG_KEY, connectInjector } from "@univerjs/ui";
...
var FUniverUIMixin = class extends FUniver {
	...
	setRibbonType(ribbonType) {
		this._injector.get(IConfigService).setConfig(UI_PLUGIN_CONFIG_KEY, { ribbonType }, { merge: true });
		return this;
	}
