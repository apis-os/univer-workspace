...
export declare function objectPermissionMenuItemFactory(accessor: IAccessor, id: string, unitType: UniverInstanceType, objectType: UnitObject): IMenuButtonItem;
